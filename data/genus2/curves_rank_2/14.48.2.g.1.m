...
// Magma code for modular curve with label 14.48.2.g.1

// Other names and/or labels
// Cummins-Pauli label: 14D2
// Rouse-Sutherland-Zureick-Brown label: 14.48.2.7
...
//   Coordinate number 1:
map_0_coord_1 := 1*((5*z+4*w)*(z^3-2*z^2*w-z*w^2+w^3)^2*(z^3-z^2*w-2*z*w^2+w^3));

// Map from the embedded model to the plane model of modular curve with label 14.48.2.g.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 14.48.2.g.1
//   Coordinate number 0:
