...
// Magma code for modular curve with label 48.48.2.dz.1

// Other names and/or labels
// Cummins-Pauli label: 8B2
// Rouse-Sutherland-Zureick-Brown label: 48.48.2.91

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[21, 26, 26, 43], [23, 46, 4, 3], [31, 3, 4, 13], [43, 17, 36, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.0.l.2", "24.24.1.dk.1", "48.24.1.g.2"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.2.dz.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.2.dz.1
//   Coordinate number 0:
map_2_coord_0 := 1*(y^2);
//   Coordinate number 1:
