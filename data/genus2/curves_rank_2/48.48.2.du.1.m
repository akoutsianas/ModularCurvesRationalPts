...
// Magma code for modular curve with label 48.48.2.du.1

// Other names and/or labels
// Cummins-Pauli label: 8B2
// Rouse-Sutherland-Zureick-Brown label: 48.48.2.135

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 43, 26, 15], [23, 37, 12, 17], [25, 39, 24, 11], [35, 47, 42, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.1.f.2", "24.24.1.dk.1", "48.24.0.k.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.2.du.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.2.du.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-y*w);
//   Coordinate number 1:
map_2_coord_1 := 1*(12*y^4*z*w+8*y^2*z*w^3);
//   Coordinate number 2:
map_2_coord_2 := 1*(-y^2);
// Codomain equation:
