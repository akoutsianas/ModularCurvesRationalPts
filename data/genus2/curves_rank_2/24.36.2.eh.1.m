...
// Magma code for modular curve with label 24.36.2.eh.1

// Other names and/or labels
// Cummins-Pauli label: 12E2
// Rouse-Sutherland-Zureick-Brown label: 24.36.2.57

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 7, 22, 3], [3, 20, 2, 9], [7, 14, 16, 13], [23, 7, 2, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["12.18.0.d.1", "24.18.1.f.1", "24.18.1.j.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.36.2.eh.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.36.2.eh.1
//   Coordinate number 0:
