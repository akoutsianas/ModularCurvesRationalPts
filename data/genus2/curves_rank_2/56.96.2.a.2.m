...
// Magma code for modular curve with label 56.96.2.a.2

// Other names and/or labels
// Cummins-Pauli label: 28F2
// Rouse-Sutherland-Zureick-Brown label: 56.96.2.101

// Group data
level := 56;
// Elements that, together with Gamma(level), generate the group
gens := [[30, 51, 49, 19], [37, 4, 48, 53], [49, 19, 45, 44], [54, 19, 37, 45]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
// Map from the embedded model to the plane model of modular curve with label 56.96.2.a.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 56.96.2.a.2
//   Coordinate number 0:
