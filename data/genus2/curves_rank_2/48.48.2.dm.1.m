...
// Magma code for modular curve with label 48.48.2.dm.1

// Other names and/or labels
// Cummins-Pauli label: 16D2
// Rouse-Sutherland-Zureick-Brown label: 48.48.2.105

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 1, 4, 23], [17, 18, 6, 47], [27, 31, 14, 9], [43, 16, 38, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.0.n.1", "24.24.1.du.1", "48.24.1.e.2"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.2.dm.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.2.dm.1
//   Coordinate number 0:
map_2_coord_0 := 1*(t^2);
//   Coordinate number 1:
