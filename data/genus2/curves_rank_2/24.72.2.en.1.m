...
// Magma code for modular curve with label 24.72.2.en.1

// Other names and/or labels
// Cummins-Pauli label: 24O2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.124

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 2, 4, 13], [3, 8, 4, 15], [9, 20, 22, 15], [13, 17, 20, 11], [19, 18, 0, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.0.t.1", "24.36.1.gh.1", "24.36.1.gl.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.en.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.en.1
//   Coordinate number 0:
