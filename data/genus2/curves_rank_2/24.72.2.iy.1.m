...
// Magma code for modular curve with label 24.72.2.iy.1

// Other names and/or labels
// Cummins-Pauli label: 24P2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.1118

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 18, 12, 17], [5, 1, 14, 23], [13, 22, 14, 7], [17, 13, 20, 11], [23, 21, 0, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.0.ci.1", "24.36.1.gc.1", "24.36.1.gh.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.iy.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.iy.1
//   Coordinate number 0:
map_2_coord_0 := 1*(x);
//   Coordinate number 1:
