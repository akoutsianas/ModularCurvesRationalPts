...
// Magma code for modular curve with label 48.24.2.f.2

// Other names and/or labels
// Cummins-Pauli label: 16A2
// Rouse-Sutherland-Zureick-Brown label: 48.24.2.3

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 44, 26, 29], [17, 7, 32, 35], [25, 6, 46, 7], [33, 26, 44, 17], [39, 10, 10, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 24;
...
// Map from the embedded model to the plane model of modular curve with label 48.24.2.f.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.24.2.f.2
//   Coordinate number 0:
