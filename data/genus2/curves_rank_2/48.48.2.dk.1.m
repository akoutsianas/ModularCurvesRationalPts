...
// Magma code for modular curve with label 48.48.2.dk.1

// Other names and/or labels
// Cummins-Pauli label: 16D2
// Rouse-Sutherland-Zureick-Brown label: 48.48.2.117

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[15, 2, 8, 7], [19, 18, 22, 25], [31, 47, 46, 45], [47, 14, 4, 35]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.0.m.1", "24.24.1.du.1", "48.24.1.e.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.2.dk.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.2.dk.1
//   Coordinate number 0:
map_2_coord_0 := 1*(w);
//   Coordinate number 1:
map_2_coord_1 := 1*(2*y*w^2+4*y*t^2);
//   Coordinate number 2:
map_2_coord_2 := 1*(t);
// Codomain equation:
