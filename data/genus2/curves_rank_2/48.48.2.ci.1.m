...
// Magma code for modular curve with label 48.48.2.ci.1

// Other names and/or labels
// Cummins-Pauli label: 8A2
// Rouse-Sutherland-Zureick-Brown label: 48.48.2.128

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 22, 10, 29], [25, 40, 44, 33], [41, 16, 14, 39], [45, 13, 34, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.1.f.2", "24.24.0.cz.1", "48.24.1.g.1"];
...
// Embedded model
model_0 := [x*w-2*y*w-z*w+x*t,2*x^2-2*x*y+2*y^2+3*w^2-2*t^2,3*x*w-2*x*t+4*y*t-2*z*t,x^2-4*x*y+4*y^2-2*z^2-6*w^2+4*t^2];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.2.ci.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.2.ci.1
//   Coordinate number 0:
