...
// Magma code for modular curve with label 48.48.2.cf.2

// Other names and/or labels
// Cummins-Pauli label: 16C2
// Rouse-Sutherland-Zureick-Brown label: 48.48.2.170

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[25, 41, 10, 43], [29, 1, 40, 19], [29, 15, 40, 11], [31, 18, 2, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.1.h.1", "24.24.0.cv.1", "48.24.1.e.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.2.cf.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.2.cf.2
//   Coordinate number 0:
