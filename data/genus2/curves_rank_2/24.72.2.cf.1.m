...
// Magma code for modular curve with label 24.72.2.cf.1

// Other names and/or labels
// Cummins-Pauli label: 24O2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.117

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 12, 18, 7], [3, 8, 20, 3], [11, 5, 16, 17], [11, 6, 6, 17], [19, 23, 4, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.0.p.1", "24.36.1.gh.1", "24.36.1.gj.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.cf.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.cf.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-z);
//   Coordinate number 1:
