...
// Magma code for modular curve with label 48.48.2.er.1

// Other names and/or labels
// Cummins-Pauli label: 16D2
// Rouse-Sutherland-Zureick-Brown label: 48.48.2.156

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 13, 24, 43], [25, 23, 16, 7], [31, 37, 30, 17], [33, 8, 46, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.1.h.2", "24.24.1.dv.1", "48.24.0.m.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.2.er.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.2.er.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-1/3*z*t);
//   Coordinate number 1:
map_2_coord_1 := 1*(2/3*y*z^4*t-1/9*y*z^2*t^3+1/54*z^3*t^3);
//   Coordinate number 2:
