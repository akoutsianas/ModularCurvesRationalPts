...
// Magma code for modular curve with label 32.96.2.g.1

// Other names and/or labels
// Cummins-Pauli label: 16I2
// Rouse-Zureick-Brown label: X526
// Rouse-Sutherland-Zureick-Brown label: 32.96.2.21

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 31, 6, 21], [9, 0, 4, 25], [25, 20, 6, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
// Map from the embedded model to the plane model of modular curve with label 32.96.2.g.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*x);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 32.96.2.g.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-z);
//   Coordinate number 1:
