...
// Magma code for modular curve with label 30.30.2.h.1

// Other names and/or labels
// Cummins-Pauli label: 30A2
// Rouse-Sutherland-Zureick-Brown label: 30.30.2.5

// Group data
level := 30;
// Elements that, together with Gamma(level), generate the group
gens := [[4, 19, 19, 26], [16, 1, 13, 2], [27, 25, 10, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 30;
...
;// CM discriminants
CM_discs := [-4, -19];
// Modular curve is a fiber product of the following curvesfactors := ['5.5.0.a.1', '6.6.0.d.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["6.6.0.d.1", "15.15.1.a.1"];
...
// Map from the embedded model to the plane model of modular curve with label 30.30.2.h.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 30.30.2.h.1
//   Coordinate number 0:
