...
// Magma code for modular curve with label 48.48.2.cy.1

// Other names and/or labels
// Cummins-Pauli label: 8B2
// Rouse-Sutherland-Zureick-Brown label: 48.48.2.132

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 38, 12, 29], [41, 26, 46, 39], [43, 12, 26, 13], [47, 31, 16, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.1.f.2", "24.24.1.de.1", "48.24.0.l.2"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.2.cy.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.2.cy.1
//   Coordinate number 0:
map_2_coord_0 := 1*(y^2);
//   Coordinate number 1:
