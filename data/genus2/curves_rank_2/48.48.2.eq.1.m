...
// Magma code for modular curve with label 48.48.2.eq.1

// Other names and/or labels
// Cummins-Pauli label: 16D2
// Rouse-Sutherland-Zureick-Brown label: 48.48.2.173

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 32, 4, 21], [5, 32, 42, 43], [35, 47, 36, 13], [45, 19, 20, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.1.h.1", "24.24.1.du.1", "48.24.0.m.2"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.2.eq.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.2.eq.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-z*w);
//   Coordinate number 1:
