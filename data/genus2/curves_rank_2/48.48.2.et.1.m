...
// Magma code for modular curve with label 48.48.2.et.1

// Other names and/or labels
// Cummins-Pauli label: 16D2
// Rouse-Sutherland-Zureick-Brown label: 48.48.2.172

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[27, 47, 22, 41], [29, 34, 34, 39], [35, 22, 2, 5], [37, 35, 14, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.1.h.1", "24.24.1.dv.1", "48.24.0.n.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.2.et.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.2.et.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-w);
//   Coordinate number 1:
