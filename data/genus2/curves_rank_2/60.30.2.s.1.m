...
// Magma code for modular curve with label 60.30.2.s.1

// Other names and/or labels
// Cummins-Pauli label: 30A2
// Rouse-Sutherland-Zureick-Brown label: 60.30.2.13

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[31, 26, 44, 41], [37, 23, 44, 29], [41, 4, 31, 1], [48, 59, 41, 57]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 30;
...
;// CM discriminants
CM_discs := [-4];
// Modular curve is a fiber product of the following curvesfactors := ['5.5.0.a.1', '12.6.0.h.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["12.6.0.h.1", "15.15.1.a.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.30.2.s.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.30.2.s.1
//   Coordinate number 0:
