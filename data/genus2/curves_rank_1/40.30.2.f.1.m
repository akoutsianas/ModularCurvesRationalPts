...
// Magma code for modular curve with label 40.30.2.f.1

// Other names and/or labels
// Cummins-Pauli label: 10A2
// Rouse-Sutherland-Zureick-Brown label: 40.30.2.2

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[8, 37, 5, 9], [17, 30, 10, 27], [22, 3, 31, 8], [32, 17, 35, 28]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 30;
...
;// CM discriminants
CM_discs := [-4, -16];
// Modular curve is a fiber product of the following curvesfactors := ['5.15.0.a.1', '8.2.0.b.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["5.15.0.a.1", "40.10.0.b.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.30.2.f.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.30.2.f.1
//   Coordinate number 0:
