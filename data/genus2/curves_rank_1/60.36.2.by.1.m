...
// Magma code for modular curve with label 60.36.2.by.1

// Other names and/or labels
// Cummins-Pauli label: 12E2
// Rouse-Sutherland-Zureick-Brown label: 60.36.2.149

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 12, 3, 25], [7, 54, 33, 53], [33, 40, 16, 51], [49, 56, 22, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["12.18.1.d.1", "60.18.0.f.1", "60.18.1.i.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.36.2.by.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.36.2.by.1
//   Coordinate number 0:
