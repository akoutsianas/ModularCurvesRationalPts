...
// Magma code for modular curve with label 40.90.2.d.1

// Other names and/or labels
// Cummins-Pauli label: 10F2
// Rouse-Sutherland-Zureick-Brown label: 40.90.2.3

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 31, 4, 17], [13, 8, 30, 27], [19, 6, 10, 37], [19, 30, 22, 21], [23, 36, 14, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 90;
...
covers := ["10.45.1.a.1", "40.30.0.d.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.90.2.d.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.90.2.d.1
//   Coordinate number 0:
map_2_coord_0 := 1*(2/5*y*z*w^2-8/5*y*z*w*t+8/5*y*z*t^2+4/5*y*w^3-12/5*y*w^2*t+8/5*y*w*t^2);
//   Coordinate number 1:
map_2_coord_1 := 1*(22/25*y*z*w^10-644/125*y*z*w^9*t+1382/125*y*z*w^8*t^2-5784/625*y*z*w^7*t^3-184/125*y*z*w^6*t^4+5248/625*y*z*w^5*t^5-3808/625*y*z*w^4*t^6+1152/625*y*z*w^3*t^7-128/625*y*z*w^2*t^8-4/25*y*w^11-188/125*y*w^10*t+44/5*y*w^9*t^2-9668/625*y*w^8*t^3+5304/625*y*w^7*t^4+3936/625*y*w^6*t^5-6912/625*y*w^5*t^6+704/125*y*w^4*t^7-128/125*y*w^3*t^8);
//   Coordinate number 2:
