...
// Magma code for modular curve with label 48.48.2.ee.1

// Other names and/or labels
// Cummins-Pauli label: 8B2
// Rouse-Sutherland-Zureick-Brown label: 48.48.2.133

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 15, 18, 23], [15, 43, 14, 13], [39, 2, 28, 19], [43, 45, 44, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.1.f.2", "24.24.1.dq.1", "48.24.0.l.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.2.ee.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.2.ee.1
//   Coordinate number 0:
