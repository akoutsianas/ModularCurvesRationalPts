...
// Magma code for modular curve with label 60.90.2.b.1

// Other names and/or labels
// Cummins-Pauli label: 10F2
// Rouse-Sutherland-Zureick-Brown label: 60.90.2.1

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[15, 7, 4, 5], [15, 7, 26, 45], [19, 10, 0, 23], [55, 16, 54, 25], [55, 29, 26, 35]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 90;
...
covers := ["10.45.1.a.1", "60.30.0.b.1"];
...
// Embedded model
model_0 := [x*z+2*y*z-x*w-y*w+x*t,15*y^2+z^2+w^2-t^2,15*x^2+4*z^2-w^2,15*x*y-2*z^2+z*w+w^2-2*z*t-w*t];

// Singular plane model
model_1 := [5*x^6+150*x^4*y^2+1350*x^2*y^4+3375*y^6+10*x^5*z+210*x^3*y^2*z+900*x*y^4*z+4*x^4*z^2-15*x^2*y^2*z^2-450*y^4*z^2-2*x^3*z^3-60*x*y^2*z^3-x^2*z^4+15*y^2*z^4];
...
// Map from the embedded model to the plane model of modular curve with label 60.90.2.b.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
...
map_1_coord_2 := 1*(t);
// Codomain equation:
map_1_codomain := [5*x^6+150*x^4*y^2+1350*x^2*y^4+3375*y^6+10*x^5*z+210*x^3*y^2*z+900*x*y^4*z+4*x^4*z^2-15*x^2*y^2*z^2-450*y^4*z^2-2*x^3*z^3-60*x*y^2*z^3-x^2*z^4+15*y^2*z^4];

// Map from the embedded model to the Weierstrass model of modular curve with label 60.90.2.b.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-1/5*y*z*w^2+4/5*y*z*w*t-4/5*y*z*t^2+2/5*y*w^3-6/5*y*w^2*t+4/5*y*w*t^2);
//   Coordinate number 1:
map_2_coord_1 := 1*(38/1125*y*z*w^10-4/25*y*z*w^9*t+482/1875*y*z*w^8*t^2-296/1875*y*z*w^7*t^3+728/28125*y*z*w^6*t^4+128/3125*y*z*w^5*t^5-1312/9375*y*z*w^4*t^6+1408/9375*y*z*w^3*t^7-1408/28125*y*z*w^2*t^8+44/1125*y*w^11-76/1125*y*w^10*t-1012/5625*y*w^9*t^2+3244/5625*y*w^8*t^3-1464/3125*y*w^7*t^4-128/1125*y*w^6*t^5+11456/28125*y*w^5*t^6-6848/28125*y*w^4*t^7+1408/28125*y*w^3*t^8);
//   Coordinate number 2:
map_2_coord_2 := 1*(1/15*w^4-1/15*w^3*t-4/75*w^2*t^2+4/75*w*t^3);
// Codomain equation:
