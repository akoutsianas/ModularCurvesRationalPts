...
// Magma code for modular curve with label 40.60.2.i.1

// Other names and/or labels
// Cummins-Pauli label: 10E2
// Rouse-Sutherland-Zureick-Brown label: 40.60.2.29

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 29, 36, 37], [3, 35, 0, 23], [7, 37, 8, 5], [9, 3, 24, 21], [13, 28, 30, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["10.30.1.a.1", "40.20.0.e.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.60.2.i.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.60.2.i.1
//   Coordinate number 0:
