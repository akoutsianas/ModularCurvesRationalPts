...
// Magma code for modular curve with label 24.72.2.iz.1

// Other names and/or labels
// Cummins-Pauli label: 24P2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.1116

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 16, 22, 11], [3, 14, 20, 3], [13, 2, 20, 5], [15, 10, 22, 21], [23, 23, 16, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.0.ci.1", "24.36.1.gd.1", "24.36.1.gh.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.iz.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.iz.1
//   Coordinate number 0:
map_2_coord_0 := 1*(x);
//   Coordinate number 1:
