...
// Magma code for modular curve with label 60.36.2.bx.1

// Other names and/or labels
// Cummins-Pauli label: 12E2
// Rouse-Sutherland-Zureick-Brown label: 60.36.2.24

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 6, 27, 23], [7, 22, 28, 11], [53, 10, 34, 31], [57, 38, 40, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["6.18.1.b.1", "60.18.0.g.1", "60.18.1.i.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.36.2.bx.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.36.2.bx.1
//   Coordinate number 0:
