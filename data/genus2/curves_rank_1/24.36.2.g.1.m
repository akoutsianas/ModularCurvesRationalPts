...
// Magma code for modular curve with label 24.36.2.g.1

// Other names and/or labels
// Cummins-Pauli label: 12E2
// Rouse-Sutherland-Zureick-Brown label: 24.36.2.15

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 2, 14, 15], [7, 14, 22, 7], [11, 0, 12, 13], [15, 22, 2, 21], [17, 6, 12, 11], [17, 20, 10, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["6.18.1.a.1", "24.18.0.i.1", "24.18.1.j.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.36.2.g.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.36.2.g.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-y);
//   Coordinate number 1:
