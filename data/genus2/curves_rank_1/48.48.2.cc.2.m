...
// Magma code for modular curve with label 48.48.2.cc.2

// Other names and/or labels
// Cummins-Pauli label: 8A2
// Rouse-Sutherland-Zureick-Brown label: 48.48.2.137

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 44, 18, 41], [19, 20, 6, 5], [23, 25, 14, 41], [41, 25, 10, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.1.f.1", "24.24.0.cp.1", "48.24.1.f.2"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.2.cc.2
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.2.cc.2
//   Coordinate number 0:
