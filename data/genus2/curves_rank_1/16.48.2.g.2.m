...
// Magma code for modular curve with label 16.48.2.g.2

// Other names and/or labels
// Cummins-Pauli label: 16C2
// Rouse-Zureick-Brown label: X373
// Rouse-Sutherland-Zureick-Brown label: 16.48.2.18

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 7, 8, 13], [7, 5, 6, 13], [15, 0, 14, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["8.24.0.o.1", "16.24.1.e.2", "16.24.1.h.2"];
...
// Map from the embedded model to the plane model of modular curve with label 16.48.2.g.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 16.48.2.g.2
//   Coordinate number 0:
