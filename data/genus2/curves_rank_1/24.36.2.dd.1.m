...
// Magma code for modular curve with label 24.36.2.dd.1

// Other names and/or labels
// Cummins-Pauli label: 12D2
// Rouse-Sutherland-Zureick-Brown label: 24.36.2.6

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 7, 4, 5], [3, 4, 2, 9], [3, 8, 16, 21], [17, 12, 0, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["6.18.0.c.1", "24.18.1.c.1", "24.18.1.k.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.36.2.dd.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.36.2.dd.1
//   Coordinate number 0:
