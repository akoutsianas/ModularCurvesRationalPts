...
// Magma code for modular curve with label 16.48.2.bt.1

// Other names and/or labels
// Cummins-Pauli label: 16D2
// Rouse-Sutherland-Zureick-Brown label: 16.48.2.39

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 7, 12, 7], [15, 10, 4, 11], [15, 14, 10, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["8.24.1.bf.1", "16.24.0.m.1", "16.24.1.h.1"];
...
// Map from the embedded model to the plane model of modular curve with label 16.48.2.bt.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 16.48.2.bt.1
//   Coordinate number 0:
map_2_coord_0 := 1*(w);
//   Coordinate number 1:
