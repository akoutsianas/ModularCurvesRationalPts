...
// Magma code for modular curve with label 36.54.2.b.1

// Other names and/or labels
// Cummins-Pauli label: 18J2
// Rouse-Sutherland-Zureick-Brown label: 36.54.2.2

// Group data
level := 36;
// Elements that, together with Gamma(level), generate the group
gens := [[2, 25, 33, 8], [11, 21, 22, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 54;
...
// Map from the embedded model to the plane model of modular curve with label 36.54.2.b.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 36.54.2.b.1
//   Coordinate number 0:
