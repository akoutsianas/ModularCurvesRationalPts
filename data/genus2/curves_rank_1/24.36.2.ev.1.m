...
// Magma code for modular curve with label 24.36.2.ev.1

// Other names and/or labels
// Cummins-Pauli label: 12C2
// Rouse-Sutherland-Zureick-Brown label: 24.36.2.1

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 11, 8, 3], [3, 19, 22, 21], [19, 6, 6, 11], [21, 14, 20, 3], [21, 16, 20, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
// Map from the embedded model to the plane model of modular curve with label 24.36.2.ev.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.36.2.ev.1
//   Coordinate number 0:
