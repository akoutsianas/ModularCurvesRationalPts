...
// Magma code for modular curve with label 24.72.2.dv.1

// Other names and/or labels
// Cummins-Pauli label: 12I2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.538

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 2, 20, 15], [5, 8, 2, 19], [11, 7, 10, 13], [17, 20, 4, 17], [17, 23, 8, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bz.1", "24.36.0.cb.1", "24.36.1.fw.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.dv.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.dv.1
//   Coordinate number 0:
