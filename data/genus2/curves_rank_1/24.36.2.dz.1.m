...
// Magma code for modular curve with label 24.36.2.dz.1

// Other names and/or labels
// Cummins-Pauli label: 12E2
// Rouse-Sutherland-Zureick-Brown label: 24.36.2.25

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 14, 8, 13], [11, 15, 18, 7], [11, 23, 16, 23], [19, 15, 0, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["6.18.1.b.1", "24.18.0.e.1", "24.18.1.j.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.36.2.dz.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.36.2.dz.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-1/2*y^2);
//   Coordinate number 1:
map_2_coord_1 := 1*(-12*x^4*y^2-6*x^3*y^2*t-3*x^2*y^4-3/4*x*y^4*t-1/8*y^6);
//   Coordinate number 2:
map_2_coord_2 := 1*(-x*y);
// Codomain equation:
