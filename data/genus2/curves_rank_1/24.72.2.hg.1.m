...
// Magma code for modular curve with label 24.72.2.hg.1

// Other names and/or labels
// Cummins-Pauli label: 24L2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.100

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 9, 0, 1], [9, 20, 10, 15], [13, 3, 18, 11], [15, 7, 16, 21], [17, 23, 10, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
;// CM discriminants
CM_discs := [-28];
// Modular curve is a fiber product of the following curvesfactors := ['3.3.0.a.1', '8.24.0.bi.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["8.24.0.bi.1", "24.36.0.cj.1", "24.36.1.fp.1", "24.36.1.fw.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.hg.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.hg.1
//   Coordinate number 0:
map_2_coord_0 := 1*(z);
//   Coordinate number 1:
