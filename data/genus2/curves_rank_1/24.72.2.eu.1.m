...
// Magma code for modular curve with label 24.72.2.eu.1

// Other names and/or labels
// Cummins-Pauli label: 24L2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.1083

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 7, 16, 23], [7, 4, 14, 13], [11, 1, 22, 13], [23, 5, 22, 5], [23, 7, 8, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.24.0.dm.1", "24.36.0.cf.1", "24.36.1.fp.1", "24.36.1.fy.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.eu.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.eu.1
//   Coordinate number 0:
map_2_coord_0 := 1*(w);
//   Coordinate number 1:
