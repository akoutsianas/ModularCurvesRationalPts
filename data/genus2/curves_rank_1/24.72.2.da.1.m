...
// Magma code for modular curve with label 24.72.2.da.1

// Other names and/or labels
// Cummins-Pauli label: 12I2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.189

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 8, 16, 7], [13, 13, 10, 23], [15, 16, 20, 15], [23, 9, 12, 13], [23, 9, 12, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bs.1", "24.24.0.fg.1", "24.36.0.by.1", "24.36.1.gc.1"];
...
// Embedded model
model_0 := [y*z+x*w+2*y*w-x*t,6*x^2-6*y^2-w^2+2*z*t+2*w*t+t^2,6*x*y+6*y^2-z^2-z*w-w^2-z*t-t^2,6*x^2-6*x*y+6*y^2+z*w-w^2+z*t+4*w*t-t^2];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.da.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.da.1
//   Coordinate number 0:
