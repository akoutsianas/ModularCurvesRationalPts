...
// Magma code for modular curve with label 48.48.2.eh.1

// Other names and/or labels
// Cummins-Pauli label: 8B2
// Rouse-Sutherland-Zureick-Brown label: 48.48.2.89

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 3, 30, 25], [25, 18, 42, 23], [31, 34, 26, 9], [35, 37, 26, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.0.l.2", "24.24.1.dq.1", "48.24.1.g.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.2.eh.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.2.eh.1
//   Coordinate number 0:
map_2_coord_0 := 1*(w^3);
//   Coordinate number 1:
