...
// Magma code for modular curve with label 24.72.2.gj.1

// Other names and/or labels
// Cummins-Pauli label: 24P2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.512

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 3, 12, 17], [7, 5, 4, 13], [7, 20, 14, 17], [13, 0, 12, 1], [19, 6, 6, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bx.1", "24.36.0.cf.1", "24.36.1.gh.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.gj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.gj.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-x);
//   Coordinate number 1:
