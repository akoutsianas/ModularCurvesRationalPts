...
// Magma code for modular curve with label 24.36.2.bf.1

// Other names and/or labels
// Cummins-Pauli label: 12E2
// Rouse-Sutherland-Zureick-Brown label: 24.36.2.131

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 11, 8, 5], [5, 9, 6, 23], [11, 0, 6, 5], [19, 9, 12, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["12.18.1.g.1", "24.18.0.i.1", "24.18.1.b.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.36.2.bf.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.36.2.bf.1
//   Coordinate number 0:
map_2_coord_0 := 1*(w^2*t-2/3*t^3);
//   Coordinate number 1:
map_2_coord_1 := 1*(3/4*z*w^8-5/2*z*w^6*t^2+10/3*z*w^4*t^4-2*z*w^2*t^6+4/9*z*t^8);
//   Coordinate number 2:
