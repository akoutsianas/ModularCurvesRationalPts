...
// Magma code for modular curve with label 24.36.2.bj.1

// Other names and/or labels
// Cummins-Pauli label: 12E2
// Rouse-Sutherland-Zureick-Brown label: 24.36.2.56

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 10, 22, 7], [11, 18, 0, 5], [13, 2, 10, 7], [17, 9, 12, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["12.18.0.c.1", "24.18.1.b.1", "24.18.1.k.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.36.2.bj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.36.2.bj.1
//   Coordinate number 0:
