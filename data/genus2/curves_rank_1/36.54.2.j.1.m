...
// Magma code for modular curve with label 36.54.2.j.1

// Other names and/or labels
// Cummins-Pauli label: 36B2
// Rouse-Sutherland-Zureick-Brown label: 36.54.2.6

// Group data
level := 36;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 18, 0, 29], [7, 25, 2, 25], [19, 25, 34, 5], [23, 26, 10, 29], [33, 34, 10, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 54;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['4.6.0.e.1', '9.9.0.a.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["12.18.0.l.1", "18.27.1.a.1"];
...
// Weierstrass model
model_2 := [2*x^4*z^2+x^3*y-2*x^2*z^4+x*y*z^2+y^2+4*z^6];
...
// Map from the embedded model to the plane model of modular curve with label 36.54.2.j.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 36.54.2.j.1
//   Coordinate number 0:
map_2_coord_0 := 1*(z);
//   Coordinate number 1:
map_2_coord_1 := 1*(-x^2*y+x^2*z-z^3);
//   Coordinate number 2:
map_2_coord_2 := 1*(-x);
// Codomain equation:
map_2_codomain := [2*x^4*z^2+x^3*y-2*x^2*z^4+x*y*z^2+y^2+4*z^6];
