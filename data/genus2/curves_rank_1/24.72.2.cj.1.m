...
// Magma code for modular curve with label 24.72.2.cj.1

// Other names and/or labels
// Cummins-Pauli label: 24O2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.110

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 4, 14, 21], [13, 19, 10, 11], [17, 13, 22, 19], [19, 0, 0, 11], [23, 6, 0, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.0.p.1", "24.36.1.gf.1", "24.36.1.gl.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.cj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.cj.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-y);
//   Coordinate number 1:
