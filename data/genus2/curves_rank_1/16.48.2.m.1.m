...
// Magma code for modular curve with label 16.48.2.m.1

// Other names and/or labels
// Cummins-Pauli label: 8A2
// Rouse-Zureick-Brown label: X400
// Rouse-Sutherland-Zureick-Brown label: 16.48.2.15

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 0, 14, 7], [9, 3, 2, 3], [11, 13, 8, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["8.24.0.v.1", "16.24.1.f.2", "16.24.1.g.1"];
...
// Map from the embedded model to the plane model of modular curve with label 16.48.2.m.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 16.48.2.m.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-w);
//   Coordinate number 1:
