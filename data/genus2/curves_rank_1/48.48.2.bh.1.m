...
// Magma code for modular curve with label 48.48.2.bh.1

// Other names and/or labels
// Cummins-Pauli label: 8B2
// Rouse-Sutherland-Zureick-Brown label: 48.48.2.55

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 34, 0, 35], [13, 7, 36, 19], [17, 17, 10, 35], [27, 32, 8, 3], [37, 24, 24, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["8.24.1.y.1", "48.24.0.k.2", "48.24.1.g.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.2.bh.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(4*w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.2.bh.1
//   Coordinate number 0:
map_2_coord_0 := 1*(y^2);
//   Coordinate number 1:
