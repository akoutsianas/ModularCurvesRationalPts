...
// Magma code for modular curve with label 24.72.2.el.1

// Other names and/or labels
// Cummins-Pauli label: 24O2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.1156

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 9, 6, 23], [5, 0, 6, 19], [5, 8, 10, 23], [9, 19, 22, 3], [17, 5, 14, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.0.cb.1", "24.36.1.gg.1", "24.36.1.gl.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.el.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.el.1
//   Coordinate number 0:
