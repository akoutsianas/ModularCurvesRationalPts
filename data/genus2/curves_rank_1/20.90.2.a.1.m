...
// Magma code for modular curve with label 20.90.2.a.1

// Other names and/or labels
// Cummins-Pauli label: 10F2
// Rouse-Sutherland-Zureick-Brown label: 20.90.2.1

// Group data
level := 20;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 14, 2, 11], [13, 3, 4, 7], [13, 11, 4, 7], [19, 6, 10, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 90;
...
covers := ["10.45.1.a.1", "20.30.0.a.1"];
...
// Embedded model
model_0 := [2*x^2+x*y-z*w-w^2+w*t,x^2-2*x*y+2*z*w-w^2+2*w*t,5*y^2+5*z^2-w^2-t^2,5*x*z-x*w-3*y*w+3*x*t+4*y*t];

// Singular plane model
model_1 := [5*x^6-15*x^4*z^2-x^2*y^2*z^2+6*x^2*y*z^3+11*x^2*z^4-y^2*z^4-2*y*z^5-z^6];
...
// Map from the embedded model to the plane model of modular curve with label 20.90.2.a.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(4*z);
...
map_1_coord_2 := 1*(w);
// Codomain equation:
map_1_codomain := [5*x^6-15*x^4*z^2-x^2*y^2*z^2+6*x^2*y*z^3+11*x^2*z^4-y^2*z^4-2*y*z^5-z^6];

// Map from the embedded model to the Weierstrass model of modular curve with label 20.90.2.a.1
//   Coordinate number 0:
map_2_coord_0 := 1*(x*w);
//   Coordinate number 1:
map_2_coord_1 := 1*(1/2*x^6+2*x^4*z*w-x^4*w^2+2*x^2*z*w^3+1/2*x^2*w^4);
//   Coordinate number 2:
map_2_coord_2 := 1*(-x^2);
// Codomain equation:
