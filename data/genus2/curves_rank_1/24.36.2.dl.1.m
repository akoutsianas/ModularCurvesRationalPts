...
// Magma code for modular curve with label 24.36.2.dl.1

// Other names and/or labels
// Cummins-Pauli label: 12D2
// Rouse-Sutherland-Zureick-Brown label: 24.36.2.143

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 10, 20, 1], [9, 19, 4, 21], [17, 17, 10, 23], [19, 22, 10, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["12.18.1.h.1", "24.18.0.k.1", "24.18.1.c.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.36.2.dl.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(6*z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.36.2.dl.1
//   Coordinate number 0:
map_2_coord_0 := 1*(w^2*t+1/6*t^3);
//   Coordinate number 1:
map_2_coord_1 := 1*(6*z*w^8+5*z*w^6*t^2+5/3*z*w^4*t^4+1/4*z*w^2*t^6+1/72*z*t^8-1/2*w^6*t^3-1/4*w^4*t^5-1/24*w^2*t^7-1/432*t^9);
//   Coordinate number 2:
