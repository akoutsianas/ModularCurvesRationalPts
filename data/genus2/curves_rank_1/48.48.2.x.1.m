...
// Magma code for modular curve with label 48.48.2.x.1

// Other names and/or labels
// Cummins-Pauli label: 8B2
// Rouse-Sutherland-Zureick-Brown label: 48.48.2.49

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 29, 34, 15], [31, 17, 10, 25], [31, 40, 16, 39], [39, 47, 44, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["8.24.1.u.1", "48.24.0.l.1", "48.24.1.g.2"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.2.x.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(4*w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.2.x.1
//   Coordinate number 0:
