...
// Magma code for modular curve with label 24.72.2.u.1

// Other names and/or labels
// Cummins-Pauli label: 24O2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.143

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 13, 16, 15], [11, 9, 0, 17], [17, 9, 0, 11], [23, 18, 12, 7], [23, 22, 10, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.0.o.1", "24.36.1.fq.1", "24.36.1.gh.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.u.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.u.1
//   Coordinate number 0:
