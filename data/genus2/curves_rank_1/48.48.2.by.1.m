...
// Magma code for modular curve with label 48.48.2.by.1

// Other names and/or labels
// Cummins-Pauli label: 16C2
// Rouse-Sutherland-Zureick-Brown label: 48.48.2.177

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 21, 16, 25], [13, 34, 2, 31], [23, 26, 8, 7], [23, 39, 2, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.1.e.2", "24.24.0.dd.1", "48.24.1.e.2"];
...
// Embedded model
model_0 := [x*z+y*z+y*w+x*t,2*x*z+y*z+x*w-y*w-x*t-2*y*t,z^2+4*z*w+w^2+2*t^2,x^2-2*x*y-2*y^2+3*z^2+3*w^2-2*t^2];
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.2.by.1
//   Coordinate number 0:
