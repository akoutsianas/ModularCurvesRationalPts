...
// Magma code for modular curve with label 24.36.2.s.1

// Other names and/or labels
// Cummins-Pauli label: 12E2
// Rouse-Sutherland-Zureick-Brown label: 24.36.2.61

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 4, 10, 23], [13, 13, 8, 19], [17, 16, 20, 17], [17, 19, 10, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["12.18.0.f.1", "24.18.1.a.1", "24.18.1.j.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.36.2.s.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.36.2.s.1
//   Coordinate number 0:
