...
// Magma code for modular curve with label 24.72.2.ch.1

// Other names and/or labels
// Cummins-Pauli label: 24O2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.1172

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 0, 6, 7], [5, 12, 6, 23], [17, 6, 0, 1], [23, 7, 22, 13], [23, 21, 0, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.0.bp.1", "24.36.1.ge.1", "24.36.1.gl.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.ch.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.ch.1
//   Coordinate number 0:
map_2_coord_0 := 1*(y);
//   Coordinate number 1:
