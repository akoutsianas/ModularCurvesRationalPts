...
// Magma code for modular curve with label 24.36.2.ef.1

// Other names and/or labels
// Cummins-Pauli label: 12E2
// Rouse-Sutherland-Zureick-Brown label: 24.36.2.170

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 19, 16, 11], [5, 22, 2, 23], [13, 1, 10, 5], [21, 14, 14, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["12.18.1.d.1", "24.18.0.f.1", "24.18.1.j.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.36.2.ef.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.36.2.ef.1
//   Coordinate number 0:
