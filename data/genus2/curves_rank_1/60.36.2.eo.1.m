...
// Magma code for modular curve with label 60.36.2.eo.1

// Other names and/or labels
// Cummins-Pauli label: 12D2
// Rouse-Sutherland-Zureick-Brown label: 60.36.2.68

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 26, 31, 15], [25, 18, 18, 23], [25, 38, 34, 49], [47, 0, 51, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["12.18.0.h.1", "60.18.1.b.1", "60.18.1.h.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.36.2.eo.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.36.2.eo.1
//   Coordinate number 0:
