...
// Magma code for modular curve with label 48.48.2.cc.1

// Other names and/or labels
// Cummins-Pauli label: 8A2
// Rouse-Sutherland-Zureick-Brown label: 48.48.2.129

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[37, 21, 36, 31], [37, 42, 44, 17], [39, 26, 22, 41], [41, 32, 12, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.1.f.2", "24.24.0.cp.1", "48.24.1.f.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.2.cc.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.2.cc.1
//   Coordinate number 0:
