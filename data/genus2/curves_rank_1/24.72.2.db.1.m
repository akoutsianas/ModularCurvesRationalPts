...
// Magma code for modular curve with label 24.72.2.db.1

// Other names and/or labels
// Cummins-Pauli label: 12I2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.525

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 4, 8, 1], [5, 0, 18, 11], [11, 7, 20, 5], [11, 8, 10, 5], [19, 22, 22, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.by.1", "24.36.0.by.1", "24.36.1.fw.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.db.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.db.1
//   Coordinate number 0:
