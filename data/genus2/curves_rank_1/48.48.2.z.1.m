...
// Magma code for modular curve with label 48.48.2.z.1

// Other names and/or labels
// Cummins-Pauli label: 16D2
// Rouse-Sutherland-Zureick-Brown label: 48.48.2.30

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 41, 2, 15], [25, 0, 36, 5], [29, 16, 16, 21], [29, 29, 20, 3], [29, 44, 4, 41]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["8.24.1.bb.1", "48.24.0.m.2", "48.24.1.e.2"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.2.z.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.2.z.1
//   Coordinate number 0:
