...
// Magma code for modular curve with label 48.48.2.dd.1

// Other names and/or labels
// Cummins-Pauli label: 8B2
// Rouse-Sutherland-Zureick-Brown label: 48.48.2.98

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 42, 38, 35], [23, 24, 42, 25], [23, 37, 14, 41], [33, 14, 26, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.0.k.1", "24.24.1.dg.1", "48.24.1.g.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.2.dd.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.2.dd.1
//   Coordinate number 0:
map_2_coord_0 := 1*(w^3);
//   Coordinate number 1:
