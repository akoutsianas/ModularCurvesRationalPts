...
// Magma code for modular curve with label 24.36.2.dt.1

// Other names and/or labels
// Cummins-Pauli label: 12D2
// Rouse-Sutherland-Zureick-Brown label: 24.36.2.100

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 1, 8, 21], [7, 6, 12, 13], [9, 1, 8, 21], [13, 3, 0, 5], [17, 15, 12, 11], [19, 10, 8, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["12.18.1.c.1", "24.18.0.l.1", "24.18.1.j.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.36.2.dt.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.36.2.dt.1
//   Coordinate number 0:
map_2_coord_0 := 1*(x);
//   Coordinate number 1:
