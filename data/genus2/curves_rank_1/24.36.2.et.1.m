...
// Magma code for modular curve with label 24.36.2.et.1

// Other names and/or labels
// Cummins-Pauli label: 12D2
// Rouse-Sutherland-Zureick-Brown label: 24.36.2.3

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 19, 10, 11], [9, 14, 22, 9], [21, 4, 22, 15], [23, 12, 0, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["6.18.0.c.1", "24.18.1.h.1", "24.18.1.j.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.36.2.et.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.36.2.et.1
//   Coordinate number 0:
