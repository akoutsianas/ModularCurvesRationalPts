...
// Magma code for modular curve with label 40.30.2.g.1

// Other names and/or labels
// Cummins-Pauli label: 10B2
// Rouse-Sutherland-Zureick-Brown label: 40.30.2.15

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[23, 32, 18, 5], [31, 20, 36, 17], [33, 11, 34, 7], [37, 21, 18, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 30;
...
covers := ["10.15.1.a.1", "40.6.0.a.1", "40.10.0.c.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.30.2.g.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.30.2.g.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-1/2*y);
//   Coordinate number 1:
map_2_coord_1 := 1*(9*x^2*y-5/2*x^2*w-1/8*y^3-1/4*y^2*w);
//   Coordinate number 2:
map_2_coord_2 := 1*(-x);
// Codomain equation:
