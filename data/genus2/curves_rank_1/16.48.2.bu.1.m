...
// Magma code for modular curve with label 16.48.2.bu.1

// Other names and/or labels
// Cummins-Pauli label: 16D2
// Rouse-Zureick-Brown label: X361
// Rouse-Sutherland-Zureick-Brown label: 16.48.2.45

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 10, 12, 7], [9, 7, 0, 7], [11, 4, 0, 11], [15, 11, 14, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["8.24.1.be.1", "16.24.0.n.2", "16.24.1.h.1"];
...
// Map from the embedded model to the plane model of modular curve with label 16.48.2.bu.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 16.48.2.bu.1
//   Coordinate number 0:
map_2_coord_0 := 1*(z);
//   Coordinate number 1:
