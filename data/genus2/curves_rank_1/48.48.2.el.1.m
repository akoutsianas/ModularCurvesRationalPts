...
// Magma code for modular curve with label 48.48.2.el.1

// Other names and/or labels
// Cummins-Pauli label: 16D2
// Rouse-Sutherland-Zureick-Brown label: 48.48.2.104

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 39, 22, 23], [21, 23, 2, 35], [21, 40, 14, 31], [33, 5, 22, 43]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.0.n.1", "24.24.1.dv.1", "48.24.1.h.2"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.2.el.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.2.el.1
//   Coordinate number 0:
map_2_coord_0 := 1*(t^2);
//   Coordinate number 1:
