...
// Magma code for modular curve with label 24.72.2.ek.1

// Other names and/or labels
// Cummins-Pauli label: 24O2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.1158

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 8, 8, 5], [3, 10, 10, 9], [7, 4, 10, 17], [17, 9, 18, 23], [19, 6, 18, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.0.cb.1", "24.36.1.gh.1", "24.36.1.gk.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.ek.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.ek.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-y);
//   Coordinate number 1:
