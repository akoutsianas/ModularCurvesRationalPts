...
// Magma code for modular curve with label 24.36.2.gj.1

// Other names and/or labels
// Cummins-Pauli label: 24C2
// Rouse-Sutherland-Zureick-Brown label: 24.36.2.49

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 8, 2, 11], [1, 8, 16, 1], [7, 9, 18, 17], [11, 6, 12, 23], [17, 10, 22, 7], [23, 21, 0, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
// Map from the embedded model to the plane model of modular curve with label 24.36.2.gj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.36.2.gj.1
//   Coordinate number 0:
