...
// Magma code for modular curve with label 24.72.2.gz.1

// Other names and/or labels
// Cummins-Pauli label: 24L2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.452

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 4, 16, 17], [11, 13, 8, 5], [13, 4, 10, 23], [17, 19, 14, 11], [17, 22, 20, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bv.1", "24.24.0.el.1", "24.36.0.cf.1", "24.36.1.gl.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.gz.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.gz.1
//   Coordinate number 0:
