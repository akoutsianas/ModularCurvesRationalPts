...
// Magma code for modular curve with label 48.48.2.ev.1

// Other names and/or labels
// Cummins-Pauli label: 16D2
// Rouse-Sutherland-Zureick-Brown label: 48.48.2.175

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 1, 22, 33], [17, 39, 14, 11], [25, 17, 24, 31], [25, 18, 36, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.1.h.1", "24.24.1.dz.1", "48.24.0.m.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.2.ev.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.2.ev.1
//   Coordinate number 0:
map_2_coord_0 := 1*(z^2);
//   Coordinate number 1:
