...
// Magma code for modular curve with label 24.72.2.t.1

// Other names and/or labels
// Cummins-Pauli label: 24O2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.1169

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 8, 8, 5], [7, 3, 18, 13], [13, 12, 6, 19], [19, 14, 22, 13], [21, 2, 16, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.0.bm.1", "24.36.1.fr.1", "24.36.1.gh.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.t.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.t.1
//   Coordinate number 0:
map_2_coord_0 := 1*(w);
//   Coordinate number 1:
