...
// Magma code for modular curve with label 24.36.2.ed.1

// Other names and/or labels
// Cummins-Pauli label: 12E2
// Rouse-Sutherland-Zureick-Brown label: 24.36.2.133

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 2, 20, 17], [9, 13, 22, 21], [9, 23, 4, 15], [21, 7, 2, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["12.18.1.g.1", "24.18.0.e.1", "24.18.1.f.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.36.2.ed.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.36.2.ed.1
//   Coordinate number 0:
