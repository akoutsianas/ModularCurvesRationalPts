...
// Magma code for modular curve with label 16.48.2.br.1

// Other names and/or labels
// Cummins-Pauli label: 16D2
// Rouse-Zureick-Brown label: X383
// Rouse-Sutherland-Zureick-Brown label: 16.48.2.28

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 12, 6, 1], [9, 8, 6, 7], [15, 0, 2, 9], [15, 13, 6, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["8.24.1.bb.1", "16.24.0.n.1", "16.24.1.h.1"];
...
// Map from the embedded model to the plane model of modular curve with label 16.48.2.br.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 16.48.2.br.1
//   Coordinate number 0:
