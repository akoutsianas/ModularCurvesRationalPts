...
// Magma code for modular curve with label 48.48.2.ba.1

// Other names and/or labels
// Cummins-Pauli label: 16D2
// Rouse-Sutherland-Zureick-Brown label: 48.48.2.24

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 17, 6, 31], [7, 9, 40, 17], [15, 10, 2, 1], [31, 15, 14, 13], [43, 39, 38, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["8.24.1.ba.1", "48.24.0.n.1", "48.24.1.e.2"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.2.ba.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.2.ba.1
//   Coordinate number 0:
map_2_coord_0 := 1*(z^2);
//   Coordinate number 1:
