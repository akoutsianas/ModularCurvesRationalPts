...
// Magma code for modular curve with label 48.48.2.t.1

// Other names and/or labels
// Cummins-Pauli label: 8B2
// Rouse-Sutherland-Zureick-Brown label: 48.48.2.33

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 2, 40, 21], [3, 1, 32, 1], [13, 28, 18, 35], [43, 24, 38, 13], [47, 20, 6, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["8.24.1.s.1", "48.24.0.l.1", "48.24.1.g.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.2.t.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.2.t.1
//   Coordinate number 0:
