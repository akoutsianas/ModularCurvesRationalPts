...
// Magma code for modular curve with label 48.48.2.by.2

// Other names and/or labels
// Cummins-Pauli label: 16C2
// Rouse-Sutherland-Zureick-Brown label: 48.48.2.161

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[27, 32, 4, 7], [35, 38, 24, 35], [45, 23, 16, 11], [47, 6, 6, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.1.e.1", "24.24.0.dd.1", "48.24.1.e.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.2.by.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.2.by.2
//   Coordinate number 0:
