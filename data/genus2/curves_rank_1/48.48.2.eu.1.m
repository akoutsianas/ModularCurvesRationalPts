...
// Magma code for modular curve with label 48.48.2.eu.1

// Other names and/or labels
// Cummins-Pauli label: 16D2
// Rouse-Sutherland-Zureick-Brown label: 48.48.2.158

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 31, 14, 15], [15, 10, 22, 29], [45, 13, 22, 15], [47, 20, 26, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.1.h.2", "24.24.1.dy.1", "48.24.0.m.2"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.2.eu.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(4*y);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.2.eu.1
//   Coordinate number 0:
map_2_coord_0 := 1*(w);
//   Coordinate number 1:
