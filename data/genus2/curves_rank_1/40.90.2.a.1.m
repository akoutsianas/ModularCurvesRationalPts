...
// Magma code for modular curve with label 40.90.2.a.1

// Other names and/or labels
// Cummins-Pauli label: 10F2
// Rouse-Sutherland-Zureick-Brown label: 40.90.2.1

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 27, 28, 19], [17, 39, 16, 23], [21, 24, 8, 9], [33, 38, 30, 37], [39, 15, 2, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 90;
...
covers := ["10.45.1.a.1", "40.30.0.a.1"];
...
// Embedded model
model_0 := [4*x^2+2*x*y-z*w-w^2-w*t,2*x^2-4*x*y+2*z*w-w^2-2*w*t,5*x*z-x*w-3*y*w-3*x*t-4*y*t,10*y^2+5*z^2-w^2-t^2];

// Singular plane model
model_1 := [40*x^6-60*x^4*z^2-2*x^2*y^2*z^2+12*x^2*y*z^3+22*x^2*z^4-y^2*z^4-2*y*z^5-z^6];
...
// Map from the embedded model to the plane model of modular curve with label 40.90.2.a.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(4*z);
...
map_1_coord_2 := 1*(w);
// Codomain equation:
map_1_codomain := [40*x^6-60*x^4*z^2-2*x^2*y^2*z^2+12*x^2*y*z^3+22*x^2*z^4-y^2*z^4-2*y*z^5-z^6];

// Map from the embedded model to the Weierstrass model of modular curve with label 40.90.2.a.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-x^2);
//   Coordinate number 1:
map_2_coord_1 := 1*(1/2*x^6+x^4*z*w-3/4*x^4*w^2+1/2*x^2*z*w^3+1/8*x^2*w^4);
//   Coordinate number 2:
map_2_coord_2 := 1*(1/2*x*w);
// Codomain equation:
