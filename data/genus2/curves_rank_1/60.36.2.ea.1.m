...
// Magma code for modular curve with label 60.36.2.ea.1

// Other names and/or labels
// Cummins-Pauli label: 12D2
// Rouse-Sutherland-Zureick-Brown label: 60.36.2.63

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 46, 58, 9], [25, 58, 46, 23], [35, 12, 33, 5], [39, 14, 7, 39]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["12.18.0.e.1", "60.18.1.c.1", "60.18.1.i.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.36.2.ea.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.36.2.ea.1
//   Coordinate number 0:
