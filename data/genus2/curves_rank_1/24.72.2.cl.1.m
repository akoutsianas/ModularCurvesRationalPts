...
// Magma code for modular curve with label 24.72.2.cl.1

// Other names and/or labels
// Cummins-Pauli label: 24O2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.1147

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 11, 14, 5], [11, 1, 22, 13], [11, 22, 22, 13], [15, 17, 8, 9], [19, 0, 6, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.0.by.1", "24.36.1.fp.1", "24.36.1.gh.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.cl.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.cl.1
//   Coordinate number 0:
map_2_coord_0 := 1*(x);
//   Coordinate number 1:
