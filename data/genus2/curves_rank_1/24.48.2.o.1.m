...
// Magma code for modular curve with label 24.48.2.o.1

// Other names and/or labels
// Cummins-Pauli label: 12G2
// Rouse-Sutherland-Zureick-Brown label: 24.48.2.23

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 15, 16, 7], [11, 15, 6, 17], [13, 6, 12, 1], [17, 0, 8, 17], [17, 18, 18, 11], [23, 15, 8, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["12.24.1.l.1", "24.12.0.bt.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.48.2.o.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.48.2.o.1
//   Coordinate number 0:
