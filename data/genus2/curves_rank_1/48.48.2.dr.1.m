...
// Magma code for modular curve with label 48.48.2.dr.1

// Other names and/or labels
// Cummins-Pauli label: 16D2
// Rouse-Sutherland-Zureick-Brown label: 48.48.2.111

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 25, 34, 29], [31, 7, 34, 45], [41, 24, 34, 31], [43, 5, 0, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.0.n.2", "24.24.1.dz.1", "48.24.1.e.2"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.2.dr.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.2.dr.1
//   Coordinate number 0:
