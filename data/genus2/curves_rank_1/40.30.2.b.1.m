...
// Magma code for modular curve with label 40.30.2.b.1

// Other names and/or labels
// Cummins-Pauli label: 10B2
// Rouse-Sutherland-Zureick-Brown label: 40.30.2.10

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 3, 32, 23], [13, 29, 32, 15], [21, 3, 34, 31], [27, 11, 28, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 30;
...
;// CM discriminants
CM_discs := [-4, -16];
// Modular curve is a fiber product of the following curvesfactors := ['5.5.0.a.1', '8.6.0.b.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["8.6.0.b.1", "10.15.1.a.1", "40.10.0.b.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.30.2.b.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.30.2.b.1
//   Coordinate number 0:
