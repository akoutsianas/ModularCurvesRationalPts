...
// Magma code for modular curve with label 48.48.2.bc.1

// Other names and/or labels
// Cummins-Pauli label: 16D2
// Rouse-Sutherland-Zureick-Brown label: 48.48.2.47

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 2, 28, 23], [7, 18, 14, 25], [13, 44, 30, 11], [41, 39, 0, 47], [47, 7, 36, 41]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["8.24.1.be.1", "48.24.0.m.1", "48.24.1.e.2"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.2.bc.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.2.bc.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-t);
//   Coordinate number 1:
