...
// Magma code for modular curve with label 48.48.2.m.1

// Other names and/or labels
// Cummins-Pauli label: 8A2
// Rouse-Sutherland-Zureick-Brown label: 48.48.2.14

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 25, 24, 13], [15, 13, 44, 17], [37, 15, 44, 11], [47, 4, 26, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["8.24.0.v.1", "48.24.1.f.2", "48.24.1.g.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.2.m.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.2.m.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-w);
//   Coordinate number 1:
