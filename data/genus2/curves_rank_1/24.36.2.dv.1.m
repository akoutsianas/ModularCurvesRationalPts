...
// Magma code for modular curve with label 24.36.2.dv.1

// Other names and/or labels
// Cummins-Pauli label: 12D2
// Rouse-Sutherland-Zureick-Brown label: 24.36.2.7

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 9, 0, 13], [11, 2, 22, 11], [11, 14, 22, 17], [13, 1, 16, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["6.18.0.d.1", "24.18.1.d.1", "24.18.1.j.1"];
...
// Embedded model
model_0 := [x*w-2*y*w-2*x*t+y*t,2*x*w+2*z*w-2*y*t-z*t,3*x^2-3*x*z+3*z^2+2*w^2-2*w*t+2*t^2,4*x^2-4*x*y+4*y^2+3*x*z];
...
// Map from the embedded model to the plane model of modular curve with label 24.36.2.dv.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.36.2.dv.1
//   Coordinate number 0:
