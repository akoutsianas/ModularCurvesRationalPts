...
// Magma code for modular curve with label 48.48.2.cu.1

// Other names and/or labels
// Cummins-Pauli label: 8B2
// Rouse-Sutherland-Zureick-Brown label: 48.48.2.100

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 42, 32, 43], [39, 19, 8, 17], [43, 44, 36, 35], [47, 37, 6, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.0.k.2", "24.24.1.de.1", "48.24.1.f.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.2.cu.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.2.cu.1
//   Coordinate number 0:
map_2_coord_0 := 1*(y^2);
//   Coordinate number 1:
