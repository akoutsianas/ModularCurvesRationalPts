...
// Magma code for modular curve with label 40.60.2.h.1

// Other names and/or labels
// Cummins-Pauli label: 20F2
// Rouse-Sutherland-Zureick-Brown label: 40.60.2.20

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 29, 8, 39], [9, 16, 12, 1], [11, 1, 30, 29], [25, 23, 12, 37], [33, 33, 2, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
// Map from the embedded model to the plane model of modular curve with label 40.60.2.h.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.60.2.h.1
//   Coordinate number 0:
