...
// Magma code for modular curve with label 48.48.2.ei.1

// Other names and/or labels
// Cummins-Pauli label: 16D2
// Rouse-Sutherland-Zureick-Brown label: 48.48.2.113

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 11, 12, 13], [21, 13, 16, 3], [37, 12, 10, 35], [39, 41, 28, 41]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.0.m.2", "24.24.1.du.1", "48.24.1.h.2"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.2.ei.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.2.ei.1
//   Coordinate number 0:
map_2_coord_0 := 1*(t^2);
//   Coordinate number 1:
