...
// Magma code for modular curve with label 48.48.2.be.1

// Other names and/or labels
// Cummins-Pauli label: 16D2
// Rouse-Sutherland-Zureick-Brown label: 48.48.2.44

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 32, 32, 11], [23, 22, 12, 43], [29, 43, 14, 23], [41, 32, 38, 15], [45, 46, 10, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["8.24.1.be.1", "48.24.0.n.1", "48.24.1.e.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.2.be.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.2.be.1
//   Coordinate number 0:
