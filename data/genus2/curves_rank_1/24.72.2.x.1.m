...
// Magma code for modular curve with label 24.72.2.x.1

// Other names and/or labels
// Cummins-Pauli label: 12I2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.551

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 19, 8, 3], [15, 8, 14, 9], [19, 2, 14, 5], [21, 4, 20, 21], [23, 12, 12, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bw.1", "24.36.0.bm.1", "24.36.1.fw.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.x.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.x.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-z);
//   Coordinate number 1:
