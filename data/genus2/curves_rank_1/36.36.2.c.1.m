...
// Magma code for modular curve with label 36.36.2.c.1

// Other names and/or labels
// Cummins-Pauli label: 18F2
// Rouse-Sutherland-Zureick-Brown label: 36.36.2.2

// Group data
level := 36;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 31, 34, 33], [6, 11, 29, 3], [21, 29, 34, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
// Map from the embedded model to the plane model of modular curve with label 36.36.2.c.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 36.36.2.c.1
//   Coordinate number 0:
