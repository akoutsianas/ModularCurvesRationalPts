...
// Magma code for modular curve with label 60.36.2.eg.1

// Other names and/or labels
// Cummins-Pauli label: 12D2
// Rouse-Sutherland-Zureick-Brown label: 60.36.2.64

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 42, 3, 5], [37, 32, 11, 29], [41, 28, 17, 29], [41, 40, 14, 59]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["12.18.0.e.1", "60.18.1.e.1", "60.18.1.h.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.36.2.eg.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.36.2.eg.1
//   Coordinate number 0:
