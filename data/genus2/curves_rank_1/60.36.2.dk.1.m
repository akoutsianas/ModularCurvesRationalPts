...
// Magma code for modular curve with label 60.36.2.dk.1

// Other names and/or labels
// Cummins-Pauli label: 12C2
// Rouse-Sutherland-Zureick-Brown label: 60.36.2.1

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 12, 18, 49], [17, 48, 30, 19], [19, 18, 39, 31], [39, 20, 26, 21], [55, 48, 57, 53]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
// Map from the embedded model to the plane model of modular curve with label 60.36.2.dk.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.36.2.dk.1
//   Coordinate number 0:
