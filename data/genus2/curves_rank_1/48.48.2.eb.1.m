...
// Magma code for modular curve with label 48.48.2.eb.1

// Other names and/or labels
// Cummins-Pauli label: 8B2
// Rouse-Sutherland-Zureick-Brown label: 48.48.2.101

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 37, 14, 17], [17, 44, 18, 47], [35, 10, 20, 15], [37, 24, 36, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.0.k.2", "24.24.1.dq.1", "48.24.1.g.2"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.2.eb.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.2.eb.1
//   Coordinate number 0:
