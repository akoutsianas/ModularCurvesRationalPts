...
// Magma code for modular curve with label 48.96.2.g.2

// Other names and/or labels
// Cummins-Pauli label: 16K2
// Rouse-Sutherland-Zureick-Brown label: 48.96.2.36

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 4, 8, 25], [17, 22, 0, 11], [23, 18, 16, 19], [23, 30, 24, 5], [31, 40, 32, 9], [39, 16, 40, 43]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
// Map from the embedded model to the plane model of modular curve with label 48.96.2.g.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.96.2.g.2
//   Coordinate number 0:
map_2_coord_0 := 1*(y+z);
//   Coordinate number 1:
