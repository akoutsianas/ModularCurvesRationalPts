...
// Magma code for modular curve with label 24.72.2.gc.1

// Other names and/or labels
// Cummins-Pauli label: 24P2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.545

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 17, 16, 7], [7, 10, 4, 11], [13, 15, 0, 7], [15, 16, 8, 3], [23, 12, 6, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bw.1", "24.36.0.ce.1", "24.36.1.gg.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.gc.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.gc.1
//   Coordinate number 0:
