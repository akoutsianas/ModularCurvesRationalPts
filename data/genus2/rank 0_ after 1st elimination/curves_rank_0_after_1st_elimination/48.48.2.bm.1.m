...
// Magma code for modular curve with label 48.48.2.bm.1

// Other names and/or labels
// Cummins-Pauli label: 8B2
// Rouse-Sutherland-Zureick-Brown label: 48.48.2.41

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 25, 32, 33], [13, 33, 20, 19], [37, 21, 26, 19], [43, 24, 10, 5], [43, 38, 22, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["8.24.1.be.1", "48.24.0.l.1", "48.24.1.f.2"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.2.bm.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(4*w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.2.bm.1
//   Coordinate number 0:
