...
// Magma code for modular curve with label 24.72.2.bh.1

// Other names and/or labels
// Cummins-Pauli label: 12I2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.139

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 8, 22, 11], [9, 13, 8, 3], [17, 22, 10, 19], [19, 19, 22, 17], [21, 14, 8, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.0.o.1", "24.36.1.fz.1", "24.36.1.gd.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.bh.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.bh.1
//   Coordinate number 0:
