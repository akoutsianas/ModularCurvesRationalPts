...
// Magma code for modular curve with label 30.40.2.c.1

// Other names and/or labels
// Cummins-Pauli label: 30D2
// Rouse-Sutherland-Zureick-Brown label: 30.40.2.3

// Group data
level := 30;
// Elements that, together with Gamma(level), generate the group
gens := [[16, 3, 9, 10], [17, 1, 18, 5], [17, 29, 9, 10]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 40;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['3.4.0.a.1', '10.10.0.b.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["10.10.0.b.1", "15.20.1.a.1", "30.8.0.a.1"];
...
// Map from the embedded model to the plane model of modular curve with label 30.40.2.c.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 30.40.2.c.1
//   Coordinate number 0:
map_2_coord_0 := 1*(x^2);
//   Coordinate number 1:
map_2_coord_1 := 1*(-x^6+1/5*x^4*z^2-3/25*x^2*z^4+3/25*x^2*z^3*w);
//   Coordinate number 2:
