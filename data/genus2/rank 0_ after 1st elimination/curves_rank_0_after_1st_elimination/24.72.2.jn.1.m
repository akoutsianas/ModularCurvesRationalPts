...
// Magma code for modular curve with label 24.72.2.jn.1

// Other names and/or labels
// Cummins-Pauli label: 24L2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.62

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 3, 18, 5], [13, 16, 2, 7], [15, 7, 4, 21], [19, 4, 16, 23], [23, 19, 20, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
;// CM discriminants
CM_discs := [-4];
// Modular curve is a fiber product of the following curvesfactors := ['3.3.0.a.1', '8.24.0.bn.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["8.24.0.bn.1", "12.36.1.bt.1", "24.36.0.ci.1", "24.36.1.gk.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.jn.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.jn.1
//   Coordinate number 0:
