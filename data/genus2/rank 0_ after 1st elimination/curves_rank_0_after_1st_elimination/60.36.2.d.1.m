...
// Magma code for modular curve with label 60.36.2.d.1

// Other names and/or labels
// Cummins-Pauli label: 12B2
// Rouse-Sutherland-Zureick-Brown label: 60.36.2.13

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 6, 42, 41], [13, 50, 4, 13], [37, 28, 50, 1], [41, 10, 40, 7], [51, 44, 50, 3], [55, 24, 12, 47]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["6.18.1.a.1", "60.12.0.b.1", "60.18.0.i.1", "60.18.1.f.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.36.2.d.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.36.2.d.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-y);
//   Coordinate number 1:
