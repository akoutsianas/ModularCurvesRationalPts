...
// Magma code for modular curve with label 60.36.2.fc.1

// Other names and/or labels
// Cummins-Pauli label: 12B2
// Rouse-Sutherland-Zureick-Brown label: 60.36.2.55

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[31, 42, 6, 23], [33, 22, 11, 15], [45, 46, 56, 27], [59, 50, 56, 49]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["12.18.0.j.1", "30.18.1.a.1", "60.12.0.bb.1", "60.18.1.e.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.36.2.fc.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.36.2.fc.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-x);
//   Coordinate number 1:
