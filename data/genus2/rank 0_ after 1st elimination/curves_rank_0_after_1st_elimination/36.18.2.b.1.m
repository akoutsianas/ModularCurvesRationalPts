...
// Magma code for modular curve with label 36.18.2.b.1

// Other names and/or labels
// Cummins-Pauli label: 18A2
// Rouse-Sutherland-Zureick-Brown label: 36.18.2.2

// Group data
level := 36;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 6, 33, 5], [21, 14, 23, 3], [34, 25, 1, 35]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 18;
...
// Map from the embedded model to the plane model of modular curve with label 36.18.2.b.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 36.18.2.b.1
//   Coordinate number 0:
