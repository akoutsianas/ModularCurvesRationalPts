...
// Magma code for modular curve with label 60.30.2.i.1

// Other names and/or labels
// Cummins-Pauli label: 20B2
// Rouse-Sutherland-Zureick-Brown label: 60.30.2.8

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 47, 28, 53], [23, 19, 12, 49], [33, 46, 8, 19], [53, 34, 34, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 30;
...
// Weierstrass model
model_2 := [-67*x^4*z^2+x^3*y-6356*x^2*z^4+x*y*z^2+y^2-216000*z^6];
...
// Map from the embedded model to the plane model of modular curve with label 60.30.2.i.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.30.2.i.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-z*w-1/2*w^2);
//   Coordinate number 1:
map_2_coord_1 := 1*(-225*y^4*w^2-15/2*y^2*z^2*w^2-41/2*y^2*z*w^3-67/8*y^2*w^4);
//   Coordinate number 2:
map_2_coord_2 := 1*(1/2*y*w);
// Codomain equation:
map_2_codomain := [-67*x^4*z^2+x^3*y-6356*x^2*z^4+x*y*z^2+y^2-216000*z^6];
