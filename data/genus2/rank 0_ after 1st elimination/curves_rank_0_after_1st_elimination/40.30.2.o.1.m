...
// Magma code for modular curve with label 40.30.2.o.1

// Other names and/or labels
// Cummins-Pauli label: 20B2
// Rouse-Sutherland-Zureick-Brown label: 40.30.2.7

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 33, 0, 13], [13, 5, 26, 9], [19, 20, 2, 31], [21, 20, 32, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 30;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['5.5.0.a.1', '8.6.0.e.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["8.6.0.e.1", "10.15.1.a.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.30.2.o.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.30.2.o.1
//   Coordinate number 0:
map_2_coord_0 := 1*(y*w+1/2*w^2);
//   Coordinate number 1:
map_2_coord_1 := 1*(-y^2*z^2*w^2-1/2*y^2*w^4-3/2*y*z^2*w^3-1/2*y*w^5-4*z^4*w^2-5/2*z^2*w^4-1/8*w^6);
//   Coordinate number 2:
map_2_coord_2 := 1*(z*w);
// Codomain equation:
