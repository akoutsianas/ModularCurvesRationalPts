...
// Magma code for modular curve with label 16.24.2.b.1

// Other names and/or labels
// Cummins-Pauli label: 16A2
// Rouse-Zureick-Brown label: X171
// Rouse-Sutherland-Zureick-Brown label: 16.24.2.4

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 3, 0, 15], [5, 7, 4, 7], [13, 6, 2, 7], [13, 7, 10, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 24;
...
// Map from the embedded model to the plane model of modular curve with label 16.24.2.b.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 16.24.2.b.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-x);
//   Coordinate number 1:
