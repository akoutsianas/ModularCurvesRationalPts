...
// Magma code for modular curve with label 24.36.2.fl.1

// Other names and/or labels
// Cummins-Pauli label: 12D2
// Rouse-Sutherland-Zureick-Brown label: 24.36.2.160

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 21, 0, 13], [5, 8, 10, 5], [15, 22, 2, 9], [23, 23, 8, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["12.18.1.e.1", "24.18.0.l.1", "24.18.1.k.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.36.2.fl.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.36.2.fl.1
//   Coordinate number 0:
map_2_coord_0 := 1*(x);
//   Coordinate number 1:
