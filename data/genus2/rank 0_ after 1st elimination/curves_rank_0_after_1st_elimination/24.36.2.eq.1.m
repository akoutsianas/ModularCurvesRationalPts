...
// Magma code for modular curve with label 24.36.2.eq.1

// Other names and/or labels
// Cummins-Pauli label: 12D2
// Rouse-Sutherland-Zureick-Brown label: 24.36.2.78

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 3, 12, 7], [13, 4, 14, 7], [19, 23, 20, 23], [21, 14, 10, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["12.18.0.e.1", "24.18.1.h.1", "24.18.1.i.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.36.2.eq.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.36.2.eq.1
//   Coordinate number 0:
