...
// Magma code for modular curve with label 24.36.2.ft.1

// Other names and/or labels
// Cummins-Pauli label: 12D2
// Rouse-Sutherland-Zureick-Brown label: 24.36.2.9

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 14, 16, 9], [11, 23, 8, 1], [13, 3, 18, 11], [15, 13, 16, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["6.18.0.d.1", "24.18.1.h.1", "24.18.1.l.1"];
...
// Embedded model
model_0 := [x*z+y*z-y*w,x^2-2*x*y+y^2-2*z^2+2*z*w-2*w^2-x*t+y*t+t^2,x*z-3*y*z-4*x*w-y*w+2*z*t-w*t,4*x^2+4*x*y+4*y^2+x*t-y*t];
...
// Map from the embedded model to the plane model of modular curve with label 24.36.2.ft.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.36.2.ft.1
//   Coordinate number 0:
