...
// Magma code for modular curve with label 24.72.2.y.1

// Other names and/or labels
// Cummins-Pauli label: 12I2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.265

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 13, 20, 19], [1, 20, 2, 11], [5, 9, 12, 19], [9, 8, 4, 9], [13, 5, 8, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bt.1", "24.36.0.bm.1", "24.36.1.gb.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.y.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.y.1
//   Coordinate number 0:
