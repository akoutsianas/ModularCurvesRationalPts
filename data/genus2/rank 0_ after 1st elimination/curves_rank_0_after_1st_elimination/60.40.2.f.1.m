...
// Magma code for modular curve with label 60.40.2.f.1

// Other names and/or labels
// Cummins-Pauli label: 30D2
// Rouse-Sutherland-Zureick-Brown label: 60.40.2.6

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 3, 57, 8], [20, 7, 51, 46], [23, 16, 24, 17], [29, 58, 0, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 40;
...
covers := ["15.20.1.a.1", "60.8.0.b.1", "60.10.0.b.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.40.2.f.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.40.2.f.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-1/3*w);
//   Coordinate number 1:
map_2_coord_1 := 1*(-5/3*y^2*z-5/3*y^2*w-1/9*z*w^2+2/27*w^3);
//   Coordinate number 2:
map_2_coord_2 := 1*(-y);
// Codomain equation:
