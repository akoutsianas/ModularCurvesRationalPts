...
// Magma code for modular curve with label 12.36.2.f.1

// Other names and/or labels
// Cummins-Pauli label: 12E2
// Rouse-Sutherland-Zureick-Brown label: 12.36.2.18

// Group data
level := 12;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 0, 6, 7], [3, 8, 10, 9], [7, 4, 4, 5], [7, 4, 8, 1], [9, 10, 4, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["6.18.1.a.1", "12.18.0.d.1", "12.18.1.i.1"];
...
// Map from the embedded model to the plane model of modular curve with label 12.36.2.f.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 12.36.2.f.1
//   Coordinate number 0:
