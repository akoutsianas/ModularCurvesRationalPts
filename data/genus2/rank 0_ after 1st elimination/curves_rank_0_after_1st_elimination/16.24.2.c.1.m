...
// Magma code for modular curve with label 16.24.2.c.1

// Other names and/or labels
// Cummins-Pauli label: 16B2
// Rouse-Zureick-Brown label: X169
// Rouse-Sutherland-Zureick-Brown label: 16.24.2.8

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 0, 0, 15], [3, 5, 2, 9], [9, 12, 0, 11], [13, 15, 14, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 24;
...
// Map from the embedded model to the plane model of modular curve with label 16.24.2.c.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 16.24.2.c.1
//   Coordinate number 0:
