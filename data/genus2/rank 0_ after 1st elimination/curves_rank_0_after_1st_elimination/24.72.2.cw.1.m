...
// Magma code for modular curve with label 24.72.2.cw.1

// Other names and/or labels
// Cummins-Pauli label: 24O2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.1162

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 11, 20, 21], [5, 15, 12, 19], [7, 11, 2, 17], [15, 4, 16, 3], [17, 13, 16, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.0.cb.1", "24.36.1.fq.1", "24.36.1.fv.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.cw.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.cw.1
//   Coordinate number 0:
