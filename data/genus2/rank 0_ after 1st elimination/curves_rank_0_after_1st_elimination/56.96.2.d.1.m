...
// Magma code for modular curve with label 56.96.2.d.1

// Other names and/or labels
// Cummins-Pauli label: 28F2
// Rouse-Sutherland-Zureick-Brown label: 56.96.2.105

// Group data
level := 56;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 49, 49, 38], [28, 53, 45, 25], [35, 33, 55, 14], [49, 8, 26, 39]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
// Map from the embedded model to the plane model of modular curve with label 56.96.2.d.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 56.96.2.d.1
//   Coordinate number 0:
