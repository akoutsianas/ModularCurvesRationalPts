...
// Magma code for modular curve with label 16.48.2.bn.1

// Other names and/or labels
// Cummins-Pauli label: 8B2
// Rouse-Zureick-Brown label: X360
// Rouse-Sutherland-Zureick-Brown label: 16.48.2.40

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 3, 14, 9], [9, 2, 2, 15], [9, 4, 14, 15], [11, 10, 6, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["8.24.1.be.1", "16.24.0.l.2", "16.24.1.g.1"];
...
// Map from the embedded model to the plane model of modular curve with label 16.48.2.bn.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(4*z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 16.48.2.bn.1
//   Coordinate number 0:
map_2_coord_0 := 1*(y^2);
//   Coordinate number 1:
