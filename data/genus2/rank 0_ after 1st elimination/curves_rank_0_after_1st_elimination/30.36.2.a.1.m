...
// Magma code for modular curve with label 30.36.2.a.1

// Other names and/or labels
// Cummins-Pauli label: 30C2
// Rouse-Sutherland-Zureick-Brown label: 30.36.2.4

// Group data
level := 30;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 20, 7, 13], [14, 15, 27, 28], [14, 25, 23, 17], [23, 5, 17, 28]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
// Map from the embedded model to the plane model of modular curve with label 30.36.2.a.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 30.36.2.a.1
//   Coordinate number 0:
