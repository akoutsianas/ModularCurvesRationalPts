...
// Magma code for modular curve with label 24.36.2.dh.1

// Other names and/or labels
// Cummins-Pauli label: 12D2
// Rouse-Sutherland-Zureick-Brown label: 24.36.2.102

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 17, 4, 7], [3, 2, 20, 9], [5, 9, 0, 19], [13, 18, 12, 13], [15, 23, 16, 9], [19, 17, 4, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["12.18.1.c.1", "24.18.0.h.1", "24.18.1.l.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.36.2.dh.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.36.2.dh.1
//   Coordinate number 0:
map_2_coord_0 := 1*(z);
//   Coordinate number 1:
