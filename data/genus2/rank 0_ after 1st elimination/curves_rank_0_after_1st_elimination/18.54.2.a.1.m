...
// Magma code for modular curve with label 18.54.2.a.1

// Other names and/or labels
// Cummins-Pauli label: 18J2
// Rouse-Sutherland-Zureick-Brown label: 18.54.2.1

// Group data
level := 18;
// Elements that, together with Gamma(level), generate the group
gens := [[2, 13, 5, 17], [16, 7, 1, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 54;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['2.2.0.a.1', '9.27.0.a.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["2.2.0.a.1", "9.27.0.a.1"];
...
// Map from the embedded model to the plane model of modular curve with label 18.54.2.a.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 18.54.2.a.1
//   Coordinate number 0:
