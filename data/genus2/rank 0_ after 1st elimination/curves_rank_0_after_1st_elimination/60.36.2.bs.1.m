...
// Magma code for modular curve with label 60.36.2.bs.1

// Other names and/or labels
// Cummins-Pauli label: 12D2
// Rouse-Sutherland-Zureick-Brown label: 60.36.2.135

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[21, 20, 26, 51], [35, 24, 33, 37], [37, 34, 56, 13], [39, 22, 1, 45]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["12.18.1.e.1", "30.18.0.c.1", "60.18.1.g.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.36.2.bs.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.36.2.bs.1
//   Coordinate number 0:
