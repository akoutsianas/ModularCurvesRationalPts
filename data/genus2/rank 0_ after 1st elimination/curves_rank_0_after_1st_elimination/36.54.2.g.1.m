...
// Magma code for modular curve with label 36.54.2.g.1

// Other names and/or labels
// Cummins-Pauli label: 36B2
// Rouse-Sutherland-Zureick-Brown label: 36.54.2.8

// Group data
level := 36;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 7, 14, 3], [7, 34, 10, 15], [23, 31, 10, 13], [25, 24, 2, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 54;
...
covers := ["12.18.0.i.1", "18.27.1.a.1"];
...
// Weierstrass model
model_2 := [5*x^4*z^2+x^3*y-20*x^2*z^4+x*y*z^2+y^2+108*z^6];
...
// Map from the embedded model to the plane model of modular curve with label 36.54.2.g.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 36.54.2.g.1
//   Coordinate number 0:
map_2_coord_0 := 1*(y);
//   Coordinate number 1:
map_2_coord_1 := 1*(1/3*x*z^2-5/9*y*z^2);
//   Coordinate number 2:
map_2_coord_2 := 1*(1/3*z);
// Codomain equation:
map_2_codomain := [5*x^4*z^2+x^3*y-20*x^2*z^4+x*y*z^2+y^2+108*z^6];
