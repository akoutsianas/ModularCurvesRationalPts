...
// Magma code for modular curve with label 24.72.2.fr.1

// Other names and/or labels
// Cummins-Pauli label: 24P2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.535

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 10, 4, 23], [17, 7, 10, 7], [17, 22, 2, 11], [21, 5, 10, 3], [23, 18, 18, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bz.1", "24.36.0.cf.1", "24.36.1.fu.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.fr.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.fr.1
//   Coordinate number 0:
