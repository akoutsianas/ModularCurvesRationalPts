...
// Magma code for modular curve with label 24.36.2.ez.1

// Other names and/or labels
// Cummins-Pauli label: 12E2
// Rouse-Sutherland-Zureick-Brown label: 24.36.2.24

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 13, 2, 7], [3, 4, 14, 9], [13, 6, 12, 19], [13, 15, 18, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["6.18.1.b.1", "24.18.0.j.1", "24.18.1.k.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.36.2.ez.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.36.2.ez.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-x);
//   Coordinate number 1:
