...
// Magma code for modular curve with label 12.36.2.bp.1

// Other names and/or labels
// Cummins-Pauli label: 12E2
// Rouse-Sutherland-Zureick-Brown label: 12.36.2.42

// Group data
level := 12;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 7, 4, 11], [1, 8, 2, 5], [9, 2, 8, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["12.18.0.g.1", "12.18.1.d.1", "12.18.1.j.1"];
...
// Map from the embedded model to the plane model of modular curve with label 12.36.2.bp.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 12.36.2.bp.1
//   Coordinate number 0:
