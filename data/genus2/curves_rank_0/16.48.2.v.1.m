...
// Magma code for modular curve with label 16.48.2.v.1

// Other names and/or labels
// Cummins-Pauli label: 16D2
// Rouse-Sutherland-Zureick-Brown label: 16.48.2.38

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 10, 6, 11], [1, 15, 4, 7], [13, 9, 8, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["8.24.1.bf.1", "16.24.0.m.2", "16.24.1.e.1"];
...
// Map from the embedded model to the plane model of modular curve with label 16.48.2.v.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 16.48.2.v.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-z);
//   Coordinate number 1:
