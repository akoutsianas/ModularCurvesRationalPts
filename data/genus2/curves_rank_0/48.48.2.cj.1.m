...
// Magma code for modular curve with label 48.48.2.cj.1

// Other names and/or labels
// Cummins-Pauli label: 8A2
// Rouse-Sutherland-Zureick-Brown label: 48.48.2.144

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[21, 47, 16, 7], [23, 4, 22, 1], [29, 10, 4, 33], [39, 2, 8, 43]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.1.g.1", "24.24.0.cz.1", "48.24.1.f.2"];
...
// Embedded model
model_0 := [3*x*z+x*t-2*y*t+w*t,2*x*z-4*y*z-2*z*w-x*t,2*x^2-2*x*y+2*y^2+6*z^2-t^2,3*x^2-6*x*y+6*y^2-6*z^2-2*w^2+t^2];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.2.cj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.2.cj.1
//   Coordinate number 0:
