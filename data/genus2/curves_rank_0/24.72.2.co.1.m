...
// Magma code for modular curve with label 24.72.2.co.1

// Other names and/or labels
// Cummins-Pauli label: 24O2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.1157

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 0, 18, 23], [3, 7, 20, 9], [7, 1, 20, 13], [7, 3, 6, 1], [7, 19, 16, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.0.cb.1", "24.36.1.fo.1", "24.36.1.ft.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.co.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.co.1
//   Coordinate number 0:
