...
// Magma code for modular curve with label 56.96.2.f.1

// Other names and/or labels
// Cummins-Pauli label: 28F2
// Rouse-Sutherland-Zureick-Brown label: 56.96.2.108

// Group data
level := 56;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 10, 48, 23], [13, 54, 38, 1], [28, 33, 23, 33], [42, 55, 13, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
//   Coordinate number 1:
map_0_coord_1 := 2^10*((9*z-5*w)^2*(z^3-2*z^2*w-z*w^2+w^3)^4*(z^3+5*z^2*w-8*z*w^2+w^3)^2);

// Map from the embedded model to the plane model of modular curve with label 56.96.2.f.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 56.96.2.f.1
//   Coordinate number 0:
