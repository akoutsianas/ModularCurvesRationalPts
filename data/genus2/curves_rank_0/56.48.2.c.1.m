...
// Magma code for modular curve with label 56.48.2.c.1

// Other names and/or labels
// Cummins-Pauli label: 14E2
// Rouse-Sutherland-Zureick-Brown label: 56.48.2.17

// Group data
level := 56;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 1, 48, 37], [35, 46, 20, 37], [37, 31, 18, 5], [43, 41, 8, 7], [53, 15, 10, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['7.8.0.a.1', '8.6.0.b.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["8.6.0.b.1", "14.24.1.a.1", "56.16.0.b.1"];
...
// Map from the embedded model to the plane model of modular curve with label 56.48.2.c.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 56.48.2.c.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-2/7*y^4+1/7*y^3*z+4*y^2*w^2-10/7*y*z*w^2-2/7*z^2*w^2-4*w^4);
//   Coordinate number 1:
map_2_coord_1 := 1*(-2*y^10*w^2+y^9*z*w^2+92/7*y^8*w^4-130/7*y^7*z*w^4-2*y^6*z^2*w^4-172/7*y^6*w^6+76*y^5*z*w^6+64/7*y^4*z^2*w^6+144/7*y^4*w^8-792/7*y^3*z*w^8-88/7*y^2*z^2*w^8-48*y^2*w^10+384/7*y*z*w^10+32/7*z^2*w^10+64*w^12);
//   Coordinate number 2:
