...
// Magma code for modular curve with label 24.72.2.ht.1

// Other names and/or labels
// Cummins-Pauli label: 24L2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.450

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 10, 20, 17], [9, 22, 22, 15], [11, 8, 8, 19], [15, 2, 20, 15], [15, 13, 14, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bv.1", "24.24.0.er.1", "24.36.0.ci.1", "24.36.1.fr.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.ht.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.ht.1
//   Coordinate number 0:
map_2_coord_0 := 1*(x);
//   Coordinate number 1:
