...
// Magma code for modular curve with label 24.72.2.fx.1

// Other names and/or labels
// Cummins-Pauli label: 24P2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.1132

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 21, 0, 23], [7, 13, 2, 13], [9, 1, 4, 3], [11, 9, 18, 13], [21, 1, 14, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.0.ce.1", "24.36.1.gd.1", "24.36.1.gf.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.fx.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.fx.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-z);
//   Coordinate number 1:
