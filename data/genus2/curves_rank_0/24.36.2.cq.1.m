...
// Magma code for modular curve with label 24.36.2.cq.1

// Other names and/or labels
// Cummins-Pauli label: 24D2
// Rouse-Sutherland-Zureick-Brown label: 24.36.2.85

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 0, 0, 7], [11, 5, 20, 1], [13, 12, 0, 17], [19, 22, 20, 13], [21, 1, 8, 21], [23, 3, 0, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
// Map from the embedded model to the plane model of modular curve with label 24.36.2.cq.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.36.2.cq.1
//   Coordinate number 0:
