...
// Magma code for modular curve with label 48.48.2.o.1

// Other names and/or labels
// Cummins-Pauli label: 16C2
// Rouse-Sutherland-Zureick-Brown label: 48.48.2.17

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 44, 40, 15], [11, 26, 40, 5], [43, 25, 4, 45], [47, 2, 40, 9], [47, 31, 36, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
// Map from the embedded model to the plane model of modular curve with label 48.48.2.o.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.2.o.1
//   Coordinate number 0:
