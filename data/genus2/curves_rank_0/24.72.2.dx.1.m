...
// Magma code for modular curve with label 24.72.2.dx.1

// Other names and/or labels
// Cummins-Pauli label: 12I2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.526

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 2, 20, 1], [9, 10, 22, 3], [15, 1, 4, 9], [17, 21, 6, 11], [19, 21, 18, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.by.1", "24.36.0.cb.1", "24.36.1.fx.1"];
...
// Embedded model
model_0 := [x*w+y*w-z*w+z*t,2*x^2+2*x*y+2*y^2+3*z^2+2*w^2,2*x^2+2*x*y+2*y^2-3*x*z-3*y*z-3*z^2-2*w*t,x^2+4*x*y+y^2+6*x*z+6*y*z-3*z^2-2*t^2];

// Singular plane model
model_1 := [792*x^6+144*x^5*y+36*x^4*y^2+156*x^4*z^2-12*x^2*y^2*z^2+10*x^2*z^4-4*x*y*z^4+y^2*z^4+z^6];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.dx.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
...
map_1_coord_2 := 1*(2*w);
// Codomain equation:
map_1_codomain := [792*x^6+144*x^5*y+36*x^4*y^2+156*x^4*z^2-12*x^2*y^2*z^2+10*x^2*z^4-4*x*y*z^4+y^2*z^4+z^6];

// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.dx.1
//   Coordinate number 0:
