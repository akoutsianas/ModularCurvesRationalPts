...
// Magma code for modular curve with label 24.72.2.jb.1

// Other names and/or labels
// Cummins-Pauli label: 24P2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.1125

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 1, 22, 23], [1, 18, 12, 17], [3, 19, 4, 9], [5, 23, 16, 11], [17, 4, 4, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.0.cj.1", "24.36.1.gd.1", "24.36.1.gg.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.jb.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.jb.1
//   Coordinate number 0:
map_2_coord_0 := 1*(z);
//   Coordinate number 1:
