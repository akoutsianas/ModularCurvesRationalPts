...
// Magma code for modular curve with label 40.60.2.c.1

// Other names and/or labels
// Cummins-Pauli label: 10D2
// Rouse-Sutherland-Zureick-Brown label: 40.60.2.26

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[15, 3, 18, 5], [29, 4, 20, 11], [29, 14, 0, 1], [39, 10, 10, 19], [39, 18, 22, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["10.30.1.a.1", "40.20.0.c.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.60.2.c.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.60.2.c.1
//   Coordinate number 0:
