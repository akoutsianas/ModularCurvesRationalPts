...
// Magma code for modular curve with label 24.72.2.hn.1

// Other names and/or labels
// Cummins-Pauli label: 24Q2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.1110

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 16, 20, 19], [1, 21, 6, 11], [7, 21, 6, 23], [11, 14, 20, 19], [19, 8, 4, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.hn.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.hn.1
//   Coordinate number 0:
map_2_coord_0 := 1*(1/2*t);
//   Coordinate number 1:
map_2_coord_1 := 1*(3/2*y*w*t+3/2*w*t^2);
//   Coordinate number 2:
