...
// Magma code for modular curve with label 48.24.2.b.1

// Other names and/or labels
// Cummins-Pauli label: 16B2
// Rouse-Sutherland-Zureick-Brown label: 48.24.2.7

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 19, 22, 17], [5, 20, 40, 45], [11, 22, 36, 37], [27, 47, 10, 27], [45, 38, 4, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 24;
...
// Map from the embedded model to the plane model of modular curve with label 48.24.2.b.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.24.2.b.1
//   Coordinate number 0:
