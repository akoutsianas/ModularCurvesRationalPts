...
// Magma code for modular curve with label 24.72.2.iw.1

// Other names and/or labels
// Cummins-Pauli label: 24P2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.517

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 2, 20, 17], [3, 13, 14, 9], [7, 5, 16, 1], [17, 9, 12, 7], [19, 11, 20, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.by.1", "24.36.0.ci.1", "24.36.1.gg.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.iw.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.iw.1
//   Coordinate number 0:
map_2_coord_0 := 1*(x);
//   Coordinate number 1:
