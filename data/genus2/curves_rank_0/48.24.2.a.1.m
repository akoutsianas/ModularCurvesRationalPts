...
// Magma code for modular curve with label 48.24.2.a.1

// Other names and/or labels
// Cummins-Pauli label: 16B2
// Rouse-Sutherland-Zureick-Brown label: 48.24.2.6

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 44, 0, 19], [35, 24, 32, 25], [41, 27, 6, 23], [43, 24, 8, 13], [43, 42, 20, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 24;
...
// Map from the embedded model to the plane model of modular curve with label 48.24.2.a.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.24.2.a.1
//   Coordinate number 0:
