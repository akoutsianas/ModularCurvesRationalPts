...
// Magma code for modular curve with label 40.90.2.b.1

// Other names and/or labels
// Cummins-Pauli label: 10F2
// Rouse-Sutherland-Zureick-Brown label: 40.90.2.4

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[21, 15, 8, 9], [21, 39, 20, 33], [27, 38, 0, 11], [31, 11, 18, 29], [37, 29, 20, 39]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 90;
...
covers := ["10.45.1.a.1", "40.30.0.b.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.90.2.b.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(4*z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.90.2.b.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-x^2);
//   Coordinate number 1:
