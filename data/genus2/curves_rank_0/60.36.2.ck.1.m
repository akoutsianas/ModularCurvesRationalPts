...
// Magma code for modular curve with label 60.36.2.ck.1

// Other names and/or labels
// Cummins-Pauli label: 12B2
// Rouse-Sutherland-Zureick-Brown label: 60.36.2.130

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 8, 56, 49], [17, 10, 17, 53], [31, 40, 52, 11], [57, 52, 35, 51]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["12.18.1.f.1", "30.18.1.b.1", "60.12.0.w.1", "60.18.0.k.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.36.2.ck.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.36.2.ck.1
//   Coordinate number 0:
