...
// Magma code for modular curve with label 24.36.2.cr.1

// Other names and/or labels
// Cummins-Pauli label: 24D2
// Rouse-Sutherland-Zureick-Brown label: 24.36.2.90

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 22, 20, 9], [5, 7, 4, 13], [13, 1, 4, 11], [13, 4, 16, 23], [13, 15, 12, 17], [17, 15, 0, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
// Map from the embedded model to the plane model of modular curve with label 24.36.2.cr.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.36.2.cr.1
//   Coordinate number 0:
