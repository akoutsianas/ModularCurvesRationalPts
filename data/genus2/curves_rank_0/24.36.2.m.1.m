...
// Magma code for modular curve with label 24.36.2.m.1

// Other names and/or labels
// Cummins-Pauli label: 12E2
// Rouse-Sutherland-Zureick-Brown label: 24.36.2.132

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 7, 2, 3], [21, 4, 4, 15], [21, 5, 20, 21], [23, 8, 22, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["12.18.1.g.1", "24.18.0.j.1", "24.18.1.a.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.36.2.m.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.36.2.m.1
//   Coordinate number 0:
