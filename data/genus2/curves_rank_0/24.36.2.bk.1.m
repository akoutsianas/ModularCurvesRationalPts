...
// Magma code for modular curve with label 24.36.2.bk.1

// Other names and/or labels
// Cummins-Pauli label: 12E2
// Rouse-Sutherland-Zureick-Brown label: 24.36.2.114

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 7, 14, 1], [17, 23, 20, 7], [21, 2, 16, 21], [23, 4, 14, 23], [23, 11, 4, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["12.18.1.a.1", "24.18.0.f.1", "24.18.1.l.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.36.2.bk.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.36.2.bk.1
//   Coordinate number 0:
