...
// Magma code for modular curve with label 60.36.2.dg.1

// Other names and/or labels
// Cummins-Pauli label: 12D2
// Rouse-Sutherland-Zureick-Brown label: 60.36.2.95

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[21, 26, 35, 27], [35, 6, 33, 53], [35, 16, 38, 5], [35, 48, 21, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["12.18.1.i.1", "30.18.0.c.1", "60.18.1.b.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.36.2.dg.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.36.2.dg.1
//   Coordinate number 0:
