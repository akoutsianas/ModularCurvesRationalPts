...
// Magma code for modular curve with label 40.60.2.b.1

// Other names and/or labels
// Cummins-Pauli label: 10D2
// Rouse-Sutherland-Zureick-Brown label: 40.60.2.28

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 34, 6, 3], [21, 2, 38, 9], [33, 5, 2, 37], [35, 4, 24, 15], [35, 31, 24, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["10.30.1.a.1", "40.20.0.b.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.60.2.b.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.60.2.b.1
//   Coordinate number 0:
