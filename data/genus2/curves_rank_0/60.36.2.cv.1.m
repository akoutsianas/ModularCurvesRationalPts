...
// Magma code for modular curve with label 60.36.2.cv.1

// Other names and/or labels
// Cummins-Pauli label: 12E2
// Rouse-Sutherland-Zureick-Brown label: 60.36.2.122

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[31, 22, 16, 23], [37, 54, 30, 41], [41, 30, 45, 53], [49, 44, 58, 55]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["12.18.1.h.1", "30.18.1.b.1", "60.18.0.c.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.36.2.cv.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.36.2.cv.1
//   Coordinate number 0:
