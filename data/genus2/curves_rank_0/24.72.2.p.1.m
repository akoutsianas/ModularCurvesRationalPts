...
// Magma code for modular curve with label 24.72.2.p.1

// Other names and/or labels
// Cummins-Pauli label: 24O2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.1175

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 23, 10, 1], [13, 2, 4, 1], [13, 20, 2, 11], [19, 17, 10, 1], [23, 9, 0, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.0.bp.1", "24.36.1.fr.1", "24.36.1.fs.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.p.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.p.1
//   Coordinate number 0:
map_2_coord_0 := 1*(w);
//   Coordinate number 1:
