...
// Magma code for modular curve with label 60.36.2.ci.1

// Other names and/or labels
// Cummins-Pauli label: 12B2
// Rouse-Sutherland-Zureick-Brown label: 60.36.2.139

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 54, 21, 5], [37, 28, 41, 43], [43, 14, 29, 35], [49, 16, 4, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["12.18.1.e.1", "60.12.0.u.1", "60.18.0.k.1", "60.18.1.d.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.36.2.ci.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.36.2.ci.1
//   Coordinate number 0:
