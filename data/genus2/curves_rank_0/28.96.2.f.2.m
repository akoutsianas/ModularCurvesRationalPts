...
// Magma code for modular curve with label 28.96.2.f.2

// Other names and/or labels
// Cummins-Pauli label: 28F2
// Rouse-Sutherland-Zureick-Brown label: 28.96.2.40

// Group data
level := 28;
// Elements that, together with Gamma(level), generate the group
gens := [[15, 3, 7, 24], [19, 8, 4, 9], [19, 16, 24, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
// Map from the embedded model to the plane model of modular curve with label 28.96.2.f.2
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 28.96.2.f.2
//   Coordinate number 0:
