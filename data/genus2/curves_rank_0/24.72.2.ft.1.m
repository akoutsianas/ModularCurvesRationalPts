...
// Magma code for modular curve with label 24.72.2.ft.1

// Other names and/or labels
// Cummins-Pauli label: 24P2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.1141

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 7, 8, 1], [9, 5, 14, 3], [13, 19, 16, 11], [19, 8, 10, 13], [21, 2, 2, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.0.cf.1", "24.36.1.fv.1", "24.36.1.gd.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.ft.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.ft.1
//   Coordinate number 0:
map_2_coord_0 := 1*(z);
//   Coordinate number 1:
