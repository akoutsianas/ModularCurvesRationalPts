...
// Magma code for modular curve with label 24.72.2.fz.1

// Other names and/or labels
// Cummins-Pauli label: 24P2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.1139

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 22, 16, 3], [7, 5, 10, 13], [11, 2, 10, 5], [13, 9, 18, 19], [15, 20, 14, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.0.cf.1", "24.36.1.gd.1", "24.36.1.ge.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.fz.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.fz.1
//   Coordinate number 0:
map_2_coord_0 := 1*(z);
//   Coordinate number 1:
map_2_coord_1 := 1*(-3/4*x*y*z);
//   Coordinate number 2:
