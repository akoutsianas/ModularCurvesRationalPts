...
// Magma code for modular curve with label 48.48.2.cs.1

// Other names and/or labels
// Cummins-Pauli label: 16D2
// Rouse-Sutherland-Zureick-Brown label: 48.48.2.166

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 9, 36, 7], [21, 23, 26, 19], [25, 22, 44, 45], [37, 17, 40, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.1.e.1", "24.24.1.dy.1", "48.24.0.n.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.2.cs.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(4*y);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.2.cs.1
//   Coordinate number 0:
map_2_coord_0 := 1*(w);
//   Coordinate number 1:
