...
// Magma code for modular curve with label 24.72.2.ho.2

// Other names and/or labels
// Cummins-Pauli label: 24M2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.1067

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 13, 14, 9], [11, 3, 2, 19], [15, 2, 8, 5], [19, 11, 2, 9], [23, 6, 0, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.24.0.en.2", "24.36.0.cg.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.ho.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.ho.2
//   Coordinate number 0:
map_2_coord_0 := 1*(-y);
//   Coordinate number 1:
