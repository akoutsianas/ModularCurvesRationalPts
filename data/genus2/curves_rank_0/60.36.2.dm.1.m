...
// Magma code for modular curve with label 60.36.2.dm.1

// Other names and/or labels
// Cummins-Pauli label: 12E2
// Rouse-Sutherland-Zureick-Brown label: 60.36.2.98

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[21, 2, 22, 3], [37, 16, 7, 5], [39, 58, 35, 33], [53, 52, 47, 41]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["12.18.1.i.1", "30.18.1.b.1", "60.18.0.g.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.36.2.dm.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.36.2.dm.1
//   Coordinate number 0:
map_2_coord_0 := 1*(y);
//   Coordinate number 1:
