...
// Magma code for modular curve with label 16.48.2.b.1

// Other names and/or labels
// Cummins-Pauli label: 8A2
// Rouse-Zureick-Brown label: X398
// Rouse-Sutherland-Zureick-Brown label: 16.48.2.3

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 12, 2, 15], [3, 0, 6, 13], [3, 2, 2, 5], [15, 4, 10, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["8.24.0.a.1", "16.24.1.g.1", "16.24.1.g.2"];
...
// Map from the embedded model to the plane model of modular curve with label 16.48.2.b.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 16.48.2.b.1
//   Coordinate number 0:
