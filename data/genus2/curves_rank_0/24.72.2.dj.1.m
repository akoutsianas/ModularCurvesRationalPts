...
// Magma code for modular curve with label 24.72.2.dj.1

// Other names and/or labels
// Cummins-Pauli label: 12I2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.146

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 23, 16, 19], [15, 10, 22, 21], [19, 21, 18, 5], [23, 10, 8, 11], [23, 10, 10, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.0.s.1", "24.36.1.fx.1", "24.36.1.gd.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.dj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.dj.1
//   Coordinate number 0:
