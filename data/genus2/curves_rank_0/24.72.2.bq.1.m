...
// Magma code for modular curve with label 24.72.2.bq.1

// Other names and/or labels
// Cummins-Pauli label: 12I2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.472

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 22, 8, 13], [5, 4, 2, 11], [15, 5, 8, 9], [21, 11, 20, 15], [23, 5, 4, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bu.1", "24.36.0.bp.1", "24.36.1.gd.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.bq.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.bq.1
//   Coordinate number 0:
