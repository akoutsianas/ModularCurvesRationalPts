...
// Magma code for modular curve with label 60.36.2.bq.1

// Other names and/or labels
// Cummins-Pauli label: 12E2
// Rouse-Sutherland-Zureick-Brown label: 60.36.2.147

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[39, 22, 10, 33], [55, 4, 38, 13], [57, 8, 19, 3], [57, 28, 43, 45]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["12.18.1.d.1", "60.18.0.c.1", "60.18.1.g.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.36.2.bq.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.36.2.bq.1
//   Coordinate number 0:
