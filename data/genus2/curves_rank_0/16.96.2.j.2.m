...
// Magma code for modular curve with label 16.96.2.j.2

// Other names and/or labels
// Cummins-Pauli label: 16J2
// Rouse-Zureick-Brown label: X516
// Rouse-Sutherland-Zureick-Brown label: 16.96.2.124

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 7, 0, 3], [7, 10, 0, 3], [7, 12, 0, 5], [15, 6, 0, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
// Map from the embedded model to the plane model of modular curve with label 16.96.2.j.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 16.96.2.j.2
//   Coordinate number 0:
map_2_coord_0 := 1*(y);
//   Coordinate number 1:
