...
// Magma code for modular curve with label 24.36.2.fr.1

// Other names and/or labels
// Cummins-Pauli label: 12D2
// Rouse-Sutherland-Zureick-Brown label: 24.36.2.152

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 10, 2, 13], [15, 2, 2, 15], [17, 12, 12, 11], [21, 5, 16, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["12.18.1.f.1", "24.18.0.l.1", "24.18.1.l.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.36.2.fr.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.36.2.fr.1
//   Coordinate number 0:
