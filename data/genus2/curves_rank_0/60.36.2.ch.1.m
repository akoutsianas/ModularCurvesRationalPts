...
// Magma code for modular curve with label 60.36.2.ch.1

// Other names and/or labels
// Cummins-Pauli label: 12B2
// Rouse-Sutherland-Zureick-Brown label: 60.36.2.143

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 50, 19, 29], [21, 2, 43, 33], [31, 16, 1, 17], [31, 28, 47, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["12.18.1.d.1", "60.12.0.t.1", "60.18.0.l.1", "60.18.1.f.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.36.2.ch.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.36.2.ch.1
//   Coordinate number 0:
