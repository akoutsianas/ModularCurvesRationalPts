...
// Magma code for modular curve with label 24.72.2.hv.1

// Other names and/or labels
// Cummins-Pauli label: 24L2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.456

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 12, 18, 7], [7, 21, 18, 17], [9, 14, 20, 9], [19, 2, 4, 19], [23, 1, 8, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bv.1", "24.24.0.et.1", "24.36.0.cj.1", "24.36.1.fq.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.hv.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.hv.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-x);
//   Coordinate number 1:
