...
// Magma code for modular curve with label 18.36.2.a.1

// Other names and/or labels
// Cummins-Pauli label: 18F2
// Rouse-Sutherland-Zureick-Brown label: 18.36.2.3

// Group data
level := 18;
// Elements that, together with Gamma(level), generate the group
gens := [[8, 15, 9, 1], [12, 5, 1, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['2.2.0.a.1', '9.18.0.a.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["6.12.1.b.1", "9.18.0.a.1"];
...
// Map from the embedded model to the plane model of modular curve with label 18.36.2.a.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 18.36.2.a.1
//   Coordinate number 0:
