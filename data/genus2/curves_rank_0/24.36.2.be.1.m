...
// Magma code for modular curve with label 24.36.2.be.1

// Other names and/or labels
// Cummins-Pauli label: 12E2
// Rouse-Sutherland-Zureick-Brown label: 24.36.2.111

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 4, 22, 17], [7, 3, 12, 1], [17, 12, 18, 1], [17, 17, 22, 5], [23, 21, 0, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["12.18.1.a.1", "24.18.0.i.1", "24.18.1.i.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.36.2.be.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.36.2.be.1
//   Coordinate number 0:
