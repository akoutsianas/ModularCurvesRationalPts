...
// Magma code for modular curve with label 24.36.2.e.1

// Other names and/or labels
// Cummins-Pauli label: 12E2
// Rouse-Sutherland-Zureick-Brown label: 24.36.2.17

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 2, 22, 7], [1, 18, 18, 17], [5, 2, 10, 17], [9, 4, 22, 15], [15, 22, 14, 21], [23, 14, 22, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["6.18.1.a.1", "24.18.0.e.1", "24.18.1.l.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.36.2.e.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.36.2.e.1
//   Coordinate number 0:
