...
// Magma code for modular curve with label 40.36.2.a.2

// Other names and/or labels
// Cummins-Pauli label: 20C2
// Rouse-Sutherland-Zureick-Brown label: 40.36.2.2

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 36, 14, 17], [11, 5, 0, 1], [13, 8, 30, 21], [25, 4, 24, 15], [33, 0, 16, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
// Map from the embedded model to the plane model of modular curve with label 40.36.2.a.2
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.36.2.a.2
//   Coordinate number 0:
map_2_coord_0 := 1*(1/5*z*w+1/5*w^2);
//   Coordinate number 1:
map_2_coord_1 := 1*(1/20*y*z^3*w^2-3/20*y*z^2*w^3-1/5*y*z*w^4);
//   Coordinate number 2:
map_2_coord_2 := 1*(-1/10*z*w+2/5*w^2);
// Codomain equation:
