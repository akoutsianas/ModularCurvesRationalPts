...
// Magma code for modular curve with label 24.72.2.ib.1

// Other names and/or labels
// Cummins-Pauli label: 24P2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.530

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 19, 2, 15], [11, 23, 4, 17], [17, 22, 14, 23], [19, 22, 4, 11], [23, 5, 22, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bz.1", "24.36.0.ci.1", "24.36.1.ft.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.ib.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.ib.1
//   Coordinate number 0:
map_2_coord_0 := 1*(x);
//   Coordinate number 1:
