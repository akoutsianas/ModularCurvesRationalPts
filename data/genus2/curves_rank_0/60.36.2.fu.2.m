...
// Magma code for modular curve with label 60.36.2.fu.2

// Other names and/or labels
// Cummins-Pauli label: 30C2
// Rouse-Sutherland-Zureick-Brown label: 60.36.2.151

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[22, 25, 53, 4], [24, 25, 1, 48], [33, 35, 22, 3], [51, 5, 34, 57], [58, 45, 3, 14]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
// Map from the embedded model to the plane model of modular curve with label 60.36.2.fu.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.36.2.fu.2
//   Coordinate number 0:
map_2_coord_0 := 1*(y+w);
//   Coordinate number 1:
