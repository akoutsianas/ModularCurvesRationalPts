...
// Magma code for modular curve with label 24.72.2.ce.1

// Other names and/or labels
// Cummins-Pauli label: 24O2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.116

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 23, 20, 11], [5, 18, 0, 5], [7, 0, 18, 5], [15, 2, 22, 9], [17, 7, 4, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.0.p.1", "24.36.1.gg.1", "24.36.1.gi.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.ce.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(x);
