...
// Magma code for modular curve with label 12.36.2.bk.1

// Other names and/or labels
// Cummins-Pauli label: 12C2
// Rouse-Sutherland-Zureick-Brown label: 12.36.2.5

// Group data
level := 12;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 11, 4, 3], [9, 4, 8, 3], [9, 7, 2, 9], [11, 6, 0, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
// Map from the embedded model to the plane model of modular curve with label 12.36.2.bk.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 12.36.2.bk.1
//   Coordinate number 0:
map_2_coord_0 := 1*(1/2*y+1/6*w);
//   Coordinate number 1:
map_2_coord_1 := 1*(-1/12*y*z*w-1/12*z*w^2);
//   Coordinate number 2:
map_2_coord_2 := 1*(-1/2*y+1/6*w);
// Codomain equation:
