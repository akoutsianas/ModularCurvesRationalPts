...
// Magma code for modular curve with label 24.36.2.ex.1

// Other names and/or labels
// Cummins-Pauli label: 12E2
// Rouse-Sutherland-Zureick-Brown label: 24.36.2.123

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 19, 2, 21], [11, 0, 0, 7], [11, 18, 12, 17], [13, 5, 8, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["12.18.1.j.1", "24.18.0.i.1", "24.18.1.e.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.36.2.ex.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.36.2.ex.1
//   Coordinate number 0:
