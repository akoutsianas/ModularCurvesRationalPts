...
// Magma code for modular curve with label 24.72.2.it.1

// Other names and/or labels
// Cummins-Pauli label: 24P2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.1123

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 16, 20, 1], [17, 8, 20, 13], [17, 9, 6, 7], [19, 8, 14, 17], [21, 10, 8, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.0.cj.1", "24.36.1.gb.1", "24.36.1.ge.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.it.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.it.1
//   Coordinate number 0:
map_2_coord_0 := 1*(y);
//   Coordinate number 1:
map_2_coord_1 := 1*(1/4*x*y*z-y^3);
//   Coordinate number 2:
