...
// Magma code for modular curve with label 48.48.2.p.1

// Other names and/or labels
// Cummins-Pauli label: 16C2
// Rouse-Sutherland-Zureick-Brown label: 48.48.2.23

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[25, 3, 20, 47], [27, 7, 34, 9], [37, 2, 40, 13], [41, 26, 40, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["8.24.0.z.1", "48.24.1.h.1", "48.24.1.h.2"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.2.p.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(4*w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.2.p.1
//   Coordinate number 0:
