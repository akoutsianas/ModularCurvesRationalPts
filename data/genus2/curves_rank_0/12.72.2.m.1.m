...
// Magma code for modular curve with label 12.72.2.m.1

// Other names and/or labels
// Cummins-Pauli label: 12I2
// Rouse-Sutherland-Zureick-Brown label: 12.72.2.50

// Group data
level := 12;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 1, 8, 7], [1, 5, 2, 11], [5, 2, 4, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.0.s.1", "12.36.1.bu.1", "12.36.1.bw.1"];
...
// Embedded model
model_0 := [x*z+x*w-x*t-y*t,3*x^2+2*z*w+t^2,3*x*y+2*z*w-z*t-w*t-t^2,3*y^2-z^2-w^2-2*z*t-2*w*t+t^2];

// Singular plane model
model_1 := [9*x^4-6*x^2*y^2+12*x^2*y*z+2*y^2*z^2+4*y*z^3-z^4];
...
// Map from the embedded model to the plane model of modular curve with label 12.72.2.m.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
...
map_1_coord_2 := 1*(t);
// Codomain equation:
map_1_codomain := [9*x^4-6*x^2*y^2+12*x^2*y*z+2*y^2*z^2+4*y*z^3-z^4];

// Map from the embedded model to the Weierstrass model of modular curve with label 12.72.2.m.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-1/2*x+1/2*t);
//   Coordinate number 1:
map_2_coord_1 := 1*(3/2*x^2*w-3/2*x^2*t-1/2*w*t^2-1/2*t^3);
//   Coordinate number 2:
