...
// Magma code for modular curve with label 16.48.2.bl.1

// Other names and/or labels
// Cummins-Pauli label: 8B2
// Rouse-Zureick-Brown label: X362
// Rouse-Sutherland-Zureick-Brown label: 16.48.2.43

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 8, 8, 9], [11, 0, 10, 5], [13, 2, 4, 1], [15, 11, 14, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["8.24.1.be.1", "16.24.0.k.2", "16.24.1.g.2"];
...
// Map from the embedded model to the plane model of modular curve with label 16.48.2.bl.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 16.48.2.bl.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-y*z);
//   Coordinate number 1:
