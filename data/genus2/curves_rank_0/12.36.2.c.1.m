...
// Magma code for modular curve with label 12.36.2.c.1

// Other names and/or labels
// Cummins-Pauli label: 12B2
// Rouse-Sutherland-Zureick-Brown label: 12.36.2.15

// Group data
level := 12;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 10, 10, 11], [3, 2, 2, 7], [5, 10, 4, 1], [7, 6, 0, 7], [11, 10, 6, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["6.18.1.a.1", "12.12.0.a.1", "12.18.0.j.1", "12.18.1.e.1"];
...
// Map from the embedded model to the plane model of modular curve with label 12.36.2.c.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 12.36.2.c.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-y);
//   Coordinate number 1:
