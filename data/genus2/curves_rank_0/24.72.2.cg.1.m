...
// Magma code for modular curve with label 24.72.2.cg.1

// Other names and/or labels
// Cummins-Pauli label: 24O2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.1174

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 18, 0, 17], [3, 22, 2, 21], [7, 22, 10, 5], [17, 11, 2, 7], [21, 17, 20, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.0.bp.1", "24.36.1.gf.1", "24.36.1.gk.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.cg.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.cg.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-z);
//   Coordinate number 1:
