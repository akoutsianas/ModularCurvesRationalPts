...
// Magma code for modular curve with label 24.72.2.eg.1

// Other names and/or labels
// Cummins-Pauli label: 24O2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.1161

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 0, 6, 17], [7, 9, 6, 13], [17, 1, 14, 11], [23, 4, 10, 1], [23, 5, 16, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.0.cb.1", "24.36.1.gf.1", "24.36.1.gi.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.eg.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.eg.1
//   Coordinate number 0:
map_2_coord_0 := 1*(w);
//   Coordinate number 1:
