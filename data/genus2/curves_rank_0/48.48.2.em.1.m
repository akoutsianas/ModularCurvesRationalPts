...
// Magma code for modular curve with label 48.48.2.em.1

// Other names and/or labels
// Cummins-Pauli label: 16D2
// Rouse-Sutherland-Zureick-Brown label: 48.48.2.114

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 19, 28, 47], [3, 25, 46, 45], [19, 8, 44, 15], [45, 1, 8, 43]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.0.m.2", "24.24.1.dy.1", "48.24.1.h.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.2.em.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.2.em.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-y);
//   Coordinate number 1:
