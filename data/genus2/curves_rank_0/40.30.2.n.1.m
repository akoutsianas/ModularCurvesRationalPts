...
// Magma code for modular curve with label 40.30.2.n.1

// Other names and/or labels
// Cummins-Pauli label: 20B2
// Rouse-Sutherland-Zureick-Brown label: 40.30.2.12

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 22, 34, 1], [19, 6, 15, 13], [27, 24, 32, 23], [35, 34, 19, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 30;
...
// Map from the embedded model to the plane model of modular curve with label 40.30.2.n.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(4*z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.30.2.n.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-z*w+1/8*w^2);
//   Coordinate number 1:
map_2_coord_1 := 1*(25/16*y^4*w^2-5/4*y^2*z^2*w^2+11/32*y^2*z*w^3-23/128*y^2*w^4+1/8*z^2*w^4-1/32*z*w^5+1/512*w^6);
//   Coordinate number 2:
