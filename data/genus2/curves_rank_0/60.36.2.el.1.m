...
// Magma code for modular curve with label 60.36.2.el.1

// Other names and/or labels
// Cummins-Pauli label: 12E2
// Rouse-Sutherland-Zureick-Brown label: 60.36.2.51

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 2, 5, 29], [7, 58, 10, 23], [23, 2, 58, 5], [55, 4, 46, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["12.18.0.g.1", "30.18.1.a.1", "60.18.1.g.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.36.2.el.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(6*t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.36.2.el.1
//   Coordinate number 0:
