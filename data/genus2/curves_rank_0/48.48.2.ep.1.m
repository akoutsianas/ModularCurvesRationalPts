...
// Magma code for modular curve with label 48.48.2.ep.1

// Other names and/or labels
// Cummins-Pauli label: 16D2
// Rouse-Sutherland-Zureick-Brown label: 48.48.2.107

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 6, 12, 37], [5, 25, 20, 27], [5, 40, 22, 7], [29, 32, 20, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.0.n.1", "24.24.1.dz.1", "48.24.1.h.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.2.ep.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.2.ep.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-y);
//   Coordinate number 1:
