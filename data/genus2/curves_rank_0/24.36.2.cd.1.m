...
// Magma code for modular curve with label 24.36.2.cd.1

// Other names and/or labels
// Cummins-Pauli label: 12B2
// Rouse-Sutherland-Zureick-Brown label: 24.36.2.22

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 1, 16, 19], [15, 14, 22, 15], [21, 16, 8, 21], [23, 9, 14, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["6.18.1.b.1", "24.12.0.t.1", "24.18.0.m.1", "24.18.1.d.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.36.2.cd.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.36.2.cd.1
//   Coordinate number 0:
