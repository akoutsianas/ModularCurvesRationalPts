...
// Magma code for modular curve with label 16.48.2.i.1

// Other names and/or labels
// Cummins-Pauli label: 16C2
// Rouse-Zureick-Brown label: X368
// Rouse-Sutherland-Zureick-Brown label: 16.48.2.17

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 15, 4, 7], [5, 13, 8, 9], [11, 6, 8, 11], [15, 9, 8, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
// Map from the embedded model to the plane model of modular curve with label 16.48.2.i.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 16.48.2.i.1
//   Coordinate number 0:
