...
// Magma code for modular curve with label 32.96.2.l.2

// Other names and/or labels
// Cummins-Pauli label: 32C2
// Rouse-Zureick-Brown label: X530
// Rouse-Sutherland-Zureick-Brown label: 32.96.2.36

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 26, 16, 25], [5, 2, 0, 7], [15, 4, 0, 15], [25, 22, 0, 15], [25, 25, 16, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
// Map from the embedded model to the plane model of modular curve with label 32.96.2.l.2
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 32.96.2.l.2
//   Coordinate number 0:
map_2_coord_0 := 1*(z^2);
//   Coordinate number 1:
