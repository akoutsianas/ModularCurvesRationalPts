...
// Magma code for modular curve with label 48.48.2.eo.1

// Other names and/or labels
// Cummins-Pauli label: 16D2
// Rouse-Sutherland-Zureick-Brown label: 48.48.2.110

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 37, 20, 29], [13, 29, 32, 35], [13, 41, 20, 27], [47, 20, 6, 41]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.0.n.2", "24.24.1.dy.1", "48.24.1.h.2"];
...
// Embedded model
model_0 := [x*y+y^2-t^2,2*y*z+w*t,x*w+y*w+2*z*t,3*x^2-3*x*y-8*z^2+w^2-3*t^2];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.2.eo.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.2.eo.1
//   Coordinate number 0:
