...
// Magma code for modular curve with label 12.36.2.n.1

// Other names and/or labels
// Cummins-Pauli label: 12E2
// Rouse-Sutherland-Zureick-Brown label: 12.36.2.41

// Group data
level := 12;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 4, 10, 5], [1, 7, 4, 11], [3, 11, 8, 9], [5, 6, 6, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["12.18.0.g.1", "12.18.1.a.1", "12.18.1.h.1"];
...
// Map from the embedded model to the plane model of modular curve with label 12.36.2.n.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 12.36.2.n.1
//   Coordinate number 0:
