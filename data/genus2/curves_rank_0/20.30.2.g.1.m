...
// Magma code for modular curve with label 20.30.2.g.1

// Other names and/or labels
// Cummins-Pauli label: 20A2
// Rouse-Sutherland-Zureick-Brown label: 20.30.2.9

// Group data
level := 20;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 18, 9, 11], [13, 6, 8, 17], [17, 4, 2, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 30;
...
// Map from the embedded model to the plane model of modular curve with label 20.30.2.g.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 20.30.2.g.1
//   Coordinate number 0:
map_2_coord_0 := 1*(1/2*x-1/2*y);
//   Coordinate number 1:
map_2_coord_1 := 1*(3/8*x^3+35/8*x^2*y+5/2*x^2*w+1/8*x*y^2+1/8*y^3-1/2*y^2*w);
//   Coordinate number 2:
map_2_coord_2 := 1*(-x);
// Codomain equation:
