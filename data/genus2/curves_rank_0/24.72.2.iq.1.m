...
// Magma code for modular curve with label 24.72.2.iq.1

// Other names and/or labels
// Cummins-Pauli label: 24P2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.1122

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 18, 12, 5], [5, 0, 18, 23], [5, 2, 4, 5], [7, 9, 0, 5], [19, 7, 20, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.0.ci.1", "24.36.1.ga.1", "24.36.1.gf.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.iq.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.iq.1
//   Coordinate number 0:
map_2_coord_0 := 1*(x);
//   Coordinate number 1:
