...
// Magma code for modular curve with label 56.48.2.d.1

// Other names and/or labels
// Cummins-Pauli label: 28D2
// Rouse-Sutherland-Zureick-Brown label: 56.48.2.14

// Group data
level := 56;
// Elements that, together with Gamma(level), generate the group
gens := [[15, 45, 14, 23], [27, 15, 40, 45], [39, 40, 42, 43], [49, 16, 54, 51], [53, 49, 54, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['7.8.0.a.1', '8.6.0.c.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["8.6.0.c.1", "14.24.1.a.1"];
...
// Map from the embedded model to the plane model of modular curve with label 56.48.2.d.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 56.48.2.d.1
//   Coordinate number 0:
map_2_coord_0 := 1*(w^2);
//   Coordinate number 1:
