...
// Magma code for modular curve with label 24.72.2.im.1

// Other names and/or labels
// Cummins-Pauli label: 24P2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.1130

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 22, 2, 7], [3, 7, 22, 21], [7, 14, 20, 23], [11, 2, 4, 11], [17, 4, 20, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.0.cj.1", "24.36.1.fv.1", "24.36.1.ga.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.im.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.im.1
//   Coordinate number 0:
map_2_coord_0 := 1*(z);
//   Coordinate number 1:
