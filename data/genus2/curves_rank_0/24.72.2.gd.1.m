...
// Magma code for modular curve with label 24.72.2.gd.1

// Other names and/or labels
// Cummins-Pauli label: 24P2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.509

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 19, 2, 15], [13, 20, 14, 23], [15, 7, 4, 9], [17, 1, 22, 19], [19, 23, 22, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bx.1", "24.36.0.ce.1", "24.36.1.gg.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.gd.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.gd.1
//   Coordinate number 0:
map_2_coord_0 := 1*(x);
//   Coordinate number 1:
