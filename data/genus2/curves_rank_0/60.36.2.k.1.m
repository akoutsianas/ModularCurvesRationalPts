...
// Magma code for modular curve with label 60.36.2.k.1

// Other names and/or labels
// Cummins-Pauli label: 12E2
// Rouse-Sutherland-Zureick-Brown label: 60.36.2.93

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[31, 32, 58, 55], [41, 48, 18, 53], [43, 20, 19, 13], [49, 10, 37, 29], [51, 10, 20, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["12.18.1.a.1", "60.18.0.f.1", "60.18.1.g.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.36.2.k.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.36.2.k.1
//   Coordinate number 0:
