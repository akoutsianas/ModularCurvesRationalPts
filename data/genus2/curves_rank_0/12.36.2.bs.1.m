...
// Magma code for modular curve with label 12.36.2.bs.1

// Other names and/or labels
// Cummins-Pauli label: 12D2
// Rouse-Sutherland-Zureick-Brown label: 12.36.2.49

// Group data
level := 12;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 0, 6, 5], [7, 7, 2, 7], [11, 8, 10, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["12.18.0.h.1", "12.18.1.f.1", "12.18.1.i.1"];
...
// Map from the embedded model to the plane model of modular curve with label 12.36.2.bs.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 12.36.2.bs.1
//   Coordinate number 0:
