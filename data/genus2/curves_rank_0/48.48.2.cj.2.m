...
// Magma code for modular curve with label 48.48.2.cj.2

// Other names and/or labels
// Cummins-Pauli label: 8A2
// Rouse-Sutherland-Zureick-Brown label: 48.48.2.120

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 26, 10, 35], [11, 47, 40, 5], [29, 35, 36, 11], [41, 42, 22, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.1.g.2", "24.24.0.cz.1", "48.24.1.f.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.2.cj.2
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.2.cj.2
//   Coordinate number 0:
