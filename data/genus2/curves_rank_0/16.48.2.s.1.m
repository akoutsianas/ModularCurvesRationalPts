...
// Magma code for modular curve with label 16.48.2.s.1

// Other names and/or labels
// Cummins-Pauli label: 16D2
// Rouse-Zureick-Brown label: X387
// Rouse-Sutherland-Zureick-Brown label: 16.48.2.24

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 9, 10, 11], [11, 11, 6, 9], [15, 1, 8, 1], [15, 14, 2, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["8.24.1.ba.1", "16.24.0.n.1", "16.24.1.e.2"];
...
// Map from the embedded model to the plane model of modular curve with label 16.48.2.s.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 16.48.2.s.1
//   Coordinate number 0:
map_2_coord_0 := 1*(t^2);
//   Coordinate number 1:
