...
// Magma code for modular curve with label 48.48.2.a.1

// Other names and/or labels
// Cummins-Pauli label: 8A2
// Rouse-Sutherland-Zureick-Brown label: 48.48.2.3

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 10, 30, 25], [7, 30, 46, 17], [15, 14, 14, 47], [35, 12, 40, 29], [39, 14, 22, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["8.24.0.a.1", "48.24.1.f.1", "48.24.1.f.2"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.2.a.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.2.a.1
//   Coordinate number 0:
