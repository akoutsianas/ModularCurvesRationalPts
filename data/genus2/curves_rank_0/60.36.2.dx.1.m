...
// Magma code for modular curve with label 60.36.2.dx.1

// Other names and/or labels
// Cummins-Pauli label: 12E2
// Rouse-Sutherland-Zureick-Brown label: 60.36.2.46

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 40, 43, 51], [47, 50, 35, 1], [49, 6, 9, 5], [49, 20, 55, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["12.18.0.d.1", "60.18.1.a.1", "60.18.1.j.1"];
...
// Embedded model
model_0 := [y*z+x*w,4*x*z-y*w+z*t,4*x^2+y^2+x*t,4*x^2-3*y^2+20*z^2+5*w^2-7*x*t+t^2];
...
// Map from the embedded model to the plane model of modular curve with label 60.36.2.dx.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.36.2.dx.1
//   Coordinate number 0:
