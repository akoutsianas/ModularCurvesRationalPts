...
// Magma code for modular curve with label 24.72.2.o.1

// Other names and/or labels
// Cummins-Pauli label: 24O2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.1178

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 19, 20, 11], [7, 7, 14, 13], [9, 20, 20, 9], [15, 13, 20, 21], [17, 10, 4, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.0.bp.1", "24.36.1.fq.1", "24.36.1.ft.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.o.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.o.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-w);
//   Coordinate number 1:
