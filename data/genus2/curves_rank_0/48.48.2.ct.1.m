...
// Magma code for modular curve with label 48.48.2.ct.1

// Other names and/or labels
// Cummins-Pauli label: 16D2
// Rouse-Sutherland-Zureick-Brown label: 48.48.2.183

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[23, 16, 42, 5], [35, 27, 4, 5], [41, 10, 16, 33], [43, 42, 38, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.1.e.2", "24.24.1.dz.1", "48.24.0.n.2"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.2.ct.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.2.ct.1
//   Coordinate number 0:
map_2_coord_0 := 1*(z^2);
//   Coordinate number 1:
