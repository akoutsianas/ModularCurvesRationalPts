...
// Magma code for modular curve with label 24.72.2.bd.1

// Other names and/or labels
// Cummins-Pauli label: 12I2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.539

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 6, 18, 13], [11, 15, 6, 13], [17, 6, 18, 11], [17, 7, 16, 7], [19, 15, 12, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bz.1", "24.36.0.bm.1", "24.36.1.fz.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.bd.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.bd.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-z);
//   Coordinate number 1:
