...
// Magma code for modular curve with label 60.36.2.da.1

// Other names and/or labels
// Cummins-Pauli label: 12D2
// Rouse-Sutherland-Zureick-Brown label: 60.36.2.118

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[39, 32, 47, 3], [43, 14, 23, 35], [49, 46, 52, 5], [59, 52, 53, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["12.18.1.g.1", "60.18.0.e.1", "60.18.1.f.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.36.2.da.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.36.2.da.1
//   Coordinate number 0:
