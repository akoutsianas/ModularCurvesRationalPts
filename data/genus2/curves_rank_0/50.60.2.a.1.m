...
// Magma code for modular curve with label 50.60.2.a.1

// Other names and/or labels
// Cummins-Pauli label: 50A2
// Rouse-Sutherland-Zureick-Brown label: 50.60.2.1

// Group data
level := 50;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 47, 22, 45], [41, 12, 11, 45]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["10.12.0.a.2", "25.30.0.a.1"];
...
// Embedded model
model_0 := [3*y^3+y^2*z+y*z^2-y^2*w-z^2*w-2*y*w^2-z*w^2,3*y^3+y^2*z+y*z^2+2*y^2*w+y*z*w,3*y^2*z+y*z^2+z^3+2*y*z*w+z^2*w,3*x*y^2+x*y*z+x*z^2+2*x*y*w+x*z*w,x^2*y+2*y^3-y^2*z+4*y*z^2-5*y^2*w-2*y*z*w-z^2*w+8*y*w^2+4*z*w^2,x^2*y-y^3+x^2*z+2*y*z^2+4*z^3+x^2*w+y^2*w-4*y*z*w+4*z^2*w-5*y*w^2+10*z*w^2];

// Singular plane model
model_1 := [11*x^4+10*x^2*y^2+7*x^3*z+5*x*y^2*z+9*x^2*z^2+3*x*z^3+z^4];
...
// Map from the embedded model to the plane model of modular curve with label 50.60.2.a.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
map_1_coord_2 := 1*(z);
// Codomain equation:
map_1_codomain := [11*x^4+10*x^2*y^2+7*x^3*z+5*x*y^2*z+9*x^2*z^2+3*x*z^3+z^4];

// Map from the embedded model to the Weierstrass model of modular curve with label 50.60.2.a.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-3/5*y+1/5*z);
//   Coordinate number 1:
map_2_coord_1 := 1*(-2/25*x*y^2-1/25*x*y*z);
//   Coordinate number 2:
