...
// Magma code for modular curve with label 24.72.2.bo.1

// Other names and/or labels
// Cummins-Pauli label: 12I2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.266

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 8, 16, 13], [3, 19, 10, 9], [7, 15, 12, 5], [13, 5, 2, 23], [13, 21, 12, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bt.1", "24.36.0.bp.1", "24.36.1.ga.1"];
...
// Embedded model
model_0 := [y*z+x*w-2*y*w+x*t,2*x*y-2*y^2-z*w+w^2+z*t+t^2,2*x^2-2*y^2+z^2-w^2+2*z*t-2*w*t+t^2,2*x*y+4*y^2-z*w-z*t-2*w*t-2*t^2];

// Singular plane model
model_1 := [2*x^2*y^4-3*y^6-4*x^3*y^2*z+12*x*y^4*z+2*x^4*z^2-20*x^2*y^2*z^2+12*y^4*z^2+12*x^3*z^3-32*x*y^2*z^3+26*x^2*z^4-16*y^2*z^4+24*x*z^5+8*z^6];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.bo.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
...
map_1_coord_2 := 1*(t);
// Codomain equation:
map_1_codomain := [2*x^2*y^4-3*y^6-4*x^3*y^2*z+12*x*y^4*z+2*x^4*z^2-20*x^2*y^2*z^2+12*y^4*z^2+12*x^3*z^3-32*x*y^2*z^3+26*x^2*z^4-16*y^2*z^4+24*x*z^5+8*z^6];

// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.bo.1
//   Coordinate number 0:
