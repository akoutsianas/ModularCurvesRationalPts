...
// Magma code for modular curve with label 16.48.2.bf.1

// Other names and/or labels
// Cummins-Pauli label: 8B2
// Rouse-Sutherland-Zureick-Brown label: 16.48.2.49

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 6, 6, 5], [3, 14, 12, 7], [7, 15, 4, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["8.24.1.u.1", "16.24.0.l.1", "16.24.1.g.2"];
...
// Map from the embedded model to the plane model of modular curve with label 16.48.2.bf.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 16.48.2.bf.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-y*z);
//   Coordinate number 1:
