...
// Magma code for modular curve with label 24.72.2.gh.1

// Other names and/or labels
// Cummins-Pauli label: 24P2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.1143

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 23, 20, 5], [9, 10, 2, 15], [13, 14, 10, 7], [17, 9, 18, 23], [23, 16, 14, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.0.cf.1", "24.36.1.gb.1", "24.36.1.gg.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.gh.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.gh.1
//   Coordinate number 0:
