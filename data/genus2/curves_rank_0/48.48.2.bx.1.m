...
// Magma code for modular curve with label 48.48.2.bx.1

// Other names and/or labels
// Cummins-Pauli label: 16C2
// Rouse-Sutherland-Zureick-Brown label: 48.48.2.162

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 13, 8, 27], [5, 26, 20, 33], [5, 37, 44, 35], [11, 5, 2, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.1.e.1", "24.24.0.cv.1", "48.24.1.h.2"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.2.bx.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.2.bx.1
//   Coordinate number 0:
