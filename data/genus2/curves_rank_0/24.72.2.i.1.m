...
// Magma code for modular curve with label 24.72.2.i.1

// Other names and/or labels
// Cummins-Pauli label: 24O2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.137

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 18, 0, 1], [5, 8, 22, 23], [9, 19, 4, 3], [13, 3, 0, 23], [15, 14, 8, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.0.o.1", "24.36.1.fo.1", "24.36.1.gf.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.i.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(4*w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.i.1
//   Coordinate number 0:
