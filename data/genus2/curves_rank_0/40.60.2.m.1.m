...
// Magma code for modular curve with label 40.60.2.m.1

// Other names and/or labels
// Cummins-Pauli label: 10E2
// Rouse-Sutherland-Zureick-Brown label: 40.60.2.30

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 28, 4, 11], [21, 7, 36, 39], [23, 24, 6, 27], [25, 18, 2, 37], [31, 39, 36, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["10.30.1.a.1", "40.20.0.g.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.60.2.m.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
map_1_coord_1 := 1*(5*y);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.60.2.m.1
//   Coordinate number 0:
