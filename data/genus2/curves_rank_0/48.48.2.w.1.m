...
// Magma code for modular curve with label 48.48.2.w.1

// Other names and/or labels
// Cummins-Pauli label: 8B2
// Rouse-Sutherland-Zureick-Brown label: 48.48.2.48

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 46, 28, 27], [9, 1, 10, 11], [19, 36, 16, 35], [25, 16, 38, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["8.24.1.u.1", "48.24.0.l.2", "48.24.1.f.1"];
...
// Embedded model
model_0 := [y*z-x*t,3*y^2+w*t,3*x*y+z*w,96*x^2-16*z^2-w^2-4*w*t-2*t^2];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.2.w.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(4*z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.2.w.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-t);
//   Coordinate number 1:
map_2_coord_1 := 1*(24*y^2*z-4*z*t^2);
//   Coordinate number 2:
map_2_coord_2 := 1*(-y);
// Codomain equation:
