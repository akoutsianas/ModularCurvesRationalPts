...
// Magma code for modular curve with label 56.48.2.m.1

// Other names and/or labels
// Cummins-Pauli label: 14E2
// Rouse-Sutherland-Zureick-Brown label: 56.48.2.20

// Group data
level := 56;
// Elements that, together with Gamma(level), generate the group
gens := [[15, 19, 48, 15], [21, 17, 6, 11], [37, 0, 20, 47], [51, 33, 44, 35], [55, 18, 28, 47]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["14.24.1.a.1", "56.6.0.b.1", "56.16.0.d.1"];
...
// Map from the embedded model to the plane model of modular curve with label 56.48.2.m.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 56.48.2.m.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-y^3*z-14*y*z^3);
//   Coordinate number 1:
map_2_coord_1 := 1*(-110/343*y^10*z^2+55/343*y^9*z^2*w-332/49*y^8*z^4+562/49*y^7*z^4*w+524/7*y^6*z^6+26/49*y^6*z^4*w^2+1972/7*y^5*z^6*w+2112*y^4*z^8+136/7*y^4*z^6*w^2+2904*y^3*z^8*w+2352*y^2*z^10+232*y^2*z^8*w^2+10752*y*z^10*w-87808*z^12+896*z^10*w^2);
//   Coordinate number 2:
