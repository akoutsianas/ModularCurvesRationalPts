...
// Magma code for modular curve with label 24.72.2.c.1

// Other names and/or labels
// Cummins-Pauli label: 24N2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.158

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 11, 2, 19], [9, 14, 8, 15], [13, 16, 22, 23], [13, 19, 22, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.c.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.c.1
//   Coordinate number 0:
