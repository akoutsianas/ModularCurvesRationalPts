...
// Magma code for modular curve with label 24.72.2.bp.1

// Other names and/or labels
// Cummins-Pauli label: 12I2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.552

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 11, 16, 23], [7, 5, 22, 1], [9, 17, 20, 3], [17, 10, 16, 13], [21, 5, 22, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bw.1", "24.36.0.bp.1", "24.36.1.fx.1"];
...
// Embedded model
model_0 := [x*z-y*z-z*t+w*t,2*x*y+2*z^2-t^2,2*x*y-2*z*w+x*t-y*t+t^2,x^2+y^2+2*w^2+2*x*t-2*y*t-t^2];

// Singular plane model
model_1 := [x^4+x^2*y^2+4*x^2*y*z+2*y^2*z^2-8*y*z^3-4*z^4];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.bp.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
...
// Codomain equation:
map_1_codomain := [x^4+x^2*y^2+4*x^2*y*z+2*y^2*z^2-8*y*z^3-4*z^4];

// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.bp.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-z);
//   Coordinate number 1:
