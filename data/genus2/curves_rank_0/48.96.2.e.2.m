...
// Magma code for modular curve with label 48.96.2.e.2

// Other names and/or labels
// Cummins-Pauli label: 16K2
// Rouse-Sutherland-Zureick-Brown label: 48.96.2.38

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[15, 2, 32, 13], [17, 12, 8, 7], [17, 38, 16, 11], [25, 38, 0, 37], [33, 44, 8, 5], [39, 28, 16, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
// Map from the embedded model to the plane model of modular curve with label 48.96.2.e.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.96.2.e.2
//   Coordinate number 0:
map_2_coord_0 := 1*(-y+z);
//   Coordinate number 1:
