...
// Magma code for modular curve with label 16.48.2.bb.1

// Other names and/or labels
// Cummins-Pauli label: 8B2
// Rouse-Zureick-Brown label: X365
// Rouse-Sutherland-Zureick-Brown label: 16.48.2.33

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 3, 8, 1], [3, 5, 10, 9], [7, 6, 8, 11], [13, 4, 6, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["8.24.1.s.1", "16.24.0.l.1", "16.24.1.g.1"];
...
// Map from the embedded model to the plane model of modular curve with label 16.48.2.bb.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 16.48.2.bb.1
//   Coordinate number 0:
