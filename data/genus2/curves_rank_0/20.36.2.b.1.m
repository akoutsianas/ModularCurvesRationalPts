...
// Magma code for modular curve with label 20.36.2.b.1

// Other names and/or labels
// Cummins-Pauli label: 20C2
// Rouse-Sutherland-Zureick-Brown label: 20.36.2.3

// Group data
level := 20;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 5, 10, 1], [5, 2, 8, 15], [7, 0, 18, 3], [7, 12, 18, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
// Map from the embedded model to the plane model of modular curve with label 20.36.2.b.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(5*y);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 20.36.2.b.1
//   Coordinate number 0:
