...
// Magma code for modular curve with label 24.72.2.ig.1

// Other names and/or labels
// Cummins-Pauli label: 24P2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.1121

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 5, 22, 21], [5, 3, 12, 11], [13, 2, 4, 13], [13, 8, 14, 11], [17, 14, 2, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.0.ci.1", "24.36.1.fu.1", "24.36.1.ga.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.ig.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.ig.1
//   Coordinate number 0:
map_2_coord_0 := 1*(x);
//   Coordinate number 1:
