...
// Magma code for modular curve with label 48.48.2.df.1

// Other names and/or labels
// Cummins-Pauli label: 8B2
// Rouse-Sutherland-Zureick-Brown label: 48.48.2.150

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 46, 26, 31], [15, 13, 46, 13], [31, 17, 20, 33], [35, 26, 2, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.1.g.1", "24.24.1.dg.1", "48.24.0.k.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.2.df.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.2.df.1
//   Coordinate number 0:
