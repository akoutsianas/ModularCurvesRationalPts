...
// Magma code for modular curve with label 24.36.2.du.1

// Other names and/or labels
// Cummins-Pauli label: 12D2
// Rouse-Sutherland-Zureick-Brown label: 24.36.2.144

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 7, 16, 17], [5, 11, 22, 5], [5, 23, 8, 7], [19, 21, 0, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["12.18.1.h.1", "24.18.0.l.1", "24.18.1.d.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.36.2.du.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(6*z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.36.2.du.1
//   Coordinate number 0:
