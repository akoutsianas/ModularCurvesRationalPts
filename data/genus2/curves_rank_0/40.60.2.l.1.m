...
// Magma code for modular curve with label 40.60.2.l.1

// Other names and/or labels
// Cummins-Pauli label: 20F2
// Rouse-Sutherland-Zureick-Brown label: 40.60.2.19

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 1, 24, 33], [25, 19, 14, 35], [29, 23, 14, 31], [33, 29, 16, 39], [35, 23, 8, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
// Map from the embedded model to the plane model of modular curve with label 40.60.2.l.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.60.2.l.1
//   Coordinate number 0:
map_2_coord_0 := 1*(1/5*x^2*z+1/250*z^3);
//   Coordinate number 1:
map_2_coord_1 := 1*(7/5*x^8*z-2/5*x^8*t+1/10*x^6*z^3-12/125*x^6*z^2*t+33/12500*x^4*z^5-13/3125*x^4*z^4*t+19/625000*x^2*z^7-1/15625*x^2*z^6*t+1/7812500*z^9-1/3125000*z^8*t);
//   Coordinate number 2:
