...
// Magma code for modular curve with label 24.36.2.fs.1

// Other names and/or labels
// Cummins-Pauli label: 12D2
// Rouse-Sutherland-Zureick-Brown label: 24.36.2.128

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 11, 8, 5], [17, 16, 10, 13], [21, 22, 8, 15], [23, 16, 14, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["12.18.1.j.1", "24.18.0.l.1", "24.18.1.h.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.36.2.fs.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.36.2.fs.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-z^2*t+1/6*t^3);
//   Coordinate number 1:
map_2_coord_1 := 1*(6*z^8*w-5*z^6*w*t^2+1/2*z^6*t^3+5/3*z^4*w*t^4-1/4*z^4*t^5-1/4*z^2*w*t^6+1/24*z^2*t^7+1/72*w*t^8-1/432*t^9);
//   Coordinate number 2:
