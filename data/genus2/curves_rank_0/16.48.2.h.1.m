...
// Magma code for modular curve with label 16.48.2.h.1

// Other names and/or labels
// Cummins-Pauli label: 16C2
// Rouse-Zureick-Brown label: X378
// Rouse-Sutherland-Zureick-Brown label: 16.48.2.11

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 7, 4, 3], [7, 11, 8, 1], [11, 2, 0, 3], [15, 4, 12, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["8.24.0.x.1", "16.24.1.e.1", "16.24.1.e.2"];
...
// Map from the embedded model to the plane model of modular curve with label 16.48.2.h.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 16.48.2.h.1
//   Coordinate number 0:
