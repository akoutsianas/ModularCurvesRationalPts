...
// Magma code for modular curve with label 24.72.2.gl.1

// Other names and/or labels
// Cummins-Pauli label: 24L2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.260

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 7, 14, 7], [1, 12, 18, 23], [3, 13, 20, 21], [15, 8, 10, 21], [23, 5, 14, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bt.1", "24.24.0.dx.1", "24.36.0.ce.1", "24.36.1.gi.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.gl.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.gl.1
//   Coordinate number 0:
