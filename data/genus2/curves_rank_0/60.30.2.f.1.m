...
// Magma code for modular curve with label 60.30.2.f.1

// Other names and/or labels
// Cummins-Pauli label: 20A2
// Rouse-Sutherland-Zureick-Brown label: 60.30.2.9

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 14, 48, 11], [29, 22, 48, 11], [47, 21, 28, 1], [53, 20, 50, 39]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 30;
...
// Map from the embedded model to the plane model of modular curve with label 60.30.2.f.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.30.2.f.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-z);
//   Coordinate number 1:
map_2_coord_1 := 1*(-52*x^2*z+30*x^2*w-2*z^2*w);
//   Coordinate number 2:
map_2_coord_2 := 1*(-x);
// Codomain equation:
