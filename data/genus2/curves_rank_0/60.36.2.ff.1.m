...
// Magma code for modular curve with label 60.36.2.ff.1

// Other names and/or labels
// Cummins-Pauli label: 12B2
// Rouse-Sutherland-Zureick-Brown label: 60.36.2.60

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[15, 4, 56, 27], [17, 12, 1, 43], [31, 22, 46, 45], [45, 2, 19, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["12.18.0.i.1", "30.18.1.b.1", "60.12.0.be.1", "60.18.1.c.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.36.2.ff.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.36.2.ff.1
//   Coordinate number 0:
