...
// Magma code for modular curve with label 60.36.2.fo.1

// Other names and/or labels
// Cummins-Pauli label: 12B2
// Rouse-Sutherland-Zureick-Brown label: 60.36.2.37

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[15, 22, 11, 9], [15, 32, 31, 9], [17, 32, 38, 25], [31, 4, 57, 17], [47, 58, 31, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["12.18.0.l.1", "30.18.1.b.1", "60.12.0.bj.1", "60.18.1.e.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.36.2.fo.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.36.2.fo.1
//   Coordinate number 0:
