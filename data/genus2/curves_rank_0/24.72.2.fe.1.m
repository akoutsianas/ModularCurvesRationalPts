...
// Magma code for modular curve with label 24.72.2.fe.1

// Other names and/or labels
// Cummins-Pauli label: 24P2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.1137

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 6, 0, 5], [1, 17, 8, 11], [3, 4, 22, 9], [5, 8, 8, 1], [9, 8, 20, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.0.ce.1", "24.36.1.fs.1", "24.36.1.ga.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.fe.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.fe.1
//   Coordinate number 0:
map_2_coord_0 := 1*(x);
//   Coordinate number 1:
