...
// Magma code for modular curve with label 60.36.2.df.1

// Other names and/or labels
// Cummins-Pauli label: 12E2
// Rouse-Sutherland-Zureick-Brown label: 60.36.2.108

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[29, 20, 49, 53], [29, 44, 19, 35], [47, 8, 23, 49], [55, 2, 32, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["12.18.1.j.1", "60.18.0.d.1", "60.18.1.a.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.36.2.df.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.36.2.df.1
//   Coordinate number 0:
