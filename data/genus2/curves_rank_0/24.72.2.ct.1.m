...
// Magma code for modular curve with label 24.72.2.ct.1

// Other names and/or labels
// Cummins-Pauli label: 24O2
// Rouse-Sutherland-Zureick-Brown label: 24.72.2.1153

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 7, 2, 3], [9, 11, 20, 3], [13, 1, 16, 11], [17, 4, 10, 19], [17, 15, 0, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.0.by.1", "24.36.1.fr.1", "24.36.1.gf.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.2.ct.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.2.ct.1
//   Coordinate number 0:
map_2_coord_0 := 1*(w);
//   Coordinate number 1:
