...
// Magma code for modular curve with label 60.36.2.fr.1

// Other names and/or labels
// Cummins-Pauli label: 20C2
// Rouse-Sutherland-Zureick-Brown label: 60.36.2.27

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 30, 40, 37], [27, 10, 14, 37], [53, 25, 36, 23], [53, 40, 32, 59], [57, 20, 22, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
// Map from the embedded model to the plane model of modular curve with label 60.36.2.fr.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.36.2.fr.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-1/10*z^2-3/5*z*w-4/5*w^2);
//   Coordinate number 1:
map_2_coord_1 := 1*(3/20*y*z^4*w+6/5*y*z^3*w^2+3*y*z^2*w^3+12/5*y*z*w^4);
//   Coordinate number 2:
map_2_coord_2 := 1*(-1/5*z^2-1/5*z*w+2/5*w^2);
// Codomain equation:
