...
// Magma code for modular curve with label 60.36.2.fv.1

// Other names and/or labels
// Cummins-Pauli label: 30C2
// Rouse-Sutherland-Zureick-Brown label: 60.36.2.154

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 5, 34, 1], [11, 15, 18, 11], [47, 50, 20, 43], [48, 55, 17, 12], [58, 5, 23, 56]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
// Map from the embedded model to the plane model of modular curve with label 60.36.2.fv.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(x);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.36.2.fv.1
//   Coordinate number 0:
map_2_coord_0 := 1*(z+w);
//   Coordinate number 1:
