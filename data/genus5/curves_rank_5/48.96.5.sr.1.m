...
// Magma code for modular curve with label 48.96.5.sr.1

// Other names and/or labels
// Cummins-Pauli label: 16B5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.259

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 34, 42, 5], [25, 37, 24, 47], [29, 18, 30, 11], [47, 27, 2, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.cs.1", "24.48.1.ju.1", "48.48.1.jc.1", "48.48.3.dx.1", "48.48.3.ej.1", "48.48.3.fn.1", "48.48.3.gd.2"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.sr.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
