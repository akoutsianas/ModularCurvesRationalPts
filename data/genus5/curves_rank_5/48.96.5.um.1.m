...
// Magma code for modular curve with label 48.96.5.um.1

// Other names and/or labels
// Cummins-Pauli label: 16B5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.269

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 46, 8, 39], [27, 29, 20, 45], [31, 42, 10, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.dd.1", "24.48.1.lh.1", "48.48.1.ix.1", "48.48.3.dx.1", "48.48.3.fi.1", "48.48.3.fs.1", "48.48.3.gd.2"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.um.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
