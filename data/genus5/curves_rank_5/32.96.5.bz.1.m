...
// Magma code for modular curve with label 32.96.5.bz.1

// Other names and/or labels
// Cummins-Pauli label: 32F5
// Rouse-Zureick-Brown label: X679
// Rouse-Sutherland-Zureick-Brown label: 32.96.5.11

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 2, 30, 23], [13, 30, 18, 3], [21, 7, 8, 11], [27, 26, 2, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
// Map from the canonical model to the plane model of modular curve with label 32.96.5.bz.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
