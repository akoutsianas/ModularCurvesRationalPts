...
// Magma code for modular curve with label 32.96.5.bs.1

// Other names and/or labels
// Cummins-Pauli label: 32H5
// Rouse-Zureick-Brown label: X692
// Rouse-Sutherland-Zureick-Brown label: 32.96.5.19

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 12, 14, 15], [15, 19, 2, 17], [19, 19, 4, 13], [27, 0, 14, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
// Map from the canonical model to the plane model of modular curve with label 32.96.5.bs.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
