...
// Magma code for modular curve with label 48.96.5.ss.1

// Other names and/or labels
// Cummins-Pauli label: 16B5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.231

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 10, 30, 37], [11, 5, 40, 41], [11, 33, 38, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.ct.1", "24.48.1.jv.1", "48.48.1.jd.1", "48.48.3.dx.2", "48.48.3.ek.1", "48.48.3.fo.1", "48.48.3.gd.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.ss.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
