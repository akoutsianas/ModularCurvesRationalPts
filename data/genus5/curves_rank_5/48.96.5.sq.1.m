...
// Magma code for modular curve with label 48.96.5.sq.1

// Other names and/or labels
// Cummins-Pauli label: 16B5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.163

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[15, 1, 40, 13], [19, 21, 4, 41], [35, 24, 46, 41]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.cr.1", "24.48.1.jt.1", "48.48.1.jf.1", "48.48.3.dx.2", "48.48.3.ei.1", "48.48.3.fq.1", "48.48.3.gd.2"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.sq.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
