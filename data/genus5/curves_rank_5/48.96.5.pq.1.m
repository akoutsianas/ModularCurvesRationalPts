...
// Magma code for modular curve with label 48.96.5.pq.1

// Other names and/or labels
// Cummins-Pauli label: 16E5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.250

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[25, 18, 8, 13], [29, 8, 22, 11], [33, 46, 16, 45], [39, 5, 32, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.bn.1", "48.48.1.fk.1", "48.48.3.ej.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.pq.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
