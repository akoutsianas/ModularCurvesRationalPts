...
// Magma code for modular curve with label 40.80.5.f.1

// Other names and/or labels
// Cummins-Pauli label: 20B5
// Rouse-Sutherland-Zureick-Brown label: 40.80.5.9

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 24, 25, 11], [14, 37, 3, 11], [32, 23, 17, 39], [38, 1, 19, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 80;
...
covers := ["20.40.2.e.1", "40.20.0.b.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.80.5.f.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
