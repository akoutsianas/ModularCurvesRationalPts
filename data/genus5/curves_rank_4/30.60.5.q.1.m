...
// Magma code for modular curve with label 30.60.5.q.1

// Other names and/or labels
// Cummins-Pauli label: 30B5
// Rouse-Sutherland-Zureick-Brown label: 30.60.5.18

// Group data
level := 30;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 13, 28, 27], [13, 29, 26, 17], [22, 27, 3, 2]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["15.30.2.c.1", "30.12.1.m.1", "30.30.2.h.1", "30.30.3.c.1"];
...
// Canonical model
model_0 := [2*x*y-x*z+9*x*w+y*t+z*t,11*x^2-x*t+2*y^2+y*z-6*y*w+2*z^2+6*z*w-t^2,4*x^2+x*t+3*y*w-3*z*w+12*w^2+t^2];
...
map_0_coord_1 := 1*(-w);
//   Coordinate number 2:
map_0_coord_2 := 1*(-y+z-3*w);
// Codomain equation:
map_0_codomain := [25*x^4+55*x^2*y^2+37*y^4+27*y^3*z-9*y^2*z^2+y*z^3];

// Map from the canonical model to the plane model of modular curve with label 30.60.5.q.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
