...
// Magma code for modular curve with label 40.120.5.ec.1

// Other names and/or labels
// Cummins-Pauli label: 20E5
// Rouse-Sutherland-Zureick-Brown label: 40.120.5.146

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 27, 26, 9], [7, 5, 18, 23], [15, 19, 26, 21], [37, 5, 28, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.2.a.1", "40.60.2.h.1", "40.60.3.br.1"];
...
// Canonical model
model_0 := [5*x^2-y^2-2*y*z+y*w-z^2+z*w+w^2-t^2,5*x*y+5*x*z-y*t+z*t,5*x^2-y^2+8*y*z-4*y*w-z^2-4*z*w+6*w^2+t^2];
...
//   Coordinate number 2:
map_0_coord_2 := 1*(-2*y-2*z+w);
// Codomain equation:
map_0_codomain := [4*x^4+8*x^2*y^2+9*y^4-38*x^2*y*z-23*y^3*z-18*x^2*z^2+11*y^2*z^2+8*y*z^3-6*z^4];

// Map from the canonical model to the plane model of modular curve with label 40.120.5.ec.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
