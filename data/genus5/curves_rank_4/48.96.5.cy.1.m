...
// Magma code for modular curve with label 48.96.5.cy.1

// Other names and/or labels
// Cummins-Pauli label: 16B5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.75

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 37, 12, 35], [5, 29, 18, 43], [11, 11, 38, 21], [13, 5, 10, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.w.1", "48.48.1.gv.1", "48.48.1.if.1", "48.48.3.j.1", "48.48.3.m.2", "48.48.3.ei.1", "48.48.3.fs.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.cy.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z+t);
//   Coordinate number 1:
map_1_coord_1 := 1*(4*x);
