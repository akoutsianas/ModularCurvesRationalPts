...
// Magma code for modular curve with label 48.96.5.qr.1

// Other names and/or labels
// Cummins-Pauli label: 16E5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.273

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 11, 38, 13], [7, 32, 34, 1], [39, 8, 32, 31], [41, 19, 28, 43]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.bz.1", "48.48.1.ge.1", "48.48.3.fr.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.qr.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
