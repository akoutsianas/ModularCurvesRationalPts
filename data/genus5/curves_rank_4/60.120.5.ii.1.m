...
// Magma code for modular curve with label 60.120.5.ii.1

// Other names and/or labels
// Cummins-Pauli label: 30Q5
// Rouse-Sutherland-Zureick-Brown label: 60.120.5.79

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[4, 13, 19, 26], [7, 28, 8, 43], [35, 43, 7, 40], [49, 53, 4, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["15.60.2.c.1", "60.60.2.q.1", "60.60.3.cb.1"];
...
//   Coordinate number 2:
map_0_coord_2 := 1*(3*x+2*z-2*w+2*t);
// Codomain equation:
...
// Map from the canonical model to the plane model of modular curve with label 60.120.5.ii.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
