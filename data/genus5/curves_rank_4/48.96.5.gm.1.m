...
// Magma code for modular curve with label 48.96.5.gm.1

// Other names and/or labels
// Cummins-Pauli label: 16B5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.712

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 3, 38, 25], [27, 5, 26, 5], [29, 3, 20, 43]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.bg.1", "24.48.1.en.1", "48.48.1.ht.1", "48.48.1.hu.1", "48.48.3.bf.2", "48.48.3.fg.1", "48.48.3.fh.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.gm.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
