...
// Magma code for modular curve with label 48.96.5.gy.1

// Other names and/or labels
// Cummins-Pauli label: 16B5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.711

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 19, 0, 25], [31, 42, 12, 47], [43, 21, 10, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.bg.1", "24.48.1.fj.1", "48.48.1.ia.1", "48.48.1.id.1", "48.48.3.bf.1", "48.48.3.fn.1", "48.48.3.fq.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.gy.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
