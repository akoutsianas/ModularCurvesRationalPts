...
// Magma code for modular curve with label 48.96.5.px.1

// Other names and/or labels
// Cummins-Pauli label: 16E5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.252

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 11, 32, 5], [11, 41, 10, 29], [47, 37, 32, 45], [47, 40, 42, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.bl.1", "48.48.1.fk.1", "48.48.3.en.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.px.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
