...
// Magma code for modular curve with label 48.96.5.qq.1

// Other names and/or labels
// Cummins-Pauli label: 16E5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.279

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[23, 6, 24, 19], [23, 46, 32, 3], [25, 36, 14, 47], [43, 27, 36, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.bx.1", "48.48.1.gh.1", "48.48.3.fr.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.qq.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
