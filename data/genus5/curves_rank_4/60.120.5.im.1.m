...
// Magma code for modular curve with label 60.120.5.im.1

// Other names and/or labels
// Cummins-Pauli label: 30Q5
// Rouse-Sutherland-Zureick-Brown label: 60.120.5.246

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 44, 32, 9], [13, 41, 54, 47], [17, 42, 12, 23], [53, 41, 29, 12]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["30.60.3.r.1", "60.60.2.n.1", "60.60.2.r.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.120.5.im.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
