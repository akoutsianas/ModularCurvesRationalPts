...
// Magma code for modular curve with label 48.96.5.dr.1

// Other names and/or labels
// Cummins-Pauli label: 16B5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.695

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[29, 46, 4, 45], [41, 23, 16, 39], [45, 25, 10, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.n.1", "24.48.1.dg.1", "48.48.1.hv.1", "48.48.1.id.1", "48.48.3.m.2", "48.48.3.fi.1", "48.48.3.fq.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.dr.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
