...
// Magma code for modular curve with label 48.96.5.rm.1

// Other names and/or labels
// Cummins-Pauli label: 16F5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.146

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 17, 26, 45], [5, 4, 32, 5], [13, 7, 36, 19], [13, 32, 20, 41]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.ch.1", "24.48.1.mh.1", "48.48.3.fu.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.rm.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*w);
