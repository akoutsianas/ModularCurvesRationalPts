...
// Magma code for modular curve with label 48.96.5.pr.1

// Other names and/or labels
// Cummins-Pauli label: 16E5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.251

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 14, 0, 37], [11, 33, 40, 25], [13, 32, 38, 35], [47, 5, 0, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.bl.1", "48.48.1.fp.1", "48.48.3.ej.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.pr.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
