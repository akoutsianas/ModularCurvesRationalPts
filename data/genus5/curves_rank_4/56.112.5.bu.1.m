...
// Magma code for modular curve with label 56.112.5.bu.1

// Other names and/or labels
// Cummins-Pauli label: 14E5
// Rouse-Sutherland-Zureick-Brown label: 56.112.5.40

// Group data
level := 56;
// Elements that, together with Gamma(level), generate the group
gens := [[23, 44, 22, 33], [42, 19, 47, 46], [49, 25, 24, 35]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 112;
...
covers := ["28.56.1.b.1", "56.56.1.h.1", "56.56.3.d.1"];
...
// Map from the canonical model to the plane model of modular curve with label 56.112.5.bu.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*t);
