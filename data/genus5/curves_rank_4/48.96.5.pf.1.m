...
// Magma code for modular curve with label 48.96.5.pf.1

// Other names and/or labels
// Cummins-Pauli label: 16F5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.123

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[21, 34, 14, 39], [23, 15, 34, 25], [25, 14, 34, 39], [43, 40, 44, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.bc.1", "24.48.1.me.1", "48.48.3.ft.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.pf.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(8*y);
