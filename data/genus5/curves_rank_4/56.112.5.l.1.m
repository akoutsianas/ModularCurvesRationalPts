...
// Magma code for modular curve with label 56.112.5.l.1

// Other names and/or labels
// Cummins-Pauli label: 14E5
// Rouse-Sutherland-Zureick-Brown label: 56.112.5.11

// Group data
level := 56;
// Elements that, together with Gamma(level), generate the group
gens := [[31, 40, 40, 49], [47, 35, 32, 37], [50, 5, 19, 47]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 112;
...
covers := ["14.56.1.b.1", "56.56.1.b.1", "56.56.3.b.1"];
...
model_1 := [x^8-4*x^6*y^2+4*x^4*y^4+24*x^5*y^2*z-16*x^3*y^4*z-38*x^6*z^2-40*x^4*y^2*z^2+24*x^2*y^4*z^2+44*x^5*z^3+32*x^3*y^2*z^3-16*x*y^4*z^3+351*x^4*z^4-16*x^2*y^2*z^4+4*y^4*z^4-836*x^3*z^5+674*x^2*z^6+4*y^2*z^6-220*x*z^7+25*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 56.112.5.l.1
//   Coordinate number 0:
...
// Codomain equation:
map_1_codomain := [x^8-4*x^6*y^2+4*x^4*y^4+24*x^5*y^2*z-16*x^3*y^4*z-38*x^6*z^2-40*x^4*y^2*z^2+24*x^2*y^4*z^2+44*x^5*z^3+32*x^3*y^2*z^3-16*x*y^4*z^3+351*x^4*z^4-16*x^2*y^2*z^4+4*y^4*z^4-836*x^3*z^5+674*x^2*z^6+4*y^2*z^6-220*x*z^7+25*z^8];
