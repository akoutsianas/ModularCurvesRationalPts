...
// Magma code for modular curve with label 48.96.5.qf.1

// Other names and/or labels
// Cummins-Pauli label: 16F5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.63

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 39, 2, 1], [11, 35, 46, 5], [29, 3, 16, 43], [45, 22, 10, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.bt.1", "48.48.1.fw.1", "48.48.3.ft.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.qf.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
