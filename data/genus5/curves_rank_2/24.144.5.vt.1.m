...
// Magma code for modular curve with label 24.144.5.vt.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1275

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 3, 0, 7], [17, 4, 20, 17], [19, 21, 18, 13], [23, 13, 20, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.dy.1", "24.72.2.dw.1", "24.72.2.eh.1", "24.72.2.fy.1", "24.72.2.gr.1", "24.72.3.bdv.1", "24.72.3.bem.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.vt.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x-z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
