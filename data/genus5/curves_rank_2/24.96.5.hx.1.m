...
// Magma code for modular curve with label 24.96.5.hx.1

// Other names and/or labels
// Cummins-Pauli label: 24J5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.182

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 2, 12, 17], [5, 15, 18, 11], [5, 22, 6, 23], [7, 20, 0, 11], [13, 5, 6, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.24.0.ep.1", "24.48.2.j.1", "24.48.2.o.1", "24.48.3.co.1"];
...
model_1 := [2*x^4*z^4+8*x^3*y^2*z^3+9*x^2*y^4*z^2-24*x^2*y^2*z^4-12*x^2*z^6+2*x*y^6*z-48*x*y^4*z^3-24*x*y^2*z^5-y^8-6*y^6*z^2-84*y^4*z^4+72*y^2*z^6];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.hx.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+w);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
...
// Codomain equation:
map_1_codomain := [2*x^4*z^4+8*x^3*y^2*z^3+9*x^2*y^4*z^2-24*x^2*y^2*z^4-12*x^2*z^6+2*x*y^6*z-48*x*y^4*z^3-24*x*y^2*z^5-y^8-6*y^6*z^2-84*y^4*z^4+72*y^2*z^6];
