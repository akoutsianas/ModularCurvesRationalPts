...
// Magma code for modular curve with label 60.96.5.bw.2

// Other names and/or labels
// Cummins-Pauli label: 30N5
// Rouse-Sutherland-Zureick-Brown label: 60.96.5.122

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 25, 12, 49], [29, 40, 18, 23], [43, 0, 21, 37], [59, 35, 0, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["30.48.3.e.2", "60.24.1.be.1", "60.48.1.bw.2", "60.48.3.bb.1"];
...
map_0_coord_0 := 1*(-5*x);
//   Coordinate number 1:
map_0_coord_1 := 1*(5*x+3*z-2*w);
//   Coordinate number 2:
map_0_coord_2 := 1*(5*x+z+w);
// Codomain equation:
...
// Map from the canonical model to the plane model of modular curve with label 60.96.5.bw.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
