...
// Magma code for modular curve with label 16.96.5.bj.1

// Other names and/or labels
// Cummins-Pauli label: 16B5
// Rouse-Sutherland-Zureick-Brown label: 16.96.5.73

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 7, 6, 13], [13, 0, 2, 15], [13, 1, 10, 3], [15, 7, 14, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.y.1", "16.48.1.ct.1", "16.48.1.df.1", "16.48.3.m.2", "16.48.3.n.1", "16.48.3.bs.1", "16.48.3.ce.1"];
...
// Map from the canonical model to the plane model of modular curve with label 16.96.5.bj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z+t);
//   Coordinate number 1:
map_1_coord_1 := 1*(4*y);
