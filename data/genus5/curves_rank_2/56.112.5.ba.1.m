...
// Magma code for modular curve with label 56.112.5.ba.1

// Other names and/or labels
// Cummins-Pauli label: 14E5
// Rouse-Sutherland-Zureick-Brown label: 56.112.5.16

// Group data
level := 56;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 46, 4, 25], [28, 51, 19, 28], [35, 47, 54, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 112;
...
covers := ["14.56.1.a.1", "56.56.1.a.1", "56.56.3.c.1"];
...
// Map from the canonical model to the plane model of modular curve with label 56.112.5.ba.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
