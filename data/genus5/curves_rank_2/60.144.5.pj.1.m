...
// Magma code for modular curve with label 60.144.5.pj.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.746

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[33, 55, 14, 57], [49, 40, 30, 11], [57, 55, 14, 59]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.z.1", "60.72.1.cb.2", "60.72.1.cn.1", "60.72.1.dy.1", "60.72.3.qx.1", "60.72.3.rq.1", "60.72.3.yw.2"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.pj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x-y);
//   Coordinate number 1:
