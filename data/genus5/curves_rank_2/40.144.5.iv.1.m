...
// Magma code for modular curve with label 40.144.5.iv.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.445

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 27, 14, 15], [21, 7, 22, 31], [23, 30, 6, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.v.2", "40.72.1.y.2", "40.72.1.bm.2", "40.72.1.cr.1", "40.72.3.dk.1", "40.72.3.dy.1", "40.72.3.ex.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.iv.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
