...
// Magma code for modular curve with label 24.72.5.db.1

// Other names and/or labels
// Cummins-Pauli label: 24A5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.257

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 10, 22, 7], [11, 8, 14, 13], [17, 15, 6, 23], [21, 4, 10, 15], [23, 10, 2, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.24.1.bf.1", "24.36.0.cf.1", "24.36.2.gf.1", "24.36.3.d.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.5.db.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.5.db.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-r);
//   Coordinate number 1:
