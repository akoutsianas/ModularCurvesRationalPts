...
// Magma code for modular curve with label 24.72.5.nl.1

// Other names and/or labels
// Cummins-Pauli label: 24E5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.112

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 7, 22, 5], [7, 11, 10, 7], [11, 13, 2, 11], [19, 3, 6, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bp.1", "24.36.1.gr.1", "24.36.3.e.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.5.nl.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
