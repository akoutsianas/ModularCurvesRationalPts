...
// Magma code for modular curve with label 48.144.5.bm.2

// Other names and/or labels
// Cummins-Pauli label: 48F5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.723

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 11, 2, 15], [9, 1, 14, 3], [23, 24, 36, 25], [35, 11, 2, 13], [37, 21, 6, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.2.hj.1", "48.48.1.hm.1", "48.72.0.a.1", "48.72.3.bf.1"];
...
model_1 := [8*x^12-108*x^6*z^6-6*y^2*z^10+729*z^12];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.bm.2
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(9*v);
...
// Codomain equation:
map_1_codomain := [8*x^12-108*x^6*z^6-6*y^2*z^10+729*z^12];

// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.bm.2
//   Coordinate number 0:
map_2_coord_0 := 1*(-r);
//   Coordinate number 1:
