...
// Magma code for modular curve with label 48.96.5.ub.1

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.186

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 29, 30, 35], [29, 2, 36, 7], [47, 47, 22, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.cw.1", "24.48.1.kw.2", "48.48.1.iq.2", "48.48.3.du.1", "48.48.3.et.1", "48.48.3.ez.2", "48.48.3.gc.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.ub.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
