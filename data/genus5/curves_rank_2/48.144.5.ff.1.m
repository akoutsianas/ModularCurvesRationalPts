...
// Magma code for modular curve with label 48.144.5.ff.1

// Other names and/or labels
// Cummins-Pauli label: 48F5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.59

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 31, 2, 25], [9, 23, 26, 21], [17, 38, 40, 35], [19, 35, 2, 5], [25, 11, 2, 35], [25, 30, 36, 41]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['3.3.0.a.1', '16.48.1.cx.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["16.48.1.cx.1", "24.72.2.hp.1", "48.72.0.c.2", "48.72.3.bf.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.ff.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.ff.1
//   Coordinate number 0:
map_2_coord_0 := 1*(w);
//   Coordinate number 1:
