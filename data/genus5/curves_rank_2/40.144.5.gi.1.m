...
// Magma code for modular curve with label 40.144.5.gi.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.506

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 28, 38, 21], [19, 33, 16, 1], [27, 37, 38, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.x.2", "40.72.1.x.2", "40.72.1.bh.1", "40.72.1.cf.1", "40.72.3.bu.1", "40.72.3.cs.1", "40.72.3.eo.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.gi.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
