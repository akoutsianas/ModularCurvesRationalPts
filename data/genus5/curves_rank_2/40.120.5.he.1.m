...
// Magma code for modular curve with label 40.120.5.he.1

// Other names and/or labels
// Cummins-Pauli label: 20F5
// Rouse-Sutherland-Zureick-Brown label: 40.120.5.100

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 31, 10, 39], [5, 31, 4, 29], [15, 36, 24, 9], [17, 29, 2, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.2.g.1", "40.60.2.m.1", "40.60.3.ch.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.120.5.he.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
