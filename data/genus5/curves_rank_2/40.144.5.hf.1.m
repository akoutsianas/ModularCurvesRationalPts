...
// Magma code for modular curve with label 40.144.5.hf.1

// Other names and/or labels
// Cummins-Pauli label: 40M5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.624

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 22, 0, 19], [11, 23, 32, 27], [23, 28, 24, 7], [27, 19, 28, 13], [27, 35, 8, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["40.72.1.s.1", "40.72.3.cb.1", "40.72.3.cf.1"];
...
// Canonical model
model_0 := [y^2+x*z,5*y^2-5*x*z-w*t,50*x^2+10*z^2+w^2+4*w*t+t^2];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.hf.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
