...
// Magma code for modular curve with label 40.144.5.bc.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.523

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 13, 28, 1], [3, 15, 22, 11], [21, 21, 24, 33], [29, 5, 16, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.q.1", "40.72.1.e.1", "40.72.1.p.1", "40.72.1.cp.1", "40.72.3.g.1", "40.72.3.l.1", "40.72.3.fa.2"];
...
model_1 := [144*x^8+480*x^6*z^2-8*x^4*y^2*z^2+760*x^4*z^4+8*x^2*y^2*z^4+y^4*z^4+600*x^2*z^6-10*y^2*z^6+225*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.bc.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Codomain equation:
map_1_codomain := [144*x^8+480*x^6*z^2-8*x^4*y^2*z^2+760*x^4*z^4+8*x^2*y^2*z^4+y^4*z^4+600*x^2*z^6-10*y^2*z^6+225*z^8];
