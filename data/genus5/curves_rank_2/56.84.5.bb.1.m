...
// Magma code for modular curve with label 56.84.5.bb.1

// Other names and/or labels
// Cummins-Pauli label: 14B5
// Rouse-Sutherland-Zureick-Brown label: 56.84.5.23

// Group data
level := 56;
// Elements that, together with Gamma(level), generate the group
gens := [[15, 33, 12, 51], [45, 25, 26, 11], [48, 3, 3, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 84;
...
covers := ["14.42.3.b.1", "56.42.1.b.1", "56.42.1.e.1"];
...
// Map from the canonical model to the plane model of modular curve with label 56.84.5.bb.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
