...
// Magma code for modular curve with label 48.96.5.jp.1

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.425

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 0, 36, 43], [13, 3, 2, 1], [45, 7, 2, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.bv.2", "24.48.1.ku.2", "48.48.1.hi.2", "48.48.1.hn.1", "48.48.3.bj.1", "48.48.3.bw.1", "48.48.3.ds.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.jp.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
