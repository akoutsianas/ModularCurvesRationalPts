...
// Magma code for modular curve with label 56.96.5.bb.1

// Other names and/or labels
// Cummins-Pauli label: 28E5
// Rouse-Sutherland-Zureick-Brown label: 56.96.5.29

// Group data
level := 56;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 27, 10, 31], [23, 11, 16, 23], [47, 52, 42, 41], [51, 3, 50, 35], [55, 4, 40, 39]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["28.48.2.b.1", "56.12.0.p.1", "56.48.2.m.1", "56.48.3.a.1"];
...
// Map from the canonical model to the plane model of modular curve with label 56.96.5.bb.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
