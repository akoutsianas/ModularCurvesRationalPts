...
// Magma code for modular curve with label 48.96.5.jr.2

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.418

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 4, 20, 13], [27, 1, 38, 33], [35, 39, 2, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.bt.1", "24.48.1.kw.2", "48.48.1.hi.1", "48.48.1.hk.2", "48.48.3.bk.1", "48.48.3.bv.2", "48.48.3.dt.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.jr.2
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
