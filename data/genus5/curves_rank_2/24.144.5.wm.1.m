...
// Magma code for modular curve with label 24.144.5.wm.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.397

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 14, 4, 13], [17, 0, 12, 5], [17, 7, 4, 7], [23, 8, 10, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.2.q.1", "24.72.1.dz.1", "24.72.2.en.1", "24.72.2.gj.1", "24.72.2.gy.1", "24.72.3.bei.1", "24.72.3.bez.1"];
...
// Canonical model
model_0 := [x*z-x*w+2*y*z+y*w,x^2+x*y+y^2+2*z^2+2*z*w-w^2,4*x^2+x*y+y^2-2*z^2-2*z*w-5*w^2+3*t^2];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.wm.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x-y);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*z);
