...
// Magma code for modular curve with label 40.144.5.mo.1

// Other names and/or labels
// Cummins-Pauli label: 40L5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.669

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 6, 30, 27], [13, 6, 12, 37], [17, 21, 18, 35], [19, 25, 22, 17], [35, 13, 22, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["40.72.1.ct.2", "40.72.3.fw.2", "40.72.3.gb.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.mo.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*x);
