...
// Magma code for modular curve with label 24.72.5.ik.1

// Other names and/or labels
// Cummins-Pauli label: 24F5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.304

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 19, 22, 9], [11, 19, 2, 23], [19, 17, 14, 11], [21, 14, 8, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.gm.1", "24.36.2.fz.1", "24.36.2.gg.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.5.ik.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
