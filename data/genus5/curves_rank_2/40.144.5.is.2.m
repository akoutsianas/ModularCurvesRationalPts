...
// Magma code for modular curve with label 40.144.5.is.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.566

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 16, 36, 33], [15, 24, 36, 23], [15, 31, 14, 17], [37, 5, 34, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.bl.2", "40.72.1.bi.1", "40.72.1.bo.2", "40.72.1.cn.1", "40.72.3.db.2", "40.72.3.dk.2", "40.72.3.dx.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.is.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x-y);
//   Coordinate number 1:
