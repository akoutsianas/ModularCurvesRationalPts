...
// Magma code for modular curve with label 32.96.5.q.1

// Other names and/or labels
// Cummins-Pauli label: 32A5
// Rouse-Zureick-Brown label: X684
// Rouse-Sutherland-Zureick-Brown label: 32.96.5.65

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 26, 8, 27], [19, 18, 24, 3], [25, 21, 12, 25], [27, 14, 0, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
// Map from the canonical model to the plane model of modular curve with label 32.96.5.q.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*z);
