...
// Magma code for modular curve with label 48.96.5.oc.1

// Other names and/or labels
// Cummins-Pauli label: 16H5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.685

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 25, 16, 37], [13, 33, 34, 43], [21, 44, 8, 37], [43, 36, 18, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.cg.1", "48.48.2.bl.1", "48.48.2.bu.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.oc.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
