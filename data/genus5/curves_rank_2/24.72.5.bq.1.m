...
// Magma code for modular curve with label 24.72.5.bq.1

// Other names and/or labels
// Cummins-Pauli label: 24F5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.317

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 21, 6, 17], [5, 16, 8, 5], [21, 22, 8, 3], [23, 15, 6, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.gq.1", "24.36.2.ba.1", "24.36.2.gg.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.5.bq.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
