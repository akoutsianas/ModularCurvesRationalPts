...
// Magma code for modular curve with label 24.144.5.zo.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.935

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 13, 22, 17], [7, 18, 12, 23], [17, 15, 12, 7], [19, 13, 2, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.el.1", "24.72.2.v.1", "24.72.2.bg.1", "24.72.2.hw.1", "24.72.2.ja.1", "24.72.3.bdc.1", "24.72.3.beg.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.zo.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*z);
