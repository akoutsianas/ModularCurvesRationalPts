...
// Magma code for modular curve with label 24.96.5.em.1

// Other names and/or labels
// Cummins-Pauli label: 24K5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.210

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 17, 6, 23], [7, 7, 12, 13], [11, 5, 12, 5], [13, 21, 0, 11], [17, 0, 6, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.24.1.dk.1", "24.48.2.l.1", "24.48.2.p.1", "24.48.3.bu.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.em.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
