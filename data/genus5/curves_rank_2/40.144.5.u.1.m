...
// Magma code for modular curve with label 40.144.5.u.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.407

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 30, 32, 39], [15, 8, 6, 7], [15, 26, 32, 19], [27, 6, 14, 29], [31, 20, 0, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.e.1", "40.72.1.b.1", "40.72.1.bp.2", "40.72.1.cc.1", "40.72.3.c.1", "40.72.3.dh.2", "40.72.3.eo.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.u.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
