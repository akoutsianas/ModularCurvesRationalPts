...
// Magma code for modular curve with label 24.96.5.en.1

// Other names and/or labels
// Cummins-Pauli label: 24K5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.206

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 2, 18, 23], [7, 1, 6, 17], [11, 2, 0, 23], [13, 6, 12, 17], [19, 16, 18, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.24.1.dl.1", "24.48.2.m.1", "24.48.2.p.1", "24.48.3.bu.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.en.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
