...
// Magma code for modular curve with label 40.144.5.gc.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.491

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 11, 2, 35], [17, 16, 14, 29], [27, 7, 36, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.w.2", "40.72.1.u.2", "40.72.1.be.1", "40.72.1.cc.1", "40.72.3.bu.1", "40.72.3.cp.1", "40.72.3.el.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.gc.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
