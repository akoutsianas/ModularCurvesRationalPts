...
// Magma code for modular curve with label 24.72.5.lg.1

// Other names and/or labels
// Cummins-Pauli label: 24G5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.340

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 6, 0, 17], [5, 17, 8, 7], [7, 5, 22, 1], [11, 5, 20, 1], [17, 15, 6, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fu.1", "24.36.1.gc.1", "24.36.3.h.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.5.lg.1
//   Coordinate number 0:
