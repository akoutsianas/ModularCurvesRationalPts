...
// Magma code for modular curve with label 24.192.5.fp.4

// Other names and/or labels
// Cummins-Pauli label: 24Z5
// Rouse-Sutherland-Zureick-Brown label: 24.192.5.1474

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 0, 4, 19], [5, 0, 0, 1], [7, 6, 16, 11], [19, 9, 8, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["24.96.1.da.2", "24.96.1.dj.3", "24.96.1.dr.2", "24.96.3.fr.2", "24.96.3.fu.1", "24.96.3.gq.2", "24.96.3.gy.2"];
...
model_1 := [36*x^4*z^4+72*x^3*y^2*z^3+72*x^3*z^5+24*x^2*y^4*z^2+120*x^2*y^2*z^4+144*x^2*z^6-12*x*y^6*z+36*x*y^4*z^3+156*x*y^2*z^5+108*x*z^7-5*y^8-8*y^6*z^2+58*y^4*z^4+72*y^2*z^6+27*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 24.192.5.fp.4
//   Coordinate number 0:
map_1_coord_0 := 1*(x+w);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
...
map_1_coord_2 := 1*(z);
// Codomain equation:
map_1_codomain := [36*x^4*z^4+72*x^3*y^2*z^3+72*x^3*z^5+24*x^2*y^4*z^2+120*x^2*y^2*z^4+144*x^2*z^6-12*x*y^6*z+36*x*y^4*z^3+156*x*y^2*z^5+108*x*z^7-5*y^8-8*y^6*z^2+58*y^4*z^4+72*y^2*z^6+27*z^8];
