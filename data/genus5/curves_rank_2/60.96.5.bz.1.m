...
// Magma code for modular curve with label 60.96.5.bz.1

// Other names and/or labels
// Cummins-Pauli label: 30N5
// Rouse-Sutherland-Zureick-Brown label: 60.96.5.113

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 0, 33, 43], [26, 5, 3, 32], [53, 0, 27, 13], [59, 45, 57, 16]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["30.48.3.f.1", "60.24.1.bh.1", "60.48.1.bx.1", "60.48.3.bb.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.96.5.bz.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(5*y);
