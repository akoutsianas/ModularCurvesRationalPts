...
// Magma code for modular curve with label 48.96.5.jl.1

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.423

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 46, 32, 39], [15, 41, 46, 5], [47, 33, 22, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.bv.2", "24.48.1.ks.1", "48.48.1.he.2", "48.48.1.hn.2", "48.48.3.bi.2", "48.48.3.bs.1", "48.48.3.dq.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.jl.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
