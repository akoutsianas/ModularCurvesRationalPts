...
// Magma code for modular curve with label 48.96.5.tt.1

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.185

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 26, 32, 45], [15, 19, 10, 39], [23, 38, 24, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.cw.1", "24.48.1.ks.2", "48.48.1.ip.2", "48.48.3.dq.1", "48.48.3.er.1", "48.48.3.fa.1", "48.48.3.ga.2"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.tt.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
