...
// Magma code for modular curve with label 48.96.5.nl.1

// Other names and/or labels
// Cummins-Pauli label: 16H5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.673

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 37, 16, 37], [7, 6, 28, 11], [17, 28, 8, 17], [37, 39, 22, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.cf.1", "48.48.2.be.1", "48.48.2.bl.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.nl.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
