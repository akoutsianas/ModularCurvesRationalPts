...
// Magma code for modular curve with label 48.144.5.gz.1

// Other names and/or labels
// Cummins-Pauli label: 48E5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.756

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 8, 42, 41], [9, 41, 4, 39], [19, 11, 30, 5], [21, 40, 28, 41], [33, 14, 14, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.2.jj.1", "48.48.1.jh.1", "48.72.0.d.2", "48.72.3.bm.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.gz.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*v);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.gz.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-t);
//   Coordinate number 1:
