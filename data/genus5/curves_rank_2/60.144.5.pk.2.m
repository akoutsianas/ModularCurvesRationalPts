...
// Magma code for modular curve with label 60.144.5.pk.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.910

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 15, 34, 31], [7, 30, 34, 59], [21, 10, 46, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.ba.2", "60.72.1.cd.1", "60.72.1.cl.2", "60.72.1.dx.2", "60.72.3.qv.2", "60.72.3.rr.1", "60.72.3.yw.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.pk.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*w);
