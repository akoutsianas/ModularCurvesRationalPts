...
// Magma code for modular curve with label 24.144.5.bgc.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.968

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 11, 4, 9], [5, 9, 18, 19], [5, 22, 10, 19], [7, 19, 10, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.fb.1", "24.72.2.dk.1", "24.72.2.do.1", "24.72.2.im.1", "24.72.2.ji.1", "24.72.3.bgy.1", "24.72.3.bhu.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.bgc.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*z);
