...
// Magma code for modular curve with label 16.96.5.ca.2

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 16.96.5.107

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 11, 10, 1], [9, 6, 4, 1], [11, 10, 12, 15], [13, 5, 6, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.bh.2", "16.48.1.cw.1", "16.48.1.cx.2", "16.48.3.t.2", "16.48.3.z.1", "16.48.3.bv.1", "16.48.3.bw.2"];
...
// Map from the canonical model to the plane model of modular curve with label 16.96.5.ca.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
