...
// Magma code for modular curve with label 48.96.5.pv.1

// Other names and/or labels
// Cummins-Pauli label: 16E5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.245

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 20, 46, 23], [29, 19, 30, 35], [41, 6, 38, 23], [45, 23, 14, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.bk.1", "48.48.1.fl.1", "48.48.3.en.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.pv.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
