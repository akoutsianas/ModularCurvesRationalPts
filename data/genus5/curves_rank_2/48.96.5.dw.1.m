...
// Magma code for modular curve with label 48.96.5.dw.1

// Other names and/or labels
// Cummins-Pauli label: 16C5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.661

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 37, 30, 17], [37, 38, 28, 27], [41, 39, 26, 17], [47, 28, 40, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.r.1", "48.48.1.k.1", "48.48.3.w.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.dw.1
//   Coordinate number 0:
