...
// Magma code for modular curve with label 40.192.5.i.2

// Other names and/or labels
// Cummins-Pauli label: 8A5
// Rouse-Sutherland-Zureick-Brown label: 40.192.5.45

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 4, 0, 13], [15, 8, 36, 17], [21, 28, 24, 1], [21, 32, 16, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["8.96.3.f.1", "40.96.1.e.2", "40.96.1.h.1", "40.96.1.o.2", "40.96.3.o.1", "40.96.3.s.2", "40.96.3.v.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.192.5.i.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x+z);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
