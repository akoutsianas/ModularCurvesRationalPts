...
// Magma code for modular curve with label 40.144.5.hn.2

// Other names and/or labels
// Cummins-Pauli label: 40M5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.613

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 6, 16, 27], [7, 10, 20, 37], [15, 28, 12, 11], [29, 38, 8, 9], [39, 19, 0, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["40.72.1.v.2", "40.72.3.cc.2", "40.72.3.cf.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.hn.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
