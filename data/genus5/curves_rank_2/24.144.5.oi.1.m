...
// Magma code for modular curve with label 24.144.5.oi.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1304

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 1, 22, 23], [1, 2, 8, 5], [7, 0, 12, 23], [7, 10, 14, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.de.1", "24.72.2.t.1", "24.72.2.x.1", "24.72.2.fc.1", "24.72.2.gi.1", "24.72.3.bge.1", "24.72.3.bhk.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.oi.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
