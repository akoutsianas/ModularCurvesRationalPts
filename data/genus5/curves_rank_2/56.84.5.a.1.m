...
// Magma code for modular curve with label 56.84.5.a.1

// Other names and/or labels
// Cummins-Pauli label: 14B5
// Rouse-Sutherland-Zureick-Brown label: 56.84.5.20

// Group data
level := 56;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 17, 33, 16], [20, 27, 27, 3], [47, 44, 20, 9], [50, 35, 49, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 84;
...
covers := ["14.42.3.a.1", "56.42.1.a.1", "56.42.1.h.1"];
...
model_1 := [91*x^8-180*x^6*y^2-4*x^4*y^4-928*x^7*z+1864*x^5*y^2*z-16*x^3*y^4*z+1834*x^6*z^2-2460*x^4*y^2*z^2-24*x^2*y^4*z^2+1204*x^5*z^3-9168*x^3*y^2*z^3-16*x*y^4*z^3-4732*x^4*z^4-2764*x^2*y^2*z^4-4*y^4*z^4+2296*x^3*z^5+1736*x*y^2*z^5-154*x^2*z^6-164*y^2*z^6-28*x*z^7+z^8];
...
// Map from the canonical model to the plane model of modular curve with label 56.84.5.a.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y+3/14*t);
//   Coordinate number 1:
map_1_coord_1 := 1*(1/2*w);
//   Coordinate number 2:
map_1_coord_2 := 1*(2*z+5/14*t);
// Codomain equation:
map_1_codomain := [91*x^8-180*x^6*y^2-4*x^4*y^4-928*x^7*z+1864*x^5*y^2*z-16*x^3*y^4*z+1834*x^6*z^2-2460*x^4*y^2*z^2-24*x^2*y^4*z^2+1204*x^5*z^3-9168*x^3*y^2*z^3-16*x*y^4*z^3-4732*x^4*z^4-2764*x^2*y^2*z^4-4*y^4*z^4+2296*x^3*z^5+1736*x*y^2*z^5-154*x^2*z^6-164*y^2*z^6-28*x*z^7+z^8];
