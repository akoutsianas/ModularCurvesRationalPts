...
// Magma code for modular curve with label 48.96.5.bx.2

// Other names and/or labels
// Cummins-Pauli label: 16A5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.542

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 36, 24, 31], [13, 2, 24, 11], [23, 10, 28, 19], [41, 16, 0, 37], [45, 8, 16, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.f.2", "24.48.1.r.1", "48.48.3.f.2"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.bx.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
