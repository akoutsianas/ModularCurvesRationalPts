...
// Magma code for modular curve with label 48.96.5.oi.1

// Other names and/or labels
// Cummins-Pauli label: 16H5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.337

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 14, 38, 21], [11, 29, 32, 13], [25, 26, 26, 23], [47, 0, 34, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.bs.1", "48.48.2.bk.1", "48.48.3.de.1"];
...
// Canonical model
model_0 := [2*x*z+y*w-y*t,6*x^2+12*y^2+4*z^2+w^2-w*t,6*x^2-12*y^2+4*z^2+2*w^2-3*w*t-t^2];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.oi.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
