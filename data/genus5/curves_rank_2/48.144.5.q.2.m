...
// Magma code for modular curve with label 48.144.5.q.2

// Other names and/or labels
// Cummins-Pauli label: 48H5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.763

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 40, 32, 5], [5, 44, 40, 41], [15, 29, 22, 33], [23, 21, 6, 43], [37, 8, 28, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.2.hl.1", "48.72.0.a.2", "48.72.3.u.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.q.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.q.2
//   Coordinate number 0:
map_2_coord_0 := 1*(-u);
//   Coordinate number 1:
map_2_coord_1 := 1*(36*y*z^3*u^2-u^6);
//   Coordinate number 2:
map_2_coord_2 := 1*(-z);
// Codomain equation:
