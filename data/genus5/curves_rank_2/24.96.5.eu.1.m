...
// Magma code for modular curve with label 24.96.5.eu.1

// Other names and/or labels
// Cummins-Pauli label: 24K5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.217

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 5, 12, 23], [7, 0, 18, 1], [7, 21, 12, 5], [11, 22, 0, 23], [23, 4, 0, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.24.1.ds.1", "24.48.2.n.1", "24.48.2.r.1", "24.48.3.bu.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.eu.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
