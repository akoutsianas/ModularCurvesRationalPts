...
// Magma code for modular curve with label 24.144.5.ny.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.940

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 17, 20, 21], [5, 0, 12, 13], [11, 18, 12, 23], [23, 14, 2, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.dc.1", "24.72.2.u.1", "24.72.2.be.1", "24.72.2.ew.1", "24.72.2.ge.1", "24.72.3.bgc.1", "24.72.3.bhk.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.ny.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
