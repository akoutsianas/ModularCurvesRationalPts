...
// Magma code for modular curve with label 48.96.5.jt.2

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.410

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 7, 38, 9], [35, 37, 6, 13], [47, 23, 6, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.bv.1", "24.48.1.kw.2", "48.48.1.hg.1", "48.48.1.hm.2", "48.48.3.bk.2", "48.48.3.bt.2", "48.48.3.du.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.jt.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x+z);
//   Coordinate number 1:
