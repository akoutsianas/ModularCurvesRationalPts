...
// Magma code for modular curve with label 40.120.5.gd.1

// Other names and/or labels
// Cummins-Pauli label: 20F5
// Rouse-Sutherland-Zureick-Brown label: 40.120.5.85

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 5, 0, 17], [13, 26, 28, 27], [21, 8, 2, 23], [39, 10, 0, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.2.d.1", "40.60.2.n.1", "40.60.3.ce.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.120.5.gd.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
