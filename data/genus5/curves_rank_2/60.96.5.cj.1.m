...
// Magma code for modular curve with label 60.96.5.cj.1

// Other names and/or labels
// Cummins-Pauli label: 20D5
// Rouse-Sutherland-Zureick-Brown label: 60.96.5.98

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[2, 5, 5, 58], [43, 10, 34, 33], [47, 25, 9, 44]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["20.48.3.j.2", "60.24.1.be.2", "60.48.1.bz.1", "60.48.3.bf.1"];
...
// Canonical model
model_0 := [x^2-4*x*y+x*z+x*t+y^2+y*z-y*t-3*z^2+t^2,2*x^2+x*z-x*t+2*y^2+y*z+y*t+3*z^2+2*w^2-t^2,3*x*z-x*w+3*y*z+y*w-3*z^2+3*w^2-2*w*t];
...
// Map from the canonical model to the plane model of modular curve with label 60.96.5.cj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
