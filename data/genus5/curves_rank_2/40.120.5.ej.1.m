...
// Magma code for modular curve with label 40.120.5.ej.1

// Other names and/or labels
// Cummins-Pauli label: 10B5
// Rouse-Sutherland-Zureick-Brown label: 40.120.5.38

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 30, 30, 13], [7, 2, 28, 5], [13, 3, 30, 27], [39, 21, 12, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["10.60.2.e.1", "40.40.1.bp.1", "40.60.2.c.1", "40.60.3.bo.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.120.5.ej.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
