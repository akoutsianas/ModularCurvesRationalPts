...
// Magma code for modular curve with label 48.96.5.or.1

// Other names and/or labels
// Cummins-Pauli label: 48D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.730

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 7, 36, 29], [17, 32, 24, 11], [31, 34, 0, 1], [31, 40, 0, 7], [37, 15, 36, 35], [47, 15, 12, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.48.1.iw.1", "48.24.1.c.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.or.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
