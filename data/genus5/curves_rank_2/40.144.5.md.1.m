...
// Magma code for modular curve with label 40.144.5.md.1

// Other names and/or labels
// Cummins-Pauli label: 40L5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.287

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 9, 34, 25], [27, 5, 18, 19], [33, 31, 26, 3], [35, 4, 36, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.s.1", "40.72.3.fv.1", "40.72.3.fz.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.md.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
