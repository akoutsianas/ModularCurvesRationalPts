...
// Magma code for modular curve with label 24.144.5.hf.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.8

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 12, 18, 17], [11, 3, 18, 1], [11, 15, 0, 1], [19, 15, 0, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["6.72.1.b.1", "24.48.1.il.1", "24.72.1.t.1", "24.72.1.ce.1", "24.72.3.mt.1", "24.72.3.ql.1", "24.72.3.qp.1", "24.72.3.th.1"];
...
// Canonical model
model_0 := [x^2-x*y+y^2-z^2,x^2+2*w^2+x*t+t^2,x^2-x*z+2*y*z+z^2+x*t+t^2];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.hf.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
