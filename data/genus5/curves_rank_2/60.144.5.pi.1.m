...
// Magma code for modular curve with label 60.144.5.pi.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.896

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 25, 40, 43], [7, 35, 58, 9], [11, 25, 30, 59]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.y.1", "60.72.1.ca.2", "60.72.1.cm.1", "60.72.1.dx.1", "60.72.3.qy.1", "60.72.3.rq.1", "60.72.3.yx.2"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.pi.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
