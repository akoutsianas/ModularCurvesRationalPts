...
// Magma code for modular curve with label 40.144.5.do.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.496

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 9, 8, 13], [27, 15, 36, 21], [29, 17, 26, 5], [33, 13, 26, 25], [33, 24, 4, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.i.2", "40.72.1.g.2", "40.72.1.u.1", "40.72.1.co.2", "40.72.3.bh.1", "40.72.3.cp.1", "40.72.3.ex.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.do.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
