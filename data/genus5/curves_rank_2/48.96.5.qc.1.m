...
// Magma code for modular curve with label 48.96.5.qc.1

// Other names and/or labels
// Cummins-Pauli label: 16E5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.240

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 41, 38, 15], [21, 29, 40, 11], [31, 47, 10, 9], [47, 41, 40, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.bp.1", "48.48.1.fn.1", "48.48.3.en.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.qc.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*z);
