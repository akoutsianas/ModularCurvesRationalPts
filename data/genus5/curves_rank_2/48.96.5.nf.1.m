...
// Magma code for modular curve with label 48.96.5.nf.1

// Other names and/or labels
// Cummins-Pauli label: 16H5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.668

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 4, 6, 47], [11, 15, 12, 37], [37, 20, 8, 21], [41, 7, 32, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.cf.1", "48.48.2.bc.1", "48.48.2.bn.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.nf.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
