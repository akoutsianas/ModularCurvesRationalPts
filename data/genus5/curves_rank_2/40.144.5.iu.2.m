...
// Magma code for modular curve with label 40.144.5.iu.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.18

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 20, 22, 39], [21, 38, 10, 19], [29, 39, 10, 3], [35, 16, 6, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["10.72.1.b.2", "40.72.1.bl.1", "40.72.1.cs.2", "40.72.3.cv.1", "40.72.3.dl.2", "40.72.3.dy.1", "40.72.3.ew.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.iu.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
