...
// Magma code for modular curve with label 60.144.5.qd.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.922

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 55, 32, 37], [19, 50, 0, 47], [23, 20, 50, 21], [57, 35, 8, 47]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.bn.1", "60.72.1.ce.2", "60.72.1.ci.1", "60.72.1.ed.2", "60.72.3.qw.2", "60.72.3.ra.2", "60.72.3.rw.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.qd.2
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*w);
