...
// Magma code for modular curve with label 24.144.5.ui.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1257

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 16, 20, 19], [19, 18, 18, 1], [21, 10, 22, 3], [21, 19, 20, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.du.1", "24.72.2.da.1", "24.72.2.dn.1", "24.72.2.fs.1", "24.72.2.gq.1", "24.72.3.bdo.1", "24.72.3.bem.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.ui.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
