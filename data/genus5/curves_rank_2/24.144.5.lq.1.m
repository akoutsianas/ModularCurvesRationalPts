...
// Magma code for modular curve with label 24.144.5.lq.1

// Other names and/or labels
// Cummins-Pauli label: 12D5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.124

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 8, 14, 15], [9, 14, 20, 9], [21, 2, 8, 21], [21, 22, 10, 3], [23, 15, 18, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.1.v.1", "24.72.3.zp.1", "24.72.3.zq.1"];
...
// Canonical model
model_0 := [y*t+z*w,y^2+y*z+z^2+w*t,6*x^2+3*y*z-2*y*w-2*z*t-w^2-w*t-t^2];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.lq.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
