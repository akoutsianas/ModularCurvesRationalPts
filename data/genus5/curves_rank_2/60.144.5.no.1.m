...
// Magma code for modular curve with label 60.144.5.no.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.606

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 40, 26, 23], [49, 15, 28, 11], [57, 5, 28, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.q.1", "60.72.1.bt.2", "60.72.1.cl.1", "60.72.3.oj.1", "60.72.3.os.1", "60.72.3.rd.2", "60.72.3.yf.2"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.no.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
