...
// Magma code for modular curve with label 24.144.5.nf.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.858

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 7, 14, 13], [11, 6, 6, 17], [21, 4, 16, 9], [23, 13, 14, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.dj.1", "24.72.2.n.1", "24.72.2.bx.1", "24.72.2.ev.1", "24.72.2.fs.1", "24.72.3.bga.1", "24.72.3.bgz.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.nf.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
