...
// Magma code for modular curve with label 60.144.5.kk.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.925

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 50, 6, 47], [21, 55, 4, 37], [39, 50, 58, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.bj.1", "60.72.1.v.1", "60.72.1.ci.1", "60.72.1.dq.1", "60.72.3.mz.2", "60.72.3.oo.1", "60.72.3.ra.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.kk.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
