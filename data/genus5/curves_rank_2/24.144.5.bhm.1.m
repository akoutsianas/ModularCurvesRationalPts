...
// Magma code for modular curve with label 24.144.5.bhm.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.885

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 5, 14, 17], [13, 12, 6, 19], [17, 8, 4, 5], [19, 11, 20, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.ff.1", "24.72.2.ee.1", "24.72.2.ei.1", "24.72.2.it.1", "24.72.2.ji.1", "24.72.3.bhe.1", "24.72.3.bhv.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.bhm.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
