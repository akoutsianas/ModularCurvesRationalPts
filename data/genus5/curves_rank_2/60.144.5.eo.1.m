...
// Magma code for modular curve with label 60.144.5.eo.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.136

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 58, 52, 7], [37, 50, 12, 11], [56, 43, 19, 4], [58, 47, 47, 2]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.1.g.1", "60.72.1.bh.1", "60.72.1.el.1", "60.72.3.gi.1", "60.72.3.hy.1", "60.72.3.le.1", "60.72.3.uq.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.eo.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x-z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
