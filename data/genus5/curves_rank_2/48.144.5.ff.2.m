...
// Magma code for modular curve with label 48.144.5.ff.2

// Other names and/or labels
// Cummins-Pauli label: 48F5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.69

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 5, 22, 25], [3, 41, 46, 3], [17, 32, 16, 41], [23, 39, 18, 31], [37, 9, 6, 35], [39, 7, 34, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['3.3.0.a.1', '16.48.1.cx.2']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["16.48.1.cx.2", "24.72.2.hp.2", "48.72.0.c.1", "48.72.3.bf.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.ff.2
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(v);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.ff.2
//   Coordinate number 0:
map_2_coord_0 := 1*(t);
//   Coordinate number 1:
