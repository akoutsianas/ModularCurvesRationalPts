...
// Magma code for modular curve with label 40.144.5.gj.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.90

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 21, 14, 29], [23, 1, 30, 29], [37, 35, 24, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.j.1", "40.72.1.w.2", "40.72.1.cg.1", "40.72.3.bu.1", "40.72.3.ct.1", "40.72.3.dd.1", "40.72.3.en.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.gj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x-w);
//   Coordinate number 1:
