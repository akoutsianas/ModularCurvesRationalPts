...
// Magma code for modular curve with label 48.96.5.cp.1

// Other names and/or labels
// Cummins-Pauli label: 16B5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.699

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 29, 10, 3], [29, 21, 40, 11], [33, 38, 20, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.g.1", "24.48.1.dg.1", "48.48.1.hr.1", "48.48.1.hz.1", "48.48.3.m.1", "48.48.3.fe.1", "48.48.3.fm.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.cp.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
