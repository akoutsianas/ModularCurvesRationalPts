...
// Magma code for modular curve with label 24.72.5.na.1

// Other names and/or labels
// Cummins-Pauli label: 24F5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.384

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 22, 10, 23], [5, 13, 2, 23], [13, 0, 12, 17], [13, 13, 4, 23], [23, 18, 12, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.gs.1", "24.36.2.gc.1", "24.36.2.gm.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.5.na.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
