...
// Magma code for modular curve with label 40.90.5.d.1

// Other names and/or labels
// Cummins-Pauli label: 20C5
// Rouse-Sutherland-Zureick-Brown label: 40.90.5.3

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 9, 0, 39], [9, 21, 22, 31], [11, 22, 38, 19], [33, 0, 10, 13], [33, 32, 20, 39]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 90;
...
// Map from the canonical model to the plane model of modular curve with label 40.90.5.d.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
