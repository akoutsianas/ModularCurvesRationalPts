...
// Magma code for modular curve with label 24.72.5.bd.1

// Other names and/or labels
// Cummins-Pauli label: 24A5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.246

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 20, 4, 1], [1, 22, 2, 7], [5, 7, 8, 11], [7, 3, 18, 5], [9, 23, 2, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.24.1.h.1", "24.36.0.cf.1", "24.36.2.x.1", "24.36.3.h.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.5.bd.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.5.bd.1
//   Coordinate number 0:
map_2_coord_0 := 1*(t);
//   Coordinate number 1:
