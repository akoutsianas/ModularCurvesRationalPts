...
// Magma code for modular curve with label 30.120.5.bh.1

// Other names and/or labels
// Cummins-Pauli label: 30Q5
// Rouse-Sutherland-Zureick-Brown label: 30.120.5.29

// Group data
level := 30;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 25, 25, 24], [18, 11, 23, 12], [25, 2, 13, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["15.60.2.a.1", "30.60.2.j.1", "30.60.3.o.1"];
...
// Map from the canonical model to the plane model of modular curve with label 30.120.5.bh.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
