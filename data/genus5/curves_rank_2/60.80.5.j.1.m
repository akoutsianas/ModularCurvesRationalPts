...
// Magma code for modular curve with label 60.80.5.j.1

// Other names and/or labels
// Cummins-Pauli label: 30I5
// Rouse-Sutherland-Zureick-Brown label: 60.80.5.7

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[4, 55, 57, 16], [17, 5, 30, 37], [37, 1, 15, 58], [43, 36, 18, 37], [44, 15, 15, 14]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 80;
...
;// CM discriminants
CM_discs := [-12];
// Modular curve is a fiber product of the following curvesfactors := ['3.4.0.a.1', '20.20.0.d.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["15.40.2.a.1", "20.20.0.d.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.80.5.j.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
