...
// Magma code for modular curve with label 24.144.5.uq.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1208

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 3, 18, 7], [19, 9, 18, 17], [23, 11, 2, 1], [23, 14, 10, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.ds.1", "24.72.2.df.1", "24.72.2.dr.1", "24.72.2.fg.1", "24.72.2.gu.1", "24.72.3.bdk.1", "24.72.3.bey.1"];
...
//   Coordinate number 0:
map_0_coord_0 := 1*(4*x-8*y+2*t);
//   Coordinate number 1:
map_0_coord_1 := 1*(-2*x+4*y-2*t);
//   Coordinate number 2:
map_0_coord_2 := 1*(w);
// Codomain equation:
map_0_codomain := [6*x^4+6*x^3*y-15*x^2*y^2-12*x*y^3+6*y^4+12*x^2*z^2+12*x*y*z^2-6*y^2*z^2+4*z^4];

// Map from the canonical model to the plane model of modular curve with label 24.144.5.uq.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
