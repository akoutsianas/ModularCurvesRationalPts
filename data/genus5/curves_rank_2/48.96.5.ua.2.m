...
// Magma code for modular curve with label 48.96.5.ua.2

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.225

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[29, 4, 16, 33], [31, 9, 38, 13], [31, 30, 32, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.cv.2", "24.48.1.kx.2", "48.48.1.it.1", "48.48.3.dt.1", "48.48.3.ew.2", "48.48.3.ey.1", "48.48.3.gc.2"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.ua.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
