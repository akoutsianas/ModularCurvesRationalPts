...
// Magma code for modular curve with label 24.144.5.tf.1

// Other names and/or labels
// Cummins-Pauli label: 24S5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.998

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 6, 6, 7], [15, 11, 10, 9], [15, 20, 10, 21], [23, 3, 18, 5], [23, 6, 6, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.cq.1", "24.72.3.bch.1", "24.72.3.bft.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.tf.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
