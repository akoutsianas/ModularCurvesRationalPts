...
// Magma code for modular curve with label 24.144.5.uk.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.982

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 2, 4, 1], [13, 23, 14, 11], [15, 13, 20, 9], [23, 23, 2, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.dv.1", "24.72.2.di.1", "24.72.2.do.1", "24.72.2.fs.1", "24.72.2.go.1", "24.72.3.bds.1", "24.72.3.beo.1"];
...
// Canonical model
model_0 := [x*z+x*w-2*y*z+y*w,3*x^2-3*x*y+z^2+2*z*w+w^2-3*t^2,2*x^2-2*x*y-y^2+4*z^2-4*z*w+4*w^2];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.uk.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
map_1_coord_1 := 1*(6*z);
