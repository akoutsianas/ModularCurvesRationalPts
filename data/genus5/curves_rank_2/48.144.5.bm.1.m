...
// Magma code for modular curve with label 48.144.5.bm.1

// Other names and/or labels
// Cummins-Pauli label: 48F5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.739

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 1, 38, 45], [15, 17, 14, 45], [25, 32, 32, 5], [35, 46, 40, 13], [37, 21, 6, 35]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.2.hj.2", "48.48.1.hm.2", "48.72.0.a.2", "48.72.3.bf.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.bm.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.bm.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-r);
//   Coordinate number 1:
