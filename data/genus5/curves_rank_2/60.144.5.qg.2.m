...
// Magma code for modular curve with label 60.144.5.qg.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.649

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 50, 44, 31], [19, 25, 18, 59], [23, 45, 38, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.s.2", "60.72.1.cl.2", "60.72.1.cr.1", "60.72.3.re.2", "60.72.3.rj.2", "60.72.3.ru.1", "60.72.3.zb.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.qg.2
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
