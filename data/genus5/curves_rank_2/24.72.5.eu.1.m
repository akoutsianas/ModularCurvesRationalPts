...
// Magma code for modular curve with label 24.72.5.eu.1

// Other names and/or labels
// Cummins-Pauli label: 24B5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.254

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 16, 16, 17], [5, 12, 0, 1], [7, 13, 8, 1], [7, 22, 22, 17], [15, 14, 4, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.24.1.bk.1", "24.36.1.fq.1", "24.36.1.fy.1", "24.36.3.d.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.5.eu.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x-y);
//   Coordinate number 1:
