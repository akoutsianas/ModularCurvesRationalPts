...
// Magma code for modular curve with label 48.96.5.tx.2

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.209

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 11, 18, 19], [33, 28, 8, 45], [37, 37, 38, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.cw.2", "24.48.1.ku.2", "48.48.1.it.1", "48.48.3.ds.1", "48.48.3.ev.2", "48.48.3.fa.1", "48.48.3.gb.2"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.tx.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
