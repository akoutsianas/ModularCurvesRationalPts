...
// Magma code for modular curve with label 24.96.5.h.1

// Other names and/or labels
// Cummins-Pauli label: 24I5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.62

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 12, 12, 17], [1, 20, 12, 13], [11, 10, 12, 7], [13, 10, 12, 7], [17, 6, 12, 11], [17, 20, 0, 13], [23, 20, 0, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["12.48.1.b.1", "24.24.1.d.1", "24.48.3.bs.1", "24.48.3.cj.1"];
...
model_1 := [2*x^8-7*x^6*y*z+3*x^4*y^2*z^2+8*x^2*y^3*z^3-36*x^2*y*z^5-4*y^4*z^4+36*y^2*z^6];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.h.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Codomain equation:
map_1_codomain := [2*x^8-7*x^6*y*z+3*x^4*y^2*z^2+8*x^2*y^3*z^3-36*x^2*y*z^5-4*y^4*z^4+36*y^2*z^6];
