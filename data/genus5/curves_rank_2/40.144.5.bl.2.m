...
// Magma code for modular curve with label 40.144.5.bl.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.393

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 9, 12, 15], [25, 23, 28, 25], [25, 24, 26, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.z.2", "40.72.1.f.2", "40.72.1.bk.2", "40.72.1.cg.2", "40.72.3.i.1", "40.72.3.k.1", "40.72.3.el.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.bl.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
