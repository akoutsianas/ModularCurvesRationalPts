...
// Magma code for modular curve with label 24.72.5.bs.1

// Other names and/or labels
// Cummins-Pauli label: 24F5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.309

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 4, 4, 23], [9, 7, 10, 3], [11, 0, 0, 19], [23, 14, 4, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.gn.1", "24.36.2.ba.1", "24.36.2.gl.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.5.bs.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
