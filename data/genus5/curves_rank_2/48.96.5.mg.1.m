...
// Magma code for modular curve with label 48.96.5.mg.1

// Other names and/or labels
// Cummins-Pauli label: 16F5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.367

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 43, 10, 15], [17, 35, 28, 15], [25, 31, 36, 47], [39, 44, 4, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.ce.1", "24.48.1.mg.1", "48.48.1.gp.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.mg.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
