...
// Magma code for modular curve with label 60.72.5.cd.1

// Other names and/or labels
// Cummins-Pauli label: 30H5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.108

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[20, 53, 29, 31], [23, 4, 13, 37], [35, 39, 18, 19], [51, 28, 2, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["30.36.1.o.1", "60.12.1.t.1", "60.36.1.do.1", "60.36.3.d.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.72.5.cd.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w+t);
