...
// Magma code for modular curve with label 24.72.5.le.1

// Other names and/or labels
// Cummins-Pauli label: 24G5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.344

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 23, 4, 9], [17, 2, 4, 5], [19, 0, 6, 1], [19, 17, 14, 17], [23, 16, 10, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fv.1", "24.36.1.gc.1", "24.36.3.g.1"];
...
model_1 := [6*x^8-42*x^6*y^2+36*x^4*y^4+27*x^6*z^2-42*x^4*y^2*z^2+47*x^4*z^4+38*x^2*z^6+12*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.5.le.1
//   Coordinate number 0:
...
// Codomain equation:
map_1_codomain := [6*x^8-42*x^6*y^2+36*x^4*y^4+27*x^6*z^2-42*x^4*y^2*z^2+47*x^4*z^4+38*x^2*z^6+12*z^8];
