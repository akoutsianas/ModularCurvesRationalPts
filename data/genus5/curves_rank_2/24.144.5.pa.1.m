...
// Magma code for modular curve with label 24.144.5.pa.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.950

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 19, 2, 19], [5, 11, 14, 19], [7, 7, 10, 17], [17, 15, 0, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.df.1", "24.72.2.be.1", "24.72.2.bk.1", "24.72.2.fk.1", "24.72.2.go.1", "24.72.3.bgq.1", "24.72.3.bhu.1"];
...
//   Coordinate number 0:
map_0_coord_0 := 1*(6*x+6*y+2*t);
//   Coordinate number 1:
map_0_coord_1 := 1*(-6*x-6*y-4*t);
//   Coordinate number 2:
map_0_coord_2 := 1*(-z-w);
// Codomain equation:
map_0_codomain := [2*x^4-4*x^3*y-5*x^2*y^2+2*x*y^3+2*y^4+6*x^2*z^2-12*x*y*z^2-12*y^2*z^2+12*z^4];

// Map from the canonical model to the plane model of modular curve with label 24.144.5.pa.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
