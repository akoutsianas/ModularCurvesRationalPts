...
// Magma code for modular curve with label 24.72.5.lz.1

// Other names and/or labels
// Cummins-Pauli label: 24G5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.352

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 9, 6, 13], [11, 13, 14, 17], [17, 2, 10, 11], [19, 17, 2, 5], [23, 3, 18, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.gb.1", "24.36.1.gh.1", "24.36.3.h.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.5.lz.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
