...
// Magma code for modular curve with label 60.96.5.cl.2

// Other names and/or labels
// Cummins-Pauli label: 20D5
// Rouse-Sutherland-Zureick-Brown label: 60.96.5.61

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[14, 5, 9, 2], [38, 35, 31, 29], [57, 50, 35, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["20.48.1.b.1", "30.24.1.j.1", "60.48.3.be.1", "60.48.3.co.2"];
...
// Canonical model
model_0 := [4*x^2+x*y+x*z+y^2+2*z*t+w^2,x*z+x*w+2*y*w+3*z^2+2*z*t+w^2,x^2+2*x*y+2*x*t+2*y^2-2*z^2+2*w^2+2*t^2];
...
// Map from the canonical model to the plane model of modular curve with label 60.96.5.cl.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
