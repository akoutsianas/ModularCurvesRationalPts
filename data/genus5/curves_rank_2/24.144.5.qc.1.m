...
// Magma code for modular curve with label 24.144.5.qc.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1314

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 1, 2, 19], [1, 15, 18, 11], [17, 23, 16, 11], [19, 8, 10, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.di.1", "24.72.2.bn.1", "24.72.2.cc.1", "24.72.2.gj.1", "24.72.2.go.1", "24.72.3.bhk.1", "24.72.3.bhr.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.qc.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
