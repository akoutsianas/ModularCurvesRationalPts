...
// Magma code for modular curve with label 48.96.5.cn.1

// Other names and/or labels
// Cummins-Pauli label: 16B5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.700

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 26, 2, 9], [21, 28, 2, 7], [31, 37, 10, 41]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.g.1", "24.48.1.de.1", "48.48.1.hp.1", "48.48.1.hx.1", "48.48.3.m.2", "48.48.3.fc.1", "48.48.3.fk.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.cn.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
