...
// Magma code for modular curve with label 48.144.5.w.2

// Other names and/or labels
// Cummins-Pauli label: 48H5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.772

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 20, 40, 17], [7, 35, 2, 29], [11, 20, 20, 37], [27, 7, 2, 33], [35, 0, 36, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.2.hk.2", "48.72.0.a.2", "48.72.3.x.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.w.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.w.2
//   Coordinate number 0:
