...
// Magma code for modular curve with label 40.144.5.bc.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.540

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 17, 30, 19], [7, 25, 28, 39], [9, 5, 38, 21], [9, 35, 26, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.q.2", "40.72.1.e.2", "40.72.1.p.2", "40.72.1.cp.2", "40.72.3.g.1", "40.72.3.l.2", "40.72.3.fa.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.bc.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x+w);
//   Coordinate number 1:
