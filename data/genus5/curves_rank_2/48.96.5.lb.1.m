...
// Magma code for modular curve with label 48.96.5.lb.1

// Other names and/or labels
// Cummins-Pauli label: 16E5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.478

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[21, 35, 32, 23], [31, 43, 40, 33], [37, 41, 16, 27], [43, 13, 18, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.bn.1", "48.48.1.fk.1", "48.48.1.fm.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.lb.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
