...
// Magma code for modular curve with label 60.96.5.cm.1

// Other names and/or labels
// Cummins-Pauli label: 20D5
// Rouse-Sutherland-Zureick-Brown label: 60.96.5.66

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[44, 25, 47, 53], [47, 30, 10, 37], [59, 25, 16, 57]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["20.48.1.a.2", "60.24.1.bg.2", "60.48.3.bf.1", "60.48.3.co.1"];
...
// Canonical model
model_0 := [x^2+3*x*y+x*t+y^2-y*t+5*z^2+w^2-t^2,5*x^2-5*x*y+x*w+5*y^2-y*w+5*z^2-2*w*t,x^2+3*x*y-5*x*z-x*w+x*t+y^2-5*y*z+y*w-y*t+4*w^2+2*w*t-t^2];
...
// Map from the canonical model to the plane model of modular curve with label 60.96.5.cm.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x-y);
//   Coordinate number 1:
map_1_coord_1 := 1*(5*z);
