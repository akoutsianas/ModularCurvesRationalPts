...
// Magma code for modular curve with label 60.144.5.ql.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.575

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 45, 30, 17], [23, 15, 36, 37], [29, 10, 32, 9], [49, 45, 24, 43]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.v.2", "30.72.1.j.2", "60.72.1.cp.1", "60.72.3.re.2", "60.72.3.ri.2", "60.72.3.rw.1", "60.72.3.zc.1"];
...
// Canonical model
model_0 := [x*w-2*y*w+w^2+t^2,x*y-y^2-x*z+z^2-w^2-t^2,4*x^2-x*y+y^2+w^2];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.ql.2
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
