...
// Magma code for modular curve with label 40.144.5.jl.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.542

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 31, 4, 5], [7, 1, 6, 17], [33, 15, 16, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.ba.2", "40.72.1.bg.2", "40.72.1.bq.1", "40.72.1.cp.2", "40.72.3.db.1", "40.72.3.ec.1", "40.72.3.ex.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.jl.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+t);
//   Coordinate number 1:
