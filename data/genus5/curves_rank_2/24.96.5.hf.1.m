...
// Magma code for modular curve with label 24.96.5.hf.1

// Other names and/or labels
// Cummins-Pauli label: 24J5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.184

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 4, 6, 19], [1, 13, 18, 11], [7, 2, 18, 17], [17, 5, 0, 23], [17, 18, 0, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.24.0.eh.1", "24.48.2.o.1", "24.48.2.s.1", "24.48.3.ck.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.hf.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
