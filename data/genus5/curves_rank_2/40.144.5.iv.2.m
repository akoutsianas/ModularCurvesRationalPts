...
// Magma code for modular curve with label 40.144.5.iv.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.450

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 20, 10, 23], [17, 26, 24, 39], [31, 27, 20, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.v.1", "40.72.1.y.1", "40.72.1.bm.1", "40.72.1.cr.2", "40.72.3.dk.2", "40.72.3.dy.1", "40.72.3.ex.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.iv.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
