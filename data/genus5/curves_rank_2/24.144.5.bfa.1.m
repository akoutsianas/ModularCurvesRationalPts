...
// Magma code for modular curve with label 24.144.5.bfa.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1094

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 17, 22, 9], [7, 20, 14, 17], [11, 2, 4, 11], [13, 15, 18, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.fc.1", "24.72.2.cw.1", "24.72.2.dz.1", "24.72.2.hq.1", "24.72.2.ij.1", "24.72.3.bgh.1", "24.72.3.bgy.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.bfa.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
