...
// Magma code for modular curve with label 40.144.5.iu.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.5

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 8, 0, 9], [13, 1, 20, 29], [25, 36, 6, 5], [35, 9, 22, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["10.72.1.b.1", "40.72.1.bl.2", "40.72.1.cs.1", "40.72.3.cv.2", "40.72.3.dl.1", "40.72.3.dy.1", "40.72.3.ew.2"];
...
model_1 := [25*x^8-75*x^6*y^2+25*x^4*y^4-140*x^6*z^2+160*x^4*y^2*z^2+236*x^4*z^4-60*x^2*y^2*z^4-112*x^2*z^6+16*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.iu.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y+t);
...
map_1_coord_2 := 1*(w);
// Codomain equation:
map_1_codomain := [25*x^8-75*x^6*y^2+25*x^4*y^4-140*x^6*z^2+160*x^4*y^2*z^2+236*x^4*z^4-60*x^2*y^2*z^4-112*x^2*z^6+16*z^8];
