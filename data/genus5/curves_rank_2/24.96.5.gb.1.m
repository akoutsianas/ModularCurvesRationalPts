...
// Magma code for modular curve with label 24.96.5.gb.1

// Other names and/or labels
// Cummins-Pauli label: 24I5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.211

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 14, 12, 5], [5, 9, 0, 19], [5, 11, 12, 7], [7, 1, 6, 17], [13, 14, 18, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.24.1.en.1", "24.48.1.jj.1", "24.48.3.bu.1", "24.48.3.co.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.gb.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
