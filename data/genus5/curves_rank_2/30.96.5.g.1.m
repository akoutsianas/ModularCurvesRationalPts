...
// Magma code for modular curve with label 30.96.5.g.1

// Other names and/or labels
// Cummins-Pauli label: 30N5
// Rouse-Sutherland-Zureick-Brown label: 30.96.5.9

// Group data
level := 30;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 12, 3, 25], [13, 8, 18, 25], [23, 8, 27, 23], [26, 15, 3, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["15.48.1.a.1", "30.24.1.i.1", "30.48.3.d.1", "30.48.3.e.2"];
...
map_0_coord_0 := 1*(-5*x);
//   Coordinate number 1:
map_0_coord_1 := 1*(5*x-2*y-z-4*w);
//   Coordinate number 2:
map_0_coord_2 := 1*(5*x+y-2*z+2*w);
// Codomain equation:
...
// Map from the canonical model to the plane model of modular curve with label 30.96.5.g.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
