...
// Magma code for modular curve with label 24.96.5.gn.1

// Other names and/or labels
// Cummins-Pauli label: 24J5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.172

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 12, 12, 17], [1, 14, 18, 19], [7, 10, 0, 11], [11, 8, 6, 1], [23, 23, 18, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.24.0.dp.1", "24.48.2.j.1", "24.48.2.m.1", "24.48.3.ck.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.gn.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
