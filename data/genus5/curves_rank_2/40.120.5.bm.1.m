...
// Magma code for modular curve with label 40.120.5.bm.1

// Other names and/or labels
// Cummins-Pauli label: 20E5
// Rouse-Sutherland-Zureick-Brown label: 40.120.5.104

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 27, 22, 35], [21, 30, 14, 29], [23, 6, 18, 17], [33, 24, 6, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.2.e.1", "40.60.2.c.1", "40.60.3.c.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.120.5.bm.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
