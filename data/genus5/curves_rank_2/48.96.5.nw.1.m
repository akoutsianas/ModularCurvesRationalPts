...
// Magma code for modular curve with label 48.96.5.nw.1

// Other names and/or labels
// Cummins-Pauli label: 16H5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.680

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 30, 36, 41], [15, 17, 2, 5], [27, 26, 14, 5], [41, 18, 12, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.cg.1", "48.48.2.bn.1", "48.48.2.bs.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.nw.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
