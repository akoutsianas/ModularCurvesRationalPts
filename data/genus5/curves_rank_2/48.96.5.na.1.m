...
// Magma code for modular curve with label 48.96.5.na.1

// Other names and/or labels
// Cummins-Pauli label: 16H5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.327

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 36, 34, 41], [9, 41, 28, 47], [33, 25, 4, 7], [37, 35, 30, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.w.1", "48.48.2.bn.1", "48.48.3.de.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.na.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
