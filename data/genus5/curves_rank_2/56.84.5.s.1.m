...
// Magma code for modular curve with label 56.84.5.s.1

// Other names and/or labels
// Cummins-Pauli label: 14B5
// Rouse-Sutherland-Zureick-Brown label: 56.84.5.46

// Group data
level := 56;
// Elements that, together with Gamma(level), generate the group
gens := [[31, 6, 41, 35], [34, 39, 7, 22], [44, 19, 47, 52], [45, 31, 27, 18]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 84;
...
covers := ["28.42.3.a.1", "56.42.1.c.1", "56.42.1.e.1"];
...
// Map from the canonical model to the plane model of modular curve with label 56.84.5.s.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
