...
// Magma code for modular curve with label 48.144.5.bj.2

// Other names and/or labels
// Cummins-Pauli label: 48F5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.333

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 45, 30, 35], [29, 37, 38, 41], [35, 43, 34, 31], [37, 0, 0, 25], [45, 25, 46, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.2.hp.2", "48.48.1.hj.2", "48.72.0.a.1", "48.72.3.bd.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.bj.2
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.bj.2
//   Coordinate number 0:
map_2_coord_0 := 1*(-u);
//   Coordinate number 1:
