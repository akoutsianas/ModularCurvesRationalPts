...
// Magma code for modular curve with label 16.96.5.dt.1

// Other names and/or labels
// Cummins-Pauli label: 16F5
// Rouse-Sutherland-Zureick-Brown label: 16.96.5.17

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 4, 12, 13], [9, 15, 4, 7], [15, 6, 6, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.bs.1", "16.48.1.ce.1", "16.48.3.cd.1"];
...
// Map from the canonical model to the plane model of modular curve with label 16.96.5.dt.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
