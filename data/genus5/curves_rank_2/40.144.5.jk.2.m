...
// Magma code for modular curve with label 40.144.5.jk.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.63

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 17, 14, 33], [13, 13, 32, 39], [25, 36, 24, 7], [35, 11, 36, 35]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.m.1", "40.72.1.bf.2", "40.72.1.co.1", "40.72.3.dc.1", "40.72.3.dm.1", "40.72.3.ec.1", "40.72.3.ew.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.jk.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
