...
// Magma code for modular curve with label 56.112.5.bm.1

// Other names and/or labels
// Cummins-Pauli label: 14E5
// Rouse-Sutherland-Zureick-Brown label: 56.112.5.25

// Group data
level := 56;
// Elements that, together with Gamma(level), generate the group
gens := [[4, 3, 3, 54], [41, 48, 17, 29], [49, 43, 8, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 112;
...
covers := ["28.56.1.d.1", "56.56.1.d.1", "56.56.3.c.1"];
...
model_1 := [3*x^8-189*x^6*y^2-3969*x^4*y^4-104*x^7*z+1386*x^5*y^2*z+68796*x^3*y^4*z+1148*x^6*z^2+14385*x^4*y^2*z^2-447174*x^2*y^4*z^2-4200*x^5*z^3-207508*x^3*y^2*z^3+1291836*x*y^4*z^3-11214*x^4*z^4+935473*x^2*y^2*z^4-1399489*y^4*z^4+142184*x^3*z^5-1810718*x*y^2*z^5-457604*x^2*z^6+1226771*y^2*z^6+622952*x*z^7-292861*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 56.112.5.bm.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+w+5/2*t);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*z);
//   Coordinate number 2:
map_1_coord_2 := 1*(y-1/2*w+1/2*t);
// Codomain equation:
map_1_codomain := [3*x^8-189*x^6*y^2-3969*x^4*y^4-104*x^7*z+1386*x^5*y^2*z+68796*x^3*y^4*z+1148*x^6*z^2+14385*x^4*y^2*z^2-447174*x^2*y^4*z^2-4200*x^5*z^3-207508*x^3*y^2*z^3+1291836*x*y^4*z^3-11214*x^4*z^4+935473*x^2*y^2*z^4-1399489*y^4*z^4+142184*x^3*z^5-1810718*x*y^2*z^5-457604*x^2*z^6+1226771*y^2*z^6+622952*x*z^7-292861*z^8];
