...
// Magma code for modular curve with label 48.96.5.eg.1

// Other names and/or labels
// Cummins-Pauli label: 16B5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.82

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 45, 42, 19], [21, 28, 8, 5], [27, 32, 46, 37], [39, 35, 8, 45], [47, 47, 16, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.bg.1", "48.48.1.gz.1", "48.48.1.ha.1", "48.48.3.bf.2", "48.48.3.bg.1", "48.48.3.em.1", "48.48.3.en.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.eg.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y-2*z-1/2*t);
//   Coordinate number 1:
map_1_coord_1 := 1*(4*x);
//   Coordinate number 2:
