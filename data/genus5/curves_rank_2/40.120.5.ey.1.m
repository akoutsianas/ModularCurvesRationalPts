...
// Magma code for modular curve with label 40.120.5.ey.1

// Other names and/or labels
// Cummins-Pauli label: 20E5
// Rouse-Sutherland-Zureick-Brown label: 40.120.5.96

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 3, 38, 35], [7, 11, 34, 23], [19, 3, 14, 1], [39, 34, 10, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.2.g.1", "40.60.2.c.1", "40.60.3.br.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.120.5.ey.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
