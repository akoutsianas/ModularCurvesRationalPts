...
// Magma code for modular curve with label 48.96.5.lf.1

// Other names and/or labels
// Cummins-Pauli label: 16E5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.470

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[21, 44, 22, 43], [21, 47, 38, 27], [25, 29, 30, 31], [41, 32, 22, 47]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.br.1", "48.48.1.fk.1", "48.48.1.fl.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.lf.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
