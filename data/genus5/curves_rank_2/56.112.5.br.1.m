...
// Magma code for modular curve with label 56.112.5.br.1

// Other names and/or labels
// Cummins-Pauli label: 14E5
// Rouse-Sutherland-Zureick-Brown label: 56.112.5.7

// Group data
level := 56;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 41, 34, 41], [3, 8, 29, 15], [3, 22, 35, 25], [50, 27, 27, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 112;
...
covers := ["7.56.1.b.1", "56.56.1.g.1", "56.56.3.d.1"];
...
model_1 := [26*x^8+7616*x^6*y^2-50176*x^4*y^4+389*x^7*z+2688*x^5*y^2*z+50176*x^3*y^4*z+329*x^6*z^2+24780*x^4*y^2*z^2-18816*x^2*y^4*z^2+497*x^5*z^3+26726*x^3*y^2*z^3+3136*x*y^4*z^3+959*x^4*z^4-9366*x^2*y^2*z^4-196*y^4*z^4-3241*x^3*z^5-1974*x*y^2*z^5-4627*x^2*z^6+560*y^2*z^6-997*x*z^7+104*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 56.112.5.br.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x-2/3*w-2/3*t);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
//   Coordinate number 2:
map_1_coord_2 := 1*(z+1/3*w+1/3*t);
// Codomain equation:
map_1_codomain := [26*x^8+7616*x^6*y^2-50176*x^4*y^4+389*x^7*z+2688*x^5*y^2*z+50176*x^3*y^4*z+329*x^6*z^2+24780*x^4*y^2*z^2-18816*x^2*y^4*z^2+497*x^5*z^3+26726*x^3*y^2*z^3+3136*x*y^4*z^3+959*x^4*z^4-9366*x^2*y^2*z^4-196*y^4*z^4-3241*x^3*z^5-1974*x*y^2*z^5-4627*x^2*z^6+560*y^2*z^6-997*x*z^7+104*z^8];
