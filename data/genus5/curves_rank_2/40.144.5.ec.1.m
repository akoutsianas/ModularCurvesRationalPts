...
// Magma code for modular curve with label 40.144.5.ec.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.85

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 11, 26, 23], [17, 35, 10, 37], [39, 13, 26, 31], [39, 34, 38, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.c.1", "40.72.1.w.1", "40.72.1.cs.1", "40.72.3.bb.2", "40.72.3.bh.1", "40.72.3.ct.1", "40.72.3.ez.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.ec.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
