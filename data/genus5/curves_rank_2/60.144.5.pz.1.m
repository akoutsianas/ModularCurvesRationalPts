...
// Magma code for modular curve with label 60.144.5.pz.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.934

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 55, 34, 51], [17, 15, 30, 13], [21, 55, 2, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.bl.2", "60.72.1.ce.1", "60.72.1.ck.2", "60.72.1.eb.1", "60.72.3.qv.1", "60.72.3.rb.1", "60.72.3.ru.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.pz.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
