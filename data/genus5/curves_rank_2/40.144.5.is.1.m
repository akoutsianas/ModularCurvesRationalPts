...
// Magma code for modular curve with label 40.144.5.is.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.549

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 15, 14, 3], [11, 38, 32, 27], [15, 27, 6, 21], [35, 19, 18, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.bl.1", "40.72.1.bi.2", "40.72.1.bo.1", "40.72.1.cn.2", "40.72.3.db.1", "40.72.3.dk.1", "40.72.3.dx.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.is.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
