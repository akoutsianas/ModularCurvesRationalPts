...
// Magma code for modular curve with label 48.96.5.lw.1

// Other names and/or labels
// Cummins-Pauli label: 16E5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.501

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 46, 24, 19], [15, 7, 46, 33], [31, 38, 2, 17], [41, 28, 8, 41]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.cb.1", "48.48.1.gc.1", "48.48.1.gf.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.lw.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
