...
// Magma code for modular curve with label 60.60.5.br.1

// Other names and/or labels
// Cummins-Pauli label: 30B5
// Rouse-Sutherland-Zureick-Brown label: 60.60.5.29

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[33, 5, 46, 39], [51, 26, 5, 49], [56, 43, 19, 49]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["30.30.2.g.1", "60.12.1.bf.1", "60.30.2.o.1", "60.30.3.d.1"];
...
// Canonical model
model_0 := [x*z-6*x*w-y*t,15*x^2-4*z*w+16*w^2-t^2,30*x^2-15*y^2+z^2+12*z*w-16*w^2+2*t^2];
...
// Map from the canonical model to the plane model of modular curve with label 60.60.5.br.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
