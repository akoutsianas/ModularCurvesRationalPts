...
// Magma code for modular curve with label 30.96.5.g.2

// Other names and/or labels
// Cummins-Pauli label: 30N5
// Rouse-Sutherland-Zureick-Brown label: 30.96.5.16

// Group data
level := 30;
// Elements that, together with Gamma(level), generate the group
gens := [[14, 15, 15, 4], [14, 27, 15, 8], [25, 11, 27, 26], [25, 18, 3, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["15.48.1.a.2", "30.24.1.i.2", "30.48.3.d.1", "30.48.3.e.1"];
...
// Map from the canonical model to the plane model of modular curve with label 30.96.5.g.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
