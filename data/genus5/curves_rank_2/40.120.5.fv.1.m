...
// Magma code for modular curve with label 40.120.5.fv.1

// Other names and/or labels
// Cummins-Pauli label: 20F5
// Rouse-Sutherland-Zureick-Brown label: 40.120.5.99

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 33, 32, 39], [17, 39, 36, 3], [29, 17, 18, 1], [37, 35, 18, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.2.g.1", "40.60.2.i.1", "40.60.3.cf.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.120.5.fv.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
