...
// Magma code for modular curve with label 24.72.5.ko.1

// Other names and/or labels
// Cummins-Pauli label: 24B5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.231

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 17, 2, 11], [3, 2, 20, 15], [7, 3, 0, 1], [13, 8, 4, 13], [23, 19, 2, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.24.1.de.1", "24.36.1.fr.1", "24.36.1.fw.1", "24.36.3.g.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.5.ko.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x-y);
//   Coordinate number 1:
