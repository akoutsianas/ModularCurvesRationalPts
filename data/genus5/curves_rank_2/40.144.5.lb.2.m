...
// Magma code for modular curve with label 40.144.5.lb.2

// Other names and/or labels
// Cummins-Pauli label: 40N5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.210

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 0, 10, 33], [3, 1, 32, 37], [3, 13, 20, 1], [3, 15, 26, 17], [33, 23, 16, 35]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.u.2", "40.72.3.fg.1", "40.72.3.fr.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.lb.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
