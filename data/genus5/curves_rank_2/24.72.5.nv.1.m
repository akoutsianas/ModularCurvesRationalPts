...
// Magma code for modular curve with label 24.72.5.nv.1

// Other names and/or labels
// Cummins-Pauli label: 24E5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.387

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 3, 6, 17], [13, 11, 20, 11], [15, 14, 4, 15], [23, 14, 16, 11], [23, 23, 14, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fn.1", "24.36.1.gt.1", "24.36.3.h.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.5.nv.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*w);
