...
// Magma code for modular curve with label 24.144.5.ua.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1204

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 13, 4, 9], [15, 19, 20, 9], [15, 23, 10, 21], [23, 23, 16, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.ds.1", "24.72.2.db.1", "24.72.2.dn.1", "24.72.2.fo.1", "24.72.2.gm.1", "24.72.3.bds.1", "24.72.3.beq.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.ua.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
