...
// Magma code for modular curve with label 24.72.5.lq.1

// Other names and/or labels
// Cummins-Pauli label: 24G5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.343

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 16, 4, 21], [17, 2, 20, 1], [19, 6, 0, 11], [19, 21, 12, 1], [21, 23, 2, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.gc.1", "24.36.1.gf.1", "24.36.3.h.1"];
...
model_1 := [24*x^8-42*x^6*y^2+9*x^4*y^4+54*x^6*z^2-21*x^4*y^2*z^2+47*x^4*z^4+19*x^2*z^6+3*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.5.lq.1
//   Coordinate number 0:
...
map_1_coord_2 := 1*(t);
// Codomain equation:
map_1_codomain := [24*x^8-42*x^6*y^2+9*x^4*y^4+54*x^6*z^2-21*x^4*y^2*z^2+47*x^4*z^4+19*x^2*z^6+3*z^8];
