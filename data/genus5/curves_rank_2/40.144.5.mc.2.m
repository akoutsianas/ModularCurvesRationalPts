...
// Magma code for modular curve with label 40.144.5.mc.2

// Other names and/or labels
// Cummins-Pauli label: 40L5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.640

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 26, 8, 29], [5, 31, 18, 23], [25, 31, 6, 15], [29, 22, 28, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["40.72.1.ck.1", "40.72.3.fu.2", "40.72.3.fz.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.mc.2
//   Coordinate number 0:
