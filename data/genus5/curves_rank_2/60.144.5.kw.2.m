...
// Magma code for modular curve with label 60.144.5.kw.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.924

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 15, 2, 1], [29, 55, 6, 19], [53, 20, 50, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.bj.1", "60.72.1.bb.1", "60.72.1.cg.2", "60.72.1.dr.2", "60.72.3.nf.2", "60.72.3.ou.1", "60.72.3.qy.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.kw.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x-y);
//   Coordinate number 1:
