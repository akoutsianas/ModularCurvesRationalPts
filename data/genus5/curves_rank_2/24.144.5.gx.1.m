...
// Magma code for modular curve with label 24.144.5.gx.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.73

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 18, 12, 19], [5, 9, 0, 13], [13, 3, 12, 7], [13, 15, 12, 11], [19, 0, 0, 1], [23, 0, 12, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.1.f.1", "24.48.1.ik.1", "24.72.1.bn.1", "24.72.1.cd.1", "24.72.3.mq.1", "24.72.3.qj.1", "24.72.3.qp.1", "24.72.3.tj.1"];
...
model_1 := [-36*x^4*y^4+72*x^3*y^5-72*x^3*y^3*z^2-144*x^2*y^6+240*x^2*y^4*z^2-24*x^2*y^2*z^4+108*x*y^7-276*x*y^5*z^2+156*x*y^3*z^4+12*x*y*z^6-27*y^8+108*y^6*z^2-142*y^4*z^4+20*y^2*z^6+5*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.gx.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+w);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
...
map_1_coord_2 := 1*(z);
// Codomain equation:
map_1_codomain := [-36*x^4*y^4+72*x^3*y^5-72*x^3*y^3*z^2-144*x^2*y^6+240*x^2*y^4*z^2-24*x^2*y^2*z^4+108*x*y^7-276*x*y^5*z^2+156*x*y^3*z^4+12*x*y*z^6-27*y^8+108*y^6*z^2-142*y^4*z^4+20*y^2*z^6+5*z^8];
