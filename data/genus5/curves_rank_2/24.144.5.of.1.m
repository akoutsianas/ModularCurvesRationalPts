...
// Magma code for modular curve with label 24.144.5.of.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1227

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 13, 2, 13], [9, 20, 20, 9], [11, 0, 18, 13], [11, 16, 16, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.dd.1", "24.72.2.t.1", "24.72.2.y.1", "24.72.2.ez.1", "24.72.2.gf.1", "24.72.3.bgj.1", "24.72.3.bhp.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.of.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
