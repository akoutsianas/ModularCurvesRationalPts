...
// Magma code for modular curve with label 40.144.5.gc.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.500

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 25, 32, 19], [7, 22, 10, 29], [15, 12, 38, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.w.1", "40.72.1.u.1", "40.72.1.be.2", "40.72.1.cc.2", "40.72.3.bu.1", "40.72.3.cp.2", "40.72.3.el.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.gc.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
