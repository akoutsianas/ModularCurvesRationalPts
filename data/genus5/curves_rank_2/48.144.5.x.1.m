...
// Magma code for modular curve with label 48.144.5.x.1

// Other names and/or labels
// Cummins-Pauli label: 48H5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.788

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 27, 42, 29], [19, 10, 44, 31], [29, 11, 34, 47], [37, 19, 34, 29], [47, 29, 46, 47]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.2.hn.1", "48.72.0.a.2", "48.72.3.x.1"];
...
// Embedded model
model_0 := [w^2-u*r,w*t+w*u+t*u,w*t+t*r+u*r,x*w-z*u,x*w+x*t+z*t,z*w-x*r,z*t+y*r,y*w+x*t,x*t+x*u-y*u,x^2-x*y-y*z,2*x^2+4*x*y-2*y*z-t*u,2*x^2-2*x*y+4*y*z-w*t,6*x*z+u*r,6*y^2-t^2-t*u,6*z^2+w*r,2*w^2-2*w*t+t^2+w*u+t*u+8*u^2-6*v^2+2*w*r+t*r+2*u*r+r^2];

// Singular plane model
model_1 := [x^12-12*x^10*z^2+72*x^8*z^4-324*x^6*z^6-3*x^4*y^2*z^6+1296*x^4*z^8+36*x^2*y^2*z^8-3888*x^2*z^10-108*y^2*z^10+5832*z^12];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.x.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*v);
...
// Codomain equation:
map_1_codomain := [x^12-12*x^10*z^2+72*x^8*z^4-324*x^6*z^6-3*x^4*y^2*z^6+1296*x^4*z^8+36*x^2*y^2*z^8-3888*x^2*z^10-108*y^2*z^10+5832*z^12];

// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.x.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-1/2*r);
//   Coordinate number 1:
map_2_coord_1 := 1*(9/8*z^2*v*r^3-3/16*v*r^5);
//   Coordinate number 2:
map_2_coord_2 := 1*(-z);
// Codomain equation:
