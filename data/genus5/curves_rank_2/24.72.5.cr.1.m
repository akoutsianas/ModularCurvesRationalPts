...
// Magma code for modular curve with label 24.72.5.cr.1

// Other names and/or labels
// Cummins-Pauli label: 24A5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.252

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 23, 2, 7], [7, 14, 20, 23], [9, 10, 8, 15], [13, 3, 6, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.24.1.v.1", "24.36.0.cc.1", "24.36.2.fz.1", "24.36.3.a.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.5.cr.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.5.cr.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-r);
//   Coordinate number 1:
