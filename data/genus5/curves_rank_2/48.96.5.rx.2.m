...
// Magma code for modular curve with label 48.96.5.rx.2

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.197

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 38, 32, 27], [11, 14, 44, 15], [29, 43, 2, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.ck.1", "24.48.1.ks.2", "48.48.1.it.1", "48.48.3.di.1", "48.48.3.eg.2", "48.48.3.ev.1", "48.48.3.ga.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.rx.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
