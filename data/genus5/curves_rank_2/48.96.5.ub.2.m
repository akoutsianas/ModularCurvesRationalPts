...
// Magma code for modular curve with label 48.96.5.ub.2

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.208

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[35, 24, 12, 1], [43, 10, 32, 21], [45, 17, 46, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.cw.2", "24.48.1.kw.1", "48.48.1.iq.1", "48.48.3.du.1", "48.48.3.et.2", "48.48.3.ez.1", "48.48.3.gc.2"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.ub.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
