...
// Magma code for modular curve with label 48.96.5.md.1

// Other names and/or labels
// Cummins-Pauli label: 16F5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.352

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 44, 0, 47], [15, 10, 10, 13], [41, 5, 30, 31], [47, 18, 30, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.cd.1", "24.48.1.me.1", "48.48.1.gm.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.md.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
