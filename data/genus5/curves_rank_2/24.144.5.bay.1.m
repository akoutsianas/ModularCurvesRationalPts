...
// Magma code for modular curve with label 24.144.5.bay.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1127

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 6, 12, 19], [11, 22, 4, 7], [17, 23, 10, 23], [19, 1, 4, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.em.1", "24.72.2.br.1", "24.72.2.cd.1", "24.72.2.ix.1", "24.72.2.jg.1", "24.72.3.beg.1", "24.72.3.ber.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.bay.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
