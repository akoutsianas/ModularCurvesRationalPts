...
// Magma code for modular curve with label 60.144.5.cy.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.70

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 41, 12, 29], [23, 43, 16, 25], [53, 7, 12, 55], [59, 54, 54, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.1.c.1", "60.72.1.be.1", "60.72.1.ep.1", "60.72.3.cu.1", "60.72.3.cv.1", "60.72.3.le.1", "60.72.3.uu.1"];
...
// Canonical model
model_0 := [y*z-y*w+z*w,4*y^2-2*y*z+z^2+2*y*w+4*z*w+w^2+t^2,15*x^2+y^2+z*w];

// Singular plane model
model_1 := [810000*x^8-27000*x^6*y^2+225*x^4*y^4-324000*x^6*z^2+12600*x^4*y^2*z^2-180*x^2*y^4*z^2+y^6*z^2+27000*x^4*z^4-630*x^2*y^2*z^4+4*y^4*z^4-1080*x^2*z^6+12*y^2*z^6+9*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.cy.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
...
map_1_coord_2 := 1*(w);
// Codomain equation:
map_1_codomain := [810000*x^8-27000*x^6*y^2+225*x^4*y^4-324000*x^6*z^2+12600*x^4*y^2*z^2-180*x^2*y^4*z^2+y^6*z^2+27000*x^4*z^4-630*x^2*y^2*z^4+4*y^4*z^4-1080*x^2*z^6+12*y^2*z^6+9*z^8];
