...
// Magma code for modular curve with label 24.144.5.ft.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.656

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 23, 4, 9], [15, 8, 22, 3], [19, 15, 18, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.3.ct.1", "24.72.1.o.1", "24.72.1.bl.1", "24.72.1.ca.1", "24.72.3.ly.1", "24.72.3.qb.1", "24.72.3.qq.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.ft.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
