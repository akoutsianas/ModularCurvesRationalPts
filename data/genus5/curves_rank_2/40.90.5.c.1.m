...
// Magma code for modular curve with label 40.90.5.c.1

// Other names and/or labels
// Cummins-Pauli label: 20C5
// Rouse-Sutherland-Zureick-Brown label: 40.90.5.2

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 11, 4, 37], [21, 17, 38, 9], [27, 20, 26, 13], [29, 39, 20, 11], [37, 10, 20, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 90;
...
// Canonical model
model_0 := [y*z-2*z^2+y*w+z*w-2*w^2+2*y*t-z*t-w*t+t^2,2*y*z+4*z^2+2*y*w-2*z*w-w^2-y*t-t^2,10*x^2-y*w+z*w+w^2-y*t+z*t+w*t];

// Singular plane model
model_1 := [10*x^8-50*x^6*y*z+20*x^6*z^2+78*x^4*y^2*z^2-95*x^4*y*z^3-44*x^2*y^3*z^3+60*x^4*z^4+145*x^2*y^2*z^4+8*y^4*z^4-110*x^2*y*z^5-50*y^3*z^5+90*y^2*z^6-50*y*z^7];
...
// Map from the canonical model to the plane model of modular curve with label 40.90.5.c.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Codomain equation:
map_1_codomain := [10*x^8-50*x^6*y*z+20*x^6*z^2+78*x^4*y^2*z^2-95*x^4*y*z^3-44*x^2*y^3*z^3+60*x^4*z^4+145*x^2*y^2*z^4+8*y^4*z^4-110*x^2*y*z^5-50*y^3*z^5+90*y^2*z^6-50*y*z^7];
