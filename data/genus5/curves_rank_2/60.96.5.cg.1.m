...
// Magma code for modular curve with label 60.96.5.cg.1

// Other names and/or labels
// Cummins-Pauli label: 20D5
// Rouse-Sutherland-Zureick-Brown label: 60.96.5.86

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 45, 46, 17], [19, 30, 22, 53], [26, 5, 25, 23], [29, 10, 7, 43]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["20.48.3.i.2", "30.24.1.i.2", "60.48.1.bz.1", "60.48.3.be.1"];
...
// Canonical model
model_0 := [x^2-3*x*y-x*z+y^2-y*z-w^2,x^2-3*x*y+2*x*z+x*w+y^2+2*y*z-y*w-3*z^2+2*w^2-2*w*t,3*x^2-2*x*y+x*z+x*w+2*x*t+3*y^2+y*z-y*w-2*y*t+3*z^2+3*w^2-2*w*t-2*t^2];
...
// Map from the canonical model to the plane model of modular curve with label 60.96.5.cg.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x-y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
