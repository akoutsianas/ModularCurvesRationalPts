...
// Magma code for modular curve with label 40.120.5.be.1

// Other names and/or labels
// Cummins-Pauli label: 20E5
// Rouse-Sutherland-Zureick-Brown label: 40.120.5.152

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 30, 0, 3], [5, 8, 8, 25], [9, 1, 32, 31], [11, 25, 20, 21], [21, 1, 4, 25], [23, 15, 0, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.3.c.1", "40.60.2.a.1", "40.60.2.k.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.120.5.be.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
