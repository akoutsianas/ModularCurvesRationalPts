...
// Magma code for modular curve with label 48.192.5.il.1

// Other names and/or labels
// Cummins-Pauli label: 8A5
// Rouse-Sutherland-Zureick-Brown label: 48.192.5.2626

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[35, 45, 42, 29], [41, 28, 42, 23], [43, 44, 16, 19], [45, 7, 20, 43]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["16.96.3.dk.1", "24.96.3.ex.1", "48.96.1.ce.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.192.5.il.1
//   Coordinate number 0:
