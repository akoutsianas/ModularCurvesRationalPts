...
// Magma code for modular curve with label 40.144.5.fz.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.67

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 6, 4, 37], [15, 19, 4, 25], [15, 22, 16, 21], [23, 11, 4, 15], [29, 28, 0, 17], [39, 35, 8, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.f.1", "40.72.1.bf.2", "40.72.1.cc.2", "40.72.3.bt.1", "40.72.3.co.2", "40.72.3.dc.2", "40.72.3.ek.1"];
...
model_1 := [13125*x^8+11500*x^7*y+3650*x^6*y^2+500*x^5*y^3+25*x^4*y^4+19000*x^6*z^2+13000*x^5*y*z^2+2840*x^4*y^2*z^2+200*x^3*y^3*z^2+11320*x^4*z^4+5200*x^3*y*z^4+584*x^2*y^2*z^4+3040*x^2*z^6+736*x*y*z^6+336*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.fz.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x-2*w+2*t);
//   Coordinate number 1:
map_1_coord_1 := 1*(20*w);
//   Coordinate number 2:
map_1_coord_2 := 1*(5*z);
// Codomain equation:
map_1_codomain := [13125*x^8+11500*x^7*y+3650*x^6*y^2+500*x^5*y^3+25*x^4*y^4+19000*x^6*z^2+13000*x^5*y*z^2+2840*x^4*y^2*z^2+200*x^3*y^3*z^2+11320*x^4*z^4+5200*x^3*y*z^4+584*x^2*y^2*z^4+3040*x^2*z^6+736*x*y*z^6+336*z^8];
