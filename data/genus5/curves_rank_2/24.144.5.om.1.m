...
// Magma code for modular curve with label 24.144.5.om.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.949

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 17, 20, 9], [7, 3, 0, 13], [19, 1, 22, 5], [19, 6, 0, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.df.1", "24.72.2.v.1", "24.72.2.be.1", "24.72.2.fc.1", "24.72.2.gg.1", "24.72.3.bgi.1", "24.72.3.bhm.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.om.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
