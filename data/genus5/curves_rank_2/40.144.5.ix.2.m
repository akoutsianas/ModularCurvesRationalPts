...
// Magma code for modular curve with label 40.144.5.ix.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.444

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 3, 20, 7], [9, 30, 0, 39], [33, 13, 6, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.u.1", "40.72.1.z.1", "40.72.1.bp.1", "40.72.1.co.2", "40.72.3.dh.2", "40.72.3.dy.1", "40.72.3.fa.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.ix.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
