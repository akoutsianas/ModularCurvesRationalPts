...
// Magma code for modular curve with label 24.144.5.bfo.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.887

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 9, 6, 7], [17, 19, 16, 7], [19, 5, 14, 5], [23, 19, 22, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.ff.1", "24.72.2.cz.1", "24.72.2.ee.1", "24.72.2.hw.1", "24.72.2.in.1", "24.72.3.bgj.1", "24.72.3.bgy.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.bfo.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
