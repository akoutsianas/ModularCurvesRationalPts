...
// Magma code for modular curve with label 60.120.5.fi.1

// Other names and/or labels
// Cummins-Pauli label: 20F5
// Rouse-Sutherland-Zureick-Brown label: 60.120.5.155

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 57, 54, 43], [29, 55, 0, 59], [55, 21, 6, 23], [59, 45, 2, 41]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.2.i.1", "60.60.2.d.1", "60.60.3.br.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.120.5.fi.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
