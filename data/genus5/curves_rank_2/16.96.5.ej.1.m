...
// Magma code for modular curve with label 16.96.5.ej.1

// Other names and/or labels
// Cummins-Pauli label: 16H5
// Rouse-Sutherland-Zureick-Brown label: 16.96.5.148

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 2, 2, 15], [11, 15, 6, 5], [15, 1, 10, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.bk.1", "16.48.2.bu.1", "16.48.3.cf.1"];
...
// Map from the canonical model to the plane model of modular curve with label 16.96.5.ej.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
