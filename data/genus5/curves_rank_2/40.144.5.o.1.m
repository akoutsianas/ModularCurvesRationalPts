...
// Magma code for modular curve with label 40.144.5.o.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.417

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 18, 6, 15], [17, 26, 34, 9], [25, 26, 6, 15], [27, 22, 16, 3], [35, 14, 26, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.f.1", "40.72.1.a.1", "40.72.1.bm.1", "40.72.1.cf.2", "40.72.3.c.1", "40.72.3.dk.1", "40.72.3.el.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.o.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
