...
// Magma code for modular curve with label 48.144.5.r.2

// Other names and/or labels
// Cummins-Pauli label: 48H5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.813

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 29, 22, 29], [17, 25, 14, 17], [17, 42, 36, 1], [21, 31, 34, 15], [43, 40, 40, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.2.hm.1", "48.72.0.a.1", "48.72.3.u.1"];
...
// Embedded model
model_0 := [x*u+t*v,y*u+w*v,x*y-z*v,x*w+z*u,x*w-y*t,x*w-y*w-x*u,w^2-w*t+t*u,z*w-x*t-z*t,x^2+x*z-y*z,x*y-y^2+x*v,x*y+y^2+t*u-x*v+z*v,x^2-2*x*z-y*z+t^2,x^2+x*z+2*y*z-w*t,2*y^2+w*u+x*v+z*v,u^2-3*y*v,x*y+x*z+8*z^2+w^2+2*w*t+2*t^2-w*u+u^2-y*v+v^2+2*r^2];
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.r.2
//   Coordinate number 0:
map_2_coord_0 := 1*(u);
//   Coordinate number 1:
