...
// Magma code for modular curve with label 60.96.5.bw.1

// Other names and/or labels
// Cummins-Pauli label: 30N5
// Rouse-Sutherland-Zureick-Brown label: 60.96.5.125

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 30, 27, 7], [29, 15, 0, 53], [53, 10, 21, 17], [59, 50, 30, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["30.48.3.e.1", "60.24.1.be.2", "60.48.1.bw.1", "60.48.3.bb.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.96.5.bw.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
