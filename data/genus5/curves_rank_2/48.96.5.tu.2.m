...
// Magma code for modular curve with label 48.96.5.tu.2

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.218

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 14, 20, 23], [5, 18, 28, 1], [17, 31, 18, 35], [47, 10, 16, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.cx.2", "24.48.1.kt.2", "48.48.1.io.1", "48.48.3.dq.1", "48.48.3.es.2", "48.48.3.ez.2", "48.48.3.ga.2"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.tu.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
