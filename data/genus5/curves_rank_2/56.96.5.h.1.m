...
// Magma code for modular curve with label 56.96.5.h.1

// Other names and/or labels
// Cummins-Pauli label: 28E5
// Rouse-Sutherland-Zureick-Brown label: 56.96.5.35

// Group data
level := 56;
// Elements that, together with Gamma(level), generate the group
gens := [[26, 15, 51, 26], [38, 21, 29, 8], [46, 7, 17, 54], [54, 7, 3, 34]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["28.48.2.i.1", "56.12.0.d.1", "56.48.2.b.1", "56.48.3.a.1"];
...
// Map from the canonical model to the plane model of modular curve with label 56.96.5.h.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
