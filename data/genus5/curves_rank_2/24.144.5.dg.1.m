...
// Magma code for modular curve with label 24.144.5.dg.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.641

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 7, 14, 15], [3, 17, 8, 9], [7, 12, 0, 7], [9, 20, 10, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.3.y.1", "24.72.1.j.1", "24.72.1.bg.1", "24.72.1.cd.1", "24.72.3.gi.1", "24.72.3.qt.1", "24.72.3.tu.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.dg.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
