...
// Magma code for modular curve with label 24.72.5.gd.1

// Other names and/or labels
// Cummins-Pauli label: 24G5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.338

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 1, 16, 15], [17, 13, 8, 11], [19, 6, 12, 11], [19, 15, 6, 13], [23, 7, 14, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.gd.1", "24.36.1.gh.1", "24.36.3.d.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.5.gd.1
//   Coordinate number 0:
