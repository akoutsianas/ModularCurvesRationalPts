...
// Magma code for modular curve with label 40.120.5.ed.1

// Other names and/or labels
// Cummins-Pauli label: 20E5
// Rouse-Sutherland-Zureick-Brown label: 40.120.5.106

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[27, 10, 28, 33], [29, 11, 4, 23], [33, 11, 14, 27], [35, 23, 2, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.2.e.1", "40.60.2.b.1", "40.60.3.br.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.120.5.ed.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
