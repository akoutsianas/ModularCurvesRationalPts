...
// Magma code for modular curve with label 24.144.5.bco.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.346

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 5, 4, 17], [11, 16, 8, 11], [23, 18, 18, 1], [23, 23, 2, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.2.k.1", "24.72.1.fb.1", "24.72.2.cm.1", "24.72.2.he.1", "24.72.2.jc.1", "24.72.3.bfy.1", "24.72.3.bho.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.bco.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x-z);
//   Coordinate number 1:
