...
// Magma code for modular curve with label 24.144.5.dk.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.178

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 2, 22, 9], [5, 18, 6, 1], [9, 7, 2, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.1.j.1", "24.72.1.k.1", "24.72.1.cd.1", "24.72.3.gg.1", "24.72.3.gl.1", "24.72.3.qs.1", "24.72.3.tv.1"];
...
model_1 := [-x^8+4*x^6*y*z+12*x^6*z^2-6*x^4*y^2*z^2-48*x^4*y*z^3-36*x^4*z^4+4*x^2*y^3*z^3+48*x^2*y^2*z^4+36*x^2*y*z^5-2*y^4*z^4-12*y^3*z^5+54*y^2*z^6+216*y*z^7+81*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.dk.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y+w);
...
// Codomain equation:
map_1_codomain := [-x^8+4*x^6*y*z+12*x^6*z^2-6*x^4*y^2*z^2-48*x^4*y*z^3-36*x^4*z^4+4*x^2*y^3*z^3+48*x^2*y^2*z^4+36*x^2*y*z^5-2*y^4*z^4-12*y^3*z^5+54*y^2*z^6+216*y*z^7+81*z^8];
