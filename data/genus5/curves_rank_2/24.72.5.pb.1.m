...
// Magma code for modular curve with label 24.72.5.pb.1

// Other names and/or labels
// Cummins-Pauli label: 24A5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.243

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 1, 14, 1], [21, 17, 14, 3], [21, 17, 16, 15], [23, 10, 8, 11], [23, 23, 8, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.24.1.ep.1", "24.36.0.cj.1", "24.36.2.gf.1", "24.36.3.h.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.5.pb.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
map_1_coord_1 := 1*(4*u);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.5.pb.1
//   Coordinate number 0:
map_2_coord_0 := 1*(r);
//   Coordinate number 1:
