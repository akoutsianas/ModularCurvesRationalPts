...
// Magma code for modular curve with label 24.144.5.bax.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1122

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 21, 6, 13], [13, 21, 6, 23], [19, 17, 14, 5], [21, 17, 8, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.em.1", "24.72.2.bs.1", "24.72.2.cc.1", "24.72.2.iy.1", "24.72.2.jf.1", "24.72.3.bej.1", "24.72.3.beo.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.bax.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
