...
// Magma code for modular curve with label 40.120.5.dz.1

// Other names and/or labels
// Cummins-Pauli label: 20E5
// Rouse-Sutherland-Zureick-Brown label: 40.120.5.27

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 5, 30, 21], [3, 26, 34, 7], [5, 22, 18, 23], [7, 13, 12, 39]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["10.60.2.a.1", "40.60.2.g.1", "40.60.3.br.1"];
...
// Canonical model
model_0 := [2*x*w-3*x*t+y*w+y*t,2*x^2+2*x*y-2*y^2+3*z^2+2*z*w-2*z*t+2*w^2+w*t+2*t^2,6*x^2-4*x*y+4*y^2+z^2-z*w+z*t-w^2+2*w*t-t^2];
...
// Map from the canonical model to the plane model of modular curve with label 40.120.5.dz.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
