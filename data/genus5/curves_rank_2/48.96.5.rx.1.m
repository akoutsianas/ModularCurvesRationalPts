...
// Magma code for modular curve with label 48.96.5.rx.1

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.203

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 26, 32, 21], [23, 29, 46, 27], [27, 17, 22, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.ck.2", "24.48.1.ks.1", "48.48.1.it.2", "48.48.3.di.1", "48.48.3.eg.1", "48.48.3.ev.2", "48.48.3.ga.2"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.rx.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
