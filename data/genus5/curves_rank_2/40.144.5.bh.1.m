...
// Magma code for modular curve with label 40.144.5.bh.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.251

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 19, 2, 21], [25, 31, 2, 19], [29, 5, 28, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.l.2", "40.72.1.d.1", "40.72.1.cc.2", "40.72.3.i.1", "40.72.3.m.2", "40.72.3.dg.2", "40.72.3.en.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.bh.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+z);
//   Coordinate number 1:
