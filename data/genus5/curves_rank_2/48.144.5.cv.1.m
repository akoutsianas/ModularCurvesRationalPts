...
// Magma code for modular curve with label 48.144.5.cv.1

// Other names and/or labels
// Cummins-Pauli label: 48G5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.834

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 20, 40, 25], [17, 0, 6, 19], [21, 11, 10, 27], [33, 44, 20, 21], [35, 2, 40, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.2.jb.1", "48.72.0.b.1", "48.72.3.bj.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.cv.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.cv.1
//   Coordinate number 0:
