...
// Magma code for modular curve with label 24.72.5.lk.1

// Other names and/or labels
// Cummins-Pauli label: 24G5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.330

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 8, 20, 17], [19, 5, 20, 5], [21, 16, 10, 3], [23, 3, 6, 1], [23, 5, 2, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.gc.1", "24.36.1.ge.1", "24.36.3.g.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.5.lk.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
