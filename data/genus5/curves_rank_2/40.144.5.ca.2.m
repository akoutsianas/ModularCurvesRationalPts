...
// Magma code for modular curve with label 40.144.5.ca.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.283

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 23, 6, 37], [31, 33, 34, 25], [37, 4, 0, 31], [37, 16, 24, 39]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.s.1", "40.72.1.e.1", "40.72.1.x.1", "40.72.3.n.2", "40.72.3.q.1", "40.72.3.cq.1", "40.72.3.ev.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.ca.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
