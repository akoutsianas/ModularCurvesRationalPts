...
// Magma code for modular curve with label 40.144.5.lv.2

// Other names and/or labels
// Cummins-Pauli label: 40N5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.167

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 17, 4, 29], [11, 37, 20, 33], [19, 33, 32, 5], [27, 2, 30, 9], [37, 1, 8, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.v.2", "40.72.3.fp.1", "40.72.3.fr.1"];
...
// Canonical model
model_0 := [y*z+y*t+z*w,y*w-z^2+z*t+w^2+t^2,5*x^2+y*w-y*t+z^2+z*w-z*t+w^2-t^2];
...
map_0_coord_0 := 1*(-5*x);
//   Coordinate number 1:
map_0_coord_1 := 1*(2*y+5*z+4*w);
//   Coordinate number 2:
map_0_coord_2 := 1*(y+2*w);
// Codomain equation:
map_0_codomain := [2*x^4+x^2*y^2+y^3*z+x^2*z^2-2*y^2*z^2+y*z^3-2*z^4];

// Map from the canonical model to the plane model of modular curve with label 40.144.5.lv.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
