...
// Magma code for modular curve with label 24.144.5.oc.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1239

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 0, 18, 1], [11, 2, 20, 7], [17, 21, 12, 7], [23, 17, 20, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.dd.1", "24.72.2.s.1", "24.72.2.x.1", "24.72.2.ew.1", "24.72.2.gc.1", "24.72.3.bgg.1", "24.72.3.bhm.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.oc.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
