...
// Magma code for modular curve with label 24.96.5.id.1

// Other names and/or labels
// Cummins-Pauli label: 24J5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.191

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 18, 4, 17], [5, 3, 8, 23], [11, 9, 2, 13], [13, 0, 10, 7], [19, 21, 12, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.24.0.ev.1", "24.48.2.k.1", "24.48.2.o.1", "24.48.3.cp.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.id.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
