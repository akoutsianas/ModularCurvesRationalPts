...
// Magma code for modular curve with label 40.144.5.u.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.412

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 2, 4, 29], [23, 36, 10, 39], [25, 34, 22, 27], [29, 38, 28, 39], [37, 4, 26, 35]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.e.2", "40.72.1.b.2", "40.72.1.bp.1", "40.72.1.cc.2", "40.72.3.c.1", "40.72.3.dh.1", "40.72.3.eo.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.u.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
