...
// Magma code for modular curve with label 60.120.5.cn.1

// Other names and/or labels
// Cummins-Pauli label: 10A5
// Rouse-Sutherland-Zureick-Brown label: 60.120.5.108

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 5, 35, 2], [37, 30, 50, 41], [46, 55, 25, 36]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.0.a.1", "30.60.3.i.1", "60.24.1.bc.1", "60.24.1.bc.2", "60.60.2.c.1"];
...
model_2 := [x^2+y^2+z^2,-33*x^6+6*x^5*y+72*x^3*y*z^2+96*x*y*z^4-125*w^2];
...
// Map from the embedded model to the plane model of modular curve with label 60.120.5.cn.1
//   Coordinate number 0:
map_1_coord_0 := 1*(v);
//   Coordinate number 1:
