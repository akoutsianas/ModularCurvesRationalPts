...
// Magma code for modular curve with label 24.96.5.ft.1

// Other names and/or labels
// Cummins-Pauli label: 24I5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.194

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 0, 0, 1], [11, 7, 18, 13], [11, 18, 12, 5], [13, 10, 12, 23], [23, 14, 12, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.24.1.ef.1", "24.48.1.jd.1", "24.48.3.bs.1", "24.48.3.cm.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.ft.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
