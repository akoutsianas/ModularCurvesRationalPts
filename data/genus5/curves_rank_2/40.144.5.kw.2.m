...
// Magma code for modular curve with label 40.144.5.kw.2

// Other names and/or labels
// Cummins-Pauli label: 20J5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.206

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[15, 4, 36, 23], [21, 12, 22, 31], [23, 23, 36, 5], [35, 28, 2, 21], [37, 34, 0, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.u.2", "40.72.3.fk.1", "40.72.3.fm.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.kw.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
