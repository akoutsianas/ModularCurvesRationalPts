...
// Magma code for modular curve with label 28.84.5.a.1

// Other names and/or labels
// Cummins-Pauli label: 14B5
// Rouse-Sutherland-Zureick-Brown label: 28.84.5.11

// Group data
level := 28;
// Elements that, together with Gamma(level), generate the group
gens := [[10, 5, 5, 23], [19, 11, 11, 14], [25, 27, 17, 10]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 84;
...
covers := ["14.42.3.a.1", "28.42.1.a.1", "28.42.1.d.1"];
...
// Map from the canonical model to the plane model of modular curve with label 28.84.5.a.1
//   Coordinate number 0:
