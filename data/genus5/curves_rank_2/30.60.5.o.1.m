...
// Magma code for modular curve with label 30.60.5.o.1

// Other names and/or labels
// Cummins-Pauli label: 30B5
// Rouse-Sutherland-Zureick-Brown label: 30.60.5.13

// Group data
level := 30;
// Elements that, together with Gamma(level), generate the group
gens := [[2, 25, 1, 16], [13, 23, 10, 19], [20, 19, 23, 20]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["15.30.2.d.1", "30.12.1.k.1", "30.30.2.g.1", "30.30.3.c.1"];
...
// Canonical model
model_0 := [x*z+3*x*t-y*w,x^2+x*w-y*t+2*z*t-w^2+4*t^2,4*x^2-x*w-y^2-y*z+2*y*t+z^2-4*z*t+w^2];
...
map_0_coord_1 := 1*(-t);
//   Coordinate number 2:
map_0_coord_2 := 1*(y-2*z-3*t);
// Codomain equation:
map_0_codomain := [25*x^4+55*x^2*y^2+37*y^4+27*y^3*z-9*y^2*z^2+y*z^3];

// Map from the canonical model to the plane model of modular curve with label 30.60.5.o.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
