...
// Magma code for modular curve with label 60.144.5.jh.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.104

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 3, 50, 53], [31, 53, 24, 53], [35, 28, 52, 49]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.1.m.1", "60.72.1.u.1", "60.72.1.eo.1", "60.72.3.le.1", "60.72.3.lv.1", "60.72.3.ny.1", "60.72.3.ud.1"];
...
model_1 := [625*x^8-750*x^6*z^2-25*x^4*y^2*z^2+75*x^4*z^4+90*x^2*z^6+y^4*z^4+3*y^2*z^6+9*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.jh.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y+w);
...
map_1_coord_2 := 1*(z);
// Codomain equation:
map_1_codomain := [625*x^8-750*x^6*z^2-25*x^4*y^2*z^2+75*x^4*z^4+90*x^2*z^6+y^4*z^4+3*y^2*z^6+9*z^8];
