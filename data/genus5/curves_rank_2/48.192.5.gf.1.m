...
// Magma code for modular curve with label 48.192.5.gf.1

// Other names and/or labels
// Cummins-Pauli label: 8A5
// Rouse-Sutherland-Zureick-Brown label: 48.192.5.427

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 26, 10, 11], [13, 15, 0, 11], [23, 13, 32, 9], [37, 37, 18, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["8.96.3.k.1", "48.64.1.b.1", "48.96.1.be.1", "48.96.3.et.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.192.5.gf.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
