...
// Magma code for modular curve with label 24.72.5.nb.1

// Other names and/or labels
// Cummins-Pauli label: 24F5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.392

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 20, 20, 13], [19, 5, 20, 17], [19, 6, 18, 17], [19, 7, 22, 5], [23, 11, 8, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.gt.1", "24.36.2.gc.1", "24.36.2.gn.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.5.nb.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*z);
