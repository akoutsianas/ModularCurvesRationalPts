...
// Magma code for modular curve with label 48.96.5.lm.1

// Other names and/or labels
// Cummins-Pauli label: 16F5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.375

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[27, 20, 46, 5], [33, 8, 22, 19], [33, 19, 2, 23], [35, 44, 10, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.ca.1", "24.48.1.mg.1", "48.48.1.fx.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.lm.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
