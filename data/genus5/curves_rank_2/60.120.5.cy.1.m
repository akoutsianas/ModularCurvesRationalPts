...
// Magma code for modular curve with label 60.120.5.cy.1

// Other names and/or labels
// Cummins-Pauli label: 20E5
// Rouse-Sutherland-Zureick-Brown label: 60.120.5.217

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[35, 34, 22, 15], [51, 16, 28, 59], [59, 18, 59, 1], [59, 26, 18, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.3.n.1", "30.60.2.a.1", "60.60.2.e.1"];
...
// Canonical model
model_0 := [7*x*z+x*w+z*t-2*w*t,7*x^2+2*x*t+3*y^2-3*y*z-3*z^2-2*t^2,4*x^2-x*t+9*y^2+6*y*z+z^2+5*z*w-5*w^2+t^2];
...
// Map from the canonical model to the plane model of modular curve with label 60.120.5.cy.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
