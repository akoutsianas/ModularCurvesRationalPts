...
// Magma code for modular curve with label 24.144.5.bce.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1065

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 14, 2, 21], [7, 6, 18, 13], [7, 15, 18, 13], [11, 7, 10, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.ey.1", "24.72.2.cl.1", "24.72.2.da.1", "24.72.2.hc.1", "24.72.2.iy.1", "24.72.3.bga.1", "24.72.3.bho.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.bce.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
