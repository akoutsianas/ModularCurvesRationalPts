...
// Magma code for modular curve with label 24.96.5.o.1

// Other names and/or labels
// Cummins-Pauli label: 24I5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.199

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 11, 18, 23], [7, 2, 0, 23], [11, 20, 12, 1], [19, 9, 6, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.24.1.e.1", "24.48.1.ct.1", "24.48.3.bs.1", "24.48.3.ci.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.o.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
