...
// Magma code for modular curve with label 40.120.5.bl.1

// Other names and/or labels
// Cummins-Pauli label: 20E5
// Rouse-Sutherland-Zureick-Brown label: 40.120.5.13

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[15, 14, 8, 15], [19, 3, 4, 9], [35, 24, 28, 5], [39, 31, 2, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['5.20.0.b.1', '8.6.0.c.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["10.60.2.b.1", "40.30.2.c.1", "40.60.2.h.1", "40.60.3.c.1"];
...
// Canonical model
model_0 := [x*z-x*t-y*w-y*t,2*x^2-4*x*y+2*y^2+z^2+z*t+w^2-w*t+t^2,4*x^2+2*x*y+4*y^2-z^2+z*w-z*t-w^2+w*t];
...
//   Coordinate number 0:
map_0_coord_0 := 1*(-2*x-2*y-z+w-t);
//   Coordinate number 1:
map_0_coord_1 := 1*(2*x+2*y-z+w);
//   Coordinate number 2:
...
// Map from the canonical model to the plane model of modular curve with label 40.120.5.bl.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
