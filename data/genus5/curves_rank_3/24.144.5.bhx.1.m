...
// Magma code for modular curve with label 24.144.5.bhx.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.873

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 10, 20, 13], [7, 1, 16, 17], [9, 23, 8, 15], [21, 7, 10, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.fd.1", "24.72.2.ed.1", "24.72.2.en.1", "24.72.2.iy.1", "24.72.2.jp.1", "24.72.3.bhl.1", "24.72.3.bia.1"];
...
// Canonical model
model_0 := [x*w+y*z,2*x^2+2*x*y+2*y^2-z^2-2*z*w+2*w^2,4*x^2-2*x*y-2*y^2+5*z^2-2*z*w+2*w^2-t^2];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.bhx.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
