...
// Magma code for modular curve with label 24.72.5.bb.1

// Other names and/or labels
// Cummins-Pauli label: 24F5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.389

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 7, 8, 21], [11, 19, 2, 17], [19, 12, 18, 1], [19, 18, 6, 13], [21, 8, 2, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.gt.1", "24.36.2.x.1", "24.36.2.gj.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.5.bb.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
