...
// Magma code for modular curve with label 56.96.5.bz.1

// Other names and/or labels
// Cummins-Pauli label: 28E5
// Rouse-Sutherland-Zureick-Brown label: 56.96.5.37

// Group data
level := 56;
// Elements that, together with Gamma(level), generate the group
gens := [[6, 11, 25, 14], [24, 35, 25, 54], [42, 31, 23, 44], [47, 36, 44, 39]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["28.48.2.h.1", "56.12.0.bj.1", "56.48.2.l.1", "56.48.3.d.1"];
...
// Map from the canonical model to the plane model of modular curve with label 56.96.5.bz.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
