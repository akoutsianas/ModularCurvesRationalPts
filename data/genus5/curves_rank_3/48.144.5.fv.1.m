...
// Magma code for modular curve with label 48.144.5.fv.1

// Other names and/or labels
// Cummins-Pauli label: 48G5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.836

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 42, 24, 41], [7, 23, 32, 41], [31, 3, 36, 1], [31, 46, 26, 25], [35, 19, 10, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.2.if.1", "48.72.0.d.2", "48.72.3.bl.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.fv.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.fv.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-t);
//   Coordinate number 1:
map_2_coord_1 := 1*(3/4*t^4*v*r-3/16*v*r^5);
//   Coordinate number 2:
