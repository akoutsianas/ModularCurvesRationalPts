...
// Magma code for modular curve with label 48.144.5.cu.1

// Other names and/or labels
// Cummins-Pauli label: 48G5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.841

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 26, 16, 19], [19, 31, 34, 29], [23, 34, 14, 29], [35, 16, 28, 31], [45, 25, 28, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.2.ja.1", "48.72.0.b.2", "48.72.3.bj.2"];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.cu.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(v);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.cu.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-r);
//   Coordinate number 1:
