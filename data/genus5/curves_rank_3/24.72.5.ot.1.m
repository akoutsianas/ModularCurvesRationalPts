...
// Magma code for modular curve with label 24.72.5.ot.1

// Other names and/or labels
// Cummins-Pauli label: 24A5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.220

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 18, 0, 1], [5, 21, 6, 19], [17, 20, 20, 7], [21, 22, 4, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.24.1.eh.1", "24.36.0.ch.1", "24.36.2.fz.1", "24.36.3.f.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.5.ot.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.5.ot.1
//   Coordinate number 0:
