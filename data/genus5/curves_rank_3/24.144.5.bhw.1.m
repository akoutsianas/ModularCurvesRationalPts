...
// Magma code for modular curve with label 24.144.5.bhw.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.875

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 15, 12, 13], [13, 16, 8, 13], [19, 16, 14, 13], [21, 11, 8, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.fd.1", "24.72.2.ec.1", "24.72.2.en.1", "24.72.2.iz.1", "24.72.2.jo.1", "24.72.3.bhk.1", "24.72.3.bib.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.bhw.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x-y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
