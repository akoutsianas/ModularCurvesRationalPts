...
// Magma code for modular curve with label 48.96.5.fo.1

// Other names and/or labels
// Cummins-Pauli label: 16C5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.295

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 39, 6, 7], [13, 24, 24, 29], [19, 11, 6, 29], [29, 12, 32, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.l.1", "48.48.3.w.1", "48.48.3.bb.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.fo.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
