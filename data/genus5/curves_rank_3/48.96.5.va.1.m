...
// Magma code for modular curve with label 48.96.5.va.1

// Other names and/or labels
// Cummins-Pauli label: 16B5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.157

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 27, 18, 41], [17, 32, 34, 35], [23, 16, 20, 35], [35, 4, 2, 45]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.db.1", "24.48.1.md.1", "48.48.1.jc.1", "48.48.3.ea.1", "48.48.3.fj.1", "48.48.3.fu.1", "48.48.3.gg.2"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.va.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*w);
