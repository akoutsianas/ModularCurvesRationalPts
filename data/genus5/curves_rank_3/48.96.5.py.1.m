...
// Magma code for modular curve with label 48.96.5.py.1

// Other names and/or labels
// Cummins-Pauli label: 16E5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.248

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 29, 8, 19], [15, 16, 34, 25], [17, 29, 14, 7], [45, 26, 22, 43]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.bo.1", "48.48.1.fk.1", "48.48.3.en.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.py.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
