...
// Magma code for modular curve with label 48.96.5.gc.2

// Other names and/or labels
// Cummins-Pauli label: 16B5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.596

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 40, 8, 3], [15, 47, 8, 41], [19, 22, 28, 27], [43, 5, 16, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.bd.2", "24.48.1.ea.1", "48.48.1.hp.1", "48.48.1.hs.1", "48.48.3.bc.1", "48.48.3.fb.1", "48.48.3.fg.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.gc.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
