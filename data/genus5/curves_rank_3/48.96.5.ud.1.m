...
// Magma code for modular curve with label 48.96.5.ud.1

// Other names and/or labels
// Cummins-Pauli label: 16B5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.293

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[15, 22, 2, 25], [27, 29, 20, 9], [29, 43, 18, 19], [43, 3, 30, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.cy.1", "24.48.1.lg.1", "48.48.1.ja.1", "48.48.3.dv.1", "48.48.3.fd.1", "48.48.3.fv.1", "48.48.3.gd.2"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.ud.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
