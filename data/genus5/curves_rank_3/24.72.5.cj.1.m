...
// Magma code for modular curve with label 24.72.5.cj.1

// Other names and/or labels
// Cummins-Pauli label: 24F5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.390

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 17, 8, 5], [15, 5, 8, 21], [15, 17, 4, 9], [21, 14, 8, 21], [23, 0, 18, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.gt.1", "24.36.2.bv.1", "24.36.2.gj.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.5.cj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
