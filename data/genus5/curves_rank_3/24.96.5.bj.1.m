...
// Magma code for modular curve with label 24.96.5.bj.1

// Other names and/or labels
// Cummins-Pauli label: 24I5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.223

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 1, 6, 23], [5, 11, 18, 23], [7, 2, 18, 5], [11, 6, 18, 1], [19, 13, 18, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.24.1.o.1", "24.48.1.et.1", "24.48.3.bu.1", "24.48.3.ck.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.bj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
