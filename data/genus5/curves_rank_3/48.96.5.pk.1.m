...
// Magma code for modular curve with label 48.96.5.pk.1

// Other names and/or labels
// Cummins-Pauli label: 16F5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.149

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 31, 38, 23], [21, 43, 40, 19], [37, 36, 46, 7], [43, 4, 38, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.bd.1", "24.48.1.mg.1", "48.48.3.fy.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.pk.1
//   Coordinate number 0:
