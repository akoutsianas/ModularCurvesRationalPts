...
// Magma code for modular curve with label 24.96.5.z.1

// Other names and/or labels
// Cummins-Pauli label: 24I5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.197

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 17, 18, 17], [11, 12, 0, 11], [13, 17, 6, 5], [17, 0, 12, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.24.1.k.1", "24.48.1.dr.1", "24.48.3.bs.1", "24.48.3.ci.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.z.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
