...
// Magma code for modular curve with label 16.96.5.eg.1

// Other names and/or labels
// Cummins-Pauli label: 16H5
// Rouse-Sutherland-Zureick-Brown label: 16.96.5.149

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 9, 8, 5], [11, 9, 10, 9], [13, 13, 10, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.bk.1", "16.48.2.bs.1", "16.48.3.cg.1"];
