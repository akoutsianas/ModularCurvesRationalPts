...
// Magma code for modular curve with label 48.96.5.vi.1

// Other names and/or labels
// Cummins-Pauli label: 16B5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.153

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 36, 24, 1], [3, 32, 38, 41], [13, 25, 26, 3], [31, 16, 44, 43]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.df.1", "24.48.1.md.1", "48.48.1.jg.1", "48.48.3.ec.2", "48.48.3.fn.1", "48.48.3.fy.1", "48.48.3.gg.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.vi.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y+z);
