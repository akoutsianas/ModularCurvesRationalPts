...
// Magma code for modular curve with label 24.72.5.gc.1

// Other names and/or labels
// Cummins-Pauli label: 24G5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.345

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 17, 8, 15], [13, 9, 18, 7], [17, 1, 8, 11], [17, 15, 6, 19], [21, 7, 4, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.gc.1", "24.36.1.gh.1", "24.36.3.d.1"];
...
model_1 := [81*x^8-171*x^6*y^2+141*x^4*y^4+21*x^4*y^2*z^2+3*x^4*z^4-54*x^2*y^6-14*x^2*y^4*z^2+8*y^8];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.5.gc.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
...
// Codomain equation:
map_1_codomain := [81*x^8-171*x^6*y^2+141*x^4*y^4+21*x^4*y^2*z^2+3*x^4*z^4-54*x^2*y^6-14*x^2*y^4*z^2+8*y^8];
