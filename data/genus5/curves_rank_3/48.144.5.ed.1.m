...
// Magma code for modular curve with label 48.144.5.ed.1

// Other names and/or labels
// Cummins-Pauli label: 48E5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.73

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[15, 11, 46, 33], [27, 19, 22, 21], [29, 43, 40, 31], [35, 21, 0, 1], [47, 44, 22, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['3.3.0.a.1', '16.48.1.ct.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["16.48.1.ct.1", "24.72.2.hh.1", "48.72.0.d.1", "48.72.3.bn.2"];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.ed.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*v);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.ed.1
//   Coordinate number 0:
map_2_coord_0 := 1*(t);
//   Coordinate number 1:
