...
// Magma code for modular curve with label 24.144.5.qq.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1253

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 19, 14, 19], [5, 16, 20, 17], [7, 19, 20, 1], [11, 1, 4, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.dh.1", "24.72.2.br.1", "24.72.2.ch.1", "24.72.2.fv.1", "24.72.2.gu.1", "24.72.3.bhe.1", "24.72.3.bif.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.qq.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
