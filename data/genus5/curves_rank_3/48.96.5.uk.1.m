...
// Magma code for modular curve with label 48.96.5.uk.1

// Other names and/or labels
// Cummins-Pauli label: 16B5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.158

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[29, 8, 44, 9], [33, 44, 26, 15], [39, 17, 40, 33], [47, 4, 24, 47]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.db.1", "24.48.1.ln.1", "48.48.1.ix.1", "48.48.3.dw.2", "48.48.3.fe.1", "48.48.3.fu.1", "48.48.3.ge.2"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.uk.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
