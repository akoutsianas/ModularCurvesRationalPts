...
// Magma code for modular curve with label 60.120.5.fd.1

// Other names and/or labels
// Cummins-Pauli label: 20F5
// Rouse-Sutherland-Zureick-Brown label: 60.120.5.148

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[29, 30, 52, 11], [43, 4, 54, 5], [53, 11, 8, 7], [57, 41, 46, 45]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.2.h.1", "60.60.2.f.1", "60.60.3.bq.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.120.5.fd.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
