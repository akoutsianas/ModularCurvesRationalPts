...
// Magma code for modular curve with label 48.96.5.tj.1

// Other names and/or labels
// Cummins-Pauli label: 16B5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.137

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[23, 8, 44, 3], [23, 31, 18, 25], [41, 39, 44, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.cq.1", "24.48.1.km.1", "48.48.1.jb.1", "48.48.3.ec.2", "48.48.3.el.1", "48.48.3.fi.1", "48.48.3.gg.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.tj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
