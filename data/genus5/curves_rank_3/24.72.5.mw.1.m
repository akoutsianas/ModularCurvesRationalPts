...
// Magma code for modular curve with label 24.72.5.mw.1

// Other names and/or labels
// Cummins-Pauli label: 24F5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.320

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 20, 4, 23], [9, 11, 22, 21], [23, 5, 10, 23], [23, 19, 10, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.gq.1", "24.36.2.fz.1", "24.36.2.gk.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.5.mw.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*z);
