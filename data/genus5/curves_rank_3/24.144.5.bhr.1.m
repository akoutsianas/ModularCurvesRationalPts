...
// Magma code for modular curve with label 24.144.5.bhr.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1084

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 0, 6, 19], [1, 3, 12, 19], [5, 16, 16, 1], [17, 0, 0, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.fc.1", "24.72.2.dw.1", "24.72.2.ek.1", "24.72.2.iy.1", "24.72.2.jn.1", "24.72.3.bhp.1", "24.72.3.bic.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.bhr.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
