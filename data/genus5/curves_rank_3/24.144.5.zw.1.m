...
// Magma code for modular curve with label 24.144.5.zw.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.927

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 15, 0, 7], [7, 18, 12, 23], [13, 11, 10, 7], [17, 16, 10, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.ej.1", "24.72.2.bg.1", "24.72.2.bl.1", "24.72.2.hy.1", "24.72.2.jg.1", "24.72.3.bde.1", "24.72.3.bem.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.zw.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x-y);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*z);
