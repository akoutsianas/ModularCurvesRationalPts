...
// Magma code for modular curve with label 60.120.5.gd.1

// Other names and/or labels
// Cummins-Pauli label: 20F5
// Rouse-Sutherland-Zureick-Brown label: 60.120.5.195

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[29, 34, 20, 51], [41, 56, 47, 43], [47, 6, 37, 49], [49, 58, 32, 31], [53, 8, 45, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.3.v.1", "60.60.2.d.1", "60.60.2.f.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.120.5.gd.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
