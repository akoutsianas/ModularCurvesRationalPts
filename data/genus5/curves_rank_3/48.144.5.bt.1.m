...
// Magma code for modular curve with label 48.144.5.bt.1

// Other names and/or labels
// Cummins-Pauli label: 48E5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.413

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 12, 42, 43], [3, 2, 26, 13], [11, 17, 2, 37], [29, 15, 0, 23], [29, 27, 12, 47]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.2.hv.1", "48.48.1.ht.1", "48.72.0.b.1", "48.72.3.bn.2"];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.bt.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(6*v);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.bt.1
//   Coordinate number 0:
map_2_coord_0 := 1*(w);
//   Coordinate number 1:
