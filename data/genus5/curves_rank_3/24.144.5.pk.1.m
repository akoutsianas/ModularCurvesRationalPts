...
// Magma code for modular curve with label 24.144.5.pk.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1236

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 19, 8, 7], [5, 1, 22, 19], [13, 19, 14, 7], [19, 20, 22, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.dd.1", "24.72.2.bb.1", "24.72.2.bz.1", "24.72.2.fo.1", "24.72.2.gu.1", "24.72.3.bgy.1", "24.72.3.bie.1"];
...
map_0_coord_0 := 1*(2*t);
//   Coordinate number 1:
map_0_coord_1 := 1*(-2*x-4*z);
//   Coordinate number 2:
map_0_coord_2 := 1*(y);
// Codomain equation:
map_0_codomain := [3*x^4+5*x^2*y^2+2*y^4+18*x^2*z^2+18*y^2*z^2+36*z^4];

// Map from the canonical model to the plane model of modular curve with label 24.144.5.pk.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+z);
//   Coordinate number 1:
