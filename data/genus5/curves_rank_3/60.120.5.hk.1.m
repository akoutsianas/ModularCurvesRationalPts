...
// Magma code for modular curve with label 60.120.5.hk.1

// Other names and/or labels
// Cummins-Pauli label: 30Q5
// Rouse-Sutherland-Zureick-Brown label: 60.120.5.84

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 46, 13, 57], [41, 38, 50, 19], [47, 19, 59, 14], [48, 23, 31, 42]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["15.60.2.a.1", "60.60.2.o.1", "60.60.3.cb.1"];
...
// Canonical model
model_0 := [2*x*z+x*t+2*y*z+y*w,3*x^2-6*x*y+3*y^2-z^2-w^2+w*t-t^2,6*x^2+3*x*y+6*y^2+z*w+z*t+w*t];
...
//   Coordinate number 1:
map_0_coord_1 := 1*(3*x+3*y-w-t);
//   Coordinate number 2:
map_0_coord_2 := 1*(3*x+3*y+2*z+2*w+2*t);
// Codomain equation:
...
// Map from the canonical model to the plane model of modular curve with label 60.120.5.hk.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
