...
// Magma code for modular curve with label 48.96.5.qv.1

// Other names and/or labels
// Cummins-Pauli label: 16E5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.284

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 11, 30, 17], [7, 18, 42, 17], [37, 26, 22, 3], [41, 2, 8, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.bw.1", "48.48.1.gc.1", "48.48.3.fv.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.qv.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
