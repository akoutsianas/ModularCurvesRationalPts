...
// Magma code for modular curve with label 48.96.5.uz.1

// Other names and/or labels
// Cummins-Pauli label: 16B5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.129

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 34, 26, 41], [15, 32, 44, 3], [33, 2, 46, 35], [39, 13, 20, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.da.1", "24.48.1.mc.1", "48.48.1.jd.1", "48.48.3.ea.2", "48.48.3.fk.1", "48.48.3.ft.1", "48.48.3.gg.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.uz.1
//   Coordinate number 0:
