...
// Magma code for modular curve with label 40.144.5.ge.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.189

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 28, 14, 9], [17, 27, 20, 29], [35, 38, 38, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.q.1", "40.72.1.u.2", "40.72.1.bg.1", "40.72.3.bv.1", "40.72.3.cq.1", "40.72.3.dc.1", "40.72.3.em.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.ge.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*w);
