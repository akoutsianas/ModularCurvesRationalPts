...
// Magma code for modular curve with label 24.96.5.ef.1

// Other names and/or labels
// Cummins-Pauli label: 24K5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.115

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 3, 6, 19], [1, 19, 0, 19], [5, 7, 18, 19], [11, 13, 0, 13], [17, 23, 18, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["12.48.2.d.1", "24.24.1.dd.1", "24.48.2.j.1", "24.48.3.bu.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.ef.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
