...
// Magma code for modular curve with label 60.120.5.be.1

// Other names and/or labels
// Cummins-Pauli label: 20E5
// Rouse-Sutherland-Zureick-Brown label: 60.120.5.180

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[15, 23, 22, 15], [19, 13, 18, 53], [47, 24, 24, 59], [51, 53, 20, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.2.a.1", "60.60.2.h.1", "60.60.3.n.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.120.5.be.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
