...
// Magma code for modular curve with label 48.96.5.fr.1

// Other names and/or labels
// Cummins-Pauli label: 16C5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.649

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 14, 44, 35], [15, 32, 16, 31], [37, 24, 40, 29], [39, 5, 22, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.x.1", "48.48.1.k.1", "48.48.3.bb.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.fr.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+z);
//   Coordinate number 1:
