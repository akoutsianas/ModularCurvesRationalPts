...
// Magma code for modular curve with label 48.96.5.ok.1

// Other names and/or labels
// Cummins-Pauli label: 16H5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.335

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 9, 10, 13], [15, 7, 14, 1], [23, 11, 44, 9], [39, 23, 38, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.bs.1", "48.48.2.bn.1", "48.48.3.de.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.ok.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
