...
// Magma code for modular curve with label 24.144.5.bcg.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.956

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 13, 22, 23], [1, 18, 12, 13], [5, 11, 16, 23], [13, 21, 12, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.ez.1", "24.72.2.cm.1", "24.72.2.di.1", "24.72.2.ha.1", "24.72.2.iy.1", "24.72.3.bfu.1", "24.72.3.bhk.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.bcg.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*w);
