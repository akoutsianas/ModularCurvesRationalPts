...
// Magma code for modular curve with label 48.96.5.lg.1

// Other names and/or labels
// Cummins-Pauli label: 16E5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.469

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 23, 40, 27], [7, 47, 8, 9], [25, 42, 8, 37], [41, 29, 46, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.br.1", "48.48.1.fk.1", "48.48.1.fo.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.lg.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
