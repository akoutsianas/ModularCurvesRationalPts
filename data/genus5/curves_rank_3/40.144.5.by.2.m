...
// Magma code for modular curve with label 40.144.5.by.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.244

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[23, 10, 10, 33], [29, 3, 26, 31], [37, 7, 10, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.q.2", "40.72.1.e.2", "40.72.1.bp.1", "40.72.3.m.2", "40.72.3.p.1", "40.72.3.di.2", "40.72.3.ep.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.by.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
