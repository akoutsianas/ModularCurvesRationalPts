...
// Magma code for modular curve with label 48.96.5.so.1

// Other names and/or labels
// Cummins-Pauli label: 16B5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.237

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 29, 40, 13], [15, 22, 40, 19], [27, 44, 34, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.cp.1", "24.48.1.jz.1", "48.48.1.jf.1", "48.48.3.dw.1", "48.48.3.ek.1", "48.48.3.fm.1", "48.48.3.ge.2"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.so.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
