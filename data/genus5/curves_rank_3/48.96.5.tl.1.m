...
// Magma code for modular curve with label 48.96.5.tl.1

// Other names and/or labels
// Cummins-Pauli label: 16B5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.262

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[15, 31, 34, 33], [23, 23, 26, 9], [41, 34, 14, 23], [41, 34, 24, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.cs.1", "24.48.1.ko.1", "48.48.1.iz.1", "48.48.3.ec.2", "48.48.3.en.1", "48.48.3.fg.1", "48.48.3.gg.2"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.tl.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
