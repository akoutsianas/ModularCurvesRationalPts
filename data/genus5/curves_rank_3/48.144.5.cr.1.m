...
// Magma code for modular curve with label 48.144.5.cr.1

// Other names and/or labels
// Cummins-Pauli label: 48G5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.825

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 6, 0, 35], [15, 32, 14, 33], [23, 27, 24, 37], [25, 21, 0, 19], [35, 40, 4, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.2.it.1", "48.72.0.b.2", "48.72.3.bl.2"];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.cr.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.cr.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-t);
//   Coordinate number 1:
