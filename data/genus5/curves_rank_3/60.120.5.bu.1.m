...
// Magma code for modular curve with label 60.120.5.bu.1

// Other names and/or labels
// Cummins-Pauli label: 20E5
// Rouse-Sutherland-Zureick-Brown label: 60.120.5.121

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 23, 28, 23], [23, 35, 34, 17], [49, 0, 20, 59], [59, 7, 32, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.2.d.1", "60.60.2.b.1", "60.60.3.n.1"];
...
// Canonical model
model_0 := [x*w-2*x*t-y*z,3*y^2+2*z^2+w^2+2*w*t+2*t^2,15*x^2+5*z^2-2*w^2-2*w*t+2*t^2];
...
// Map from the canonical model to the plane model of modular curve with label 60.120.5.bu.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
