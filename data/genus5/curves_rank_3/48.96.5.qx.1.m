...
// Magma code for modular curve with label 48.96.5.qx.1

// Other names and/or labels
// Cummins-Pauli label: 16E5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.285

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 31, 30, 19], [29, 13, 6, 11], [37, 17, 20, 47], [41, 20, 42, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.bv.1", "48.48.1.gh.1", "48.48.3.fv.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.qx.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
