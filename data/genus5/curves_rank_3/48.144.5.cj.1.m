...
// Magma code for modular curve with label 48.144.5.cj.1

// Other names and/or labels
// Cummins-Pauli label: 48G5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.425

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 11, 34, 37], [35, 5, 40, 17], [35, 37, 28, 1], [37, 46, 44, 13], [39, 10, 10, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.2.il.1", "48.72.0.b.2", "48.72.3.bl.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.cj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*r);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.cj.1
//   Coordinate number 0:
map_2_coord_0 := 1*(t);
//   Coordinate number 1:
