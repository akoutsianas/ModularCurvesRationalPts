...
// Magma code for modular curve with label 56.96.5.q.1

// Other names and/or labels
// Cummins-Pauli label: 28E5
// Rouse-Sutherland-Zureick-Brown label: 56.96.5.40

// Group data
level := 56;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 38, 52, 55], [28, 19, 41, 28], [33, 36, 6, 41], [35, 32, 46, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["28.48.2.h.1", "56.12.0.h.1", "56.48.2.c.1", "56.48.3.a.1"];
...
// Map from the canonical model to the plane model of modular curve with label 56.96.5.q.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
