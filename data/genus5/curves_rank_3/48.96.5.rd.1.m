...
// Magma code for modular curve with label 48.96.5.rd.1

// Other names and/or labels
// Cummins-Pauli label: 16F5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.14

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 19, 38, 5], [19, 25, 32, 45], [21, 14, 22, 15], [29, 8, 24, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.bs.1", "48.48.1.go.1", "48.48.3.ft.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.rd.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
