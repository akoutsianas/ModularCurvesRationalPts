...
// Magma code for modular curve with label 60.120.5.hm.1

// Other names and/or labels
// Cummins-Pauli label: 30Q5
// Rouse-Sutherland-Zureick-Brown label: 60.120.5.239

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[8, 3, 21, 52], [31, 36, 6, 29], [35, 52, 13, 55], [49, 41, 11, 26]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["30.60.2.g.1", "60.60.2.k.1", "60.60.3.cb.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.120.5.hm.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
