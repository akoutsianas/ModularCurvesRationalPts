...
// Magma code for modular curve with label 48.96.5.cl.1

// Other names and/or labels
// Cummins-Pauli label: 16B5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.51

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 6, 40, 29], [11, 20, 42, 17], [13, 28, 46, 39], [13, 40, 8, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.o.1", "48.48.1.gx.1", "48.48.1.ij.1", "48.48.3.a.1", "48.48.3.b.1", "48.48.3.eo.1", "48.48.3.fs.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.cl.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
