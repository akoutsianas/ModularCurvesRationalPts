...
// Magma code for modular curve with label 48.144.5.ci.1

// Other names and/or labels
// Cummins-Pauli label: 48G5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.450

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 4, 22, 45], [5, 46, 14, 23], [7, 26, 4, 31], [17, 46, 34, 7], [29, 29, 28, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.2.ik.1", "48.72.0.b.1", "48.72.3.bl.2"];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.ci.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.ci.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-t);
//   Coordinate number 1:
