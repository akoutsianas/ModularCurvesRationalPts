...
// Magma code for modular curve with label 48.96.5.d.2

// Other names and/or labels
// Cummins-Pauli label: 16B5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.47

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 46, 18, 31], [17, 38, 16, 45], [19, 14, 22, 45], [23, 42, 22, 25], [25, 20, 0, 41]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.d.1", "48.48.1.ha.1", "48.48.1.ie.1", "48.48.3.a.1", "48.48.3.b.1", "48.48.3.ej.1", "48.48.3.fv.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.d.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
