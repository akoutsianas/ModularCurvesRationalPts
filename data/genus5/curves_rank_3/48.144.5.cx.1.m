...
// Magma code for modular curve with label 48.144.5.cx.1

// Other names and/or labels
// Cummins-Pauli label: 48G5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.445

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[15, 40, 34, 9], [23, 28, 8, 47], [35, 44, 28, 47], [37, 6, 24, 17], [45, 7, 44, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.2.jd.1", "48.72.0.b.2", "48.72.3.bj.1"];
...
// Embedded model
model_0 := [w*t+y*r,z*w+x*r,z^2+t^2-z*r,x*z+y*t-x*r,y*z-x*t,z^2-t^2-t*u+z*r,x*z-y*t-y*u+x*r,x^2+y^2+x*w,y*z+x*t+x*u+w*u,2*z*t+z*u-u*r,x^2-2*y^2+x*w-z*t,3*y*w-z*r,3*x*y+z^2,x^2+y^2-2*x*w-3*w^2-t*r,2*x^2-y^2-x*w+3*w^2-z*t+t*r+u*r,z^2+2*t*u+2*u^2-3*v^2+2*z*r+r^2];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.cx.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(v);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.cx.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-r);
//   Coordinate number 1:
map_2_coord_1 := 1*(27*w^4*v*r+3*v*r^5);
//   Coordinate number 2:
map_2_coord_2 := 1*(-w);
// Codomain equation:
