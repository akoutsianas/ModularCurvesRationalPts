...
// Magma code for modular curve with label 48.96.5.rc.1

// Other names and/or labels
// Cummins-Pauli label: 16F5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.89

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 44, 4, 13], [7, 17, 2, 17], [9, 4, 22, 3], [25, 12, 46, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.bu.1", "48.48.1.gn.1", "48.48.3.fu.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.rc.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
