...
// Magma code for modular curve with label 48.96.5.ph.1

// Other names and/or labels
// Cummins-Pauli label: 16F5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.122

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 38, 22, 45], [21, 25, 10, 27], [23, 3, 26, 25], [41, 41, 2, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.be.1", "24.48.1.mf.1", "48.48.3.ft.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.ph.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(4*y);
