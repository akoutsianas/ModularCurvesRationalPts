...
// Magma code for modular curve with label 28.84.5.l.1

// Other names and/or labels
// Cummins-Pauli label: 14B5
// Rouse-Sutherland-Zureick-Brown label: 28.84.5.8

// Group data
level := 28;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 11, 14, 27], [24, 13, 13, 18]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 84;
...
covers := ["14.42.1.b.1", "28.42.1.b.1", "28.42.3.b.1"];
...
// Map from the canonical model to the plane model of modular curve with label 28.84.5.l.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
