...
// Magma code for modular curve with label 28.112.5.l.1

// Other names and/or labels
// Cummins-Pauli label: 14E5
// Rouse-Sutherland-Zureick-Brown label: 28.112.5.6

// Group data
level := 28;
// Elements that, together with Gamma(level), generate the group
gens := [[6, 5, 7, 8], [15, 15, 1, 24], [16, 5, 5, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 112;
...
covers := ["14.56.1.b.1", "28.56.1.b.1", "28.56.3.b.1"];
...
// Map from the canonical model to the plane model of modular curve with label 28.112.5.l.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
