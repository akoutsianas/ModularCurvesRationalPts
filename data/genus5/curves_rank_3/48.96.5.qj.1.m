...
// Magma code for modular curve with label 48.96.5.qj.1

// Other names and/or labels
// Cummins-Pauli label: 16F5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.15

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 32, 0, 41], [5, 35, 4, 3], [39, 20, 44, 11], [39, 34, 10, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.bs.1", "48.48.1.fw.1", "48.48.3.fx.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.qj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
