...
// Magma code for modular curve with label 48.96.5.qa.1

// Other names and/or labels
// Cummins-Pauli label: 16E5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.249

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 31, 16, 35], [11, 40, 8, 11], [19, 10, 42, 29], [29, 11, 14, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.bn.1", "48.48.1.fp.1", "48.48.3.en.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.qa.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
