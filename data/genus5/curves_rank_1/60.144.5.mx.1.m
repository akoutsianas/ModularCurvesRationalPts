...
// Magma code for modular curve with label 60.144.5.mx.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.198

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 58, 43, 45], [51, 8, 16, 15], [53, 24, 0, 59]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.3.dd.1", "60.72.1.bj.1", "60.72.1.bp.1", "60.72.1.ez.1", "60.72.3.ny.1", "60.72.3.od.1", "60.72.3.ux.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.mx.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
