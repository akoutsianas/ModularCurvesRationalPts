...
// Magma code for modular curve with label 48.96.5.jj.2

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.431

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 41, 14, 25], [25, 29, 6, 13], [43, 46, 16, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.bt.2", "24.48.1.ks.1", "48.48.1.hc.2", "48.48.1.hl.2", "48.48.3.bi.1", "48.48.3.bq.1", "48.48.3.dp.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.jj.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x+z);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
