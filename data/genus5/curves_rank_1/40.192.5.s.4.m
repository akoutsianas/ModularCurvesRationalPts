...
// Magma code for modular curve with label 40.192.5.s.4

// Other names and/or labels
// Cummins-Pauli label: 8A5
// Rouse-Sutherland-Zureick-Brown label: 40.192.5.44

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 28, 8, 9], [7, 32, 0, 33], [9, 0, 24, 31], [13, 12, 16, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["8.96.3.h.1", "40.96.1.n.2", "40.96.1.q.1", "40.96.1.s.2", "40.96.3.s.1", "40.96.3.w.3", "40.96.3.ba.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.192.5.s.4
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
