...
// Magma code for modular curve with label 48.96.5.nx.1

// Other names and/or labels
// Cummins-Pauli label: 16H5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.317

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 12, 32, 41], [29, 30, 26, 35], [29, 43, 30, 31], [37, 26, 44, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.bm.1", "48.48.2.bs.1", "48.48.3.dd.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.nx.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
