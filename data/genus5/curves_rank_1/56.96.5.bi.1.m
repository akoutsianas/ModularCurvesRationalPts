...
// Magma code for modular curve with label 56.96.5.bi.1

// Other names and/or labels
// Cummins-Pauli label: 28E5
// Rouse-Sutherland-Zureick-Brown label: 56.96.5.44

// Group data
level := 56;
// Elements that, together with Gamma(level), generate the group
gens := [[10, 21, 11, 8], [12, 35, 11, 38], [12, 49, 27, 44], [31, 26, 4, 53]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["28.48.2.g.1", "56.12.0.w.1", "56.48.2.e.1", "56.48.3.b.1"];
...
// Map from the canonical model to the plane model of modular curve with label 56.96.5.bi.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
