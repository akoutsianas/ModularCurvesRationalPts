...
// Magma code for modular curve with label 60.144.5.sv.1

// Other names and/or labels
// Cummins-Pauli label: 12D5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.282

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 2, 6, 17], [22, 35, 41, 38], [43, 8, 32, 23], [53, 6, 34, 55]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.3.dv.1", "60.72.1.fb.1", "60.72.3.baj.1"];
...
// Canonical model
model_0 := [5*y*z-w*t,5*y^2-5*z^2-3*w^2-t^2,15*x^2+5*y^2+2*w*t-t^2];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.sv.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
