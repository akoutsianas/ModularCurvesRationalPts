...
// Magma code for modular curve with label 24.96.5.gx.1

// Other names and/or labels
// Cummins-Pauli label: 24J5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.171

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 23, 18, 7], [5, 23, 12, 11], [17, 17, 18, 7], [23, 13, 18, 13], [23, 17, 0, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.24.0.dz.1", "24.48.2.m.1", "24.48.2.q.1", "24.48.3.ck.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.gx.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
