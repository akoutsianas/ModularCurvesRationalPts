...
// Magma code for modular curve with label 56.96.5.s.1

// Other names and/or labels
// Cummins-Pauli label: 28E5
// Rouse-Sutherland-Zureick-Brown label: 56.96.5.32

// Group data
level := 56;
// Elements that, together with Gamma(level), generate the group
gens := [[4, 29, 53, 28], [5, 50, 44, 33], [6, 29, 53, 44], [28, 13, 33, 14], [43, 38, 44, 51]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["28.48.2.a.1", "56.12.0.j.1", "56.48.2.o.1", "56.48.3.b.1"];
...
// Map from the canonical model to the plane model of modular curve with label 56.96.5.s.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
