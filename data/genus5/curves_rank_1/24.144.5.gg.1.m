...
// Magma code for modular curve with label 24.144.5.gg.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.624

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 5, 20, 9], [9, 10, 2, 9], [15, 22, 2, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.3.cr.1", "24.72.1.r.1", "24.72.1.bq.1", "24.72.1.bx.1", "24.72.3.lr.1", "24.72.3.qb.1", "24.72.3.qw.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.gg.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
