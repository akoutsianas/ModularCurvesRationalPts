...
// Magma code for modular curve with label 24.144.5.kn.1

// Other names and/or labels
// Cummins-Pauli label: 12D5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.712

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 18, 12, 17], [9, 7, 22, 3], [15, 10, 20, 3], [17, 18, 6, 19], [23, 0, 18, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.3.dw.1", "24.72.1.cq.1", "24.72.3.zo.1"];
...
// Canonical model
model_0 := [2*x*z-w*t,6*x^2+2*z^2+w^2-t^2,6*y^2+2*z^2+w^2-2*w*t];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.kn.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
