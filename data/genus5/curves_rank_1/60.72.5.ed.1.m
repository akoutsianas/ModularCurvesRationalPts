...
// Magma code for modular curve with label 60.72.5.ed.1

// Other names and/or labels
// Cummins-Pauli label: 30G5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.119

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[34, 45, 51, 56], [41, 15, 3, 22], [43, 50, 29, 47], [58, 15, 27, 16]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["30.36.1.p.1", "60.36.2.fs.1", "60.36.2.fu.2"];
...
// Map from the canonical model to the plane model of modular curve with label 60.72.5.ed.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
