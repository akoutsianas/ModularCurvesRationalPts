...
// Magma code for modular curve with label 24.144.5.xi.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.836

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 17, 22, 23], [19, 6, 18, 13], [21, 10, 20, 9], [23, 0, 0, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.en.1", "24.72.2.m.1", "24.72.2.bu.1", "24.72.2.ha.1", "24.72.2.ih.1", "24.72.3.bcp.1", "24.72.3.bdm.1"];
...
// Canonical model
model_0 := [x*w+y*z,2*x*y-z^2-w^2,2*x^2+2*x*y+2*y^2+z^2-4*z*w+w^2-t^2];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.xi.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
