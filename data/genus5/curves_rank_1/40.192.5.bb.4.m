...
// Magma code for modular curve with label 40.192.5.bb.4

// Other names and/or labels
// Cummins-Pauli label: 8A5
// Rouse-Sutherland-Zureick-Brown label: 40.192.5.18

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 20, 28, 3], [27, 20, 2, 29], [27, 24, 36, 39], [31, 8, 14, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["8.96.1.g.1", "40.96.1.n.2", "40.96.1.x.2", "40.96.3.w.3", "40.96.3.x.2", "40.96.3.z.2", "40.96.3.be.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.192.5.bb.4
//   Coordinate number 0:
map_1_coord_0 := 1*(x+z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
