...
// Magma code for modular curve with label 60.144.5.bz.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.256

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[41, 34, 10, 13], [46, 27, 35, 8], [49, 24, 20, 29], [59, 18, 54, 59]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.3.t.1", "60.72.1.f.1", "60.72.1.h.1", "60.72.1.fa.1", "60.72.3.cu.1", "60.72.3.hx.1", "60.72.3.ux.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.bz.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+z);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
