...
// Magma code for modular curve with label 40.120.5.ew.1

// Other names and/or labels
// Cummins-Pauli label: 20E5
// Rouse-Sutherland-Zureick-Brown label: 40.120.5.184

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[15, 26, 3, 25], [15, 34, 18, 15], [37, 8, 6, 7], [39, 38, 4, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.3.o.1", "40.60.2.c.1", "40.60.2.k.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.120.5.ew.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
