...
// Magma code for modular curve with label 24.72.5.hq.1

// Other names and/or labels
// Cummins-Pauli label: 24D5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.268

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 22, 4, 15], [7, 13, 2, 1], [11, 11, 2, 19], [19, 7, 14, 13], [19, 16, 8, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.0.bv.1", "24.36.2.gg.1", "24.36.3.b.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.5.hq.1
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
