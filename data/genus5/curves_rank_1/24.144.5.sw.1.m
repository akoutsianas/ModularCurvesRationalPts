...
// Magma code for modular curve with label 24.144.5.sw.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1258

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 21, 18, 11], [17, 1, 18, 19], [21, 1, 22, 23], [21, 19, 20, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.du.1", "24.72.2.cs.1", "24.72.2.da.1", "24.72.2.fa.1", "24.72.2.fy.1", "24.72.3.bcw.1", "24.72.3.bdu.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.sw.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x-z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
