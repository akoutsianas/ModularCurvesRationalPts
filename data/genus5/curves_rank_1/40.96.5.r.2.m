...
// Magma code for modular curve with label 40.96.5.r.2

// Other names and/or labels
// Cummins-Pauli label: 20D5
// Rouse-Sutherland-Zureick-Brown label: 40.96.5.13

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[15, 17, 11, 16], [25, 2, 38, 39], [39, 24, 35, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["20.48.1.a.2", "40.24.1.cn.2", "40.48.3.g.1", "40.48.3.j.1"];
...
// Canonical model
model_0 := [x^2+2*x*y+3*x*z+x*t+y^2-2*y*z+y*t+z^2-z*t-t^2,2*x^2+2*x*t+3*y^2+4*y*z+3*z^2-2*t^2,4*x^2+8*x*y+2*x*z-6*x*t-6*y*t+6*z*t-5*w^2+6*t^2];
...
// Map from the canonical model to the plane model of modular curve with label 40.96.5.r.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
