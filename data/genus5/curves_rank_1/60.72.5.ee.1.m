...
// Magma code for modular curve with label 60.72.5.ee.1

// Other names and/or labels
// Cummins-Pauli label: 30G5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.73

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[4, 25, 7, 56], [6, 35, 23, 42], [38, 45, 27, 56], [41, 25, 44, 53]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["15.36.2.b.1", "60.36.1.fz.1", "60.36.2.fv.2"];
...
// Map from the canonical model to the plane model of modular curve with label 60.72.5.ee.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
