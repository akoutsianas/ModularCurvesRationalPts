...
// Magma code for modular curve with label 48.144.5.bg.2

// Other names and/or labels
// Cummins-Pauli label: 48F5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.330

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[23, 18, 36, 35], [29, 25, 46, 1], [41, 42, 12, 13], [43, 5, 14, 17], [45, 41, 38, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.2.hi.2", "48.48.1.hg.2", "48.72.0.a.1", "48.72.3.bc.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.bg.2
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.bg.2
//   Coordinate number 0:
map_2_coord_0 := 1*(t);
//   Coordinate number 1:
