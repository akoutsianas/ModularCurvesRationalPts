...
// Magma code for modular curve with label 24.144.5.bdu.1

// Other names and/or labels
// Cummins-Pauli label: 24S5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.987

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 13, 22, 21], [9, 23, 10, 15], [15, 2, 4, 3], [21, 2, 16, 3], [21, 17, 22, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.cn.1", "24.72.3.bfr.1", "24.72.3.big.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.bdu.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
