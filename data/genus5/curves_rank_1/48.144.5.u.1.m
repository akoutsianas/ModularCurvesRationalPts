...
// Magma code for modular curve with label 48.144.5.u.1

// Other names and/or labels
// Cummins-Pauli label: 48H5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.795

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 42, 0, 47], [19, 29, 38, 23], [23, 38, 40, 41], [25, 14, 16, 43], [43, 7, 2, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.2.hk.1", "48.72.0.a.2", "48.72.3.w.1"];
...
// Embedded model
model_0 := [x*z-y*w,x*z-x*w-t*r,x*z+x*w-z*t,z*t-w*t+x*u-x*v,z^2-z*w-z*r-w*r,z^2-w^2+z*u-z*v,x*z-y*z+x*r+y*r,y*z-x*w+y*u-y*v,x^2+x*y-y*t,z*w-w^2-z*r-w*r-u*r+v*r,2*x^2-x*y-z*w+y*t+w*r,x^2-2*x*y+z*w-y*t+w*r,z^2+w^2-3*x*t+z*u-z*v,3*y^2-z^2-z*r,w^2+2*u^2+2*u*v+2*v^2-2*z*r-u*r+v*r+r^2,2*z*w+2*w^2-3*t^2+2*w*u-2*w*v];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.u.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(6*v);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.u.1
//   Coordinate number 0:
map_2_coord_0 := 1*(w);
//   Coordinate number 1:
map_2_coord_1 := 1*(-36*w^3*t^2*v-54*w^2*t^4+54*w*t^4*v+40*t^6);
//   Coordinate number 2:
map_2_coord_2 := 1*(t);
// Codomain equation:
