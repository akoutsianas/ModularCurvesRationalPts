...
// Magma code for modular curve with label 48.144.5.d.1

// Other names and/or labels
// Cummins-Pauli label: 48F5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.734

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 19, 2, 13], [9, 10, 20, 21], [23, 43, 2, 11], [35, 12, 0, 31], [43, 10, 44, 43]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.2.ho.1", "48.48.1.gt.2", "48.72.0.a.1", "48.72.3.r.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.d.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*v);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.d.1
//   Coordinate number 0:
map_2_coord_0 := 1*(w);
//   Coordinate number 1:
