...
// Magma code for modular curve with label 24.192.5.fi.3

// Other names and/or labels
// Cummins-Pauli label: 24Z5
// Rouse-Sutherland-Zureick-Brown label: 24.192.5.1511

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 3, 0, 13], [13, 11, 0, 1], [19, 20, 0, 23], [23, 6, 0, 17], [23, 6, 0, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["24.96.1.dc.4", "24.96.1.dg.4", "24.96.1.dj.2", "24.96.3.ff.1", "24.96.3.fz.1", "24.96.3.gn.3", "24.96.3.gq.1"];
...
model_1 := [4*x^8-120*x^6*y^2+36*x^4*y^4-16*x^7*z+480*x^5*y^2*z-144*x^3*y^4*z+48*x^6*z^2-792*x^4*y^2*z^2+216*x^2*y^4*z^2-88*x^5*z^3+696*x^3*y^2*z^3-144*x*y^4*z^3+116*x^4*z^4-324*x^2*y^2*z^4+36*y^4*z^4-104*x^3*z^5+48*x*y^2*z^5+52*x^2*z^6+12*y^2*z^6-12*x*z^7+z^8];
...
// Map from the canonical model to the plane model of modular curve with label 24.192.5.fi.3
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z+t);
...
map_1_coord_2 := 1*(y+w);
// Codomain equation:
map_1_codomain := [4*x^8-120*x^6*y^2+36*x^4*y^4-16*x^7*z+480*x^5*y^2*z-144*x^3*y^4*z+48*x^6*z^2-792*x^4*y^2*z^2+216*x^2*y^4*z^2-88*x^5*z^3+696*x^3*y^2*z^3-144*x*y^4*z^3+116*x^4*z^4-324*x^2*y^2*z^4+36*y^4*z^4-104*x^3*z^5+48*x*y^2*z^5+52*x^2*z^6+12*y^2*z^6-12*x*z^7+z^8];
