...
// Magma code for modular curve with label 24.72.5.lw.1

// Other names and/or labels
// Cummins-Pauli label: 24G5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.144

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 2, 10, 11], [7, 12, 6, 1], [13, 7, 2, 19], [17, 14, 20, 1], [21, 4, 4, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bw.1", "24.36.1.gg.1", "24.36.3.h.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.5.lw.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y+z);
