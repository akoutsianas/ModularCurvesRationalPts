...
// Magma code for modular curve with label 52.84.5.k.1

// Other names and/or labels
// Cummins-Pauli label: 52B5
// Rouse-Sutherland-Zureick-Brown label: 52.84.5.14

// Group data
level := 52;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 39, 10, 11], [11, 17, 20, 35], [17, 4, 48, 47], [51, 11, 10, 47]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 84;
...
// Weierstrass model
model_2 := [26*x^10*z^2-338*x^8*z^4+x^6*y+9887*x^6*z^6-57122*x^4*z^8+742586*x^2*z^10+y^2+y*z^6-1206702*z^12];
...
// Map from the embedded model to the plane model of modular curve with label 52.84.5.k.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 52.84.5.k.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-u);
//   Coordinate number 1:
map_2_coord_1 := 1*(-25267/3*z^6+3380/3*z^4*u^2-416/3*z^2*u^4+338/3*z*w*u^4);
//   Coordinate number 2:
map_2_coord_2 := 1*(-z);
// Codomain equation:
map_2_codomain := [26*x^10*z^2-338*x^8*z^4+x^6*y+9887*x^6*z^6-57122*x^4*z^8+742586*x^2*z^10+y^2+y*z^6-1206702*z^12];
