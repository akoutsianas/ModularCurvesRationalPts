...
// Magma code for modular curve with label 24.144.5.ph.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.941

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 20, 14, 5], [11, 10, 14, 5], [13, 19, 14, 7], [19, 3, 0, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.dc.1", "24.72.2.bh.1", "24.72.2.cb.1", "24.72.2.fn.1", "24.72.2.gv.1", "24.72.3.bgt.1", "24.72.3.bib.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.ph.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x-y);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*z);
