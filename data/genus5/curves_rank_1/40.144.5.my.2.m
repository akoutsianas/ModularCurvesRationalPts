...
// Magma code for modular curve with label 40.144.5.my.2

// Other names and/or labels
// Cummins-Pauli label: 40L5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.674

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 28, 38, 39], [27, 19, 0, 21], [33, 5, 16, 7], [33, 24, 0, 37], [39, 33, 36, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["40.72.1.cq.1", "40.72.3.fx.2", "40.72.3.ge.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.my.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
