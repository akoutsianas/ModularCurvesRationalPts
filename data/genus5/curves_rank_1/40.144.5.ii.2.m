...
// Magma code for modular curve with label 40.144.5.ii.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.79

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 16, 2, 27], [21, 17, 22, 11], [31, 16, 20, 37], [31, 37, 30, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.k.1", "40.72.1.bf.2", "40.72.1.ci.1", "40.72.3.df.1", "40.72.3.dg.2", "40.72.3.dw.1", "40.72.3.eq.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.ii.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
