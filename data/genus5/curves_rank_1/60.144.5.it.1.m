...
// Magma code for modular curve with label 60.144.5.it.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.124

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 50, 13, 51], [15, 14, 46, 33], [49, 54, 15, 47]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.1.j.1", "60.72.1.p.1", "60.72.1.ej.1", "60.72.3.lf.1", "60.72.3.mc.1", "60.72.3.ob.1", "60.72.3.ty.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.it.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x-w);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*y);
