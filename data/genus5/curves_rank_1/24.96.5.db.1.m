...
// Magma code for modular curve with label 24.96.5.db.1

// Other names and/or labels
// Cummins-Pauli label: 24K5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.231

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 21, 18, 23], [11, 1, 0, 1], [11, 19, 12, 1], [17, 9, 18, 11], [19, 5, 0, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.24.1.bv.1", "24.48.2.o.1", "24.48.2.q.1", "24.48.3.d.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.db.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x-z);
//   Coordinate number 1:
map_1_coord_1 := 1*(4*y);
