...
// Magma code for modular curve with label 60.72.5.eb.2

// Other names and/or labels
// Cummins-Pauli label: 30G5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.49

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[23, 10, 58, 19], [32, 25, 7, 31], [37, 30, 39, 19], [57, 35, 20, 39], [57, 50, 38, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["15.36.2.a.1", "60.36.1.fz.1", "60.36.2.fu.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.72.5.eb.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
