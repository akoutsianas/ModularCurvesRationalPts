...
// Magma code for modular curve with label 40.120.5.ft.1

// Other names and/or labels
// Cummins-Pauli label: 20F5
// Rouse-Sutherland-Zureick-Brown label: 40.120.5.185

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[21, 24, 33, 39], [27, 28, 9, 7], [29, 32, 34, 1], [31, 22, 19, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.3.s.1", "40.60.2.i.1", "40.60.2.l.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.120.5.ft.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
