...
// Magma code for modular curve with label 20.120.5.bh.1

// Other names and/or labels
// Cummins-Pauli label: 20E5
// Rouse-Sutherland-Zureick-Brown label: 20.120.5.47

// Group data
level := 20;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 19, 4, 3], [13, 18, 6, 17], [19, 3, 14, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.2.b.1", "20.60.2.g.1", "20.60.3.n.1"];
...
// Map from the canonical model to the plane model of modular curve with label 20.120.5.bh.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
