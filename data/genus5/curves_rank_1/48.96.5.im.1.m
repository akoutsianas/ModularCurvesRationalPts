...
// Magma code for modular curve with label 48.96.5.im.1

// Other names and/or labels
// Cummins-Pauli label: 16B5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.390

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 4, 38, 1], [45, 13, 16, 7], [47, 24, 12, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.bq.1", "24.48.1.jx.1", "48.48.1.gz.1", "48.48.1.ib.1", "48.48.3.bm.1", "48.48.3.ck.1", "48.48.3.dy.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.im.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
