...
// Magma code for modular curve with label 40.120.5.p.1

// Other names and/or labels
// Cummins-Pauli label: 10B5
// Rouse-Sutherland-Zureick-Brown label: 40.120.5.168

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 4, 6, 39], [5, 22, 28, 13], [9, 4, 10, 21], [19, 6, 2, 31], [25, 17, 12, 35]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.3.a.1", "40.40.1.s.1", "40.60.2.c.1", "40.60.2.i.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.120.5.p.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
