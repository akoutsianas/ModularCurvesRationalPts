...
// Magma code for modular curve with label 48.144.5.m.2

// Other names and/or labels
// Cummins-Pauli label: 48F5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.328

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 27, 18, 11], [19, 15, 42, 19], [35, 2, 16, 41], [35, 45, 6, 37], [41, 42, 12, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.2.hi.2", "48.48.1.hc.2", "48.72.0.a.2", "48.72.3.s.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.m.2
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*r);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.m.2
//   Coordinate number 0:
map_2_coord_0 := 1*(-v);
//   Coordinate number 1:
