...
// Magma code for modular curve with label 60.108.5.q.1

// Other names and/or labels
// Cummins-Pauli label: 60A5
// Rouse-Sutherland-Zureick-Brown label: 60.108.5.19

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 25, 50, 3], [11, 15, 0, 23], [17, 5, 16, 23], [33, 35, 28, 9], [37, 0, 6, 23], [43, 55, 46, 47]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 108;
...
covers := ["30.54.2.a.1", "60.18.0.i.1", "60.36.1.dm.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.108.5.q.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.108.5.q.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-v);
//   Coordinate number 1:
map_2_coord_1 := 1*(-5063*y^6+30*y*w*v^4);
//   Coordinate number 2:
map_2_coord_2 := 1*(-y);
// Codomain equation:
map_2_codomain := [x^6*y-15187*x^6*z^6+y^2+y*z^6-2847656*z^12];
