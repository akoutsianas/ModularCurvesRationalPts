...
// Magma code for modular curve with label 48.96.5.le.1

// Other names and/or labels
// Cummins-Pauli label: 16E5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.475

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 13, 16, 1], [25, 13, 8, 39], [31, 43, 16, 33], [41, 26, 46, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.bn.1", "48.48.1.fo.1", "48.48.1.fp.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.le.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
