...
// Magma code for modular curve with label 40.120.5.gm.1

// Other names and/or labels
// Cummins-Pauli label: 20F5
// Rouse-Sutherland-Zureick-Brown label: 40.120.5.107

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 7, 30, 3], [21, 9, 18, 9], [21, 29, 36, 7], [31, 24, 6, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.2.e.1", "40.60.2.i.1", "40.60.3.cg.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.120.5.gm.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
