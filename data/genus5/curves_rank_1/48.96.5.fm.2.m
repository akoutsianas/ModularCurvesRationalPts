...
// Magma code for modular curve with label 48.96.5.fm.2

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.99

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 13, 46, 11], [9, 5, 22, 1], [11, 21, 38, 17], [15, 23, 26, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.bj.1", "48.48.1.hh.2", "48.48.1.hj.1", "48.48.3.v.2", "48.48.3.ba.1", "48.48.3.eu.1", "48.48.3.ew.2"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.fm.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
