...
// Magma code for modular curve with label 48.96.5.hv.2

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.414

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[15, 5, 22, 13], [37, 11, 38, 41], [43, 22, 28, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.bh.1", "24.48.1.kw.2", "48.48.1.gq.1", "48.48.1.he.1", "48.48.3.bk.2", "48.48.3.br.1", "48.48.3.dl.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.hv.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x+z);
//   Coordinate number 1:
