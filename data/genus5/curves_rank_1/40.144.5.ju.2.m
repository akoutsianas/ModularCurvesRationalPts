...
// Magma code for modular curve with label 40.144.5.ju.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.553

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 3, 14, 39], [5, 28, 22, 11], [9, 0, 22, 27], [15, 22, 22, 5], [33, 34, 24, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.bn.1", "40.72.1.bi.2", "40.72.1.bu.2", "40.72.1.ct.2", "40.72.3.de.1", "40.72.3.dq.2", "40.72.3.ed.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.ju.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
