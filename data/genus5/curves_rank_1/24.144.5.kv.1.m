...
// Magma code for modular curve with label 24.144.5.kv.1

// Other names and/or labels
// Cummins-Pauli label: 24U5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1002

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 4, 2, 9], [5, 9, 18, 19], [7, 0, 12, 23], [21, 10, 14, 3], [23, 12, 6, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.cq.1", "24.72.3.zj.1", "24.72.3.bar.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.kv.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
