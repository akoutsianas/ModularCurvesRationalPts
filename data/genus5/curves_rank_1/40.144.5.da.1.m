...
// Magma code for modular curve with label 40.144.5.da.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.493

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 8, 2, 1], [9, 28, 20, 37], [21, 28, 38, 21], [27, 35, 36, 21], [31, 32, 34, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.i.2", "40.72.1.j.2", "40.72.1.bp.1", "40.72.1.bz.2", "40.72.3.v.1", "40.72.3.dk.1", "40.72.3.ei.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.da.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
