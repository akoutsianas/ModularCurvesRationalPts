...
// Magma code for modular curve with label 40.144.5.cd.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.110

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 26, 2, 37], [15, 29, 8, 1], [17, 9, 24, 7], [19, 29, 32, 21], [33, 30, 34, 39]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.v.1", "40.72.1.f.1", "40.72.1.o.1", "40.72.3.n.2", "40.72.3.r.1", "40.72.3.cn.1", "40.72.3.ey.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.cd.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
