...
// Magma code for modular curve with label 48.96.5.hn.1

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.427

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 33, 22, 31], [35, 23, 34, 39], [39, 31, 2, 45]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.bh.2", "24.48.1.ks.1", "48.48.1.gr.1", "48.48.1.hg.2", "48.48.3.bi.2", "48.48.3.bu.2", "48.48.3.dh.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.hn.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
