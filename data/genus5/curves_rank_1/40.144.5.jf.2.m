...
// Magma code for modular curve with label 40.144.5.jf.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.555

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 11, 14, 27], [5, 18, 4, 9], [7, 2, 14, 5], [13, 8, 30, 11], [35, 38, 24, 39]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.bn.1", "40.72.1.bb.2", "40.72.1.bo.1", "40.72.1.cq.2", "40.72.3.cx.1", "40.72.3.dh.1", "40.72.3.ea.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.jf.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
