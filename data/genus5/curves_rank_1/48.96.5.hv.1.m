...
// Magma code for modular curve with label 48.96.5.hv.1

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.428

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 23, 34, 25], [29, 19, 42, 43], [39, 13, 26, 43]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.bh.2", "24.48.1.kw.1", "48.48.1.gq.2", "48.48.1.he.2", "48.48.3.bk.1", "48.48.3.br.2", "48.48.3.dl.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.hv.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
