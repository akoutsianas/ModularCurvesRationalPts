...
// Magma code for modular curve with label 48.96.5.ic.1

// Other names and/or labels
// Cummins-Pauli label: 16B5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.455

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 14, 2, 19], [21, 31, 10, 19], [35, 41, 32, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.bo.1", "24.48.1.jv.1", "48.48.1.hb.1", "48.48.1.hx.1", "48.48.3.bl.2", "48.48.3.ck.1", "48.48.3.dv.2"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.ic.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
