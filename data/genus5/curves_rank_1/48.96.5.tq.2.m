...
// Magma code for modular curve with label 48.96.5.tq.2

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.215

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 16, 24, 17], [37, 12, 32, 7], [41, 34, 44, 21], [47, 3, 30, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.cx.2", "24.48.1.kr.2", "48.48.1.in.1", "48.48.3.do.1", "48.48.3.eq.2", "48.48.3.fa.2", "48.48.3.fz.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.tq.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
