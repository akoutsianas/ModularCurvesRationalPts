...
// Magma code for modular curve with label 48.96.5.ie.1

// Other names and/or labels
// Cummins-Pauli label: 16B5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.386

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[37, 1, 16, 39], [47, 12, 2, 29], [47, 19, 22, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.bm.1", "24.48.1.jx.1", "48.48.1.gv.1", "48.48.1.hx.1", "48.48.3.bm.2", "48.48.3.cg.1", "48.48.3.dw.2"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.ie.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
