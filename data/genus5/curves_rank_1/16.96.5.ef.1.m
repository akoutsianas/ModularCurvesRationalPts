...
// Magma code for modular curve with label 16.96.5.ef.1

// Other names and/or labels
// Cummins-Pauli label: 16H5
// Rouse-Sutherland-Zureick-Brown label: 16.96.5.153

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 14, 12, 13], [5, 2, 10, 3], [13, 3, 14, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.bl.1", "16.48.2.bs.1", "16.48.3.cf.1"];
...
// Map from the canonical model to the plane model of modular curve with label 16.96.5.ef.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
