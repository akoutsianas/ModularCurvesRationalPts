...
// Magma code for modular curve with label 40.144.5.ka.2

// Other names and/or labels
// Cummins-Pauli label: 40N5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.664

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 36, 26, 23], [15, 33, 14, 9], [15, 34, 6, 33], [23, 39, 0, 37], [37, 0, 30, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["40.72.1.ct.2", "40.72.3.fc.1", "40.72.3.fh.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.ka.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
