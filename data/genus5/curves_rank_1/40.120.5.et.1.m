...
// Magma code for modular curve with label 40.120.5.et.1

// Other names and/or labels
// Cummins-Pauli label: 20E5
// Rouse-Sutherland-Zureick-Brown label: 40.120.5.189

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 2, 10, 17], [3, 34, 7, 37], [7, 34, 11, 21], [15, 16, 1, 35]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.3.n.1", "40.60.2.c.1", "40.60.2.l.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.120.5.et.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
