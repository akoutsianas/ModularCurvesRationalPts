...
// Magma code for modular curve with label 48.96.5.jk.2

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.450

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 19, 26, 5], [37, 32, 40, 25], [47, 23, 34, 45]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.bu.2", "24.48.1.kt.2", "48.48.1.hd.2", "48.48.1.hk.2", "48.48.3.bi.2", "48.48.3.bp.1", "48.48.3.dp.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.jk.2
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
