...
// Magma code for modular curve with label 60.120.5.fc.1

// Other names and/or labels
// Cummins-Pauli label: 20F5
// Rouse-Sutherland-Zureick-Brown label: 60.120.5.128

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[41, 58, 50, 59], [49, 59, 38, 21], [53, 24, 44, 35], [55, 39, 26, 55]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.2.g.1", "30.60.2.d.1", "60.60.3.bq.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.120.5.fc.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
