...
// Magma code for modular curve with label 24.144.5.or.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.937

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 3, 12, 17], [21, 22, 16, 9], [23, 5, 14, 1], [23, 22, 22, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.dc.1", "24.72.2.bf.1", "24.72.2.bl.1", "24.72.2.ff.1", "24.72.2.gn.1", "24.72.3.bgl.1", "24.72.3.bht.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.or.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
