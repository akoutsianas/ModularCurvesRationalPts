...
// Magma code for modular curve with label 60.144.5.sl.1

// Other names and/or labels
// Cummins-Pauli label: 20J5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.627

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 2, 13, 15], [35, 48, 6, 7], [45, 58, 22, 11], [55, 26, 2, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.u.1", "60.72.3.zr.1", "60.72.3.zv.1"];
...
// Canonical model
model_0 := [3*x^2-y^2+z^2-w^2,3*x^2+4*y^2-5*y*z+z^2-w*t,3*x^2+4*y^2+5*y*z-4*z^2+4*w^2+w*t-t^2];
...
map_0_coord_0 := 1*(2*x);
//   Coordinate number 1:
map_0_coord_1 := 1*(x-2*y+z);
//   Coordinate number 2:
map_0_coord_2 := 1*(-x+z);
// Codomain equation:
map_0_codomain := [3*x^4+2*x^3*y-3*x^2*y^2+2*x*y^3-y^4+5*x^3*z+6*x^2*z^2+2*x*z^3+z^4];

// Map from the canonical model to the plane model of modular curve with label 60.144.5.sl.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
