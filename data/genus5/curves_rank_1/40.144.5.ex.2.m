...
// Magma code for modular curve with label 40.144.5.ex.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.83

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 8, 20, 9], [19, 27, 38, 23], [21, 25, 22, 29], [37, 5, 36, 1], [37, 37, 16, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.d.1", "40.72.1.bf.2", "40.72.1.bw.2", "40.72.3.bn.1", "40.72.3.ci.2", "40.72.3.df.2", "40.72.3.ee.1"];
...
model_1 := [24375*x^8+8500*x^7*y-1600*x^6*y^2-40*x^5*y^3+4*x^4*y^4-7500*x^6*z^2+2700*x^5*y*z^2-160*x^4*y^2*z^2-8*x^3*y^3*z^2-450*x^4*z^4+260*x^3*y*z^4-8*x^2*y^2*z^4-100*x^2*z^6+12*x*y*z^6-z^8];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.ex.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
map_1_coord_2 := 1*(t);
// Codomain equation:
map_1_codomain := [24375*x^8+8500*x^7*y-1600*x^6*y^2-40*x^5*y^3+4*x^4*y^4-7500*x^6*z^2+2700*x^5*y*z^2-160*x^4*y^2*z^2-8*x^3*y^3*z^2-450*x^4*z^4+260*x^3*y*z^4-8*x^2*y^2*z^4-100*x^2*z^6+12*x*y*z^6-z^8];
