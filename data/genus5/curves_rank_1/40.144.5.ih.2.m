...
// Magma code for modular curve with label 40.144.5.ih.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.515

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 5, 8, 29], [19, 34, 10, 33], [23, 16, 36, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.x.1", "40.72.1.be.1", "40.72.1.bm.1", "40.72.1.ci.2", "40.72.3.dh.2", "40.72.3.dv.1", "40.72.3.er.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.ih.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
