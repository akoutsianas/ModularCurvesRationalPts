...
// Magma code for modular curve with label 40.144.5.jj.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.492

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[21, 25, 8, 33], [33, 0, 22, 11], [39, 12, 16, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.w.2", "40.72.1.be.2", "40.72.1.bs.1", "40.72.1.co.1", "40.72.3.dn.1", "40.72.3.eb.1", "40.72.3.ex.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.jj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
