...
// Magma code for modular curve with label 24.144.5.nx.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.860

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 18, 0, 13], [3, 20, 22, 9], [17, 13, 10, 7], [19, 17, 10, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.dj.1", "24.72.2.r.1", "24.72.2.bv.1", "24.72.2.fd.1", "24.72.2.fk.1", "24.72.3.bgi.1", "24.72.3.bgr.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.nx.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
