...
// Magma code for modular curve with label 40.144.5.kn.2

// Other names and/or labels
// Cummins-Pauli label: 20J5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.596

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 25, 8, 33], [15, 9, 6, 13], [25, 37, 2, 35], [27, 24, 10, 21], [39, 39, 38, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.bs.2", "40.72.1.cq.2", "40.72.3.fi.1"];
...
// Canonical model
model_0 := [2*x^2-2*x*y+w*t,2*x^2-2*y^2+2*z^2-t^2,4*x^2+4*x*y+2*y^2-4*z^2+w^2+t^2];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.kn.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x-y);
//   Coordinate number 1:
