...
// Magma code for modular curve with label 56.96.5.bd.1

// Other names and/or labels
// Cummins-Pauli label: 28E5
// Rouse-Sutherland-Zureick-Brown label: 56.96.5.53

// Group data
level := 56;
// Elements that, together with Gamma(level), generate the group
gens := [[23, 10, 0, 25], [29, 0, 30, 33], [33, 42, 6, 45], [52, 43, 33, 44]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["28.48.3.a.1", "56.12.0.r.1", "56.48.2.d.1", "56.48.2.m.1"];
...
// Map from the canonical model to the plane model of modular curve with label 56.96.5.bd.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
