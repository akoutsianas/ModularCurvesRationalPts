...
// Magma code for modular curve with label 48.144.5.cd.1

// Other names and/or labels
// Cummins-Pauli label: 48G5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.838

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 19, 38, 15], [9, 29, 22, 39], [11, 10, 38, 5], [17, 40, 22, 43], [33, 44, 34, 39]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.2.if.1", "48.72.0.b.1", "48.72.3.bk.1"];
...
model_1 := [y^12-3*x^2*y^8*z^2-36*y^8*z^4+216*x^2*y^4*z^6+648*y^4*z^8-3888*x^2*z^10-5832*z^12];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.cd.1
//   Coordinate number 0:
map_1_coord_0 := 1*(v);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*z);
...
// Codomain equation:
map_1_codomain := [y^12-3*x^2*y^8*z^2-36*y^8*z^4+216*x^2*y^4*z^6+648*y^4*z^8-3888*x^2*z^10-5832*z^12];

// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.cd.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-1/2*r);
//   Coordinate number 1:
map_2_coord_1 := 1*(27/4*z^4*v*r-3/16*v*r^5);
//   Coordinate number 2:
map_2_coord_2 := 1*(-z);
// Codomain equation:
