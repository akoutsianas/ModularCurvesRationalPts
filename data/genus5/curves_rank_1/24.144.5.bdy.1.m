...
// Magma code for modular curve with label 24.144.5.bdy.1

// Other names and/or labels
// Cummins-Pauli label: 24Y5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1033

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 9, 6, 1], [17, 6, 0, 11], [17, 11, 2, 1], [21, 13, 22, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.eu.1", "24.72.2.hn.1", "24.72.2.hp.1"];
...
// Canonical model
model_0 := [y*z-x*w+x*t+y*t,6*x^2+6*x*y+12*y^2-z^2+3*z*w+2*w^2+3*z*t-w*t-2*t^2,6*x^2-12*x*y+12*y^2-z^2-2*z*w-2*w^2+2*w*t-t^2];

// Singular plane model
model_1 := [-6*x^6*z^2-24*x^5*y*z^2+x^4*y^4-36*x^4*y^2*z^2+36*x^4*z^4+2*x^3*y^5-36*x^3*y^3*z^2+144*x^3*y*z^4-x^2*y^6-60*x^2*y^4*z^2+288*x^2*y^2*z^4-2*x*y^7-96*x*y^5*z^2+288*x*y^3*z^4+y^8-72*y^6*z^2+144*y^4*z^4];
...
// Codomain equation:
map_1_codomain := [-6*x^6*z^2-24*x^5*y*z^2+x^4*y^4-36*x^4*y^2*z^2+36*x^4*z^4+2*x^3*y^5-36*x^3*y^3*z^2+144*x^3*y*z^4-x^2*y^6-60*x^2*y^4*z^2+288*x^2*y^2*z^4-2*x*y^7-96*x*y^5*z^2+288*x*y^3*z^4+y^8-72*y^6*z^2+144*y^4*z^4];
