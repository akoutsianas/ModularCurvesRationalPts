...
// Magma code for modular curve with label 24.144.5.ge.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.630

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 21, 6, 1], [19, 21, 12, 17], [21, 22, 2, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.3.cs.1", "24.72.1.o.1", "24.72.1.bp.1", "24.72.1.cg.1", "24.72.3.lr.1", "24.72.3.qe.1", "24.72.3.qn.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.ge.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
