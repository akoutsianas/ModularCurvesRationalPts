...
// Magma code for modular curve with label 48.96.5.cv.2

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.639

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 13, 46, 45], [11, 33, 38, 17], [35, 20, 24, 43]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.j.1", "24.48.1.ca.2", "48.48.1.gs.1", "48.48.1.hn.2", "48.48.3.h.2", "48.48.3.eg.1", "48.48.3.ez.2"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.cv.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
