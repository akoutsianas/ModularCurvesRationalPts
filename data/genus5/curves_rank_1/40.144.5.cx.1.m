...
// Magma code for modular curve with label 40.144.5.cx.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.347

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 17, 10, 31], [23, 33, 34, 27], [35, 29, 14, 35], [37, 24, 34, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.bg.2", "40.72.1.h.1", "40.72.1.bl.2", "40.72.1.by.2", "40.72.3.x.1", "40.72.3.bc.2", "40.72.3.dh.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.cx.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+z);
//   Coordinate number 1:
