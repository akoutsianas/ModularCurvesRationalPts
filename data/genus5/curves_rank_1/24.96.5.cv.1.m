...
// Magma code for modular curve with label 24.96.5.cv.1

// Other names and/or labels
// Cummins-Pauli label: 24K5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.238

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 18, 18, 19], [5, 21, 8, 19], [11, 12, 16, 11], [19, 0, 18, 1], [19, 0, 20, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.24.1.bp.1", "24.48.2.o.1", "24.48.2.p.1", "24.48.3.c.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.cv.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
