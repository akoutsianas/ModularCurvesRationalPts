...
// Magma code for modular curve with label 24.72.5.lx.1

// Other names and/or labels
// Cummins-Pauli label: 24G5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.120

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 5, 20, 21], [13, 2, 16, 1], [19, 11, 16, 13], [19, 15, 6, 13], [19, 23, 16, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bx.1", "24.36.1.gg.1", "24.36.3.h.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.5.lx.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y-t);
//   Coordinate number 1:
map_1_coord_1 := 1*(x);
