...
// Magma code for modular curve with label 24.96.5.bv.1

// Other names and/or labels
// Cummins-Pauli label: 24I5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.240

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 12, 10, 13], [7, 21, 14, 13], [11, 12, 14, 13], [19, 6, 12, 19], [23, 21, 4, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.24.1.z.1", "24.48.1.jg.1", "24.48.3.c.1", "24.48.3.ck.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.bv.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
