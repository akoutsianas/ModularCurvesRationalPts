...
// Magma code for modular curve with label 40.144.5.in.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.489

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[23, 15, 34, 9], [25, 31, 16, 15], [37, 27, 4, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.w.2", "40.72.1.bh.2", "40.72.1.bp.2", "40.72.1.cl.2", "40.72.3.dk.1", "40.72.3.dv.1", "40.72.3.eu.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.in.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
