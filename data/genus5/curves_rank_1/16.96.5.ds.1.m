...
// Magma code for modular curve with label 16.96.5.ds.1

// Other names and/or labels
// Cummins-Pauli label: 16F5
// Rouse-Sutherland-Zureick-Brown label: 16.96.5.84

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 13, 12, 15], [5, 12, 14, 3], [11, 15, 0, 5], [15, 15, 14, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.bv.1", "16.48.1.ch.1", "16.48.3.ca.1"];
...
// Map from the canonical model to the plane model of modular curve with label 16.96.5.ds.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
