...
// Magma code for modular curve with label 48.144.5.ee.2

// Other names and/or labels
// Cummins-Pauli label: 48F5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.720

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 21, 6, 31], [33, 46, 32, 27], [35, 45, 30, 17], [43, 10, 16, 29], [45, 28, 44, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.2.hj.1", "48.48.1.im.2", "48.72.0.c.1", "48.72.3.s.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.ee.2
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
map_1_coord_1 := 1*(v);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.ee.2
//   Coordinate number 0:
map_2_coord_0 := 1*(r);
//   Coordinate number 1:
