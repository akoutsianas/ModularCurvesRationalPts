...
// Magma code for modular curve with label 24.72.5.nw.1

// Other names and/or labels
// Cummins-Pauli label: 24D5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.270

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 15, 18, 19], [5, 13, 10, 7], [13, 13, 10, 5], [15, 10, 4, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.0.bs.1", "24.36.2.gl.1", "24.36.3.e.1"];
...
model_2 := [3*x^2+y^2+z^2,9*x^6-30*x^4*z^2-36*x^2*z^4-8*z^6-6*w^2];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.5.nw.1
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
