...
// Magma code for modular curve with label 48.96.5.nu.1

// Other names and/or labels
// Cummins-Pauli label: 16H5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.684

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 27, 6, 47], [17, 42, 42, 7], [25, 32, 38, 15], [31, 4, 34, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.cg.1", "48.48.2.bk.1", "48.48.2.bs.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.nu.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
