...
// Magma code for modular curve with label 16.96.5.w.2

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 16.96.5.38

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 4, 8, 15], [9, 0, 4, 15], [11, 4, 4, 9], [15, 8, 0, 7], [15, 10, 0, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.k.2", "16.48.1.cj.2", "16.48.1.cx.2", "16.48.3.e.2", "16.48.3.f.2", "16.48.3.bi.2", "16.48.3.bw.2"];
...
// Map from the canonical model to the plane model of modular curve with label 16.96.5.w.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
