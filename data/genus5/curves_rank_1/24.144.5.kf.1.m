...
// Magma code for modular curve with label 24.144.5.kf.1

// Other names and/or labels
// Cummins-Pauli label: 24U5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1004

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 12, 12, 17], [3, 23, 20, 9], [9, 11, 2, 15], [11, 21, 6, 17], [23, 6, 0, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.cq.1", "24.72.3.zh.1", "24.72.3.bab.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.kf.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
