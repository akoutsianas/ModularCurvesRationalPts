...
// Magma code for modular curve with label 24.144.5.bbp.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1117

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 1, 20, 11], [11, 12, 6, 17], [13, 2, 14, 23], [17, 17, 20, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.em.1", "24.72.2.bp.1", "24.72.2.ch.1", "24.72.2.io.1", "24.72.2.jp.1", "24.72.3.bdz.1", "24.72.3.bey.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.bbp.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
