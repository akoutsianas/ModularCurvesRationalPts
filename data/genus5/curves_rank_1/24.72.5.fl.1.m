...
// Magma code for modular curve with label 24.72.5.fl.1

// Other names and/or labels
// Cummins-Pauli label: 24G5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.347

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 22, 20, 11], [13, 5, 10, 19], [13, 22, 22, 23], [19, 4, 22, 17], [19, 16, 14, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fu.1", "24.36.1.gb.1", "24.36.3.d.1"];
...
model_1 := [3*x^8-19*x^6*y^2+47*x^4*y^4+7*x^4*y^2*z^2+x^4*z^4-54*x^2*y^6-14*x^2*y^4*z^2+24*y^8];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.5.fl.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
...
// Codomain equation:
map_1_codomain := [3*x^8-19*x^6*y^2+47*x^4*y^4+7*x^4*y^2*z^2+x^4*z^4-54*x^2*y^6-14*x^2*y^4*z^2+24*y^8];
