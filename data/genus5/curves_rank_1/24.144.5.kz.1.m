...
// Magma code for modular curve with label 24.144.5.kz.1

// Other names and/or labels
// Cummins-Pauli label: 24U5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1016

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 11, 10, 15], [9, 22, 20, 21], [13, 6, 0, 13], [19, 9, 6, 17], [21, 16, 10, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.ct.1", "24.72.3.zh.1", "24.72.3.zi.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.kz.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
