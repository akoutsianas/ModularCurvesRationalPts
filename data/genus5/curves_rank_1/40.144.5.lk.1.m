...
// Magma code for modular curve with label 40.144.5.lk.1

// Other names and/or labels
// Cummins-Pauli label: 20J5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.465

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 13, 22, 9], [15, 34, 8, 11], [23, 33, 20, 1], [27, 11, 18, 25], [27, 32, 30, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.bq.1", "40.72.1.ct.1", "40.72.3.fn.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.lk.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
