...
// Magma code for modular curve with label 40.144.5.er.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.443

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 17, 12, 31], [17, 7, 14, 5], [27, 12, 16, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.u.1", "40.72.1.r.1", "40.72.1.z.2", "40.72.1.cc.2", "40.72.3.bl.1", "40.72.3.cj.2", "40.72.3.eo.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.er.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
