...
// Magma code for modular curve with label 56.84.5.bd.1

// Other names and/or labels
// Cummins-Pauli label: 14B5
// Rouse-Sutherland-Zureick-Brown label: 56.84.5.27

// Group data
level := 56;
// Elements that, together with Gamma(level), generate the group
gens := [[21, 1, 29, 52], [53, 7, 47, 38], [55, 38, 43, 43]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 84;
...
covers := ["28.42.1.c.1", "56.42.1.b.1", "56.42.3.c.1"];
...
// Map from the canonical model to the plane model of modular curve with label 56.84.5.bd.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
