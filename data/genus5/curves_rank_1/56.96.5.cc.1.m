...
// Magma code for modular curve with label 56.96.5.cc.1

// Other names and/or labels
// Cummins-Pauli label: 28E5
// Rouse-Sutherland-Zureick-Brown label: 56.96.5.33

// Group data
level := 56;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 28, 36, 13], [34, 15, 39, 30], [47, 28, 6, 11], [50, 51, 25, 24]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["28.48.2.i.1", "56.12.0.bm.1", "56.48.2.m.1", "56.48.3.d.1"];
...
model_1 := [4*x^4*y^4+56*x^4*y^2*z^2+196*x^4*z^4+36*x^2*y^6+14*x^2*y^4*z^2-1176*x^2*y^2*z^4+3430*x^2*z^6+81*y^8-630*y^6*z^2+2989*y^4*z^4-6860*y^2*z^6+9604*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 56.96.5.cc.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x-z);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
...
// Codomain equation:
map_1_codomain := [4*x^4*y^4+56*x^4*y^2*z^2+196*x^4*z^4+36*x^2*y^6+14*x^2*y^4*z^2-1176*x^2*y^2*z^4+3430*x^2*z^6+81*y^8-630*y^6*z^2+2989*y^4*z^4-6860*y^2*z^6+9604*z^8];
