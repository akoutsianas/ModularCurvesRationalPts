...
// Magma code for modular curve with label 20.144.5.q.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 20.144.5.16

// Group data
level := 20;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 11, 0, 13], [5, 8, 12, 5], [13, 14, 14, 19], [13, 17, 18, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["10.72.1.b.2", "20.72.1.d.1", "20.72.1.r.2", "20.72.3.m.1", "20.72.3.r.2", "20.72.3.v.1", "20.72.3.bi.1"];
