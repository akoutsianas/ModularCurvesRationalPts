...
// Magma code for modular curve with label 24.144.5.fm.1

// Other names and/or labels
// Cummins-Pauli label: 24R5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1031

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 12, 0, 5], [5, 0, 12, 11], [9, 20, 8, 9], [15, 13, 8, 3], [21, 19, 20, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.v.1", "24.72.3.pn.1", "24.72.3.po.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.fm.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
