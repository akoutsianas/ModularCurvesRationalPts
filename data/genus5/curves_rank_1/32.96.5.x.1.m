...
// Magma code for modular curve with label 32.96.5.x.1

// Other names and/or labels
// Cummins-Pauli label: 32C5
// Rouse-Sutherland-Zureick-Brown label: 32.96.5.54

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 26, 0, 29], [21, 21, 24, 21], [25, 9, 24, 3], [25, 26, 16, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.w.1", "32.48.3.a.2", "32.48.3.d.1"];
...
// Map from the canonical model to the plane model of modular curve with label 32.96.5.x.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
