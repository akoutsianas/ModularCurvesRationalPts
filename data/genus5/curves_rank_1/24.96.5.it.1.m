...
// Magma code for modular curve with label 24.96.5.it.1

// Other names and/or labels
// Cummins-Pauli label: 24J5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.7

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 11, 18, 19], [5, 23, 12, 19], [7, 20, 18, 5], [11, 17, 6, 13], [13, 12, 18, 11], [23, 12, 12, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['3.4.0.a.1', '8.24.0.bt.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["8.24.0.bt.1", "12.48.2.d.1", "24.48.2.s.1", "24.48.3.cp.1"];
...
// Canonical model
model_0 := [y^2-x*w-x*t,x*y-x*z-y*w-z*w-y*t+z*t,y^2-z^2+2*x*t+2*w*t];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.it.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
