...
// Magma code for modular curve with label 60.144.5.ej.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.50

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 24, 59, 1], [43, 6, 42, 1], [47, 6, 36, 5], [53, 54, 15, 41]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.1.d.1", "30.72.1.e.1", "60.48.1.m.1", "60.72.1.em.1", "60.72.3.ge.1", "60.72.3.hx.1", "60.72.3.lc.1", "60.72.3.uq.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.ej.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
