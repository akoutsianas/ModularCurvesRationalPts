...
// Magma code for modular curve with label 40.144.5.in.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.498

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 26, 6, 23], [29, 24, 2, 1], [31, 25, 12, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.w.1", "40.72.1.bh.1", "40.72.1.bp.1", "40.72.1.cl.1", "40.72.3.dk.2", "40.72.3.dv.1", "40.72.3.eu.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.in.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
