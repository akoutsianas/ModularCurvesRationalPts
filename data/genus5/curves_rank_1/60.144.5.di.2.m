...
// Magma code for modular curve with label 60.144.5.di.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.846

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 5, 18, 37], [1, 25, 16, 39], [13, 25, 10, 9], [19, 20, 52, 39]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.k.1", "60.72.1.e.2", "60.72.1.cd.2", "60.72.1.dr.2", "60.72.3.dg.1", "60.72.3.qu.2", "60.72.3.yf.2"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.di.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z+w);
