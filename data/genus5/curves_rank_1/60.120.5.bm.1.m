...
// Magma code for modular curve with label 60.120.5.bm.1

// Other names and/or labels
// Cummins-Pauli label: 20E5
// Rouse-Sutherland-Zureick-Brown label: 60.120.5.5

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 46, 46, 39], [13, 44, 36, 7], [33, 1, 32, 41], [37, 54, 38, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['5.20.0.b.1', '12.6.0.c.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["10.60.2.b.1", "60.30.2.c.1", "60.60.2.d.1", "60.60.3.o.1"];
...
//   Coordinate number 0:
map_0_coord_0 := 1*(-7*x-7*y+z+w);
//   Coordinate number 1:
map_0_coord_1 := 1*(2*x+2*y+z+w-t);
//   Coordinate number 2:
...
// Map from the canonical model to the plane model of modular curve with label 60.120.5.bm.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
