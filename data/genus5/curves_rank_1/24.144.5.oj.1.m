...
// Magma code for modular curve with label 24.144.5.oj.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1298

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 12, 12, 17], [7, 15, 18, 5], [17, 19, 14, 11], [23, 6, 18, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.de.1", "24.72.2.t.1", "24.72.2.z.1", "24.72.2.fd.1", "24.72.2.gj.1", "24.72.3.bgf.1", "24.72.3.bhl.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.oj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
