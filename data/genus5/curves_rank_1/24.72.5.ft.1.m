...
// Magma code for modular curve with label 24.72.5.ft.1

// Other names and/or labels
// Cummins-Pauli label: 24G5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.117

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 22, 4, 11], [11, 17, 10, 17], [17, 10, 20, 5], [19, 18, 6, 5], [23, 10, 20, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bx.1", "24.36.1.ge.1", "24.36.3.d.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.5.ft.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x-y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
