...
// Magma code for modular curve with label 24.144.5.ug.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1267

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[23, 4, 20, 23], [23, 6, 12, 19], [23, 15, 0, 1], [23, 23, 2, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.du.1", "24.72.2.db.1", "24.72.2.dm.1", "24.72.2.fq.1", "24.72.2.go.1", "24.72.3.bdm.1", "24.72.3.bek.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.ug.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
