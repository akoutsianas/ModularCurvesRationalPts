...
// Magma code for modular curve with label 16.96.5.df.1

// Other names and/or labels
// Cummins-Pauli label: 16E5
// Rouse-Sutherland-Zureick-Brown label: 16.96.5.118

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 14, 0, 7], [11, 12, 6, 5], [15, 11, 0, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.bm.1", "16.48.1.bp.1", "16.48.3.br.1"];
...
// Map from the canonical model to the plane model of modular curve with label 16.96.5.df.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
