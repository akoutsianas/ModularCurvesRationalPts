...
// Magma code for modular curve with label 60.120.5.bw.1

// Other names and/or labels
// Cummins-Pauli label: 20E5
// Rouse-Sutherland-Zureick-Brown label: 60.120.5.118

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 25, 34, 37], [19, 58, 24, 31], [41, 6, 26, 19], [55, 41, 14, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.2.d.1", "30.60.2.b.1", "60.60.3.o.1"];
...
// Canonical model
model_0 := [2*x*z-x*w-x*t-y*w,3*x^2-3*x*y-3*y^2+z^2-2*z*w+2*z*t-w*t,x^2+4*x*y+4*y^2+z^2-z*w-w^2-w*t+t^2];
...
// Map from the canonical model to the plane model of modular curve with label 60.120.5.bw.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
