...
// Magma code for modular curve with label 24.96.5.ei.1

// Other names and/or labels
// Cummins-Pauli label: 24K5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.209

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 1, 6, 11], [1, 8, 12, 17], [5, 6, 0, 1], [13, 6, 12, 1], [17, 7, 12, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.24.1.dg.1", "24.48.2.j.1", "24.48.2.l.1", "24.48.3.bv.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.ei.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
