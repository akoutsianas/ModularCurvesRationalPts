...
// Magma code for modular curve with label 24.144.5.bgh.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1068

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 16, 16, 7], [13, 9, 6, 7], [15, 20, 8, 3], [17, 1, 4, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.ey.1", "24.72.2.dc.1", "24.72.2.dq.1", "24.72.2.hz.1", "24.72.2.jn.1", "24.72.3.bgp.1", "24.72.3.bid.1"];
...
// Canonical model
model_0 := [x*t+2*y*w,3*x^2-12*y^2+2*w^2+2*t^2,3*x^2+6*y^2+8*z^2-8*z*w+2*w^2+t^2];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.bgh.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
