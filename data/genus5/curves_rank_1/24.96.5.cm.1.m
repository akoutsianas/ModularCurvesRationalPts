...
// Magma code for modular curve with label 24.96.5.cm.1

// Other names and/or labels
// Cummins-Pauli label: 24K5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.148

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 0, 20, 17], [5, 18, 20, 13], [19, 6, 14, 13], [19, 21, 12, 1], [23, 21, 18, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["12.48.2.e.1", "24.24.1.bg.1", "24.48.2.j.1", "24.48.3.c.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.cm.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
