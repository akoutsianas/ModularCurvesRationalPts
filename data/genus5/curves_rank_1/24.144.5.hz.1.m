...
// Magma code for modular curve with label 24.144.5.hz.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.84

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 6, 18, 17], [5, 15, 12, 5], [23, 12, 6, 19], [23, 21, 12, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.1.h.1", "24.48.1.iz.1", "24.72.1.bn.1", "24.72.1.cl.1", "24.72.3.tj.1", "24.72.3.ty.1", "24.72.3.ua.1", "24.72.3.uv.1"];
...
model_1 := [4*x^8+24*x^6*y^2+36*x^4*y^4+32*x^7*z-96*x^5*y^2*z+64*x^6*z^2-8*x^5*z^3-24*x^3*y^2*z^3-28*x^4*z^4-12*x^2*y^2*z^4+16*x^3*z^5+4*x^2*z^6-4*x*z^7+z^8];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.hz.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y+w);
//   Coordinate number 1:
map_1_coord_1 := 1*(x+t);
...
map_1_coord_2 := 1*(z);
// Codomain equation:
map_1_codomain := [4*x^8+24*x^6*y^2+36*x^4*y^4+32*x^7*z-96*x^5*y^2*z+64*x^6*z^2-8*x^5*z^3-24*x^3*y^2*z^3-28*x^4*z^4-12*x^2*y^2*z^4+16*x^3*z^5+4*x^2*z^6-4*x*z^7+z^8];
