...
// Magma code for modular curve with label 24.192.5.di.1

// Other names and/or labels
// Cummins-Pauli label: 24Z5
// Rouse-Sutherland-Zureick-Brown label: 24.192.5.1498

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 15, 4, 19], [13, 18, 8, 7], [17, 12, 20, 19], [19, 6, 4, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["24.96.1.cr.2", "24.96.1.dh.4", "24.96.1.dl.4", "24.96.3.cn.1", "24.96.3.cp.1", "24.96.3.go.2", "24.96.3.gs.2"];
...
model_1 := [48*x^8+16*x^6*y^2-36*x^4*y^4-384*x^7*z-224*x^5*y^2*z+144*x^3*y^4*z+1440*x^6*z^2+832*x^4*y^2*z^2-216*x^2*y^4*z^2-3264*x^5*z^3-1344*x^3*y^2*z^3+144*x*y^4*z^3+4872*x^4*z^4+1044*x^2*y^2*z^4-36*y^4*z^4-4896*x^3*z^5-360*x*y^2*z^5+3240*x^2*z^6+36*y^2*z^6-1296*x*z^7+243*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 24.192.5.di.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x-1/2*t);
//   Coordinate number 1:
map_1_coord_1 := 1*(4/3*w);
//   Coordinate number 2:
map_1_coord_2 := 1*(1/3*y-2/3*z-1/3*w-1/3*t);
// Codomain equation:
map_1_codomain := [48*x^8+16*x^6*y^2-36*x^4*y^4-384*x^7*z-224*x^5*y^2*z+144*x^3*y^4*z+1440*x^6*z^2+832*x^4*y^2*z^2-216*x^2*y^4*z^2-3264*x^5*z^3-1344*x^3*y^2*z^3+144*x*y^4*z^3+4872*x^4*z^4+1044*x^2*y^2*z^4-36*y^4*z^4-4896*x^3*z^5-360*x*y^2*z^5+3240*x^2*z^6+36*y^2*z^6-1296*x*z^7+243*z^8];
