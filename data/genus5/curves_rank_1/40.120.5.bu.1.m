...
// Magma code for modular curve with label 40.120.5.bu.1

// Other names and/or labels
// Cummins-Pauli label: 20E5
// Rouse-Sutherland-Zureick-Brown label: 40.120.5.138

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 13, 22, 21], [9, 37, 8, 27], [23, 31, 38, 17], [25, 27, 32, 35]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.2.b.1", "40.60.2.h.1", "40.60.3.d.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.120.5.bu.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
