...
// Magma code for modular curve with label 24.72.5.cg.1

// Other names and/or labels
// Cummins-Pauli label: 24F5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.382

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 10, 14, 23], [11, 4, 14, 5], [13, 14, 4, 13], [19, 3, 12, 5], [19, 15, 6, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.gs.1", "24.36.2.bv.1", "24.36.2.gi.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.5.cg.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*y);
