...
// Magma code for modular curve with label 40.144.5.jb.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.377

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[25, 38, 26, 17], [29, 17, 2, 39], [37, 14, 6, 35]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.z.1", "40.72.1.bd.1", "40.72.1.bk.2", "40.72.1.cs.1", "40.72.3.cw.2", "40.72.3.dz.1", "40.72.3.ex.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.jb.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
