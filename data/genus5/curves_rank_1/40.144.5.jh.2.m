...
// Magma code for modular curve with label 40.144.5.jh.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.150

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 21, 18, 39], [25, 34, 18, 11], [29, 22, 36, 25], [35, 6, 26, 5], [35, 26, 4, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.v.2", "40.72.1.bd.2", "40.72.1.bm.2", "40.72.3.cz.1", "40.72.3.dl.2", "40.72.3.ea.1", "40.72.3.ey.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.jh.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
