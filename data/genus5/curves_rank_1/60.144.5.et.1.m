...
// Magma code for modular curve with label 60.144.5.et.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.266

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[31, 26, 18, 29], [34, 59, 11, 32], [40, 3, 51, 10]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.3.bu.1", "60.72.1.h.1", "60.72.1.bl.1", "60.72.1.eg.1", "60.72.3.hx.1", "60.72.3.nz.1", "60.72.3.tf.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.et.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+z);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
