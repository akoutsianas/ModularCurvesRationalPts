...
// Magma code for modular curve with label 48.96.5.se.1

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.221

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 2, 8, 23], [9, 31, 34, 21], [29, 2, 24, 7], [37, 16, 20, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.cj.2", "24.48.1.kx.2", "48.48.1.ip.2", "48.48.3.dl.1", "48.48.3.ee.2", "48.48.3.es.2", "48.48.3.gc.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.se.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
