...
// Magma code for modular curve with label 40.144.5.eh.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.111

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 7, 18, 35], [1, 22, 32, 1], [13, 33, 30, 31], [23, 38, 22, 29], [27, 5, 0, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.v.1", "40.72.1.l.1", "40.72.1.x.1", "40.72.3.bd.2", "40.72.3.bj.1", "40.72.3.ct.1", "40.72.3.fb.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.eh.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
