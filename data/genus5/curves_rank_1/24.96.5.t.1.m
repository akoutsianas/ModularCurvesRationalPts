...
// Magma code for modular curve with label 24.96.5.t.1

// Other names and/or labels
// Cummins-Pauli label: 24I5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.51

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 0, 6, 23], [17, 7, 6, 7], [19, 10, 6, 13], [19, 21, 18, 5], [23, 1, 0, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['3.4.0.a.1', '8.24.1.h.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["8.24.1.h.1", "24.48.1.cu.1", "24.48.3.d.1", "24.48.3.cp.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.t.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
