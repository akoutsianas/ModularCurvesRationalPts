...
// Magma code for modular curve with label 24.192.5.fb.1

// Other names and/or labels
// Cummins-Pauli label: 24Z5
// Rouse-Sutherland-Zureick-Brown label: 24.192.5.2140

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 12, 20, 17], [7, 6, 16, 17], [17, 3, 8, 11], [19, 15, 16, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["24.96.1.db.1", "24.96.1.df.4", "24.96.1.dj.2", "24.96.3.fc.1", "24.96.3.fw.1", "24.96.3.gk.3", "24.96.3.go.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.192.5.fb.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
