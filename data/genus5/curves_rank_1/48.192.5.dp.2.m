...
// Magma code for modular curve with label 48.192.5.dp.2

// Other names and/or labels
// Cummins-Pauli label: 16O5
// Rouse-Sutherland-Zureick-Brown label: 48.192.5.1334

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 46, 16, 11], [23, 16, 0, 25], [31, 0, 0, 35], [47, 2, 0, 7], [47, 34, 40, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["16.96.2.e.2", "24.96.1.ch.2", "48.96.2.g.2"];
...
// Map from the canonical model to the plane model of modular curve with label 48.192.5.dp.2
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
