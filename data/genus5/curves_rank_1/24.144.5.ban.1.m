...
// Magma code for modular curve with label 24.144.5.ban.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.921

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 18, 12, 1], [19, 18, 12, 23], [19, 23, 2, 5], [23, 15, 12, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.ej.1", "24.72.2.bf.1", "24.72.2.cb.1", "24.72.2.ih.1", "24.72.2.jp.1", "24.72.3.bdn.1", "24.72.3.bev.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.ban.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*z);
