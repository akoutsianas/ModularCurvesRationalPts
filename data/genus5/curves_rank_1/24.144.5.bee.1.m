...
// Magma code for modular curve with label 24.144.5.bee.1

// Other names and/or labels
// Cummins-Pauli label: 24S5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.985

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 0, 0, 23], [9, 11, 22, 21], [15, 22, 16, 9], [19, 0, 0, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.cn.1", "24.72.3.bfq.1", "24.72.3.bii.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.bee.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
