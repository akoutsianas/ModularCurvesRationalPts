...
// Magma code for modular curve with label 24.144.5.fb.1

// Other names and/or labels
// Cummins-Pauli label: 24R5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1030

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 9, 12, 19], [15, 4, 20, 21], [17, 18, 12, 7], [23, 6, 12, 1], [23, 21, 0, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.v.1", "24.72.3.pd.1", "24.72.3.pe.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.fb.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
