...
// Magma code for modular curve with label 32.96.5.bd.1

// Other names and/or labels
// Cummins-Pauli label: 32D5
// Rouse-Sutherland-Zureick-Brown label: 32.96.5.47

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 17, 0, 11], [17, 17, 16, 15], [19, 28, 24, 25], [23, 16, 0, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.u.1", "32.48.3.d.1", "32.48.3.e.1"];
...
// Map from the canonical model to the plane model of modular curve with label 32.96.5.bd.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
