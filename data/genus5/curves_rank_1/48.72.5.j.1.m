...
// Magma code for modular curve with label 48.72.5.j.1

// Other names and/or labels
// Cummins-Pauli label: 48B5
// Rouse-Sutherland-Zureick-Brown label: 48.72.5.5

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 31, 32, 43], [3, 31, 16, 45], [13, 16, 32, 1], [17, 8, 16, 5], [43, 33, 24, 1], [47, 36, 24, 19], [47, 39, 0, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
// Canonical model
model_0 := [x*z-x*w-y*t,6*x*y-2*z^2-2*z*w+t^2,8*x^2+2*y^2+z*t-w*t];

// Singular plane model
model_1 := [x^7-4*x^5*y^2+2*x^4*y*z^2+4*x^3*y^4+x*y^2*z^4+4*y^5*z^2];
...
// Map from the canonical model to the plane model of modular curve with label 48.72.5.j.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
map_1_coord_2 := 1*(z);
// Codomain equation:
map_1_codomain := [x^7-4*x^5*y^2+2*x^4*y*z^2+4*x^3*y^4+x*y^2*z^4+4*y^5*z^2];
