...
// Magma code for modular curve with label 40.144.5.ej.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.432

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 36, 12, 27], [7, 20, 14, 13], [19, 2, 0, 11], [29, 5, 6, 33], [35, 12, 32, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.m.1", "40.72.1.p.2", "40.72.1.z.1", "40.72.1.ce.1", "40.72.3.ci.1", "40.72.3.cu.1", "40.72.3.ep.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.ej.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
