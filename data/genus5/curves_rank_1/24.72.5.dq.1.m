...
// Magma code for modular curve with label 24.72.5.dq.1

// Other names and/or labels
// Cummins-Pauli label: 24E5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.155

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 20, 2, 21], [3, 20, 16, 15], [5, 3, 6, 23], [17, 1, 4, 7], [23, 6, 12, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bn.1", "24.36.1.gs.1", "24.36.3.d.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.5.dq.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
