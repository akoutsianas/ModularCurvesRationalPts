...
// Magma code for modular curve with label 24.144.5.lx.1

// Other names and/or labels
// Cummins-Pauli label: 24U5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1005

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 1, 20, 21], [9, 13, 2, 3], [11, 21, 0, 5], [15, 16, 22, 9], [23, 6, 18, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.ct.1", "24.72.3.baq.1", "24.72.3.bat.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.lx.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
