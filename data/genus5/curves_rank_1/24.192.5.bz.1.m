...
// Magma code for modular curve with label 24.192.5.bz.1

// Other names and/or labels
// Cummins-Pauli label: 12E5
// Rouse-Sutherland-Zureick-Brown label: 24.192.5.1214

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 0, 18, 7], [7, 4, 18, 5], [11, 16, 0, 13], [17, 2, 18, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["12.96.3.h.2", "24.96.1.cl.3", "24.96.1.cm.1", "24.96.1.cp.2", "24.96.3.bg.1", "24.96.3.bx.2", "24.96.3.cd.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.192.5.bz.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
