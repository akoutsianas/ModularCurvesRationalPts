...
// Magma code for modular curve with label 48.96.5.rw.1

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.222

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 44, 36, 17], [11, 5, 30, 41], [27, 46, 4, 23], [31, 3, 34, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.cj.2", "24.48.1.kt.2", "48.48.1.iq.2", "48.48.3.dh.1", "48.48.3.ed.1", "48.48.3.eu.2", "48.48.3.ga.2"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.rw.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
