...
// Magma code for modular curve with label 24.144.5.mn.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.414

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 16, 22, 11], [9, 14, 20, 21], [13, 23, 22, 7], [19, 8, 14, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.2.f.1", "24.72.1.df.1", "24.72.2.i.1", "24.72.2.et.1", "24.72.2.gb.1", "24.72.3.bfz.1", "24.72.3.bhh.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.mn.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
