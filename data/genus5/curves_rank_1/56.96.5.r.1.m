...
// Magma code for modular curve with label 56.96.5.r.1

// Other names and/or labels
// Cummins-Pauli label: 28E5
// Rouse-Sutherland-Zureick-Brown label: 56.96.5.56

// Group data
level := 56;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 24, 16, 49], [8, 43, 39, 26], [10, 21, 31, 16], [14, 11, 13, 10]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["28.48.3.a.1", "56.12.0.i.1", "56.48.2.c.1", "56.48.2.n.1"];
...
// Map from the canonical model to the plane model of modular curve with label 56.96.5.r.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
