...
// Magma code for modular curve with label 24.144.5.ow.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1303

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 13, 8, 7], [7, 0, 12, 23], [11, 0, 18, 13], [15, 5, 4, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.de.1", "24.72.2.x.1", "24.72.2.bi.1", "24.72.2.fi.1", "24.72.2.go.1", "24.72.3.bgk.1", "24.72.3.bhq.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.ow.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
