...
// Magma code for modular curve with label 24.144.5.yo.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.837

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 12, 18, 7], [7, 23, 10, 13], [17, 6, 6, 19], [21, 4, 16, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.en.1", "24.72.2.q.1", "24.72.2.bw.1", "24.72.2.hq.1", "24.72.2.hz.1", "24.72.3.bcx.1", "24.72.3.bde.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.yo.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
