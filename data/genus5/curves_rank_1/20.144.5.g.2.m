...
// Magma code for modular curve with label 20.144.5.g.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 20.144.5.64

// Group data
level := 20;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 6, 6, 15], [1, 16, 6, 15], [5, 16, 12, 11], [7, 2, 10, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.a.2", "20.72.1.l.2", "20.72.1.q.2", "20.72.3.c.1", "20.72.3.e.2", "20.72.3.y.2", "20.72.3.bj.2"];
...
// Map from the canonical model to the plane model of modular curve with label 20.144.5.g.2
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(x);
