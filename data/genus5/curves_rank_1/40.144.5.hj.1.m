...
// Magma code for modular curve with label 40.144.5.hj.1

// Other names and/or labels
// Cummins-Pauli label: 40M5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.626

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 9, 16, 31], [9, 35, 36, 23], [15, 37, 16, 1], [37, 14, 0, 21], [39, 25, 36, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["40.72.1.s.2", "40.72.3.cb.1", "40.72.3.ch.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.hj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
