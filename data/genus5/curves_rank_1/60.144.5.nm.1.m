...
// Magma code for modular curve with label 60.144.5.nm.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.644

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[27, 10, 52, 37], [31, 50, 2, 3], [59, 15, 16, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.o.1", "60.72.1.bu.2", "60.72.1.cm.1", "60.72.3.oj.1", "60.72.3.or.1", "60.72.3.rg.2", "60.72.3.yc.2"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.nm.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
