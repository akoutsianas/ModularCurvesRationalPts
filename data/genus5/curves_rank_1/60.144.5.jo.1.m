...
// Magma code for modular curve with label 60.144.5.jo.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.233

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 30, 0, 41], [45, 38, 32, 21], [57, 44, 13, 45]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.3.cu.1", "60.72.1.bp.1", "60.72.1.cw.1", "60.72.1.eo.1", "60.72.3.ku.1", "60.72.3.lh.1", "60.72.3.me.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.jo.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(5*t);
