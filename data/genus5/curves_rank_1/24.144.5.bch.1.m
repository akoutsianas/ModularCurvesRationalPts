...
// Magma code for modular curve with label 24.144.5.bch.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.954

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 11, 2, 11], [11, 21, 12, 17], [21, 5, 16, 15], [23, 16, 8, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.ez.1", "24.72.2.cm.1", "24.72.2.dj.1", "24.72.2.hb.1", "24.72.2.iz.1", "24.72.3.bfv.1", "24.72.3.bhl.1"];
...
// Canonical model
model_0 := [x*z+2*x*w-y*z,3*x^2+y^2-6*z^2+t^2,3*x^2-y^2+4*z^2+4*z*w+4*w^2];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.bch.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x-y);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*w);
