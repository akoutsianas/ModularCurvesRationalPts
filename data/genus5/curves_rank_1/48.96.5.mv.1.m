...
// Magma code for modular curve with label 48.96.5.mv.1

// Other names and/or labels
// Cummins-Pauli label: 16H5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.339

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[23, 10, 12, 43], [33, 38, 34, 7], [35, 25, 18, 17], [37, 13, 20, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.u.1", "48.48.2.bn.1", "48.48.3.dd.1"];
...
// Canonical model
model_0 := [y*z-x*t,6*y^2-8*z^2+w^2-4*w*t-3*t^2,12*x^2+3*y^2-4*z^2-w*t-t^2];
