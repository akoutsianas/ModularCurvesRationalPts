...
// Magma code for modular curve with label 56.84.5.bh.1

// Other names and/or labels
// Cummins-Pauli label: 14B5
// Rouse-Sutherland-Zureick-Brown label: 56.84.5.47

// Group data
level := 56;
// Elements that, together with Gamma(level), generate the group
gens := [[18, 11, 15, 52], [20, 3, 43, 43], [51, 29, 12, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 84;
...
covers := ["28.42.3.b.1", "56.42.1.b.1", "56.42.1.f.1"];
...
model_1 := [112*x^8+280*x^6*y^2-392*x^6*z^2+84*x^4*y^4-392*x^4*y^2*z^2+2744*x^4*z^4+2*x^2*y^6-154*x^2*y^4*z^2+5194*x^2*y^2*z^4-4802*x^2*z^6+441*y^4*z^4+2058*y^2*z^6+2401*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 56.84.5.bh.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
...
// Codomain equation:
map_1_codomain := [112*x^8+280*x^6*y^2-392*x^6*z^2+84*x^4*y^4-392*x^4*y^2*z^2+2744*x^4*z^4+2*x^2*y^6-154*x^2*y^4*z^2+5194*x^2*y^2*z^4-4802*x^2*z^6+441*y^4*z^4+2058*y^2*z^6+2401*z^8];
