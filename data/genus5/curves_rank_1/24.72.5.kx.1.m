...
// Magma code for modular curve with label 24.72.5.kx.1

// Other names and/or labels
// Cummins-Pauli label: 24G5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.353

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 8, 2, 11], [5, 20, 16, 17], [9, 10, 10, 15], [9, 13, 2, 3], [23, 11, 2, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.ft.1", "24.36.1.gb.1", "24.36.3.g.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.5.kx.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
