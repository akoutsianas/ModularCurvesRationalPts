...
// Magma code for modular curve with label 48.72.5.e.1

// Other names and/or labels
// Cummins-Pauli label: 48A5
// Rouse-Sutherland-Zureick-Brown label: 48.72.5.9

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 37, 32, 27], [19, 26, 20, 29], [21, 44, 8, 9], [25, 5, 28, 13], [25, 17, 28, 1], [25, 37, 8, 43], [29, 43, 28, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.2.cj.1", "48.24.1.a.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.72.5.e.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.72.5.e.1
//   Coordinate number 0:
