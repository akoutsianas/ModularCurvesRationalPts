...
// Magma code for modular curve with label 48.96.5.ka.1

// Other names and/or labels
// Cummins-Pauli label: 16B5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.483

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[15, 13, 46, 41], [29, 13, 36, 23], [31, 29, 28, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.by.1", "24.48.1.ll.1", "48.48.1.hp.1", "48.48.1.if.1", "48.48.3.bm.2", "48.48.3.by.1", "48.48.3.dw.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.ka.1
//   Coordinate number 0:
