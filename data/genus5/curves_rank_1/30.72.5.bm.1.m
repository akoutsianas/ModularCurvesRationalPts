...
// Magma code for modular curve with label 30.72.5.bm.1

// Other names and/or labels
// Cummins-Pauli label: 30G5
// Rouse-Sutherland-Zureick-Brown label: 30.72.5.66

// Group data
level := 30;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 25, 10, 11], [12, 5, 25, 6], [28, 25, 11, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["15.36.2.b.1", "30.36.1.p.1", "30.36.2.b.2"];
...
// Map from the canonical model to the plane model of modular curve with label 30.72.5.bm.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
