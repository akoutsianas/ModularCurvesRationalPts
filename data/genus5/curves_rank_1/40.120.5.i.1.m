...
// Magma code for modular curve with label 40.120.5.i.1

// Other names and/or labels
// Cummins-Pauli label: 10B5
// Rouse-Sutherland-Zureick-Brown label: 40.120.5.127

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 28, 20, 7], [25, 11, 14, 9], [37, 16, 34, 31], [39, 7, 18, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.2.f.1", "40.40.1.r.1", "40.60.2.d.1", "40.60.3.a.1"];
...
//   Coordinate number 0:
map_0_coord_0 := 1*(-3*x-y-2*z+w);
//   Coordinate number 1:
map_0_coord_1 := 1*(-x+2*z);
//   Coordinate number 2:
map_0_coord_2 := 1*(2*x-y-2*z+w);
// Codomain equation:
...
// Map from the canonical model to the plane model of modular curve with label 40.120.5.i.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
