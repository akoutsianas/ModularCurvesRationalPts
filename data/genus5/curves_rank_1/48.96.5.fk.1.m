...
// Magma code for modular curve with label 48.96.5.fk.1

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.617

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 28, 4, 47], [11, 6, 12, 19], [21, 14, 16, 19], [43, 1, 22, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.w.1", "24.48.1.dt.1", "48.48.1.iq.2", "48.48.1.is.1", "48.48.3.ba.1", "48.48.3.bt.1", "48.48.3.bv.2"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.fk.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
