...
// Magma code for modular curve with label 48.96.5.hy.1

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.453

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 17, 18, 13], [11, 33, 10, 19], [13, 45, 6, 35]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.bk.2", "24.48.1.kx.2", "48.48.1.gt.2", "48.48.1.hd.2", "48.48.3.bk.1", "48.48.3.bq.2", "48.48.3.dm.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.hy.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
