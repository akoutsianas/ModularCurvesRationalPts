...
// Magma code for modular curve with label 24.192.5.ez.4

// Other names and/or labels
// Cummins-Pauli label: 24Z5
// Rouse-Sutherland-Zureick-Brown label: 24.192.5.1508

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 21, 20, 19], [23, 0, 4, 5], [23, 0, 16, 23], [23, 18, 20, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["24.96.1.da.4", "24.96.1.df.2", "24.96.1.dn.3", "24.96.3.fa.1", "24.96.3.fr.2", "24.96.3.gm.2", "24.96.3.gu.2"];
...
model_1 := [1872*x^8+1440*x^7*y+504*x^6*y^2+72*x^5*y^3+9*x^4*y^4-480*x^6*z^2-816*x^5*y*z^2-168*x^4*y^2*z^2-36*x^3*y^3*z^2+376*x^4*z^4+24*x^3*y*z^4+30*x^2*y^2*z^4+8*x^2*z^6+12*x*y*z^6-11*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 24.192.5.ez.4
//   Coordinate number 0:
...
map_1_coord_2 := 1*(t);
// Codomain equation:
map_1_codomain := [1872*x^8+1440*x^7*y+504*x^6*y^2+72*x^5*y^3+9*x^4*y^4-480*x^6*z^2-816*x^5*y*z^2-168*x^4*y^2*z^2-36*x^3*y^3*z^2+376*x^4*z^4+24*x^3*y*z^4+30*x^2*y^2*z^4+8*x^2*z^6+12*x*y*z^6-11*z^8];
