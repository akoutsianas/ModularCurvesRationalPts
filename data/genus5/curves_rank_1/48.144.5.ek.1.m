...
// Magma code for modular curve with label 48.144.5.ek.1

// Other names and/or labels
// Cummins-Pauli label: 48H5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.792

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 8, 4, 39], [25, 8, 28, 43], [25, 21, 6, 23], [27, 43, 26, 3], [37, 18, 36, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.2.hk.1", "48.72.0.c.1", "48.72.3.v.1"];
...
// Embedded model
model_0 := [y^2+x*t,x*y+x*t-w*r,w^2+x*t+y*t,x^2-x*y+z*r,x*y+z*w-x*t,x^2+x*y-z^2,y*w-z*t,y*z+x*w,x*t-y*t-z*r-u*r+v*r,z*w-y*t+t^2+w*u-w*v,x*w+w*t-y*u+y*v,z^2-w^2+z*u-z*v,x*z+z*t+x*u-x*v,x*z+x*w+x*r+y*r,x*w-z*t-y*r+t*r,w^2+x*t-y*t+2*u^2+2*u*v+2*v^2+z*r+r^2];

// Singular plane model
model_1 := [2*x^12-4*x^10*z^2+3*x^8*y^2*z^2+4*x^8*z^4-6*x^6*y^2*z^4-6*x^6*y*z^5-3*x^6*z^6+3*x^4*y^2*z^6+9*x^4*y*z^7+5*x^4*z^8-3*x^2*y*z^9-4*x^2*z^10+z^12];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.ek.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(v);
...
map_1_coord_2 := 1*(w);
// Codomain equation:
map_1_codomain := [2*x^12-4*x^10*z^2+3*x^8*y^2*z^2+4*x^8*z^4-6*x^6*y^2*z^4-6*x^6*y*z^5-3*x^6*z^6+3*x^4*y^2*z^6+9*x^4*y*z^7+5*x^4*z^8-3*x^2*y*z^9-4*x^2*z^10+z^12];

// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.ek.1
//   Coordinate number 0:
map_2_coord_0 := 1*(w);
//   Coordinate number 1:
map_2_coord_1 := 1*(-3*y^4*w*v+3*y^2*w^4+3*y^2*w^3*v-2*w^6);
//   Coordinate number 2:
map_2_coord_2 := 1*(-y);
// Codomain equation:
