...
// Magma code for modular curve with label 48.96.5.lx.1

// Other names and/or labels
// Cummins-Pauli label: 16E5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.500

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 31, 28, 27], [21, 22, 46, 35], [31, 38, 2, 17], [37, 23, 42, 35]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.cb.1", "48.48.1.gd.1", "48.48.1.gh.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.lx.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
