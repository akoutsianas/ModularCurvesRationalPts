...
// Magma code for modular curve with label 60.144.5.dr.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.260

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[4, 33, 5, 8], [43, 42, 26, 11], [46, 35, 3, 14], [49, 32, 20, 17], [53, 58, 46, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.3.bf.1", "60.72.1.f.1", "60.72.1.j.1", "60.72.1.fc.1", "60.72.3.dp.1", "60.72.3.hz.1", "60.72.3.uz.1"];
...
// Canonical model
model_0 := [4*x^2+x*w-x*t-2*w*t+t^2,x^2-4*y^2+z^2,3*x^2+3*y^2+3*z^2-x*w-w^2+2*w*t];

// Singular plane model
model_1 := [100*x^4*z^4-200*x^2*y^2*z^4+5625*y^8+3000*y^6*z^2+250*y^4*z^4-40*y^2*z^6+z^8];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.dr.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+z);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
...
map_1_coord_2 := 1*(2*w);
// Codomain equation:
map_1_codomain := [100*x^4*z^4-200*x^2*y^2*z^4+5625*y^8+3000*y^6*z^2+250*y^4*z^4-40*y^2*z^6+z^8];
