...
// Magma code for modular curve with label 40.96.5.n.2

// Other names and/or labels
// Cummins-Pauli label: 20D5
// Rouse-Sutherland-Zureick-Brown label: 40.96.5.30

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[10, 7, 29, 38], [24, 7, 25, 31], [30, 21, 19, 7], [37, 20, 28, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["20.48.3.i.2", "40.24.1.cj.2", "40.48.1.kh.1", "40.48.3.g.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.96.5.n.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
