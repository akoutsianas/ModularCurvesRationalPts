...
// Magma code for modular curve with label 40.144.5.dj.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.43

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 18, 6, 25], [17, 37, 16, 13], [23, 26, 30, 19], [37, 12, 30, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.m.2", "40.72.1.h.1", "40.72.1.cc.2", "40.72.3.ba.1", "40.72.3.bf.1", "40.72.3.dm.1", "40.72.3.ek.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.dj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+z);
//   Coordinate number 1:
