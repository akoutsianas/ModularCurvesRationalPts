...
// Magma code for modular curve with label 24.144.5.sq.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1193

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 18, 18, 23], [3, 17, 16, 9], [15, 13, 4, 21], [19, 17, 8, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.ds.1", "24.72.2.ct.1", "24.72.2.da.1", "24.72.2.ey.1", "24.72.2.fw.1", "24.72.3.bdc.1", "24.72.3.bea.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.sq.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
