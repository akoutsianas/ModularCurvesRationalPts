...
// Magma code for modular curve with label 48.144.5.bd.1

// Other names and/or labels
// Cummins-Pauli label: 48H5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.781

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 41, 46, 29], [17, 30, 12, 29], [31, 44, 28, 1], [33, 47, 34, 15], [37, 11, 2, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.2.hm.2", "48.72.0.a.1", "48.72.3.ba.1"];
...
model_1 := [8*x^12+48*x^10*z^2+144*x^8*z^4+324*x^6*z^6+x^4*y^2*z^6+648*x^4*z^8+6*x^2*y^2*z^8+972*x^2*z^10+9*y^2*z^10+729*z^12];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.bd.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
map_1_coord_1 := 1*(9*r);
...
map_1_coord_2 := 1*(v);
// Codomain equation:
map_1_codomain := [8*x^12+48*x^10*z^2+144*x^8*z^4+324*x^6*z^6+x^4*y^2*z^6+648*x^4*z^8+6*x^2*y^2*z^8+972*x^2*z^10+9*y^2*z^10+729*z^12];

// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.bd.1
//   Coordinate number 0:
map_2_coord_0 := 1*(t);
//   Coordinate number 1:
