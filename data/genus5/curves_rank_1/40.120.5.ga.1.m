...
// Magma code for modular curve with label 40.120.5.ga.1

// Other names and/or labels
// Cummins-Pauli label: 20F5
// Rouse-Sutherland-Zureick-Brown label: 40.120.5.108

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 12, 38, 3], [23, 28, 0, 37], [33, 26, 18, 7], [33, 33, 22, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.2.e.1", "40.60.2.m.1", "40.60.3.ce.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.120.5.ga.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
