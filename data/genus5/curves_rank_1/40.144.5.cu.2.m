...
// Magma code for modular curve with label 40.144.5.cu.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.511

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[21, 1, 28, 39], [23, 4, 10, 27], [25, 28, 18, 5], [25, 38, 24, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.j.1", "40.72.1.g.1", "40.72.1.bm.1", "40.72.1.bw.2", "40.72.3.v.1", "40.72.3.dh.1", "40.72.3.ef.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.cu.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
