...
// Magma code for modular curve with label 24.144.5.kj.1

// Other names and/or labels
// Cummins-Pauli label: 12D5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.711

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 13, 4, 9], [9, 2, 20, 21], [17, 0, 18, 23], [17, 12, 6, 7], [21, 23, 2, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.3.dw.1", "24.72.1.cq.1", "24.72.3.zm.1"];
...
// Canonical model
model_0 := [2*x*t+3*z*w,2*x^2-2*y^2+z^2-2*z*w,4*x^2+2*y^2+2*z^2+2*z*w-3*w^2+2*t^2];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.kj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
