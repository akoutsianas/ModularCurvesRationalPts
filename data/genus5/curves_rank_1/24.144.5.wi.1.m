...
// Magma code for modular curve with label 24.144.5.wi.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1279

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 17, 2, 9], [7, 18, 12, 11], [13, 16, 4, 17], [19, 12, 18, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.dy.1", "24.72.2.dy.1", "24.72.2.el.1", "24.72.2.gh.1", "24.72.2.gy.1", "24.72.3.bec.1", "24.72.3.bev.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.wi.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
