...
// Magma code for modular curve with label 40.144.5.ky.1

// Other names and/or labels
// Cummins-Pauli label: 40N5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.682

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 6, 18, 3], [19, 35, 2, 37], [21, 16, 2, 35], [31, 11, 10, 37], [33, 39, 26, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["40.72.1.cq.1", "40.72.3.fg.2", "40.72.3.fq.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.ky.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
