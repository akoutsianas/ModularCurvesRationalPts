...
// Magma code for modular curve with label 40.144.5.ei.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.429

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 14, 20, 7], [9, 10, 38, 31], [9, 13, 0, 17], [13, 6, 14, 35], [17, 10, 34, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.m.1", "40.72.1.m.1", "40.72.1.y.2", "40.72.1.ch.2", "40.72.3.cl.2", "40.72.3.cv.2", "40.72.3.em.1"];
...
model_1 := [x^8+30*x^6*y^2+100*x^4*y^4-4*x^6*z^2-160*x^4*y^2*z^2+44*x^4*z^4+600*x^2*y^2*z^4-80*x^2*z^6+400*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.ei.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Codomain equation:
map_1_codomain := [x^8+30*x^6*y^2+100*x^4*y^4-4*x^6*z^2-160*x^4*y^2*z^2+44*x^4*z^4+600*x^2*y^2*z^4-80*x^2*z^6+400*z^8];
