...
// Magma code for modular curve with label 24.72.5.io.1

// Other names and/or labels
// Cummins-Pauli label: 24F5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.368

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 2, 20, 21], [13, 9, 12, 11], [17, 4, 2, 23], [17, 13, 14, 23], [23, 11, 8, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.go.1", "24.36.2.gc.1", "24.36.2.gi.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.5.io.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
