...
// Magma code for modular curve with label 16.96.5.da.1

// Other names and/or labels
// Cummins-Pauli label: 16E5
// Rouse-Sutherland-Zureick-Brown label: 16.96.5.120

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 7, 6, 7], [1, 13, 14, 7], [3, 15, 0, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.bk.1", "16.48.1.bn.1", "16.48.3.bn.1"];
...
// Map from the canonical model to the plane model of modular curve with label 16.96.5.da.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
