...
// Magma code for modular curve with label 24.144.5.jc.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.175

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 21, 12, 19], [21, 11, 22, 21], [23, 9, 12, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.1.j.1", "24.72.1.bo.1", "24.72.1.co.1", "24.72.3.tj.1", "24.72.3.ts.1", "24.72.3.uj.1", "24.72.3.vx.1"];
...
model_1 := [-18*x^4*y^4-36*x^3*y^5+36*x^3*y^3*z^2-90*x^2*y^6+108*x^2*y^4*z^2-6*x^2*y^2*z^4-72*x*y^7+144*x*y^5*z^2-60*x*y^3*z^4-12*x*y*z^6-45*y^8+72*y^6*z^2-30*y^4*z^4+z^8];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.jc.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
...
map_1_coord_2 := 1*(t);
// Codomain equation:
map_1_codomain := [-18*x^4*y^4-36*x^3*y^5+36*x^3*y^3*z^2-90*x^2*y^6+108*x^2*y^4*z^2-6*x^2*y^2*z^4-72*x*y^7+144*x*y^5*z^2-60*x*y^3*z^4-12*x*y*z^6-45*y^8+72*y^6*z^2-30*y^4*z^4+z^8];
