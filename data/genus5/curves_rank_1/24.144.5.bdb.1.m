...
// Magma code for modular curve with label 24.144.5.bdb.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1148

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 4, 22, 17], [7, 23, 4, 13], [11, 19, 14, 5], [21, 5, 10, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.fe.1", "24.72.2.co.1", "24.72.2.dw.1", "24.72.2.hf.1", "24.72.2.ie.1", "24.72.3.bfu.1", "24.72.3.bgn.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.bdb.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
