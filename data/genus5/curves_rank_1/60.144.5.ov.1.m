...
// Magma code for modular curve with label 60.144.5.ov.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.810

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 55, 20, 23], [33, 25, 26, 51], [47, 45, 34, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.u.1", "60.72.1.bx.1", "60.72.1.co.2", "60.72.1.dv.1", "60.72.3.ra.1", "60.72.3.ro.1", "60.72.3.yz.2"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.ov.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
