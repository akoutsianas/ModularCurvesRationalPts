...
// Magma code for modular curve with label 24.144.5.bj.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.682

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 19, 20, 9], [3, 23, 14, 3], [19, 15, 18, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.3.ch.1", "24.72.1.d.1", "24.72.1.be.1", "24.72.1.bw.1", "24.72.3.cx.1", "24.72.3.dm.1", "24.72.3.tr.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.bj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
