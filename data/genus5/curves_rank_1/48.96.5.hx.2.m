...
// Magma code for modular curve with label 48.96.5.hx.2

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.436

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 16, 40, 33], [29, 23, 42, 23], [37, 38, 28, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.bj.2", "24.48.1.kw.1", "48.48.1.gs.2", "48.48.1.hc.2", "48.48.3.bk.2", "48.48.3.bp.2", "48.48.3.dm.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.hx.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x+z);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
