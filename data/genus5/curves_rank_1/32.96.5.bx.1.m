...
// Magma code for modular curve with label 32.96.5.bx.1

// Other names and/or labels
// Cummins-Pauli label: 32F5
// Rouse-Zureick-Brown label: X693
// Rouse-Sutherland-Zureick-Brown label: 32.96.5.22

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 28, 12, 29], [13, 21, 12, 19], [19, 24, 6, 25], [25, 29, 30, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
// Map from the canonical model to the plane model of modular curve with label 32.96.5.bx.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
