...
// Magma code for modular curve with label 24.144.5.bfm.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.393

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 20, 22, 7], [3, 10, 2, 21], [5, 19, 16, 7], [23, 5, 20, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.2.q.1", "24.72.1.ff.1", "24.72.2.cy.1", "24.72.2.hu.1", "24.72.2.il.1", "24.72.3.bgh.1", "24.72.3.bgw.1"];
...
// Canonical model
model_0 := [x*z+x*w+y*w,x^2+x*y+y^2-z^2-4*z*w-w^2,2*x^2+2*x*y-y^2-2*z^2+4*z*w-2*w^2+t^2];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.bfm.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
