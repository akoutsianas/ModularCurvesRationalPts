...
// Magma code for modular curve with label 24.72.5.bn.1

// Other names and/or labels
// Cummins-Pauli label: 24F5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.183

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 2, 4, 1], [9, 2, 4, 9], [15, 8, 20, 15], [23, 8, 20, 19], [23, 23, 10, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.i.1", "24.36.1.gq.1", "24.36.2.gh.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.5.bn.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
