...
// Magma code for modular curve with label 48.144.5.gd.1

// Other names and/or labels
// Cummins-Pauli label: 48G5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.848

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 4, 46, 7], [13, 16, 28, 41], [13, 17, 8, 23], [17, 6, 18, 23], [33, 4, 34, 39]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.2.in.1", "48.72.0.d.2", "48.72.3.bk.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.gd.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.gd.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-t);
//   Coordinate number 1:
