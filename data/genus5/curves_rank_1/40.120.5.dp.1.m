...
// Magma code for modular curve with label 40.120.5.dp.1

// Other names and/or labels
// Cummins-Pauli label: 10B5
// Rouse-Sutherland-Zureick-Brown label: 40.120.5.194

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 13, 32, 1], [19, 38, 34, 21], [27, 31, 34, 33], [37, 6, 4, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.3.m.1", "40.40.1.bh.1", "40.60.2.b.1", "40.60.2.j.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.120.5.dp.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
