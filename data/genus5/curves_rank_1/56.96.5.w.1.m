...
// Magma code for modular curve with label 56.96.5.w.1

// Other names and/or labels
// Cummins-Pauli label: 28E5
// Rouse-Sutherland-Zureick-Brown label: 56.96.5.7

// Group data
level := 56;
// Elements that, together with Gamma(level), generate the group
gens := [[10, 27, 49, 44], [18, 13, 7, 52], [31, 46, 14, 27], [34, 7, 21, 12], [37, 16, 28, 5], [47, 2, 0, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['7.8.0.a.1', '8.12.0.k.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["8.12.0.k.1", "28.48.2.c.1", "56.48.2.c.1", "56.48.3.d.1"];
...
// Map from the canonical model to the plane model of modular curve with label 56.96.5.w.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
