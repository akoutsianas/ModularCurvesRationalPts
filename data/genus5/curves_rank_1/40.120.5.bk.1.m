...
// Magma code for modular curve with label 40.120.5.bk.1

// Other names and/or labels
// Cummins-Pauli label: 20E5
// Rouse-Sutherland-Zureick-Brown label: 40.120.5.158

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 9, 26, 5], [19, 23, 12, 11], [25, 4, 6, 11], [31, 12, 6, 29], [39, 34, 16, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.3.b.1", "40.60.2.c.1", "40.60.2.h.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.120.5.bk.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
