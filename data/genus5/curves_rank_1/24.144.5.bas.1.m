...
// Magma code for modular curve with label 24.144.5.bas.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.932

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 22, 16, 15], [5, 7, 14, 11], [17, 13, 14, 23], [21, 1, 4, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.el.1", "24.72.2.be.1", "24.72.2.ca.1", "24.72.2.im.1", "24.72.2.jq.1", "24.72.3.bds.1", "24.72.3.bew.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.bas.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*z);
