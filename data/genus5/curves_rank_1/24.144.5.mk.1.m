...
// Magma code for modular curve with label 24.144.5.mk.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1300

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 13, 22, 9], [3, 14, 14, 9], [17, 4, 2, 11], [17, 23, 2, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.de.1", "24.72.2.h.1", "24.72.2.bb.1", "24.72.2.eu.1", "24.72.2.ga.1", "24.72.3.bfw.1", "24.72.3.bhc.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.mk.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
