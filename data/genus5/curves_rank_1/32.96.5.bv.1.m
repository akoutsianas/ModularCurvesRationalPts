...
// Magma code for modular curve with label 32.96.5.bv.1

// Other names and/or labels
// Cummins-Pauli label: 32E5
// Rouse-Zureick-Brown label: X674
// Rouse-Sutherland-Zureick-Brown label: 32.96.5.80

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 21, 26, 3], [15, 3, 28, 25], [19, 18, 8, 15], [31, 25, 12, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
// Map from the canonical model to the plane model of modular curve with label 32.96.5.bv.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*z);
