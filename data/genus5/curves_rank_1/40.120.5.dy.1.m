...
// Magma code for modular curve with label 40.120.5.dy.1

// Other names and/or labels
// Cummins-Pauli label: 20E5
// Rouse-Sutherland-Zureick-Brown label: 40.120.5.183

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 8, 4, 7], [7, 12, 19, 27], [17, 14, 28, 17], [31, 4, 13, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.3.o.1", "40.60.2.a.1", "40.60.2.g.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.120.5.dy.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
