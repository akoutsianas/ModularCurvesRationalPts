...
// Magma code for modular curve with label 44.72.5.a.1

// Other names and/or labels
// Cummins-Pauli label: 44B5
// Rouse-Sutherland-Zureick-Brown label: 44.72.5.4

// Group data
level := 44;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 33, 0, 19], [17, 0, 6, 31], [17, 22, 4, 41], [27, 11, 28, 35]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
// Map from the embedded model to the plane model of modular curve with label 44.72.5.a.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 44.72.5.a.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-v);
//   Coordinate number 1:
map_2_coord_1 := 1*(121*x^4*v^2+121*x^3*t*v^2-22*x^2*v^4);
//   Coordinate number 2:
map_2_coord_2 := 1*(-x);
// Codomain equation:
