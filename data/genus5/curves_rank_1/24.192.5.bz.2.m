...
// Magma code for modular curve with label 24.192.5.bz.2

// Other names and/or labels
// Cummins-Pauli label: 12E5
// Rouse-Sutherland-Zureick-Brown label: 24.192.5.1227

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 12, 6, 5], [11, 20, 0, 17], [17, 14, 12, 7], [17, 18, 12, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["12.96.3.h.1", "24.96.1.cl.1", "24.96.1.cm.2", "24.96.1.cp.4", "24.96.3.bg.1", "24.96.3.bx.1", "24.96.3.cd.2"];
...
// Map from the canonical model to the plane model of modular curve with label 24.192.5.bz.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
