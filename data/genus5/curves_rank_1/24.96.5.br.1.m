...
// Magma code for modular curve with label 24.96.5.br.1

// Other names and/or labels
// Cummins-Pauli label: 24I5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.228

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 20, 0, 7], [11, 6, 12, 5], [13, 17, 18, 1], [13, 21, 6, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.24.1.v.1", "24.48.1.jd.1", "24.48.3.a.1", "24.48.3.ci.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.br.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*z);
