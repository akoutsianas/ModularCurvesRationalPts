...
// Magma code for modular curve with label 24.144.5.jg.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.623

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 21, 6, 19], [21, 4, 2, 15], [21, 23, 20, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.3.cr.1", "24.72.1.bg.1", "24.72.1.bq.1", "24.72.1.co.1", "24.72.3.tr.1", "24.72.3.uk.1", "24.72.3.vw.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.jg.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
