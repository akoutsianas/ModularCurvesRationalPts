...
// Magma code for modular curve with label 32.96.5.bd.2

// Other names and/or labels
// Cummins-Pauli label: 32D5
// Rouse-Sutherland-Zureick-Brown label: 32.96.5.44

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 20, 8, 13], [17, 0, 8, 11], [17, 27, 8, 21], [21, 7, 16, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.u.2", "32.48.3.d.1", "32.48.3.e.2"];
...
// Map from the canonical model to the plane model of modular curve with label 32.96.5.bd.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
