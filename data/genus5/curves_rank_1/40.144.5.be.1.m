...
// Magma code for modular curve with label 40.144.5.be.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.519

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 38, 8, 11], [7, 27, 4, 15], [31, 16, 20, 7], [33, 24, 36, 11], [39, 39, 36, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.s.1", "40.72.1.e.1", "40.72.1.v.1", "40.72.1.cj.2", "40.72.3.h.1", "40.72.3.k.1", "40.72.3.eu.2"];
...
model_1 := [9*x^8-20*x^6*y^2+4*x^4*y^4+12*x^6*z^2-56*x^4*y^2*z^2+94*x^4*z^4-100*x^2*y^2*z^4+60*x^2*z^6+225*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.be.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
map_1_coord_2 := 1*(z);
// Codomain equation:
map_1_codomain := [9*x^8-20*x^6*y^2+4*x^4*y^4+12*x^6*z^2-56*x^4*y^2*z^2+94*x^4*z^4-100*x^2*y^2*z^4+60*x^2*z^6+225*z^8];
