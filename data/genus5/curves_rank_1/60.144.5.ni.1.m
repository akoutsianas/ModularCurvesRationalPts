...
// Magma code for modular curve with label 60.144.5.ni.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.664

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 5, 2, 19], [17, 40, 54, 41], [29, 55, 4, 57]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.o.2", "60.72.1.br.1", "60.72.1.cp.2", "60.72.3.oi.1", "60.72.3.op.1", "60.72.3.rh.2", "60.72.3.yc.2"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.ni.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
