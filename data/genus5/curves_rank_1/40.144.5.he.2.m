...
// Magma code for modular curve with label 40.144.5.he.2

// Other names and/or labels
// Cummins-Pauli label: 40M5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.630

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 30, 36, 33], [11, 22, 20, 13], [15, 19, 32, 37], [31, 22, 8, 35], [39, 9, 0, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["40.72.1.s.2", "40.72.3.ca.2", "40.72.3.ce.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.he.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(x);
