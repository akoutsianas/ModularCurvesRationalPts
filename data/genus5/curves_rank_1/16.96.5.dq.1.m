...
// Magma code for modular curve with label 16.96.5.dq.1

// Other names and/or labels
// Cummins-Pauli label: 16F5
// Rouse-Sutherland-Zureick-Brown label: 16.96.5.89

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 11, 0, 5], [9, 5, 4, 7], [9, 12, 14, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.bu.1", "16.48.1.cf.1", "16.48.3.ca.1"];
...
// Map from the canonical model to the plane model of modular curve with label 16.96.5.dq.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
