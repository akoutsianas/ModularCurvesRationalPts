...
// Magma code for modular curve with label 48.144.5.em.1

// Other names and/or labels
// Cummins-Pauli label: 48H5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.815

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 19, 26, 19], [9, 11, 34, 21], [13, 17, 22, 31], [27, 28, 40, 15], [41, 2, 8, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.2.hl.2", "48.72.0.c.1", "48.72.3.w.1"];
...
model_1 := [x^10+4*x^8*z^2+6*x^6*z^4+4*x^4*y*z^5+4*x^4*z^6-2*x^2*y^2*z^6+8*x^2*y*z^7+8*y*z^9];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.em.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(v);
...
map_1_coord_2 := 1*(w);
// Codomain equation:
map_1_codomain := [x^10+4*x^8*z^2+6*x^6*z^4+4*x^4*y*z^5+4*x^4*z^6-2*x^2*y^2*z^6+8*x^2*y*z^7+8*y*z^9];

// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.em.1
//   Coordinate number 0:
map_2_coord_0 := 1*(y);
//   Coordinate number 1:
