...
// Magma code for modular curve with label 24.144.5.yt.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1186

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 5, 8, 11], [7, 9, 0, 17], [7, 17, 4, 1], [9, 20, 22, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.eo.1", "24.72.2.o.1", "24.72.2.bs.1", "24.72.2.hv.1", "24.72.2.ie.1", "24.72.3.bcw.1", "24.72.3.bdh.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.yt.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*z);
