...
// Magma code for modular curve with label 40.144.5.gs.1

// Other names and/or labels
// Cummins-Pauli label: 40M5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.612

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 22, 20, 13], [1, 23, 20, 19], [3, 24, 12, 25], [5, 37, 32, 15], [19, 38, 20, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["40.72.1.v.2", "40.72.3.bw.1", "40.72.3.cb.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.gs.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
