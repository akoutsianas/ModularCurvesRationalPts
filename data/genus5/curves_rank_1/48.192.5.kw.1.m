...
// Magma code for modular curve with label 48.192.5.kw.1

// Other names and/or labels
// Cummins-Pauli label: 48I5
// Rouse-Sutherland-Zureick-Brown label: 48.192.5.4243

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 42, 24, 41], [11, 29, 12, 11], [17, 3, 36, 5], [25, 6, 0, 29], [37, 41, 12, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["24.96.1.dp.3", "48.96.3.px.1", "48.96.3.qi.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.192.5.kw.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*z);
