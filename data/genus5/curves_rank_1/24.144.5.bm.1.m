...
// Magma code for modular curve with label 24.144.5.bm.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.176

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[15, 2, 20, 21], [15, 13, 14, 3], [23, 6, 18, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.1.j.1", "24.72.1.d.1", "24.72.1.bx.1", "24.72.3.cz.1", "24.72.3.ds.1", "24.72.3.qv.1", "24.72.3.ts.1"];
...
model_1 := [81*x^8-216*x^6*z^2+18*x^4*y^2*z^2+54*x^4*z^4-12*x^2*y^3*z^3+12*x^2*y^2*z^4-12*x^2*y*z^5+72*x^2*z^6+2*y^4*z^4-4*y^3*z^5+6*y^2*z^6-4*y*z^7+11*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.bm.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y+w);
...
map_1_coord_2 := 1*(z);
// Codomain equation:
map_1_codomain := [81*x^8-216*x^6*z^2+18*x^4*y^2*z^2+54*x^4*z^4-12*x^2*y^3*z^3+12*x^2*y^2*z^4-12*x^2*y*z^5+72*x^2*z^6+2*y^4*z^4-4*y^3*z^5+6*y^2*z^6-4*y*z^7+11*z^8];
