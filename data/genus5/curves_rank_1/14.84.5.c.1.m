...
// Magma code for modular curve with label 14.84.5.c.1

// Other names and/or labels
// Cummins-Pauli label: 14B5
// Rouse-Sutherland-Zureick-Brown label: 14.84.5.4

// Group data
level := 14;
// Elements that, together with Gamma(level), generate the group
gens := [[6, 5, 5, 1], [7, 3, 10, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 84;
...
covers := ["7.42.1.a.1", "14.42.1.a.1", "14.42.3.b.1"];
...
// Canonical model
model_0 := [x^2+2*x*y-y^2-3*x*w+2*y*w,2*x*y+3*y^2+x*w-y*w-3*w^2-t^2,2*x^2+x*y+4*y^2-7*y*z+7*z^2+3*x*w+2*y*w+w^2];
