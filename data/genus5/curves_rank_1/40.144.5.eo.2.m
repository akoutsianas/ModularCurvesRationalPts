...
// Magma code for modular curve with label 40.144.5.eo.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.17

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 28, 34, 17], [15, 34, 36, 33], [29, 3, 8, 19], [37, 32, 26, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["10.72.1.b.2", "40.72.1.n.1", "40.72.1.cg.2", "40.72.3.bl.1", "40.72.3.cn.2", "40.72.3.cv.2", "40.72.3.ek.1"];
...
model_1 := [625*x^8+250*x^7*y-75*x^6*y^2-20*x^5*y^3-x^4*y^4-2000*x^6*z^2-500*x^5*y*z^2+40*x^4*y^2*z^2+8*x^3*y^3*z^2+1700*x^4*z^4+680*x^3*y*z^4+36*x^2*y^2*z^4-960*x^2*z^6-208*x*y*z^6-176*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.eo.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y+z);
//   Coordinate number 1:
map_1_coord_1 := 1*(5*x+5*t);
//   Coordinate number 2:
map_1_coord_2 := 1*(w);
// Codomain equation:
map_1_codomain := [625*x^8+250*x^7*y-75*x^6*y^2-20*x^5*y^3-x^4*y^4-2000*x^6*z^2-500*x^5*y*z^2+40*x^4*y^2*z^2+8*x^3*y^3*z^2+1700*x^4*z^4+680*x^3*y*z^4+36*x^2*y^2*z^4-960*x^2*z^6-208*x*y*z^6-176*z^8];
