...
// Magma code for modular curve with label 40.144.5.dl.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.343

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 31, 20, 19], [23, 26, 0, 9], [37, 17, 14, 5], [37, 29, 24, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.bi.2", "40.72.1.h.1", "40.72.1.br.2", "40.72.1.ce.2", "40.72.3.z.1", "40.72.3.bg.1", "40.72.3.dn.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.dl.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+z);
//   Coordinate number 1:
