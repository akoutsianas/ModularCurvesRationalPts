...
// Magma code for modular curve with label 48.144.5.be.1

// Other names and/or labels
// Cummins-Pauli label: 48H5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.822

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[25, 0, 36, 31], [31, 17, 22, 37], [37, 19, 34, 11], [41, 46, 32, 11], [47, 1, 46, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.2.hl.2", "48.72.0.a.1", "48.72.3.bb.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.be.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(9*w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.be.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-u);
//   Coordinate number 1:
