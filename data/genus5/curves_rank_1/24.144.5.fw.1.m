...
// Magma code for modular curve with label 24.144.5.fw.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.172

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 2, 10, 21], [3, 13, 14, 15], [3, 23, 10, 15], [19, 18, 6, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.1.e.1", "24.72.1.bo.1", "24.72.1.bx.1", "24.72.3.lo.1", "24.72.3.qa.1", "24.72.3.qv.1", "24.72.3.tj.1"];
...
model_1 := [18*x^4*y^4+36*x^3*y^5-36*x^3*y^3*z^2-18*x^2*y^6+12*x^2*y^4*z^2+42*x^2*y^2*z^4-36*x*y^7+84*x*y^5*z^2-24*x*y^3*z^4-24*x*y*z^6-9*y^8+24*y^6*z^2-10*y^4*z^4+8*y^2*z^6+5*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.fw.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+w);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
...
map_1_coord_2 := 1*(z);
// Codomain equation:
map_1_codomain := [18*x^4*y^4+36*x^3*y^5-36*x^3*y^3*z^2-18*x^2*y^6+12*x^2*y^4*z^2+42*x^2*y^2*z^4-36*x*y^7+84*x*y^5*z^2-24*x*y^3*z^4-24*x*y*z^6-9*y^8+24*y^6*z^2-10*y^4*z^4+8*y^2*z^6+5*z^8];
