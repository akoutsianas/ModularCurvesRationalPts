...
// Magma code for modular curve with label 24.144.5.hi.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.628

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 16, 2, 15], [9, 1, 10, 9], [9, 7, 4, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.3.cs.1", "24.72.1.x.1", "24.72.1.bq.1", "24.72.1.ca.1", "24.72.3.mt.1", "24.72.3.qh.1", "24.72.3.qt.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.hi.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
