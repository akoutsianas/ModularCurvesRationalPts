...
// Magma code for modular curve with label 40.120.5.du.1

// Other names and/or labels
// Cummins-Pauli label: 20E5
// Rouse-Sutherland-Zureick-Brown label: 40.120.5.103

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 9, 36, 15], [21, 11, 30, 19], [35, 37, 18, 23], [39, 36, 2, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.2.e.1", "40.60.2.a.1", "40.60.3.bq.1"];
...
// Canonical model
model_0 := [5*x*w+z*t,10*x^2-2*y^2-2*y*w+2*w^2-t^2,10*y^2-10*y*w-10*z^2+5*w^2-2*t^2];
...
// Map from the canonical model to the plane model of modular curve with label 40.120.5.du.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
