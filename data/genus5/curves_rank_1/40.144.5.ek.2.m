...
// Magma code for modular curve with label 40.144.5.ek.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.81

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 28, 12, 27], [13, 30, 22, 31], [13, 39, 22, 25], [15, 3, 16, 7], [39, 3, 28, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.d.1", "40.72.1.ba.2", "40.72.1.cf.2", "40.72.3.bk.1", "40.72.3.cl.2", "40.72.3.cz.2", "40.72.3.ek.1"];
...
model_1 := [299*x^8+28*x^7*y-24*x^6*y^2-8*x^5*y^3+4*x^4*y^4+1860*x^6*z^2+100*x^5*y*z^2+80*x^4*y^2*z^2-40*x^3*y^3*z^2+5950*x^4*z^4-100*x^3*y*z^4+9500*x^2*z^6+500*x*y*z^6+6875*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.ek.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z+w);
...
// Codomain equation:
map_1_codomain := [299*x^8+28*x^7*y-24*x^6*y^2-8*x^5*y^3+4*x^4*y^4+1860*x^6*z^2+100*x^5*y*z^2+80*x^4*y^2*z^2-40*x^3*y^3*z^2+5950*x^4*z^4-100*x^3*y*z^4+9500*x^2*z^6+500*x*y*z^6+6875*z^8];
