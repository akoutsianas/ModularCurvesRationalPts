...
// Magma code for modular curve with label 24.72.5.fm.1

// Other names and/or labels
// Cummins-Pauli label: 24G5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.146

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 7, 8, 7], [7, 5, 2, 5], [11, 2, 4, 11], [17, 2, 4, 5], [19, 12, 0, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bw.1", "24.36.1.fv.1", "24.36.3.d.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.5.fm.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x-y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
