...
// Magma code for modular curve with label 48.96.5.li.1

// Other names and/or labels
// Cummins-Pauli label: 16E5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.467

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 26, 40, 19], [27, 31, 32, 5], [31, 13, 42, 1], [37, 42, 22, 35]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.br.1", "48.48.1.fn.1", "48.48.1.fp.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.li.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
