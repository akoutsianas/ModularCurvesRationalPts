...
// Magma code for modular curve with label 48.96.5.lt.1

// Other names and/or labels
// Cummins-Pauli label: 16E5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.492

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 29, 34, 35], [25, 39, 10, 47], [37, 41, 36, 19], [41, 15, 12, 43]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.bx.1", "48.48.1.ge.1", "48.48.1.gh.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.lt.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
