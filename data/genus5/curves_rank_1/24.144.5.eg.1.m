...
// Magma code for modular curve with label 24.144.5.eg.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.680

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 22, 14, 9], [5, 0, 12, 5], [9, 7, 20, 15], [9, 20, 10, 15], [17, 0, 12, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.3.db.1", "24.72.1.k.1", "24.72.1.w.1", "24.72.1.ct.1", "24.72.3.hr.1", "24.72.3.hy.1", "24.72.3.qk.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.eg.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
