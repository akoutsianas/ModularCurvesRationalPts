...
// Magma code for modular curve with label 24.144.5.ot.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1228

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 21, 18, 19], [7, 7, 14, 13], [23, 16, 22, 13], [23, 20, 10, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.dd.1", "24.72.2.y.1", "24.72.2.bi.1", "24.72.2.ff.1", "24.72.2.gl.1", "24.72.3.bgp.1", "24.72.3.bhv.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.ot.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
