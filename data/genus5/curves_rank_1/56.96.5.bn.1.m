...
// Magma code for modular curve with label 56.96.5.bn.1

// Other names and/or labels
// Cummins-Pauli label: 56D5
// Rouse-Sutherland-Zureick-Brown label: 56.96.5.24

// Group data
level := 56;
// Elements that, together with Gamma(level), generate the group
gens := [[2, 3, 35, 18], [6, 13, 51, 28], [17, 26, 36, 55], [25, 34, 28, 43], [35, 32, 26, 29], [53, 14, 42, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["28.48.2.c.1", "56.12.0.z.1"];
...
// Codomain equation:
map_1_codomain := [9*x^7+6*x^6*y+13*x^5*y^2+56*x^5*z^2+4*x^4*y^3+91*x^4*y*z^2+4*x^3*y^4+70*x^3*y^2*z^2+49*x^3*z^4+42*x^2*y^3*z^2+98*x^2*y*z^4+14*x*y^4*z^2+49*x*y^2*z^4+7*y^5*z^2];
