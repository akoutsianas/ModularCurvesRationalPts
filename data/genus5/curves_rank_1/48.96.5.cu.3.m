...
// Magma code for modular curve with label 48.96.5.cu.3

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.637

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 23, 42, 11], [19, 34, 20, 43], [41, 1, 38, 45]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.i.1", "24.48.1.ca.1", "48.48.1.io.2", "48.48.1.it.1", "48.48.3.i.1", "48.48.3.bs.2", "48.48.3.bv.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.cu.3
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*w);
