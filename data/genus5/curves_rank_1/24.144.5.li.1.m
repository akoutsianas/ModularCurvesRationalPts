...
// Magma code for modular curve with label 24.144.5.li.1

// Other names and/or labels
// Cummins-Pauli label: 12D5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.706

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 16, 2, 21], [3, 20, 20, 15], [15, 20, 4, 3], [17, 12, 6, 11], [21, 5, 14, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.3.dt.1", "24.72.1.ct.1", "24.72.3.zq.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.li.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
