...
// Magma code for modular curve with label 24.144.5.yk.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1128

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 21, 0, 13], [17, 10, 14, 11], [17, 21, 6, 19], [21, 2, 20, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.em.1", "24.72.2.o.1", "24.72.2.br.1", "24.72.2.hq.1", "24.72.2.ib.1", "24.72.3.bdb.1", "24.72.3.bdk.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.yk.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
