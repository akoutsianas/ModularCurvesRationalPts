...
// Magma code for modular curve with label 60.72.5.cx.1

// Other names and/or labels
// Cummins-Pauli label: 30C5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.53

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 46, 14, 23], [13, 52, 53, 49], [23, 39, 21, 20], [26, 13, 55, 58], [32, 45, 9, 41]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["15.36.2.a.2", "60.24.1.bd.2", "60.36.0.cg.1", "60.36.3.d.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.5.cx.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.72.5.cx.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-t);
//   Coordinate number 1:
map_2_coord_1 := 1*(67*z^6+135*z^5*w+12*t^6);
//   Coordinate number 2:
map_2_coord_2 := 1*(-z);
// Codomain equation:
