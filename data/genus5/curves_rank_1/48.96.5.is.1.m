...
// Magma code for modular curve with label 48.96.5.is.1

// Other names and/or labels
// Cummins-Pauli label: 16B5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.456

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 43, 10, 31], [11, 29, 16, 9], [31, 26, 0, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.bo.1", "24.48.1.kl.1", "48.48.1.hb.1", "48.48.1.hq.1", "48.48.3.bn.2", "48.48.3.cd.1", "48.48.3.dz.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.is.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*z);
