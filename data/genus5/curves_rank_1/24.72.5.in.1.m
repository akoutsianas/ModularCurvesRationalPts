...
// Magma code for modular curve with label 24.72.5.in.1

// Other names and/or labels
// Cummins-Pauli label: 24F5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.197

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 8, 10, 9], [15, 10, 20, 3], [17, 2, 14, 19], [17, 23, 4, 11], [23, 13, 14, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.bw.1", "24.36.1.go.1", "24.36.2.gj.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.5.in.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
