...
// Magma code for modular curve with label 32.96.5.f.1

// Other names and/or labels
// Cummins-Pauli label: 32B5
// Rouse-Sutherland-Zureick-Brown label: 32.96.5.67

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 5, 4, 7], [29, 24, 8, 7], [29, 29, 4, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.c.1", "32.48.3.b.2", "32.48.3.f.1"];
...
// Map from the canonical model to the plane model of modular curve with label 32.96.5.f.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
