...
// Magma code for modular curve with label 48.96.5.rv.2

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.211

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 21, 38, 31], [13, 26, 24, 11], [29, 4, 28, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.ci.2", "24.48.1.ks.1", "48.48.1.ir.2", "48.48.3.dh.1", "48.48.3.ee.1", "48.48.3.et.2", "48.48.3.ga.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.rv.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
