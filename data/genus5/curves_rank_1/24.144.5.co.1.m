...
// Magma code for modular curve with label 24.144.5.co.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.173

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 9, 12, 23], [15, 14, 22, 21], [19, 15, 0, 23], [23, 15, 0, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.1.e.1", "24.72.1.k.1", "24.72.1.cl.1", "24.72.3.ey.1", "24.72.3.gg.1", "24.72.3.qd.1", "24.72.3.ud.1"];
...
model_1 := [2*x^4*z^4-12*x^3*y^2*z^3+4*x^3*z^5+18*x^2*y^4*z^2-8*x^2*y^2*z^4+6*x^2*z^6-12*x*y^4*z^3-8*x*y^2*z^5+4*x*z^7-9*y^8+24*y^6*z^2-4*y^4*z^4-4*y^2*z^6+z^8];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.co.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+w);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
...
map_1_coord_2 := 1*(z);
// Codomain equation:
map_1_codomain := [2*x^4*z^4-12*x^3*y^2*z^3+4*x^3*z^5+18*x^2*y^4*z^2-8*x^2*y^2*z^4+6*x^2*z^6-12*x*y^4*z^3-8*x*y^2*z^5+4*x*z^7-9*y^8+24*y^6*z^2-4*y^4*z^4-4*y^2*z^6+z^8];
