...
// Magma code for modular curve with label 60.144.5.ox.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.855

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 55, 26, 3], [7, 40, 42, 47], [31, 15, 56, 49]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.w.2", "60.72.1.by.2", "60.72.1.cq.1", "60.72.1.dv.2", "60.72.3.rb.2", "60.72.3.rp.1", "60.72.3.yy.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.ox.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
