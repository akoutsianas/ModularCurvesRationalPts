...
// Magma code for modular curve with label 30.72.5.bl.2

// Other names and/or labels
// Cummins-Pauli label: 30G5
// Rouse-Sutherland-Zureick-Brown label: 30.72.5.44

// Group data
level := 30;
// Elements that, together with Gamma(level), generate the group
gens := [[8, 15, 21, 14], [26, 5, 17, 4], [27, 10, 4, 9], [29, 25, 4, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["15.36.2.a.1", "30.36.1.p.1", "30.36.2.a.1"];
...
// Map from the canonical model to the plane model of modular curve with label 30.72.5.bl.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
