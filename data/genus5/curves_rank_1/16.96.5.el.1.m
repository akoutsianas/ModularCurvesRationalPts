...
// Magma code for modular curve with label 16.96.5.el.1

// Other names and/or labels
// Cummins-Pauli label: 16H5
// Rouse-Sutherland-Zureick-Brown label: 16.96.5.140

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 15, 14, 7], [15, 0, 10, 9], [15, 11, 6, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.bn.1", "16.48.2.bu.1", "16.48.3.cf.1"];
...
// Map from the canonical model to the plane model of modular curve with label 16.96.5.el.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
