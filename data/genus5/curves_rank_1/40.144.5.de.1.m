...
// Magma code for modular curve with label 40.144.5.de.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.577

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 11, 34, 33], [11, 23, 2, 17], [37, 2, 34, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.bh.2", "40.72.1.k.2", "40.72.1.bo.2", "40.72.1.cb.2", "40.72.3.x.1", "40.72.3.z.1", "40.72.3.dk.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.de.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
