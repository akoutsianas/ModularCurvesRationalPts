...
// Magma code for modular curve with label 40.144.5.io.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.91

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 21, 30, 23], [23, 24, 2, 25], [29, 13, 32, 35]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.j.1", "40.72.1.bo.2", "40.72.1.cm.1", "40.72.3.da.2", "40.72.3.dl.1", "40.72.3.dv.1", "40.72.3.et.1"];
...
// Canonical model
model_0 := [x^2-2*x*y+2*y^2+2*z^2,x^2-5*x*z-x*t-t^2,2*x*y-2*y^2+3*z^2+2*w^2-x*t-t^2];

// Singular plane model
model_1 := [36*x^8-252*x^7*z+5160*x^6*y^2-34*x^6*z^2-20190*x^5*y^2*z+2664*x^5*z^3+289225*x^4*y^4-66920*x^4*y^2*z^2+1336*x^4*z^4+479400*x^3*y^4*z-8280*x^3*y^2*z^3-7320*x^3*z^5-7476500*x^2*y^6+2093600*x^2*y^4*z^2-44160*x^2*y^2*z^4+464*x^2*z^6-2523000*x*y^6*z-183600*x*y^4*z^3-104400*x*y^2*z^5+20160*x*z^7+40322500*y^8-14210000*y^6*z^2+3288000*y^4*z^4-364000*y^2*z^6+19600*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.io.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
