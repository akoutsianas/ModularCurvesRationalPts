...
// Magma code for modular curve with label 60.144.5.ew.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.263

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[14, 45, 45, 14], [14, 55, 55, 22], [55, 42, 32, 41], [58, 27, 27, 46]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.3.by.1", "60.72.1.i.1", "60.72.1.bk.1", "60.72.1.eh.1", "60.72.3.hy.1", "60.72.3.nz.1", "60.72.3.tg.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.ew.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+z);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
