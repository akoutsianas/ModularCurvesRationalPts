...
// Magma code for modular curve with label 24.72.5.gp.1

// Other names and/or labels
// Cummins-Pauli label: 24B5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.14

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 20, 4, 19], [7, 23, 14, 5], [7, 23, 20, 17], [13, 5, 8, 11], [17, 4, 10, 7], [17, 5, 8, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
;// CM discriminants
CM_discs := [-4];
// Modular curve is a fiber product of the following curvesfactors := ['3.3.0.a.1', '8.24.1.bb.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["8.24.1.bb.1", "12.36.1.bt.1", "24.36.1.gl.1", "24.36.3.c.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.5.gp.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
