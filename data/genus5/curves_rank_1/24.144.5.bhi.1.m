...
// Magma code for modular curve with label 24.144.5.bhi.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1158

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 21, 18, 11], [9, 10, 10, 3], [17, 10, 16, 13], [17, 20, 14, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.fe.1", "24.72.2.dz.1", "24.72.2.eg.1", "24.72.2.iv.1", "24.72.2.ji.1", "24.72.3.bhc.1", "24.72.3.bhr.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.bhi.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
