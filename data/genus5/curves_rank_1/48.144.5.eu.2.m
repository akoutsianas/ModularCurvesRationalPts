...
// Magma code for modular curve with label 48.144.5.eu.2

// Other names and/or labels
// Cummins-Pauli label: 48H5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.769

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 23, 2, 1], [11, 27, 18, 47], [15, 26, 44, 3], [31, 29, 38, 47], [37, 47, 2, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.2.hk.2", "48.72.0.c.2", "48.72.3.ba.1"];
...
// Embedded model
model_0 := [2*x*z+u*r,2*x*y-t*u,w*u-t*u-t*r-u*r,w*t+w*u-t*u,w^2+u*r,x*w+z*u,x*w-x*t-z*t,z*w-x*r,z*t+y*r,y*w+x*t,x*t+x*u+y*u,x^2+x*y+y*z,x^2-x*y-y*z+w*u,2*y^2+t^2+t*u,2*z^2-w*r,x^2+x*y-y*z+w^2+2*w*t+t^2-w*u+t*u+8*u^2+6*v^2+2*w*r-2*u*r+r^2];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.eu.2
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(v);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.eu.2
//   Coordinate number 0:
map_2_coord_0 := 1*(-z);
//   Coordinate number 1:
map_2_coord_1 := 1*(-1/2*z^6-3/16*z^2*v*r^3-3/32*v*r^5);
//   Coordinate number 2:
