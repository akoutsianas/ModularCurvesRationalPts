...
// Magma code for modular curve with label 40.144.5.bb.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.296

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 13, 16, 17], [13, 24, 12, 5], [17, 29, 8, 13], [21, 36, 28, 39], [35, 23, 16, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.g.1", "40.72.1.d.2", "40.72.1.ci.2", "40.72.3.h.1", "40.72.3.n.2", "40.72.3.co.1", "40.72.3.et.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.bb.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x+w);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
