...
// Magma code for modular curve with label 48.144.5.a.1

// Other names and/or labels
// Cummins-Pauli label: 48F5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.724

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 6, 36, 37], [17, 0, 36, 7], [19, 1, 22, 17], [23, 44, 8, 31], [33, 1, 22, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.2.hj.1", "48.48.1.gq.2", "48.72.0.a.1", "48.72.3.q.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.a.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(9*v);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.a.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-r);
//   Coordinate number 1:
