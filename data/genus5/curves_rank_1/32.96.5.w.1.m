...
// Magma code for modular curve with label 32.96.5.w.1

// Other names and/or labels
// Cummins-Pauli label: 32C5
// Rouse-Sutherland-Zureick-Brown label: 32.96.5.26

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 3, 8, 31], [13, 7, 8, 13], [15, 24, 0, 21], [25, 24, 0, 5], [27, 19, 24, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.v.1", "32.48.3.a.2", "32.48.3.d.1"];
...
// Map from the canonical model to the plane model of modular curve with label 32.96.5.w.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
