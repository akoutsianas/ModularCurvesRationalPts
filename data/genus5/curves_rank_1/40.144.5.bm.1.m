...
// Magma code for modular curve with label 40.144.5.bm.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.544

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 0, 38, 19], [29, 2, 2, 9], [37, 15, 24, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.ba.2", "40.72.1.e.2", "40.72.1.bt.1", "40.72.1.bx.2", "40.72.3.j.1", "40.72.3.k.1", "40.72.3.ei.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.bm.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
