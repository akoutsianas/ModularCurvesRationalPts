...
// Magma code for modular curve with label 48.144.5.ek.2

// Other names and/or labels
// Cummins-Pauli label: 48H5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.770

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 13, 14, 45], [13, 39, 42, 29], [17, 31, 10, 13], [23, 4, 28, 13], [23, 45, 6, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.2.hk.2", "48.72.0.c.2", "48.72.3.v.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.ek.2
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
map_1_coord_1 := 1*(v);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.ek.2
//   Coordinate number 0:
map_2_coord_0 := 1*(-t);
//   Coordinate number 1:
map_2_coord_1 := 1*(-1/2*t^6-3/16*t^2*v*r^3+3/32*v*r^5);
//   Coordinate number 2:
