...
// Magma code for modular curve with label 24.72.5.mb.1

// Other names and/or labels
// Cummins-Pauli label: 24B5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.230

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 22, 16, 1], [7, 11, 2, 5], [17, 13, 8, 23], [17, 19, 4, 7], [19, 20, 10, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.24.1.dl.1", "24.36.1.fx.1", "24.36.1.gi.1", "24.36.3.g.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.5.mb.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
