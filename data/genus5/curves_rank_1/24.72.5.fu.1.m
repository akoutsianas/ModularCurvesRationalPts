...
// Magma code for modular curve with label 24.72.5.fu.1

// Other names and/or labels
// Cummins-Pauli label: 24G5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.357

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 21, 12, 11], [5, 6, 18, 23], [5, 7, 8, 11], [9, 14, 4, 21], [9, 23, 22, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.ga.1", "24.36.1.gf.1", "24.36.3.d.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.5.fu.1
//   Coordinate number 0:
