...
// Magma code for modular curve with label 24.72.5.on.1

// Other names and/or labels
// Cummins-Pauli label: 24A5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.217

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 21, 6, 23], [3, 17, 22, 9], [7, 9, 6, 17], [9, 7, 2, 21], [19, 11, 2, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.24.1.eb.1", "24.36.0.cg.1", "24.36.2.fw.1", "24.36.3.e.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.5.on.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
map_1_coord_1 := 1*(4*u);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.5.on.1
//   Coordinate number 0:
map_2_coord_0 := 1*(r);
//   Coordinate number 1:
