...
// Magma code for modular curve with label 60.144.5.mb.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.191

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 6, 51, 35], [39, 20, 17, 3], [51, 22, 8, 45]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.3.cr.1", "60.72.1.bj.1", "60.72.1.da.1", "60.72.1.es.1", "60.72.3.nn.1", "60.72.3.nw.1", "60.72.3.pk.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.mb.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
