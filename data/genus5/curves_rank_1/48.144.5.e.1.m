...
// Magma code for modular curve with label 48.144.5.e.1

// Other names and/or labels
// Cummins-Pauli label: 48E5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.170

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 20, 40, 31], [17, 40, 4, 13], [25, 46, 10, 35], [37, 35, 4, 7], [39, 40, 16, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.2.he.1", "48.48.1.gu.1", "48.72.0.b.1", "48.72.3.bh.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.e.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*r);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.e.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-v);
//   Coordinate number 1:
