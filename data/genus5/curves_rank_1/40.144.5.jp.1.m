...
// Magma code for modular curve with label 40.144.5.jp.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.505

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 26, 28, 25], [11, 5, 30, 31], [33, 16, 30, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.x.2", "40.72.1.bh.2", "40.72.1.bv.2", "40.72.1.cr.1", "40.72.3.dq.2", "40.72.3.eb.1", "40.72.3.fa.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.jp.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
