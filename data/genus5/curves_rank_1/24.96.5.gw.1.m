...
// Magma code for modular curve with label 24.96.5.gw.1

// Other names and/or labels
// Cummins-Pauli label: 24J5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.175

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 12, 6, 13], [17, 9, 12, 19], [19, 9, 22, 1], [23, 15, 6, 13], [23, 15, 18, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.24.0.dy.1", "24.48.2.l.1", "24.48.2.q.1", "24.48.3.ck.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.gw.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
