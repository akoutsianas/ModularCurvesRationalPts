...
// Magma code for modular curve with label 16.96.5.cv.1

// Other names and/or labels
// Cummins-Pauli label: 16F5
// Rouse-Sutherland-Zureick-Brown label: 16.96.5.64

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 13, 12, 5], [9, 5, 14, 15], [9, 7, 0, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.bt.1", "16.48.1.bc.1", "16.48.3.cd.1"];
...
// Map from the canonical model to the plane model of modular curve with label 16.96.5.cv.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*w);
