...
// Magma code for modular curve with label 40.120.5.gf.1

// Other names and/or labels
// Cummins-Pauli label: 20F5
// Rouse-Sutherland-Zureick-Brown label: 40.120.5.187

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[25, 6, 18, 5], [31, 36, 3, 21], [33, 20, 0, 3], [39, 14, 8, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.3.s.1", "40.60.2.g.1", "40.60.2.n.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.120.5.gf.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
