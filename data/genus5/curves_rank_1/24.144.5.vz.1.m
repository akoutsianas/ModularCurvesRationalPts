...
// Magma code for modular curve with label 24.144.5.vz.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1214

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 5, 14, 23], [19, 20, 14, 5], [19, 22, 14, 13], [23, 18, 6, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.dw.1", "24.72.2.ea.1", "24.72.2.ek.1", "24.72.2.ge.1", "24.72.2.gt.1", "24.72.3.bej.1", "24.72.3.bew.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.vz.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
