...
// Magma code for modular curve with label 40.144.5.ij.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.529

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 24, 34, 23], [7, 0, 14, 33], [19, 35, 6, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.y.1", "40.72.1.bg.1", "40.72.1.bk.2", "40.72.1.cj.2", "40.72.3.de.2", "40.72.3.dw.1", "40.72.3.er.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.ij.1
//   Coordinate number 0:
