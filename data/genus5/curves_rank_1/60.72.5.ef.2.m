...
// Magma code for modular curve with label 60.72.5.ef.2

// Other names and/or labels
// Cummins-Pauli label: 30G5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.129

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[41, 35, 16, 53], [43, 25, 53, 22], [51, 55, 41, 18], [59, 55, 4, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["30.36.2.b.2", "60.36.1.fz.1", "60.36.2.ft.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.72.5.ef.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
