...
// Magma code for modular curve with label 24.144.5.uy.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1263

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 22, 14, 9], [15, 7, 22, 21], [19, 19, 16, 5], [21, 8, 14, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.du.1", "24.72.2.de.1", "24.72.2.dr.1", "24.72.2.fk.1", "24.72.2.gy.1", "24.72.3.bdg.1", "24.72.3.beu.1"];
...
// Canonical model
model_0 := [3*x*w+y*t+z*t,6*x^2+3*y^2-6*y*z+3*z^2-3*w^2-2*t^2,6*x^2+y^2+2*y*z+z^2-6*w^2+4*t^2];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.uy.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
