...
// Magma code for modular curve with label 60.144.5.fn.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.822

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 32, 31, 35], [19, 40, 22, 11], [27, 56, 10, 41], [57, 40, 40, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.p.1", "60.72.1.n.1", "60.72.1.bz.2", "60.72.1.dr.2", "60.72.3.hv.2", "60.72.3.qq.1", "60.72.3.yf.1"];
...
//   Coordinate number 1:
map_0_coord_1 := 1*(w^4*(2*w-t)*(2*w+t)*(1760*z^2*w^10-3000*z^2*w^8*t^2+900*z^2*w^6*t^4+50*z^2*w^4*t^6-50*z^2*w^2*t^8+5*z^2*t^10+912*w^12-96*w^10*t^2-117*w^8*t^4+36*w^6*t^6-3*w^4*t^8));

// Map from the canonical model to the plane model of modular curve with label 60.144.5.fn.2
//   Coordinate number 0:
