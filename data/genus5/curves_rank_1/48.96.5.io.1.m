...
// Magma code for modular curve with label 48.96.5.io.1

// Other names and/or labels
// Cummins-Pauli label: 16B5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.461

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 29, 26, 41], [19, 16, 2, 9], [35, 18, 42, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.bs.1", "24.48.1.jz.1", "48.48.1.hb.1", "48.48.1.id.1", "48.48.3.bm.2", "48.48.3.cm.1", "48.48.3.dy.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.io.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
