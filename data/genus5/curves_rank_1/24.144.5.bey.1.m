...
// Magma code for modular curve with label 24.144.5.bey.1

// Other names and/or labels
// Cummins-Pauli label: 24S5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.995

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 18, 18, 19], [3, 14, 16, 15], [15, 17, 22, 9], [17, 9, 12, 7], [21, 16, 20, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.cq.1", "24.72.3.bfs.1", "24.72.3.biq.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.bey.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
