...
// Magma code for modular curve with label 48.96.5.me.1

// Other names and/or labels
// Cummins-Pauli label: 16F5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.370

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 7, 12, 23], [1, 11, 2, 39], [27, 20, 44, 31], [45, 40, 22, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.ce.1", "24.48.1.mh.1", "48.48.1.gn.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.me.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*z);
