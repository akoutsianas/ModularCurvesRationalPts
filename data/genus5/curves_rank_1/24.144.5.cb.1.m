...
// Magma code for modular curve with label 24.144.5.cb.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.106

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 6, 12, 11], [3, 19, 14, 3], [15, 11, 14, 9], [21, 17, 10, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.1.t.1", "24.72.1.f.1", "24.72.1.u.1", "24.72.3.ds.1", "24.72.3.du.1", "24.72.3.ql.1", "24.72.3.uc.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.cb.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
