...
// Magma code for modular curve with label 60.72.5.eb.1

// Other names and/or labels
// Cummins-Pauli label: 30G5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.57

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 25, 14, 7], [11, 5, 7, 2], [29, 20, 11, 7], [46, 25, 1, 17], [56, 5, 37, 44]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["15.36.2.a.2", "60.36.1.fz.1", "60.36.2.fu.2"];
...
// Map from the canonical model to the plane model of modular curve with label 60.72.5.eb.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
