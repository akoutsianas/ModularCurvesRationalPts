...
// Magma code for modular curve with label 40.144.5.he.1

// Other names and/or labels
// Cummins-Pauli label: 40M5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.622

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 11, 12, 15], [23, 36, 36, 3], [25, 32, 28, 39], [29, 10, 36, 33], [37, 1, 8, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["40.72.1.s.1", "40.72.3.ca.1", "40.72.3.ce.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.he.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
