...
// Magma code for modular curve with label 48.144.5.ez.2

// Other names and/or labels
// Cummins-Pauli label: 48F5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.714

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[23, 35, 34, 47], [25, 45, 6, 31], [35, 39, 42, 31], [37, 35, 10, 7], [47, 11, 26, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.2.ho.2", "48.48.1.ir.2", "48.72.0.c.2", "48.72.3.bc.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.ez.2
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*v);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.ez.2
//   Coordinate number 0:
map_2_coord_0 := 1*(-t);
//   Coordinate number 1:
