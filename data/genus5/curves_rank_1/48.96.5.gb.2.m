...
// Magma code for modular curve with label 48.96.5.gb.2

// Other names and/or labels
// Cummins-Pauli label: 16B5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.584

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 45, 4, 43], [7, 31, 4, 9], [13, 22, 40, 33], [23, 40, 36, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.bc.2", "24.48.1.ea.1", "48.48.1.iv.1", "48.48.1.iy.1", "48.48.3.bd.2", "48.48.3.bx.1", "48.48.3.cc.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.gb.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
