...
// Magma code for modular curve with label 48.144.5.bk.2

// Other names and/or labels
// Cummins-Pauli label: 48F5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.725

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 44, 16, 15], [5, 7, 18, 1], [7, 35, 42, 29], [13, 41, 30, 35], [19, 14, 24, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.2.hj.1", "48.48.1.hk.1", "48.72.0.a.2", "48.72.3.be.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.bk.2
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.bk.2
//   Coordinate number 0:
