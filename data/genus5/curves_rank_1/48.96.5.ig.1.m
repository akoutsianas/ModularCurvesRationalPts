...
// Magma code for modular curve with label 48.96.5.ig.1

// Other names and/or labels
// Cummins-Pauli label: 16B5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.457

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 11, 8, 41], [13, 38, 14, 15], [21, 44, 46, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.bo.1", "24.48.1.jz.1", "48.48.1.gx.1", "48.48.1.hz.1", "48.48.3.bm.1", "48.48.3.ci.1", "48.48.3.dw.2"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.ig.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
