...
// Magma code for modular curve with label 60.144.5.bm.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.594

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 10, 22, 29], [13, 50, 54, 1], [29, 50, 12, 41], [41, 30, 58, 43], [59, 10, 4, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.a.2", "60.72.1.ci.2", "60.72.1.dm.2", "60.72.3.c.1", "60.72.3.ca.1", "60.72.3.rh.2", "60.72.3.xx.2"];
...
// Canonical model
model_0 := [y*z-z^2+w*t,y^2+2*y*z+2*z^2+w^2+t^2,15*x^2+w*t];

// Singular plane model
model_1 := [x^2*y^4+5*x^4*z^2+60*x^2*y^2*z^2+225*y^4*z^2+225*x^2*z^4];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.bm.2
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(x);
...
// Codomain equation:
map_1_codomain := [x^2*y^4+5*x^4*z^2+60*x^2*y^2*z^2+225*y^4*z^2+225*x^2*z^4];
