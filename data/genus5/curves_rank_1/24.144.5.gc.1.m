...
// Magma code for modular curve with label 24.144.5.gc.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.681

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 4, 2, 3], [15, 22, 22, 15], [23, 3, 6, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.3.ch.1", "24.72.1.q.1", "24.72.1.bo.1", "24.72.1.bw.1", "24.72.3.ls.1", "24.72.3.qb.1", "24.72.3.tg.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.gc.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
