...
// Magma code for modular curve with label 56.84.5.p.1

// Other names and/or labels
// Cummins-Pauli label: 14B5
// Rouse-Sutherland-Zureick-Brown label: 56.84.5.21

// Group data
level := 56;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 2, 20, 37], [19, 27, 41, 30], [42, 47, 23, 35], [45, 2, 42, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 84;
...
covers := ["14.42.3.a.1", "56.42.1.d.1", "56.42.1.e.1"];
...
// Map from the canonical model to the plane model of modular curve with label 56.84.5.p.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
