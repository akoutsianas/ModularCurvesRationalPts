...
// Magma code for modular curve with label 60.120.5.db.1

// Other names and/or labels
// Cummins-Pauli label: 20E5
// Rouse-Sutherland-Zureick-Brown label: 60.120.5.211

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 20, 25, 31], [5, 12, 32, 35], [55, 52, 28, 57], [59, 38, 47, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.3.o.1", "60.60.2.a.1", "60.60.2.e.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.120.5.db.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
