...
// Magma code for modular curve with label 40.144.5.dy.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.392

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 12, 10, 9], [13, 5, 0, 23], [21, 20, 18, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.bb.2", "40.72.1.l.2", "40.72.1.bt.1", "40.72.1.cg.2", "40.72.3.bc.2", "40.72.3.bf.1", "40.72.3.eo.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.dy.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
