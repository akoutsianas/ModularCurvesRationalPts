...
// Magma code for modular curve with label 48.96.5.sg.1

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.171

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 31, 18, 23], [39, 4, 8, 9], [47, 28, 8, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.cl.1", "24.48.1.kx.1", "48.48.1.in.1", "48.48.3.dm.1", "48.48.3.eg.1", "48.48.3.eq.1", "48.48.3.gc.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.sg.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
