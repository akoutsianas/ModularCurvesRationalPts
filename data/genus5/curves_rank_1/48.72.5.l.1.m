...
// Magma code for modular curve with label 48.72.5.l.1

// Other names and/or labels
// Cummins-Pauli label: 48B5
// Rouse-Sutherland-Zureick-Brown label: 48.72.5.11

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 23, 4, 29], [9, 1, 20, 15], [11, 7, 4, 43], [17, 35, 4, 29], [29, 23, 20, 43], [45, 41, 20, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
// Map from the canonical model to the plane model of modular curve with label 48.72.5.l.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
