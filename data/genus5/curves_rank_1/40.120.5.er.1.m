...
// Magma code for modular curve with label 40.120.5.er.1

// Other names and/or labels
// Cummins-Pauli label: 20E5
// Rouse-Sutherland-Zureick-Brown label: 40.120.5.140

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 0, 10, 27], [7, 15, 28, 13], [21, 29, 36, 27], [27, 16, 14, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.2.b.1", "40.60.2.k.1", "40.60.3.bq.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.120.5.er.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
