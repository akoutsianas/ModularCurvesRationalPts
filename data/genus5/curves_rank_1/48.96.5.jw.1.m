...
// Magma code for modular curve with label 48.96.5.jw.1

// Other names and/or labels
// Cummins-Pauli label: 16B5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.485

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 46, 40, 11], [9, 17, 44, 43], [25, 29, 26, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.by.1", "24.48.1.lh.1", "48.48.1.hr.1", "48.48.1.ij.1", "48.48.3.bl.1", "48.48.3.ce.1", "48.48.3.dv.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.jw.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
