...
// Magma code for modular curve with label 48.96.5.la.1

// Other names and/or labels
// Cummins-Pauli label: 16B5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.373

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 24, 18, 13], [25, 20, 44, 21], [29, 5, 46, 11], [31, 12, 32, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.ce.1", "24.48.1.md.1", "48.48.1.ia.1", "48.48.1.il.1", "48.48.3.bo.1", "48.48.3.cj.1", "48.48.3.ec.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.la.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
