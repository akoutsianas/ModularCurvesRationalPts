...
// Magma code for modular curve with label 24.144.5.tn.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.889

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 10, 2, 17], [11, 19, 10, 13], [13, 11, 20, 23], [23, 7, 16, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.dx.1", "24.72.2.cy.1", "24.72.2.ed.1", "24.72.2.ex.1", "24.72.2.fm.1", "24.72.3.bcw.1", "24.72.3.bdn.1"];
...
// Canonical model
model_0 := [x*z+2*x*w+2*y*z+y*w,2*x^2+2*x*y+2*y^2-z^2+2*z*w+2*w^2,4*x^2+4*x*y-2*y^2+6*z^2-3*t^2];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.tn.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
