...
// Magma code for modular curve with label 48.96.5.ir.1

// Other names and/or labels
// Cummins-Pauli label: 16B5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.472

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 35, 40, 27], [23, 3, 24, 5], [25, 11, 34, 31], [43, 40, 6, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.bn.1", "24.48.1.kk.1", "48.48.1.ha.1", "48.48.1.hr.1", "48.48.3.bn.1", "48.48.3.ce.1", "48.48.3.dz.2"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.ir.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+z);
//   Coordinate number 1:
