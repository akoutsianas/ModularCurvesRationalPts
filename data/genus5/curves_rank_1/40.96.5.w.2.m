...
// Magma code for modular curve with label 40.96.5.w.2

// Other names and/or labels
// Cummins-Pauli label: 20D5
// Rouse-Sutherland-Zureick-Brown label: 40.96.5.42

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 30, 26, 13], [28, 9, 5, 12], [33, 11, 36, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["20.48.3.j.2", "40.24.1.cs.1", "40.48.1.kh.1", "40.48.3.h.1"];
...
// Canonical model
model_0 := [x^2-3*x*y+y^2-z^2+z*t-w^2+t^2,2*x^2-x*y+2*y^2+z^2+z*t+3*w^2-t^2,2*x*w+2*y*w-3*z^2+2*z*t+2*w^2];
...
//   Coordinate number 0:
map_0_coord_0 := 1*(-x+4*y-w);
//   Coordinate number 1:
map_0_coord_1 := 1*(x+y-4*w);
//   Coordinate number 2:
map_0_coord_2 := 1*(-4*x+y+w);
// Codomain equation:
...
// Map from the canonical model to the plane model of modular curve with label 40.96.5.w.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x-y);
//   Coordinate number 1:
