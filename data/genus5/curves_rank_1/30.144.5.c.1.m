...
// Magma code for modular curve with label 30.144.5.c.1

// Other names and/or labels
// Cummins-Pauli label: 30R5
// Rouse-Sutherland-Zureick-Brown label: 30.144.5.16

// Group data
level := 30;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 15, 24, 1], [27, 25, 14, 27], [29, 0, 21, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["15.72.1.a.2", "30.72.3.d.2", "30.72.3.j.1"];
...
// Canonical model
model_0 := [y*t-z*w,y^2+y*w+y*t+z*t+t^2,15*x^2-y^2+y*z+y*w-y*t-z*w+z*t+w*t-t^2];
...
// Map from the canonical model to the plane model of modular curve with label 30.144.5.c.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
