...
// Magma code for modular curve with label 24.72.5.bk.1

// Other names and/or labels
// Cummins-Pauli label: 24F5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.182

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 22, 4, 5], [7, 18, 0, 19], [11, 16, 8, 23], [15, 11, 2, 3], [19, 2, 4, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.i.1", "24.36.1.gn.1", "24.36.2.gk.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.5.bk.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
