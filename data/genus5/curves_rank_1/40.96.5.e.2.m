...
// Magma code for modular curve with label 40.96.5.e.2

// Other names and/or labels
// Cummins-Pauli label: 20D5
// Rouse-Sutherland-Zureick-Brown label: 40.96.5.45

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[2, 21, 15, 3], [25, 26, 38, 23], [35, 14, 29, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["20.48.3.j.2", "40.24.1.ca.2", "40.48.1.kg.2", "40.48.3.e.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.96.5.e.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*w);
