...
// Magma code for modular curve with label 40.144.5.kc.2

// Other names and/or labels
// Cummins-Pauli label: 40N5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.158

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 28, 38, 31], [5, 23, 12, 31], [23, 9, 16, 21], [33, 29, 16, 11], [35, 6, 26, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.v.2", "40.72.3.fc.1", "40.72.3.fg.2"];
...
// Canonical model
model_0 := [x*y+x*w+y*z,x*z-y^2+y*w+z^2+w^2,x*z-x*w+y^2+y*z-y*w+z^2-w^2-t^2];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.kc.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
