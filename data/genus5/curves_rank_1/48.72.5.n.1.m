...
// Magma code for modular curve with label 48.72.5.n.1

// Other names and/or labels
// Cummins-Pauli label: 48B5
// Rouse-Sutherland-Zureick-Brown label: 48.72.5.7

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 3, 0, 37], [3, 1, 32, 45], [17, 23, 32, 43], [21, 44, 32, 9], [35, 13, 32, 47], [35, 34, 8, 23], [37, 17, 16, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
// Canonical model
model_0 := [x*z-x*w+y*t,18*x*y+2*z^2+2*z*w-t^2,24*x^2+6*y^2+z*t-w*t];

// Singular plane model
model_1 := [-x^7+4*x^5*y^2+6*x^4*y*z^2-4*x^3*y^4-9*x*y^2*z^4+12*y^5*z^2];
...
// Map from the canonical model to the plane model of modular curve with label 48.72.5.n.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Codomain equation:
map_1_codomain := [-x^7+4*x^5*y^2+6*x^4*y*z^2-4*x^3*y^4-9*x*y^2*z^4+12*y^5*z^2];
