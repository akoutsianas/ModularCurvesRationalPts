...
// Magma code for modular curve with label 24.144.5.pp.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1293

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 17, 8, 19], [13, 8, 20, 17], [17, 10, 20, 5], [19, 11, 2, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.de.1", "24.72.2.bc.1", "24.72.2.bz.1", "24.72.2.ft.1", "24.72.2.gz.1", "24.72.3.bgv.1", "24.72.3.bib.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.pp.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
