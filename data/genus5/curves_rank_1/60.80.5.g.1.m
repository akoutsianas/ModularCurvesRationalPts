...
// Magma code for modular curve with label 60.80.5.g.1

// Other names and/or labels
// Cummins-Pauli label: 30I5
// Rouse-Sutherland-Zureick-Brown label: 60.80.5.12

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[22, 19, 9, 34], [29, 7, 57, 20], [34, 23, 39, 46], [34, 29, 3, 11], [43, 31, 33, 52]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 80;
...
covers := ["15.40.2.a.1", "60.20.0.c.1"];
...
model_1 := [1125*x^8-2700*x^6*y^2-2025*x^4*y^4-675*x^6*y*z+2025*x^4*y^3*z+150*x^6*z^2-180*x^4*y^2*z^2+270*x^2*y^4*z^2+30*x^4*y*z^3-180*x^2*y^3*z^3+5*x^4*z^4-15*x^2*y^2*z^4-9*y^4*z^4+5*x^2*y*z^5+3*y^3*z^5+y^2*z^6];
...
// Map from the canonical model to the plane model of modular curve with label 60.80.5.g.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
map_1_coord_2 := 1*(t);
// Codomain equation:
map_1_codomain := [1125*x^8-2700*x^6*y^2-2025*x^4*y^4-675*x^6*y*z+2025*x^4*y^3*z+150*x^6*z^2-180*x^4*y^2*z^2+270*x^2*y^4*z^2+30*x^4*y*z^3-180*x^2*y^3*z^3+5*x^4*z^4-15*x^2*y^2*z^4-9*y^4*z^4+5*x^2*y*z^5+3*y^3*z^5+y^2*z^6];
