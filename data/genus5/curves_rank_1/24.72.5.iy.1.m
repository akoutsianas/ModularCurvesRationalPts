...
// Magma code for modular curve with label 24.72.5.iy.1

// Other names and/or labels
// Cummins-Pauli label: 24E5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.114

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 1, 22, 15], [7, 5, 2, 23], [9, 13, 2, 3], [11, 9, 6, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bl.1", "24.36.1.gn.1", "24.36.3.e.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.5.iy.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
