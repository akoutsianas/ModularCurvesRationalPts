...
// Magma code for modular curve with label 40.144.5.hp.1

// Other names and/or labels
// Cummins-Pauli label: 40M5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.274

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[15, 34, 8, 31], [25, 29, 36, 33], [27, 31, 24, 29], [29, 32, 32, 29], [39, 18, 16, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.g.2", "40.72.3.cd.1", "40.72.3.ch.1"];
...
model_1 := [4*x^6*y^2+x^4*y^4-8*x^5*y*z^2+8*x^4*y^2*z^2-4*x^3*y^3*z^2+8*x^4*z^4-16*x^3*y*z^4+11*x^2*y^2*z^4+8*x^2*z^6-14*x*y*z^6+6*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.hp.1
//   Coordinate number 0:
...
map_1_coord_2 := 1*(2*y);
// Codomain equation:
map_1_codomain := [4*x^6*y^2+x^4*y^4-8*x^5*y*z^2+8*x^4*y^2*z^2-4*x^3*y^3*z^2+8*x^4*z^4-16*x^3*y*z^4+11*x^2*y^2*z^4+8*x^2*z^6-14*x*y*z^6+6*z^8];
