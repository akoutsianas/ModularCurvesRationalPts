...
// Magma code for modular curve with label 24.96.5.ii.1

// Other names and/or labels
// Cummins-Pauli label: 24J5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.190

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 15, 10, 17], [7, 21, 20, 13], [11, 3, 20, 5], [11, 21, 6, 5], [23, 9, 0, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.24.0.fa.1", "24.48.2.n.1", "24.48.2.p.1", "24.48.3.cp.1"];
...
model_1 := [3*x^4*y^2+18*x^2*y^4-x^4*z^2-12*x^2*y^2*z^2-2*x^2*z^4+3*y^2*z^4-z^6];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.ii.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
map_1_coord_2 := 1*(y);
// Codomain equation:
map_1_codomain := [3*x^4*y^2+18*x^2*y^4-x^4*z^2-12*x^2*y^2*z^2-2*x^2*z^4+3*y^2*z^4-z^6];
