...
// Magma code for modular curve with label 48.96.5.nd.1

// Other names and/or labels
// Cummins-Pauli label: 16H5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.672

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 25, 36, 35], [35, 4, 24, 19], [37, 46, 28, 33], [47, 30, 22, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.cf.1", "48.48.2.bc.1", "48.48.2.bk.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.nd.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
