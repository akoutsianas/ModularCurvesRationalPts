...
// Magma code for modular curve with label 40.120.5.eo.1

// Other names and/or labels
// Cummins-Pauli label: 10B5
// Rouse-Sutherland-Zureick-Brown label: 40.120.5.133

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 28, 2, 29], [21, 10, 14, 39], [21, 20, 30, 21], [23, 3, 2, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.2.b.1", "40.40.1.bu.1", "40.60.2.n.1", "40.60.3.bp.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.120.5.eo.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
