...
// Magma code for modular curve with label 60.144.5.ga.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.886

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 0, 28, 31], [17, 45, 8, 29], [33, 25, 52, 13], [51, 5, 28, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.s.1", "60.72.1.n.2", "60.72.1.cl.1", "60.72.1.dk.1", "60.72.3.fe.1", "60.72.3.qv.2", "60.72.3.xy.2"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.ga.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*w);
