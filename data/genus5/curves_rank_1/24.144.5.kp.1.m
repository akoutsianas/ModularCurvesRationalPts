...
// Magma code for modular curve with label 24.144.5.kp.1

// Other names and/or labels
// Cummins-Pauli label: 12D5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.708

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 11, 14, 9], [3, 19, 8, 21], [9, 10, 22, 15], [15, 22, 8, 3], [21, 23, 8, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.3.dx.1", "24.72.1.cq.1", "24.72.3.zp.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.kp.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
