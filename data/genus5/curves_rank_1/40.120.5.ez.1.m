...
// Magma code for modular curve with label 40.120.5.ez.1

// Other names and/or labels
// Cummins-Pauli label: 20E5
// Rouse-Sutherland-Zureick-Brown label: 40.120.5.181

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 36, 8, 11], [17, 0, 30, 13], [33, 20, 35, 7], [39, 38, 29, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.3.o.1", "40.60.2.d.1", "40.60.2.l.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.120.5.ez.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
