...
// Magma code for modular curve with label 40.96.5.n.1

// Other names and/or labels
// Cummins-Pauli label: 20D5
// Rouse-Sutherland-Zureick-Brown label: 40.96.5.27

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[15, 36, 19, 37], [19, 32, 32, 39], [31, 33, 35, 4], [35, 19, 18, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["20.48.3.i.1", "40.24.1.cj.1", "40.48.1.kh.2", "40.48.3.g.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.96.5.n.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x-y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
