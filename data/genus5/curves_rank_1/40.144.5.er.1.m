...
// Magma code for modular curve with label 40.144.5.er.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.440

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 4, 6, 37], [15, 21, 32, 9], [19, 10, 8, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.u.2", "40.72.1.r.2", "40.72.1.z.1", "40.72.1.cc.1", "40.72.3.bl.1", "40.72.3.cj.1", "40.72.3.eo.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.er.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
