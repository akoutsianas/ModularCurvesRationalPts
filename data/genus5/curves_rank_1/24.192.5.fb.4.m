...
// Magma code for modular curve with label 24.192.5.fb.4

// Other names and/or labels
// Cummins-Pauli label: 24Z5
// Rouse-Sutherland-Zureick-Brown label: 24.192.5.2138

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 6, 12, 17], [11, 6, 16, 11], [13, 18, 8, 23], [23, 15, 20, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["24.96.1.db.1", "24.96.1.df.1", "24.96.1.dj.3", "24.96.3.fc.1", "24.96.3.fw.2", "24.96.3.gk.2", "24.96.3.go.4"];
...
// Map from the canonical model to the plane model of modular curve with label 24.192.5.fb.4
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
