...
// Magma code for modular curve with label 60.144.5.ki.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.945

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[21, 55, 58, 19], [47, 15, 24, 31], [59, 15, 48, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.bh.2", "60.72.1.v.2", "60.72.1.ck.2", "60.72.1.do.2", "60.72.3.my.2", "60.72.3.on.1", "60.72.3.rb.2"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.ki.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
