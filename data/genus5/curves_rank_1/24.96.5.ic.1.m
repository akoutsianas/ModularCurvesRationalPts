...
// Magma code for modular curve with label 24.96.5.ic.1

// Other names and/or labels
// Cummins-Pauli label: 24J5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.189

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 15, 12, 11], [1, 21, 6, 7], [13, 6, 8, 1], [17, 15, 14, 23], [19, 12, 18, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.24.0.eu.1", "24.48.2.k.1", "24.48.2.n.1", "24.48.3.cp.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.ic.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
