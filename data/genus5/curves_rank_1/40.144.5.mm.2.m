...
// Magma code for modular curve with label 40.144.5.mm.2

// Other names and/or labels
// Cummins-Pauli label: 40L5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.656

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 10, 22, 39], [1, 21, 28, 39], [15, 32, 8, 19], [31, 1, 10, 17], [37, 22, 0, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["40.72.1.ct.1", "40.72.3.fx.1", "40.72.3.ga.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.mm.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
