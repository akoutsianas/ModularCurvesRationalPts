...
// Magma code for modular curve with label 40.96.5.q.1

// Other names and/or labels
// Cummins-Pauli label: 20D5
// Rouse-Sutherland-Zureick-Brown label: 40.96.5.49

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[12, 5, 33, 4], [14, 17, 23, 38], [18, 39, 1, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["20.48.3.j.1", "40.24.1.cm.1", "40.48.1.kg.2", "40.48.3.g.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.96.5.q.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x-z);
//   Coordinate number 1:
