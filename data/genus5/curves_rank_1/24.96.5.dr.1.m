...
// Magma code for modular curve with label 24.96.5.dr.1

// Other names and/or labels
// Cummins-Pauli label: 12A5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.150

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 3, 15, 22], [7, 6, 6, 13], [7, 12, 12, 23], [19, 21, 12, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['3.12.0.a.1', '8.8.0.b.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["12.48.3.o.1", "24.24.1.cd.1", "24.32.1.b.1", "24.48.1.mi.1", "24.48.3.z.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.dr.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
