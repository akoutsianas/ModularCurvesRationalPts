...
// Magma code for modular curve with label 40.144.5.kp.1

// Other names and/or labels
// Cummins-Pauli label: 20J5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.583

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 7, 30, 23], [17, 25, 16, 11], [21, 10, 8, 33], [31, 7, 20, 33], [39, 4, 8, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.bt.1", "40.72.1.cq.1", "40.72.3.fj.1"];
...
// Canonical model
model_0 := [2*x^2+2*y^2+z^2+2*z*w,2*x^2+2*y*t+z^2-3*z*w,6*x^2-4*y^2-2*y*t-2*z^2+z*w+5*w^2+2*t^2];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.kp.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
