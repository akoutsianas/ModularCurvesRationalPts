...
// Magma code for modular curve with label 60.144.5.ov.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.805

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[21, 35, 2, 37], [23, 25, 36, 29], [27, 20, 34, 53]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.u.2", "60.72.1.bx.2", "60.72.1.co.1", "60.72.1.dv.2", "60.72.3.ra.2", "60.72.3.ro.1", "60.72.3.yz.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.ov.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
