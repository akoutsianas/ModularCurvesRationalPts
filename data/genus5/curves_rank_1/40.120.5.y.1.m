...
// Magma code for modular curve with label 40.120.5.y.1

// Other names and/or labels
// Cummins-Pauli label: 20E5
// Rouse-Sutherland-Zureick-Brown label: 40.120.5.157

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 20, 22, 37], [5, 33, 12, 17], [31, 14, 28, 19], [39, 22, 18, 17], [39, 22, 18, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.3.b.1", "40.60.2.a.1", "40.60.2.l.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.120.5.y.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
