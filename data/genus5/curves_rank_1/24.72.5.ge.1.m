...
// Magma code for modular curve with label 24.72.5.ge.1

// Other names and/or labels
// Cummins-Pauli label: 24B5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.260

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 17, 16, 7], [9, 23, 4, 3], [11, 13, 4, 1], [17, 5, 20, 7], [23, 15, 6, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.24.1.bo.1", "24.36.1.fy.1", "24.36.1.gi.1", "24.36.3.c.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.5.ge.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
