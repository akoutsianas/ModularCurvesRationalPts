...
// Magma code for modular curve with label 48.96.5.fi.1

// Other names and/or labels
// Cummins-Pauli label: 16C5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.651

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 7, 6, 1], [17, 34, 44, 39], [31, 26, 4, 7], [31, 42, 20, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.v.1", "48.48.1.l.1", "48.48.3.bb.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.fi.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+z);
//   Coordinate number 1:
