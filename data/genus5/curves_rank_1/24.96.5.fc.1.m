...
// Magma code for modular curve with label 24.96.5.fc.1

// Other names and/or labels
// Cummins-Pauli label: 12A5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.151

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 3, 3, 16], [7, 18, 9, 5], [10, 3, 3, 22], [11, 15, 15, 10]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["12.48.3.o.1", "24.24.1.ci.1", "24.32.1.d.1", "24.48.1.mi.1", "24.48.3.cd.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.fc.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
