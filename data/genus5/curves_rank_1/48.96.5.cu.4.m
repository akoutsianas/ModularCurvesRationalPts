...
// Magma code for modular curve with label 48.96.5.cu.4

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.635

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 18, 20, 13], [35, 23, 42, 47], [41, 27, 18, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.i.1", "24.48.1.ca.2", "48.48.1.ip.1", "48.48.1.is.2", "48.48.3.i.1", "48.48.3.br.1", "48.48.3.bw.2"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.cu.4
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
