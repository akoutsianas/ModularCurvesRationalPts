...
// Magma code for modular curve with label 24.144.5.fi.1

// Other names and/or labels
// Cummins-Pauli label: 24R5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1026

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 21, 0, 1], [9, 10, 20, 21], [9, 11, 4, 9], [11, 15, 0, 7], [13, 3, 0, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.v.1", "24.72.3.pj.1", "24.72.3.pm.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.fi.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
