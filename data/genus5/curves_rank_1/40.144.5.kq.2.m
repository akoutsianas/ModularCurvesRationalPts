...
// Magma code for modular curve with label 40.144.5.kq.2

// Other names and/or labels
// Cummins-Pauli label: 20J5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.468

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[15, 26, 34, 37], [19, 3, 8, 29], [23, 20, 2, 21], [25, 37, 22, 15], [37, 32, 10, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.bq.1", "40.72.1.cq.2", "40.72.3.fm.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.kq.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
