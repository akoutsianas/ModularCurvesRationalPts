...
// Magma code for modular curve with label 48.96.5.fj.1

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.105

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[15, 47, 34, 39], [41, 20, 32, 33], [43, 38, 32, 21], [43, 42, 0, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.bi.1", "48.48.1.hg.2", "48.48.1.hi.1", "48.48.3.v.1", "48.48.3.ba.1", "48.48.3.et.1", "48.48.3.ev.2"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.fj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
