...
// Magma code for modular curve with label 60.72.5.ee.2

// Other names and/or labels
// Cummins-Pauli label: 30G5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.65

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[4, 15, 33, 28], [17, 10, 41, 59], [33, 10, 25, 3], [43, 45, 9, 8]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["15.36.2.b.2", "60.36.1.fz.1", "60.36.2.fv.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.72.5.ee.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
