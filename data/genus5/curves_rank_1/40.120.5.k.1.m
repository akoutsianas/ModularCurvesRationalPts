...
// Magma code for modular curve with label 40.120.5.k.1

// Other names and/or labels
// Cummins-Pauli label: 10B5
// Rouse-Sutherland-Zureick-Brown label: 40.120.5.120

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 26, 34, 21], [27, 22, 18, 15], [33, 5, 32, 37], [35, 12, 32, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.2.i.1", "40.40.1.f.1", "40.60.2.b.1", "40.60.3.a.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.120.5.k.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
