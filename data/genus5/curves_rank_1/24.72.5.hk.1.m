...
// Magma code for modular curve with label 24.72.5.hk.1

// Other names and/or labels
// Cummins-Pauli label: 24D5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.271

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 20, 16, 1], [5, 9, 6, 5], [7, 11, 14, 23], [7, 23, 10, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.0.bs.1", "24.36.2.gh.1", "24.36.3.a.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.5.hk.1
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
