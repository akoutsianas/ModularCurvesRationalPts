...
// Magma code for modular curve with label 60.144.5.fo.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.499

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 20, 44, 9], [19, 15, 4, 11], [29, 40, 44, 9], [53, 45, 50, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.d.2", "30.72.1.i.1", "60.72.1.dj.1", "60.72.3.fc.1", "60.72.3.ht.1", "60.72.3.re.2", "60.72.3.xw.2"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.fo.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
