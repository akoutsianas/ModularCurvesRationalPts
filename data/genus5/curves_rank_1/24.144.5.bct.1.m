...
// Magma code for modular curve with label 24.144.5.bct.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1086

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 1, 16, 7], [13, 19, 2, 7], [17, 11, 4, 11], [19, 16, 8, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.fc.1", "24.72.2.co.1", "24.72.2.dx.1", "24.72.2.hb.1", "24.72.2.ia.1", "24.72.3.bfy.1", "24.72.3.bgr.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.bct.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
