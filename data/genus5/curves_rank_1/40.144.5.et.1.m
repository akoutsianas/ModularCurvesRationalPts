...
// Magma code for modular curve with label 40.144.5.et.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.576

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 32, 26, 15], [25, 29, 32, 17], [33, 14, 4, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.bj.2", "40.72.1.q.2", "40.72.1.bb.1", "40.72.1.ce.1", "40.72.3.bm.1", "40.72.3.cj.1", "40.72.3.cx.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.et.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+z);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
