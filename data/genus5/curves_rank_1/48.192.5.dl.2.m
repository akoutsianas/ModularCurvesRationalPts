...
// Magma code for modular curve with label 48.192.5.dl.2

// Other names and/or labels
// Cummins-Pauli label: 16O5
// Rouse-Sutherland-Zureick-Brown label: 48.192.5.1333

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[15, 44, 32, 19], [23, 8, 16, 9], [25, 42, 8, 17], [31, 4, 8, 33], [47, 6, 24, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["16.96.2.e.2", "24.96.1.ch.2", "48.96.2.f.2"];
...
// Map from the canonical model to the plane model of modular curve with label 48.192.5.dl.2
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
