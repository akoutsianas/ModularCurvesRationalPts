...
// Magma code for modular curve with label 24.96.5.fv.1

// Other names and/or labels
// Cummins-Pauli label: 24I5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.196

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 6, 0, 5], [5, 4, 12, 1], [7, 11, 6, 19], [7, 18, 0, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.24.1.eh.1", "24.48.1.jd.1", "24.48.3.bt.1", "24.48.3.cn.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.fv.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
