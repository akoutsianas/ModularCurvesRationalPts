...
// Magma code for modular curve with label 40.144.5.bf.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.366

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 6, 20, 17], [7, 16, 28, 15], [23, 35, 20, 23], [29, 38, 8, 39], [33, 28, 12, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.t.1", "40.72.1.f.1", "40.72.1.s.1", "40.72.1.cm.1", "40.72.3.h.1", "40.72.3.l.1", "40.72.3.er.1"];
...
// Canonical model
model_0 := [x^2-2*y*z+2*w^2+t^2,x^2+y^2+y*z+z^2-y*w+z*w+2*w^2+t^2,4*x^2-y^2-y*z-z^2-y*w+z*w-t^2];
...
//   Coordinate number 0:
map_0_coord_0 := 1*(56623104*y*w^17+141557760*y*w^15*t^2-147456000*y*w^13*t^4-905216000*y*w^11*t^6-1356800000*y*w^9*t^8-1036800000*y*w^7*t^10-442000000*y*w^5*t^12-100000000*y*w^3*t^14-9375000*y*w*t^16-56623104*z*w^17-141557760*z*w^15*t^2+147456000*z*w^13*t^4+905216000*z*w^11*t^6+1356800000*z*w^9*t^8+1036800000*z*w^7*t^10+442000000*z*w^5*t^12+100000000*z*w^3*t^14+9375000*z*w*t^16-622854144*w^18-3963617280*w^16*t^2-10469376000*w^14*t^4-14985216000*w^12*t^6-12718080000*w^10*t^8-6547200000*w^8*t^10-1974000000*w^6*t^12-300000000*w^4*t^14-9375000*w^2*t^16+1953125*t^18);
//   Coordinate number 1:
map_0_coord_1 := 2^5*(w^10*(8*w^2+5*t^2)^2*(16*y*w^3+20*y*w*t^2-16*z*w^3-20*z*w*t^2-176*w^4-150*w^2*t^2-25*t^4));

// Map from the canonical model to the plane model of modular curve with label 40.144.5.bf.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(1/2*x+1/2*t);
//   Coordinate number 2:
map_1_coord_2 := 1*(z);
// Codomain equation:
