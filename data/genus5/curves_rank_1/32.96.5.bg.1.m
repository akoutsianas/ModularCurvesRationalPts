...
// Magma code for modular curve with label 32.96.5.bg.1

// Other names and/or labels
// Cummins-Pauli label: 32D5
// Rouse-Sutherland-Zureick-Brown label: 32.96.5.27

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 9, 8, 3], [21, 5, 0, 7], [21, 23, 0, 27], [25, 14, 8, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.x.1", "32.48.3.d.1", "32.48.3.e.1"];
...
// Map from the canonical model to the plane model of modular curve with label 32.96.5.bg.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
