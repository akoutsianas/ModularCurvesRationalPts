...
// Magma code for modular curve with label 24.144.5.qh.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.859

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 18, 0, 17], [11, 11, 20, 1], [19, 7, 2, 1], [19, 13, 22, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.dj.1", "24.72.2.bv.1", "24.72.2.ce.1", "24.72.2.gg.1", "24.72.2.gp.1", "24.72.3.bhn.1", "24.72.3.bhu.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.qh.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
