...
// Magma code for modular curve with label 40.144.5.dh.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.488

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 19, 28, 23], [27, 15, 26, 11], [29, 9, 26, 37], [29, 24, 10, 13], [39, 0, 0, 39]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.i.1", "40.72.1.g.2", "40.72.1.bs.1", "40.72.1.cc.1", "40.72.3.be.1", "40.72.3.dn.2", "40.72.3.el.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.dh.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
