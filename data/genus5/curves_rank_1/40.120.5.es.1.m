...
// Magma code for modular curve with label 40.120.5.es.1

// Other names and/or labels
// Cummins-Pauli label: 20E5
// Rouse-Sutherland-Zureick-Brown label: 40.120.5.97

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 19, 14, 35], [11, 25, 0, 11], [17, 32, 8, 15], [37, 13, 32, 39]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.2.g.1", "40.60.2.d.1", "40.60.3.bq.1"];
...
// Canonical model
model_0 := [5*x*w+y*t,10*x^2+5*y^2-2*z^2-2*z*w+2*w^2,10*y^2+10*z^2-10*z*w+5*w^2+2*t^2];
...
// Map from the canonical model to the plane model of modular curve with label 40.120.5.es.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
