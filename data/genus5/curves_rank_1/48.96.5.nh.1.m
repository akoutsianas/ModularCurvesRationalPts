...
// Magma code for modular curve with label 48.96.5.nh.1

// Other names and/or labels
// Cummins-Pauli label: 16H5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.314

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 28, 18, 1], [29, 21, 34, 11], [31, 29, 16, 1], [35, 43, 44, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.bn.1", "48.48.2.bc.1", "48.48.3.dd.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.nh.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
