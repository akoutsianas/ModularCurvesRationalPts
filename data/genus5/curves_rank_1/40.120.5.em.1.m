...
// Magma code for modular curve with label 40.120.5.em.1

// Other names and/or labels
// Cummins-Pauli label: 10B5
// Rouse-Sutherland-Zureick-Brown label: 40.120.5.118

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 27, 8, 7], [27, 10, 8, 13], [29, 32, 18, 31], [35, 26, 14, 39]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.2.i.1", "40.40.1.bs.1", "40.60.2.c.1", "40.60.3.bp.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.120.5.em.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
