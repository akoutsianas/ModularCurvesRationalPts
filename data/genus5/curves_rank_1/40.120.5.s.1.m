...
// Magma code for modular curve with label 40.120.5.s.1

// Other names and/or labels
// Cummins-Pauli label: 10B5
// Rouse-Sutherland-Zureick-Brown label: 40.120.5.166

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[15, 33, 8, 5], [15, 36, 16, 35], [25, 7, 2, 25], [37, 13, 6, 33], [39, 20, 20, 39]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.3.a.1", "40.40.1.v.1", "40.60.2.d.1", "40.60.2.j.1"];
...
// Canonical model
model_0 := [5*x^2-x*y+2*x*z-3*y*z+z^2+3*w*t+2*t^2,2*x*y+6*y*z-w^2-2*w*t,2*x^2+x*y-8*x*z+5*y^2+3*y*z-2*z^2+2*w^2-w*t];
...
// Map from the canonical model to the plane model of modular curve with label 40.120.5.s.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
