...
// Magma code for modular curve with label 40.120.5.do.1

// Other names and/or labels
// Cummins-Pauli label: 10B5
// Rouse-Sutherland-Zureick-Brown label: 40.120.5.125

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 3, 12, 19], [15, 19, 14, 25], [31, 19, 38, 39], [39, 23, 4, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.2.f.1", "40.40.1.bg.1", "40.60.2.a.1", "40.60.3.bp.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.120.5.do.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
