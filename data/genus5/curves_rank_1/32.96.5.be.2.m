...
// Magma code for modular curve with label 32.96.5.be.2

// Other names and/or labels
// Cummins-Pauli label: 32D5
// Rouse-Sutherland-Zureick-Brown label: 32.96.5.35

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 14, 8, 1], [13, 5, 16, 15], [13, 18, 24, 23], [23, 4, 24, 17], [29, 20, 0, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.v.2", "32.48.3.d.2", "32.48.3.e.1"];
...
// Map from the canonical model to the plane model of modular curve with label 32.96.5.be.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
