...
// Magma code for modular curve with label 24.192.5.fl.1

// Other names and/or labels
// Cummins-Pauli label: 24Z5
// Rouse-Sutherland-Zureick-Brown label: 24.192.5.2011

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 3, 0, 23], [19, 7, 0, 5], [19, 18, 12, 7], [23, 17, 12, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["24.96.1.cz.1", "24.96.1.dj.4", "24.96.1.ds.4", "24.96.3.fo.1", "24.96.3.ft.1", "24.96.3.go.1", "24.96.3.gx.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.192.5.fl.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
