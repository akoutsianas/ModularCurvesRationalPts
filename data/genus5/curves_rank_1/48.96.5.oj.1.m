...
// Magma code for modular curve with label 48.96.5.oj.1

// Other names and/or labels
// Cummins-Pauli label: 16H5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.336

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 39, 44, 41], [19, 8, 42, 29], [21, 16, 14, 35], [21, 26, 10, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.bs.1", "48.48.2.bm.1", "48.48.3.dd.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.oj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
