...
// Magma code for modular curve with label 24.96.5.eb.1

// Other names and/or labels
// Cummins-Pauli label: 24K5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.216

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 12, 4, 7], [11, 21, 12, 17], [13, 12, 12, 17], [17, 18, 22, 11], [19, 12, 2, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.24.1.cz.1", "24.48.2.h.1", "24.48.2.o.1", "24.48.3.bv.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.eb.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
