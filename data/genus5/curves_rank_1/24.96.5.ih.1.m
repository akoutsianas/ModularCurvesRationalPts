...
// Magma code for modular curve with label 24.96.5.ih.1

// Other names and/or labels
// Cummins-Pauli label: 24J5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.181

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 14, 6, 7], [17, 23, 0, 19], [23, 14, 18, 5], [23, 19, 18, 17], [23, 23, 12, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.24.0.ez.1", "24.48.2.o.1", "24.48.2.q.1", "24.48.3.co.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.ih.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
