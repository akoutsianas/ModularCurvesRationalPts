...
// Magma code for modular curve with label 40.144.5.ft.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.451

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 2, 4, 9], [31, 31, 20, 27], [31, 35, 38, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.v.1", "40.72.1.x.1", "40.72.1.z.2", "40.72.1.bw.2", "40.72.3.br.1", "40.72.3.cp.2", "40.72.3.ei.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.ft.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
