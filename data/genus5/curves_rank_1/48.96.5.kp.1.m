...
// Magma code for modular curve with label 48.96.5.kp.1

// Other names and/or labels
// Cummins-Pauli label: 16B5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.487

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 32, 2, 41], [17, 17, 18, 23], [23, 34, 40, 3], [29, 40, 8, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.bx.1", "24.48.1.ma.1", "48.48.1.hz.1", "48.48.1.ie.1", "48.48.3.bo.2", "48.48.3.ci.1", "48.48.3.ea.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.kp.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
