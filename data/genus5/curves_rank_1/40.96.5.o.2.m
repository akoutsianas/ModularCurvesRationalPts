...
// Magma code for modular curve with label 40.96.5.o.2

// Other names and/or labels
// Cummins-Pauli label: 20D5
// Rouse-Sutherland-Zureick-Brown label: 40.96.5.2

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 34, 17, 31], [10, 37, 33, 34], [19, 23, 35, 12]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["20.48.1.b.2", "40.24.1.ck.2", "40.48.3.g.1", "40.48.3.i.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.96.5.o.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
