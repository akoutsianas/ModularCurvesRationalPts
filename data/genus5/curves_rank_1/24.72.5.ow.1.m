...
// Magma code for modular curve with label 24.72.5.ow.1

// Other names and/or labels
// Cummins-Pauli label: 24A5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.194

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 17, 20, 9], [5, 18, 12, 5], [11, 7, 14, 5], [11, 16, 10, 13], [23, 16, 4, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.bw.1", "24.24.1.ek.1", "24.36.0.cj.1", "24.36.3.g.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.5.ow.1
//   Coordinate number 0:
map_1_coord_0 := 1*(v);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.5.ow.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-w);
//   Coordinate number 1:
map_2_coord_1 := 1*(-2*w^6-3/16*v*r^5);
//   Coordinate number 2:
