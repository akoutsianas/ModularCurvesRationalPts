...
// Magma code for modular curve with label 40.144.5.jy.2

// Other names and/or labels
// Cummins-Pauli label: 40N5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.202

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 34, 0, 31], [19, 17, 28, 33], [25, 6, 12, 29], [31, 36, 10, 17], [35, 19, 16, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.u.2", "40.72.3.fc.1", "40.72.3.fp.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.jy.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
