...
// Magma code for modular curve with label 60.72.5.ec.1

// Other names and/or labels
// Cummins-Pauli label: 30G5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.153

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[8, 5, 17, 13], [23, 15, 3, 34], [37, 45, 42, 37], [48, 5, 41, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["30.36.2.a.1", "60.36.1.fz.1", "60.36.2.fs.2"];
...
// Map from the canonical model to the plane model of modular curve with label 60.72.5.ec.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
