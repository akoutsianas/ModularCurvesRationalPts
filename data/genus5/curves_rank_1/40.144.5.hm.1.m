...
// Magma code for modular curve with label 40.144.5.hm.1

// Other names and/or labels
// Cummins-Pauli label: 40M5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.607

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 27, 36, 3], [19, 13, 36, 11], [21, 8, 28, 1], [23, 21, 4, 35], [23, 29, 24, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["40.72.1.v.1", "40.72.3.cd.1", "40.72.3.ce.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.hm.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
