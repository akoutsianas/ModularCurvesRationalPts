...
// Magma code for modular curve with label 24.144.5.jx.1

// Other names and/or labels
// Cummins-Pauli label: 24U5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1001

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 10, 16, 15], [3, 19, 16, 21], [9, 1, 8, 15], [13, 0, 18, 11], [13, 18, 18, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.cq.1", "24.72.3.yv.1", "24.72.3.bar.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.jx.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
