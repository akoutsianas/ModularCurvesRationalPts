...
// Magma code for modular curve with label 60.144.5.rk.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.85

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[33, 14, 31, 39], [33, 14, 50, 27], [33, 28, 11, 15], [41, 12, 51, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.1.v.1", "30.72.1.k.1", "60.72.1.cu.1", "60.72.3.ua.1", "60.72.3.ue.1", "60.72.3.uk.1", "60.72.3.uy.1"];
...
// Canonical model
model_0 := [x^2-x*y-y^2+z^2,x^2-x*y-y^2-2*z^2-x*w+w^2+x*t-t^2,2*x^2+2*x*y+2*y^2+z^2-x*w+2*w*t-t^2];

// Singular plane model
model_1 := [9*x^8+45*x^6*y^2+25*x^4*y^4+6*x^6*z^2+40*x^4*y^2*z^2-5*x^4*z^4-15*x^2*y^2*z^4-2*x^2*z^6+z^8];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.rk.1
//   Coordinate number 0:
...
map_1_coord_2 := 1*(3*z);
// Codomain equation:
map_1_codomain := [9*x^8+45*x^6*y^2+25*x^4*y^4+6*x^6*z^2+40*x^4*y^2*z^2-5*x^4*z^4-15*x^2*y^2*z^4-2*x^2*z^6+z^8];
