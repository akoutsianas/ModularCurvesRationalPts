...
// Magma code for modular curve with label 60.144.5.lo.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.139

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 18, 57, 55], [11, 18, 18, 31], [33, 10, 49, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.1.k.1", "60.72.1.bh.1", "60.72.1.et.1", "60.72.3.nr.1", "60.72.3.od.1", "60.72.3.pt.1", "60.72.3.uq.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.lo.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
