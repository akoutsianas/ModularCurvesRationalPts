...
// Magma code for modular curve with label 40.96.5.c.1

// Other names and/or labels
// Cummins-Pauli label: 20D5
// Rouse-Sutherland-Zureick-Brown label: 40.96.5.6

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 29, 19, 10], [6, 17, 7, 26], [39, 35, 17, 2]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["20.48.1.b.1", "40.24.1.by.1", "40.48.3.e.1", "40.48.3.i.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.96.5.c.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
