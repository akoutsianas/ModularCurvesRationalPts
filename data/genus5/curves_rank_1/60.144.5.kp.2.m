...
// Magma code for modular curve with label 60.144.5.kp.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.729

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 55, 20, 57], [21, 35, 8, 27], [31, 50, 48, 41], [49, 20, 54, 43]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.bg.1", "60.72.1.y.1", "60.72.1.cf.2", "60.72.1.do.2", "60.72.3.nd.2", "60.72.3.or.1", "60.72.3.qy.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.kp.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
