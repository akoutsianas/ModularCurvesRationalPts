...
// Magma code for modular curve with label 24.144.5.bga.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1139

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 18, 0, 5], [11, 16, 2, 5], [13, 17, 10, 19], [21, 22, 2, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.fa.1", "24.72.2.de.1", "24.72.2.dn.1", "24.72.2.im.1", "24.72.2.jk.1", "24.72.3.bgu.1", "24.72.3.bhs.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.bga.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
