...
// Magma code for modular curve with label 24.144.5.ew.1

// Other names and/or labels
// Cummins-Pauli label: 24R5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1018

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 11, 20, 3], [7, 6, 0, 5], [7, 21, 12, 19], [9, 22, 8, 15], [11, 6, 12, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.s.1", "24.72.3.pe.1", "24.72.3.pm.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.ew.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
