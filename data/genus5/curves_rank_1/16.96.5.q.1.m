...
// Magma code for modular curve with label 16.96.5.q.1

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 16.96.5.20

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 4, 0, 5], [9, 6, 8, 3], [11, 0, 4, 13], [13, 6, 4, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.i.1", "16.48.3.e.2", "16.48.3.f.1"];
...
// Map from the canonical model to the plane model of modular curve with label 16.96.5.q.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
