...
// Magma code for modular curve with label 24.144.5.io.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.645

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 15, 12, 13], [13, 18, 12, 23], [15, 17, 2, 21], [23, 21, 0, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.3.cq.1", "24.72.1.bg.1", "24.72.1.bu.1", "24.72.1.cl.1", "24.72.3.tu.1", "24.72.3.ue.1", "24.72.3.vb.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.io.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
