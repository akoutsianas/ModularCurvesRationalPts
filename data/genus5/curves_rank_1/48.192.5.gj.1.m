...
// Magma code for modular curve with label 48.192.5.gj.1

// Other names and/or labels
// Cummins-Pauli label: 16M5
// Rouse-Sutherland-Zureick-Brown label: 48.192.5.2555

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 42, 10, 31], [15, 34, 38, 9], [31, 11, 22, 1], [37, 29, 2, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["16.96.3.bu.1", "48.96.1.be.1", "48.96.3.eu.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.192.5.gj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
