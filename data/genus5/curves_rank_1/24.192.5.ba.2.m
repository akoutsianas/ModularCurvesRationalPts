...
// Magma code for modular curve with label 24.192.5.ba.2

// Other names and/or labels
// Cummins-Pauli label: 8A5
// Rouse-Sutherland-Zureick-Brown label: 24.192.5.97

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 16, 4, 3], [5, 16, 4, 21], [5, 16, 12, 19], [19, 16, 16, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["8.96.3.h.1", "24.96.1.o.2", "24.96.1.q.2", "24.96.1.r.1", "24.96.3.m.2", "24.96.3.r.1", "24.96.3.w.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.192.5.ba.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
