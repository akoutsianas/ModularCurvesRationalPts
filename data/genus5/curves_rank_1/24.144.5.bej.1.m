...
// Magma code for modular curve with label 24.144.5.bej.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1073

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 5, 22, 19], [5, 22, 14, 23], [21, 13, 22, 3], [23, 12, 6, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.ey.1", "24.72.2.ct.1", "24.72.2.dg.1", "24.72.2.ht.1", "24.72.2.ir.1", "24.72.3.bgj.1", "24.72.3.bhh.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.bej.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
