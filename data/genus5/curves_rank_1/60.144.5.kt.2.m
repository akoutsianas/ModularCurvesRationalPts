...
// Magma code for modular curve with label 60.144.5.kt.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.728

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[21, 55, 8, 33], [49, 30, 52, 31], [49, 40, 4, 41], [59, 20, 46, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.bg.1", "30.72.1.i.2", "60.72.1.ba.1", "60.72.1.dp.2", "60.72.3.nf.2", "60.72.3.ot.1", "60.72.3.qw.1"];
...
model_1 := [202500*x^8+6750*x^7*y+1125*x^6*y^2+60*x^5*y^3+x^4*y^4+114750*x^6*z^2+4050*x^5*y*z^2+240*x^4*y^2*z^2+4*x^3*y^3*z^2+21825*x^4*z^4+150*x^3*y*z^4+x^2*y^2*z^4+2070*x^2*z^6-6*x*y*z^6+96*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.kt.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x-y);
//   Coordinate number 1:
...
map_1_coord_2 := 1*(t);
// Codomain equation:
map_1_codomain := [202500*x^8+6750*x^7*y+1125*x^6*y^2+60*x^5*y^3+x^4*y^4+114750*x^6*z^2+4050*x^5*y*z^2+240*x^4*y^2*z^2+4*x^3*y^3*z^2+21825*x^4*z^4+150*x^3*y*z^4+x^2*y^2*z^4+2070*x^2*z^6-6*x*y*z^6+96*z^8];
