...
// Magma code for modular curve with label 40.144.5.lu.2

// Other names and/or labels
// Cummins-Pauli label: 40N5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.161

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 9, 32, 25], [21, 0, 10, 31], [25, 14, 34, 35], [33, 5, 32, 11], [39, 2, 26, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.v.2", "40.72.3.fo.1", "40.72.3.fq.1"];
...
//   Coordinate number 0:
map_0_coord_0 := 1*(10*x-y-5*z+2*w);
//   Coordinate number 1:
map_0_coord_1 := 1*(-2*y+4*w);
//   Coordinate number 2:
map_0_coord_2 := 1*(10*x+y+5*z-2*w);
// Codomain equation:
map_0_codomain := [y^4-x^3*z+2*x^2*y*z+2*x*y^2*z-2*x^2*z^2-2*x*y*z^2-x*z^3];

// Map from the canonical model to the plane model of modular curve with label 40.144.5.lu.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
