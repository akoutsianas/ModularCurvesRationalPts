...
// Magma code for modular curve with label 40.120.5.l.1

// Other names and/or labels
// Cummins-Pauli label: 10B5
// Rouse-Sutherland-Zureick-Brown label: 40.120.5.37

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 27, 32, 25], [13, 11, 8, 17], [29, 10, 10, 9], [37, 24, 36, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["10.60.2.e.1", "40.40.1.c.1", "40.60.2.a.1", "40.60.3.a.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.120.5.l.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
