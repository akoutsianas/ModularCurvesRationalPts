...
// Magma code for modular curve with label 48.144.5.ds.1

// Other names and/or labels
// Cummins-Pauli label: 48F5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.68

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 12, 24, 13], [7, 30, 36, 47], [21, 1, 14, 33], [33, 17, 14, 39], [35, 32, 4, 41]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['3.3.0.a.1', '16.48.1.ci.2']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["16.48.1.ci.2", "24.72.2.hi.2", "48.72.0.c.2", "48.72.3.q.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.ds.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*r);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.ds.1
//   Coordinate number 0:
map_2_coord_0 := 1*(t);
//   Coordinate number 1:
