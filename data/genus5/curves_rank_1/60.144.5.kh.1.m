...
// Magma code for modular curve with label 60.144.5.kh.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.712

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 10, 32, 9], [37, 5, 56, 51], [49, 55, 42, 11], [53, 55, 0, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.bg.2", "30.72.1.d.1", "60.72.1.cj.2", "60.72.1.dp.2", "60.72.3.mz.1", "60.72.3.on.1", "60.72.3.rc.2"];
...
model_1 := [81*x^8+270*x^6*z^2+45*x^4*y^2*z^2+315*x^4*z^4+120*x^2*y^2*z^4+25*y^4*z^4+150*x^2*z^6+25*y^2*z^6+25*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.kh.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Codomain equation:
map_1_codomain := [81*x^8+270*x^6*z^2+45*x^4*y^2*z^2+315*x^4*z^4+120*x^2*y^2*z^4+25*y^4*z^4+150*x^2*z^6+25*y^2*z^6+25*z^8];
