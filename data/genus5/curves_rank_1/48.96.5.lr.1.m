...
// Magma code for modular curve with label 48.96.5.lr.1

// Other names and/or labels
// Cummins-Pauli label: 16E5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.494

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 13, 4, 31], [27, 41, 22, 29], [47, 1, 38, 41], [47, 46, 16, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.bx.1", "48.48.1.gc.1", "48.48.1.gd.1"];
...
model_1 := [648*x^8+72*x^4*y^4+648*x^6*z^2+225*x^4*z^4+30*x^2*z^6+z^8];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.lr.1
//   Coordinate number 0:
...
map_1_coord_2 := 1*(z);
// Codomain equation:
map_1_codomain := [648*x^8+72*x^4*y^4+648*x^6*z^2+225*x^4*z^4+30*x^2*z^6+z^8];
