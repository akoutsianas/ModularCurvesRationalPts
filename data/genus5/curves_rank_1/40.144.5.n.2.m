...
// Magma code for modular curve with label 40.144.5.n.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.398

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 34, 0, 37], [11, 30, 30, 29], [11, 36, 20, 19], [13, 30, 30, 9], [31, 26, 0, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.c.1", "40.72.1.a.2", "40.72.1.bk.1", "40.72.1.ch.1", "40.72.3.f.2", "40.72.3.dj.1", "40.72.3.em.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.n.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
