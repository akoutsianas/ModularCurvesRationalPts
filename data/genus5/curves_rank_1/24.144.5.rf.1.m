...
// Magma code for modular curve with label 24.144.5.rf.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.975

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 4, 20, 7], [23, 1, 8, 5], [23, 2, 14, 13], [23, 16, 10, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.dt.1", "24.72.2.cm.1", "24.72.2.dl.1", "24.72.2.ep.1", "24.72.2.gf.1", "24.72.3.bcp.1", "24.72.3.bef.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.rf.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*z);
