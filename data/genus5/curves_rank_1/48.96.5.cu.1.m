...
// Magma code for modular curve with label 48.96.5.cu.1

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.633

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 3, 42, 25], [15, 10, 32, 13], [25, 39, 18, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.i.2", "24.48.1.ca.1", "48.48.1.ip.2", "48.48.1.is.1", "48.48.3.i.1", "48.48.3.br.2", "48.48.3.bw.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.cu.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
