...
// Magma code for modular curve with label 32.96.5.be.1

// Other names and/or labels
// Cummins-Pauli label: 32D5
// Rouse-Sutherland-Zureick-Brown label: 32.96.5.24

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 6, 16, 1], [11, 1, 8, 11], [11, 17, 8, 29], [27, 21, 24, 23], [31, 8, 16, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.v.1", "32.48.3.d.2", "32.48.3.e.2"];
...
// Map from the canonical model to the plane model of modular curve with label 32.96.5.be.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
