...
// Magma code for modular curve with label 56.96.5.bo.1

// Other names and/or labels
// Cummins-Pauli label: 56D5
// Rouse-Sutherland-Zureick-Brown label: 56.96.5.26

// Group data
level := 56;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 34, 2, 49], [16, 27, 47, 16], [22, 1, 7, 40], [42, 53, 23, 40], [51, 32, 44, 35], [55, 4, 26, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["28.48.2.c.1", "56.12.0.ba.1"];
...
// Map from the canonical model to the plane model of modular curve with label 56.96.5.bo.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
