...
// Magma code for modular curve with label 48.96.5.ol.1

// Other names and/or labels
// Cummins-Pauli label: 16H5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.333

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 1, 36, 47], [17, 2, 12, 37], [43, 17, 0, 37], [47, 4, 10, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.bu.1", "48.48.2.bk.1", "48.48.3.dd.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.ol.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
