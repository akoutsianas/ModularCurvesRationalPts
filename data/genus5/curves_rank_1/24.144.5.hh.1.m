...
// Magma code for modular curve with label 24.144.5.hh.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.146

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 5, 8, 9], [13, 15, 18, 17], [21, 10, 20, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.1.m.1", "24.72.1.w.1", "24.72.1.cb.1", "24.72.3.mt.1", "24.72.3.qi.1", "24.72.3.qs.1", "24.72.3.ti.1"];
...
// Canonical model
model_0 := [x^2+2*w^2+x*t+t^2,x^2-x*z+2*y*z-z^2+x*t+t^2,x^2+2*x*y-2*y^2+2*z^2];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.hh.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
