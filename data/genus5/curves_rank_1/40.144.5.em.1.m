...
// Magma code for modular curve with label 40.144.5.em.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.524

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 0, 4, 39], [17, 5, 26, 21], [29, 35, 16, 13], [37, 9, 6, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.q.1", "40.72.1.p.2", "40.72.1.bc.1", "40.72.1.cd.1", "40.72.3.bk.1", "40.72.3.cx.1", "40.72.3.eo.2"];
...
model_1 := [625*x^8+700*x^6*z^2-300*x^4*y^2*z^2+446*x^4*z^4-40*x^2*y^2*z^4+100*y^4*z^4+140*x^2*z^6-60*y^2*z^6+25*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.em.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
map_1_coord_2 := 1*(y);
// Codomain equation:
map_1_codomain := [625*x^8+700*x^6*z^2-300*x^4*y^2*z^2+446*x^4*z^4-40*x^2*y^2*z^4+100*y^4*z^4+140*x^2*z^6-60*y^2*z^6+25*z^8];
