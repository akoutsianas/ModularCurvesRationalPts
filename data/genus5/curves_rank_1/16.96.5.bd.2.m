...
// Magma code for modular curve with label 16.96.5.bd.2

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 16.96.5.112

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 3, 2, 1], [5, 10, 8, 7], [7, 14, 4, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.s.2", "16.48.1.ck.2", "16.48.1.cx.2", "16.48.3.i.2", "16.48.3.j.1", "16.48.3.bk.2", "16.48.3.bv.2"];
...
// Map from the canonical model to the plane model of modular curve with label 16.96.5.bd.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
