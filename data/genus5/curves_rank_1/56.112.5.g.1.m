...
// Magma code for modular curve with label 56.112.5.g.1

// Other names and/or labels
// Cummins-Pauli label: 14E5
// Rouse-Sutherland-Zureick-Brown label: 56.112.5.44

// Group data
level := 56;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 25, 32, 9], [9, 7, 31, 54], [13, 55, 41, 8], [51, 14, 49, 51]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 112;
...
covers := ["28.56.3.a.1", "56.56.1.a.1", "56.56.1.g.1"];
...
// Map from the canonical model to the plane model of modular curve with label 56.112.5.g.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
