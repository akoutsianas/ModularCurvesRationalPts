...
// Magma code for modular curve with label 24.72.5.kw.1

// Other names and/or labels
// Cummins-Pauli label: 24G5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.360

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 9, 0, 23], [13, 4, 22, 11], [13, 8, 16, 1], [15, 10, 4, 3], [21, 22, 22, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.ft.1", "24.36.1.ga.1", "24.36.3.g.1"];
...
model_1 := [972*x^8+4*x^4*y^4-1026*x^6*z^2-42*x^4*y^2*z^2+423*x^4*z^4+14*x^2*y^2*z^4-81*x^2*z^6+6*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.5.kw.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
...
// Codomain equation:
map_1_codomain := [972*x^8+4*x^4*y^4-1026*x^6*z^2-42*x^4*y^2*z^2+423*x^4*z^4+14*x^2*y^2*z^4-81*x^2*z^6+6*z^8];
