...
// Magma code for modular curve with label 24.144.5.bhb.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1090

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 22, 2, 7], [5, 13, 14, 23], [11, 20, 2, 13], [23, 6, 6, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.fc.1", "24.72.2.ea.1", "24.72.2.eg.1", "24.72.2.iq.1", "24.72.2.jf.1", "24.72.3.bhh.1", "24.72.3.bhu.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.bhb.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
