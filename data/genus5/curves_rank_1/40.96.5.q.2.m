...
// Magma code for modular curve with label 40.96.5.q.2

// Other names and/or labels
// Cummins-Pauli label: 20D5
// Rouse-Sutherland-Zureick-Brown label: 40.96.5.44

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[21, 7, 4, 39], [27, 1, 3, 0], [27, 7, 18, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["20.48.3.j.2", "40.24.1.cm.2", "40.48.1.kg.1", "40.48.3.g.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.96.5.q.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x-y);
//   Coordinate number 1:
