...
// Magma code for modular curve with label 60.144.5.ow.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.513

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 44, 47, 57], [13, 10, 44, 51], [35, 58, 12, 55], [41, 58, 59, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.i.2", "60.72.1.cj.1", "60.72.1.dz.2", "60.72.3.qp.2", "60.72.3.rj.2", "60.72.3.rp.1", "60.72.3.yu.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.ow.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
