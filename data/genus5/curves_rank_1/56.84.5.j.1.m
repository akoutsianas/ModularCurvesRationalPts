...
// Magma code for modular curve with label 56.84.5.j.1

// Other names and/or labels
// Cummins-Pauli label: 14B5
// Rouse-Sutherland-Zureick-Brown label: 56.84.5.43

// Group data
level := 56;
// Elements that, together with Gamma(level), generate the group
gens := [[22, 53, 25, 34], [29, 49, 10, 41], [33, 34, 27, 37], [55, 55, 19, 22]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 84;
...
covers := ["28.42.3.a.1", "56.42.1.b.1", "56.42.1.h.1"];
...
// Map from the canonical model to the plane model of modular curve with label 56.84.5.j.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
