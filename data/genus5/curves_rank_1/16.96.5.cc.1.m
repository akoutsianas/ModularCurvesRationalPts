...
// Magma code for modular curve with label 16.96.5.cc.1

// Other names and/or labels
// Cummins-Pauli label: 16C5
// Rouse-Sutherland-Zureick-Brown label: 16.96.5.133

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 6, 4, 1], [9, 3, 14, 15], [13, 8, 0, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.l.1", "16.48.3.v.1", "16.48.3.bb.1"];
...
// Canonical model
model_0 := [2*y*t-z^2+w^2,2*y^2+z^2+w^2+t^2,8*x^2-y*t-w^2-t^2];
...
// Map from the canonical model to the plane model of modular curve with label 16.96.5.cc.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+1/4*t);
//   Coordinate number 1:
map_1_coord_1 := 1*(1/4*z+1/4*w);
//   Coordinate number 2:
