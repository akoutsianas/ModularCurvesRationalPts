...
// Magma code for modular curve with label 24.96.5.hr.1

// Other names and/or labels
// Cummins-Pauli label: 24J5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.13

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 14, 6, 23], [5, 23, 0, 11], [11, 11, 0, 1], [11, 15, 0, 17], [13, 12, 6, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['3.4.0.a.1', '8.24.0.bj.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["8.24.0.bj.1", "24.48.2.i.1", "24.48.2.m.1", "24.48.3.cp.1"];
...
model_1 := [2*x^4*y^2+x^2*y^4-4*x^4*y*z-4*x^2*y^3*z-6*x^4*z^2-2*x^2*y^2*z^2+12*x^2*y*z^3-23*x^2*z^4+2*y^2*z^4-4*y*z^5-6*z^6];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.hr.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
...
map_1_coord_2 := 1*(y);
// Codomain equation:
map_1_codomain := [2*x^4*y^2+x^2*y^4-4*x^4*y*z-4*x^2*y^3*z-6*x^4*z^2-2*x^2*y^2*z^2+12*x^2*y*z^3-23*x^2*z^4+2*y^2*z^4-4*y*z^5-6*z^6];
