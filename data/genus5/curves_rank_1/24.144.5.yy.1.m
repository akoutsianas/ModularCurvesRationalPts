...
// Magma code for modular curve with label 24.144.5.yy.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.846

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 16, 22, 9], [19, 7, 14, 13], [21, 22, 8, 9], [23, 11, 2, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.ep.1", "24.72.2.r.1", "24.72.2.bw.1", "24.72.2.hw.1", "24.72.2.if.1", "24.72.3.bdd.1", "24.72.3.bdk.1"];
...
// Canonical model
model_0 := [x*t+z*w,x*z+w^2+t^2,x^2+x*z+6*y^2+z^2-w^2+4*w*t-t^2];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.yy.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
