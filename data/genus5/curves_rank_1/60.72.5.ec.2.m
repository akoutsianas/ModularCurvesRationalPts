...
// Magma code for modular curve with label 60.72.5.ec.2

// Other names and/or labels
// Cummins-Pauli label: 30G5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.145

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[37, 25, 46, 41], [43, 35, 13, 46], [44, 25, 31, 43], [47, 0, 9, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["30.36.2.a.2", "60.36.1.fz.1", "60.36.2.fs.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.72.5.ec.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
