...
// Magma code for modular curve with label 40.144.5.ds.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.356

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[15, 24, 16, 23], [21, 18, 20, 29], [21, 33, 0, 39], [23, 31, 34, 5], [33, 25, 34, 39], [35, 32, 24, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['5.12.0.a.2', '8.12.0.l.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["20.72.3.bm.1", "40.72.1.h.2", "40.72.1.t.1", "40.72.1.cq.1", "40.72.3.z.1", "40.72.3.bj.1", "40.72.3.cp.1"];
...
model_1 := [33*x^8+40*x^7*y+26*x^6*y^2+8*x^5*y^3+x^4*y^4-328*x^6*z^2-160*x^5*y*z^2-40*x^4*y^2*z^2+1304*x^4*z^4+160*x^3*y*z^4+40*x^2*y^2*z^4-3360*x^2*z^6+3600*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.ds.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x-y);
//   Coordinate number 1:
...
// Codomain equation:
map_1_codomain := [33*x^8+40*x^7*y+26*x^6*y^2+8*x^5*y^3+x^4*y^4-328*x^6*z^2-160*x^5*y*z^2-40*x^4*y^2*z^2+1304*x^4*z^4+160*x^3*y*z^4+40*x^2*y^2*z^4-3360*x^2*z^6+3600*z^8];
