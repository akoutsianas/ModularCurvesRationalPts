...
// Magma code for modular curve with label 30.60.5.i.1

// Other names and/or labels
// Cummins-Pauli label: 30B5
// Rouse-Sutherland-Zureick-Brown label: 30.60.5.16

// Group data
level := 30;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 7, 28, 15], [14, 25, 13, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["15.30.2.d.1", "30.12.1.e.1", "30.30.2.f.1", "30.30.3.b.1"];
...
// Canonical model
model_0 := [15*x*y+2*x*z-x*t+z*w+2*w*t,12*x^2-3*x*w+10*y*z-z^2+z*t+3*w^2+t^2,3*x^2+3*x*w-20*y^2-5*y*z-3*w^2];
...
// Map from the canonical model to the plane model of modular curve with label 30.60.5.i.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
