...
// Magma code for modular curve with label 24.144.5.bhn.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.886

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 1, 4, 23], [11, 18, 6, 17], [13, 21, 0, 11], [13, 23, 20, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.ff.1", "24.72.2.ef.1", "24.72.2.ei.1", "24.72.2.is.1", "24.72.2.jj.1", "24.72.3.bhf.1", "24.72.3.bhu.1"];
...
// Canonical model
model_0 := [x*w+y*z+y*w,x^2+x*y+y^2-z^2-4*z*w-w^2,x^2-2*x*y-2*y^2+2*z^2-4*z*w+2*w^2-2*t^2];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.bhn.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
