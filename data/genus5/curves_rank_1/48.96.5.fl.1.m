...
// Magma code for modular curve with label 48.96.5.fl.1

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.615

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 7, 34, 29], [11, 45, 6, 11], [21, 32, 20, 3], [27, 37, 14, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.w.1", "24.48.1.du.1", "48.48.1.ir.1", "48.48.1.it.2", "48.48.3.ba.1", "48.48.3.bu.2", "48.48.3.bw.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.fl.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
