...
// Magma code for modular curve with label 24.144.5.bgn.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.953

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 9, 6, 1], [11, 13, 8, 5], [11, 15, 12, 5], [21, 13, 22, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.ez.1", "24.72.2.dj.1", "24.72.2.dt.1", "24.72.2.hz.1", "24.72.2.jp.1", "24.72.3.bgl.1", "24.72.3.bib.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.bgn.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x-y);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*w);
