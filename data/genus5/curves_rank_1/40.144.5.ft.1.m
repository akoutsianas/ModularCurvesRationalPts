...
// Magma code for modular curve with label 40.144.5.ft.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.448

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 16, 14, 29], [21, 0, 2, 19], [33, 1, 10, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.v.2", "40.72.1.x.2", "40.72.1.z.1", "40.72.1.bw.1", "40.72.3.br.1", "40.72.3.cp.1", "40.72.3.ei.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.ft.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
