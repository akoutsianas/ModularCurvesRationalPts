...
// Magma code for modular curve with label 24.72.5.lf.1

// Other names and/or labels
// Cummins-Pauli label: 24G5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.337

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 4, 14, 15], [9, 17, 2, 15], [17, 18, 6, 19], [23, 3, 6, 5], [23, 5, 16, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fv.1", "24.36.1.gd.1", "24.36.3.g.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.5.lf.1
//   Coordinate number 0:
