...
// Magma code for modular curve with label 48.72.5.m.1

// Other names and/or labels
// Cummins-Pauli label: 48B5
// Rouse-Sutherland-Zureick-Brown label: 48.72.5.8

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 16, 40, 25], [9, 20, 8, 21], [11, 27, 0, 7], [29, 31, 32, 47], [33, 19, 40, 27], [35, 16, 40, 7], [35, 43, 8, 47]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
// Canonical model
model_0 := [x*z-x*w+y*t,9*x*y+2*z^2+2*z*w-t^2,12*x^2+3*y^2+z*t-w*t];

// Singular plane model
model_1 := [-4*x^7+4*x^5*y^2+24*x^4*y*z^2-x^3*y^4-36*x*y^2*z^4+3*y^5*z^2];
...
// Map from the canonical model to the plane model of modular curve with label 48.72.5.m.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
...
// Codomain equation:
map_1_codomain := [-4*x^7+4*x^5*y^2+24*x^4*y*z^2-x^3*y^4-36*x*y^2*z^4+3*y^5*z^2];
