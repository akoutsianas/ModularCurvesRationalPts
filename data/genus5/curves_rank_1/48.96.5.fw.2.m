...
// Magma code for modular curve with label 48.96.5.fw.2

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.624

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 47, 18, 5], [15, 1, 46, 21], [35, 14, 40, 5], [41, 16, 4, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.ba.1", "24.48.1.du.1", "48.48.1.hl.2", "48.48.1.hn.1", "48.48.3.v.2", "48.48.3.ey.1", "48.48.3.fa.2"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.fw.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
