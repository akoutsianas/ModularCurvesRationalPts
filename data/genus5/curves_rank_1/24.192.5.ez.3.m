...
// Magma code for modular curve with label 24.192.5.ez.3

// Other names and/or labels
// Cummins-Pauli label: 24Z5
// Rouse-Sutherland-Zureick-Brown label: 24.192.5.1587

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 3, 0, 13], [7, 3, 20, 7], [17, 9, 20, 17], [23, 21, 16, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["24.96.1.da.3", "24.96.1.df.1", "24.96.1.dn.1", "24.96.3.fa.1", "24.96.3.fr.2", "24.96.3.gm.4", "24.96.3.gu.4"];
...
model_1 := [592*x^8-672*x^7*y+312*x^6*y^2-72*x^5*y^3+9*x^4*y^4+1120*x^6*z^2-816*x^5*y*z^2+264*x^4*y^2*z^2-36*x^3*y^3*z^2+376*x^4*z^4-24*x^3*y*z^4-18*x^2*y^2*z^4-360*x^2*z^6+108*x*y*z^6-27*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 24.192.5.ez.3
//   Coordinate number 0:
...
map_1_coord_2 := 1*(t);
// Codomain equation:
map_1_codomain := [592*x^8-672*x^7*y+312*x^6*y^2-72*x^5*y^3+9*x^4*y^4+1120*x^6*z^2-816*x^5*y*z^2+264*x^4*y^2*z^2-36*x^3*y^3*z^2+376*x^4*z^4-24*x^3*y*z^4-18*x^2*y^2*z^4-360*x^2*z^6+108*x*y*z^6-27*z^8];
