...
// Magma code for modular curve with label 64.96.5.a.1

// Other names and/or labels
// Cummins-Pauli label: 64A5
// Rouse-Zureick-Brown label: X702
// Rouse-Sutherland-Zureick-Brown label: 64.96.5.7

// Group data
level := 64;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 26, 32, 7], [29, 16, 16, 19], [29, 48, 0, 17], [51, 33, 32, 41], [59, 22, 16, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
// Map from the canonical model to the plane model of modular curve with label 64.96.5.a.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*z);
