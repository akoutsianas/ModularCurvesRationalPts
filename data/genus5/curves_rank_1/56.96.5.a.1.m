...
// Magma code for modular curve with label 56.96.5.a.1

// Other names and/or labels
// Cummins-Pauli label: 28E5
// Rouse-Sutherland-Zureick-Brown label: 56.96.5.1

// Group data
level := 56;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 4, 34, 5], [21, 24, 50, 19], [45, 36, 52, 55], [53, 4, 32, 5], [53, 54, 18, 3], [55, 12, 18, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['7.8.0.a.1', '8.12.0.a.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["8.12.0.a.1", "14.48.2.a.1", "56.48.2.d.1", "56.48.3.d.1"];
...
// Canonical model
model_0 := [x*z+y*z-y*w+x*t,2*x*y-z^2+z*w-z*t-w*t,2*x^2+2*x*y+2*y^2+w*t];

// Singular plane model
model_1 := [4*x^4*y^2+x^5*z+10*x^3*y^2*z+4*x*y^4*z+2*x^4*z^2+16*x^2*y^2*z^2+3*x^3*z^3+10*x*y^2*z^3+2*x^2*z^4+4*y^2*z^4+x*z^5];
...
// Map from the canonical model to the plane model of modular curve with label 56.96.5.a.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
map_1_coord_2 := 1*(y);
// Codomain equation:
map_1_codomain := [4*x^4*y^2+x^5*z+10*x^3*y^2*z+4*x*y^4*z+2*x^4*z^2+16*x^2*y^2*z^2+3*x^3*z^3+10*x*y^2*z^3+2*x^2*z^4+4*y^2*z^4+x*z^5];
