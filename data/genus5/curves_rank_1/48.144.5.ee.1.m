...
// Magma code for modular curve with label 48.144.5.ee.1

// Other names and/or labels
// Cummins-Pauli label: 48F5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.738

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 0, 24, 43], [15, 7, 2, 33], [25, 42, 24, 35], [31, 23, 26, 29], [47, 19, 26, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.2.hj.2", "48.48.1.im.1", "48.72.0.c.2", "48.72.3.s.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.ee.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*u);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.ee.1
//   Coordinate number 0:
map_2_coord_0 := 1*(t);
//   Coordinate number 1:
