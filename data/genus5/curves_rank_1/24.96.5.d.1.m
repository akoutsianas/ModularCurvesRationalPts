...
// Magma code for modular curve with label 24.96.5.d.1

// Other names and/or labels
// Cummins-Pauli label: 24I5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.22

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 16, 12, 7], [7, 10, 0, 17], [7, 12, 12, 17], [13, 8, 0, 13], [17, 18, 0, 7], [17, 20, 12, 5], [19, 4, 12, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['3.4.0.a.1', '8.24.1.d.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["8.24.1.d.1", "12.48.1.b.1", "24.48.3.a.1", "24.48.3.cn.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.d.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
