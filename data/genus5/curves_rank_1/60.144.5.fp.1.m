...
// Magma code for modular curve with label 60.144.5.fp.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.622

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 55, 32, 1], [17, 20, 2, 7], [53, 0, 28, 49]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.e.2", "60.72.1.ce.1", "60.72.1.di.1", "60.72.3.fc.1", "60.72.3.hs.1", "60.72.3.rd.2", "60.72.3.xx.2"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.fp.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
