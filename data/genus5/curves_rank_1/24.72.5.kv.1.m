...
// Magma code for modular curve with label 24.72.5.kv.1

// Other names and/or labels
// Cummins-Pauli label: 24G5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.119

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 13, 20, 11], [7, 6, 6, 17], [19, 8, 14, 17], [21, 20, 4, 9], [23, 10, 16, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bx.1", "24.36.1.fs.1", "24.36.3.g.1"];
...
model_1 := [24*x^8+28*x^6*y^2+4*x^4*y^4+162*x^6*z^2+42*x^4*y^2*z^2+423*x^4*z^4+513*x^2*z^6+243*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.5.kv.1
//   Coordinate number 0:
...
map_1_coord_2 := 1*(w);
// Codomain equation:
map_1_codomain := [24*x^8+28*x^6*y^2+4*x^4*y^4+162*x^6*z^2+42*x^4*y^2*z^2+423*x^4*z^4+513*x^2*z^6+243*z^8];
