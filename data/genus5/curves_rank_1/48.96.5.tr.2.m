...
// Magma code for modular curve with label 48.96.5.tr.2

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.193

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 22, 28, 9], [37, 5, 6, 7], [41, 35, 26, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.cu.1", "24.48.1.ks.2", "48.48.1.in.2", "48.48.3.dp.1", "48.48.3.ep.1", "48.48.3.ey.1", "48.48.3.ga.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.tr.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
