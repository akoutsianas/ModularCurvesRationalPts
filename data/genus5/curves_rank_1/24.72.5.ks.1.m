...
// Magma code for modular curve with label 24.72.5.ks.1

// Other names and/or labels
// Cummins-Pauli label: 24B5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.65

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 19, 14, 21], [17, 9, 18, 11], [19, 7, 2, 1], [21, 22, 22, 3], [23, 18, 6, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bs.1", "24.24.1.di.1", "24.36.1.fr.1", "24.36.3.h.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.5.ks.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
