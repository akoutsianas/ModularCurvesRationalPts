...
// Magma code for modular curve with label 40.144.5.g.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.175

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 32, 30, 19], [21, 2, 0, 13], [25, 12, 14, 13], [35, 8, 16, 27], [35, 22, 24, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.a.1", "40.72.1.q.1", "40.72.1.cp.1", "40.72.3.a.1", "40.72.3.e.2", "40.72.3.ck.1", "40.72.3.ez.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.g.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*x);
