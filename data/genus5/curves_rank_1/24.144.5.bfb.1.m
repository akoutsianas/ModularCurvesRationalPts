...
// Magma code for modular curve with label 24.144.5.bfb.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1096

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 7, 16, 11], [7, 10, 2, 1], [19, 15, 12, 5], [21, 5, 22, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.fc.1", "24.72.2.cw.1", "24.72.2.eb.1", "24.72.2.hr.1", "24.72.2.ii.1", "24.72.3.bgg.1", "24.72.3.bgz.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.bfb.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
