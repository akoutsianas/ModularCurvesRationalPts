...
// Magma code for modular curve with label 40.144.5.go.1

// Other names and/or labels
// Cummins-Pauli label: 40M5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.628

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 39, 16, 5], [11, 35, 8, 33], [19, 28, 0, 37], [21, 17, 28, 15], [35, 34, 24, 35]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["40.72.1.s.2", "40.72.3.bw.1", "40.72.3.cc.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.go.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
