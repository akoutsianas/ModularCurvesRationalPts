...
// Magma code for modular curve with label 40.144.5.bw.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.292

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 37, 38, 25], [25, 4, 38, 1], [27, 7, 26, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.o.2", "40.72.1.e.2", "40.72.1.bv.1", "40.72.3.n.2", "40.72.3.o.1", "40.72.3.do.1", "40.72.3.ej.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.bw.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
