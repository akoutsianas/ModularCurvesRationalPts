...
// Magma code for modular curve with label 48.72.5.o.1

// Other names and/or labels
// Cummins-Pauli label: 48B5
// Rouse-Sutherland-Zureick-Brown label: 48.72.5.13

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 46, 8, 19], [19, 17, 28, 19], [19, 18, 24, 47], [25, 8, 32, 47], [25, 10, 32, 13], [29, 5, 20, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
// Map from the canonical model to the plane model of modular curve with label 48.72.5.o.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
