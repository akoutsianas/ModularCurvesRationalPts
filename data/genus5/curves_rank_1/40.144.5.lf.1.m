...
// Magma code for modular curve with label 40.144.5.lf.1

// Other names and/or labels
// Cummins-Pauli label: 40N5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.229

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 10, 34, 7], [15, 36, 2, 9], [19, 29, 2, 1], [21, 13, 12, 27], [37, 35, 36, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.u.1", "40.72.3.fg.1", "40.72.3.ft.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.lf.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
