...
// Magma code for modular curve with label 40.144.5.ij.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.546

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 26, 0, 27], [3, 25, 14, 29], [21, 17, 24, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.y.2", "40.72.1.bg.2", "40.72.1.bk.1", "40.72.1.cj.1", "40.72.3.de.1", "40.72.3.dw.1", "40.72.3.er.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.ij.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x+t);
//   Coordinate number 1:
