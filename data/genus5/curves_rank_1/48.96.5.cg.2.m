...
// Magma code for modular curve with label 48.96.5.cg.2

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.540

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 2, 44, 3], [37, 26, 44, 41], [39, 26, 32, 13], [41, 6, 36, 17], [47, 26, 0, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.f.2", "24.48.1.s.1", "48.48.1.gr.1", "48.48.1.hn.2", "48.48.3.e.1", "48.48.3.ee.1", "48.48.3.fa.2"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.cg.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
