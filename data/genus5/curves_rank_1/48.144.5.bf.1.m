...
// Magma code for modular curve with label 48.144.5.bf.1

// Other names and/or labels
// Cummins-Pauli label: 48H5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.780

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 23, 26, 11], [31, 35, 10, 19], [37, 26, 28, 25], [43, 25, 38, 43], [45, 19, 2, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.2.hm.2", "48.72.0.a.2", "48.72.3.bb.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.bf.1
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
map_1_coord_1 := 1*(r);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.bf.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-v);
//   Coordinate number 1:
