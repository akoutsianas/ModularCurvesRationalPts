...
// Magma code for modular curve with label 60.120.5.gh.1

// Other names and/or labels
// Cummins-Pauli label: 20F5
// Rouse-Sutherland-Zureick-Brown label: 60.120.5.147

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 16, 6, 49], [33, 49, 14, 25], [43, 49, 20, 37], [59, 37, 50, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.2.h.1", "60.60.2.j.1", "60.60.3.bu.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.120.5.gh.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
