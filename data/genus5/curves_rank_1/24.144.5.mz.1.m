...
// Magma code for modular curve with label 24.144.5.mz.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1310

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 4, 4, 11], [15, 19, 14, 9], [19, 8, 14, 5], [23, 17, 10, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.di.1", "24.72.2.k.1", "24.72.2.bs.1", "24.72.2.et.1", "24.72.2.fs.1", "24.72.3.bfu.1", "24.72.3.bgv.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.mz.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
