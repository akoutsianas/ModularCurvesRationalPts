...
// Magma code for modular curve with label 48.144.5.b.2

// Other names and/or labels
// Cummins-Pauli label: 48F5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.716

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 4, 4, 25], [11, 15, 42, 19], [17, 3, 42, 29], [31, 43, 34, 23], [47, 40, 28, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.2.ho.2", "48.48.1.gr.1", "48.72.0.a.1", "48.72.3.q.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.b.2
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(9*v);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.b.2
//   Coordinate number 0:
map_2_coord_0 := 1*(-r);
//   Coordinate number 1:
