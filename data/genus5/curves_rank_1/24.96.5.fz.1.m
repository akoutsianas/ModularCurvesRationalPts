...
// Magma code for modular curve with label 24.96.5.fz.1

// Other names and/or labels
// Cummins-Pauli label: 24I5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.220

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 11, 6, 11], [5, 17, 18, 11], [7, 23, 18, 17], [11, 5, 0, 1], [23, 11, 0, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.24.1.el.1", "24.48.1.jg.1", "24.48.3.bv.1", "24.48.3.cp.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.fz.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
