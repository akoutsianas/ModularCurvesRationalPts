...
// Magma code for modular curve with label 16.96.5.q.2

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 16.96.5.29

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 0, 8, 9], [3, 2, 12, 9], [5, 6, 4, 15], [7, 6, 4, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.i.2", "16.48.3.e.1", "16.48.3.f.1"];
...
// Canonical model
model_0 := [z*w+y*t,2*x^2-z*w,8*y^2+2*z^2-2*w^2-t^2];
...
// Map from the canonical model to the plane model of modular curve with label 16.96.5.q.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
