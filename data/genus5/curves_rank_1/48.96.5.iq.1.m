...
// Magma code for modular curve with label 48.96.5.iq.1

// Other names and/or labels
// Cummins-Pauli label: 16B5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.384

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 32, 22, 37], [41, 36, 46, 7], [45, 7, 46, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.bm.1", "24.48.1.kj.1", "48.48.1.gz.1", "48.48.1.ho.1", "48.48.3.bn.1", "48.48.3.cb.1", "48.48.3.dz.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.iq.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*w);
