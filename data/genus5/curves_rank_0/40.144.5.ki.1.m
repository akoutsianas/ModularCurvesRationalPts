...
// Magma code for modular curve with label 40.144.5.ki.1

// Other names and/or labels
// Cummins-Pauli label: 40N5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.660

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 28, 36, 31], [21, 31, 32, 35], [27, 5, 6, 1], [35, 24, 22, 37], [37, 29, 36, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["40.72.1.ct.1", "40.72.3.fe.1", "40.72.3.fh.2"];
...
// Canonical model
model_0 := [2*y*t+5*z*w,20*x^2+2*y^2-4*y*t+5*w^2,2*y^2-25*z^2+5*w^2-2*t^2];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.ki.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
