...
// Magma code for modular curve with label 24.144.5.rz.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1278

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 8, 2, 7], [19, 4, 4, 23], [21, 17, 4, 15], [21, 23, 14, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.dy.1", "24.72.2.co.1", "24.72.2.ea.1", "24.72.2.et.1", "24.72.2.fk.1", "24.72.3.bco.1", "24.72.3.bdh.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.rz.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
