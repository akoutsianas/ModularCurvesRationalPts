...
// Magma code for modular curve with label 24.192.5.bm.1

// Other names and/or labels
// Cummins-Pauli label: 12E5
// Rouse-Sutherland-Zureick-Brown label: 24.192.5.275

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 6, 18, 1], [7, 0, 6, 17], [7, 10, 12, 11], [13, 8, 18, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["12.96.1.c.1", "24.96.1.cj.3", "24.96.1.cn.4", "24.96.3.bc.1", "24.96.3.bt.2", "24.96.3.by.1", "24.96.3.bz.1"];
...
model_1 := [-9*x^8+36*x^7*y-36*x^6*y^2-108*x^6*z^2+12*x^5*y^3+432*x^5*y*z^2+8*x^4*y^4-504*x^4*y^2*z^2-81*x^4*z^4-16*x^3*y^5+360*x^3*y^3*z^2+324*x^3*y*z^4+8*x^2*y^6-132*x^2*y^4*z^2-162*x^2*y^2*z^4-12*x*y^5*z^2+216*x*y^3*z^4-9*y^4*z^4+162*y^2*z^6];
...
// Map from the canonical model to the plane model of modular curve with label 24.192.5.bm.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
...
// Codomain equation:
map_1_codomain := [-9*x^8+36*x^7*y-36*x^6*y^2-108*x^6*z^2+12*x^5*y^3+432*x^5*y*z^2+8*x^4*y^4-504*x^4*y^2*z^2-81*x^4*z^4-16*x^3*y^5+360*x^3*y^3*z^2+324*x^3*y*z^4+8*x^2*y^6-132*x^2*y^4*z^2-162*x^2*y^2*z^4-12*x*y^5*z^2+216*x*y^3*z^4-9*y^4*z^4+162*y^2*z^6];
