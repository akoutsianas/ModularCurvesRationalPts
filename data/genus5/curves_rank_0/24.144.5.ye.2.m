...
// Magma code for modular curve with label 24.144.5.ye.2

// Other names and/or labels
// Cummins-Pauli label: 24Y5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1053

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 19, 2, 1], [13, 6, 0, 7], [17, 20, 20, 7], [21, 19, 2, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.ee.1", "24.72.2.hn.2", "24.72.2.ho.2"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.ye.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
