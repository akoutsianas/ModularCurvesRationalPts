...
// Magma code for modular curve with label 32.192.5.b.3

// Other names and/or labels
// Cummins-Pauli label: 32N5
// Rouse-Sutherland-Zureick-Brown label: 32.192.5.63

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 0, 0, 21], [15, 30, 16, 25], [23, 16, 0, 1], [25, 0, 0, 7], [31, 8, 16, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["16.96.1.f.2", "32.96.2.j.1", "32.96.2.k.1"];
...
// Canonical model
model_0 := [y*w-z*t,x^2-z*w-y*t,y*z+z*w-y*t+w*t];
...
// Map from the canonical model to the plane model of modular curve with label 32.192.5.b.3
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(x);
