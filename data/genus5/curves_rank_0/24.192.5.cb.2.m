...
// Magma code for modular curve with label 24.192.5.cb.2

// Other names and/or labels
// Cummins-Pauli label: 24AB5
// Rouse-Sutherland-Zureick-Brown label: 24.192.5.294

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 12, 0, 23], [11, 8, 0, 1], [13, 2, 0, 13], [23, 4, 0, 7], [23, 4, 0, 23], [23, 16, 12, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["12.96.1.b.2", "24.96.3.bm.2", "24.96.3.bn.1"];
...
// Canonical model
model_0 := [x*t+z*w,x*w+2*y^2+z^2+z*t-w^2+t^2,x*z+x*w+x*t-z^2-z*w-z*t-w^2-t^2];
...
// Map from the canonical model to the plane model of modular curve with label 24.192.5.cb.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
