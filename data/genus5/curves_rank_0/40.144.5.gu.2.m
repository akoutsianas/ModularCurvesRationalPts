...
// Magma code for modular curve with label 40.144.5.gu.2

// Other names and/or labels
// Cummins-Pauli label: 40M5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.39

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 34, 36, 35], [9, 30, 36, 33], [25, 9, 4, 35], [27, 9, 4, 27], [35, 19, 36, 23], [37, 29, 36, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.f.2", "40.72.3.by.1", "40.72.3.cd.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.gu.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
