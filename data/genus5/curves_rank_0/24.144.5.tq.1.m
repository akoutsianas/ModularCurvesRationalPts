...
// Magma code for modular curve with label 24.144.5.tq.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1274

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 11, 16, 11], [11, 6, 18, 5], [17, 14, 10, 23], [19, 8, 20, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.dy.1", "24.72.2.cw.1", "24.72.2.du.1", "24.72.2.fa.1", "24.72.2.ft.1", "24.72.3.bcx.1", "24.72.3.bdo.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.tq.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
