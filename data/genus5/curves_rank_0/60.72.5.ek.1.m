...
// Magma code for modular curve with label 60.72.5.ek.1

// Other names and/or labels
// Cummins-Pauli label: 30G5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.71

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 40, 22, 11], [18, 25, 53, 36], [29, 35, 29, 46], [57, 5, 26, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["15.36.2.b.1", "60.36.1.ga.1", "60.36.2.fu.2"];
...
// Map from the canonical model to the plane model of modular curve with label 60.72.5.ek.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
