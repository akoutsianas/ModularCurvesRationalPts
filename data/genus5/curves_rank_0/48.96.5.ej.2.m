...
// Magma code for modular curve with label 48.96.5.ej.2

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.107

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 38, 44, 1], [13, 36, 24, 41], [31, 25, 30, 11], [43, 24, 16, 47]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.bh.2", "48.48.1.he.1", "48.48.1.hf.2", "48.48.3.p.1", "48.48.3.t.1", "48.48.3.er.1", "48.48.3.es.2"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.ej.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
