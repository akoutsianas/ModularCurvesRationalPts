...
// Magma code for modular curve with label 20.96.5.d.1

// Other names and/or labels
// Cummins-Pauli label: 20D5
// Rouse-Sutherland-Zureick-Brown label: 20.96.5.12

// Group data
level := 20;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 5, 4, 1], [13, 3, 5, 4], [13, 7, 4, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["20.24.1.c.1", "20.48.1.b.1", "20.48.3.f.1", "20.48.3.j.1"];
...
// Canonical model
model_0 := [x^2-x*w+2*x*t+z^2+z*w+w*t-t^2,2*x^2+y^2+y*w-z^2-z*w-w*t+t^2,x^2+x*w-2*x*t-2*y^2-z^2-z*w-w^2+w*t-t^2];
...
// Map from the canonical model to the plane model of modular curve with label 20.96.5.d.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
