...
// Magma code for modular curve with label 60.72.5.eo.2

// Other names and/or labels
// Cummins-Pauli label: 30G5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.144

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 0, 3, 43], [38, 55, 47, 59], [43, 30, 9, 41], [58, 35, 7, 58]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["30.36.2.a.2", "60.36.1.gb.1", "60.36.2.fs.2"];
...
// Map from the canonical model to the plane model of modular curve with label 60.72.5.eo.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
