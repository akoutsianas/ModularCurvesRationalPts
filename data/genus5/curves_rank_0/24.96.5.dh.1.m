...
// Magma code for modular curve with label 24.96.5.dh.1

// Other names and/or labels
// Cummins-Pauli label: 24K5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.36

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 3, 12, 1], [7, 23, 6, 17], [19, 7, 6, 17], [23, 16, 0, 7], [23, 20, 0, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['3.4.0.a.1', '8.24.1.bd.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["8.24.1.bd.1", "12.48.2.d.1", "24.48.2.r.1", "24.48.3.d.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.dh.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
