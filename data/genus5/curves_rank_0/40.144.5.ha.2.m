...
// Magma code for modular curve with label 40.144.5.ha.2

// Other names and/or labels
// Cummins-Pauli label: 40M5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.616

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 12, 16, 33], [13, 31, 0, 29], [13, 36, 20, 29], [29, 17, 32, 19], [31, 17, 20, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["40.72.1.v.2", "40.72.3.by.1", "40.72.3.cb.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.ha.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
