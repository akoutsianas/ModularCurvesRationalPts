...
// Magma code for modular curve with label 60.144.5.bi.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.774

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[31, 0, 32, 31], [37, 0, 50, 43], [39, 50, 38, 27], [51, 50, 34, 53], [59, 40, 54, 43]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.e.1", "60.72.1.b.2", "60.72.1.bt.2", "60.72.1.dv.2", "60.72.3.a.1", "60.72.3.nd.2", "60.72.3.yz.2"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.bi.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
