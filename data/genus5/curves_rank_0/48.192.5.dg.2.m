...
// Magma code for modular curve with label 48.192.5.dg.2

// Other names and/or labels
// Cummins-Pauli label: 16O5
// Rouse-Sutherland-Zureick-Brown label: 48.192.5.1962

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 18, 4, 7], [13, 38, 4, 33], [21, 26, 44, 29], [23, 32, 32, 45], [43, 2, 28, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["16.96.3.bd.1", "24.96.1.z.1", "48.96.3.by.1"];
...
// Canonical model
model_0 := [3*y*z+2*w*t,3*y^2+3*y*z-3*z^2-2*w^2-6*w*t+2*t^2,12*x^2-3*y^2-3*y*z+2*w*t-2*t^2];
...
// Map from the canonical model to the plane model of modular curve with label 48.192.5.dg.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
