...
// Magma code for modular curve with label 24.96.5.cf.1

// Other names and/or labels
// Cummins-Pauli label: 24K5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.41

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 9, 8, 23], [11, 15, 18, 17], [13, 3, 14, 7], [13, 15, 16, 23], [23, 6, 10, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['3.4.0.a.1', '8.24.1.t.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["8.24.1.t.1", "24.48.2.i.1", "24.48.2.m.1", "24.48.3.c.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.cf.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
