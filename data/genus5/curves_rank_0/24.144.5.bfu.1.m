...
// Magma code for modular curve with label 24.144.5.bfu.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.440

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 10, 20, 19], [13, 17, 16, 7], [17, 1, 22, 7], [21, 8, 14, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.2.m.1", "24.72.1.ez.1", "24.72.2.do.1", "24.72.2.ii.1", "24.72.2.je.1", "24.72.3.bgu.1", "24.72.3.bhq.1"];
...
// Canonical model
model_0 := [x*z+x*w-2*y*z,2*x*y+2*x*t-2*y^2-3*z^2+w^2+2*t^2,x^2-2*x*t-3*z^2-3*w^2-2*t^2];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.bfu.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
