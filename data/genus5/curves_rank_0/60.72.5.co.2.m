...
// Magma code for modular curve with label 60.72.5.co.2

// Other names and/or labels
// Cummins-Pauli label: 30C5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.62

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 58, 31, 21], [38, 41, 55, 14], [40, 41, 11, 5], [55, 17, 7, 40]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["15.36.2.b.2", "60.24.1.ba.1", "60.36.0.cg.1", "60.36.3.c.1"];
...
// Weierstrass model
model_2 := [469*x^12+x^6*y+2228*x^6*z^6+y^2+y*z^6+2734*z^12];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.5.co.2
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*r);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.72.5.co.2
//   Coordinate number 0:
map_2_coord_0 := 1*(t);
//   Coordinate number 1:
map_2_coord_1 := 1*(7*t^6-135*t*u^4*r-203*u^6);
//   Coordinate number 2:
map_2_coord_2 := 1*(u);
// Codomain equation:
map_2_codomain := [469*x^12+x^6*y+2228*x^6*z^6+y^2+y*z^6+2734*z^12];
