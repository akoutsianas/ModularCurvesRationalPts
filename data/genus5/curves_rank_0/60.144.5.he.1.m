...
// Magma code for modular curve with label 60.144.5.he.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.155

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 22, 30, 41], [37, 6, 36, 19], [41, 32, 18, 49], [56, 41, 51, 10]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.3.cf.1", "60.48.1.bk.1", "60.72.1.r.1", "60.72.1.bg.1", "60.72.1.ef.1", "60.72.3.la.1", "60.72.3.nk.1", "60.72.3.sy.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.he.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y+z);
//   Coordinate number 1:
map_1_coord_1 := 1*(z+w);
