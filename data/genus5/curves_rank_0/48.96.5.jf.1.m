...
// Magma code for modular curve with label 48.96.5.jf.1

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.416

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 16, 8, 47], [23, 3, 26, 19], [31, 34, 0, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.bt.1", "24.48.1.kq.1", "48.48.1.he.1", "48.48.1.hk.1", "48.48.3.bh.2", "48.48.3.br.2", "48.48.3.dn.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.jf.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
