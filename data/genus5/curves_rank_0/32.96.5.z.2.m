...
// Magma code for modular curve with label 32.96.5.z.2

// Other names and/or labels
// Cummins-Pauli label: 32D5
// Rouse-Sutherland-Zureick-Brown label: 32.96.5.43

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 7, 24, 13], [23, 17, 16, 25], [25, 14, 24, 27], [27, 20, 0, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.u.2", "32.48.3.c.1", "32.48.3.e.1"];
...
// Map from the canonical model to the plane model of modular curve with label 32.96.5.z.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
