...
// Magma code for modular curve with label 40.144.5.fk.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.422

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 1, 0, 19], [7, 16, 24, 9], [9, 32, 28, 33], [23, 30, 20, 3], [35, 33, 16, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.o.1", "40.72.1.s.2", "40.72.1.y.1", "40.72.1.cb.1", "40.72.3.cr.1", "40.72.3.cu.1", "40.72.3.eg.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.fk.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
