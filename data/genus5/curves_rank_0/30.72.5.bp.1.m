...
// Magma code for modular curve with label 30.72.5.bp.1

// Other names and/or labels
// Cummins-Pauli label: 30G5
// Rouse-Sutherland-Zureick-Brown label: 30.72.5.48

// Group data
level := 30;
// Elements that, together with Gamma(level), generate the group
gens := [[4, 5, 11, 14], [4, 15, 9, 26], [24, 5, 7, 3], [29, 25, 16, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['5.12.0.a.2', '6.6.0.d.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["15.36.2.a.2", "30.36.1.r.1", "30.36.2.a.1"];
...
// Map from the canonical model to the plane model of modular curve with label 30.72.5.bp.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
