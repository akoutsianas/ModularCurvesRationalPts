...
// Magma code for modular curve with label 24.192.5.cm.4

// Other names and/or labels
// Cummins-Pauli label: 24AB5
// Rouse-Sutherland-Zureick-Brown label: 24.192.5.307

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 10, 12, 5], [1, 16, 0, 13], [5, 12, 0, 19], [7, 6, 0, 13], [7, 16, 12, 1], [23, 0, 0, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["12.96.1.b.3", "24.96.3.bq.1", "24.96.3.br.1"];
...
// Canonical model
model_0 := [x*t-y^2-y*w,x^2-y^2-2*z^2+w^2,x^2-x*t+y^2-y*w+w^2-t^2];
...
// Map from the canonical model to the plane model of modular curve with label 24.192.5.cm.4
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
