...
// Magma code for modular curve with label 16.96.5.bc.2

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 16.96.5.111

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 2, 8, 1], [11, 6, 0, 1], [15, 15, 2, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.s.2", "16.48.1.cj.2", "16.48.1.cu.2", "16.48.3.h.1", "16.48.3.i.2", "16.48.3.bh.2", "16.48.3.bu.2"];
...
model_1 := [16*x^8-8*x^6*y^2+2*x^4*y^4+64*x^6*y*z-32*x^4*y^3*z-96*x^6*z^2+216*x^4*y^2*z^2-704*x^4*y*z^3+920*x^4*z^4-2*x^2*y^2*z^4+16*x^2*y*z^5-24*x^2*z^6+z^8];
...
// Map from the canonical model to the plane model of modular curve with label 16.96.5.bc.2
//   Coordinate number 0:
...
// Codomain equation:
map_1_codomain := [16*x^8-8*x^6*y^2+2*x^4*y^4+64*x^6*y*z-32*x^4*y^3*z-96*x^6*z^2+216*x^4*y^2*z^2-704*x^4*y*z^3+920*x^4*z^4-2*x^2*y^2*z^4+16*x^2*y*z^5-24*x^2*z^6+z^8];
