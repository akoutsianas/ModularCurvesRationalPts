...
// Magma code for modular curve with label 60.96.5.a.1

// Other names and/or labels
// Cummins-Pauli label: 30N5
// Rouse-Sutherland-Zureick-Brown label: 60.96.5.53

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 45, 39, 26], [19, 45, 57, 46], [23, 15, 3, 32], [31, 40, 0, 47], [41, 55, 33, 4]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['3.4.0.a.1', '20.24.1.a.2']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["20.24.1.a.2", "30.48.3.a.1", "60.48.1.bw.1", "60.48.3.bd.2"];
...
// Map from the canonical model to the plane model of modular curve with label 60.96.5.a.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
