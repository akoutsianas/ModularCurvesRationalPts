...
// Magma code for modular curve with label 40.144.5.ha.1

// Other names and/or labels
// Cummins-Pauli label: 40M5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.608

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 4, 8, 1], [21, 7, 24, 39], [31, 3, 32, 7], [31, 8, 20, 9], [37, 21, 20, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["40.72.1.v.1", "40.72.3.by.1", "40.72.3.cb.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.ha.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
