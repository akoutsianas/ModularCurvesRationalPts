...
// Magma code for modular curve with label 16.192.5.p.2

// Other names and/or labels
// Cummins-Pauli label: 16O5
// Rouse-Sutherland-Zureick-Brown label: 16.192.5.314

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 10, 4, 3], [7, 8, 0, 13], [9, 0, 8, 1], [9, 8, 0, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["8.96.1.h.2", "16.96.3.n.1", "16.96.3.bd.1"];
...
// Map from the canonical model to the plane model of modular curve with label 16.192.5.p.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
