...
// Magma code for modular curve with label 40.96.5.v.2

// Other names and/or labels
// Cummins-Pauli label: 20D5
// Rouse-Sutherland-Zureick-Brown label: 40.96.5.38

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[0, 29, 29, 20], [7, 1, 19, 24], [25, 14, 3, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["20.48.3.h.1", "40.24.1.cr.1", "40.48.1.kh.1", "40.48.3.j.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.96.5.v.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
