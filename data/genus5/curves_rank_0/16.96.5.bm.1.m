...
// Magma code for modular curve with label 16.96.5.bm.1

// Other names and/or labels
// Cummins-Pauli label: 16C5
// Rouse-Sutherland-Zureick-Brown label: 16.96.5.138

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 11, 2, 5], [7, 13, 10, 1], [9, 1, 2, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.k.1", "16.48.3.r.1", "16.48.3.v.1"];
...
// Map from the canonical model to the plane model of modular curve with label 16.96.5.bm.1
//   Coordinate number 0:
