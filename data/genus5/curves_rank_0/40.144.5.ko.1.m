...
// Magma code for modular curve with label 40.144.5.ko.1

// Other names and/or labels
// Cummins-Pauli label: 20J5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.331

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 8, 30, 29], [13, 33, 26, 15], [21, 20, 28, 33], [21, 25, 2, 19], [39, 19, 2, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.bp.1", "40.72.1.cq.1", "40.72.3.fn.1"];
...
// Canonical model
model_0 := [2*x^2-4*x*y-2*z^2+w^2,4*x^2+2*x*y-4*z^2+w^2+w*t,4*x^2+2*x*y-10*y^2+6*z^2+2*w^2+w*t-t^2];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.ko.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
