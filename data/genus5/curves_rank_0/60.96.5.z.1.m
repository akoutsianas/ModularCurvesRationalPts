...
// Magma code for modular curve with label 60.96.5.z.1

// Other names and/or labels
// Cummins-Pauli label: 12A5
// Rouse-Sutherland-Zureick-Brown label: 60.96.5.12

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 54, 18, 59], [28, 45, 3, 16], [52, 51, 27, 37], [53, 8, 15, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["12.48.3.o.1", "60.24.1.m.1", "60.32.1.d.1", "60.48.1.ca.1", "60.48.3.bw.1"];
...
// Canonical model
model_0 := [5*x*y+5*x*z+x*t+y*t-z*t-2*w*t-3*t^2,4*x^2-2*x*y-y^2-3*x*z-3*y*z-z^2-x*w-y*w+z*w+w^2-x*t-y*t+z*t+2*w*t,10*x*y+5*y^2-5*x*z-5*y*z+5*z^2+2*x*t+2*y*t-2*z*t-4*w*t+3*t^2];
