...
// Magma code for modular curve with label 16.96.5.e.1

// Other names and/or labels
// Cummins-Pauli label: 16C5
// Rouse-Sutherland-Zureick-Brown label: 16.96.5.33

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 6, 0, 3], [7, 8, 4, 5], [9, 2, 4, 1], [11, 14, 8, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.e.1", "16.48.3.c.1", "16.48.3.d.2"];
...
// Map from the canonical model to the plane model of modular curve with label 16.96.5.e.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
