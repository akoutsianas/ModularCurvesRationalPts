...
// Magma code for modular curve with label 48.96.5.tv.1

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.201

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 25, 38, 17], [13, 13, 38, 45], [23, 25, 46, 43]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.cu.2", "24.48.1.ku.2", "48.48.1.ir.1", "48.48.3.dr.1", "48.48.3.et.2", "48.48.3.ey.1", "48.48.3.gb.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.tv.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
