...
// Magma code for modular curve with label 60.72.5.f.1

// Other names and/or labels
// Cummins-Pauli label: 30C5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.93

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 50, 47, 53], [1, 50, 50, 41], [16, 35, 31, 46], [18, 35, 43, 42], [33, 25, 11, 24]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["30.36.0.e.1", "60.24.1.f.2", "60.36.2.ft.1", "60.36.3.a.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.5.f.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(9*v);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.72.5.f.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-r);
//   Coordinate number 1:
