...
// Magma code for modular curve with label 36.144.5.m.1

// Other names and/or labels
// Cummins-Pauli label: 36L5
// Rouse-Sutherland-Zureick-Brown label: 36.144.5.29

// Group data
level := 36;
// Elements that, together with Gamma(level), generate the group
gens := [[23, 13, 18, 13], [29, 26, 0, 23], [31, 32, 0, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.48.1.m.1", "18.72.1.d.1", "36.72.1.g.1", "36.72.3.w.1"];
...
model_1 := [7*x^8+10*x^7*y+19*x^6*y^2+12*x^5*y^3+9*x^4*y^4-78*x^6*z^2-48*x^5*y*z^2-72*x^4*y^2*z^2-108*x^4*z^4-234*x^3*y*z^4-351*x^2*y^2*z^4+1890*x^2*z^6+3969*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 36.144.5.m.1
//   Coordinate number 0:
...
// Codomain equation:
map_1_codomain := [7*x^8+10*x^7*y+19*x^6*y^2+12*x^5*y^3+9*x^4*y^4-78*x^6*z^2-48*x^5*y*z^2-72*x^4*y^2*z^2-108*x^4*z^4-234*x^3*y*z^4-351*x^2*y^2*z^4+1890*x^2*z^6+3969*z^8];
