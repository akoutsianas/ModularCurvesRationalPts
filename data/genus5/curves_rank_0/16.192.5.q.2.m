...
// Magma code for modular curve with label 16.192.5.q.2

// Other names and/or labels
// Cummins-Pauli label: 16O5
// Rouse-Sutherland-Zureick-Brown label: 16.192.5.323

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 8, 8, 9], [7, 0, 12, 1], [13, 2, 12, 15], [13, 14, 0, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["8.96.1.j.2", "16.96.2.e.2", "16.96.2.g.2"];
...
// Map from the canonical model to the plane model of modular curve with label 16.192.5.q.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x+z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
