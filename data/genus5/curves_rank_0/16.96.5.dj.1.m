...
// Magma code for modular curve with label 16.96.5.dj.1

// Other names and/or labels
// Cummins-Pauli label: 16E5
// Rouse-Sutherland-Zureick-Brown label: 16.96.5.125

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 1, 6, 7], [11, 10, 0, 7], [15, 13, 12, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.bw.1", "16.48.1.bz.1", "16.48.3.bx.1"];
...
// Map from the canonical model to the plane model of modular curve with label 16.96.5.dj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
