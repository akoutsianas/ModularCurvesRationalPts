...
// Magma code for modular curve with label 40.96.5.m.1

// Other names and/or labels
// Cummins-Pauli label: 20D5
// Rouse-Sutherland-Zureick-Brown label: 40.96.5.34

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 35, 6, 21], [15, 22, 38, 29], [28, 39, 19, 28]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["20.48.3.g.1", "40.24.1.ci.2", "40.48.1.kh.1", "40.48.3.i.2"];
...
// Canonical model
model_0 := [x^2+x*y-2*x*w+y^2+y*w+z^2-w^2+t^2,3*x^2-x*y+2*x*w-2*y^2+3*y*w+z^2-3*w^2+t^2,4*x^2+3*y^2-2*y*w-2*z*t+2*w^2-t^2];
...
// Map from the canonical model to the plane model of modular curve with label 40.96.5.m.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
