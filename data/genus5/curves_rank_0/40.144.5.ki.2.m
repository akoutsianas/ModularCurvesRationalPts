...
// Magma code for modular curve with label 40.144.5.ki.2

// Other names and/or labels
// Cummins-Pauli label: 40N5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.672

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 0, 14, 27], [9, 22, 10, 31], [25, 33, 6, 7], [31, 18, 32, 7], [35, 9, 4, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["40.72.1.ct.2", "40.72.3.fe.1", "40.72.3.fh.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.ki.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
