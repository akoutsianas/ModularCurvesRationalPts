...
// Magma code for modular curve with label 60.72.5.es.2

// Other names and/or labels
// Cummins-Pauli label: 30G5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.105

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[31, 25, 29, 16], [33, 20, 53, 33], [37, 40, 8, 1], [48, 55, 23, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["30.36.1.r.1", "60.36.2.ft.2", "60.36.2.fv.2"];
...
// Map from the canonical model to the plane model of modular curve with label 60.72.5.es.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
