...
// Magma code for modular curve with label 24.144.5.su.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.347

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 20, 4, 1], [5, 22, 22, 7], [15, 11, 14, 9], [17, 17, 14, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.2.k.1", "24.72.1.dt.1", "24.72.2.cv.1", "24.72.2.ey.1", "24.72.2.fu.1", "24.72.3.bcy.1", "24.72.3.bdu.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.su.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
