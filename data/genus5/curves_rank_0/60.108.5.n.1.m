...
// Magma code for modular curve with label 60.108.5.n.1

// Other names and/or labels
// Cummins-Pauli label: 60B5
// Rouse-Sutherland-Zureick-Brown label: 60.108.5.5

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 0, 15, 43], [17, 2, 35, 49], [29, 42, 30, 7], [37, 36, 15, 7], [49, 20, 10, 7], [57, 32, 40, 57]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 108;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['5.6.0.a.1', '12.18.0.f.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["12.18.0.f.1", "30.54.2.a.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.108.5.n.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
