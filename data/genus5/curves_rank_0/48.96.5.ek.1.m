...
// Magma code for modular curve with label 48.96.5.ek.1

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.601

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 23, 34, 17], [35, 22, 44, 11], [45, 16, 16, 17], [47, 45, 30, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.t.2", "24.48.1.ds.1", "48.48.1.io.1", "48.48.1.ip.2", "48.48.3.p.1", "48.48.3.br.1", "48.48.3.bs.2"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.ek.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
