...
// Magma code for modular curve with label 32.96.5.bb.2

// Other names and/or labels
// Cummins-Pauli label: 32D5
// Rouse-Sutherland-Zureick-Brown label: 32.96.5.40

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 6, 24, 29], [13, 13, 8, 17], [19, 26, 0, 31], [21, 2, 0, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.w.2", "32.48.3.c.2", "32.48.3.e.2"];
...
// Map from the canonical model to the plane model of modular curve with label 32.96.5.bb.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
