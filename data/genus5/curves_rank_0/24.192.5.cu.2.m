...
// Magma code for modular curve with label 24.192.5.cu.2

// Other names and/or labels
// Cummins-Pauli label: 24Z5
// Rouse-Sutherland-Zureick-Brown label: 24.192.5.1811

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 4, 6, 7], [11, 14, 0, 11], [17, 18, 12, 13], [19, 10, 12, 23], [23, 6, 18, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["24.96.1.ci.2", "24.96.3.bj.1", "24.96.3.cf.1"];
...
// Canonical model
model_0 := [2*y*z-w*t,3*x^2+y*z,2*y^2+6*z^2+w^2-t^2];
...
// Map from the canonical model to the plane model of modular curve with label 24.192.5.cu.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
