...
// Magma code for modular curve with label 60.72.5.b.1

// Other names and/or labels
// Cummins-Pauli label: 30C5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.51

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 55, 17, 52], [29, 30, 57, 29], [31, 20, 37, 1], [34, 5, 17, 47], [46, 45, 45, 29], [51, 20, 7, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['3.3.0.a.1', '4.2.0.a.1', '5.12.0.a.2']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["15.36.2.a.2", "20.24.1.b.2", "60.36.0.ch.1", "60.36.3.a.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.5.b.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.72.5.b.1
//   Coordinate number 0:
map_2_coord_0 := 1*(z);
//   Coordinate number 1:
map_2_coord_1 := 1*(1/25*z^4*w*v-13/15625*w^6);
//   Coordinate number 2:
