...
// Magma code for modular curve with label 24.192.5.co.2

// Other names and/or labels
// Cummins-Pauli label: 24AB5
// Rouse-Sutherland-Zureick-Brown label: 24.192.5.1723

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 6, 12, 17], [7, 18, 0, 19], [11, 6, 12, 13], [13, 2, 0, 13], [13, 22, 12, 5], [19, 18, 0, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["24.96.1.ck.4", "24.96.3.bo.1", "24.96.3.br.3"];
