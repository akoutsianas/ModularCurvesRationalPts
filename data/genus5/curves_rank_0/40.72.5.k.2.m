...
// Magma code for modular curve with label 40.72.5.k.2

// Other names and/or labels
// Cummins-Pauli label: 40B5
// Rouse-Sutherland-Zureick-Brown label: 40.72.5.13

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 11, 14, 3], [1, 15, 24, 7], [9, 35, 28, 31], [31, 6, 4, 3], [37, 10, 26, 31], [37, 21, 8, 35]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
// Canonical model
model_0 := [2*x*y-y^2-w^2-w*t,z^2-2*x*w-2*x*t+y*t,2*y*w+x*t+2*y*t];

// Singular plane model
model_1 := [5*x^6*z+8*x^5*y^2-10*x^4*z^3-20*x^3*y^2*z^2+5*x^2*z^5+12*x*y^2*z^4+4*y^4*z^3];
...
// Map from the canonical model to the plane model of modular curve with label 40.72.5.k.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Codomain equation:
map_1_codomain := [5*x^6*z+8*x^5*y^2-10*x^4*z^3-20*x^3*y^2*z^2+5*x^2*z^5+12*x*y^2*z^4+4*y^4*z^3];
