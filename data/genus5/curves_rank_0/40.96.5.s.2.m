...
// Magma code for modular curve with label 40.96.5.s.2

// Other names and/or labels
// Cummins-Pauli label: 20D5
// Rouse-Sutherland-Zureick-Brown label: 40.96.5.40

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[10, 23, 1, 22], [37, 19, 36, 35], [39, 22, 37, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["20.48.3.h.1", "40.24.1.co.1", "40.48.1.kg.2", "40.48.3.i.1"];
...
// Canonical model
model_0 := [y^2-y*z-2*y*t+z^2-z*t-t^2,10*x*w+4*y^2-2*z^2+2*z*t+5*w^2+2*t^2,10*x^2-3*y^2-y*z-2*y*t+2*z^2+3*z*t+10*w^2+3*t^2];
...
// Map from the canonical model to the plane model of modular curve with label 40.96.5.s.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
