...
// Magma code for modular curve with label 24.96.5.ea.1

// Other names and/or labels
// Cummins-Pauli label: 24K5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.215

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 12, 2, 7], [11, 9, 6, 1], [11, 18, 18, 5], [11, 21, 4, 17], [23, 3, 22, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.24.1.cy.1", "24.48.2.h.1", "24.48.2.n.1", "24.48.3.bv.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.ea.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
