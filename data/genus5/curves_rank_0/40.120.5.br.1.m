...
// Magma code for modular curve with label 40.120.5.br.1

// Other names and/or labels
// Cummins-Pauli label: 20E5
// Rouse-Sutherland-Zureick-Brown label: 40.120.5.14

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 7, 4, 33], [11, 27, 36, 21], [31, 28, 34, 11], [35, 24, 8, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['5.20.0.b.1', '8.6.0.d.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["10.60.2.b.1", "40.30.2.d.1", "40.60.2.g.1", "40.60.3.d.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.120.5.br.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
