...
// Magma code for modular curve with label 48.96.5.fe.2

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.604

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 28, 24, 29], [15, 35, 10, 7], [21, 34, 20, 17], [35, 10, 36, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.t.1", "24.48.1.ds.2", "48.48.1.iq.1", "48.48.1.ir.2", "48.48.3.y.1", "48.48.3.bt.1", "48.48.3.bu.2"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.fe.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
