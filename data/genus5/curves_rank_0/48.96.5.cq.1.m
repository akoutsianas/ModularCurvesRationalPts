...
// Magma code for modular curve with label 48.96.5.cq.1

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.645

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 11, 18, 7], [17, 5, 38, 13], [31, 21, 14, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.h.1", "24.48.1.ca.1", "48.48.1.gq.2", "48.48.1.hl.1", "48.48.3.h.2", "48.48.3.ee.2", "48.48.3.ex.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.cq.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
