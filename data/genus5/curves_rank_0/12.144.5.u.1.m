...
// Magma code for modular curve with label 12.144.5.u.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 12.144.5.13

// Group data
level := 12;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 6, 0, 11], [1, 9, 0, 5], [5, 6, 0, 7], [11, 9, 0, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.48.1.l.1", "12.72.1.f.1", "12.72.1.l.1", "12.72.1.o.1", "12.72.3.by.1", "12.72.3.cc.1", "12.72.3.ce.1", "12.72.3.cq.1"];
...
// Canonical model
model_0 := [z^2+y*w+y*t,y^2-z^2+y*t-w*t,3*x^2+y^2+z^2+y*w-w^2-y*t-t^2];

// Singular plane model
model_1 := [-9*x^4*y^4+18*x^3*y^5-18*x^3*y^3*z^2-45*x^2*y^6+66*x^2*y^4*z^2-3*x^2*y^2*z^4+36*x*y^7-84*x*y^5*z^2+42*x*y^3*z^4+6*x*y*z^6-9*y^8+24*y^6*z^2-34*y^4*z^4+8*y^2*z^6+2*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 12.144.5.u.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+w);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
...
map_1_coord_2 := 1*(z);
// Codomain equation:
map_1_codomain := [-9*x^4*y^4+18*x^3*y^5-18*x^3*y^3*z^2-45*x^2*y^6+66*x^2*y^4*z^2-3*x^2*y^2*z^4+36*x*y^7-84*x*y^5*z^2+42*x*y^3*z^4+6*x*y*z^6-9*y^8+24*y^6*z^2-34*y^4*z^4+8*y^2*z^6+2*z^8];
