...
// Magma code for modular curve with label 24.72.5.dl.1

// Other names and/or labels
// Cummins-Pauli label: 24E5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.378

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 11, 4, 21], [9, 14, 10, 15], [9, 22, 22, 3], [23, 12, 18, 5], [23, 14, 2, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.ey.1", "24.36.1.gs.1", "24.36.3.c.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.5.dl.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
