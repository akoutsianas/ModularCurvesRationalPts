...
// Magma code for modular curve with label 16.192.5.bb.1

// Other names and/or labels
// Cummins-Pauli label: 16N5
// Rouse-Sutherland-Zureick-Brown label: 16.192.5.449

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 6, 0, 1], [13, 6, 0, 9], [13, 8, 0, 7], [15, 12, 0, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["16.96.1.f.1", "16.96.2.f.1", "16.96.2.j.1", "16.96.3.ea.1"];
...
// Canonical model
model_0 := [y*w-z*t,2*x^2-y^2-y*z-w^2-w*t,2*x^2+y*z-z^2+w*t-t^2];
...
// Map from the canonical model to the plane model of modular curve with label 16.192.5.bb.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
