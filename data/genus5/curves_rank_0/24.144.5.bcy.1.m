...
// Magma code for modular curve with label 24.144.5.bcy.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.327

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 17, 14, 3], [17, 4, 8, 5], [21, 4, 8, 9], [23, 13, 16, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.2.o.1", "24.72.1.fd.1", "24.72.2.cr.1", "24.72.2.hc.1", "24.72.2.ib.1", "24.72.3.bfx.1", "24.72.3.bgm.1"];
...
//   Coordinate number 1:
map_0_coord_1 := 1*(-5*z+4*t);
//   Coordinate number 2:
map_0_coord_2 := 1*(2*x-4*y);
// Codomain equation:
map_0_codomain := [2*x^4+4*x^3*y-5*x^2*y^2-2*x*y^3+2*y^4+3*x^2*z^2+6*x*y*z^2-6*y^2*z^2+3*z^4];

// Map from the canonical model to the plane model of modular curve with label 24.144.5.bcy.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
