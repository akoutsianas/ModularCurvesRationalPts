...
// Magma code for modular curve with label 68.72.5.e.2

// Other names and/or labels
// Cummins-Pauli label: 34B5
// Rouse-Sutherland-Zureick-Brown label: 68.72.5.13

// Group data
level := 68;
// Elements that, together with Gamma(level), generate the group
gens := [[29, 43, 63, 0], [47, 2, 47, 41]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["34.36.3.c.2", "68.36.1.a.1", "68.36.3.b.1"];
...
// Map from the canonical model to the plane model of modular curve with label 68.72.5.e.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
