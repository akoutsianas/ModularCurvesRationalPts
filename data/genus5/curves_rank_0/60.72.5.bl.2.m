...
// Magma code for modular curve with label 60.72.5.bl.2

// Other names and/or labels
// Cummins-Pauli label: 30F5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.174

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 35, 28, 19], [21, 5, 8, 51], [41, 0, 21, 37], [44, 55, 19, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["30.36.3.c.1", "60.36.0.j.2", "60.36.2.fv.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.5.bl.2
//   Coordinate number 0:
map_1_coord_0 := 1*(v);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*t);
