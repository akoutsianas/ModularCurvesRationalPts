...
// Magma code for modular curve with label 40.96.5.g.2

// Other names and/or labels
// Cummins-Pauli label: 20D5
// Rouse-Sutherland-Zureick-Brown label: 40.96.5.25

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[23, 1, 20, 29], [28, 39, 25, 7], [28, 39, 37, 15], [36, 13, 25, 24]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["20.48.3.f.1", "40.24.1.cc.2", "40.48.1.kg.2", "40.48.3.i.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.96.5.g.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x+z);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
