...
// Magma code for modular curve with label 60.72.5.dw.1

// Other names and/or labels
// Cummins-Pauli label: 30G5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.138

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[31, 35, 59, 38], [41, 50, 47, 31], [48, 5, 1, 39], [49, 40, 11, 49]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["30.36.2.b.1", "60.36.1.fy.1", "60.36.2.fs.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.72.5.dw.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
