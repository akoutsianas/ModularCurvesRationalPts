...
// Magma code for modular curve with label 16.96.5.n.2

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 16.96.5.28

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 6, 0, 13], [7, 0, 0, 15], [9, 2, 0, 3], [13, 4, 12, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.i.2", "16.48.3.c.1", "16.48.3.e.2"];
...
// Map from the canonical model to the plane model of modular curve with label 16.96.5.n.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
