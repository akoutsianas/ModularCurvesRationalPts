...
// Magma code for modular curve with label 56.96.5.bp.1

// Other names and/or labels
// Cummins-Pauli label: 56D5
// Rouse-Sutherland-Zureick-Brown label: 56.96.5.23

// Group data
level := 56;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 38, 46, 25], [10, 15, 9, 16], [20, 23, 43, 48], [32, 25, 7, 38], [35, 24, 46, 45], [50, 33, 29, 30]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["28.48.2.c.1", "56.12.0.bb.1"];
...
// Map from the canonical model to the plane model of modular curve with label 56.96.5.bp.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
