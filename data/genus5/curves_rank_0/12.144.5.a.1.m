...
// Magma code for modular curve with label 12.144.5.a.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 12.144.5.2

// Group data
level := 12;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 6, 0, 1], [5, 0, 0, 1], [5, 0, 0, 5], [7, 0, 0, 7], [7, 0, 6, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['3.12.0.a.1', '4.12.0.a.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["6.72.1.a.1", "12.48.1.a.1", "12.72.1.d.1", "12.72.1.v.1", "12.72.3.i.1", "12.72.3.r.1", "12.72.3.cb.1", "12.72.3.da.1"];
...
// Map from the canonical model to the plane model of modular curve with label 12.144.5.a.1
//   Coordinate number 0:
