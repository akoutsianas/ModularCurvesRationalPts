...
// Magma code for modular curve with label 40.120.5.gi.1

// Other names and/or labels
// Cummins-Pauli label: 20F5
// Rouse-Sutherland-Zureick-Brown label: 40.120.5.179

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[15, 6, 2, 15], [19, 22, 36, 29], [29, 2, 39, 11], [33, 8, 4, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.3.t.1", "40.60.2.g.1", "40.60.2.m.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.120.5.gi.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
