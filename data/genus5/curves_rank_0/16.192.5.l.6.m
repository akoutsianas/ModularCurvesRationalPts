...
// Magma code for modular curve with label 16.192.5.l.6

// Other names and/or labels
// Cummins-Pauli label: 16O5
// Rouse-Sutherland-Zureick-Brown label: 16.192.5.171

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 12, 12, 7], [3, 0, 12, 15], [5, 8, 0, 1], [11, 12, 0, 9], [15, 4, 4, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["8.96.1.g.2", "16.96.2.a.1", "16.96.2.d.1"];
...
// Map from the canonical model to the plane model of modular curve with label 16.192.5.l.6
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
