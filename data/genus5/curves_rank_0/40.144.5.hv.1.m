...
// Magma code for modular curve with label 40.144.5.hv.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.447

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 1, 28, 35], [25, 31, 32, 29], [29, 37, 6, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.v.2", "40.72.1.z.2", "40.72.1.bv.2", "40.72.1.ci.1", "40.72.3.dn.1", "40.72.3.ds.1", "40.72.3.eu.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.hv.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
