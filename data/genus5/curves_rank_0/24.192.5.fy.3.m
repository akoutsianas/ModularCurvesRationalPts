...
// Magma code for modular curve with label 24.192.5.fy.3

// Other names and/or labels
// Cummins-Pauli label: 24Z5
// Rouse-Sutherland-Zureick-Brown label: 24.192.5.1588

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 18, 8, 11], [7, 18, 12, 5], [19, 9, 0, 11], [19, 18, 16, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["24.96.1.dc.3", "24.96.1.dn.1", "24.96.1.ds.2", "24.96.3.fz.2", "24.96.3.gd.1", "24.96.3.gu.2", "24.96.3.gz.4"];
...
model_1 := [432*x^8-864*x^7*y+72*x^6*y^2+72*x^5*y^3-9*x^4*y^4-1440*x^6*z^2-48*x^5*y*z^2+264*x^4*y^2*z^2-36*x^3*y^3*z^2-376*x^4*z^4+408*x^3*y*z^4-78*x^2*y^2*z^4+280*x^2*z^6-84*x*y*z^6-37*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 24.192.5.fy.3
//   Coordinate number 0:
...
map_1_coord_2 := 1*(t);
// Codomain equation:
map_1_codomain := [432*x^8-864*x^7*y+72*x^6*y^2+72*x^5*y^3-9*x^4*y^4-1440*x^6*z^2-48*x^5*y*z^2+264*x^4*y^2*z^2-36*x^3*y^3*z^2-376*x^4*z^4+408*x^3*y*z^4-78*x^2*y^2*z^4+280*x^2*z^6-84*x*y*z^6-37*z^8];
