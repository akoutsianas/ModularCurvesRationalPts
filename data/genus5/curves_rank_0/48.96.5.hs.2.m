...
// Magma code for modular curve with label 48.96.5.hs.2

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.444

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[27, 47, 2, 1], [41, 41, 22, 47], [43, 14, 40, 25], [45, 46, 16, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.bi.2", "24.48.1.kv.2", "48.48.1.gq.2", "48.48.1.hd.2", "48.48.3.bj.2", "48.48.3.bp.2", "48.48.3.dj.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.hs.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*z);
