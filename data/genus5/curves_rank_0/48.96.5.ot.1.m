...
// Magma code for modular curve with label 48.96.5.ot.1

// Other names and/or labels
// Cummins-Pauli label: 48C5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.720

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 4, 0, 5], [5, 31, 24, 11], [7, 10, 12, 17], [17, 4, 24, 13], [25, 35, 36, 29], [41, 16, 12, 11], [43, 4, 36, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
// Canonical model
model_0 := [y*w+x*t+y*t,x*y-2*y^2+w^2-w*t,2*z^2+x*w+y*w-2*x*t+y*t];

// Singular plane model
model_1 := [x^5*z^2+3*x^4*y^2*z+2*x^3*y^4-144*x^3*z^4+108*x*y^4*z^2+36*y^6*z];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.ot.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Codomain equation:
map_1_codomain := [x^5*z^2+3*x^4*y^2*z+2*x^3*y^4-144*x^3*z^4+108*x*y^4*z^2+36*y^6*z];
