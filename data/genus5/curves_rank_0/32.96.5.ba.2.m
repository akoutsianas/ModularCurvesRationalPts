...
// Magma code for modular curve with label 32.96.5.ba.2

// Other names and/or labels
// Cummins-Pauli label: 32D5
// Rouse-Sutherland-Zureick-Brown label: 32.96.5.36

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 28, 24, 7], [3, 13, 8, 23], [3, 14, 0, 15], [7, 6, 24, 25], [19, 11, 16, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.v.2", "32.48.3.c.2", "32.48.3.e.2"];
...
// Map from the canonical model to the plane model of modular curve with label 32.96.5.ba.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
