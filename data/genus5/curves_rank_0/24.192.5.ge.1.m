...
// Magma code for modular curve with label 24.192.5.ge.1

// Other names and/or labels
// Cummins-Pauli label: 24AA5
// Rouse-Sutherland-Zureick-Brown label: 24.192.5.2454

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 18, 0, 5], [5, 17, 0, 17], [13, 1, 0, 23], [17, 1, 0, 11], [23, 10, 0, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["24.96.1.de.3", "24.96.3.gg.1", "24.96.3.gj.2"];
...
// Canonical model
model_0 := [6*x^2-6*x*z+w*t,6*x^2-6*y^2-6*z^2+t^2,6*x^2+6*x*z+6*z^2+w^2+w*t-t^2];
...
// Map from the canonical model to the plane model of modular curve with label 24.192.5.ge.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x-z);
//   Coordinate number 1:
