...
// Magma code for modular curve with label 60.72.5.bi.2

// Other names and/or labels
// Cummins-Pauli label: 30F5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.176

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 30, 57, 17], [7, 35, 22, 19], [13, 40, 22, 59], [34, 25, 25, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["30.36.3.c.1", "60.36.0.i.1", "60.36.2.fu.2"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.5.bi.2
//   Coordinate number 0:
map_1_coord_0 := 1*(v);
//   Coordinate number 1:
map_1_coord_1 := 1*(u);
