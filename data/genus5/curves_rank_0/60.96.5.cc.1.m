...
// Magma code for modular curve with label 60.96.5.cc.1

// Other names and/or labels
// Cummins-Pauli label: 20D5
// Rouse-Sutherland-Zureick-Brown label: 60.96.5.89

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 0, 51, 37], [27, 5, 14, 49], [29, 15, 35, 56]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["20.48.3.g.1", "30.24.1.h.2", "60.48.1.bz.1", "60.48.3.co.2"];
...
// Canonical model
model_0 := [x^2+x*y+2*x*z+x*w+2*y^2-2*y*z-2*z^2+w^2+t^2,3*x^2+2*x*y-2*x*z-2*y^2-4*y*z+2*z^2,3*x^2-x*y-2*x*z-x*t+7*y^2+2*y*z+2*z^2-2*w*t-t^2];
...
// Map from the canonical model to the plane model of modular curve with label 60.96.5.cc.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
