...
// Magma code for modular curve with label 60.144.5.pr.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.793

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 35, 34, 9], [17, 45, 14, 31], [23, 0, 4, 43], [57, 20, 52, 43]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.bc.1", "60.72.1.bx.2", "60.72.1.cd.1", "60.72.1.eb.2", "60.72.3.qo.2", "60.72.3.qt.2", "60.72.3.zb.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.pr.2
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
