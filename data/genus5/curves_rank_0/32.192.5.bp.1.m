...
// Magma code for modular curve with label 32.192.5.bp.1

// Other names and/or labels
// Cummins-Pauli label: 32O5
// Rouse-Sutherland-Zureick-Brown label: 32.192.5.690

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 4, 16, 9], [15, 29, 0, 1], [23, 28, 0, 15], [29, 23, 16, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["16.96.2.j.1", "32.96.1.b.2", "32.96.2.k.2"];
...
// Map from the canonical model to the plane model of modular curve with label 32.192.5.bp.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
