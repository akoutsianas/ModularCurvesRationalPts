...
// Magma code for modular curve with label 40.144.5.ed.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.322

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 5, 32, 1], [3, 9, 4, 13], [7, 36, 36, 27], [17, 14, 20, 1], [31, 31, 32, 5], [31, 38, 20, 39]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.l.1", "40.72.1.j.2", "40.72.1.v.2", "40.72.1.ct.2", "40.72.3.bb.1", "40.72.3.cr.2", "40.72.3.fb.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.ed.2
//   Coordinate number 0:
