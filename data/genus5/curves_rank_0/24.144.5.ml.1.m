...
// Magma code for modular curve with label 24.144.5.ml.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1302

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 15, 0, 7], [17, 11, 22, 11], [23, 13, 16, 1], [23, 23, 2, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.de.1", "24.72.2.h.1", "24.72.2.bd.1", "24.72.2.ev.1", "24.72.2.gb.1", "24.72.3.bfx.1", "24.72.3.bhd.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.ml.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y+w);
