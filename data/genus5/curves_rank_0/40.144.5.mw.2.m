...
// Magma code for modular curve with label 40.144.5.mw.2

// Other names and/or labels
// Cummins-Pauli label: 40L5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.642

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 6, 24, 19], [11, 6, 4, 13], [21, 2, 32, 31], [33, 19, 26, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["40.72.1.cn.1", "40.72.3.fu.2", "40.72.3.gd.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.mw.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
