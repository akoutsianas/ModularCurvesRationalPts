...
// Magma code for modular curve with label 40.144.5.hq.1

// Other names and/or labels
// Cummins-Pauli label: 40M5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.611

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 3, 4, 5], [1, 20, 8, 33], [17, 16, 8, 35], [19, 20, 0, 19], [19, 20, 32, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["40.72.1.v.2", "40.72.3.cd.1", "40.72.3.cg.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.hq.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
