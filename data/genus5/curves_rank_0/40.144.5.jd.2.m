...
// Magma code for modular curve with label 40.144.5.jd.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.435

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 2, 8, 31], [21, 31, 30, 7], [23, 1, 10, 9], [27, 21, 16, 37], [39, 34, 12, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.be.1", "40.72.1.z.2", "40.72.1.bn.1", "40.72.1.cq.2", "40.72.3.cu.1", "40.72.3.dg.2", "40.72.3.fb.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.jd.2
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
