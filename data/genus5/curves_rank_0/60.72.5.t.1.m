...
// Magma code for modular curve with label 60.72.5.t.1

// Other names and/or labels
// Cummins-Pauli label: 30F5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.134

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 45, 48, 13], [12, 25, 47, 51], [27, 25, 49, 54], [37, 10, 53, 1], [53, 0, 9, 43]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["30.36.2.b.1", "60.36.0.i.1", "60.36.3.a.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.5.t.1
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
