...
// Magma code for modular curve with label 24.144.5.rs.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1215

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 20, 8, 5], [15, 11, 16, 9], [19, 12, 6, 5], [19, 21, 0, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.dw.1", "24.72.2.cp.1", "24.72.2.dy.1", "24.72.2.eq.1", "24.72.2.ff.1", "24.72.3.bcv.1", "24.72.3.bdi.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.rs.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+w);
//   Coordinate number 1:
