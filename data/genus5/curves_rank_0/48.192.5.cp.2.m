...
// Magma code for modular curve with label 48.192.5.cp.2

// Other names and/or labels
// Cummins-Pauli label: 16O5
// Rouse-Sutherland-Zureick-Brown label: 48.192.5.1966

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 16, 8, 33], [23, 24, 0, 19], [29, 30, 20, 19], [33, 44, 8, 27], [35, 34, 28, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["16.96.3.bc.1", "24.96.1.z.1", "48.96.3.be.1"];
...
// Canonical model
model_0 := [6*y*z+w*t,6*y^2-6*z^2-w^2+4*w*t+t^2,12*x^2+6*z^2-2*w*t-t^2];
...
// Map from the canonical model to the plane model of modular curve with label 48.192.5.cp.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
