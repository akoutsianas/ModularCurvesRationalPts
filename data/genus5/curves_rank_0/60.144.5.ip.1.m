...
// Magma code for modular curve with label 60.144.5.ip.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.535

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 35, 2, 1], [17, 15, 22, 13], [37, 25, 12, 43]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.j.1", "60.72.1.bb.2", "60.72.1.dn.1", "60.72.3.kt.1", "60.72.3.om.1", "60.72.3.qq.2", "60.72.3.xx.2"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.ip.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
