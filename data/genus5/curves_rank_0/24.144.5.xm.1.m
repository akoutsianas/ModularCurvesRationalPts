...
// Magma code for modular curve with label 24.144.5.xm.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1178

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 4, 4, 5], [7, 22, 22, 5], [13, 15, 12, 23], [19, 9, 12, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.eo.1", "24.72.2.k.1", "24.72.2.bm.1", "24.72.2.he.1", "24.72.2.in.1", "24.72.3.bcp.1", "24.72.3.bdo.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.xm.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
