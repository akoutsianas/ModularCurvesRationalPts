...
// Magma code for modular curve with label 24.144.5.my.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1312

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 7, 10, 23], [5, 18, 18, 11], [17, 4, 4, 13], [19, 9, 12, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.di.1", "24.72.2.k.1", "24.72.2.bq.1", "24.72.2.es.1", "24.72.2.ft.1", "24.72.3.bfv.1", "24.72.3.bgu.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.my.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
