...
// Magma code for modular curve with label 60.120.5.m.1

// Other names and/or labels
// Cummins-Pauli label: 20E5
// Rouse-Sutherland-Zureick-Brown label: 60.120.5.182

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[31, 20, 10, 51], [37, 56, 14, 53], [41, 48, 29, 19], [49, 0, 5, 49], [55, 44, 3, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['4.6.0.c.1', '15.20.0.b.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["20.60.3.c.1", "30.60.2.b.1", "60.60.2.d.1"];
...
// Canonical model
model_0 := [3*x^2+3*x*y-3*y^2+z^2-3*z*w+z*t+t^2,4*x^2-x*y+y^2+3*z*t-3*w^2+3*t^2,5*x*z-3*x*w+x*t-y*z-2*y*t];
...
//   Coordinate number 0:
map_0_coord_0 := 1*(-5*x-z-w);
//   Coordinate number 1:
map_0_coord_1 := 1*(-4*z+w);
//   Coordinate number 2:
map_0_coord_2 := 1*(-2*z+3*w);
// Codomain equation:
...
// Map from the canonical model to the plane model of modular curve with label 60.120.5.m.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
