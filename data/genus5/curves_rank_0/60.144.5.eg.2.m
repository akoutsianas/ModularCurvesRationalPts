...
// Magma code for modular curve with label 60.144.5.eg.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.522

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 20, 25, 39], [31, 40, 44, 37], [39, 40, 29, 53], [49, 0, 8, 37], [59, 40, 41, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['5.12.0.a.2', '12.12.0.h.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["20.72.1.f.1", "60.72.1.w.2", "60.72.1.dv.1", "60.72.3.et.1", "60.72.3.hu.1", "60.72.3.oh.2", "60.72.3.yu.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.eg.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(x+w);
