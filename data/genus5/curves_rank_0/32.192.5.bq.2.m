...
// Magma code for modular curve with label 32.192.5.bq.2

// Other names and/or labels
// Cummins-Pauli label: 32O5
// Rouse-Sutherland-Zureick-Brown label: 32.192.5.682

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 12, 16, 23], [15, 19, 16, 9], [29, 15, 0, 15], [31, 4, 16, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["16.96.2.k.2", "32.96.1.b.2", "32.96.2.k.2"];
...
// Canonical model
model_0 := [y*z-x*w,x^2-x*y-2*z^2-2*z*w+t^2,x*y+y^2+2*z*w-2*w^2+t^2];
...
// Map from the canonical model to the plane model of modular curve with label 32.192.5.bq.2
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
