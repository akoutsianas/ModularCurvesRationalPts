...
// Magma code for modular curve with label 20.144.5.s.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 20.144.5.36

// Group data
level := 20;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 15, 16, 19], [11, 19, 10, 19], [17, 7, 6, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.d.1", "20.72.1.i.2", "20.72.1.o.2", "20.72.3.n.1", "20.72.3.q.2", "20.72.3.x.1", "20.72.3.bg.1"];
...
model_1 := [900*x^8+4325*x^6*y^2+3000*x^6*z^2+6400*x^4*y^4+10640*x^4*y^2*z^2+3760*x^4*z^4+3500*x^2*y^6+10060*x^2*y^4*z^2+8660*x^2*y^2*z^4+2100*x^2*z^6+625*y^8+2700*y^6*z^2+3966*y^4*z^4+2332*y^2*z^6+441*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 20.144.5.s.2
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
...
map_1_coord_2 := 1*(t);
// Codomain equation:
map_1_codomain := [900*x^8+4325*x^6*y^2+3000*x^6*z^2+6400*x^4*y^4+10640*x^4*y^2*z^2+3760*x^4*z^4+3500*x^2*y^6+10060*x^2*y^4*z^2+8660*x^2*y^2*z^4+2100*x^2*z^6+625*y^8+2700*y^6*z^2+3966*y^4*z^4+2332*y^2*z^6+441*z^8];
