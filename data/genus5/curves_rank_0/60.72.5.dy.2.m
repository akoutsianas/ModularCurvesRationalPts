...
// Magma code for modular curve with label 60.72.5.dy.2

// Other names and/or labels
// Cummins-Pauli label: 30G5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.66

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[14, 25, 25, 52], [38, 5, 31, 23], [41, 10, 4, 19], [44, 5, 35, 16]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["15.36.2.b.2", "60.36.1.fy.1", "60.36.2.fu.2"];
...
// Map from the canonical model to the plane model of modular curve with label 60.72.5.dy.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
