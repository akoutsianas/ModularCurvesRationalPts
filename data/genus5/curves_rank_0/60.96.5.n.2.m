...
// Magma code for modular curve with label 60.96.5.n.2

// Other names and/or labels
// Cummins-Pauli label: 20D5
// Rouse-Sutherland-Zureick-Brown label: 60.96.5.79

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 55, 8, 31], [19, 5, 28, 49], [22, 5, 57, 53], [23, 40, 52, 39]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["20.48.3.f.1", "60.24.1.f.1", "60.48.1.bz.2", "60.48.3.cp.2"];
...
// Canonical model
model_0 := [x^2-x*y+x*z+y*z,19*x^2+11*x*y-11*x*z-7*y^2+5*y*z+2*y*w-7*z^2+2*z*w+2*w^2+2*t^2,8*x^2-8*x*y+8*x*z+7*y^2-23*y*z-2*y*w+y*t+7*z^2-2*z*w+z*t-2*w^2+2*w*t-3*t^2];
...
//   Coordinate number 0:
map_0_coord_0 := 1*(-12*y-12*z-9*w-3*t);
//   Coordinate number 1:
map_0_coord_1 := 1*(-8*y-8*z-w+3*t);
//   Coordinate number 2:
map_0_coord_2 := 1*(-7*y-7*z+w-3*t);
// Codomain equation:
...
// Map from the canonical model to the plane model of modular curve with label 60.96.5.n.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
