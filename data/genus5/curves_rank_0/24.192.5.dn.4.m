...
// Magma code for modular curve with label 24.192.5.dn.4

// Other names and/or labels
// Cummins-Pauli label: 24Z5
// Rouse-Sutherland-Zureick-Brown label: 24.192.5.1480

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 15, 4, 11], [5, 21, 0, 11], [7, 9, 16, 1], [19, 12, 8, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["24.96.1.cr.2", "24.96.1.dk.4", "24.96.1.do.4", "24.96.3.cq.1", "24.96.3.ct.2", "24.96.3.gr.2", "24.96.3.gv.2"];
...
// Map from the canonical model to the plane model of modular curve with label 24.192.5.dn.4
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
