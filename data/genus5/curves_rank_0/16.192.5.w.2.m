...
// Magma code for modular curve with label 16.192.5.w.2

// Other names and/or labels
// Cummins-Pauli label: 16O5
// Rouse-Sutherland-Zureick-Brown label: 16.192.5.313

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 4, 0, 9], [7, 6, 12, 11], [9, 14, 4, 13], [15, 14, 0, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["8.96.1.h.2", "16.96.3.bc.1", "16.96.3.bd.1"];
...
// Map from the canonical model to the plane model of modular curve with label 16.192.5.w.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
