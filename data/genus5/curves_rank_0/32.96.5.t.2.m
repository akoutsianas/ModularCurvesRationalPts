...
// Magma code for modular curve with label 32.96.5.t.2

// Other names and/or labels
// Cummins-Pauli label: 32C5
// Rouse-Sutherland-Zureick-Brown label: 32.96.5.42

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 5, 8, 19], [11, 13, 24, 11], [13, 21, 24, 23], [13, 29, 24, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.w.2", "32.48.3.a.2", "32.48.3.c.1"];
...
// Map from the canonical model to the plane model of modular curve with label 32.96.5.t.2
//   Coordinate number 0:
