...
// Magma code for modular curve with label 60.144.5.px.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.840

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 25, 46, 13], [23, 25, 50, 29], [27, 10, 26, 41], [27, 10, 40, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.bf.1", "60.72.1.bz.2", "60.72.1.cd.1", "60.72.1.ee.2", "60.72.3.qq.2", "60.72.3.qu.2", "60.72.3.zd.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.px.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
