...
// Magma code for modular curve with label 60.144.5.fl.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.790

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 35, 24, 53], [11, 35, 28, 23], [13, 30, 24, 17], [41, 10, 56, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.o.1", "60.72.1.n.2", "60.72.1.bx.1", "60.72.1.do.1", "60.72.3.hu.1", "60.72.3.qo.2", "60.72.3.yd.2"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.fl.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
