...
// Magma code for modular curve with label 24.144.5.ky.1

// Other names and/or labels
// Cummins-Pauli label: 24U5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1012

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 7, 14, 3], [9, 11, 20, 3], [11, 9, 0, 5], [15, 11, 16, 21], [17, 12, 6, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.ct.1", "24.72.3.zg.1", "24.72.3.zj.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.ky.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
