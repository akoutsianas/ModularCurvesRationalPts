...
// Magma code for modular curve with label 48.192.5.p.1

// Other names and/or labels
// Cummins-Pauli label: 16O5
// Rouse-Sutherland-Zureick-Brown label: 48.192.5.1305

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 8, 40, 41], [3, 20, 40, 33], [5, 16, 32, 33], [9, 8, 16, 7], [47, 28, 28, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["16.96.2.a.1", "24.96.1.x.1", "48.96.2.d.1"];
...
model_1 := [162*x^8+108*x^6*y^2+108*x^6*z^2+9*x^4*y^4+36*x^4*y^2*z^2+36*x^4*z^4-6*x^2*y^4*z^2+12*x^2*y^2*z^4+12*x^2*z^6+y^4*z^4+4*y^2*z^6+2*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 48.192.5.p.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*z);
...
map_1_coord_2 := 1*(w);
// Codomain equation:
map_1_codomain := [162*x^8+108*x^6*y^2+108*x^6*z^2+9*x^4*y^4+36*x^4*y^2*z^2+36*x^4*z^4-6*x^2*y^4*z^2+12*x^2*y^2*z^4+12*x^2*z^6+y^4*z^4+4*y^2*z^6+2*z^8];
