...
// Magma code for modular curve with label 40.144.5.cm.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.485

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 18, 20, 21], [13, 20, 14, 9], [19, 23, 30, 7], [29, 15, 12, 7], [39, 12, 16, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.i.1", "40.72.1.j.2", "40.72.1.r.2", "40.72.1.cl.2", "40.72.3.s.1", "40.72.3.cm.2", "40.72.3.eu.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.cm.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
