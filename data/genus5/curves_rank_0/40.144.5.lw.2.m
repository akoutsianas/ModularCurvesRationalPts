...
// Magma code for modular curve with label 40.144.5.lw.2

// Other names and/or labels
// Cummins-Pauli label: 40N5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.665

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 10, 0, 27], [17, 17, 30, 19], [21, 1, 14, 3], [23, 20, 0, 3], [35, 18, 6, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["40.72.1.ct.2", "40.72.3.fp.2", "40.72.3.fs.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.lw.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
