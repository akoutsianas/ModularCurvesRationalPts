...
// Magma code for modular curve with label 60.72.5.ej.2

// Other names and/or labels
// Cummins-Pauli label: 30G5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.100

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 0, 18, 37], [33, 50, 34, 3], [43, 35, 16, 19], [49, 45, 15, 56]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["30.36.1.q.1", "60.36.2.fs.2", "60.36.2.fv.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.72.5.ej.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
