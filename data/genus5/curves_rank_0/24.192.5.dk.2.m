...
// Magma code for modular curve with label 24.192.5.dk.2

// Other names and/or labels
// Cummins-Pauli label: 24Z5
// Rouse-Sutherland-Zureick-Brown label: 24.192.5.1605

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 9, 0, 19], [13, 18, 0, 13], [17, 15, 0, 7], [19, 7, 0, 5], [19, 10, 0, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["24.96.1.cr.3", "24.96.1.de.3", "24.96.1.dq.3", "24.96.3.cn.1", "24.96.3.cr.1", "24.96.3.gl.4", "24.96.3.gx.4"];
...
// Map from the canonical model to the plane model of modular curve with label 24.192.5.dk.2
//   Coordinate number 0:
