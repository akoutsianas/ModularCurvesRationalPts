...
// Magma code for modular curve with label 60.72.5.en.1

// Other names and/or labels
// Cummins-Pauli label: 30G5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.56

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[29, 40, 37, 49], [31, 40, 43, 59], [39, 35, 47, 36], [49, 0, 54, 37], [49, 45, 42, 49]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['5.12.0.a.2', '12.6.0.i.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["15.36.2.a.2", "60.36.1.gb.1", "60.36.2.fu.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.72.5.en.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
