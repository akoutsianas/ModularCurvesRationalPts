...
// Magma code for modular curve with label 24.144.5.wx.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1164

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 12, 6, 23], [19, 9, 18, 5], [19, 12, 18, 13], [23, 20, 22, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.ek.1", "24.72.2.g.1", "24.72.2.y.1", "24.72.2.hf.1", "24.72.2.it.1", "24.72.3.bcp.1", "24.72.3.bdv.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.wx.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*w);
