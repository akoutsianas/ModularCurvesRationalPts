...
// Magma code for modular curve with label 48.192.5.bs.2

// Other names and/or labels
// Cummins-Pauli label: 16O5
// Rouse-Sutherland-Zureick-Brown label: 48.192.5.189

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[21, 32, 44, 1], [23, 34, 40, 45], [25, 2, 32, 27], [27, 32, 28, 31], [39, 38, 32, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["8.96.1.f.2", "48.96.2.b.1", "48.96.2.d.1"];
...
// Canonical model
model_0 := [z*w+y*t,y^2-w^2-2*z*t,12*x^2+y^2+z^2+w^2+t^2];
...
// Map from the canonical model to the plane model of modular curve with label 48.192.5.bs.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
