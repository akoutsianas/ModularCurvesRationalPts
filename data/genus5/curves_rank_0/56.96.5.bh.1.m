...
// Magma code for modular curve with label 56.96.5.bh.1

// Other names and/or labels
// Cummins-Pauli label: 28E5
// Rouse-Sutherland-Zureick-Brown label: 56.96.5.28

// Group data
level := 56;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 38, 0, 15], [17, 36, 0, 53], [25, 48, 28, 9], [27, 44, 0, 39], [30, 41, 21, 38], [39, 38, 14, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["28.48.2.c.1", "56.12.0.v.1", "56.48.2.m.1", "56.48.3.b.1"];
...
// Map from the canonical model to the plane model of modular curve with label 56.96.5.bh.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
