...
// Magma code for modular curve with label 32.192.5.l.2

// Other names and/or labels
// Cummins-Pauli label: 32N5
// Rouse-Sutherland-Zureick-Brown label: 32.192.5.471

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 4, 16, 13], [7, 18, 0, 15], [9, 12, 16, 19], [21, 11, 8, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["16.96.1.i.1", "32.96.3.z.1", "32.96.3.bb.1"];
...
// Map from the canonical model to the plane model of modular curve with label 32.192.5.l.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
