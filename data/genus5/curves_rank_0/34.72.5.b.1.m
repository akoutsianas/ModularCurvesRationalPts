...
// Magma code for modular curve with label 34.72.5.b.1

// Other names and/or labels
// Cummins-Pauli label: 34B5
// Rouse-Sutherland-Zureick-Brown label: 34.72.5.4

// Group data
level := 34;
// Elements that, together with Gamma(level), generate the group
gens := [[26, 17, 17, 1], [32, 9, 17, 14]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["17.36.1.a.2", "34.36.3.b.1", "34.36.3.c.2"];
...
// Map from the canonical model to the plane model of modular curve with label 34.72.5.b.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y+z);
