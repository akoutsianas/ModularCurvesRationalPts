...
// Magma code for modular curve with label 60.144.5.fj.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.829

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 40, 8, 43], [17, 25, 58, 37], [29, 55, 16, 57]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.n.1", "60.72.1.l.2", "60.72.1.bz.1", "60.72.1.dp.1", "60.72.3.ht.1", "60.72.3.qp.2", "60.72.3.yd.2"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.fj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*z);
