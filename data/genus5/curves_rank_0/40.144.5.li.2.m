...
// Magma code for modular curve with label 40.144.5.li.2

// Other names and/or labels
// Cummins-Pauli label: 20J5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.330

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 25, 10, 31], [7, 36, 24, 19], [27, 12, 18, 1], [31, 12, 12, 11], [31, 31, 30, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.bp.1", "40.72.1.ct.2", "40.72.3.fm.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.li.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
