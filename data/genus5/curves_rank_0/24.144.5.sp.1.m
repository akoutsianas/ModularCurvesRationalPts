...
// Magma code for modular curve with label 24.144.5.sp.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1205

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 22, 2, 9], [11, 1, 22, 13], [15, 17, 16, 21], [15, 20, 2, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.ds.1", "24.72.2.cs.1", "24.72.2.dd.1", "24.72.2.ex.1", "24.72.2.fv.1", "24.72.3.bdb.1", "24.72.3.bdz.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.sp.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+w);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
