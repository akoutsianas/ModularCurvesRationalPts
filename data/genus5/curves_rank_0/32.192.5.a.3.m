...
// Magma code for modular curve with label 32.192.5.a.3

// Other names and/or labels
// Cummins-Pauli label: 32N5
// Rouse-Sutherland-Zureick-Brown label: 32.192.5.64

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 6, 16, 29], [7, 4, 0, 27], [17, 0, 16, 29], [23, 2, 16, 5], [25, 22, 0, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["16.96.1.f.2", "32.96.2.i.2", "32.96.2.l.1"];
...
// Canonical model
model_0 := [y*w+z*t,y*z-z*w+y*t+w*t,2*x^2-y*z+w*t];
...
// Map from the canonical model to the plane model of modular curve with label 32.192.5.a.3
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
