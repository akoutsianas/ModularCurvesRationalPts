...
// Magma code for modular curve with label 60.72.5.ei.2

// Other names and/or labels
// Cummins-Pauli label: 30G5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.127

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 25, 46, 59], [11, 35, 58, 17], [21, 5, 59, 24], [23, 20, 2, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["30.36.2.b.2", "60.36.1.ga.1", "60.36.2.fs.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.72.5.ei.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
