...
// Magma code for modular curve with label 60.120.5.eg.1

// Other names and/or labels
// Cummins-Pauli label: 20E5
// Rouse-Sutherland-Zureick-Brown label: 60.120.5.172

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 37, 32, 3], [31, 39, 14, 23], [35, 16, 14, 45], [47, 44, 24, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.2.b.1", "60.60.2.h.1", "60.60.3.bf.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.120.5.eg.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
