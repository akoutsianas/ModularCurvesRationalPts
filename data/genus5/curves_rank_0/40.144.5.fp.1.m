...
// Magma code for modular curve with label 40.144.5.fp.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.365

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 28, 28, 29], [15, 4, 4, 15], [25, 11, 12, 39], [37, 12, 36, 23], [39, 3, 12, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.t.1", "40.72.1.s.2", "40.72.1.bd.1", "40.72.1.ca.1", "40.72.3.bq.1", "40.72.3.cx.1", "40.72.3.ef.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.fp.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
