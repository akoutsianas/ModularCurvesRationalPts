...
// Magma code for modular curve with label 60.144.5.br.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.769

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 40, 48, 23], [19, 20, 8, 9], [21, 50, 58, 53], [23, 10, 48, 29], [41, 20, 56, 51]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.d.1", "60.72.1.b.1", "60.72.1.cd.1", "60.72.1.do.1", "60.72.3.cb.1", "60.72.3.qt.1", "60.72.3.yd.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.br.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
