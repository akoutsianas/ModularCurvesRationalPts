...
// Magma code for modular curve with label 60.72.5.dv.2

// Other names and/or labels
// Cummins-Pauli label: 30G5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.50

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[6, 35, 59, 9], [27, 10, 35, 9], [38, 45, 15, 4], [39, 40, 13, 21], [59, 10, 43, 49]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["15.36.2.a.1", "60.36.1.fy.1", "60.36.2.fv.2"];
...
// Map from the canonical model to the plane model of modular curve with label 60.72.5.dv.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
