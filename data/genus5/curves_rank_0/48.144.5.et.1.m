...
// Magma code for modular curve with label 48.144.5.et.1

// Other names and/or labels
// Cummins-Pauli label: 48H5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.778

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 26, 40, 31], [21, 47, 10, 27], [29, 20, 16, 17], [31, 14, 8, 29], [37, 25, 46, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.2.hm.2", "48.72.0.c.2", "48.72.3.z.1"];
...
// Embedded model
model_0 := [x*t-w*v,y*t+z*v,t^2-2*y*v,w*t+x*v-y*v-u*v,x*y+y^2+x*v,x*y-y^2-y*v-u*v,x^2-x*y+w^2-x*u,z*t-x*v-y*v-u*v,x^2+x*y-z*w+x*u,z^2-z*w+w*t,z*w+y*u-y*v-u*v,x*z+y*w,x*z+y*z-x*t,x*z+x*w-x*t-z*u+w*u,x*z-y*z+y*t+t*u,x^2-y^2-t^2-2*u^2-v^2-r^2];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.et.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
map_1_coord_1 := 1*(r);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.et.1
//   Coordinate number 0:
map_2_coord_0 := 1*(t);
//   Coordinate number 1:
