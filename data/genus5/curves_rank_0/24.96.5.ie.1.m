...
// Magma code for modular curve with label 24.96.5.ie.1

// Other names and/or labels
// Cummins-Pauli label: 24J5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.135

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 16, 6, 17], [11, 22, 18, 17], [13, 7, 18, 7], [13, 16, 0, 1], [23, 5, 6, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["12.48.2.e.1", "24.24.0.ew.1", "24.48.2.p.1", "24.48.3.co.1"];
...
model_1 := [4*x^4*z^4-16*x^3*y^2*z^3+21*x^2*y^4*z^2-24*x^2*y^2*z^4-12*x^2*z^6-10*x*y^6*z+48*x*y^4*z^3+24*x*y^2*z^5+y^8-15*y^6*z^2-48*y^4*z^4+36*y^2*z^6];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.ie.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+w);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
...
// Codomain equation:
map_1_codomain := [4*x^4*z^4-16*x^3*y^2*z^3+21*x^2*y^4*z^2-24*x^2*y^2*z^4-12*x^2*z^6-10*x*y^6*z+48*x*y^4*z^3+24*x*y^2*z^5+y^8-15*y^6*z^2-48*y^4*z^4+36*y^2*z^6];
