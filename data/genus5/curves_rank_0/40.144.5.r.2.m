...
// Magma code for modular curve with label 40.144.5.r.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.406

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 22, 34, 9], [7, 24, 20, 1], [13, 38, 36, 25], [25, 4, 28, 31], [27, 26, 30, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.e.1", "40.72.1.a.2", "40.72.1.bs.1", "40.72.1.bz.1", "40.72.3.d.1", "40.72.3.dq.1", "40.72.3.ef.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.r.2
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
