...
// Magma code for modular curve with label 24.144.5.mb.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.943

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 6, 12, 1], [17, 0, 12, 13], [17, 10, 10, 19], [21, 19, 16, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.dc.1", "24.72.2.i.1", "24.72.2.bh.1", "24.72.2.ep.1", "24.72.2.fx.1", "24.72.3.bfv.1", "24.72.3.bhd.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.mb.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*z);
