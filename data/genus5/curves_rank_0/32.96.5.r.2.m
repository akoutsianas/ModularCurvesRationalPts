...
// Magma code for modular curve with label 32.96.5.r.2

// Other names and/or labels
// Cummins-Pauli label: 32C5
// Rouse-Sutherland-Zureick-Brown label: 32.96.5.45

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 8, 16, 1], [17, 28, 8, 3], [19, 17, 24, 3], [21, 1, 24, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.u.2", "32.48.3.a.1", "32.48.3.c.2"];
...
// Map from the canonical model to the plane model of modular curve with label 32.96.5.r.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(4*z);
