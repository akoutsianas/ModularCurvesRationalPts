...
// Magma code for modular curve with label 24.192.5.cn.2

// Other names and/or labels
// Cummins-Pauli label: 24AB5
// Rouse-Sutherland-Zureick-Brown label: 24.192.5.1742

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 18, 0, 11], [5, 2, 0, 19], [7, 18, 12, 23], [11, 22, 12, 1], [17, 4, 0, 1], [17, 4, 12, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["24.96.1.ck.2", "24.96.3.bn.1", "24.96.3.br.3"];
...
// Map from the canonical model to the plane model of modular curve with label 24.192.5.cn.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
