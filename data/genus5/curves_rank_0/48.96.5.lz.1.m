...
// Magma code for modular curve with label 48.96.5.lz.1

// Other names and/or labels
// Cummins-Pauli label: 16F5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.346

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 42, 10, 17], [33, 43, 44, 15], [35, 26, 22, 5], [35, 46, 34, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.bz.1", "24.48.1.mf.1", "48.48.1.gm.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.lz.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
