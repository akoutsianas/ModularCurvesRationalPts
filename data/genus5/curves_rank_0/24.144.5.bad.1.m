...
// Magma code for modular curve with label 24.144.5.bad.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.934

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 0, 12, 5], [13, 11, 14, 11], [17, 20, 22, 23], [21, 2, 20, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.el.1", "24.72.2.bh.1", "24.72.2.bk.1", "24.72.2.if.1", "24.72.2.jj.1", "24.72.3.bdl.1", "24.72.3.bep.1"];
...
// Canonical model
model_0 := [x*w-y*t,x*y+3*z^2-w^2-2*w*t-t^2,x^2+x*y+y^2+3*z^2-w^2+2*w*t-t^2];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.bad.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*z);
