...
// Magma code for modular curve with label 24.144.5.sv.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.427

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 8, 4, 1], [13, 19, 20, 7], [15, 1, 8, 21], [15, 17, 2, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.2.l.1", "24.72.1.dt.1", "24.72.2.cv.1", "24.72.2.ez.1", "24.72.2.fv.1", "24.72.3.bcz.1", "24.72.3.bdv.1"];
...
map_0_coord_0 := 1*(2*t);
//   Coordinate number 1:
map_0_coord_1 := 1*(2*x-2*y+2*w);
//   Coordinate number 2:
map_0_coord_2 := 1*(-3*x+2*y-4*w);
// Codomain equation:
map_0_codomain := [x^4-3*x^2*y^2+6*y^4+6*x^2*y*z-12*y^3*z+6*x^2*z^2-15*y^2*z^2+6*y*z^3+6*z^4];

// Map from the canonical model to the plane model of modular curve with label 24.144.5.sv.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
