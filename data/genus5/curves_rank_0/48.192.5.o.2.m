...
// Magma code for modular curve with label 48.192.5.o.2

// Other names and/or labels
// Cummins-Pauli label: 16O5
// Rouse-Sutherland-Zureick-Brown label: 48.192.5.1974

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 6, 4, 37], [11, 6, 44, 37], [31, 32, 16, 15], [33, 28, 40, 5], [41, 44, 32, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["16.96.3.m.1", "24.96.1.z.1", "48.96.3.by.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.192.5.o.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
