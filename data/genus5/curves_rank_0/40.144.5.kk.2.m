...
// Magma code for modular curve with label 40.144.5.kk.2

// Other names and/or labels
// Cummins-Pauli label: 40N5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.166

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 21, 24, 19], [25, 6, 16, 25], [27, 4, 28, 23], [37, 22, 18, 11], [39, 23, 38, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.v.2", "40.72.3.fe.1", "40.72.3.fg.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.kk.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
