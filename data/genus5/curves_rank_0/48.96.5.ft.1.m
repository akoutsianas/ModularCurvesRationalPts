...
// Magma code for modular curve with label 48.96.5.ft.1

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.612

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 40, 0, 19], [19, 35, 10, 43], [23, 24, 32, 23], [45, 14, 44, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.y.1", "24.48.1.ds.1", "48.48.1.hk.2", "48.48.1.hl.1", "48.48.3.t.2", "48.48.3.ex.2", "48.48.3.ey.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.ft.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
