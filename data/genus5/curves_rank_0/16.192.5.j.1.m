...
// Magma code for modular curve with label 16.192.5.j.1

// Other names and/or labels
// Cummins-Pauli label: 16O5
// Rouse-Sutherland-Zureick-Brown label: 16.192.5.341

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 10, 4, 9], [11, 6, 12, 7], [15, 6, 0, 9], [15, 8, 8, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["8.96.1.h.1", "16.96.3.m.2", "16.96.3.bc.2"];
...
// Canonical model
model_0 := [y*z-y*t+z*w+w*t,4*x^2+y^2-y*z-y*w-y*t+z*w-z*t-w*t+t^2,4*x^2+y*z+y*w+y*t+z^2-z*w+z*t+w^2+w*t];
...
// Map from the canonical model to the plane model of modular curve with label 16.192.5.j.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
