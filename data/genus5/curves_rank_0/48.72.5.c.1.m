...
// Magma code for modular curve with label 48.72.5.c.1

// Other names and/or labels
// Cummins-Pauli label: 48A5
// Rouse-Sutherland-Zureick-Brown label: 48.72.5.3

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 38, 8, 17], [3, 32, 16, 27], [7, 9, 36, 11], [29, 1, 28, 19], [29, 19, 20, 23], [45, 25, 20, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['3.3.0.a.1', '16.24.1.c.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["16.24.1.c.1", "24.36.2.cw.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.72.5.c.1
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.72.5.c.1
//   Coordinate number 0:
map_2_coord_0 := 1*(v);
//   Coordinate number 1:
