...
// Magma code for modular curve with label 40.144.5.cj.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.335

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 1, 34, 5], [11, 30, 32, 19], [25, 34, 24, 25], [37, 9, 34, 17], [37, 39, 30, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['5.12.0.a.1', '8.12.0.i.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["20.72.3.bk.2", "40.72.1.h.1", "40.72.1.n.2", "40.72.1.ck.1", "40.72.3.u.1", "40.72.3.bc.1", "40.72.3.cj.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.cj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x-z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y+t);
