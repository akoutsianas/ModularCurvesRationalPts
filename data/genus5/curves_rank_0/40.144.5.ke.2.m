...
// Magma code for modular curve with label 40.144.5.ke.2

// Other names and/or labels
// Cummins-Pauli label: 40N5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.691

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 10, 36, 7], [13, 21, 32, 7], [21, 37, 22, 11], [31, 28, 28, 31], [39, 8, 8, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["40.72.1.cq.2", "40.72.3.fe.1", "40.72.3.fo.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.ke.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
