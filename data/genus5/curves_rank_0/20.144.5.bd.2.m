...
// Magma code for modular curve with label 20.144.5.bd.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 20.144.5.71

// Group data
level := 20;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 11, 14, 11], [9, 10, 0, 9], [17, 0, 18, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.h.2", "20.72.1.l.1", "20.72.1.u.2", "20.72.3.u.2", "20.72.3.y.2", "20.72.3.be.1", "20.72.3.bn.1"];
...
// Map from the canonical model to the plane model of modular curve with label 20.144.5.bd.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
