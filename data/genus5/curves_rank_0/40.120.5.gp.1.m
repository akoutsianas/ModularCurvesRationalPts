...
// Magma code for modular curve with label 40.120.5.gp.1

// Other names and/or labels
// Cummins-Pauli label: 20F5
// Rouse-Sutherland-Zureick-Brown label: 40.120.5.86

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 18, 12, 9], [5, 37, 22, 35], [7, 28, 36, 13], [27, 8, 2, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.2.d.1", "40.60.2.j.1", "40.60.3.cg.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.120.5.gp.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
