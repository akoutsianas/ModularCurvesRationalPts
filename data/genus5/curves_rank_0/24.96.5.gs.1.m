...
// Magma code for modular curve with label 24.96.5.gs.1

// Other names and/or labels
// Cummins-Pauli label: 24J5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.177

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 20, 12, 17], [5, 19, 0, 11], [11, 2, 0, 23], [11, 16, 6, 5], [17, 2, 6, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.24.0.du.1", "24.48.2.k.1", "24.48.2.l.1", "24.48.3.cl.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.gs.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
