...
// Magma code for modular curve with label 16.192.5.k.1

// Other names and/or labels
// Cummins-Pauli label: 16O5
// Rouse-Sutherland-Zureick-Brown label: 16.192.5.202

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 2, 0, 1], [3, 6, 8, 1], [7, 0, 0, 15], [7, 6, 0, 9], [11, 2, 8, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["8.96.1.g.1", "16.96.2.f.1", "16.96.2.g.1"];
...
// Canonical model
model_0 := [z*w+y*t,2*x^2-z*w,y^2+2*y*z-z^2+w^2+2*w*t-t^2];
...
// Map from the canonical model to the plane model of modular curve with label 16.192.5.k.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
