...
// Magma code for modular curve with label 20.96.5.a.2

// Other names and/or labels
// Cummins-Pauli label: 20D5
// Rouse-Sutherland-Zureick-Brown label: 20.96.5.3

// Group data
level := 20;
// Elements that, together with Gamma(level), generate the group
gens := [[6, 1, 15, 3], [9, 0, 0, 9], [11, 15, 9, 14], [17, 8, 16, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['4.8.0.a.1', '5.12.0.a.2']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["10.24.1.a.2", "20.48.1.b.2", "20.48.3.e.1", "20.48.3.i.2"];
...
// Canonical model
model_0 := [2*x^2-4*x*y-2*x*z+2*x*w-2*y^2-2*y*z+2*y*w-z^2+2*z*w-w^2,2*x^2+6*x*y+3*x*z-3*x*w-2*y^2-2*y*z+2*y*w-z*w-t^2,11*x^2-2*x*y-x*z+x*w+4*y^2+4*y*z-4*y*w+2*z^2-4*z*w-z*t+2*w^2-w*t+t^2];
...
// Map from the canonical model to the plane model of modular curve with label 20.96.5.a.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
