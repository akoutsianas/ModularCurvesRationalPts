...
// Magma code for modular curve with label 60.144.5.ic.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.812

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 10, 26, 11], [33, 25, 2, 1], [41, 5, 46, 47]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.v.2", "30.72.1.h.1", "60.72.1.bu.2", "60.72.1.dj.1", "60.72.3.kq.1", "60.72.3.nc.1", "60.72.3.ya.2"];
...
// Canonical model
model_0 := [x*z+y*z+z^2+w^2,x^2+2*x*y+y^2-x*z-y*z+2*z^2-w^2+x*t+y*t+t^2,2*x^2-x*y+2*y^2-x*z-y*z+2*z^2+2*w^2];
