...
// Magma code for modular curve with label 24.144.5.xf.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1118

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 2, 14, 7], [9, 1, 4, 3], [15, 20, 14, 21], [23, 1, 8, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.em.1", "24.72.2.k.1", "24.72.2.bp.1", "24.72.2.hb.1", "24.72.2.ii.1", "24.72.3.bcs.1", "24.72.3.bdt.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.xf.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
