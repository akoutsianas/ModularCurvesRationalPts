...
// Magma code for modular curve with label 60.144.5.hu.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.909

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[51, 20, 34, 17], [53, 30, 22, 29], [59, 55, 28, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.ba.2", "60.72.1.bq.2", "60.72.1.cd.2", "60.72.1.dk.2", "60.72.3.kn.1", "60.72.3.my.2", "60.72.3.xy.2"];
...
model_1 := [5625*x^8+1500*x^6*y^2-4500*x^6*z^2+2350*x^4*y^4-6750*x^4*y^2*z^2+1350*x^4*z^4+300*x^2*y^6-1800*x^2*y^4*z^2+1320*x^2*y^2*z^4-180*x^2*z^6+225*y^8-270*y^6*z^2+279*y^4*z^4-54*y^2*z^6+9*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.hu.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
...
map_1_coord_2 := 1*(t);
// Codomain equation:
map_1_codomain := [5625*x^8+1500*x^6*y^2-4500*x^6*z^2+2350*x^4*y^4-6750*x^4*y^2*z^2+1350*x^4*z^4+300*x^2*y^6-1800*x^2*y^4*z^2+1320*x^2*y^2*z^4-180*x^2*z^6+225*y^8-270*y^6*z^2+279*y^4*z^4-54*y^2*z^6+9*z^8];
