...
// Magma code for modular curve with label 48.192.5.bm.1

// Other names and/or labels
// Cummins-Pauli label: 16O5
// Rouse-Sutherland-Zureick-Brown label: 48.192.5.342

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[23, 0, 40, 7], [23, 34, 36, 37], [33, 34, 28, 43], [41, 42, 4, 13], [47, 0, 16, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["8.96.1.h.1", "48.96.3.be.2", "48.96.3.by.2"];
...
// Canonical model
model_0 := [y*z-y*w+z*t+w*t,y^2+2*y*z+2*y*w+2*y*t+z^2-2*z*w-2*z*t-w^2+2*w*t-t^2,12*x^2-y^2-y*z-y*w-y*t-z^2+z*w+z*t-w*t];
...
// Map from the canonical model to the canonical model of modular curve with label 48.96.3.be.2
//   Coordinate number 0:
map_0_coord_0 := 1*(4*x);
//   Coordinate number 1:
...
// Map from the canonical model to the plane model of modular curve with label 48.192.5.bm.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
