...
// Magma code for modular curve with label 30.72.5.bj.2

// Other names and/or labels
// Cummins-Pauli label: 30G5
// Rouse-Sutherland-Zureick-Brown label: 30.72.5.43

// Group data
level := 30;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 25, 11, 24], [12, 25, 7, 24], [23, 5, 17, 4], [28, 5, 7, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["15.36.2.a.1", "30.36.1.o.1", "30.36.2.b.2"];
...
// Map from the canonical model to the plane model of modular curve with label 30.72.5.bj.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
