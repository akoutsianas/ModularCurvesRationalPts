...
// Magma code for modular curve with label 40.120.5.fz.1

// Other names and/or labels
// Cummins-Pauli label: 20F5
// Rouse-Sutherland-Zureick-Brown label: 40.120.5.177

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 34, 17, 17], [9, 34, 8, 1], [15, 18, 1, 15], [39, 22, 14, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.3.t.1", "40.60.2.j.1", "40.60.2.l.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.120.5.fz.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
