...
// Magma code for modular curve with label 32.192.5.bg.2

// Other names and/or labels
// Cummins-Pauli label: 32N5
// Rouse-Sutherland-Zureick-Brown label: 32.192.5.461

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 12, 16, 31], [3, 7, 24, 15], [9, 4, 0, 15], [13, 19, 24, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["16.96.1.s.1", "32.96.3.bb.1", "32.96.3.bc.2"];
...
// Map from the canonical model to the plane model of modular curve with label 32.192.5.bg.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
