...
// Magma code for modular curve with label 24.192.5.ft.4

// Other names and/or labels
// Cummins-Pauli label: 24Z5
// Rouse-Sutherland-Zureick-Brown label: 24.192.5.2137

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 21, 12, 7], [5, 12, 12, 19], [11, 12, 0, 1], [11, 12, 16, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["24.96.1.db.1", "24.96.1.do.3", "24.96.1.ds.1", "24.96.3.fw.2", "24.96.3.gb.1", "24.96.3.gt.4", "24.96.3.gx.2"];
...
// Map from the canonical model to the plane model of modular curve with label 24.192.5.ft.4
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
