...
// Magma code for modular curve with label 16.96.5.u.2

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 16.96.5.39

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 10, 4, 15], [9, 6, 4, 1], [9, 8, 4, 15], [13, 8, 12, 7], [15, 10, 12, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.k.2", "16.48.1.cl.2", "16.48.1.cv.2", "16.48.3.c.2", "16.48.3.e.1", "16.48.3.bk.2", "16.48.3.bu.2"];
...
// Map from the canonical model to the plane model of modular curve with label 16.96.5.u.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
