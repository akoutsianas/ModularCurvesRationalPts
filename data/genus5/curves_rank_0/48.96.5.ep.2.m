...
// Magma code for modular curve with label 48.96.5.ep.2

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.619

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 23, 2, 33], [19, 3, 26, 17], [25, 9, 22, 25], [45, 40, 40, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.w.2", "24.48.1.du.1", "48.48.1.in.2", "48.48.1.ip.1", "48.48.3.q.1", "48.48.3.bq.1", "48.48.3.bs.2"];
...
// Canonical model
model_0 := [y^2+x*z,3*x^2+y^2-2*x*z+2*z^2-2*z*w+2*w^2,9*x^2-8*y^2+7*x*z+4*z^2+2*z*w-2*w^2+t^2];
