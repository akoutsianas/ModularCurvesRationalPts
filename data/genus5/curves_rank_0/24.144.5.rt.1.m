...
// Magma code for modular curve with label 24.144.5.rt.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1213

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 3, 0, 5], [11, 4, 22, 13], [13, 22, 2, 19], [15, 19, 22, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.dw.1", "24.72.2.cp.1", "24.72.2.ea.1", "24.72.2.er.1", "24.72.2.fe.1", "24.72.3.bcu.1", "24.72.3.bdj.1"];
...
// Canonical model
model_0 := [3*x*t-2*y*w+2*z*w,3*x^2-2*y^2+4*y*z-2*z^2-4*w^2-6*t^2,8*y^2+8*y*z+8*z^2+6*w^2+3*t^2];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.rt.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
