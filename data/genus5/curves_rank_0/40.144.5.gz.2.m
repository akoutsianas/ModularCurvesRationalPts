...
// Magma code for modular curve with label 40.144.5.gz.2

// Other names and/or labels
// Cummins-Pauli label: 40M5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.280

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 30, 0, 11], [13, 24, 36, 11], [15, 31, 8, 3], [29, 37, 16, 5], [31, 2, 0, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.g.2", "40.72.3.bz.1", "40.72.3.cb.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.gz.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
