...
// Magma code for modular curve with label 24.192.5.fx.4

// Other names and/or labels
// Cummins-Pauli label: 24Z5
// Rouse-Sutherland-Zureick-Brown label: 24.192.5.1473

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 14, 0, 5], [17, 13, 12, 23], [19, 7, 12, 17], [19, 9, 12, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["24.96.1.dc.2", "24.96.1.do.1", "24.96.1.dr.2", "24.96.3.fz.2", "24.96.3.gc.1", "24.96.3.gv.2", "24.96.3.gy.4"];
...
// Canonical model
model_0 := [z^2-y*t,y^2-y*w+w^2+w*t,6*x^2-2*y^2+z^2-y*w+w^2+y*t+w*t+t^2];

// Singular plane model
model_1 := [36*x^4*z^4+12*x^2*y^4*z^2+24*x^2*y^3*z^3-48*x^2*y^2*z^4+24*x^2*y*z^5+12*x^2*z^6+y^8-20*y^7*z+116*y^6*z^2-180*y^5*z^3+266*y^4*z^4-180*y^3*z^5+116*y^2*z^6-20*y*z^7+z^8];
...
// Map from the canonical model to the plane model of modular curve with label 24.192.5.fx.4
//   Coordinate number 0:
map_1_coord_0 := 1*(x+z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
...
map_1_coord_2 := 1*(w);
// Codomain equation:
map_1_codomain := [36*x^4*z^4+12*x^2*y^4*z^2+24*x^2*y^3*z^3-48*x^2*y^2*z^4+24*x^2*y*z^5+12*x^2*z^6+y^8-20*y^7*z+116*y^6*z^2-180*y^5*z^3+266*y^4*z^4-180*y^3*z^5+116*y^2*z^6-20*y*z^7+z^8];
