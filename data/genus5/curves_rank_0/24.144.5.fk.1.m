...
// Magma code for modular curve with label 24.144.5.fk.1

// Other names and/or labels
// Cummins-Pauli label: 24R5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.195

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 20, 20, 15], [9, 23, 4, 15], [9, 23, 20, 15], [11, 21, 0, 23], [15, 23, 4, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.1.g.1", "24.72.3.pm.1", "24.72.3.po.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.fk.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
