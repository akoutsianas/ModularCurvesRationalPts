...
// Magma code for modular curve with label 60.72.5.bg.2

// Other names and/or labels
// Cummins-Pauli label: 30C5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.45

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 45, 6, 29], [47, 10, 5, 29], [48, 25, 7, 6], [51, 50, 29, 9], [59, 20, 34, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['5.12.0.a.1', '12.6.1.b.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["15.36.2.a.1", "60.24.1.k.1", "60.36.0.cg.1", "60.36.3.b.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.5.bg.2
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*v);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.72.5.bg.2
//   Coordinate number 0:
map_2_coord_0 := 1*(t);
//   Coordinate number 1:
map_2_coord_1 := 1*(-68/15625*u^6+27/3125*u^5*v);
//   Coordinate number 2:
