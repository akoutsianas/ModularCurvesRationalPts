...
// Magma code for modular curve with label 60.72.5.t.2

// Other names and/or labels
// Cummins-Pauli label: 30F5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.125

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[8, 45, 33, 52], [19, 5, 4, 49], [23, 45, 12, 29], [48, 25, 5, 12], [52, 55, 49, 41]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["30.36.2.b.2", "60.36.0.i.2", "60.36.3.a.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.5.t.2
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
