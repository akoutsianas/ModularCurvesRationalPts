...
// Magma code for modular curve with label 24.72.5.fb.1

// Other names and/or labels
// Cummins-Pauli label: 24G5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.339

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 15, 0, 23], [13, 23, 2, 23], [17, 18, 18, 23], [23, 9, 12, 5], [23, 23, 10, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.ft.1", "24.36.1.gd.1", "24.36.3.c.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.5.fb.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x-y);
//   Coordinate number 1:
