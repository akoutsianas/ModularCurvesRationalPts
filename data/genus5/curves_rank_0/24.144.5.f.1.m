...
// Magma code for modular curve with label 24.144.5.f.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.609

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 14, 14, 9], [9, 20, 22, 15], [13, 18, 0, 13], [19, 18, 12, 19], [21, 2, 2, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.3.q.1", "24.72.1.a.1", "24.72.1.u.1", "24.72.1.cl.1", "24.72.3.bf.1", "24.72.3.qk.1", "24.72.3.ub.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.f.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
