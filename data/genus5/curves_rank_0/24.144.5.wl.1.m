...
// Magma code for modular curve with label 24.144.5.wl.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.904

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 18, 18, 19], [3, 5, 20, 21], [7, 19, 4, 17], [11, 4, 8, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.dz.1", "24.72.2.ef.1", "24.72.2.em.1", "24.72.2.gg.1", "24.72.2.gx.1", "24.72.3.beh.1", "24.72.3.bew.1"];
...
//   Coordinate number 0:
map_0_coord_0 := 1*(x-2*y+z-w-3*t);
//   Coordinate number 1:
map_0_coord_1 := 1*(z-w+t);
//   Coordinate number 2:
map_0_coord_2 := 1*(-x+2*y+2*t);
// Codomain equation:
map_0_codomain := [4*x^4-x^3*y+6*x^2*y^2-x*y^3+4*y^4+8*x^3*z+9*x^2*y*z+7*y^3*z+15*x*y*z^2-6*y^2*z^2-4*x*z^3+y*z^3+z^4];

// Map from the canonical model to the plane model of modular curve with label 24.144.5.wl.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*z);
