...
// Magma code for modular curve with label 24.96.5.cg.1

// Other names and/or labels
// Cummins-Pauli label: 24K5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.47

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 13, 12, 11], [1, 19, 6, 23], [7, 1, 18, 1], [7, 18, 12, 19], [23, 23, 6, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['3.4.0.a.1', '8.24.1.u.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["8.24.1.u.1", "24.48.2.h.1", "24.48.2.l.1", "24.48.3.d.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.cg.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x-z);
//   Coordinate number 1:
map_1_coord_1 := 1*(4*y);
