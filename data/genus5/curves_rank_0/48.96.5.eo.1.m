...
// Magma code for modular curve with label 48.96.5.eo.1

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.618

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 3, 18, 25], [23, 29, 14, 7], [33, 34, 44, 33], [43, 26, 20, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.w.1", "24.48.1.dt.1", "48.48.1.im.2", "48.48.1.io.1", "48.48.3.q.1", "48.48.3.bp.1", "48.48.3.br.2"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.eo.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
