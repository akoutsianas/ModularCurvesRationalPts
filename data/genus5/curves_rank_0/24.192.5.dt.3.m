...
// Magma code for modular curve with label 24.192.5.dt.3

// Other names and/or labels
// Cummins-Pauli label: 24Z5
// Rouse-Sutherland-Zureick-Brown label: 24.192.5.1496

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 5, 0, 13], [7, 9, 0, 19], [11, 22, 0, 13], [13, 2, 0, 5], [23, 22, 0, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["24.96.1.cy.2", "24.96.1.dd.2", "24.96.1.de.1", "24.96.3.dg.1", "24.96.3.eg.2", "24.96.3.gk.3", "24.96.3.gl.1"];
...
model_1 := [11*x^8+4*x^7*y+6*x^6*y^2+4*x^5*y^3+2*x^4*y^4-8*x^6*z^2+8*x^3*y^3*z^2-32*x^4*z^4-16*x^3*y*z^4+8*x^2*y^2*z^4+16*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 24.192.5.dt.3
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
...
// Codomain equation:
map_1_codomain := [11*x^8+4*x^7*y+6*x^6*y^2+4*x^5*y^3+2*x^4*y^4-8*x^6*z^2+8*x^3*y^3*z^2-32*x^4*z^4-16*x^3*y*z^4+8*x^2*y^2*z^4+16*z^8];
