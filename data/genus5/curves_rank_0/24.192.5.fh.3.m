...
// Magma code for modular curve with label 24.192.5.fh.3

// Other names and/or labels
// Cummins-Pauli label: 24Z5
// Rouse-Sutherland-Zureick-Brown label: 24.192.5.1584

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 3, 20, 5], [5, 18, 12, 7], [17, 6, 16, 23], [23, 15, 4, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["24.96.1.dc.3", "24.96.1.df.2", "24.96.1.dk.1", "24.96.3.fe.1", "24.96.3.fz.2", "24.96.3.gm.4", "24.96.3.gr.2"];
...
model_1 := [4*x^4*y^4+4*x^2*y^6+y^8+192*x^6*z^2+192*x^4*y^2*z^2+72*x^2*y^4*z^2+12*y^6*z^2-36*x^2*y^2*z^4+18*y^4*z^4+108*y^2*z^6+81*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 24.192.5.fh.3
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
...
map_1_coord_2 := 1*(w);
// Codomain equation:
map_1_codomain := [4*x^4*y^4+4*x^2*y^6+y^8+192*x^6*z^2+192*x^4*y^2*z^2+72*x^2*y^4*z^2+12*y^6*z^2-36*x^2*y^2*z^4+18*y^4*z^4+108*y^2*z^6+81*z^8];
