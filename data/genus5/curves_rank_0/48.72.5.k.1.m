...
// Magma code for modular curve with label 48.72.5.k.1

// Other names and/or labels
// Cummins-Pauli label: 48B5
// Rouse-Sutherland-Zureick-Brown label: 48.72.5.12

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 44, 16, 9], [11, 4, 40, 25], [19, 10, 32, 1], [33, 13, 20, 3], [35, 37, 44, 41], [37, 9, 36, 41]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
// Map from the canonical model to the plane model of modular curve with label 48.72.5.k.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
