...
// Magma code for modular curve with label 40.144.5.dp.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.324

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 14, 16, 31], [3, 25, 16, 37], [17, 20, 16, 21], [17, 30, 8, 29], [31, 2, 12, 11], [31, 16, 28, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.l.1", "40.72.1.g.1", "40.72.1.s.2", "40.72.1.cq.2", "40.72.3.y.2", "40.72.3.co.2", "40.72.3.ey.2"];
...
model_1 := [x^8+12*x^6*y^2+20*x^4*y^4+4*x^6*z^2-8*x^4*y^2*z^2+6*x^4*z^4+12*x^2*y^2*z^4+4*x^2*z^6+z^8];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.dp.1
//   Coordinate number 0:
...
// Codomain equation:
map_1_codomain := [x^8+12*x^6*y^2+20*x^4*y^4+4*x^6*z^2-8*x^4*y^2*z^2+6*x^4*z^4+12*x^2*y^2*z^4+4*x^2*z^6+z^8];
