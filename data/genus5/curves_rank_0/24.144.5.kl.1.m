...
// Magma code for modular curve with label 24.144.5.kl.1

// Other names and/or labels
// Cummins-Pauli label: 12D5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.707

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 0, 12, 1], [3, 5, 20, 9], [3, 23, 22, 9], [11, 18, 6, 17], [13, 3, 6, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.3.dx.1", "24.72.1.cq.1", "24.72.3.zn.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.kl.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
