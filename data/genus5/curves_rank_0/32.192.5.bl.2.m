...
// Magma code for modular curve with label 32.192.5.bl.2

// Other names and/or labels
// Cummins-Pauli label: 32O5
// Rouse-Sutherland-Zureick-Brown label: 32.192.5.673

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 28, 0, 9], [9, 27, 0, 11], [15, 21, 0, 31], [23, 15, 0, 19], [31, 30, 0, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["16.96.2.j.2", "32.96.1.f.1", "32.96.2.i.2"];
...
// Map from the canonical model to the plane model of modular curve with label 32.192.5.bl.2
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
