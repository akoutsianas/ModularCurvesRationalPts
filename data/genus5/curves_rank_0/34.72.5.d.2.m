...
// Magma code for modular curve with label 34.72.5.d.2

// Other names and/or labels
// Cummins-Pauli label: 34A5
// Rouse-Sutherland-Zureick-Brown label: 34.72.5.2

// Group data
level := 34;
// Elements that, together with Gamma(level), generate the group
gens := [[8, 7, 17, 16], [18, 13, 17, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
// Map from the canonical model to the plane model of modular curve with label 34.72.5.d.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
