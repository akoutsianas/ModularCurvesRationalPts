...
// Magma code for modular curve with label 48.96.5.mi.1

// Other names and/or labels
// Cummins-Pauli label: 48D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.116

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 38, 24, 25], [5, 9, 12, 29], [13, 37, 0, 35], [23, 45, 36, 11], [25, 24, 36, 31], [35, 33, 0, 1], [35, 35, 24, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['3.4.0.a.1', '16.24.1.b.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["16.24.1.b.1", "24.48.1.ir.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.mi.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
