...
// Magma code for modular curve with label 16.192.5.bd.2

// Other names and/or labels
// Cummins-Pauli label: 16N5
// Rouse-Sutherland-Zureick-Brown label: 16.192.5.438

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 8, 8, 7], [7, 8, 0, 5], [9, 0, 8, 13], [15, 2, 8, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["16.96.1.c.2", "16.96.2.f.2", "16.96.2.h.2"];
...
model_1 := [8*x^6-8*x^4*y*z-2*x^2*y^3*z-8*x^4*z^2+y^4*z^2+4*x^2*y*z^3+y^3*z^3+2*x^2*z^4];
...
// Map from the canonical model to the plane model of modular curve with label 16.192.5.bd.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x-y);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*t);
...
// Codomain equation:
map_1_codomain := [8*x^6-8*x^4*y*z-2*x^2*y^3*z-8*x^4*z^2+y^4*z^2+4*x^2*y*z^3+y^3*z^3+2*x^2*z^4];
