...
// Magma code for modular curve with label 24.192.5.co.1

// Other names and/or labels
// Cummins-Pauli label: 24AB5
// Rouse-Sutherland-Zureick-Brown label: 24.192.5.1734

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 14, 12, 19], [17, 8, 12, 7], [19, 6, 12, 23], [19, 10, 12, 5], [19, 12, 12, 7], [23, 8, 12, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["24.96.1.ck.3", "24.96.3.bo.2", "24.96.3.br.4"];
...
// Map from the canonical model to the plane model of modular curve with label 24.192.5.co.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
