...
// Magma code for modular curve with label 24.144.5.bbn.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1116

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 4, 8, 23], [11, 7, 2, 5], [11, 12, 6, 17], [19, 4, 16, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.em.1", "24.72.2.bo.1", "24.72.2.cg.1", "24.72.2.iq.1", "24.72.2.jn.1", "24.72.3.beb.1", "24.72.3.bew.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.bbn.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
