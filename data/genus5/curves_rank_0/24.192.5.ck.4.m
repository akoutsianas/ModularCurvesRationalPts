...
// Magma code for modular curve with label 24.192.5.ck.4

// Other names and/or labels
// Cummins-Pauli label: 24AB5
// Rouse-Sutherland-Zureick-Brown label: 24.192.5.335

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 20, 0, 7], [7, 0, 12, 5], [11, 20, 12, 17], [13, 14, 0, 19], [13, 18, 0, 7], [17, 16, 12, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["12.96.1.b.4", "24.96.3.bo.2", "24.96.3.br.1"];
...
//   Coordinate number 2:
map_0_coord_2 := 1*(x-y-z+2*w+2*t);
// Codomain equation:
map_0_codomain := [6*x^4-4*x^3*y+6*x^2*y^2+4*x*y^3-8*x^3*z-6*x^2*y*z+2*y^3*z-3*x^2*z^2-6*x*y*z^2-3*y^2*z^2+2*x*z^3+y*z^3];

// Map from the canonical model to the plane model of modular curve with label 24.192.5.ck.4
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
