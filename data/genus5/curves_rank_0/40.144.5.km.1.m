...
// Magma code for modular curve with label 40.144.5.km.1

// Other names and/or labels
// Cummins-Pauli label: 20J5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.320

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 17, 10, 31], [13, 25, 6, 27], [23, 1, 32, 37], [29, 18, 10, 7], [37, 36, 0, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.bo.1", "40.48.1.kg.2", "40.72.1.cq.1", "40.72.3.fm.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.km.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
