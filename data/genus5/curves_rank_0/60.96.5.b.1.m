...
// Magma code for modular curve with label 60.96.5.b.1

// Other names and/or labels
// Cummins-Pauli label: 30N5
// Rouse-Sutherland-Zureick-Brown label: 60.96.5.37

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[14, 55, 3, 7], [31, 10, 9, 11], [44, 15, 27, 28], [46, 5, 33, 2], [56, 5, 15, 43], [59, 45, 6, 47]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['3.4.0.a.1', '4.2.0.a.1', '5.12.0.a.2']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["15.48.1.a.2", "20.24.1.b.2", "60.48.3.c.1", "60.48.3.bd.2"];
...
// Map from the canonical model to the plane model of modular curve with label 60.96.5.b.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
