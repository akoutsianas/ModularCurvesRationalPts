...
// Magma code for modular curve with label 60.144.5.id.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.809

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 45, 14, 31], [21, 10, 28, 11], [31, 35, 20, 47]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.u.1", "60.72.1.bt.1", "60.72.1.bx.2", "60.72.1.di.2", "60.72.3.kq.1", "60.72.3.nd.2", "60.72.3.yb.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.id.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
