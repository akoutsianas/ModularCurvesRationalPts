...
// Magma code for modular curve with label 16.96.5.bo.2

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 16.96.5.106

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 13, 6, 7], [7, 6, 4, 15], [13, 8, 4, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.bi.1", "16.48.1.ci.2", "16.48.1.ck.1", "16.48.3.q.1", "16.48.3.w.2", "16.48.3.bh.1", "16.48.3.bj.2"];
...
// Map from the canonical model to the plane model of modular curve with label 16.96.5.bo.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
