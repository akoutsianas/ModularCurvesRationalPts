...
// Magma code for modular curve with label 40.144.5.ez.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.22

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 14, 4, 5], [15, 34, 34, 15], [21, 30, 34, 27], [27, 27, 20, 39]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.i.1", "40.72.1.n.2", "40.72.1.bx.1", "40.72.3.bo.1", "40.72.3.ck.1", "40.72.3.dd.1", "40.72.3.ee.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.ez.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
