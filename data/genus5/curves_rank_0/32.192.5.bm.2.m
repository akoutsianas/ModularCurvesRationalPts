...
// Magma code for modular curve with label 32.192.5.bm.2

// Other names and/or labels
// Cummins-Pauli label: 32O5
// Rouse-Sutherland-Zureick-Brown label: 32.192.5.665

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 12, 0, 19], [23, 28, 0, 25], [23, 31, 0, 13], [31, 22, 0, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["16.96.2.k.1", "32.96.1.f.1", "32.96.2.i.2"];
...
// Map from the canonical model to the plane model of modular curve with label 32.192.5.bm.2
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
