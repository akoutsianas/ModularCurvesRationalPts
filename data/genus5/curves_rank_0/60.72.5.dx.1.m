...
// Magma code for modular curve with label 60.72.5.dx.1

// Other names and/or labels
// Cummins-Pauli label: 30G5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.114

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[14, 55, 47, 53], [19, 25, 43, 32], [47, 25, 40, 37], [54, 35, 53, 48]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["30.36.1.o.1", "60.36.2.fs.1", "60.36.2.fv.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.72.5.dx.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
