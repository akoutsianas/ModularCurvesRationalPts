...
// Magma code for modular curve with label 20.144.5.c.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 20.144.5.63

// Group data
level := 20;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 16, 0, 19], [17, 2, 0, 1], [17, 8, 18, 19], [17, 16, 8, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.a.2", "20.72.1.e.2", "20.72.1.u.2", "20.72.3.a.1", "20.72.3.e.1", "20.72.3.q.2", "20.72.3.bn.2"];
...
// Canonical model
model_0 := [y^2-w*t,y^2-x*z-z^2,x^2-2*x*z+2*z^2+w^2+t^2];
...
// Map from the canonical model to the plane model of modular curve with label 20.144.5.c.2
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
