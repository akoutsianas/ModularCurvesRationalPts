...
// Magma code for modular curve with label 24.192.5.cg.4

// Other names and/or labels
// Cummins-Pauli label: 24AB5
// Rouse-Sutherland-Zureick-Brown label: 24.192.5.1757

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 2, 12, 1], [7, 10, 12, 5], [11, 14, 12, 7], [13, 10, 0, 13], [17, 2, 12, 19], [23, 16, 0, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["24.96.1.ck.1", "24.96.3.bm.1", "24.96.3.bo.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.192.5.cg.4
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
