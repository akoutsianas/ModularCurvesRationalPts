...
// Magma code for modular curve with label 48.144.5.er.1

// Other names and/or labels
// Cummins-Pauli label: 48H5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.775

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 3, 18, 25], [23, 30, 36, 31], [29, 32, 16, 41], [29, 41, 38, 19], [47, 30, 12, 35]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.2.hm.2", "48.72.0.c.1", "48.72.3.y.1"];
...
// Embedded model
model_0 := [t^2-y*v,y*t+w*v,x*t+z*v,x*y+z*t,x*y-w*t-x*v,x*y+w*t+y*v-u*v,x*y-z*w-w^2,x^2-z^2-z*w,z^2+w^2-x*u,x^2-w*t-x*u-y*u,x*w+y*w+x*t,y*z-x*w,y^2+w*t,x*z+y*w-z*u-w*u,y*z-y*w-y*t+t*u,x^2-x*y-2*u^2+y*v+u*v-v^2-r^2];

// Singular plane model
model_1 := [8*x^12-16*x^10*z^2+16*x^8*z^4-12*x^6*z^6+x^4*y^2*z^6+8*x^4*z^8-2*x^2*y^2*z^8-4*x^2*z^10+y^2*z^10+z^12];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.er.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
map_1_coord_1 := 1*(r);
...
map_1_coord_2 := 1*(v);
// Codomain equation:
map_1_codomain := [8*x^12-16*x^10*z^2+16*x^8*z^4-12*x^6*z^6+x^4*y^2*z^6+8*x^4*z^8-2*x^2*y^2*z^8-4*x^2*z^10+y^2*z^10+z^12];

// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.er.1
//   Coordinate number 0:
map_2_coord_0 := 1*(v);
//   Coordinate number 1:
map_2_coord_1 := 1*(-t^2*v^3*r+v^5*r);
//   Coordinate number 2:
map_2_coord_2 := 1*(-t);
// Codomain equation:
