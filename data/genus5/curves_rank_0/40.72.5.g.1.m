...
// Magma code for modular curve with label 40.72.5.g.1

// Other names and/or labels
// Cummins-Pauli label: 40C5
// Rouse-Sutherland-Zureick-Brown label: 40.72.5.16

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 10, 8, 33], [3, 5, 36, 37], [9, 17, 30, 11], [11, 10, 38, 13], [29, 8, 6, 11], [31, 10, 30, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.1.j.1", "40.12.1.g.1"];
...
// Canonical model
model_0 := [y^2-y*z-y*w-t^2,2*y^2+y*z-y*w+z*w-w^2,5*x^2+2*y*t-z*t+3*w*t];

// Singular plane model
model_1 := [25*x^2*y^4-25*x^4*z^2+6*x^2*z^4-z^6];
...
// Map from the canonical model to the plane model of modular curve with label 40.72.5.g.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(x);
...
map_1_coord_2 := 1*(t);
// Codomain equation:
map_1_codomain := [25*x^2*y^4-25*x^4*z^2+6*x^2*z^4-z^6];
