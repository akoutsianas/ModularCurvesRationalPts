...
// Magma code for modular curve with label 24.96.5.ce.1

// Other names and/or labels
// Cummins-Pauli label: 24K5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.42

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 18, 10, 23], [7, 3, 16, 1], [7, 6, 16, 11], [11, 6, 22, 5], [23, 15, 0, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['3.4.0.a.1', '8.24.1.s.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["8.24.1.s.1", "24.48.2.i.1", "24.48.2.l.1", "24.48.3.c.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.ce.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
