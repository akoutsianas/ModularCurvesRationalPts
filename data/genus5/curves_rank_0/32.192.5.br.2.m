...
// Magma code for modular curve with label 32.192.5.br.2

// Other names and/or labels
// Cummins-Pauli label: 32O5
// Rouse-Sutherland-Zureick-Brown label: 32.192.5.686

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 1, 0, 9], [7, 24, 0, 31], [21, 5, 16, 7], [27, 12, 16, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["16.96.2.i.2", "32.96.1.b.2", "32.96.2.l.2"];
...
// Map from the canonical model to the plane model of modular curve with label 32.192.5.br.2
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
