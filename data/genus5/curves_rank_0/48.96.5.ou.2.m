...
// Magma code for modular curve with label 48.96.5.ou.2

// Other names and/or labels
// Cummins-Pauli label: 48C5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.721

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 19, 0, 47], [11, 40, 0, 31], [13, 21, 0, 7], [23, 25, 12, 31], [23, 40, 0, 19], [37, 43, 12, 13], [47, 20, 0, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.ou.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
