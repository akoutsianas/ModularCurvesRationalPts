...
// Magma code for modular curve with label 48.96.5.sa.1

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.182

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 11, 34, 1], [15, 46, 20, 27], [25, 28, 24, 37], [31, 45, 6, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.cj.1", "24.48.1.kv.1", "48.48.1.im.1", "48.48.3.dj.1", "48.48.3.ed.1", "48.48.3.eq.1", "48.48.3.gb.2"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.sa.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
