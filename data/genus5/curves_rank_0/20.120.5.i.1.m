...
// Magma code for modular curve with label 20.120.5.i.1

// Other names and/or labels
// Cummins-Pauli label: 20E5
// Rouse-Sutherland-Zureick-Brown label: 20.120.5.14

// Group data
level := 20;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 6, 16, 11], [3, 10, 0, 13], [7, 0, 0, 7], [17, 13, 8, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['4.6.0.c.1', '5.20.0.a.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["10.60.2.a.1", "20.60.2.g.1", "20.60.3.c.1"];
...
// Canonical model
model_0 := [3*x^2+2*x*y+2*y^2-z^2-z*w+w^2,x^2-x*y-y^2-2*z^2-3*z*w+z*t-2*w^2-t^2,3*x*z-5*x*w-x*t+y*z-2*y*t];
...
// Map from the canonical model to the plane model of modular curve with label 20.120.5.i.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
