...
// Magma code for modular curve with label 48.144.5.bb.1

// Other names and/or labels
// Cummins-Pauli label: 48H5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.790

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 23, 10, 7], [1, 44, 16, 25], [23, 13, 46, 43], [27, 47, 10, 3], [33, 25, 14, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.2.hn.1", "48.72.0.a.1", "48.72.3.z.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.bb.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*v);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.bb.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-r);
//   Coordinate number 1:
