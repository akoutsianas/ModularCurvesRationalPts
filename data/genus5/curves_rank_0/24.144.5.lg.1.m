...
// Magma code for modular curve with label 24.144.5.lg.1

// Other names and/or labels
// Cummins-Pauli label: 12D5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.640

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 6, 18, 23], [7, 18, 18, 1], [11, 9, 0, 13], [17, 12, 0, 1], [21, 5, 14, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.3.ds.1", "24.48.1.mj.1", "24.72.1.ct.1", "24.72.3.zr.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.lg.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
