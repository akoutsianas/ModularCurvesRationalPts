...
// Magma code for modular curve with label 32.192.5.bd.2

// Other names and/or labels
// Cummins-Pauli label: 32N5
// Rouse-Sutherland-Zureick-Brown label: 32.192.5.371

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 19, 24, 27], [11, 20, 8, 7], [27, 26, 8, 7], [27, 31, 8, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["16.96.1.l.2", "32.96.2.e.1", "32.96.2.f.1"];
...
// Map from the canonical model to the plane model of modular curve with label 32.192.5.bd.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
