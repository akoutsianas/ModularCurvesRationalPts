...
// Magma code for modular curve with label 24.96.5.bu.1

// Other names and/or labels
// Cummins-Pauli label: 24I5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.88

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 21, 0, 7], [11, 12, 18, 5], [13, 21, 20, 23], [17, 18, 12, 17], [19, 15, 22, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["12.48.1.o.1", "24.24.1.y.1", "24.48.3.c.1", "24.48.3.cl.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.bu.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
