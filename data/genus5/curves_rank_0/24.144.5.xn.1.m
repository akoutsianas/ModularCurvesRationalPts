...
// Magma code for modular curve with label 24.144.5.xn.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1180

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 1, 20, 3], [17, 17, 14, 7], [21, 5, 2, 3], [23, 19, 16, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.eo.1", "24.72.2.k.1", "24.72.2.bo.1", "24.72.2.hf.1", "24.72.2.im.1", "24.72.3.bco.1", "24.72.3.bdp.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.xn.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*w);
