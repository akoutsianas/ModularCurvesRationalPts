...
// Magma code for modular curve with label 40.144.5.hb.2

// Other names and/or labels
// Cummins-Pauli label: 40M5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.614

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 37, 16, 1], [13, 33, 12, 9], [19, 13, 20, 37], [19, 20, 16, 13], [25, 4, 8, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["40.72.1.v.2", "40.72.3.bz.1", "40.72.3.ca.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.hb.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
