...
// Magma code for modular curve with label 60.144.5.oa.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.623

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[33, 55, 22, 19], [39, 55, 20, 17], [59, 15, 0, 29], [59, 30, 24, 47]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.u.1", "60.72.1.br.2", "60.72.1.bv.1", "60.72.3.oh.2", "60.72.3.ol.1", "60.72.3.oy.1", "60.72.3.zc.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.oa.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x+z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
