...
// Magma code for modular curve with label 60.72.5.cn.1

// Other names and/or labels
// Cummins-Pauli label: 30C5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.182

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[6, 55, 37, 12], [14, 25, 35, 11], [23, 35, 53, 58], [51, 35, 23, 24]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["30.36.3.d.1", "60.24.1.z.1", "60.36.0.cg.2", "60.36.2.ft.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.5.cn.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.72.5.cn.1
//   Coordinate number 0:
map_2_coord_0 := 1*(r);
//   Coordinate number 1:
