...
// Magma code for modular curve with label 60.72.5.er.2

// Other names and/or labels
// Cummins-Pauli label: 30G5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.128

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[36, 35, 37, 57], [44, 5, 13, 56], [47, 50, 16, 59], [53, 5, 17, 4]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["30.36.2.b.2", "60.36.1.gb.1", "60.36.2.ft.2"];
...
// Map from the canonical model to the plane model of modular curve with label 60.72.5.er.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
