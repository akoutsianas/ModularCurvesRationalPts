...
// Magma code for modular curve with label 60.72.5.ce.1

// Other names and/or labels
// Cummins-Pauli label: 30H5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.178

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 13, 13, 44], [9, 4, 34, 35], [11, 44, 44, 57], [55, 11, 38, 53]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["30.36.3.d.1", "60.12.1.u.1", "60.36.1.dp.1", "60.36.1.fy.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.72.5.ce.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w+t);
