...
// Magma code for modular curve with label 60.72.5.bf.2

// Other names and/or labels
// Cummins-Pauli label: 30C5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.172

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[16, 25, 35, 46], [21, 55, 10, 57], [42, 55, 53, 33], [43, 10, 17, 49]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["30.36.3.c.1", "60.24.1.j.1", "60.36.0.cg.1", "60.36.2.fs.2"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.5.bf.2
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.72.5.bf.2
//   Coordinate number 0:
map_2_coord_0 := 1*(u);
//   Coordinate number 1:
