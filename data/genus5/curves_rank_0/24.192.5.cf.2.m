...
// Magma code for modular curve with label 24.192.5.cf.2

// Other names and/or labels
// Cummins-Pauli label: 24AB5
// Rouse-Sutherland-Zureick-Brown label: 24.192.5.1754

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 18, 12, 13], [7, 6, 12, 1], [13, 14, 0, 7], [13, 22, 12, 13], [17, 6, 0, 23], [19, 22, 12, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["24.96.1.ck.1", "24.96.3.bm.3", "24.96.3.bn.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.192.5.cf.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
