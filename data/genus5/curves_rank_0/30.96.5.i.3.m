...
// Magma code for modular curve with label 30.96.5.i.3

// Other names and/or labels
// Cummins-Pauli label: 30M5
// Rouse-Sutherland-Zureick-Brown label: 30.96.5.7

// Group data
level := 30;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 15, 21, 26], [2, 15, 3, 26], [13, 10, 15, 29], [19, 0, 3, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
// Map from the canonical model to the plane model of modular curve with label 30.96.5.i.3
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(x);
