...
// Magma code for modular curve with label 24.144.5.vb.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.983

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 19, 10, 9], [7, 4, 22, 5], [13, 23, 14, 11], [21, 8, 2, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.dv.1", "24.72.2.dl.1", "24.72.2.ds.1", "24.72.2.fl.1", "24.72.2.gx.1", "24.72.3.bdl.1", "24.72.3.bex.1"];
...
// Canonical model
model_0 := [x*z-x*w-2*y*z-y*w,2*x^2+x*y-y^2-3*w^2-3*t^2,x^2-x*y+y^2+4*z^2+4*z*w+w^2-3*t^2];
...
//   Coordinate number 0:
map_0_coord_0 := 1*(4*z+2*w-4*t);
//   Coordinate number 1:
map_0_coord_1 := 1*(-4*z-2*w+2*t);
//   Coordinate number 2:
map_0_coord_2 := 1*(-x+2*y);
// Codomain equation:
map_0_codomain := [6*x^4+6*x^3*y-15*x^2*y^2-12*x*y^3+6*y^4-12*x^2*z^2-12*x*y*z^2+6*y^2*z^2+4*z^4];

// Map from the canonical model to the plane model of modular curve with label 24.144.5.vb.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
map_1_coord_1 := 1*(6*z);
