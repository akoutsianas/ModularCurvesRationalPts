...
// Magma code for modular curve with label 20.120.5.bj.1

// Other names and/or labels
// Cummins-Pauli label: 20E5
// Rouse-Sutherland-Zureick-Brown label: 20.120.5.8

// Group data
level := 20;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 14, 14, 19], [3, 14, 1, 7], [11, 14, 9, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["10.60.2.b.1", "20.30.2.g.1", "20.60.2.g.1", "20.60.3.o.1"];
...
// Canonical model
model_0 := [2*x*w+x*t+3*y*w-y*t,5*x*y-3*z^2-2*z*w-w^2+w*t-t^2,5*x^2+5*y^2-z^2+z*w+w^2];
...
// Map from the canonical model to the plane model of modular curve with label 20.120.5.bj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
