...
// Magma code for modular curve with label 24.144.5.ys.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1188

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 5, 10, 21], [7, 19, 2, 1], [9, 10, 4, 9], [17, 19, 20, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.eo.1", "24.72.2.o.1", "24.72.2.bq.1", "24.72.2.hu.1", "24.72.2.if.1", "24.72.3.bcx.1", "24.72.3.bdg.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.ys.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
