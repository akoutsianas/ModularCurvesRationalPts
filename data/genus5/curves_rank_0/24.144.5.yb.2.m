...
// Magma code for modular curve with label 24.144.5.yb.2

// Other names and/or labels
// Cummins-Pauli label: 24Y5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.908

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 15, 18, 5], [3, 1, 14, 3], [7, 14, 8, 17], [17, 1, 14, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.eb.1", "24.72.2.hm.1", "24.72.2.hp.2"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.yb.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
