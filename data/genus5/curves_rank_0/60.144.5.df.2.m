...
// Magma code for modular curve with label 60.144.5.df.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.687

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 5, 24, 29], [9, 55, 32, 43], [23, 35, 52, 17], [27, 20, 56, 31], [31, 35, 56, 41]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['4.12.0.d.1', '15.12.0.b.2']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["20.72.3.l.1", "60.72.1.d.2", "60.72.1.m.1", "60.72.1.ed.1", "60.72.3.df.2", "60.72.3.hu.1", "60.72.3.zc.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.df.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z+w);
