...
// Magma code for modular curve with label 36.108.5.b.1

// Other names and/or labels
// Cummins-Pauli label: 36I5
// Rouse-Sutherland-Zureick-Brown label: 36.108.5.6

// Group data
level := 36;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 32, 28, 33], [13, 33, 18, 5], [21, 2, 22, 3], [27, 5, 10, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 108;
...
covers := ["12.36.1.bi.1", "18.54.1.a.1"];
...
// Map from the canonical model to the plane model of modular curve with label 36.108.5.b.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
