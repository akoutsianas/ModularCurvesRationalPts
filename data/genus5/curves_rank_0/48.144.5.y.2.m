...
// Magma code for modular curve with label 48.144.5.y.2

// Other names and/or labels
// Cummins-Pauli label: 48H5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.771

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 10, 32, 25], [23, 2, 44, 43], [37, 4, 16, 5], [39, 38, 16, 33], [45, 31, 2, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.2.hk.2", "48.72.0.a.2", "48.72.3.y.1"];
...
// Weierstrass model
model_2 := [6*x^12-36*x^10*z^2+108*x^8*z^4-243*x^6*z^6+486*x^4*z^8-729*x^2*z^10+y^2+y*z^6+547*z^12];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.y.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.y.2
//   Coordinate number 0:
map_2_coord_0 := 1*(-1/2*t);
//   Coordinate number 1:
map_2_coord_1 := 1*(-1/2*y^6-27/8*y^4*t*v);
//   Coordinate number 2:
map_2_coord_2 := 1*(-y);
// Codomain equation:
map_2_codomain := [6*x^12-36*x^10*z^2+108*x^8*z^4-243*x^6*z^6+486*x^4*z^8-729*x^2*z^10+y^2+y*z^6+547*z^12];
