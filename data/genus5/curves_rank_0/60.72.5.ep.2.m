...
// Magma code for modular curve with label 60.72.5.ep.2

// Other names and/or labels
// Cummins-Pauli label: 30G5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.103

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 10, 44, 7], [33, 25, 53, 48], [47, 55, 10, 7], [49, 40, 56, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["30.36.1.r.1", "60.36.2.fs.2", "60.36.2.fu.2"];
...
// Map from the canonical model to the plane model of modular curve with label 60.72.5.ep.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
