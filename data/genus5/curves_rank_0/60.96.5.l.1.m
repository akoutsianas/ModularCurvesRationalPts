...
// Magma code for modular curve with label 60.96.5.l.1

// Other names and/or labels
// Cummins-Pauli label: 20D5
// Rouse-Sutherland-Zureick-Brown label: 60.96.5.76

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[14, 5, 45, 13], [26, 55, 51, 43], [41, 45, 45, 32], [43, 40, 40, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["20.48.3.e.1", "60.24.1.d.2", "60.48.1.by.1", "60.48.3.cp.1"];
...
// Canonical model
model_0 := [x^2-2*x*y-2*x*z-y*z-y*w+z*w-w^2-t^2,2*x^2+2*x*y+2*x*z-y^2-z^2,4*x^2+x*y+x*z+2*y^2+y*z+y*w+y*t+2*z^2-z*w-z*t+w^2+2*w*t+2*t^2];
...
//   Coordinate number 0:
map_0_coord_0 := 1*(-2*y+2*z-w+3*t);
//   Coordinate number 1:
map_0_coord_1 := 1*(4*y-4*z+2*w);
//   Coordinate number 2:
...
// Map from the canonical model to the plane model of modular curve with label 60.96.5.l.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
