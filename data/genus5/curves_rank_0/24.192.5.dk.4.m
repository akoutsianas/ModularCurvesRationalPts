...
// Magma code for modular curve with label 24.192.5.dk.4

// Other names and/or labels
// Cummins-Pauli label: 24Z5
// Rouse-Sutherland-Zureick-Brown label: 24.192.5.1575

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 0, 0, 17], [7, 23, 0, 11], [17, 17, 0, 5], [17, 20, 0, 11], [19, 12, 0, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["24.96.1.cr.1", "24.96.1.de.1", "24.96.1.dq.1", "24.96.3.cn.2", "24.96.3.cr.1", "24.96.3.gl.3", "24.96.3.gx.3"];
...
// Map from the canonical model to the plane model of modular curve with label 24.192.5.dk.4
//   Coordinate number 0:
