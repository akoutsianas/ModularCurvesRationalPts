...
// Magma code for modular curve with label 32.192.5.i.2

// Other names and/or labels
// Cummins-Pauli label: 32N5
// Rouse-Sutherland-Zureick-Brown label: 32.192.5.468

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[25, 10, 16, 1], [25, 27, 0, 29], [31, 11, 16, 19], [31, 13, 16, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["16.96.1.g.2", "32.96.2.j.1", "32.96.2.l.1"];
...
// Canonical model
model_0 := [x*w-z*t,2*y^2+2*x*z+2*z^2+w^2-w*t,2*x^2+2*y^2-2*x*z+w*t+t^2];
