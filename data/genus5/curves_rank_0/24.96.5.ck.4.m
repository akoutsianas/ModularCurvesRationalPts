...
// Magma code for modular curve with label 24.96.5.ck.4

// Other names and/or labels
// Cummins-Pauli label: 24M5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.252

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 6, 12, 19], [11, 4, 12, 13], [17, 9, 18, 23], [17, 22, 12, 5], [23, 17, 18, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.ck.4
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
