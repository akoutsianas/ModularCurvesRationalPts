...
// Magma code for modular curve with label 60.96.5.s.1

// Other names and/or labels
// Cummins-Pauli label: 30N5
// Rouse-Sutherland-Zureick-Brown label: 60.96.5.109

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 20, 51, 47], [23, 15, 12, 13], [46, 5, 15, 14], [58, 5, 9, 26]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["30.48.3.b.1", "60.24.1.j.2", "60.48.1.bw.1", "60.48.3.bc.2"];
...
// Map from the canonical model to the plane model of modular curve with label 60.96.5.s.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
