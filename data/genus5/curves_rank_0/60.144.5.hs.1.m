...
// Magma code for modular curve with label 60.144.5.hs.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.897

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 30, 44, 19], [37, 0, 46, 7], [51, 35, 2, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.y.1", "60.72.1.bq.1", "60.72.1.cb.1", "60.72.1.dm.1", "60.72.3.km.1", "60.72.3.mz.2", "60.72.3.yb.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.hs.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
