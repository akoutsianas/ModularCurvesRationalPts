...
// Magma code for modular curve with label 48.96.5.ow.1

// Other names and/or labels
// Cummins-Pauli label: 48C5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.725

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 21, 12, 37], [11, 21, 12, 25], [37, 20, 0, 47], [41, 6, 24, 7], [43, 1, 12, 19], [43, 29, 12, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.ow.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
