...
// Magma code for modular curve with label 48.96.5.eu.1

// Other names and/or labels
// Cummins-Pauli label: 16C5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.298

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 46, 20, 41], [21, 40, 8, 19], [33, 10, 4, 1], [35, 35, 14, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.l.1", "48.48.3.r.1", "48.48.3.x.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.eu.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+z);
//   Coordinate number 1:
