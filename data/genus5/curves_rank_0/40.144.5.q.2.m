...
// Magma code for modular curve with label 40.144.5.q.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.402

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 18, 30, 33], [3, 22, 30, 29], [11, 38, 10, 3], [21, 0, 20, 31], [33, 18, 20, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.d.1", "40.72.1.a.2", "40.72.1.bq.1", "40.72.1.cb.1", "40.72.3.e.1", "40.72.3.dp.1", "40.72.3.eg.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.q.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
