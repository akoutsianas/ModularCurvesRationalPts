...
// Magma code for modular curve with label 48.96.5.ep.1

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.616

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[15, 4, 44, 33], [23, 42, 24, 17], [33, 7, 2, 19], [41, 1, 14, 41]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.w.1", "24.48.1.du.1", "48.48.1.in.1", "48.48.1.ip.2", "48.48.3.q.1", "48.48.3.bq.2", "48.48.3.bs.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.ep.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
