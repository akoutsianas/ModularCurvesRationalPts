...
// Magma code for modular curve with label 24.192.5.b.2

// Other names and/or labels
// Cummins-Pauli label: 12E5
// Rouse-Sutherland-Zureick-Brown label: 24.192.5.353

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 18, 18, 23], [5, 10, 12, 1], [5, 16, 12, 13], [19, 20, 6, 13], [23, 10, 0, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["12.96.1.a.2", "24.96.1.cj.1", "24.96.1.cj.2", "24.96.3.d.1", "24.96.3.bs.2", "24.96.3.bt.2"];
...
model_1 := [5*x^8+16*x^7*y+24*x^6*y^2+16*x^5*y^3+4*x^4*y^4-16*x^6*z^2-32*x^5*y*z^2-16*x^4*y^2*z^2-24*x^4*z^4+144*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 24.192.5.b.2
//   Coordinate number 0:
...
map_1_coord_2 := 1*(z);
// Codomain equation:
map_1_codomain := [5*x^8+16*x^7*y+24*x^6*y^2+16*x^5*y^3+4*x^4*y^4-16*x^6*z^2-32*x^5*y*z^2-16*x^4*y^2*z^2-24*x^4*z^4+144*z^8];
