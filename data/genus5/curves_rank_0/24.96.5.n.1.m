...
// Magma code for modular curve with label 24.96.5.n.1

// Other names and/or labels
// Cummins-Pauli label: 24I5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.49

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 12, 18, 5], [7, 21, 20, 13], [11, 15, 16, 13], [13, 21, 16, 11], [19, 6, 14, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['3.4.0.a.1', '8.24.1.f.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["8.24.1.f.1", "24.48.1.cu.1", "24.48.3.c.1", "24.48.3.co.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.n.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
