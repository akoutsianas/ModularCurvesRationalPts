...
// Magma code for modular curve with label 24.96.5.hg.1

// Other names and/or labels
// Cummins-Pauli label: 24J5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.187

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 1, 6, 7], [5, 16, 0, 5], [7, 1, 12, 5], [13, 11, 6, 23], [19, 10, 0, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.24.0.ei.1", "24.48.2.n.1", "24.48.2.r.1", "24.48.3.cl.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.hg.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
