...
// Magma code for modular curve with label 60.144.5.cv.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.216

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[28, 9, 9, 10], [46, 3, 3, 28], [55, 56, 2, 23], [59, 0, 10, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.3.be.1", "60.72.1.c.1", "60.72.1.cu.1", "60.72.1.et.1", "60.72.3.cs.1", "60.72.3.la.1", "60.72.3.nv.1"];
...
model_1 := [18125*x^8-1500*x^7*y-50*x^6*y^2+20*x^5*y^3+x^4*y^4-45500*x^6*z^2+2500*x^5*y*z^2+460*x^4*y^2*z^2+12*x^3*y^3*z^2+28750*x^4*z^4+2460*x^3*y*z^4+78*x^2*y^2*z^4+9540*x^2*z^6+252*x*y*z^6+621*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.cv.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y-z);
//   Coordinate number 1:
...
map_1_coord_2 := 1*(t);
// Codomain equation:
map_1_codomain := [18125*x^8-1500*x^7*y-50*x^6*y^2+20*x^5*y^3+x^4*y^4-45500*x^6*z^2+2500*x^5*y*z^2+460*x^4*y^2*z^2+12*x^3*y^3*z^2+28750*x^4*z^4+2460*x^3*y*z^4+78*x^2*y^2*z^4+9540*x^2*z^6+252*x*y*z^6+621*z^8];
