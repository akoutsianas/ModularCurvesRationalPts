...
// Magma code for modular curve with label 60.72.5.el.1

// Other names and/or labels
// Cummins-Pauli label: 30G5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.151

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 15, 3, 58], [13, 30, 21, 37], [56, 25, 41, 59], [58, 25, 55, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["30.36.2.a.1", "60.36.1.ga.1", "60.36.2.ft.2"];
...
// Map from the canonical model to the plane model of modular curve with label 60.72.5.el.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
