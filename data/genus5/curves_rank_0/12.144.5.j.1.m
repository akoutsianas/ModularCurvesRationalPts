...
// Magma code for modular curve with label 12.144.5.j.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 12.144.5.19

// Group data
level := 12;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 1, 2, 3], [7, 3, 6, 11], [7, 9, 6, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.1.c.1", "12.72.1.e.1", "12.72.1.t.1", "12.72.3.t.1", "12.72.3.y.1", "12.72.3.cb.1", "12.72.3.cz.1"];
...
model_1 := [16*x^8+160*x^6*y^2+8*x^6*z^2+24*x^4*y^4+88*x^4*y^2*z^2+x^4*z^4-8*x^2*y^6+2*x^2*y^4*z^2+16*x^2*y^2*z^4+y^8+y^2*z^6];
...
// Map from the canonical model to the plane model of modular curve with label 12.144.5.j.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
map_1_coord_2 := 1*(2*t);
// Codomain equation:
map_1_codomain := [16*x^8+160*x^6*y^2+8*x^6*z^2+24*x^4*y^4+88*x^4*y^2*z^2+x^4*z^4-8*x^2*y^6+2*x^2*y^4*z^2+16*x^2*y^2*z^4+y^8+y^2*z^6];
