...
// Magma code for modular curve with label 60.120.5.dp.1

// Other names and/or labels
// Cummins-Pauli label: 20E5
// Rouse-Sutherland-Zureick-Brown label: 60.120.5.138

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 2, 32, 47], [41, 40, 10, 51], [51, 2, 22, 7], [55, 27, 12, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.2.e.1", "60.60.2.a.1", "60.60.3.bg.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.120.5.dp.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
