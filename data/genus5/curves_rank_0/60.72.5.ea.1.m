...
// Magma code for modular curve with label 60.72.5.ea.1

// Other names and/or labels
// Cummins-Pauli label: 30G5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.112

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 30, 6, 41], [19, 30, 45, 43], [19, 35, 13, 28], [27, 35, 37, 42]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["30.36.1.o.1", "60.36.2.ft.1", "60.36.2.fu.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.72.5.ea.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
