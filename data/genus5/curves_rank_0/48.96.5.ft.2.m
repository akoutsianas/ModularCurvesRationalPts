...
// Magma code for modular curve with label 48.96.5.ft.2

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.611

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 29, 38, 23], [23, 24, 24, 43], [33, 31, 2, 25], [35, 2, 4, 39]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.y.1", "24.48.1.ds.2", "48.48.1.hk.1", "48.48.1.hl.2", "48.48.3.t.1", "48.48.3.ex.1", "48.48.3.ey.2"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.ft.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
