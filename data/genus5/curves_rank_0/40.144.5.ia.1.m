...
// Magma code for modular curve with label 40.144.5.ia.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.426

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 13, 14, 15], [5, 17, 26, 21], [5, 31, 18, 3], [27, 27, 34, 35], [27, 30, 20, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.bc.1", "40.72.1.y.1", "40.72.1.bq.2", "40.72.1.cn.1", "40.72.3.cu.2", "40.72.3.dp.1", "40.72.3.es.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.ia.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
