...
// Magma code for modular curve with label 24.144.5.nt.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1319

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 7, 4, 9], [9, 16, 4, 9], [11, 10, 22, 1], [13, 11, 8, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.di.1", "24.72.2.p.1", "24.72.2.bp.1", "24.72.2.fd.1", "24.72.2.fi.1", "24.72.3.bge.1", "24.72.3.bgl.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.nt.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
