...
// Magma code for modular curve with label 24.144.5.xt.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.841

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 11, 22, 7], [3, 22, 8, 15], [5, 13, 8, 23], [19, 1, 10, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.ep.1", "24.72.2.n.1", "24.72.2.bv.1", "24.72.2.hh.1", "24.72.2.im.1", "24.72.3.bcu.1", "24.72.3.bdt.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.xt.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
