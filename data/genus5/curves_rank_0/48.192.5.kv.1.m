...
// Magma code for modular curve with label 48.192.5.kv.1

// Other names and/or labels
// Cummins-Pauli label: 48I5
// Rouse-Sutherland-Zureick-Brown label: 48.192.5.4244

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 35, 36, 35], [7, 27, 12, 13], [13, 14, 24, 43], [23, 23, 12, 19], [25, 6, 24, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["24.96.1.dp.3", "48.96.3.py.1", "48.96.3.qh.1"];
...
//   Coordinate number 1:
map_0_coord_1 := 1*(t^2*w^6*(w^2+t^2)*(6*y^2*w^12-156*y^2*w^10*t^2+1194*y^2*w^8*t^4-1896*y^2*w^6*t^6-5190*y^2*w^4*t^8+1668*y^2*w^2*t^10+4374*y^2*t^12+w^14-30*w^12*t^2+291*w^10*t^4-884*w^8*t^6-537*w^6*t^8+2706*w^4*t^10+1909*w^2*t^12));

// Map from the canonical model to the plane model of modular curve with label 48.192.5.kv.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
