...
// Magma code for modular curve with label 48.96.5.cq.3

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.646

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 12, 44, 31], [11, 3, 10, 23], [17, 10, 24, 35]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.h.1", "24.48.1.ca.1", "48.48.1.gr.2", "48.48.1.hk.1", "48.48.3.h.1", "48.48.3.ed.2", "48.48.3.ey.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.cq.3
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
