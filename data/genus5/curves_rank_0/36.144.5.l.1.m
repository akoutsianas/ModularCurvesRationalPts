...
// Magma code for modular curve with label 36.144.5.l.1

// Other names and/or labels
// Cummins-Pauli label: 36L5
// Rouse-Sutherland-Zureick-Brown label: 36.144.5.54

// Group data
level := 36;
// Elements that, together with Gamma(level), generate the group
gens := [[23, 22, 0, 13], [29, 9, 0, 11], [31, 6, 0, 5], [35, 9, 0, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.48.1.l.1", "36.72.1.c.1", "36.72.1.e.1", "36.72.3.v.1"];
...
model_1 := [x^7-3*x^5*z^2+7*x^4*y^3-24*x^2*y^3*z^2-8*x*y^6+9*y^3*z^4];
...
// Map from the canonical model to the plane model of modular curve with label 36.144.5.l.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y+z);
...
map_1_coord_2 := 1*(t);
// Codomain equation:
map_1_codomain := [x^7-3*x^5*z^2+7*x^4*y^3-24*x^2*y^3*z^2-8*x*y^6+9*y^3*z^4];
