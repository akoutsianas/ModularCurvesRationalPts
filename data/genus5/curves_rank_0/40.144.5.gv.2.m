...
// Magma code for modular curve with label 40.144.5.gv.2

// Other names and/or labels
// Cummins-Pauli label: 40M5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.37

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 7, 12, 19], [11, 0, 32, 19], [11, 5, 8, 3], [13, 36, 24, 5], [29, 22, 36, 5], [35, 31, 16, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.f.2", "40.72.3.bz.1", "40.72.3.cc.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.gv.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
