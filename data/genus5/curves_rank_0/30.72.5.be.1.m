...
// Magma code for modular curve with label 30.72.5.be.1

// Other names and/or labels
// Cummins-Pauli label: 30H5
// Rouse-Sutherland-Zureick-Brown label: 30.72.5.31

// Group data
level := 30;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 2, 25, 13], [14, 17, 5, 28], [23, 13, 20, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["15.36.1.d.1", "30.12.1.k.1", "30.36.1.q.1", "30.36.3.d.1"];
...
// Map from the canonical model to the plane model of modular curve with label 30.72.5.be.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
