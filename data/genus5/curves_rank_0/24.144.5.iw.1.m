...
// Magma code for modular curve with label 24.144.5.iw.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.647

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 3, 12, 5], [13, 0, 0, 11], [15, 7, 10, 9], [15, 10, 22, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.3.cq.1", "24.72.1.ba.1", "24.72.1.bl.1", "24.72.1.co.1", "24.72.3.to.1", "24.72.3.uh.1", "24.72.3.wd.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.iw.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
