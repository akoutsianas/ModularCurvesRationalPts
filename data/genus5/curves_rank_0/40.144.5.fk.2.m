...
// Magma code for modular curve with label 40.144.5.fk.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.421

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 26, 28, 29], [11, 30, 12, 19], [15, 33, 36, 27], [19, 28, 32, 5], [33, 29, 4, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.o.1", "40.72.1.s.1", "40.72.1.y.2", "40.72.1.cb.2", "40.72.3.cr.2", "40.72.3.cu.2", "40.72.3.eg.1"];
...
model_1 := [25*x^8+150*x^6*y^2+20*x^6*z^2+100*x^4*y^4+160*x^4*y^2*z^2+44*x^4*z^4+120*x^2*y^2*z^4+16*x^2*z^6+16*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.fk.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
...
map_1_coord_2 := 1*(t);
// Codomain equation:
map_1_codomain := [25*x^8+150*x^6*y^2+20*x^6*z^2+100*x^4*y^4+160*x^4*y^2*z^2+44*x^4*z^4+120*x^2*y^2*z^4+16*x^2*z^6+16*z^8];
