...
// Magma code for modular curve with label 60.72.5.eq.1

// Other names and/or labels
// Cummins-Pauli label: 30G5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.72

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[6, 25, 53, 6], [16, 5, 11, 44], [37, 20, 23, 41], [53, 15, 3, 52]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["15.36.2.b.1", "60.36.1.gb.1", "60.36.2.fv.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.72.5.eq.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
