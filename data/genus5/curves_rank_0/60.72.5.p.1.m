...
// Magma code for modular curve with label 60.72.5.p.1

// Other names and/or labels
// Cummins-Pauli label: 30H5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.160

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 40, 10, 59], [29, 5, 35, 46], [29, 50, 38, 51], [41, 25, 7, 16], [57, 55, 25, 38]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["30.36.3.a.1", "60.12.1.d.1", "60.36.1.dt.1", "60.36.1.fy.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.72.5.p.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
