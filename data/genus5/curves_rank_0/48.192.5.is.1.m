...
// Magma code for modular curve with label 48.192.5.is.1

// Other names and/or labels
// Cummins-Pauli label: 16M5
// Rouse-Sutherland-Zureick-Brown label: 48.192.5.2630

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 41, 4, 9], [9, 28, 2, 23], [17, 15, 44, 7], [27, 13, 34, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["16.96.3.dl.1", "48.96.1.ce.1", "48.96.3.kg.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.192.5.is.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
