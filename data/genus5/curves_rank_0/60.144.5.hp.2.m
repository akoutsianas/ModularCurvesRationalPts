...
// Magma code for modular curve with label 60.144.5.hp.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.640

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 50, 10, 39], [13, 5, 6, 37], [23, 5, 6, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.l.2", "60.72.1.x.2", "60.72.1.dg.2", "60.72.3.ko.1", "60.72.3.oh.2", "60.72.3.qs.2", "60.72.3.xv.2"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.hp.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
