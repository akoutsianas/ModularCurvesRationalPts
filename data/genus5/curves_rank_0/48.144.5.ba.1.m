...
// Magma code for modular curve with label 48.144.5.ba.1

// Other names and/or labels
// Cummins-Pauli label: 48H5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.796

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 20, 44, 45], [5, 10, 40, 31], [11, 10, 4, 19], [29, 27, 18, 35], [45, 4, 40, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.2.hk.1", "48.72.0.a.2", "48.72.3.z.1"];
...
// Embedded model
model_0 := [y*z-x*w,x*w+y*w+t*r,x*w-y*w-z*t,x*z-y*w+x*u-x*v,z*t+w*t+y*u-y*v,z^2+z*w+z*r-w*r,z^2-w^2+z*u-z*v,x*z+x*w+x*r-y*r,x*y-y^2-x*t,z*w+w^2-z*r+w*r-u*r+v*r,2*x*y+y^2+z*w+x*t-w*r,x*y+2*y^2-z*w-x*t-w*r,z^2+w^2+3*y*t+z*u-z*v,3*x^2+z^2-z*r,w^2+2*u^2+2*u*v+2*v^2+2*z*r+u*r-v*r+r^2,2*z*w-2*w^2-3*t^2+2*w*u-2*w*v];

// Singular plane model
model_1 := [93312*x^12+31104*x^10*z^2+5184*x^8*z^4+108*x^6*y^2*z^4+648*x^6*z^6+216*x^5*y*z^6+36*x^4*y^2*z^6+180*x^4*z^8+54*x^3*y*z^8+3*x^2*y^2*z^8+24*x^2*z^10+3*x*y*z^10+z^12];

// Weierstrass model
model_2 := [384*x^12+1152*x^10*z^2+1728*x^8*z^4+1944*x^6*z^6+1944*x^4*z^8+1458*x^2*z^10+y^2+y*z^6+547*z^12];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.ba.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(6*v);
...
map_1_coord_2 := 1*(3*t);
// Codomain equation:
map_1_codomain := [93312*x^12+31104*x^10*z^2+5184*x^8*z^4+108*x^6*y^2*z^4+648*x^6*z^6+216*x^5*y*z^6+36*x^4*y^2*z^6+180*x^4*z^8+54*x^3*y*z^8+3*x^2*y^2*z^8+24*x^2*z^10+3*x*y*z^10+z^12];

// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.ba.1
//   Coordinate number 0:
map_2_coord_0 := 1*(w);
//   Coordinate number 1:
map_2_coord_1 := 1*(-36*w^3*t^2*v-54*w^2*t^4-54*w*t^4*v-41*t^6);
//   Coordinate number 2:
map_2_coord_2 := 1*(t);
// Codomain equation:
map_2_codomain := [384*x^12+1152*x^10*z^2+1728*x^8*z^4+1944*x^6*z^6+1944*x^4*z^8+1458*x^2*z^10+y^2+y*z^6+547*z^12];
