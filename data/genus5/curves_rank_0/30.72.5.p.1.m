...
// Magma code for modular curve with label 30.72.5.p.1

// Other names and/or labels
// Cummins-Pauli label: 30C5
// Rouse-Sutherland-Zureick-Brown label: 30.72.5.51

// Group data
level := 30;
// Elements that, together with Gamma(level), generate the group
gens := [[8, 15, 3, 4], [11, 5, 29, 16], [21, 10, 2, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["15.36.2.b.2", "30.24.1.g.2", "30.36.0.f.1", "30.36.3.c.1"];
...
// Map from the embedded model to the plane model of modular curve with label 30.72.5.p.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 30.72.5.p.1
//   Coordinate number 0:
map_2_coord_0 := 1*(u);
//   Coordinate number 1:
map_2_coord_1 := 1*(37*w^6-15*w^4*u*r-4/5*u^6);
//   Coordinate number 2:
map_2_coord_2 := 1*(-w);
// Codomain equation:
