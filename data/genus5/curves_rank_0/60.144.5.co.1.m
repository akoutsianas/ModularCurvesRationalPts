...
// Magma code for modular curve with label 60.144.5.co.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.848

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[29, 25, 34, 1], [37, 25, 26, 13], [39, 20, 40, 51], [53, 25, 20, 51]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.h.1", "60.72.1.d.1", "60.72.1.ca.2", "60.72.1.do.2", "60.72.3.dg.1", "60.72.3.qr.2", "60.72.3.yc.2"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.co.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z+w);
