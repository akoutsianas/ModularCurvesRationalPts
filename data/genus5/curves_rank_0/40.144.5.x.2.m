...
// Magma code for modular curve with label 40.144.5.x.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.420

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 30, 22, 9], [17, 10, 6, 1], [27, 36, 10, 23], [29, 14, 36, 17], [33, 4, 6, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.f.1", "40.72.1.b.2", "40.72.1.bv.1", "40.72.1.bw.2", "40.72.3.d.1", "40.72.3.dn.1", "40.72.3.ei.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.x.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
