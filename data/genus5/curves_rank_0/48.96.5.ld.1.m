...
// Magma code for modular curve with label 48.96.5.ld.1

// Other names and/or labels
// Cummins-Pauli label: 16E5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.476

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 3, 16, 47], [15, 19, 26, 41], [35, 29, 42, 37], [47, 9, 26, 41]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.bn.1", "48.48.1.fl.1", "48.48.1.fp.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.ld.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
