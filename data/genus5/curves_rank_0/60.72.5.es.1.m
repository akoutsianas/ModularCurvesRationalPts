...
// Magma code for modular curve with label 60.72.5.es.1

// Other names and/or labels
// Cummins-Pauli label: 30G5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.106

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[4, 35, 53, 14], [8, 25, 47, 53], [18, 35, 1, 57], [29, 40, 20, 53]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["30.36.1.r.1", "60.36.2.ft.1", "60.36.2.fv.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.72.5.es.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
