...
// Magma code for modular curve with label 60.144.5.hz.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.758

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 5, 32, 43], [29, 35, 10, 47], [31, 35, 30, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.bb.2", "60.72.1.bs.2", "60.72.1.cd.2", "60.72.1.dn.2", "60.72.3.kp.1", "60.72.3.nb.1", "60.72.3.yb.2"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.hz.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
