...
// Magma code for modular curve with label 48.96.5.ds.1

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.610

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 47, 26, 19], [25, 9, 46, 29], [29, 37, 14, 45], [47, 22, 36, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.o.1", "24.48.1.ds.1", "48.48.1.gq.1", "48.48.1.gr.2", "48.48.3.t.1", "48.48.3.ed.1", "48.48.3.ee.2"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.ds.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
