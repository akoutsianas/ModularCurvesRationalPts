...
// Magma code for modular curve with label 24.144.5.wz.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1165

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 17, 16, 9], [11, 16, 22, 1], [19, 16, 14, 1], [21, 14, 10, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.ek.1", "24.72.2.h.1", "24.72.2.z.1", "24.72.2.hh.1", "24.72.2.iv.1", "24.72.3.bcr.1", "24.72.3.bdx.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.wz.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
