...
// Magma code for modular curve with label 48.96.5.jg.2

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.447

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 44, 12, 47], [45, 31, 10, 47], [47, 15, 2, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.bu.2", "24.48.1.kr.2", "48.48.1.hf.2", "48.48.1.hl.2", "48.48.3.bh.2", "48.48.3.bs.1", "48.48.3.dn.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.jg.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
