...
// Magma code for modular curve with label 24.144.5.nr.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1308

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 8, 16, 17], [7, 19, 10, 17], [9, 8, 22, 3], [17, 12, 12, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.di.1", "24.72.2.o.1", "24.72.2.bo.1", "24.72.2.fb.1", "24.72.2.fk.1", "24.72.3.bgc.1", "24.72.3.bgn.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.nr.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
