...
// Magma code for modular curve with label 48.96.5.cc.2

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.532

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[29, 28, 16, 45], [39, 14, 4, 15], [41, 10, 16, 3], [41, 18, 28, 17], [45, 26, 4, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.e.1", "24.48.1.s.1", "48.48.1.ip.1", "48.48.1.ir.2", "48.48.3.c.1", "48.48.3.bs.1", "48.48.3.bu.2"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.cc.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
