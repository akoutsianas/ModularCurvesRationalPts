...
// Magma code for modular curve with label 48.192.5.le.4

// Other names and/or labels
// Cummins-Pauli label: 48I5
// Rouse-Sutherland-Zureick-Brown label: 48.192.5.4258

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 4, 0, 35], [7, 32, 0, 19], [13, 17, 36, 35], [41, 20, 0, 25], [43, 0, 0, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["24.96.1.dp.4", "48.96.3.px.2", "48.96.3.qm.1"];
...
//   Coordinate number 1:
map_0_coord_1 := 1*(t^2*w^6*(w^2+t^2)*(162*z^2*w^12-108*z^2*w^10*t^2+54*z^2*w^8*t^4-936*z^2*w^6*t^6-594*z^2*w^4*t^8-108*z^2*w^2*t^10-6*z^2*t^12+81*w^14-18*w^12*t^2-w^10*t^4+4*w^8*t^6+47*w^6*t^8+14*w^4*t^10+w^2*t^12));

// Map from the canonical model to the plane model of modular curve with label 48.192.5.le.4
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
