...
// Magma code for modular curve with label 48.192.5.iz.2

// Other names and/or labels
// Cummins-Pauli label: 16N5
// Rouse-Sutherland-Zureick-Brown label: 48.192.5.2740

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 13, 28, 5], [35, 2, 40, 3], [37, 45, 24, 19], [43, 38, 44, 45]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["16.96.3.ea.2", "48.96.1.cs.1", "48.96.3.kt.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.192.5.iz.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
