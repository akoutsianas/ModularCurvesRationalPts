...
// Magma code for modular curve with label 60.96.5.a.2

// Other names and/or labels
// Cummins-Pauli label: 30N5
// Rouse-Sutherland-Zureick-Brown label: 60.96.5.54

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 30, 54, 13], [29, 0, 30, 7], [37, 10, 30, 1], [43, 40, 54, 17], [56, 5, 3, 49]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['3.4.0.a.1', '20.24.1.a.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["20.24.1.a.1", "30.48.3.a.1", "60.48.1.bw.2", "60.48.3.bd.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.96.5.a.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
