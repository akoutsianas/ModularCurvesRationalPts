...
// Magma code for modular curve with label 16.96.5.j.1

// Other names and/or labels
// Cummins-Pauli label: 16A5
// Rouse-Zureick-Brown label: X670
// Rouse-Sutherland-Zureick-Brown label: 16.96.5.11

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 8, 12, 7], [5, 12, 14, 11], [9, 8, 4, 13], [11, 8, 10, 13], [11, 12, 8, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
// Canonical model
model_0 := [2*y*z-w*t,y*w+z*w+y*t-z*t,2*x^2+y*w-z*t];
...
// Map from the canonical model to the plane model of modular curve with label 16.96.5.j.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y-z);
