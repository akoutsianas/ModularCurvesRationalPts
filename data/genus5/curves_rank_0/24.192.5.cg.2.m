...
// Magma code for modular curve with label 24.192.5.cg.2

// Other names and/or labels
// Cummins-Pauli label: 24AB5
// Rouse-Sutherland-Zureick-Brown label: 24.192.5.1733

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 12, 0, 17], [13, 2, 12, 7], [17, 8, 12, 7], [17, 10, 0, 7], [19, 18, 0, 23], [23, 10, 0, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["24.96.1.ck.3", "24.96.3.bm.3", "24.96.3.bo.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.192.5.cg.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
