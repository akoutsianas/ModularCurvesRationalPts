...
// Magma code for modular curve with label 32.96.5.l.2

// Other names and/or labels
// Cummins-Pauli label: 32B5
// Rouse-Sutherland-Zureick-Brown label: 32.96.5.60

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 10, 0, 3], [7, 10, 16, 23], [15, 0, 0, 9], [15, 9, 8, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.j.1", "32.48.3.a.2", "32.48.3.e.2"];
...
// Map from the canonical model to the plane model of modular curve with label 32.96.5.l.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
