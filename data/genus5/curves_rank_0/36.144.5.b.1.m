...
// Magma code for modular curve with label 36.144.5.b.1

// Other names and/or labels
// Cummins-Pauli label: 36L5
// Rouse-Sutherland-Zureick-Brown label: 36.144.5.3

// Group data
level := 36;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 14, 0, 1], [7, 8, 0, 19], [13, 20, 0, 29], [19, 20, 0, 29], [23, 24, 0, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['4.12.0.b.1', '9.12.0.a.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["12.48.1.b.1", "18.72.1.a.1", "36.72.1.c.1", "36.72.3.w.1"];
...
//   Coordinate number 1:
map_0_coord_1 := 1*(t^6*(x-t)^2*(x+t)^6*(x+2*t)^2*(2*x+t)^2);

// Map from the canonical model to the plane model of modular curve with label 36.144.5.b.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
