...
// Magma code for modular curve with label 32.192.5.n.2

// Other names and/or labels
// Cummins-Pauli label: 32N5
// Rouse-Sutherland-Zureick-Brown label: 32.192.5.352

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 16, 0, 13], [9, 20, 16, 17], [17, 18, 0, 25], [23, 31, 0, 13], [31, 20, 16, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["16.96.1.m.2", "32.96.2.c.1", "32.96.2.i.2", "32.96.3.z.1"];
...
// Canonical model
model_0 := [y*w+z*t,2*x^2+y*w-z*t-w^2-t^2,2*x^2-y^2-y*w-z^2+z*t];
...
// Map from the canonical model to the plane model of modular curve with label 32.192.5.n.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
