...
// Magma code for modular curve with label 32.192.5.bi.2

// Other names and/or labels
// Cummins-Pauli label: 32O5
// Rouse-Sutherland-Zureick-Brown label: 32.192.5.677

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 30, 16, 17], [13, 19, 16, 31], [13, 22, 16, 31], [25, 4, 0, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["16.96.2.l.2", "32.96.1.b.2", "32.96.2.i.1"];
...
// Map from the canonical model to the plane model of modular curve with label 32.192.5.bi.2
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
