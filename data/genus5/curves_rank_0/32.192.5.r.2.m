...
// Magma code for modular curve with label 32.192.5.r.2

// Other names and/or labels
// Cummins-Pauli label: 32N5
// Rouse-Sutherland-Zureick-Brown label: 32.192.5.462

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 27, 24, 17], [13, 7, 24, 25], [17, 26, 16, 31], [19, 7, 8, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["16.96.1.s.1", "32.96.3.z.1", "32.96.3.ba.1"];
...
// Canonical model
model_0 := [2*y*z+w*t,4*x^2-2*y^2+2*w*t+t^2,2*y^2+2*y*z-2*z^2+w^2-3*w*t-t^2];
...
// Map from the canonical model to the plane model of modular curve with label 32.192.5.r.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
