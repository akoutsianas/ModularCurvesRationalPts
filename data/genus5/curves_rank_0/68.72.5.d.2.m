...
// Magma code for modular curve with label 68.72.5.d.2

// Other names and/or labels
// Cummins-Pauli label: 34B5
// Rouse-Sutherland-Zureick-Brown label: 68.72.5.16

// Group data
level := 68;
// Elements that, together with Gamma(level), generate the group
gens := [[6, 15, 53, 45], [49, 64, 39, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["34.36.3.b.1", "68.36.1.a.2", "68.36.3.c.1"];
...
// Map from the canonical model to the plane model of modular curve with label 68.72.5.d.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
