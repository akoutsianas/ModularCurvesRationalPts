...
// Magma code for modular curve with label 24.96.5.l.2

// Other names and/or labels
// Cummins-Pauli label: 24H5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.57

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 20, 0, 19], [5, 22, 12, 19], [7, 18, 0, 7], [13, 2, 0, 17], [13, 8, 0, 19], [17, 12, 0, 19], [23, 20, 0, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
// Canonical model
model_0 := [y*w+z*t+w*t,y^2-z^2+z*w-y*t,3*x^2-y*w+z*t];

// Singular plane model
model_1 := [x^4*y^2+4*x^4*y*z+3*x^4*z^2-y^4*z^2+4*y^3*z^3-3*y^2*z^4];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.l.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
//   Coordinate number 2:
map_1_coord_2 := 1*(2/3*y+1/3*t);
// Codomain equation:
map_1_codomain := [x^4*y^2+4*x^4*y*z+3*x^4*z^2-y^4*z^2+4*y^3*z^3-3*y^2*z^4];
