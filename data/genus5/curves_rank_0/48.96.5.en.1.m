...
// Magma code for modular curve with label 48.96.5.en.1

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.106

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 11, 34, 9], [13, 46, 16, 27], [21, 25, 46, 39], [37, 25, 46, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.bi.1", "48.48.1.hc.1", "48.48.1.he.2", "48.48.3.q.1", "48.48.3.v.1", "48.48.3.ep.2", "48.48.3.er.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.en.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
