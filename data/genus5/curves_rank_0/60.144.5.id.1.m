...
// Magma code for modular curve with label 60.144.5.id.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.806

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[29, 40, 16, 51], [37, 35, 0, 49], [47, 10, 50, 47]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.u.2", "60.72.1.bt.2", "60.72.1.bx.1", "60.72.1.di.1", "60.72.3.kq.1", "60.72.3.nd.1", "60.72.3.yb.2"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.id.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
