...
// Magma code for modular curve with label 40.120.5.el.1

// Other names and/or labels
// Cummins-Pauli label: 10B5
// Rouse-Sutherland-Zureick-Brown label: 40.120.5.20

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 6, 6, 9], [5, 9, 32, 35], [15, 16, 8, 5], [35, 21, 38, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["10.60.2.b.1", "40.30.2.h.1", "40.40.1.br.1", "40.60.2.m.1", "40.60.3.bp.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.120.5.el.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
