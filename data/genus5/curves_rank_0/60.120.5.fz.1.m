...
// Magma code for modular curve with label 60.120.5.fz.1

// Other names and/or labels
// Cummins-Pauli label: 20F5
// Rouse-Sutherland-Zureick-Brown label: 60.120.5.163

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 7, 22, 47], [17, 34, 22, 33], [25, 7, 22, 21], [45, 32, 2, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.2.f.1", "60.60.2.d.1", "60.60.3.bv.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.120.5.fz.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
