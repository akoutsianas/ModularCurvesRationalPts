...
// Magma code for modular curve with label 32.192.5.bo.2

// Other names and/or labels
// Cummins-Pauli label: 32O5
// Rouse-Sutherland-Zureick-Brown label: 32.192.5.679

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 18, 0, 15], [7, 11, 0, 9], [11, 16, 0, 17], [19, 22, 0, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["16.96.2.l.2", "32.96.1.f.2", "32.96.2.j.2"];
...
// Map from the canonical model to the plane model of modular curve with label 32.192.5.bo.2
//   Coordinate number 0:
map_1_coord_0 := 1*(w-t);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
