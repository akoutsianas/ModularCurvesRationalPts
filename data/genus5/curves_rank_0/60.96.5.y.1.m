...
// Magma code for modular curve with label 60.96.5.y.1

// Other names and/or labels
// Cummins-Pauli label: 20D5
// Rouse-Sutherland-Zureick-Brown label: 60.96.5.102

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 10, 7, 39], [27, 20, 19, 33], [38, 55, 59, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["20.48.3.j.1", "60.24.1.l.2", "60.48.1.bz.1", "60.48.3.v.1"];
...
// Canonical model
model_0 := [x*y+x*z+x*t-y^2+3*z^2-t^2,x^2-2*x*y-2*x*z+2*y^2+2*w^2,x*y-2*x*z+x*w+x*t-y^2+3*w^2-2*w*t-t^2];
...
// Map from the canonical model to the plane model of modular curve with label 60.96.5.y.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
