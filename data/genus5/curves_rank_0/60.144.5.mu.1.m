...
// Magma code for modular curve with label 60.144.5.mu.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.246

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[23, 37, 0, 13], [37, 42, 20, 41], [49, 3, 42, 31], [55, 8, 38, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.3.db.1", "60.72.1.be.1", "60.72.1.bh.1", "60.72.1.fb.1", "60.72.3.nj.1", "60.72.3.nn.1", "60.72.3.ve.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.mu.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(5*w);
