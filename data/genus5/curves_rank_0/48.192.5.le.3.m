...
// Magma code for modular curve with label 48.192.5.le.3

// Other names and/or labels
// Cummins-Pauli label: 48I5
// Rouse-Sutherland-Zureick-Brown label: 48.192.5.4242

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 7, 36, 37], [13, 45, 12, 41], [41, 21, 12, 7], [43, 8, 24, 29], [47, 4, 24, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["24.96.1.dp.3", "48.96.3.px.2", "48.96.3.qm.1"];
...
//   Coordinate number 1:
map_0_coord_1 := 1*(t^2*w^6*(w^2+t^2)*(162*y^2*w^12-108*y^2*w^10*t^2+54*y^2*w^8*t^4-936*y^2*w^6*t^6-594*y^2*w^4*t^8-108*y^2*w^2*t^10-6*y^2*t^12-81*w^14+18*w^12*t^2+w^10*t^4-4*w^8*t^6-47*w^6*t^8-14*w^4*t^10-w^2*t^12));

// Map from the canonical model to the plane model of modular curve with label 48.192.5.le.3
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
