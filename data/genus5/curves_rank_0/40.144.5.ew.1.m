...
// Magma code for modular curve with label 40.144.5.ew.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.462

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 18, 18, 19], [11, 36, 24, 23], [27, 26, 20, 23], [33, 21, 2, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.n.1", "40.72.1.m.2", "40.72.1.be.1", "40.72.1.by.1", "40.72.3.ci.1", "40.72.3.dd.1", "40.72.3.eg.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.ew.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
