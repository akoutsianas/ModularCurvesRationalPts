...
// Magma code for modular curve with label 40.96.5.g.1

// Other names and/or labels
// Cummins-Pauli label: 20D5
// Rouse-Sutherland-Zureick-Brown label: 40.96.5.24

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[2, 25, 13, 9], [22, 5, 29, 13], [23, 25, 36, 37], [29, 23, 0, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["20.48.3.f.1", "40.24.1.cc.1", "40.48.1.kg.1", "40.48.3.i.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.96.5.g.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
