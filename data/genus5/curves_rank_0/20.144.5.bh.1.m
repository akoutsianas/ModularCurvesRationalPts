...
// Magma code for modular curve with label 20.144.5.bh.1

// Other names and/or labels
// Cummins-Pauli label: 20J5
// Rouse-Sutherland-Zureick-Brown label: 20.144.5.78

// Group data
level := 20;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 2, 16, 11], [11, 16, 9, 1], [15, 6, 4, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.u.1", "20.72.3.bp.1", "20.72.3.bt.1"];
...
// Canonical model
model_0 := [2*x*y+y^2-z^2-w^2,x*y-2*y^2+2*z^2+w^2-w*t,5*x^2+x*y-2*y^2-3*z^2+2*w^2-w*t-t^2];
...
// Map from the canonical model to the plane model of modular curve with label 20.144.5.bh.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
