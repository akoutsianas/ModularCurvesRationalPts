...
// Magma code for modular curve with label 48.192.5.g.1

// Other names and/or labels
// Cummins-Pauli label: 16O5
// Rouse-Sutherland-Zureick-Brown label: 48.192.5.1321

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 8, 20, 23], [19, 40, 0, 7], [23, 12, 0, 47], [23, 16, 24, 17], [25, 24, 44, 41]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["16.96.2.b.1", "24.96.1.x.1", "48.96.2.b.1"];
...
model_1 := [9*x^4*y^4-6*x^4*y^2*z^2+x^4*z^4-72*x^3*y^5+8*x^3*y*z^4+180*x^2*y^6+108*x^2*y^4*z^2+20*x^2*y^2*z^4-4*x^2*z^6+288*x*y^7-32*x*y^3*z^4+738*y^8-348*y^6*z^2+100*y^4*z^4-28*y^2*z^6+2*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 48.192.5.g.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+z);
//   Coordinate number 1:
...
// Codomain equation:
map_1_codomain := [9*x^4*y^4-6*x^4*y^2*z^2+x^4*z^4-72*x^3*y^5+8*x^3*y*z^4+180*x^2*y^6+108*x^2*y^4*z^2+20*x^2*y^2*z^4-4*x^2*z^6+288*x*y^7-32*x*y^3*z^4+738*y^8-348*y^6*z^2+100*y^4*z^4-28*y^2*z^6+2*z^8];
