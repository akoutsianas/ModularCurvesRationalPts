...
// Magma code for modular curve with label 24.192.5.cp.1

// Other names and/or labels
// Cummins-Pauli label: 24AB5
// Rouse-Sutherland-Zureick-Brown label: 24.192.5.1722

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 8, 12, 17], [1, 10, 12, 23], [5, 0, 0, 1], [5, 20, 0, 23], [13, 20, 0, 19], [23, 14, 12, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["24.96.1.ck.4", "24.96.3.bp.1", "24.96.3.br.4"];
...
// Map from the canonical model to the plane model of modular curve with label 24.192.5.cp.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
