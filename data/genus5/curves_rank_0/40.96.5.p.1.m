...
// Magma code for modular curve with label 40.96.5.p.1

// Other names and/or labels
// Cummins-Pauli label: 20D5
// Rouse-Sutherland-Zureick-Brown label: 40.96.5.36

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[4, 7, 27, 4], [9, 28, 25, 27], [15, 19, 2, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["20.48.3.g.1", "40.24.1.cl.2", "40.48.1.kg.1", "40.48.3.j.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.96.5.p.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
