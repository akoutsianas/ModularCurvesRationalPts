...
// Magma code for modular curve with label 60.96.5.v.1

// Other names and/or labels
// Cummins-Pauli label: 20D5
// Rouse-Sutherland-Zureick-Brown label: 60.96.5.85

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 35, 43, 18], [14, 55, 11, 27], [36, 25, 55, 28], [56, 5, 49, 51]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['5.12.0.a.2', '12.8.0.c.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["20.48.3.i.2", "30.24.1.d.2", "60.48.1.bz.2", "60.48.3.u.1"];
...
// Canonical model
model_0 := [2*x^2+2*x*y+2*x*z+4*x*w+y^2+2*y*z-2*y*w+z^2-2*z*w-2*w^2,5*x^2-y^2-3*y*z+y*t-z^2-z*t,x^2+x*y+x*z+2*x*w+2*y*z+4*y*w+y*t+4*z*w-z*t+4*w^2-3*t^2];
...
// Map from the canonical model to the plane model of modular curve with label 60.96.5.v.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*w);
