...
// Magma code for modular curve with label 40.144.5.hq.2

// Other names and/or labels
// Cummins-Pauli label: 40M5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.603

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 17, 16, 5], [11, 6, 24, 23], [15, 36, 12, 29], [23, 30, 24, 39], [39, 24, 12, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["40.72.1.v.1", "40.72.3.cd.2", "40.72.3.cg.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.hq.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(x);
