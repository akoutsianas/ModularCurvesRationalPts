...
// Magma code for modular curve with label 40.144.5.jt.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.473

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 0, 34, 9], [13, 9, 22, 15], [23, 3, 30, 21], [23, 26, 24, 15], [37, 19, 36, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.bf.1", "40.72.1.bh.1", "40.72.1.bt.1", "40.72.1.ct.1", "40.72.3.dd.2", "40.72.3.dp.1", "40.72.3.fb.2"];
...
model_1 := [25*x^8-900*x^6*y^2+100*x^4*y^4+440*x^6*z^2-1520*x^4*y^2*z^2+1976*x^4*z^4-720*x^2*y^2*z^4+352*x^2*z^6+16*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.jt.1
//   Coordinate number 0:
...
map_1_coord_2 := 1*(t);
// Codomain equation:
map_1_codomain := [25*x^8-900*x^6*y^2+100*x^4*y^4+440*x^6*z^2-1520*x^4*y^2*z^2+1976*x^4*z^4-720*x^2*y^2*z^4+352*x^2*z^6+16*z^8];
