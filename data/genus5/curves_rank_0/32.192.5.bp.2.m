...
// Magma code for modular curve with label 32.192.5.bp.2

// Other names and/or labels
// Cummins-Pauli label: 32O5
// Rouse-Sutherland-Zureick-Brown label: 32.192.5.675

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 30, 16, 23], [7, 15, 16, 9], [9, 29, 16, 23], [25, 2, 16, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["16.96.2.j.2", "32.96.1.b.1", "32.96.2.k.1"];
...
model_1 := [8*x^6*y+4*x^5*y^2-20*x^4*y*z^2-28*x^3*y^2*z^2-12*x^2*y^3*z^2-2*x*y^4*z^2+2*x^2*y*z^4+5*x*y^2*z^4+2*y^3*z^4-2*x*z^6-y*z^6];
...
// Map from the canonical model to the plane model of modular curve with label 32.192.5.bp.2
//   Coordinate number 0:
map_1_coord_0 := 1*(z-w);
//   Coordinate number 1:
...
map_1_coord_2 := 1*(2*y);
// Codomain equation:
map_1_codomain := [8*x^6*y+4*x^5*y^2-20*x^4*y*z^2-28*x^3*y^2*z^2-12*x^2*y^3*z^2-2*x*y^4*z^2+2*x^2*y*z^4+5*x*y^2*z^4+2*y^3*z^4-2*x*z^6-y*z^6];
