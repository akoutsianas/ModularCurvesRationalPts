...
// Magma code for modular curve with label 24.192.5.h.3

// Other names and/or labels
// Cummins-Pauli label: 12E5
// Rouse-Sutherland-Zureick-Brown label: 24.192.5.1221

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 12, 12, 19], [5, 0, 12, 7], [5, 16, 12, 13], [7, 8, 0, 23], [13, 8, 18, 11], [17, 8, 0, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["12.96.3.g.2", "24.96.1.cj.1", "24.96.1.ck.2", "24.96.1.cl.2", "24.96.3.f.1", "24.96.3.bu.2", "24.96.3.bx.2"];
...
// Canonical model
model_0 := [2*x^2+w^2-t^2,x^2+y^2-2*y*z-w^2+t^2,x^2-y^2-2*y*z+2*z^2-w^2-2*t^2];
...
//   Coordinate number 1:
map_0_coord_1 := 1*(t^4*w^4*(w-t)^2*(w+t)^2*(8*z^2*w^10-20*z^2*w^8*t^2+8*z^2*w^6*t^4+8*z^2*w^4*t^6-20*z^2*w^2*t^8+8*z^2*t^10+12*w^12-42*w^10*t^2+45*w^8*t^4-6*w^6*t^6+3*w^4*t^8));

// Map from the canonical model to the plane model of modular curve with label 24.192.5.h.3
//   Coordinate number 0:
