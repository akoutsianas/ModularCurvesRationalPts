...
// Magma code for modular curve with label 24.96.5.gy.1

// Other names and/or labels
// Cummins-Pauli label: 24J5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.178

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 13, 0, 5], [7, 19, 6, 5], [13, 7, 18, 23], [23, 1, 0, 13], [23, 20, 18, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.24.0.ea.1", "24.48.2.l.1", "24.48.2.p.1", "24.48.3.cl.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.gy.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
