...
// Magma code for modular curve with label 24.192.5.cg.3

// Other names and/or labels
// Cummins-Pauli label: 24AB5
// Rouse-Sutherland-Zureick-Brown label: 24.192.5.1748

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 18, 0, 13], [7, 20, 12, 17], [11, 18, 12, 1], [19, 2, 0, 5], [19, 8, 0, 1], [19, 22, 0, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["24.96.1.ck.2", "24.96.3.bm.2", "24.96.3.bo.2"];
...
// Map from the canonical model to the plane model of modular curve with label 24.192.5.cg.3
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*y);
