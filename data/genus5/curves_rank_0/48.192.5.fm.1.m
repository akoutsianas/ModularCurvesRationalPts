...
// Magma code for modular curve with label 48.192.5.fm.1

// Other names and/or labels
// Cummins-Pauli label: 16N5
// Rouse-Sutherland-Zureick-Brown label: 48.192.5.607

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 34, 32, 7], [19, 8, 24, 7], [29, 18, 24, 25], [29, 30, 40, 23], [37, 36, 8, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["16.96.1.c.1", "48.96.2.g.1", "48.96.2.h.1"];
...
// Canonical model
model_0 := [y*w-z*w+y*t+z*t,3*x^2+y*z-z^2+w^2+w*t,y^2+2*y*z-z^2+w^2+2*w*t-t^2];

// Singular plane model
model_1 := [36*x^4*y^4-144*x^4*y^3*z+72*x^4*y^2*z^2+144*x^4*y*z^3+36*x^4*z^4-36*x^2*y^6-24*x^2*y^5*z+84*x^2*y^4*z^2+432*x^2*y^3*z^3+84*x^2*y^2*z^4-120*x^2*y*z^5-36*x^2*z^6+9*y^8+96*y^7*z+328*y^6*z^2+408*y^5*z^3+254*y^4*z^4-56*y^2*z^6-24*y*z^7+9*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 48.192.5.fm.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+w);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
...
map_1_coord_2 := 1*(z);
// Codomain equation:
map_1_codomain := [36*x^4*y^4-144*x^4*y^3*z+72*x^4*y^2*z^2+144*x^4*y*z^3+36*x^4*z^4-36*x^2*y^6-24*x^2*y^5*z+84*x^2*y^4*z^2+432*x^2*y^3*z^3+84*x^2*y^2*z^4-120*x^2*y*z^5-36*x^2*z^6+9*y^8+96*y^7*z+328*y^6*z^2+408*y^5*z^3+254*y^4*z^4-56*y^2*z^6-24*y*z^7+9*z^8];
