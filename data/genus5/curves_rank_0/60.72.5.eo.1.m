...
// Magma code for modular curve with label 60.72.5.eo.1

// Other names and/or labels
// Cummins-Pauli label: 30G5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.152

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 45, 54, 1], [33, 20, 26, 51], [41, 50, 52, 53], [57, 5, 5, 48]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["30.36.2.a.1", "60.36.1.gb.1", "60.36.2.fs.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.72.5.eo.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
