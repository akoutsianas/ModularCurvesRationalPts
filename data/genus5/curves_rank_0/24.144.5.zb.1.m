...
// Magma code for modular curve with label 24.144.5.zb.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1111

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 7, 10, 9], [5, 23, 20, 7], [11, 6, 6, 17], [19, 17, 22, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.ei.1", "24.72.2.s.1", "24.72.2.bd.1", "24.72.2.hr.1", "24.72.2.ix.1", "24.72.3.bdb.1", "24.72.3.beh.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.zb.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
