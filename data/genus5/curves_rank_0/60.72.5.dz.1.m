...
// Magma code for modular curve with label 60.72.5.dz.1

// Other names and/or labels
// Cummins-Pauli label: 30G5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.154

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[4, 5, 37, 49], [13, 30, 48, 53], [46, 35, 43, 7], [57, 10, 17, 39]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["30.36.2.a.1", "60.36.1.fy.1", "60.36.2.ft.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.72.5.dz.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
