...
// Magma code for modular curve with label 24.192.5.ci.4

// Other names and/or labels
// Cummins-Pauli label: 24AB5
// Rouse-Sutherland-Zureick-Brown label: 24.192.5.1720

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 0, 0, 23], [5, 10, 12, 23], [19, 2, 12, 23], [19, 12, 12, 17], [23, 18, 12, 7], [23, 22, 0, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["24.96.1.ck.4", "24.96.3.bm.1", "24.96.3.bq.2"];
...
// Map from the canonical model to the plane model of modular curve with label 24.192.5.ci.4
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
