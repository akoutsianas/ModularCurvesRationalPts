...
// Magma code for modular curve with label 24.72.5.cu.1

// Other names and/or labels
// Cummins-Pauli label: 24A5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.196

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 6, 12, 5], [5, 9, 18, 7], [11, 4, 4, 7], [11, 23, 16, 5], [21, 17, 8, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.bw.1", "24.24.1.y.1", "24.36.0.cf.1", "24.36.3.c.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.5.cu.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*r);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.5.cu.1
//   Coordinate number 0:
map_2_coord_0 := 1*(w);
//   Coordinate number 1:
