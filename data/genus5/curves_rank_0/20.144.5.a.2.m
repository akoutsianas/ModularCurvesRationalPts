...
// Magma code for modular curve with label 20.144.5.a.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 20.144.5.12

// Group data
level := 20;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 6, 0, 13], [1, 16, 14, 11], [5, 4, 18, 19], [11, 4, 0, 19], [17, 2, 12, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['4.12.0.a.1', '5.12.0.a.2']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["10.72.1.a.2", "20.72.1.d.1", "20.72.1.v.1", "20.72.3.a.1", "20.72.3.f.1", "20.72.3.r.1", "20.72.3.bm.1"];
...
// Canonical model
model_0 := [x^2-y*z+y*w,2*x^2-y^2-z^2-y*w+3*z*w-w^2+t^2,2*x^2+y^2+y*z+z^2-3*z*w+w^2-y*t+z*t+w*t];

// Singular plane model
model_1 := [x^6*y+x^6*z+2*x^4*y^3-x^4*y^2*z+x^2*y^5-x^2*y^4*z+4*x^2*y^3*z^2-2*x^2*y^2*z^3+y^6*z-2*y^4*z^3+y^3*z^4];
...
// Map from the canonical model to the plane model of modular curve with label 20.144.5.a.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
...
map_1_coord_2 := 1*(z);
// Codomain equation:
map_1_codomain := [x^6*y+x^6*z+2*x^4*y^3-x^4*y^2*z+x^2*y^5-x^2*y^4*z+4*x^2*y^3*z^2-2*x^2*y^2*z^3+y^6*z-2*y^4*z^3+y^3*z^4];
