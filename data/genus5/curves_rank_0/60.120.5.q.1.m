...
// Magma code for modular curve with label 60.120.5.q.1

// Other names and/or labels
// Cummins-Pauli label: 10A5
// Rouse-Sutherland-Zureick-Brown label: 60.120.5.201

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[2, 15, 55, 19], [3, 50, 20, 3], [8, 35, 15, 14], [37, 25, 30, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.3.e.1", "30.60.2.c.1", "60.24.1.f.1", "60.24.1.f.2", "60.60.0.a.1"];
...
// Embedded model
model_0 := [y*z-x*u,z*w-z*t-t*u+z*v,x*w-x*t-y*t+x*v,z*w+3*z*t+u*v,3*x*z-2*y*z-x*u-t*r,2*y*z+x*u-3*y*u-w*r+t*r-v*r,3*z^2+w*t-t^2+w*v-t*v,w*t+3*t^2+w*v-t*v+v^2,x*w+3*x*t+y*v,4*x*w+2*y*t-2*x*v+y*v+z*r,5*w*t-t^2-3*z*u+v^2,x*w-5*y*w-x*t+4*y*t+x*v-u*r,3*x*z+4*y*z+5*x*u+3*y*u+w*r+2*t*r,3*z^2-5*w^2+3*w*t+2*t^2+3*z*u+3*u^2-2*w*v+2*t*v,15*x^2-15*x*y-w^2+w*t+t^2,30*x^2+30*x*y+15*y^2+2*w^2-w*t+t^2+w*v-t*v+v^2-r^2];

// Singular plane model
model_1 := [88209*x^12-85536*x^10*y^2+20736*x^8*y^4+266085*x^10*z^2-60588*x^8*y^2*z^2+500553*x^6*y^4*z^2-295200*x^4*y^6*z^2-96000*x^2*y^8*z^2+292410*x^8*z^4+25920*x^6*y^2*z^4+1387845*x^4*y^4*z^4-333600*x^2*y^6*z^4+32000*y^8*z^4+135000*x^6*z^6-107550*x^4*y^2*z^6+1035000*x^2*y^4*z^6-176000*y^6*z^6+27225*x^4*z^8-72600*x^2*y^2*z^8+242000*y^4*z^8];
...
// Map from the embedded model to the plane model of modular curve with label 60.120.5.q.1
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
map_1_coord_1 := 1*(r);
...
map_1_coord_2 := 1*(v);
// Codomain equation:
map_1_codomain := [88209*x^12-85536*x^10*y^2+20736*x^8*y^4+266085*x^10*z^2-60588*x^8*y^2*z^2+500553*x^6*y^4*z^2-295200*x^4*y^6*z^2-96000*x^2*y^8*z^2+292410*x^8*z^4+25920*x^6*y^2*z^4+1387845*x^4*y^4*z^4-333600*x^2*y^6*z^4+32000*y^8*z^4+135000*x^6*z^6-107550*x^4*y^2*z^6+1035000*x^2*y^4*z^6-176000*y^6*z^6+27225*x^4*z^8-72600*x^2*y^2*z^8+242000*y^4*z^8];
