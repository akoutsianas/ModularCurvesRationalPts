...
// Magma code for modular curve with label 40.144.5.jm.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.476

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 20, 0, 23], [9, 10, 20, 9], [33, 29, 16, 31], [37, 4, 36, 5], [37, 39, 30, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.bf.1", "40.72.1.be.2", "40.72.1.bq.1", "40.72.1.cq.2", "40.72.3.da.1", "40.72.3.dm.1", "40.72.3.ey.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.jm.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x+z);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
