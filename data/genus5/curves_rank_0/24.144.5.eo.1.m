...
// Magma code for modular curve with label 24.144.5.eo.1

// Other names and/or labels
// Cummins-Pauli label: 24R5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1029

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 14, 8, 3], [11, 3, 12, 17], [15, 20, 4, 3], [23, 3, 12, 7], [23, 12, 0, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.v.1", "24.72.3.oq.1", "24.72.3.pd.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.eo.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
