...
// Magma code for modular curve with label 24.192.5.dl.1

// Other names and/or labels
// Cummins-Pauli label: 24Z5
// Rouse-Sutherland-Zureick-Brown label: 24.192.5.1555

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 3, 8, 13], [7, 18, 12, 13], [11, 12, 12, 1], [23, 21, 8, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["24.96.1.cr.1", "24.96.1.df.1", "24.96.1.dr.1", "24.96.3.co.1", "24.96.3.ct.1", "24.96.3.gm.3", "24.96.3.gy.3"];
...
model_1 := [49*x^8+92*x^6*y^2+84*x^6*z^2+46*x^4*y^4+116*x^4*y^2*z^2+50*x^4*z^4+12*x^2*y^6+44*x^2*y^4*z^2+60*x^2*y^2*z^4+12*x^2*z^6+9*y^8+12*y^6*z^2+10*y^4*z^4+12*y^2*z^6+z^8];
...
// Map from the canonical model to the plane model of modular curve with label 24.192.5.dl.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
...
map_1_coord_2 := 1*(t);
// Codomain equation:
map_1_codomain := [49*x^8+92*x^6*y^2+84*x^6*z^2+46*x^4*y^4+116*x^4*y^2*z^2+50*x^4*z^4+12*x^2*y^6+44*x^2*y^4*z^2+60*x^2*y^2*z^4+12*x^2*z^6+9*y^8+12*y^6*z^2+10*y^4*z^4+12*y^2*z^6+z^8];
