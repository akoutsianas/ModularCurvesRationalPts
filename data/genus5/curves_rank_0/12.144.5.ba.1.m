...
// Magma code for modular curve with label 12.144.5.ba.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 12.144.5.36

// Group data
level := 12;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 8, 4, 9], [9, 1, 10, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.1.k.1", "12.72.1.m.1", "12.72.1.s.1", "12.72.3.cs.1", "12.72.3.cu.1", "12.72.3.cz.1", "12.72.3.dd.1"];
...
// Map from the canonical model to the plane model of modular curve with label 12.144.5.ba.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
