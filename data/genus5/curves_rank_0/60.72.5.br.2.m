...
// Magma code for modular curve with label 60.72.5.br.2

// Other names and/or labels
// Cummins-Pauli label: 30C5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.86

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[18, 5, 37, 12], [24, 55, 49, 12], [38, 35, 59, 22], [43, 15, 39, 34]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["30.36.0.f.2", "60.24.1.u.1", "60.36.2.ft.1", "60.36.3.b.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.5.br.2
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
map_1_coord_1 := 1*(v);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.72.5.br.2
//   Coordinate number 0:
map_2_coord_0 := 1*(r);
//   Coordinate number 1:
