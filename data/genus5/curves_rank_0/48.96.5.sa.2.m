...
// Magma code for modular curve with label 48.96.5.sa.2

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.220

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 2, 28, 9], [3, 41, 22, 19], [5, 1, 46, 1], [5, 17, 6, 43]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.cj.2", "24.48.1.kv.2", "48.48.1.im.2", "48.48.3.dj.1", "48.48.3.ed.2", "48.48.3.eq.2", "48.48.3.gb.1"];
...
// Canonical model
model_0 := [2*y^2+x*z,x^2+2*z^2-w^2+w*t-t^2,2*y^2-3*x*z+w^2+2*w*t-2*t^2];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.sa.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
