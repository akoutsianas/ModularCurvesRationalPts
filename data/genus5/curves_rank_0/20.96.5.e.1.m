...
// Magma code for modular curve with label 20.96.5.e.1

// Other names and/or labels
// Cummins-Pauli label: 20D5
// Rouse-Sutherland-Zureick-Brown label: 20.96.5.4

// Group data
level := 20;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 13, 12, 17], [9, 2, 11, 15], [9, 15, 5, 4]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["10.24.1.b.2", "20.48.1.b.1", "20.48.3.g.1", "20.48.3.i.2"];
...
// Canonical model
model_0 := [x*y+x*z-2*x*t-y^2+3*y*z-z^2+w^2,3*x^2+x*y+x*z-2*x*t-y*w-z*w+w^2,2*x^2-y^2-2*y*z+2*y*t-z^2+2*z*t-2*w^2-2*t^2];
...
// Map from the canonical model to the plane model of modular curve with label 20.96.5.e.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y-z);
