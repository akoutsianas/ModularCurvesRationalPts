...
// Magma code for modular curve with label 60.120.5.h.1

// Other names and/or labels
// Cummins-Pauli label: 20E5
// Rouse-Sutherland-Zureick-Brown label: 60.120.5.192

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 26, 47, 41], [21, 38, 26, 27], [39, 50, 13, 31], [49, 30, 38, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.3.b.1", "60.60.2.a.1", "60.60.2.h.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.120.5.h.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
