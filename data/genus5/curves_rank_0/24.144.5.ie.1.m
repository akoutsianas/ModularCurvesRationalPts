...
// Magma code for modular curve with label 24.144.5.ie.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.627

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 17, 8, 21], [13, 12, 6, 19], [21, 16, 14, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.3.cs.1", "24.72.1.bj.1", "24.72.1.bq.1", "24.72.1.ci.1", "24.72.3.to.1", "24.72.3.ue.1", "24.72.3.uu.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.ie.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
