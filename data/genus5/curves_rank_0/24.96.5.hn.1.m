...
// Magma code for modular curve with label 24.96.5.hn.1

// Other names and/or labels
// Cummins-Pauli label: 24J5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.5

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 8, 0, 17], [11, 0, 0, 11], [17, 5, 0, 19], [17, 5, 6, 23], [17, 12, 6, 11], [19, 11, 18, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['3.4.0.a.1', '8.24.0.bf.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["8.24.0.bf.1", "12.48.2.d.1", "24.48.2.i.1", "24.48.3.co.1"];
...
// Canonical model
model_0 := [y^2-z^2-x*t-w*t,x*y-x*z-y*w-z*w+y*t-z*t,2*y^2-x*w+x*t];

// Singular plane model
model_1 := [x^6-10*x^4*y^2+x^2*y^4-3*x^4*z^2-y^4*z^2+3*x^2*z^4+2*y^2*z^4-z^6];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.hn.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
...
map_1_coord_2 := 1*(z);
// Codomain equation:
map_1_codomain := [x^6-10*x^4*y^2+x^2*y^4-3*x^4*z^2-y^4*z^2+3*x^2*z^4+2*y^2*z^4-z^6];
