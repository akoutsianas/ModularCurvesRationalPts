...
// Magma code for modular curve with label 60.96.5.ca.3

// Other names and/or labels
// Cummins-Pauli label: 30M5
// Rouse-Sutherland-Zureick-Brown label: 60.96.5.27

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[8, 25, 21, 44], [13, 35, 21, 14], [23, 0, 9, 11], [26, 25, 39, 11], [53, 20, 57, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
// Canonical model
model_0 := [x^2+y*w+z*w+y*t-z*t,z*w+w^2-y*t+w*t-t^2,3*y*z+2*y*w-z*w+y*t+2*z*t];
...
// Map from the canonical model to the plane model of modular curve with label 60.96.5.ca.3
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(x);
