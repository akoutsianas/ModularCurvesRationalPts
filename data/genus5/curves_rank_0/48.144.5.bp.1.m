...
// Magma code for modular curve with label 48.144.5.bp.1

// Other names and/or labels
// Cummins-Pauli label: 48E5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.414

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 26, 46, 25], [19, 32, 20, 23], [23, 33, 30, 41], [25, 10, 44, 25], [29, 2, 46, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.2.hv.1", "48.48.1.hp.1", "48.72.0.b.2", "48.72.3.bg.2"];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.bp.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(v);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.bp.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-t);
//   Coordinate number 1:
map_2_coord_1 := 1*(-41*w^6-27*w^4*t*v);
//   Coordinate number 2:
map_2_coord_2 := 1*(-w);
// Codomain equation:
