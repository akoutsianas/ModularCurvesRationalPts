...
// Magma code for modular curve with label 24.144.5.bep.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1138

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 10, 16, 15], [7, 4, 22, 5], [7, 20, 20, 11], [13, 23, 20, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.fa.1", "24.72.2.cs.1", "24.72.2.dg.1", "24.72.2.hv.1", "24.72.2.it.1", "24.72.3.bgd.1", "24.72.3.bhb.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.bep.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
