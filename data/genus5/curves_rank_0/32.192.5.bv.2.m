...
// Magma code for modular curve with label 32.192.5.bv.2

// Other names and/or labels
// Cummins-Pauli label: 32O5
// Rouse-Sutherland-Zureick-Brown label: 32.192.5.674

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 13, 0, 21], [7, 9, 0, 15], [17, 9, 0, 19], [25, 11, 0, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["16.96.2.j.2", "32.96.1.f.1", "32.96.2.l.1"];
...
// Map from the canonical model to the plane model of modular curve with label 32.192.5.bv.2
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
