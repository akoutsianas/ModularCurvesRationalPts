...
// Magma code for modular curve with label 24.96.5.k.2

// Other names and/or labels
// Cummins-Pauli label: 24H5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.60

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 8, 0, 7], [1, 14, 12, 1], [5, 12, 12, 1], [7, 10, 0, 1], [11, 4, 0, 11], [13, 2, 12, 13], [17, 22, 12, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
// Canonical model
model_0 := [z*w+y*t+z*t,y^2-y*z-w^2+w*t,6*x^2+z*w-y*t];

// Singular plane model
model_1 := [x^4*y^2+3*x^4*y*z+2*x^4*z^2-144*y^4*z^2+108*y^2*z^4+36*y*z^5];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.k.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Codomain equation:
map_1_codomain := [x^4*y^2+3*x^4*y*z+2*x^4*z^2-144*y^4*z^2+108*y^2*z^4+36*y*z^5];
