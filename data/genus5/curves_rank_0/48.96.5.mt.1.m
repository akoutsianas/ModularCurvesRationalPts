...
// Magma code for modular curve with label 48.96.5.mt.1

// Other names and/or labels
// Cummins-Pauli label: 16H5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.341

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 24, 30, 19], [13, 13, 42, 43], [31, 42, 44, 35], [41, 7, 24, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.u.1", "48.48.2.bk.1", "48.48.3.dd.1"];
...
// Canonical model
model_0 := [y*z+x*w,6*y^2+8*z^2+3*w^2-4*w*t-t^2,12*x^2+3*y^2+4*z^2+w^2-w*t];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.mt.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
