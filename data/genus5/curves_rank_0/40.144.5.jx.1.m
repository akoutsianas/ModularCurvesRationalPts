...
// Magma code for modular curve with label 40.144.5.jx.1

// Other names and/or labels
// Cummins-Pauli label: 40N5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.673

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 3, 8, 35], [15, 12, 8, 19], [35, 17, 26, 21], [37, 34, 6, 15], [39, 17, 16, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["40.72.1.cq.1", "40.72.3.fd.1", "40.72.3.fp.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.jx.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
