...
// Magma code for modular curve with label 40.144.5.jd.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.436

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 4, 36, 15], [19, 3, 8, 9], [21, 13, 24, 35], [25, 24, 26, 23], [27, 6, 20, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.be.1", "40.72.1.z.1", "40.72.1.bn.2", "40.72.1.cq.1", "40.72.3.cu.2", "40.72.3.dg.1", "40.72.3.fb.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.jd.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
