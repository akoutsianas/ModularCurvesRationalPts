...
// Magma code for modular curve with label 40.144.5.lw.1

// Other names and/or labels
// Cummins-Pauli label: 40N5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.653

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 14, 8, 33], [19, 32, 6, 5], [25, 13, 14, 19], [35, 28, 14, 9], [39, 37, 36, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["40.72.1.ct.1", "40.72.3.fp.1", "40.72.3.fs.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.lw.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
