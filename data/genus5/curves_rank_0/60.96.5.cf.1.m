...
// Magma code for modular curve with label 60.96.5.cf.1

// Other names and/or labels
// Cummins-Pauli label: 20D5
// Rouse-Sutherland-Zureick-Brown label: 60.96.5.96

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 5, 4, 3], [21, 55, 7, 32], [29, 0, 9, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["20.48.3.h.1", "60.24.1.bb.2", "60.48.1.bz.1", "60.48.3.cp.2"];
...
// Canonical model
model_0 := [x^2-x*y+x*z+y^2+2*y*z-z^2,3*x^2+3*x*z-x*t-6*y^2-3*z^2+2*w*t+t^2,3*x^2-2*x*y-4*x*z+2*x*w-4*y^2+4*y*z+4*z^2-2*w^2-2*t^2];
...
//   Coordinate number 0:
map_0_coord_0 := 1*(3*x+9*w-3*t);
//   Coordinate number 1:
map_0_coord_1 := 1*(7*x+w+3*t);
//   Coordinate number 2:
map_0_coord_2 := 1*(8*x-w-3*t);
// Codomain equation:
...
// Map from the canonical model to the plane model of modular curve with label 60.96.5.cf.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
