...
// Magma code for modular curve with label 40.144.5.jx.2

// Other names and/or labels
// Cummins-Pauli label: 40N5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.685

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 0, 0, 27], [13, 25, 30, 3], [19, 18, 26, 21], [33, 14, 0, 37], [39, 9, 10, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["40.72.1.cq.2", "40.72.3.fd.1", "40.72.3.fp.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.jx.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
