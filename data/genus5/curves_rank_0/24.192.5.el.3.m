...
// Magma code for modular curve with label 24.192.5.el.3

// Other names and/or labels
// Cummins-Pauli label: 24Z5
// Rouse-Sutherland-Zureick-Brown label: 24.192.5.1577

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 0, 4, 1], [11, 6, 0, 13], [17, 12, 12, 23], [23, 21, 20, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["24.96.1.cy.1", "24.96.1.dl.4", "24.96.1.dm.2", "24.96.3.eg.1", "24.96.3.eo.1", "24.96.3.gs.4", "24.96.3.gt.2"];
...
model_1 := [7056*x^8+720*x^6*y^2+36*x^4*y^4-3360*x^6*z^2-336*x^4*y^2*z^2-776*x^4*z^4-60*x^2*y^2*z^4+280*x^2*z^6+49*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 24.192.5.el.3
//   Coordinate number 0:
map_1_coord_0 := 1*(y+z);
//   Coordinate number 1:
...
map_1_coord_2 := 1*(t);
// Codomain equation:
map_1_codomain := [7056*x^8+720*x^6*y^2+36*x^4*y^4-3360*x^6*z^2-336*x^4*y^2*z^2-776*x^4*z^4-60*x^2*y^2*z^4+280*x^2*z^6+49*z^8];
