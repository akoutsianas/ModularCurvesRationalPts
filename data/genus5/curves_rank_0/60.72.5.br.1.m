...
// Magma code for modular curve with label 60.72.5.br.1

// Other names and/or labels
// Cummins-Pauli label: 30C5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.83

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 30, 12, 11], [4, 35, 29, 47], [28, 5, 19, 22], [39, 10, 38, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["30.36.0.f.1", "60.24.1.u.2", "60.36.2.ft.2", "60.36.3.b.1"];
...
model_1 := [x^12+22*x^6*z^6-3*y^2*z^10+125*z^12];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.5.br.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(5*v);
...
// Codomain equation:
map_1_codomain := [x^12+22*x^6*z^6-3*y^2*z^10+125*z^12];

// Map from the embedded model to the Weierstrass model of modular curve with label 60.72.5.br.1
//   Coordinate number 0:
map_2_coord_0 := 1*(w);
//   Coordinate number 1:
