...
// Magma code for modular curve with label 40.144.5.lc.2

// Other names and/or labels
// Cummins-Pauli label: 40N5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.689

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 34, 32, 21], [17, 0, 16, 21], [17, 17, 6, 3], [21, 33, 28, 11], [37, 11, 20, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["40.72.1.cq.2", "40.72.3.fg.2", "40.72.3.fs.1"];
...
// Canonical model
model_0 := [x*t+2*y*w,x^2+2*x*t+4*z^2-2*w^2,x^2+10*y^2-2*w^2-t^2];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.lc.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
