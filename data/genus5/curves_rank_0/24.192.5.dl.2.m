...
// Magma code for modular curve with label 24.192.5.dl.2

// Other names and/or labels
// Cummins-Pauli label: 24Z5
// Rouse-Sutherland-Zureick-Brown label: 24.192.5.1476

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 3, 12, 23], [7, 18, 16, 23], [7, 21, 12, 7], [23, 3, 12, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["24.96.1.cr.2", "24.96.1.df.2", "24.96.1.dr.2", "24.96.3.co.1", "24.96.3.ct.1", "24.96.3.gm.1", "24.96.3.gy.1"];
...
model_1 := [13*x^8-16*x^7*y+24*x^6*y^2-16*x^5*y^3+4*x^4*y^4+16*x^6*z^2-32*x^5*y*z^2+16*x^4*y^2*z^2-24*x^4*z^4+16*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 24.192.5.dl.2
//   Coordinate number 0:
map_1_coord_0 := 1*(z+w);
//   Coordinate number 1:
...
map_1_coord_2 := 1*(t);
// Codomain equation:
map_1_codomain := [13*x^8-16*x^7*y+24*x^6*y^2-16*x^5*y^3+4*x^4*y^4+16*x^6*z^2-32*x^5*y*z^2+16*x^4*y^2*z^2-24*x^4*z^4+16*z^8];
