...
// Magma code for modular curve with label 12.144.5.i.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 12.144.5.10

// Group data
level := 12;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 3, 6, 1], [1, 6, 0, 1], [5, 0, 0, 1], [5, 0, 0, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['3.12.0.a.1', '4.12.0.c.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["12.48.1.e.1", "12.72.1.b.1", "12.72.1.d.1", "12.72.1.s.1", "12.72.3.t.1", "12.72.3.be.1", "12.72.3.ca.1", "12.72.3.cy.1"];
...
// Map from the canonical model to the plane model of modular curve with label 12.144.5.i.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+w);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
