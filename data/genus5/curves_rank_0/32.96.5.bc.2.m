...
// Magma code for modular curve with label 32.96.5.bc.2

// Other names and/or labels
// Cummins-Pauli label: 32D5
// Rouse-Sutherland-Zureick-Brown label: 32.96.5.31

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 6, 16, 23], [13, 3, 24, 5], [25, 7, 24, 21], [29, 27, 0, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.x.2", "32.48.3.c.1", "32.48.3.e.1"];
...
// Map from the canonical model to the plane model of modular curve with label 32.96.5.bc.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
