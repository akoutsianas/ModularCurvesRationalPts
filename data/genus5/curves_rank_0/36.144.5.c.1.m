...
// Magma code for modular curve with label 36.144.5.c.1

// Other names and/or labels
// Cummins-Pauli label: 36L5
// Rouse-Sutherland-Zureick-Brown label: 36.144.5.8

// Group data
level := 36;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 8, 18, 29], [7, 30, 18, 13], [13, 24, 18, 31], [25, 18, 18, 17], [29, 8, 0, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.48.1.c.1", "18.72.1.a.1", "36.72.1.f.1", "36.72.3.v.1"];
...
//   Coordinate number 1:
map_0_coord_1 := 1*(t^6*(y-t)^2*(y+t)^6*(y+2*t)^2*(2*y+t)^2);

// Map from the canonical model to the plane model of modular curve with label 36.144.5.c.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
