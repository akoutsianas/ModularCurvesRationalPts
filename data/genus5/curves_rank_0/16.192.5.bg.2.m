...
// Magma code for modular curve with label 16.192.5.bg.2

// Other names and/or labels
// Cummins-Pauli label: 16N5
// Rouse-Sutherland-Zureick-Brown label: 16.192.5.437

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 4, 0, 11], [1, 10, 0, 1], [7, 14, 8, 11], [9, 2, 8, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["16.96.1.c.2", "16.96.2.g.2", "16.96.2.h.2"];
...
// Map from the canonical model to the plane model of modular curve with label 16.192.5.bg.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
