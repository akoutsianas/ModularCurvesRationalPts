...
// Magma code for modular curve with label 30.72.5.bp.2

// Other names and/or labels
// Cummins-Pauli label: 30G5
// Rouse-Sutherland-Zureick-Brown label: 30.72.5.42

// Group data
level := 30;
// Elements that, together with Gamma(level), generate the group
gens := [[4, 5, 29, 14], [13, 15, 27, 4], [23, 10, 20, 11], [23, 20, 22, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['5.12.0.a.1', '6.6.0.d.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["15.36.2.a.1", "30.36.1.r.1", "30.36.2.a.2"];
...
// Map from the canonical model to the plane model of modular curve with label 30.72.5.bp.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
