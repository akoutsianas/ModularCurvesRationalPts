...
// Magma code for modular curve with label 24.144.5.rb.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1201

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 13, 2, 11], [7, 21, 18, 5], [11, 1, 4, 1], [15, 20, 20, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.ds.1", "24.72.2.ck.1", "24.72.2.dh.1", "24.72.2.ep.1", "24.72.2.gd.1", "24.72.3.bct.1", "24.72.3.beh.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.rb.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+z);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
