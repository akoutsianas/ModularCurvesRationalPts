...
// Magma code for modular curve with label 16.96.5.dc.1

// Other names and/or labels
// Cummins-Pauli label: 16E5
// Rouse-Sutherland-Zureick-Brown label: 16.96.5.115

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 5, 14, 7], [7, 4, 2, 1], [13, 7, 0, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.bo.1", "16.48.1.bp.1", "16.48.3.bn.1"];
...
// Map from the canonical model to the plane model of modular curve with label 16.96.5.dc.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
