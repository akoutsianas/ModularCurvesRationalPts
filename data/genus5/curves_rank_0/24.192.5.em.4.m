...
// Magma code for modular curve with label 24.192.5.em.4

// Other names and/or labels
// Cummins-Pauli label: 24Z5
// Rouse-Sutherland-Zureick-Brown label: 24.192.5.1483

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 9, 8, 5], [5, 21, 20, 5], [11, 21, 8, 1], [13, 18, 0, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["24.96.1.cy.2", "24.96.1.dn.4", "24.96.1.do.2", "24.96.3.eh.2", "24.96.3.eo.1", "24.96.3.gu.4", "24.96.3.gv.2"];
...
model_1 := [-9*x^8+132*x^6*y^2-94*x^4*y^4+504*x^4*y^2*z^2+20*x^2*y^6-240*x^2*y^4*z^2+864*x^2*y^2*z^4-y^8+24*y^6*z^2-144*y^4*z^4+648*y^2*z^6];
...
// Map from the canonical model to the plane model of modular curve with label 24.192.5.em.4
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
...
// Codomain equation:
map_1_codomain := [-9*x^8+132*x^6*y^2-94*x^4*y^4+504*x^4*y^2*z^2+20*x^2*y^6-240*x^2*y^4*z^2+864*x^2*y^2*z^4-y^8+24*y^6*z^2-144*y^4*z^4+648*y^2*z^6];
