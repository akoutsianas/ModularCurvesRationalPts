...
// Magma code for modular curve with label 60.144.5.y.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.18

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 26, 12, 13], [25, 12, 16, 49], [29, 18, 20, 31], [33, 44, 38, 37], [47, 4, 22, 45], [59, 8, 12, 53]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['5.12.0.a.2', '12.12.0.a.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["10.72.1.a.2", "60.72.1.y.1", "60.72.1.ea.1", "60.72.3.a.1", "60.72.3.cb.2", "60.72.3.ok.1", "60.72.3.yu.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.y.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
