...
// Magma code for modular curve with label 16.192.5.i.2

// Other names and/or labels
// Cummins-Pauli label: 16O5
// Rouse-Sutherland-Zureick-Brown label: 16.192.5.191

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 4, 12, 9], [5, 4, 0, 7], [9, 0, 12, 1], [13, 4, 8, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["8.96.1.f.2", "16.96.2.a.1", "16.96.2.c.1"];
...
// Map from the canonical model to the plane model of modular curve with label 16.192.5.i.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
