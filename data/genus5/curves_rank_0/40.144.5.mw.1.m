...
// Magma code for modular curve with label 40.144.5.mw.1

// Other names and/or labels
// Cummins-Pauli label: 40L5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.646

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 0, 12, 17], [33, 9, 30, 7], [35, 23, 2, 11], [39, 25, 26, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["40.72.1.cn.2", "40.72.3.fu.1", "40.72.3.gd.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.mw.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x-y);
//   Coordinate number 1:
