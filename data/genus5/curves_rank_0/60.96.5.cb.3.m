...
// Magma code for modular curve with label 60.96.5.cb.3

// Other names and/or labels
// Cummins-Pauli label: 30M5
// Rouse-Sutherland-Zureick-Brown label: 60.96.5.33

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[16, 5, 57, 44], [26, 15, 15, 58], [34, 25, 9, 53], [59, 50, 45, 13], [59, 55, 42, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
// Canonical model
model_0 := [5*x^2-y*w-z*w+y*t-z*t,y*w-2*z*w+2*w^2-2*y*t-z*t-3*w*t-2*t^2,3*y^2+3*y*z-3*z^2+3*y*w+4*z*w+4*y*t-3*z*t];

// Singular plane model
model_1 := [2*x^5*y^2-x^3*y^4-10*x^6*z-16*x^4*y^2*z+7*x^2*y^4*z+95*x^5*z^2+49*x^3*y^2*z^2-15*x*y^4*z^2-320*x^4*z^3-75*x^2*y^2*z^3+9*y^4*z^3+450*x^3*z^4+45*x*y^2*z^4-225*x^2*z^5];
...
// Map from the canonical model to the plane model of modular curve with label 60.96.5.cb.3
//   Coordinate number 0:
...
map_1_coord_2 := 1*(z);
// Codomain equation:
map_1_codomain := [2*x^5*y^2-x^3*y^4-10*x^6*z-16*x^4*y^2*z+7*x^2*y^4*z+95*x^5*z^2+49*x^3*y^2*z^2-15*x*y^4*z^2-320*x^4*z^3-75*x^2*y^2*z^3+9*y^4*z^3+450*x^3*z^4+45*x*y^2*z^4-225*x^2*z^5];
