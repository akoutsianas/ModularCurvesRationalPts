...
// Magma code for modular curve with label 16.192.5.p.1

// Other names and/or labels
// Cummins-Pauli label: 16O5
// Rouse-Sutherland-Zureick-Brown label: 16.192.5.340

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 6, 0, 15], [11, 6, 12, 15], [11, 14, 4, 7], [15, 4, 0, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["8.96.1.h.1", "16.96.3.n.2", "16.96.3.bd.2"];
...
// Map from the canonical model to the plane model of modular curve with label 16.192.5.p.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
