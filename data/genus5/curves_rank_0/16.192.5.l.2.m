...
// Magma code for modular curve with label 16.192.5.l.2

// Other names and/or labels
// Cummins-Pauli label: 16O5
// Rouse-Sutherland-Zureick-Brown label: 16.192.5.195

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 12, 0, 1], [7, 8, 8, 15], [11, 12, 12, 9], [13, 8, 0, 1], [15, 0, 0, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["8.96.1.g.1", "16.96.2.a.1", "16.96.2.d.1"];
...
// Canonical model
model_0 := [z*w-y*t,y^2+z^2-2*y*w-w^2+2*z*t-t^2,4*x^2-y^2+y*w-z*t+t^2];
...
// Map from the canonical model to the plane model of modular curve with label 16.192.5.l.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
