...
// Magma code for modular curve with label 20.120.5.k.1

// Other names and/or labels
// Cummins-Pauli label: 20E5
// Rouse-Sutherland-Zureick-Brown label: 20.120.5.6

// Group data
level := 20;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 3, 14, 1], [9, 7, 2, 5], [19, 13, 4, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['4.6.0.b.1', '5.20.0.b.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["10.60.2.b.1", "20.30.2.b.1", "20.60.2.e.1", "20.60.3.b.1"];
...
// Canonical model
model_0 := [x*z-x*t-y*w+y*t,x^2+2*x*y+y^2-z^2-z*t-w^2-w*t-t^2,2*x^2-x*y+2*y^2+z^2+z*w+z*t+w^2+w*t];
...
// Map from the canonical model to the plane model of modular curve with label 20.120.5.k.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
