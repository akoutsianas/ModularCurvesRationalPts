...
// Magma code for modular curve with label 48.144.5.cg.1

// Other names and/or labels
// Cummins-Pauli label: 48G5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.854

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 7, 8, 19], [1, 15, 12, 43], [29, 35, 26, 19], [29, 37, 32, 35], [45, 13, 38, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.2.im.1", "48.72.0.b.1", "48.72.3.bi.1"];
...
// Embedded model
model_0 := [x*u+w*v,y*z+w*t,x*y-y*t+t*v,x*z-z*t-t*u,y*z+x*w-z*v,y*u+z*v,x*z-y*w,y^2+x*t,z^2+w^2+z*u,x^2-x*t-y*v,2*x*y-z^2+w^2+y*t-z*u-t*v,x*y+z^2+w^2-y*t-z*u-2*t*v,x^2-y^2-2*z*w+x*t-y*v,x^2-x*t-2*w*u+2*y*v,z^2+w^2-z*u-2*u^2-3*x*v,x^2+2*z*w+x*t-8*t^2-2*w*u-v^2-2*r^2];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.cg.1
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.cg.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-u);
//   Coordinate number 1:
