...
// Magma code for modular curve with label 60.72.5.dy.1

// Other names and/or labels
// Cummins-Pauli label: 30G5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.74

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 10, 14, 21], [14, 45, 51, 52], [36, 25, 37, 27], [58, 55, 53, 52]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["15.36.2.b.1", "60.36.1.fy.1", "60.36.2.fu.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.72.5.dy.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
