...
// Magma code for modular curve with label 60.72.5.dx.2

// Other names and/or labels
// Cummins-Pauli label: 30G5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.113

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[2, 45, 3, 26], [19, 20, 11, 59], [26, 55, 5, 17], [57, 10, 37, 51]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["30.36.1.o.1", "60.36.2.fs.2", "60.36.2.fv.2"];
...
// Map from the canonical model to the plane model of modular curve with label 60.72.5.dx.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
