...
// Magma code for modular curve with label 24.192.5.ci.2

// Other names and/or labels
// Cummins-Pauli label: 24AB5
// Rouse-Sutherland-Zureick-Brown label: 24.192.5.1744

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 0, 0, 11], [1, 6, 12, 1], [1, 8, 12, 7], [7, 4, 12, 19], [11, 6, 0, 1], [23, 22, 12, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["24.96.1.ck.2", "24.96.3.bm.3", "24.96.3.bq.2"];
...
// Map from the canonical model to the plane model of modular curve with label 24.192.5.ci.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
