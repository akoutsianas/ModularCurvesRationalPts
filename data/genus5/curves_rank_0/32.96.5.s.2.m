...
// Magma code for modular curve with label 32.96.5.s.2

// Other names and/or labels
// Cummins-Pauli label: 32C5
// Rouse-Sutherland-Zureick-Brown label: 32.96.5.38

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 0, 0, 31], [15, 28, 0, 23], [17, 3, 16, 31], [29, 24, 8, 15], [31, 31, 0, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.v.2", "32.48.3.a.2", "32.48.3.c.1"];
...
// Map from the canonical model to the plane model of modular curve with label 32.96.5.s.2
//   Coordinate number 0:
