...
// Magma code for modular curve with label 24.192.5.cf.4

// Other names and/or labels
// Cummins-Pauli label: 24AB5
// Rouse-Sutherland-Zureick-Brown label: 24.192.5.1730

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 8, 12, 11], [7, 20, 12, 19], [11, 16, 12, 19], [11, 18, 12, 1], [13, 0, 12, 5], [19, 22, 0, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["24.96.1.ck.3", "24.96.3.bm.1", "24.96.3.bn.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.192.5.cf.4
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
