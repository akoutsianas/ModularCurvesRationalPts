...
// Magma code for modular curve with label 24.144.5.es.1

// Other names and/or labels
// Cummins-Pauli label: 24R5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1020

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 17, 4, 9], [9, 13, 16, 21], [13, 9, 12, 19], [15, 8, 20, 9], [15, 13, 20, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.s.1", "24.72.3.pc.1", "24.72.3.pi.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.es.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
