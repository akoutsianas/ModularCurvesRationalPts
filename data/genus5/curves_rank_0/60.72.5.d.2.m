...
// Magma code for modular curve with label 60.72.5.d.2

// Other names and/or labels
// Cummins-Pauli label: 30C5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.161

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[8, 5, 29, 7], [11, 25, 41, 32], [11, 40, 44, 53], [12, 35, 55, 27], [23, 25, 43, 34]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["30.36.3.a.1", "60.24.1.d.1", "60.36.0.cg.2", "60.36.2.ft.2"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.5.d.2
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.72.5.d.2
//   Coordinate number 0:
