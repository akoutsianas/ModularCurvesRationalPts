...
// Magma code for modular curve with label 48.96.5.dl.1

// Other names and/or labels
// Cummins-Pauli label: 16B5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.687

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 11, 32, 47], [33, 31, 14, 47], [37, 5, 34, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.m.2", "24.48.1.dg.1", "48.48.1.jb.1", "48.48.1.jj.1", "48.48.3.n.1", "48.48.3.ce.1", "48.48.3.cm.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.dl.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
