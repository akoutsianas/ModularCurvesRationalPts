...
// Magma code for modular curve with label 48.144.5.bb.2

// Other names and/or labels
// Cummins-Pauli label: 48H5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.804

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 28, 16, 37], [21, 29, 38, 3], [41, 38, 32, 7], [43, 13, 14, 25], [45, 37, 38, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.2.hn.2", "48.72.0.a.2", "48.72.3.z.1"];
...
// Embedded model
model_0 := [z*w+x*r,z*t-y*r,y*w+x*t,w^2+w*t-t*r,w*t-t^2+w*v+t*v,w^2-w*t+v*r,x*w-x*t-z*v,x*w+x*t+z*t,x*t+y*t+x*v-y*v,x^2-x*y-y*z,x^2+2*x*y-y*z+w*t+w*v,2*x^2+x*y+y*z-w*t+w*v,3*x*z+t*r-v*r,3*y^2-t^2-t*v,3*z^2-2*w*r,w^2+t^2-3*u^2+2*w*v-2*t*v+2*v^2-2*w*r-2*v*r+r^2];

// Singular plane model
model_1 := [y^12-12*y^10*z^2+72*y^8*z^4-6*x^2*y^4*z^6-324*y^6*z^6+72*x^2*y^2*z^8+1296*y^4*z^8-216*x^2*z^10-3888*y^2*z^10+5832*z^12];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.bb.2
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
...
// Codomain equation:
map_1_codomain := [y^12-12*y^10*z^2+72*y^8*z^4-6*x^2*y^4*z^6-324*y^6*z^6+72*x^2*y^2*z^8+1296*y^4*z^8-216*x^2*z^10-3888*y^2*z^10+5832*z^12];

// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.bb.2
//   Coordinate number 0:
map_2_coord_0 := 1*(-r);
//   Coordinate number 1:
map_2_coord_1 := 1*(18*z^2*u*r^3-12*u*r^5);
//   Coordinate number 2:
map_2_coord_2 := 1*(-z);
// Codomain equation:
