...
// Magma code for modular curve with label 60.120.5.g.1

// Other names and/or labels
// Cummins-Pauli label: 20E5
// Rouse-Sutherland-Zureick-Brown label: 60.120.5.189

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 20, 41, 47], [9, 2, 29, 21], [17, 14, 21, 13], [43, 0, 25, 43]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['4.6.0.b.1', '15.20.0.a.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["20.60.3.b.1", "30.60.2.a.1", "60.60.2.i.1"];
...
// Canonical model
model_0 := [4*x^2-x*w+2*y^2-3*y*z+y*t+6*z^2+w^2-t^2,7*x^2+2*x*w-3*y^2+9*y*z-3*z^2-2*w^2,23*x*y-15*x*z-x*t-y*w+2*w*t];
...
// Map from the canonical model to the plane model of modular curve with label 60.120.5.g.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
