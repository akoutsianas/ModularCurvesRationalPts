...
// Magma code for modular curve with label 48.96.5.ey.1

// Other names and/or labels
// Cummins-Pauli label: 24H5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.735

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 24, 6, 47], [5, 22, 6, 7], [29, 47, 24, 25], [35, 3, 0, 47], [35, 27, 6, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.ey.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y-z);
