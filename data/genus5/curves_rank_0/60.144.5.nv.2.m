...
// Magma code for modular curve with label 60.144.5.nv.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.543

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 40, 8, 11], [31, 30, 36, 19], [31, 40, 40, 53], [37, 15, 38, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.t.1", "30.72.1.g.2", "60.72.1.bv.1", "60.72.3.of.1", "60.72.3.om.1", "60.72.3.ov.1", "60.72.3.za.1"];
...
// Canonical model
model_0 := [x^2+y^2-x*z+z^2,3*x^2-y^2+x*z-z^2-x*w+w^2+t^2,x^2-4*y^2-x*z+z^2+x*t-2*w*t+t^2];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.nv.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
