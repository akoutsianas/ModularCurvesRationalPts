...
// Magma code for modular curve with label 24.192.5.ft.3

// Other names and/or labels
// Cummins-Pauli label: 24Z5
// Rouse-Sutherland-Zureick-Brown label: 24.192.5.2131

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 12, 12, 7], [11, 12, 16, 11], [13, 3, 16, 19], [23, 15, 8, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["24.96.1.db.2", "24.96.1.do.4", "24.96.1.ds.3", "24.96.3.fw.1", "24.96.3.gb.1", "24.96.3.gt.3", "24.96.3.gx.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.192.5.ft.3
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
