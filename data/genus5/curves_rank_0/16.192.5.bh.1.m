...
// Magma code for modular curve with label 16.192.5.bh.1

// Other names and/or labels
// Cummins-Pauli label: 16N5
// Rouse-Sutherland-Zureick-Brown label: 16.192.5.448

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 14, 0, 1], [5, 6, 0, 15], [7, 10, 0, 15], [13, 2, 0, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["16.96.1.f.1", "16.96.2.g.1", "16.96.2.k.2", "16.96.3.eb.1"];
...
// Canonical model
model_0 := [y*z+w*t,2*x^2+y^2-y*w+z^2+z*t,2*x^2+y*w-z*t+w^2+t^2];
...
// Map from the canonical model to the plane model of modular curve with label 16.192.5.bh.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
