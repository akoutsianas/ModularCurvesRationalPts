...
// Magma code for modular curve with label 48.96.5.em.1

// Other names and/or labels
// Cummins-Pauli label: 16C5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.652

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 3, 42, 17], [9, 29, 26, 47], [13, 41, 18, 11], [35, 28, 16, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.v.1", "48.48.1.l.1", "48.48.3.r.1"];
...
// Canonical model
model_0 := [3*y^2-3*z^2-2*w*t,3*y^2+3*z^2-2*w^2-t^2,24*x^2+3*z^2+w*t-t^2];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.em.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+z);
//   Coordinate number 1:
