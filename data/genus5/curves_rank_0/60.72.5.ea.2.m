...
// Magma code for modular curve with label 60.72.5.ea.2

// Other names and/or labels
// Cummins-Pauli label: 30G5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.111

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[37, 20, 2, 11], [44, 25, 53, 17], [46, 5, 23, 26], [58, 15, 57, 26]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["30.36.1.o.1", "60.36.2.ft.2", "60.36.2.fu.2"];
...
// Map from the canonical model to the plane model of modular curve with label 60.72.5.ea.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
