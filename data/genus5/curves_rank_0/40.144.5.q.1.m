...
// Magma code for modular curve with label 40.144.5.q.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.401

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 24, 30, 1], [21, 34, 10, 3], [27, 14, 0, 29], [31, 8, 30, 29], [37, 38, 0, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.d.1", "40.72.1.a.1", "40.72.1.bq.2", "40.72.1.cb.2", "40.72.3.e.2", "40.72.3.dp.2", "40.72.3.eg.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.q.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
