...
// Magma code for modular curve with label 16.96.5.di.1

// Other names and/or labels
// Cummins-Pauli label: 16E5
// Rouse-Sutherland-Zureick-Brown label: 16.96.5.128

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 5, 12, 1], [11, 8, 6, 13], [15, 15, 10, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.bu.1", "16.48.1.by.1", "16.48.3.bx.1"];
...
// Map from the canonical model to the plane model of modular curve with label 16.96.5.di.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
