...
// Magma code for modular curve with label 24.96.5.cb.1

// Other names and/or labels
// Cummins-Pauli label: 24I5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.233

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 23, 12, 11], [13, 9, 18, 23], [17, 14, 6, 11], [23, 3, 0, 1], [23, 5, 18, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.24.1.bf.1", "24.48.1.jj.1", "24.48.3.d.1", "24.48.3.cl.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.cb.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*z);
