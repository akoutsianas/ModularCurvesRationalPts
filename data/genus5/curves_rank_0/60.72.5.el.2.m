...
// Magma code for modular curve with label 60.72.5.el.2

// Other names and/or labels
// Cummins-Pauli label: 30G5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.143

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 35, 47, 32], [4, 15, 27, 28], [7, 5, 16, 7], [19, 0, 18, 47]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["30.36.2.a.2", "60.36.1.ga.1", "60.36.2.ft.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.72.5.el.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
