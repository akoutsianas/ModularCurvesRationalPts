...
// Magma code for modular curve with label 40.144.5.li.1

// Other names and/or labels
// Cummins-Pauli label: 20J5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.329

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 19, 14, 37], [27, 11, 10, 13], [29, 12, 32, 9], [31, 0, 14, 17], [37, 21, 26, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.bp.1", "40.72.1.ct.1", "40.72.3.fm.1"];
...
// Canonical model
model_0 := [4*x*y-2*y^2+2*z^2+w^2,2*x*y+4*y^2-4*z^2-w^2-w*t,10*x^2-2*x*y-4*y^2-6*z^2+2*w^2+w*t-t^2];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.li.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
