...
// Magma code for modular curve with label 40.144.5.ir.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.459

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 20, 24, 9], [7, 14, 20, 1], [9, 24, 12, 21], [15, 3, 6, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.bd.1", "40.72.1.bh.1", "40.72.1.bn.2", "40.72.1.cn.1", "40.72.3.da.2", "40.72.3.dj.1", "40.72.3.ev.1"];
...
model_1 := [2025*x^8+100*x^6*y^2+100*x^4*y^4+6840*x^6*z^2+880*x^4*y^2*z^2+9016*x^4*z^4+80*x^2*y^2*z^4+5472*x^2*z^6+1296*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.ir.1
//   Coordinate number 0:
...
map_1_coord_2 := 1*(t);
// Codomain equation:
map_1_codomain := [2025*x^8+100*x^6*y^2+100*x^4*y^4+6840*x^6*z^2+880*x^4*y^2*z^2+9016*x^4*z^4+80*x^2*y^2*z^4+5472*x^2*z^6+1296*z^8];
