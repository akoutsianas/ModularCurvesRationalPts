...
// Magma code for modular curve with label 48.144.5.gn.1

// Other names and/or labels
// Cummins-Pauli label: 48G5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.832

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 16, 32, 5], [13, 27, 0, 43], [15, 31, 14, 33], [21, 2, 16, 9], [29, 20, 44, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.2.jb.1", "48.72.0.d.2", "48.72.3.bi.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.gn.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.gn.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-t);
//   Coordinate number 1:
