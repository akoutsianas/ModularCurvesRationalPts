...
// Magma code for modular curve with label 24.144.5.ic.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.625

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 18, 0, 13], [11, 9, 18, 1], [15, 7, 16, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.3.cr.1", "24.72.1.ba.1", "24.72.1.bp.1", "24.72.1.cl.1", "24.72.3.tx.1", "24.72.3.ub.1", "24.72.3.uu.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.ic.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
