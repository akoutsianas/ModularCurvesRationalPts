...
// Magma code for modular curve with label 60.144.5.pq.2

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.791

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[39, 5, 22, 43], [47, 45, 10, 49], [49, 55, 34, 53], [53, 0, 56, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.bc.1", "30.72.1.h.2", "60.72.1.cc.1", "60.72.1.ec.2", "60.72.3.qn.2", "60.72.3.qu.2", "60.72.3.za.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.pq.2
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
