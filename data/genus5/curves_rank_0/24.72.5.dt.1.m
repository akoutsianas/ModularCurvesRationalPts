...
// Magma code for modular curve with label 24.72.5.dt.1

// Other names and/or labels
// Cummins-Pauli label: 24E5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.300

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 0, 0, 19], [1, 7, 22, 17], [13, 16, 20, 1], [17, 10, 16, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fe.1", "24.36.1.gm.1", "24.36.3.a.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.5.dt.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
