...
// Magma code for modular curve with label 60.144.5.eh.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.667

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 30, 32, 11], [13, 50, 52, 43], [29, 55, 4, 9], [43, 35, 36, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.1.g.1", "60.72.1.x.1", "60.72.1.dw.1", "60.72.3.et.1", "60.72.3.hv.1", "60.72.3.oi.1", "60.72.3.yv.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.eh.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x-z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
