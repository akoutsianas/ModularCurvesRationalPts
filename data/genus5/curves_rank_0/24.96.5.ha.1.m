...
// Magma code for modular curve with label 24.96.5.ha.1

// Other names and/or labels
// Cummins-Pauli label: 24J5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.103

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 8, 12, 13], [5, 0, 12, 13], [7, 2, 6, 5], [11, 1, 0, 1], [17, 4, 12, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["12.48.2.c.1", "24.24.0.ec.1", "24.48.2.q.1", "24.48.3.cl.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.ha.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
