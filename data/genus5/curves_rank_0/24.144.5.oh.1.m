...
// Magma code for modular curve with label 24.144.5.oh.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1292

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 15, 6, 7], [11, 17, 10, 17], [11, 21, 0, 17], [13, 23, 2, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.de.1", "24.72.2.s.1", "24.72.2.y.1", "24.72.2.fb.1", "24.72.2.gh.1", "24.72.3.bgd.1", "24.72.3.bhj.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.oh.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
