...
// Magma code for modular curve with label 24.144.5.bhj.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1160

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 17, 20, 19], [5, 22, 20, 5], [9, 16, 4, 21], [21, 11, 22, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.fe.1", "24.72.2.eb.1", "24.72.2.eg.1", "24.72.2.iu.1", "24.72.2.jj.1", "24.72.3.bhd.1", "24.72.3.bhq.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.bhj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
