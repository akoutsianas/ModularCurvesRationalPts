...
// Magma code for modular curve with label 60.96.5.bh.2

// Other names and/or labels
// Cummins-Pauli label: 30N5
// Rouse-Sutherland-Zureick-Brown label: 60.96.5.108

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[4, 45, 45, 43], [7, 10, 48, 31], [23, 0, 57, 49], [47, 25, 33, 14]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["30.48.3.b.1", "60.24.1.s.1", "60.48.1.bx.2", "60.48.3.bd.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.96.5.bh.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
