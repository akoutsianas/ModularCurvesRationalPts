...
// Magma code for modular curve with label 24.144.5.hp.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.654

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 20, 20, 9], [13, 9, 12, 17], [23, 18, 18, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.3.ct.1", "24.72.1.x.1", "24.72.1.bu.1", "24.72.1.cg.1", "24.72.3.na.1", "24.72.3.qk.1", "24.72.3.qw.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.hp.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
