...
// Magma code for modular curve with label 48.96.5.du.1

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.629

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 39, 10, 1], [5, 9, 30, 31], [13, 18, 44, 29], [31, 40, 12, 41]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.q.1", "24.48.1.dt.1", "48.48.1.gq.2", "48.48.1.gs.1", "48.48.3.v.1", "48.48.3.ed.1", "48.48.3.ef.2"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.du.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
