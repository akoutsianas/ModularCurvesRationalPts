...
// Magma code for modular curve with label 40.144.5.ks.2

// Other names and/or labels
// Cummins-Pauli label: 20J5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.472

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 5, 20, 31], [9, 13, 12, 35], [11, 38, 24, 35], [23, 9, 22, 25], [27, 39, 26, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.br.1", "40.72.1.cq.2", "40.72.3.fn.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.ks.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x+w);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
