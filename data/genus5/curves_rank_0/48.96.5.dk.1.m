...
// Magma code for modular curve with label 48.96.5.dk.1

// Other names and/or labels
// Cummins-Pauli label: 16B5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.693

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 4, 22, 25], [37, 43, 20, 7], [41, 2, 6, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.m.1", "24.48.1.df.1", "48.48.1.ja.1", "48.48.1.ji.1", "48.48.3.n.1", "48.48.3.cd.1", "48.48.3.cl.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.dk.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
