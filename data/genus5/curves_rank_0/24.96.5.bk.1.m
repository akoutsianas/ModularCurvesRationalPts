...
// Magma code for modular curve with label 24.96.5.bk.1

// Other names and/or labels
// Cummins-Pauli label: 24I5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.224

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 14, 12, 1], [11, 21, 12, 5], [13, 19, 12, 19], [17, 3, 0, 19], [19, 4, 6, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.24.1.p.1", "24.48.1.et.1", "24.48.3.bv.1", "24.48.3.cl.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.bk.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
