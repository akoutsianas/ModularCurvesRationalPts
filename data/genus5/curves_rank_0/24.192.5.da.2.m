...
// Magma code for modular curve with label 24.192.5.da.2

// Other names and/or labels
// Cummins-Pauli label: 24Z5
// Rouse-Sutherland-Zureick-Brown label: 24.192.5.320

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 12, 20, 13], [7, 6, 14, 5], [11, 6, 10, 5], [13, 0, 18, 19], [17, 18, 16, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["12.96.1.a.1", "24.96.3.bj.2", "24.96.3.ci.1"];
...
// Canonical model
model_0 := [x^2-w*t,x^2+y*z,y^2+3*z^2+w^2-t^2];
...
// Map from the canonical model to the plane model of modular curve with label 24.192.5.da.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
...
map_1_coord_2 := 1*(z);
// Codomain equation:
map_1_codomain := [x^4*y^2+x^4*z^2-y^4*z^2+3*y^2*z^4];
