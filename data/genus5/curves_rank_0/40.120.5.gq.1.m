...
// Magma code for modular curve with label 40.120.5.gq.1

// Other names and/or labels
// Cummins-Pauli label: 20F5
// Rouse-Sutherland-Zureick-Brown label: 40.120.5.51

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 34, 6, 21], [9, 23, 32, 31], [29, 2, 28, 31], [33, 28, 12, 35]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["10.60.2.d.1", "40.60.2.g.1", "40.60.3.cg.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.120.5.gq.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
