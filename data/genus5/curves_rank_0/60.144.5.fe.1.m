...
// Magma code for modular curve with label 60.144.5.fe.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.900

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 20, 46, 51], [27, 20, 1, 1], [29, 40, 29, 53], [29, 40, 41, 51]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.s.2", "60.72.1.m.2", "60.72.1.br.1", "60.72.1.dz.2", "60.72.3.et.1", "60.72.3.na.1", "60.72.3.yy.2"];
...
model_1 := [10*x^8-18*x^7*z+32*x^6*y*z+21*x^6*z^2-36*x^5*y*z^2+36*x^4*y^2*z^2-12*x^5*z^3+30*x^4*y*z^3-36*x^3*y^2*z^3+8*x^2*y^3*z^3+3*x^4*z^4-12*x^3*y*z^4+30*x^2*y^2*z^4+4*y^4*z^4+3*x^2*y*z^5-12*x*y^2*z^5+3*y^2*z^6];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.fe.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+z);
//   Coordinate number 1:
map_1_coord_1 := 1*(w+t);
...
// Codomain equation:
map_1_codomain := [10*x^8-18*x^7*z+32*x^6*y*z+21*x^6*z^2-36*x^5*y*z^2+36*x^4*y^2*z^2-12*x^5*z^3+30*x^4*y*z^3-36*x^3*y^2*z^3+8*x^2*y^3*z^3+3*x^4*z^4-12*x^3*y*z^4+30*x^2*y^2*z^4+4*y^4*z^4+3*x^2*y*z^5-12*x*y^2*z^5+3*y^2*z^6];
