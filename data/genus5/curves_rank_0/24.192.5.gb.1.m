...
// Magma code for modular curve with label 24.192.5.gb.1

// Other names and/or labels
// Cummins-Pauli label: 24AA5
// Rouse-Sutherland-Zureick-Brown label: 24.192.5.2453

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 19, 0, 7], [19, 1, 0, 5], [19, 10, 0, 1], [19, 13, 0, 11], [23, 5, 0, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["24.96.1.de.3", "24.96.3.ge.2", "24.96.3.gh.2"];
...
// Map from the canonical model to the plane model of modular curve with label 24.192.5.gb.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
