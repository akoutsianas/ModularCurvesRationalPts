...
// Magma code for modular curve with label 24.96.5.ey.1

// Other names and/or labels
// Cummins-Pauli label: 24K5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.144

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 13, 12, 19], [11, 4, 18, 13], [13, 9, 12, 23], [19, 10, 18, 1], [23, 20, 18, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["12.48.2.e.1", "24.24.1.dw.1", "24.48.2.r.1", "24.48.3.bv.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.ey.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
