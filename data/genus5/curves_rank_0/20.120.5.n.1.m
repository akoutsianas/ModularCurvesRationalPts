...
// Magma code for modular curve with label 20.120.5.n.1

// Other names and/or labels
// Cummins-Pauli label: 20E5
// Rouse-Sutherland-Zureick-Brown label: 20.120.5.51

// Group data
level := 20;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 3, 8, 5], [3, 1, 16, 1], [17, 1, 0, 3], [19, 0, 12, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["20.60.2.b.1", "20.60.2.e.1", "20.60.3.c.1"];
...
// Canonical model
model_0 := [x*z+2*x*w-y*t,2*y^2-z^2+2*z*w-2*w^2+t^2,5*x^2-3*y^2-3*z^2+4*z*w+t^2];
...
// Map from the canonical model to the plane model of modular curve with label 20.120.5.n.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
