...
// Magma code for modular curve with label 24.72.5.mq.1

// Other names and/or labels
// Cummins-Pauli label: 24F5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.191

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 11, 22, 5], [5, 17, 10, 17], [5, 20, 8, 7], [17, 19, 14, 5], [21, 20, 4, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.bu.1", "24.36.1.gq.1", "24.36.2.gl.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.5.mq.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
