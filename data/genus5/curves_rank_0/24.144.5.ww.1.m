...
// Magma code for modular curve with label 24.144.5.ww.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1162

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 21, 18, 23], [11, 8, 20, 7], [13, 17, 14, 11], [23, 10, 2, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.ek.1", "24.72.2.g.1", "24.72.2.w.1", "24.72.2.he.1", "24.72.2.is.1", "24.72.3.bco.1", "24.72.3.bdu.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.ww.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
