...
// Magma code for modular curve with label 48.96.5.rz.2

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.187

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[15, 40, 28, 37], [21, 40, 4, 27], [29, 29, 46, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.ci.1", "24.48.1.ku.1", "48.48.1.in.1", "48.48.3.dj.1", "48.48.3.ee.1", "48.48.3.ep.1", "48.48.3.gb.1"];
...
// Canonical model
model_0 := [2*x^2-y*z,y^2+2*z^2+w^2+w*t+t^2,2*x^2+3*y*z-2*w^2-2*w*t+t^2];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.rz.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
