...
// Magma code for modular curve with label 24.144.5.ct.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.644

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 13, 4, 9], [3, 13, 14, 15], [9, 14, 22, 9], [15, 19, 2, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.3.y.1", "24.72.1.g.1", "24.72.1.ba.1", "24.72.1.bx.1", "24.72.3.hd.1", "24.72.3.qn.1", "24.72.3.to.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.ct.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
