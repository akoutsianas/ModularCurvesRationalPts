...
// Magma code for modular curve with label 32.192.5.t.2

// Other names and/or labels
// Cummins-Pauli label: 32N5
// Rouse-Sutherland-Zureick-Brown label: 32.192.5.380

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 21, 0, 23], [7, 19, 16, 1], [15, 2, 16, 31], [15, 25, 0, 17], [29, 29, 16, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["16.96.1.m.1", "32.96.2.c.1", "32.96.2.f.1"];
...
// Canonical model
model_0 := [y*w+z*t,y^2-z^2-2*z*w+w^2+2*y*t-t^2,4*x^2+y^2-z^2-z*w+y*t];
...
// Map from the canonical model to the plane model of modular curve with label 32.192.5.t.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x+w);
//   Coordinate number 1:
