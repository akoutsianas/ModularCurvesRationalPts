...
// Magma code for modular curve with label 48.144.5.bo.1

// Other names and/or labels
// Cummins-Pauli label: 48E5
// Rouse-Sutherland-Zureick-Brown label: 48.144.5.421

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 10, 10, 37], [17, 47, 10, 23], [33, 4, 34, 3], [43, 40, 38, 1], [45, 23, 14, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.2.hu.1", "48.48.1.ho.1", "48.72.0.b.1", "48.72.3.bg.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.5.bo.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.5.bo.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-r);
//   Coordinate number 1:
