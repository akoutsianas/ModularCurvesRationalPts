...
// Magma code for modular curve with label 24.144.5.bfl.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1159

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 14, 22, 7], [3, 7, 8, 21], [13, 22, 20, 13], [19, 12, 12, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.fe.1", "24.72.2.cx.1", "24.72.2.eb.1", "24.72.2.hx.1", "24.72.2.ik.1", "24.72.3.bge.1", "24.72.3.bgt.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.bfl.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
