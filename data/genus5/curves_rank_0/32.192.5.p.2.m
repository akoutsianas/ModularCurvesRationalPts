...
// Magma code for modular curve with label 32.192.5.p.2

// Other names and/or labels
// Cummins-Pauli label: 32N5
// Rouse-Sutherland-Zureick-Brown label: 32.192.5.349

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 16, 0, 29], [7, 14, 16, 7], [17, 25, 16, 3], [23, 4, 16, 31], [25, 17, 0, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["16.96.1.m.2", "32.96.2.d.1", "32.96.2.j.1", "32.96.3.ba.1"];
...
// Canonical model
model_0 := [y*z-w*t,2*x^2-y*t+z^2+z*w+t^2,2*x^2+y^2+y*t-z*w+w^2];
...
// Map from the canonical model to the plane model of modular curve with label 32.192.5.p.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x+z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
