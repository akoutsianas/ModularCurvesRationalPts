...
// Magma code for modular curve with label 48.96.5.cr.1

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.94

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[29, 27, 2, 25], [31, 20, 32, 15], [39, 26, 16, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.s.1", "48.48.1.hc.1", "48.48.1.hh.1", "48.48.3.g.1", "48.48.3.h.2", "48.48.3.eq.1", "48.48.3.et.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.cr.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
