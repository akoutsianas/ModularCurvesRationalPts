...
// Magma code for modular curve with label 24.144.5.id.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.145

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 8, 16, 3], [11, 9, 0, 7], [17, 9, 6, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.1.m.1", "24.72.1.bh.1", "24.72.1.cj.1", "24.72.3.ti.1", "24.72.3.tq.1", "24.72.3.ud.1", "24.72.3.uu.1"];
...
// Canonical model
model_0 := [y^2+y*w+w^2-2*t^2,x^2+x*y+y^2+2*x*z-x*w+y*w+w^2,2*x^2-y^2-2*y*z-2*z^2+2*y*w+2*z*w-w^2];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.id.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
