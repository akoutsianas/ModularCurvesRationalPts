...
// Magma code for modular curve with label 16.192.5.r.2

// Other names and/or labels
// Cummins-Pauli label: 16O5
// Rouse-Sutherland-Zureick-Brown label: 16.192.5.322

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 6, 12, 7], [5, 14, 4, 7], [7, 12, 8, 7], [11, 10, 8, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["8.96.1.j.2", "16.96.2.f.2", "16.96.2.h.2"];
...
// Map from the canonical model to the plane model of modular curve with label 16.192.5.r.2
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
