...
// Magma code for modular curve with label 60.72.5.eq.2

// Other names and/or labels
// Cummins-Pauli label: 30G5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.64

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[4, 35, 53, 8], [7, 35, 25, 4], [28, 45, 15, 44], [36, 35, 31, 42]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["15.36.2.b.2", "60.36.1.gb.1", "60.36.2.fv.2"];
...
// Map from the canonical model to the plane model of modular curve with label 60.72.5.eq.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
