...
// Magma code for modular curve with label 60.96.5.bi.2

// Other names and/or labels
// Cummins-Pauli label: 30N5
// Rouse-Sutherland-Zureick-Brown label: 60.96.5.46

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 40, 57, 19], [29, 0, 36, 7], [29, 45, 54, 41], [52, 45, 57, 46]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["15.48.1.b.1", "60.24.1.t.2", "60.48.3.t.1", "60.48.3.bd.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.96.5.bi.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
