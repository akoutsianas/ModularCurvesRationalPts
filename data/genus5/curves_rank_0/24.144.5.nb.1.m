...
// Magma code for modular curve with label 24.144.5.nb.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1315

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 9, 0, 23], [5, 13, 22, 19], [5, 14, 14, 7], [7, 21, 18, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.di.1", "24.72.2.l.1", "24.72.2.bt.1", "24.72.2.ev.1", "24.72.2.fq.1", "24.72.3.bfw.1", "24.72.3.bgt.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.nb.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
