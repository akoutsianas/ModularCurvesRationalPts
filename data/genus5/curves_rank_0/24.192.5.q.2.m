...
// Magma code for modular curve with label 24.192.5.q.2

// Other names and/or labels
// Cummins-Pauli label: 8A5
// Rouse-Sutherland-Zureick-Brown label: 24.192.5.102

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 20, 22, 15], [7, 0, 14, 5], [7, 12, 4, 23], [7, 20, 2, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["8.96.3.f.1", "24.96.1.e.2", "24.96.1.h.1", "24.96.1.o.2", "24.96.3.j.1", "24.96.3.n.1", "24.96.3.q.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.192.5.q.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x+z);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
