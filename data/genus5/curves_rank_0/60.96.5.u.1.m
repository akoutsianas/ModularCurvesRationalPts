...
// Magma code for modular curve with label 60.96.5.u.1

// Other names and/or labels
// Cummins-Pauli label: 30N5
// Rouse-Sutherland-Zureick-Brown label: 60.96.5.126

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[4, 25, 45, 53], [7, 20, 39, 11], [7, 40, 54, 31], [23, 20, 0, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["30.48.3.e.1", "60.24.1.l.2", "60.48.1.bw.2", "60.48.3.t.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.96.5.u.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
