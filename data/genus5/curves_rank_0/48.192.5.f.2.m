...
// Magma code for modular curve with label 48.192.5.f.2

// Other names and/or labels
// Cummins-Pauli label: 16O5
// Rouse-Sutherland-Zureick-Brown label: 48.192.5.1970

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 28, 32, 15], [17, 40, 40, 3], [27, 46, 28, 37], [39, 32, 8, 43], [47, 20, 40, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["16.96.3.n.1", "24.96.1.z.1", "48.96.3.be.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.192.5.f.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
