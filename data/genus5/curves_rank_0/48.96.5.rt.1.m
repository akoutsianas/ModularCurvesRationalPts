...
// Magma code for modular curve with label 48.96.5.rt.1

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.196

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 18, 28, 1], [31, 25, 10, 39], [35, 11, 22, 47]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.ck.1", "24.48.1.kq.1", "48.48.1.iq.1", "48.48.3.dg.1", "48.48.3.ef.2", "48.48.3.et.1", "48.48.3.fz.2"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.rt.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
