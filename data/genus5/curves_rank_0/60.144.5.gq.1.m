...
// Magma code for modular curve with label 60.144.5.gq.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 60.144.5.223

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[2, 31, 13, 28], [10, 9, 11, 56], [29, 18, 4, 19], [29, 34, 52, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.3.cc.1", "60.72.1.i.1", "60.72.1.dd.1", "60.72.1.en.1", "60.72.3.gk.1", "60.72.3.lg.1", "60.72.3.nh.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.144.5.gq.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
