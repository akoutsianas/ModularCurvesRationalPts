...
// Magma code for modular curve with label 12.144.5.k.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 12.144.5.17

// Group data
level := 12;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 3, 0, 7], [1, 6, 0, 1], [7, 9, 6, 11], [11, 3, 6, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.48.1.g.1", "12.72.1.b.1", "12.72.1.h.1", "12.72.1.o.1", "12.72.3.y.1", "12.72.3.bc.1", "12.72.3.ce.1", "12.72.3.cu.1"];
...
// Canonical model
model_0 := [2*y^2-z^2+y*w-w^2-w*t-t^2,y^2+y*w+2*y*t-w*t,3*x^2-y*w-y*t];

// Singular plane model
model_1 := [9*x^4*y^4-36*x^4*y^3*z+54*x^4*y^2*z^2-36*x^4*y*z^3+9*x^4*z^4+6*x^2*y^6+132*x^2*y^5*z-282*x^2*y^4*z^2+138*x^2*y^3*z^3+30*x^2*y^2*z^4-42*x^2*y*z^5+18*x^2*z^6+y^8-48*y^7*z+576*y^6*z^2-2*y^5*z^3+42*y^4*z^4+144*y^3*z^5+y^2*z^6+6*y*z^7+9*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 12.144.5.k.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
...
map_1_coord_2 := 1*(t);
// Codomain equation:
map_1_codomain := [9*x^4*y^4-36*x^4*y^3*z+54*x^4*y^2*z^2-36*x^4*y*z^3+9*x^4*z^4+6*x^2*y^6+132*x^2*y^5*z-282*x^2*y^4*z^2+138*x^2*y^3*z^3+30*x^2*y^2*z^4-42*x^2*y*z^5+18*x^2*z^6+y^8-48*y^7*z+576*y^6*z^2-2*y^5*z^3+42*y^4*z^4+144*y^3*z^5+y^2*z^6+6*y*z^7+9*z^8];
