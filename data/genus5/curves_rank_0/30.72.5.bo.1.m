...
// Magma code for modular curve with label 30.72.5.bo.1

// Other names and/or labels
// Cummins-Pauli label: 30G5
// Rouse-Sutherland-Zureick-Brown label: 30.72.5.63

// Group data
level := 30;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 0, 0, 13], [13, 15, 21, 2], [13, 25, 8, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["15.36.2.b.1", "30.36.1.q.1", "30.36.2.a.2"];
...
// Map from the canonical model to the plane model of modular curve with label 30.72.5.bo.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
