...
// Magma code for modular curve with label 48.96.5.bk.2

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.20

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 20, 16, 21], [17, 32, 40, 41], [23, 34, 28, 9], [31, 32, 32, 47], [41, 44, 32, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.i.1", "48.48.3.c.2", "48.48.3.e.2"];
...
// Canonical model
model_0 := [2*y*z-z*w+w^2-z*t-t^2,4*y^2-z*w+z*t-2*w*t,6*x^2-y*z];

// Singular plane model
model_1 := [-81*x^8+9*x^4*y^4+3*x^2*y^6-12*x^2*y^5*z+12*x^2*y^4*z^2-2*y^7*z+6*y^6*z^2-8*y^5*z^3+4*y^4*z^4];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.bk.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Codomain equation:
map_1_codomain := [-81*x^8+9*x^4*y^4+3*x^2*y^6-12*x^2*y^5*z+12*x^2*y^4*z^2-2*y^7*z+6*y^6*z^2-8*y^5*z^3+4*y^4*z^4];
