...
// Magma code for modular curve with label 24.72.5.fr.1

// Other names and/or labels
// Cummins-Pauli label: 24G5
// Rouse-Sutherland-Zureick-Brown label: 24.72.5.121

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 10, 8, 17], [7, 7, 8, 1], [15, 22, 14, 9], [19, 15, 18, 17], [23, 15, 6, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bx.1", "24.36.1.gf.1", "24.36.3.c.1"];
...
model_1 := [24*x^8+28*x^6*y^2+4*x^4*y^4+54*x^6*z^2+14*x^4*y^2*z^2+47*x^4*z^4+19*x^2*z^6+3*z^8];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.5.fr.1
//   Coordinate number 0:
...
map_1_coord_2 := 1*(w);
// Codomain equation:
map_1_codomain := [24*x^8+28*x^6*y^2+4*x^4*y^4+54*x^6*z^2+14*x^4*y^2*z^2+47*x^4*z^4+19*x^2*z^6+3*z^8];
