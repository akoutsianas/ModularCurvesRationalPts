...
// Magma code for modular curve with label 24.96.5.es.1

// Other names and/or labels
// Cummins-Pauli label: 24K5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.208

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 23, 6, 11], [7, 9, 18, 1], [11, 5, 0, 1], [11, 7, 6, 17], [11, 10, 0, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.24.1.dq.1", "24.48.2.l.1", "24.48.2.q.1", "24.48.3.bv.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.es.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
