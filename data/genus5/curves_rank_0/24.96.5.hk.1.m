...
// Magma code for modular curve with label 24.96.5.hk.1

// Other names and/or labels
// Cummins-Pauli label: 24J5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.19

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 17, 6, 23], [11, 1, 0, 1], [17, 19, 18, 11], [23, 16, 0, 7], [23, 17, 6, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['3.4.0.a.1', '8.24.0.bc.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["8.24.0.bc.1", "24.48.2.h.1", "24.48.2.l.1", "24.48.3.co.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.hk.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
