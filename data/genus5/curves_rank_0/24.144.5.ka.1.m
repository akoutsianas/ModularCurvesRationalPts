...
// Magma code for modular curve with label 24.144.5.ka.1

// Other names and/or labels
// Cummins-Pauli label: 24U5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1015

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 21, 6, 23], [9, 7, 4, 3], [19, 12, 6, 1], [19, 18, 18, 17], [21, 17, 20, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.ct.1", "24.72.3.yu.1", "24.72.3.zh.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.ka.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
