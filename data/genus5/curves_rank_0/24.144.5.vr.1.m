...
// Magma code for modular curve with label 24.144.5.vr.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1284

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 19, 14, 21], [9, 11, 8, 3], [11, 11, 16, 5], [19, 5, 20, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.dy.1", "24.72.2.dx.1", "24.72.2.eg.1", "24.72.2.ga.1", "24.72.2.gp.1", "24.72.3.bdx.1", "24.72.3.bek.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.vr.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
