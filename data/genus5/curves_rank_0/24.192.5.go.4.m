...
// Magma code for modular curve with label 24.192.5.go.4

// Other names and/or labels
// Cummins-Pauli label: 24AA5
// Rouse-Sutherland-Zureick-Brown label: 24.192.5.1514

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 9, 0, 17], [11, 8, 0, 23], [13, 11, 0, 7], [13, 12, 0, 7], [19, 12, 0, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["24.96.1.dg.4", "24.96.3.gi.2", "24.96.3.gj.3"];
...
// Map from the canonical model to the plane model of modular curve with label 24.192.5.go.4
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
