...
// Magma code for modular curve with label 40.144.5.fl.1

// Other names and/or labels
// Cummins-Pauli label: 20I5
// Rouse-Sutherland-Zureick-Brown label: 40.144.5.424

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 26, 24, 5], [11, 28, 20, 19], [11, 33, 4, 25], [25, 13, 24, 19], [31, 30, 0, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["20.72.3.o.1", "40.72.1.v.2", "40.72.1.z.1", "40.72.1.by.1", "40.72.3.co.1", "40.72.3.cv.1", "40.72.3.ej.2"];
...
// Map from the canonical model to the plane model of modular curve with label 40.144.5.fl.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
