...
// Magma code for modular curve with label 24.144.5.jq.1

// Other names and/or labels
// Cummins-Pauli label: 12B5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.653

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 10, 2, 3], [17, 12, 18, 19], [21, 13, 22, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.3.ct.1", "24.72.1.bj.1", "24.72.1.bu.1", "24.72.1.cr.1", "24.72.3.tx.1", "24.72.3.uk.1", "24.72.3.wd.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.jq.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
