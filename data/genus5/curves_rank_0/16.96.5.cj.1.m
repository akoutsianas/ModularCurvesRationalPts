...
// Magma code for modular curve with label 16.96.5.cj.1

// Other names and/or labels
// Cummins-Pauli label: 16A5
// Rouse-Sutherland-Zureick-Brown label: 16.96.5.70

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 2, 4, 15], [9, 7, 0, 7], [9, 9, 12, 15], [15, 4, 8, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.bn.1", "16.48.2.bw.1", "16.48.3.cf.1"];
...
// Map from the canonical model to the plane model of modular curve with label 16.96.5.cj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
