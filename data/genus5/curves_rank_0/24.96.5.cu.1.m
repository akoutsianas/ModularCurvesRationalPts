...
// Magma code for modular curve with label 24.96.5.cu.1

// Other names and/or labels
// Cummins-Pauli label: 24K5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.236

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 15, 16, 11], [11, 12, 6, 5], [13, 0, 6, 23], [19, 12, 22, 13], [23, 15, 4, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.24.1.bo.1", "24.48.2.n.1", "24.48.2.p.1", "24.48.3.c.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.cu.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
