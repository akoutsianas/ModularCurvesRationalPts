...
// Magma code for modular curve with label 20.96.5.f.1

// Other names and/or labels
// Cummins-Pauli label: 20D5
// Rouse-Sutherland-Zureick-Brown label: 20.96.5.16

// Group data
level := 20;
// Elements that, together with Gamma(level), generate the group
gens := [[12, 5, 13, 13], [15, 3, 4, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["20.24.1.d.2", "20.48.1.a.1", "20.48.3.g.1", "20.48.3.j.2"];
...
// Canonical model
model_0 := [x^2-y*z-y*t-z*t+w^2-t^2,3*x^2+x*y+x*z+2*x*t+y*w-z*w-w^2,3*x^2-x*y-x*z-2*x*t+3*y^2+4*y*z+y*w+3*z^2-z*w+w^2];
...
//   Coordinate number 0:
map_0_coord_0 := 1*(-y-4*z+w);
//   Coordinate number 1:
map_0_coord_1 := 1*(y-z+4*w);
//   Coordinate number 2:
map_0_coord_2 := 1*(-4*y-z-w);
// Codomain equation:
...
// Map from the canonical model to the plane model of modular curve with label 20.96.5.f.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y+z);
