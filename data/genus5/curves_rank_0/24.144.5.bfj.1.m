...
// Magma code for modular curve with label 24.144.5.bfj.1

// Other names and/or labels
// Cummins-Pauli label: 24W5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.1154

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 15, 12, 17], [15, 22, 16, 3], [19, 16, 22, 5], [21, 19, 10, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.fe.1", "24.72.2.cw.1", "24.72.2.ea.1", "24.72.2.hv.1", "24.72.2.im.1", "24.72.3.bgc.1", "24.72.3.bgv.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.bfj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
