...
// Magma code for modular curve with label 24.144.5.bdt.1

// Other names and/or labels
// Cummins-Pauli label: 24Y5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.913

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 7, 2, 15], [7, 6, 12, 19], [7, 18, 0, 17], [23, 22, 16, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.er.1", "24.72.2.hn.2", "24.72.2.hp.1"];
...
// Codomain equation:
map_1_codomain := [x^6*y^2-3*x^6*z^2-6*x^5*y*z^2+2*x^4*y^4-12*x^4*y^2*z^2+9*x^4*z^4+2*x^3*y^5-18*x^3*y^3*z^2+36*x^3*y*z^4+x^2*y^6-30*x^2*y^4*z^2+72*x^2*y^2*z^4+2*x*y^7-24*x*y^5*z^2+72*x*y^3*z^4+y^8-12*y^6*z^2+36*y^4*z^4];
