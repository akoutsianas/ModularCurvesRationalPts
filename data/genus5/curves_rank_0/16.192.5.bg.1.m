...
// Magma code for modular curve with label 16.192.5.bg.1

// Other names and/or labels
// Cummins-Pauli label: 16N5
// Rouse-Sutherland-Zureick-Brown label: 16.192.5.443

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 6, 0, 1], [3, 14, 8, 15], [11, 8, 0, 1], [13, 14, 0, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["16.96.1.c.1", "16.96.2.g.1", "16.96.2.h.1"];
...
// Canonical model
model_0 := [x^2-y*z+z^2-w^2-w*t,x^2+y^2+y*z+w*t-t^2,y*w-z*w+y*t+z*t];
...
// Map from the canonical model to the plane model of modular curve with label 16.192.5.bg.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y+z);
