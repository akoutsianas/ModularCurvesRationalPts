...
// Magma code for modular curve with label 48.96.5.cs.2

// Other names and/or labels
// Cummins-Pauli label: 16D5
// Rouse-Sutherland-Zureick-Brown label: 48.96.5.632

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 45, 22, 43], [37, 24, 40, 5], [43, 26, 32, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.3.i.2", "24.48.1.ca.2", "48.48.1.in.1", "48.48.1.iq.2", "48.48.3.g.1", "48.48.3.bp.1", "48.48.3.bu.2"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.5.cs.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
