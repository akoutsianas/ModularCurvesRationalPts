...
// Magma code for modular curve with label 24.96.5.dd.1

// Other names and/or labels
// Cummins-Pauli label: 24K5
// Rouse-Sutherland-Zureick-Brown label: 24.96.5.45

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 8, 0, 5], [5, 18, 0, 17], [7, 8, 0, 23], [7, 15, 6, 5], [23, 20, 18, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['3.4.0.a.1', '8.24.1.z.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["8.24.1.z.1", "24.48.2.m.1", "24.48.2.r.1", "24.48.3.c.1"];
...
model_1 := [x^4*y^2+2*x^2*y^4+x^4*z^2+4*x^2*y^2*z^2+6*x^2*z^4+9*y^2*z^4+9*z^6];
...
// Map from the canonical model to the plane model of modular curve with label 24.96.5.dd.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Codomain equation:
map_1_codomain := [x^4*y^2+2*x^2*y^4+x^4*z^2+4*x^2*y^2*z^2+6*x^2*z^4+9*y^2*z^4+9*z^6];
