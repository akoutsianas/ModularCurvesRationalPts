...
// Magma code for modular curve with label 24.144.5.lm.1

// Other names and/or labels
// Cummins-Pauli label: 12D5
// Rouse-Sutherland-Zureick-Brown label: 24.144.5.718

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 17, 22, 21], [11, 12, 12, 11], [19, 0, 6, 5], [19, 3, 18, 5], [21, 17, 4, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.3.du.1", "24.72.1.ct.1", "24.72.3.zr.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.144.5.lm.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
