...
// Magma code for modular curve with label 32.192.5.u.1

// Other names and/or labels
// Cummins-Pauli label: 32N5
// Rouse-Sutherland-Zureick-Brown label: 32.192.5.377

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 0, 24, 23], [23, 27, 16, 29], [25, 7, 16, 23], [29, 6, 8, 29], [31, 12, 0, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 192;
...
covers := ["16.96.1.m.1", "32.96.2.d.1", "32.96.2.e.1"];
...
// Canonical model
model_0 := [y*w-z*t,y^2+z^2-2*z*w-w^2+2*y*t-t^2,4*x^2+z^2-z*w+y*t-t^2];
...
// Map from the canonical model to the plane model of modular curve with label 32.192.5.u.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
