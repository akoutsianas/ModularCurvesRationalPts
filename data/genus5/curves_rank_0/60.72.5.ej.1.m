...
// Magma code for modular curve with label 60.72.5.ej.1

// Other names and/or labels
// Cummins-Pauli label: 30G5
// Rouse-Sutherland-Zureick-Brown label: 60.72.5.99

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[32, 35, 7, 26], [39, 50, 44, 27], [48, 25, 13, 3], [49, 30, 6, 41]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["30.36.1.q.1", "60.36.2.fs.1", "60.36.2.fv.2"];
...
// Map from the canonical model to the plane model of modular curve with label 60.72.5.ej.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
