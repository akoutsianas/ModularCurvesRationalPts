...
// Magma code for modular curve with label 24.72.3.bdk.1

// Other names and/or labels
// Cummins-Pauli label: 24P3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.861

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 1, 16, 11], [1, 19, 20, 7], [5, 13, 14, 11], [19, 9, 18, 1], [21, 5, 22, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.ft.1", "24.36.1.fy.1", "24.36.1.gp.1"];
