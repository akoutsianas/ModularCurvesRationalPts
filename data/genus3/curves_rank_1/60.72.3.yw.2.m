...
// Magma code for modular curve with label 60.72.3.yw.2

// Other names and/or labels
// Cummins-Pauli label: 20G3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.827

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 0, 18, 23], [19, 0, 2, 23], [21, 55, 50, 33], [41, 55, 24, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.2.a.2", "60.36.0.b.2", "60.36.1.dq.1"];
...
model_2 := [3*x^2-y^2-z^2,648*x^4+198*x^2*y*z-1053*x^2*z^2-132*y*z^3+351*z^4-625*w^2];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.yw.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
