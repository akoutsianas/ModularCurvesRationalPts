...
// Magma code for modular curve with label 24.72.3.bgi.1

// Other names and/or labels
// Cummins-Pauli label: 24Q3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.853

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 11, 8, 11], [1, 14, 4, 1], [5, 22, 14, 11], [19, 13, 2, 1], [23, 20, 8, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fr.1", "24.36.1.ga.1", "24.36.1.gt.1"];
