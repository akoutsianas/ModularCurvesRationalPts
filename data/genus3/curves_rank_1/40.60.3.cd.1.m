...
// Magma code for modular curve with label 40.60.3.cd.1

// Other names and/or labels
// Cummins-Pauli label: 10B3
// Rouse-Sutherland-Zureick-Brown label: 40.60.3.23

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 37, 25, 32], [19, 20, 37, 11], [23, 10, 30, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["10.30.1.c.1", "40.30.0.d.1", "40.30.2.l.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.60.3.cd.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
