...
// Magma code for modular curve with label 40.72.3.df.1

// Other names and/or labels
// Cummins-Pauli label: 20I3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.68

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 20, 0, 3], [21, 22, 20, 23], [39, 15, 0, 19], [39, 25, 18, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.0.c.1", "40.36.1.f.1", "40.36.2.b.2"];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.df.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.72.3.df.1
//   Coordinate number 0:
