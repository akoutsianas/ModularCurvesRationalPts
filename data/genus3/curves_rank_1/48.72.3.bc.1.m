...
// Magma code for modular curve with label 48.72.3.bc.1

// Other names and/or labels
// Cummins-Pauli label: 48E3
// Rouse-Sutherland-Zureick-Brown label: 48.72.3.38

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 43, 2, 47], [19, 34, 20, 43], [21, 23, 10, 27], [21, 32, 20, 3], [23, 3, 18, 31], [31, 8, 28, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.0.cg.1", "48.24.1.k.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.72.3.bc.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.72.3.bc.1
//   Coordinate number 0:
map_2_coord_0 := 1*(w);
//   Coordinate number 1:
