...
// Magma code for modular curve with label 24.72.3.bhn.1

// Other names and/or labels
// Cummins-Pauli label: 24P3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.801

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 9, 0, 19], [5, 15, 12, 7], [17, 7, 2, 11], [19, 14, 2, 17], [23, 8, 20, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fx.1", "24.36.1.gg.1", "24.36.1.gt.1"];
