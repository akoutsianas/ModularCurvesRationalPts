...
// Magma code for modular curve with label 16.48.3.br.1

// Other names and/or labels
// Cummins-Pauli label: 16C3
// Rouse-Sutherland-Zureick-Brown label: 16.48.3.27

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 14, 14, 7], [9, 12, 6, 15], [13, 3, 0, 7], [13, 10, 0, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["8.24.0.bi.1", "16.24.1.n.2", "16.24.2.b.2"];
...
// Map from the embedded model to the plane model of modular curve with label 16.48.3.br.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 16.48.3.br.1
//   Coordinate number 0:
