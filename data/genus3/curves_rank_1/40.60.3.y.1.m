...
// Magma code for modular curve with label 40.60.3.y.1

// Other names and/or labels
// Cummins-Pauli label: 10B3
// Rouse-Sutherland-Zureick-Brown label: 40.60.3.50

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[16, 31, 23, 19], [17, 8, 36, 33], [28, 7, 19, 32]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["20.30.1.a.1", "40.30.0.c.1", "40.30.2.f.1"];
...
model_2 := [-2*x^2+2*x*z+121*y^2+302*z^2,-3*x^4+61*x^3*z+10198*x^2*z^2+214364*x*z^3+1148472*z^4-366025*w^2];
...
// Map from the embedded model to the plane model of modular curve with label 40.60.3.y.1
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
