...
// Magma code for modular curve with label 48.96.3.nr.1

// Other names and/or labels
// Cummins-Pauli label: 8B3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.1161

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 3, 8, 47], [5, 27, 46, 7], [7, 23, 14, 9], [23, 42, 20, 35]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.bk.1", "24.48.1.hi.1", "48.48.0.ca.1", "48.48.1.dc.1", "48.48.1.de.1", "48.48.2.bk.1", "48.48.2.ca.1"];
...
// Embedded model
model_0 := [z*w-y*t-z*t-w*u,w^2-w*t+t^2-y*u+z*u,w^2-t^2-y*u-z*u+2*u^2,w^2+w*t+2*z*u+2*u^2,y*w+2*z*w+y*t-z*t+w*u-2*t*u,y^2+4*y*z+z^2+2*u^2,12*x^2-y^2-y*z-z^2];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.nr.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
