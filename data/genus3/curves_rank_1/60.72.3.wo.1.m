...
// Magma code for modular curve with label 60.72.3.wo.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.135

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 12, 36, 17], [23, 56, 8, 49], [43, 36, 0, 23], [55, 26, 13, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.0.m.1", "60.36.1.ck.1", "60.36.1.cq.1", "60.36.1.fn.1", "60.36.2.dv.1", "60.36.2.ea.1", "60.36.2.fi.1"];
...
// Embedded model
model_0 := [x^2-y*z+y*w+z*w+w^2-x*u-u^2,x^2-y*z-y*w-z*w+w^2+x*t-t^2,y*z+z^2+t^2+2*t*u+u^2,x*z-z*t+2*w*t+z*u+2*w*u,2*x^2-y*z-2*w^2+x*t-t^2-x*u-u^2,x^2+y^2+y*z-2*x*t+t^2+2*x*u-2*t*u+u^2,2*x*w+y*t-2*w*t+y*u+2*w*u];

// Singular plane model
model_1 := [256*x^8+240*x^6*y^2+25*x^4*y^4-640*x^7*z-200*x^5*y^2*z+752*x^6*z^2+90*x^4*y^2*z^2-600*x^5*z^3-50*x^3*y^2*z^3+353*x^4*z^4+15*x^2*y^2*z^4-150*x^3*z^5+47*x^2*z^6-10*x*z^7+z^8];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.wo.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(4*u);
...
map_1_coord_2 := 1*(4*w);
// Codomain equation:
map_1_codomain := [256*x^8+240*x^6*y^2+25*x^4*y^4-640*x^7*z-200*x^5*y^2*z+752*x^6*z^2+90*x^4*y^2*z^2-600*x^5*z^3-50*x^3*y^2*z^3+353*x^4*z^4+15*x^2*y^2*z^4-150*x^3*z^5+47*x^2*z^6-10*x*z^7+z^8];
