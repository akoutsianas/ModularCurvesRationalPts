...
// Magma code for modular curve with label 24.72.3.ban.1

// Other names and/or labels
// Cummins-Pauli label: 12J3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.401

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 1, 2, 7], [5, 10, 22, 19], [7, 5, 2, 17], [13, 20, 4, 1], [17, 14, 2, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.by.1", "24.36.1.fn.1", "24.36.1.fy.1"];
