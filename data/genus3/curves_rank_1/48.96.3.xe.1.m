...
// Magma code for modular curve with label 48.96.3.xe.1

// Other names and/or labels
// Cummins-Pauli label: 16L3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.278

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[25, 43, 32, 15], [27, 17, 4, 13], [35, 41, 32, 45], [43, 5, 30, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.bv.1", "48.48.1.fv.1", "48.48.1.il.1"];
