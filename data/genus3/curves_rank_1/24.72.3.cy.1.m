...
// Magma code for modular curve with label 24.72.3.cy.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.494

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 0, 18, 11], [19, 5, 2, 11], [23, 9, 0, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.y.1", "24.36.0.n.1", "24.36.1.h.1", "24.36.1.eo.1", "24.36.2.k.1", "24.36.2.s.1", "24.36.2.el.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.cy.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
