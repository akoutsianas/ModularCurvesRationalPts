...
// Magma code for modular curve with label 40.72.3.dw.1

// Other names and/or labels
// Cummins-Pauli label: 20J3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.186

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 9, 8, 11], [19, 4, 6, 37], [19, 7, 8, 23], [21, 13, 30, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.1.e.1", "40.12.0.bg.1", "40.36.1.f.1", "40.36.1.k.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.dw.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
