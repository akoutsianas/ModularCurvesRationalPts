...
// Magma code for modular curve with label 24.72.3.bcd.1

// Other names and/or labels
// Cummins-Pauli label: 24I3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.365

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 21, 6, 17], [11, 22, 4, 13], [17, 4, 16, 19], [23, 22, 8, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bp.1", "24.36.0.cc.1", "24.36.2.gh.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.bcd.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*u);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.3.bcd.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-z);
//   Coordinate number 1:
