...
// Magma code for modular curve with label 24.72.3.ww.1

// Other names and/or labels
// Cummins-Pauli label: 24O3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.826

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 10, 4, 15], [7, 22, 4, 11], [13, 23, 22, 7], [17, 6, 6, 7], [17, 10, 2, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fb.1", "24.36.1.fo.1", "24.36.1.ft.1"];
