...
// Magma code for modular curve with label 48.48.3.ew.2

// Other names and/or labels
// Cummins-Pauli label: 16F3
// Rouse-Sutherland-Zureick-Brown label: 48.48.3.23

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 45, 38, 5], [15, 32, 44, 17], [33, 14, 44, 17], [37, 5, 38, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["8.24.0.bl.2", "48.24.1.l.1", "48.24.2.e.2"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.3.ew.2
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.3.ew.2
//   Coordinate number 0:
