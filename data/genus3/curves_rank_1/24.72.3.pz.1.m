...
// Magma code for modular curve with label 24.72.3.pz.1

// Other names and/or labels
// Cummins-Pauli label: 24L3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.908

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 0, 0, 23], [7, 17, 20, 23], [13, 11, 20, 11], [15, 19, 16, 15], [19, 4, 20, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.bt.1", "24.36.2.cq.1", "24.36.2.cx.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.pz.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(4*y);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.3.pz.1
//   Coordinate number 0:
map_2_coord_0 := 1*(w);
//   Coordinate number 1:
