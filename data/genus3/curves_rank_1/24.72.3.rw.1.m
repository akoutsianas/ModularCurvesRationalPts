...
// Magma code for modular curve with label 24.72.3.rw.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.585

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 13, 20, 11], [19, 1, 2, 1], [21, 8, 2, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.bg.1", "24.36.0.bi.1", "24.36.1.ch.1", "24.36.1.cl.1", "24.36.1.eu.1", "24.36.2.ed.1", "24.36.2.fy.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.rw.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.3.rw.1
//   Coordinate number 0:
map_2_coord_0 := 1*(t);
//   Coordinate number 1:
