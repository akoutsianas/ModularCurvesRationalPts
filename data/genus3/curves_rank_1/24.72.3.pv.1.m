...
// Magma code for modular curve with label 24.72.3.pv.1

// Other names and/or labels
// Cummins-Pauli label: 24L3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.912

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 22, 20, 21], [17, 14, 4, 11], [21, 8, 20, 21], [21, 19, 16, 21], [23, 17, 20, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.bt.1", "24.36.2.cs.1", "24.36.2.cv.1"];
...
model_2 := [-2*x^2-2*x*y-2*y^2+z^2,9*x^4+6*x^2*z^2+4*z^4-18*w^2];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.pv.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
