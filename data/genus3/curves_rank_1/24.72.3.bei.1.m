...
// Magma code for modular curve with label 24.72.3.bei.1

// Other names and/or labels
// Cummins-Pauli label: 24P3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.359

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 4, 22, 9], [9, 11, 10, 3], [13, 17, 22, 19], [15, 4, 20, 3], [17, 16, 2, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bu.1", "24.36.1.gh.1", "24.36.1.gp.1"];
