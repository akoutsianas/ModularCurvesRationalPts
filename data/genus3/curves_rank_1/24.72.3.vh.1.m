...
// Magma code for modular curve with label 24.72.3.vh.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.708

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 23, 2, 23], [17, 9, 0, 23], [17, 22, 20, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.bo.1", "24.36.0.bt.1", "24.36.1.dd.1", "24.36.1.di.1", "24.36.1.fg.1", "24.36.2.fm.1", "24.36.2.fx.1"];
