...
// Magma code for modular curve with label 40.72.3.bm.1

// Other names and/or labels
// Cummins-Pauli label: 20J3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.161

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 15, 20, 33], [25, 18, 4, 39], [25, 38, 38, 15], [27, 9, 16, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.1.h.1", "40.12.0.o.1", "40.36.1.c.1", "40.36.1.e.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.bm.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
