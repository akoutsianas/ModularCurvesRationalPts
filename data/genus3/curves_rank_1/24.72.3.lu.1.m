...
// Magma code for modular curve with label 24.72.3.lu.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.674

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 11, 16, 19], [15, 5, 22, 15], [21, 17, 10, 9], [23, 2, 8, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.r.1", "24.36.0.u.1", "24.36.1.bk.1", "24.36.1.da.1", "24.36.1.ej.1", "24.36.2.dk.1", "24.36.2.ef.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.lu.1
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*z);
