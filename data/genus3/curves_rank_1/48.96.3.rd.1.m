...
// Magma code for modular curve with label 48.96.3.rd.1

// Other names and/or labels
// Cummins-Pauli label: 16I3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.642

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 10, 34, 21], [21, 5, 4, 3], [35, 21, 38, 37], [47, 46, 20, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.y.1", "24.48.1.lq.1", "48.48.0.cm.1", "48.48.1.fq.1", "48.48.2.by.2", "48.48.2.cr.1", "48.48.2.dp.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.rd.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
