...
// Magma code for modular curve with label 48.96.3.pj.1

// Other names and/or labels
// Cummins-Pauli label: 16I3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.1097

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 11, 12, 31], [11, 39, 26, 41], [13, 18, 38, 35], [23, 37, 36, 41]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.bo.1", "24.48.1.hu.1", "48.48.0.co.1", "48.48.1.er.1", "48.48.1.fb.1", "48.48.2.bq.1", "48.48.2.cl.2"];
