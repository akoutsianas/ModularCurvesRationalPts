...
// Magma code for modular curve with label 60.72.3.rh.2

// Other names and/or labels
// Cummins-Pauli label: 20H3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.720

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 45, 26, 13], [27, 50, 32, 33], [37, 55, 40, 59], [41, 0, 4, 47]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.0.d.2", "60.36.1.bg.1", "60.36.2.fr.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.rh.2
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.72.3.rh.2
//   Coordinate number 0:
map_2_coord_0 := 1*(-1/3*w*u);
//   Coordinate number 1:
map_2_coord_1 := 1*(-160/3*z*t^4*u^3-440/9*z*t^3*u^4-400/27*z*t^2*u^5-40/27*z*t*u^6);
//   Coordinate number 2:
map_2_coord_2 := 1*(t*u+1/3*u^2);
// Codomain equation:
