...
// Magma code for modular curve with label 24.48.3.w.1

// Other names and/or labels
// Cummins-Pauli label: 12C3
// Rouse-Sutherland-Zureick-Brown label: 24.48.3.47

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 1, 17, 4], [17, 7, 20, 11], [22, 19, 7, 14]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["12.24.1.p.1", "24.12.1.q.1", "24.24.0.fe.1", "24.24.2.a.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.48.3.w.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(u);
