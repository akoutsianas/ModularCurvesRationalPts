...
// Magma code for modular curve with label 24.72.3.bhh.1

// Other names and/or labels
// Cummins-Pauli label: 24P3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.350

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 12, 6, 13], [11, 9, 0, 1], [11, 15, 6, 17], [17, 7, 8, 23], [23, 6, 12, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bv.1", "24.36.1.gf.1", "24.36.1.gt.1"];
