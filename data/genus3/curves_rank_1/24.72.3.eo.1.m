...
// Magma code for modular curve with label 24.72.3.eo.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.548

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 18, 12, 1], [7, 15, 6, 23], [17, 23, 14, 1], [23, 5, 22, 23], [23, 15, 6, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.i.1", "24.36.0.bs.1", "24.36.1.m.1", "24.36.1.y.1", "24.36.1.es.1", "24.36.2.bn.1", "24.36.2.dk.1"];
