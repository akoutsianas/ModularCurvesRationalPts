...
// Magma code for modular curve with label 24.72.3.in.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.77

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 10, 2, 17], [5, 16, 20, 11], [19, 13, 16, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.0.l.1", "24.36.1.x.1", "24.36.1.ct.1", "24.36.1.ed.1", "24.36.2.bm.1", "24.36.2.bs.1", "24.36.2.ft.1"];
...
model_2 := [3*x^2+y^2+z^2,144*x^4-144*x^3*y-48*x^2*z^2-120*x*y*z^2-74*z^4-3*w^2];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.in.1
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*t);
