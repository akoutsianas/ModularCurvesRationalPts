...
// Magma code for modular curve with label 60.96.3.bn.1

// Other names and/or labels
// Cummins-Pauli label: 12K3
// Rouse-Sutherland-Zureick-Brown label: 60.96.3.490

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 42, 21, 5], [19, 36, 12, 59], [41, 32, 42, 53], [59, 4, 15, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["60.24.0.j.1", "60.48.1.i.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.96.3.bn.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
