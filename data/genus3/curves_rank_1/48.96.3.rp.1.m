...
// Magma code for modular curve with label 48.96.3.rp.1

// Other names and/or labels
// Cummins-Pauli label: 16I3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.459

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 6, 10, 19], [21, 44, 44, 25], [29, 3, 44, 11], [39, 4, 8, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.bc.1", "24.48.1.mc.1", "48.48.0.co.1", "48.48.1.fw.1", "48.48.2.bz.2", "48.48.2.ct.1", "48.48.2.dp.1"];
