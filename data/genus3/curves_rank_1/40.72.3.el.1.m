...
// Magma code for modular curve with label 40.72.3.el.1

// Other names and/or labels
// Cummins-Pauli label: 20G3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.220

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 25, 20, 21], [33, 3, 22, 19], [37, 7, 34, 15], [37, 35, 4, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.2.a.2", "40.36.0.a.1", "40.36.1.j.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.el.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
