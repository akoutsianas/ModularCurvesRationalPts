...
// Magma code for modular curve with label 24.72.3.yn.1

// Other names and/or labels
// Cummins-Pauli label: 24O3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.465

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 12, 6, 19], [11, 23, 20, 13], [13, 18, 12, 1], [13, 21, 12, 23], [23, 23, 10, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bn.1", "24.36.1.gf.1", "24.36.1.gj.1"];
