...
// Magma code for modular curve with label 24.72.3.lw.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.742

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 19, 4, 19], [17, 3, 6, 5], [17, 19, 14, 17], [21, 7, 2, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.y.1", "24.36.0.t.1", "24.36.1.bk.1", "24.36.1.dc.1", "24.36.1.eh.1", "24.36.2.bz.1", "24.36.2.eg.1"];
...
model_2 := [3*x^2-y^2-z^2,-54*x^4-36*x^2*z^2-96*x*z^3-38*z^4-w^2];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.lw.1
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
