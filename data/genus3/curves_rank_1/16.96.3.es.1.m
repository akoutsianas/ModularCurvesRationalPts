...
// Magma code for modular curve with label 16.96.3.es.1

// Other names and/or labels
// Cummins-Pauli label: 16K3
// Rouse-Zureick-Brown label: X582
// Rouse-Sutherland-Zureick-Brown label: 16.96.3.352

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 0, 6, 7], [7, 2, 0, 11], [7, 9, 10, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.bn.1", "16.48.1.bp.1", "16.48.1.co.1"];
