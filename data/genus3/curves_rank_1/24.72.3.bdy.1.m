...
// Magma code for modular curve with label 24.72.3.bdy.1

// Other names and/or labels
// Cummins-Pauli label: 24P3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.803

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 1, 20, 23], [5, 16, 22, 19], [11, 2, 10, 5], [15, 11, 16, 9], [19, 2, 4, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fw.1", "24.36.1.ge.1", "24.36.1.gp.1"];
