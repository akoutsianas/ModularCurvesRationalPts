...
// Magma code for modular curve with label 48.96.3.cr.1

// Other names and/or labels
// Cummins-Pauli label: 16I3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.362

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 34, 32, 11], [21, 26, 8, 45], [25, 24, 42, 7], [45, 34, 44, 41]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.0.c.2", "24.48.1.bl.1", "48.48.1.du.1", "48.48.1.eq.1", "48.48.2.c.2", "48.48.2.do.1", "48.48.2.eo.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.cr.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.96.3.cr.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-t);
//   Coordinate number 1:
