...
// Magma code for modular curve with label 24.72.3.bbk.1

// Other names and/or labels
// Cummins-Pauli label: 24I3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.250

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 5, 10, 11], [17, 2, 4, 23], [17, 9, 18, 23], [19, 7, 2, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bk.1", "24.36.0.cd.1", "24.36.2.gk.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.bbk.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.3.bbk.1
//   Coordinate number 0:
map_2_coord_0 := 1*(y);
//   Coordinate number 1:
