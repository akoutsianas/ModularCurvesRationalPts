...
// Magma code for modular curve with label 16.48.3.bs.1

// Other names and/or labels
// Cummins-Pauli label: 16C3
// Rouse-Sutherland-Zureick-Brown label: 16.48.3.26

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 14, 10, 3], [11, 15, 0, 13], [15, 13, 8, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["8.24.0.bj.1", "16.24.1.n.1", "16.24.2.b.1"];
...
// Map from the embedded model to the plane model of modular curve with label 16.48.3.bs.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(4*w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 16.48.3.bs.1
//   Coordinate number 0:
