...
// Magma code for modular curve with label 40.60.3.bv.1

// Other names and/or labels
// Cummins-Pauli label: 10B3
// Rouse-Sutherland-Zureick-Brown label: 40.60.3.34

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[6, 37, 5, 32], [24, 15, 7, 31], [27, 39, 26, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["10.30.2.d.1", "40.30.0.c.1", "40.30.1.d.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.60.3.bv.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(5*z);
