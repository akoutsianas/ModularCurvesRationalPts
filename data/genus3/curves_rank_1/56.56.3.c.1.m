...
// Magma code for modular curve with label 56.56.3.c.1

// Other names and/or labels
// Cummins-Pauli label: 14C3
// Rouse-Sutherland-Zureick-Brown label: 56.56.3.4

// Group data
level := 56;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 9, 23, 28], [21, 10, 11, 49], [22, 41, 55, 3], [55, 10, 20, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 56;
...
// Map from the embedded model to the plane model of modular curve with label 56.56.3.c.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 56.56.3.c.1
//   Coordinate number 0:
