...
// Magma code for modular curve with label 36.54.3.h.1

// Other names and/or labels
// Cummins-Pauli label: 36E3
// Rouse-Sutherland-Zureick-Brown label: 36.54.3.9

// Group data
level := 36;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 22, 28, 25], [21, 28, 28, 3], [23, 27, 0, 5], [23, 30, 6, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 54;
...
covers := ["12.18.1.g.1", "18.27.1.a.1"];
...
// Weierstrass model
model_2 := [8*x^6*z^2+x^4*y-74*x^4*z^4+x^2*y*z^2+162*x^2*z^6+y^2+972*z^8];
...
// Map from the embedded model to the plane model of modular curve with label 36.54.3.h.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 36.54.3.h.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-w^2);
//   Coordinate number 1:
map_2_coord_1 := 1*(27*y^4*w^4+9*y^4*w^3*t-8*y^2*w^6);
//   Coordinate number 2:
map_2_coord_2 := 1*(y*w);
// Codomain equation:
map_2_codomain := [8*x^6*z^2+x^4*y-74*x^4*z^4+x^2*y*z^2+162*x^2*z^6+y^2+972*z^8];
