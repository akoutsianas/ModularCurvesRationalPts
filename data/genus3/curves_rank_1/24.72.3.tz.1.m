...
// Magma code for modular curve with label 24.72.3.tz.1

// Other names and/or labels
// Cummins-Pauli label: 12E3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.5

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 7, 8, 3], [5, 0, 0, 23], [9, 8, 2, 9], [11, 21, 0, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["6.36.0.b.1", "24.36.1.dn.1", "24.36.2.ev.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.tz.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(6*w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.3.tz.1
//   Coordinate number 0:
map_2_coord_0 := 1*(y*t);
//   Coordinate number 1:
