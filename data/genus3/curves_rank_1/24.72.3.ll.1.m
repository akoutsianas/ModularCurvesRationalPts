...
// Magma code for modular curve with label 24.72.3.ll.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.517

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 5, 20, 15], [13, 20, 16, 19], [23, 13, 2, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bj.1", "24.36.0.ba.1", "24.36.1.bo.1", "24.36.1.cv.1", "24.36.2.by.1", "24.36.2.dl.1", "24.36.2.ea.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.ll.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(u);
