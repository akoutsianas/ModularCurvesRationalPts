...
// Magma code for modular curve with label 24.96.3.v.1

// Other names and/or labels
// Cummins-Pauli label: 8B3
// Rouse-Sutherland-Zureick-Brown label: 24.96.3.90

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 4, 22, 9], [5, 8, 22, 11], [5, 16, 4, 21], [11, 16, 12, 23], [23, 8, 6, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.2.a.1", "24.48.0.c.1", "24.48.1.n.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.96.3.v.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
