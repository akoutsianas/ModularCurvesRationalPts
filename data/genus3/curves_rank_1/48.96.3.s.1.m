...
// Magma code for modular curve with label 48.96.3.s.1

// Other names and/or labels
// Cummins-Pauli label: 8B3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.1008

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[15, 38, 14, 9], [25, 32, 34, 31], [43, 44, 42, 37], [45, 14, 2, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.b.1", "24.48.1.d.1", "48.48.0.a.1", "48.48.1.dn.1", "48.48.1.el.1", "48.48.2.cx.1", "48.48.2.dv.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.s.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
