...
// Magma code for modular curve with label 30.60.3.q.1

// Other names and/or labels
// Cummins-Pauli label: 30H3
// Rouse-Sutherland-Zureick-Brown label: 30.60.3.6

// Group data
level := 30;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 19, 5, 12], [21, 1, 23, 0], [21, 11, 11, 24], [28, 5, 7, 22]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['5.10.0.a.1', '6.6.0.c.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["6.6.0.c.1", "15.30.1.a.1"];
