...
// Magma code for modular curve with label 24.72.3.eq.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.712

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 16, 8, 5], [9, 17, 20, 3], [13, 23, 10, 13], [19, 8, 4, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.n.1", "24.36.0.bq.1", "24.36.1.m.1", "24.36.1.ba.1", "24.36.1.er.1", "24.36.2.y.1", "24.36.2.dl.1"];
...
model_1 := [-3*x^2+y^2+z^2,114*x^4-96*x^3*z+12*x^2*z^2+2*z^4-w^2];
