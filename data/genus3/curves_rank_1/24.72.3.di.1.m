...
// Magma code for modular curve with label 24.72.3.di.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.302

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 16, 2, 7], [11, 23, 22, 11], [15, 19, 14, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.be.1", "24.36.0.bd.1", "24.36.1.e.1", "24.36.1.cj.1", "24.36.2.o.1", "24.36.2.v.1", "24.36.2.fm.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.di.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(u);
