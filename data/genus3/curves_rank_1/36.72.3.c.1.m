...
// Magma code for modular curve with label 36.72.3.c.1

// Other names and/or labels
// Cummins-Pauli label: 18F3
// Rouse-Sutherland-Zureick-Brown label: 36.72.3.27

// Group data
level := 36;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 3, 9, 26], [9, 7, 29, 6], [17, 27, 21, 8]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.24.1.a.1", "18.36.2.a.1", "36.36.0.a.1", "36.36.1.d.1"];
...
// Map from the embedded model to the plane model of modular curve with label 36.72.3.c.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
