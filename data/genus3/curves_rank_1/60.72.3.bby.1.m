...
// Magma code for modular curve with label 60.72.3.bby.1

// Other names and/or labels
// Cummins-Pauli label: 30J3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.882

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 40, 43, 11], [9, 35, 13, 48], [13, 0, 57, 13], [46, 5, 37, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["30.36.2.a.1", "60.36.0.ch.1", "60.36.1.do.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.bby.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.72.3.bby.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-y);
//   Coordinate number 1:
