...
// Magma code for modular curve with label 48.96.3.pp.1

// Other names and/or labels
// Cummins-Pauli label: 16I3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.1174

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 1, 44, 29], [7, 25, 2, 25], [11, 27, 32, 5], [19, 41, 4, 45]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.bu.1", "24.48.1.hy.1", "48.48.0.cn.1", "48.48.1.et.1", "48.48.1.fb.1", "48.48.2.bu.1", "48.48.2.ck.1"];
...
// Embedded model
model_0 := [y*w+y*t-z*t+w*u,w^2+w*t+t^2-y*u-z*u,w^2-t^2+y*u-z*u+2*u^2,w^2-w*t-2*y*u+2*u^2,2*y*w-z*w+y*t+z*t-w*u-2*t*u,3*x^2-y^2+y*z-z^2,3*x^2-3*y*z+2*u^2];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.pp.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
