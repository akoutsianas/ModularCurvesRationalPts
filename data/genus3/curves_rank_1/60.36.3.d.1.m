...
// Magma code for modular curve with label 60.36.3.d.1

// Other names and/or labels
// Cummins-Pauli label: 30B3
// Rouse-Sutherland-Zureick-Brown label: 60.36.3.4

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[4, 21, 39, 37], [31, 24, 21, 13], [36, 29, 17, 39], [38, 7, 59, 35], [57, 20, 47, 39]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["15.18.0.a.1", "60.6.1.b.1", "60.12.1.n.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.36.3.d.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.36.3.d.1
//   Coordinate number 0:
map_2_coord_0 := 1*(w);
//   Coordinate number 1:
