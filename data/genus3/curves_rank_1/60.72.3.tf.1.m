...
// Magma code for modular curve with label 60.72.3.tf.1

// Other names and/or labels
// Cummins-Pauli label: 12D3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.235

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[4, 53, 9, 44], [17, 22, 28, 55], [43, 56, 48, 53], [59, 48, 52, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bh.1", "60.36.0.a.1", "60.36.2.dk.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.tf.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
