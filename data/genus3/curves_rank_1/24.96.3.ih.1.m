...
// Magma code for modular curve with label 24.96.3.ih.1

// Other names and/or labels
// Cummins-Pauli label: 8A3
// Rouse-Sutherland-Zureick-Brown label: 24.96.3.74

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 19, 0, 11], [7, 9, 4, 17], [7, 18, 6, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.bt.1", "24.48.1.lm.1", "24.48.1.me.1"];
