...
// Magma code for modular curve with label 24.96.3.id.1

// Other names and/or labels
// Cummins-Pauli label: 8A3
// Rouse-Sutherland-Zureick-Brown label: 24.96.3.75

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 9, 14, 19], [9, 8, 4, 5], [11, 6, 10, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.bt.1", "24.48.1.li.1", "24.48.1.mf.1"];
