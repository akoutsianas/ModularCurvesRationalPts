...
// Magma code for modular curve with label 24.72.3.bz.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.495

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 1, 10, 3], [7, 5, 14, 11], [13, 6, 6, 11], [23, 12, 0, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.h.1", "24.36.0.bw.1", "24.36.1.f.1", "24.36.1.ez.1", "24.36.2.i.1", "24.36.2.s.1", "24.36.2.dk.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.bz.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(u);
