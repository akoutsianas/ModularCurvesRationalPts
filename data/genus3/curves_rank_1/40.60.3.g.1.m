...
// Magma code for modular curve with label 40.60.3.g.1

// Other names and/or labels
// Cummins-Pauli label: 10B3
// Rouse-Sutherland-Zureick-Brown label: 40.60.3.21

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[14, 33, 25, 23], [24, 29, 37, 6], [31, 11, 18, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["10.30.1.c.1", "40.30.0.a.1", "40.30.2.e.1"];
...
model_2 := [2*x^2-2*x*z-121*y^2-302*z^2,984*x^4+46564*x^3*z+825046*x^2*z^2+6486659*x*z^3+19091667*z^4-14641*w^2];
...
// Map from the embedded model to the plane model of modular curve with label 40.60.3.g.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
