...
// Magma code for modular curve with label 40.72.3.cp.2

// Other names and/or labels
// Cummins-Pauli label: 20H3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.223

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 18, 34, 35], [1, 23, 8, 11], [27, 22, 0, 19], [37, 16, 26, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.2.a.2", "40.36.0.e.2", "40.36.1.d.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.cp.2
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.72.3.cp.2
//   Coordinate number 0:
map_2_coord_0 := 1*(-1/2*t*u);
//   Coordinate number 1:
map_2_coord_1 := 1*(480*z*w*t^6-96*z*w*t^4*u^2+160*z*t^7-92*z*t^5*u^2+13/2*z*t^3*u^4);
//   Coordinate number 2:
map_2_coord_2 := 1*(-3/2*w*t-1/2*t^2);
// Codomain equation:
