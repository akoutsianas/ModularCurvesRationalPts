...
// Magma code for modular curve with label 40.72.3.ft.1

// Other names and/or labels
// Cummins-Pauli label: 40H3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.19

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 2, 24, 9], [11, 16, 18, 29], [21, 7, 18, 15], [21, 18, 2, 27], [33, 11, 10, 19], [39, 9, 10, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['5.6.0.a.1', '8.12.0.v.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["8.12.0.v.1", "20.36.1.j.1"];
