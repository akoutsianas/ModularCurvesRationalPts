...
// Magma code for modular curve with label 24.72.3.ha.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.301

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 3, 0, 11], [17, 6, 6, 11], [17, 8, 4, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.be.1", "24.36.0.ba.1", "24.36.1.n.1", "24.36.1.cp.1", "24.36.2.bi.1", "24.36.2.bs.1", "24.36.2.fp.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.ha.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(u);
