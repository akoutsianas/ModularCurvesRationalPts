...
// Magma code for modular curve with label 48.96.3.pq.1

// Other names and/or labels
// Cummins-Pauli label: 16I3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.1138

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 28, 34, 9], [11, 29, 18, 37], [31, 34, 22, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.bv.1", "24.48.1.hz.1", "48.48.0.cn.2", "48.48.1.es.1", "48.48.1.fa.1", "48.48.2.bv.1", "48.48.2.ck.2"];
...
// Weierstrass model
model_2 := [x^8+63*x^6*z^2+x^4*y+473*x^4*z^4+567*x^2*z^6+y^2+y*z^4+61*z^8];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.pq.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.96.3.pq.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-3*w*t+3*t^2-3/2*u^2);
//   Coordinate number 1:
map_2_coord_1 := 1*(-54*x*t^3*u^4+54*x*t^2*u^5-27/2*x*t*u^6-5*t^4*u^4+t^3*u^5+3/2*t^2*u^6+1/4*t*u^7-5/16*u^8);
//   Coordinate number 2:
map_2_coord_2 := 1*(t*u-1/2*u^2);
// Codomain equation:
map_2_codomain := [x^8+63*x^6*z^2+x^4*y+473*x^4*z^4+567*x^2*z^6+y^2+y*z^4+61*z^8];
