...
// Magma code for modular curve with label 24.96.3.dd.1

// Other names and/or labels
// Cummins-Pauli label: 8A3
// Rouse-Sutherland-Zureick-Brown label: 24.96.3.77

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 15, 6, 11], [7, 16, 0, 7], [17, 0, 14, 19], [19, 12, 2, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.y.1", "24.48.1.mg.1", "24.48.1.mh.1"];
