...
// Magma code for modular curve with label 24.72.3.fu.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.750

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 23, 20, 23], [13, 1, 18, 11], [21, 14, 22, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.bq.1", "24.36.0.t.1", "24.36.1.o.1", "24.36.1.ci.1", "24.36.1.dt.1", "24.36.2.bc.1", "24.36.2.bl.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.fu.1
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*t);
