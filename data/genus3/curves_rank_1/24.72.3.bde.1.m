...
// Magma code for modular curve with label 24.72.3.bde.1

// Other names and/or labels
// Cummins-Pauli label: 24P3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.855

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 5, 14, 23], [3, 13, 10, 9], [5, 12, 18, 7], [9, 13, 16, 3], [19, 20, 2, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fs.1", "24.36.1.fy.1", "24.36.1.go.1"];
