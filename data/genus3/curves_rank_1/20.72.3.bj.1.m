...
// Magma code for modular curve with label 20.72.3.bj.1

// Other names and/or labels
// Cummins-Pauli label: 20G3
// Rouse-Sutherland-Zureick-Brown label: 20.72.3.63

// Group data
level := 20;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 8, 18, 3], [3, 15, 8, 19], [19, 4, 10, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.0.a.1", "20.36.1.h.1", "20.36.2.b.2"];
...
// Map from the embedded model to the plane model of modular curve with label 20.72.3.bj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
