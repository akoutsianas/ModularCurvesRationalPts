...
// Magma code for modular curve with label 24.72.3.yh.1

// Other names and/or labels
// Cummins-Pauli label: 12J3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.404

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 3, 0, 11], [9, 11, 20, 15], [13, 15, 18, 19], [23, 3, 0, 17], [23, 16, 20, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bz.1", "24.36.1.fb.1", "24.36.1.fx.1"];
