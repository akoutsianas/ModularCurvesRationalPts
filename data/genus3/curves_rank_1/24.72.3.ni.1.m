...
// Magma code for modular curve with label 24.72.3.ni.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.518

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 8, 16, 23], [5, 17, 10, 5], [7, 18, 6, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bj.1", "24.36.0.bd.1", "24.36.1.bu.1", "24.36.1.de.1", "24.36.2.ch.1", "24.36.2.du.1", "24.36.2.eg.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.ni.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(u);
