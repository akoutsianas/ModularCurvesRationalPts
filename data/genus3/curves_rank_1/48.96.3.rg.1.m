...
// Magma code for modular curve with label 48.96.3.rg.1

// Other names and/or labels
// Cummins-Pauli label: 16I3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.602

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 30, 46, 29], [21, 29, 38, 23], [39, 5, 38, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.bb.1", "24.48.1.lr.1", "48.48.0.cn.2", "48.48.1.ft.1", "48.48.2.by.2", "48.48.2.cs.1", "48.48.2.dq.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.rg.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.96.3.rg.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-3*w*t+3*t^2-3/2*u^2);
//   Coordinate number 1:
map_2_coord_1 := 1*(-36*y*t^3*u^4+36*y*t^2*u^5-9*y*t*u^6);
//   Coordinate number 2:
