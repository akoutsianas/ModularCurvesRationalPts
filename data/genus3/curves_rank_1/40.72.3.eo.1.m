...
// Magma code for modular curve with label 40.72.3.eo.1

// Other names and/or labels
// Cummins-Pauli label: 20G3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.245

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 23, 8, 39], [19, 34, 2, 11], [21, 7, 8, 25], [31, 30, 8, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.2.b.2", "40.36.0.b.1", "40.36.1.j.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.eo.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.72.3.eo.1
//   Coordinate number 0:
