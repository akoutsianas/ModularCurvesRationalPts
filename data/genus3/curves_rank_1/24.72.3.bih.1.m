...
// Magma code for modular curve with label 24.72.3.bih.1

// Other names and/or labels
// Cummins-Pauli label: 24I3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.758

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 7, 10, 1], [13, 3, 18, 5], [15, 17, 22, 9], [23, 13, 14, 11], [23, 14, 20, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.0.cg.1", "24.36.1.fe.1", "24.36.2.gk.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.bih.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.3.bih.1
//   Coordinate number 0:
map_2_coord_0 := 1*(u);
//   Coordinate number 1:
