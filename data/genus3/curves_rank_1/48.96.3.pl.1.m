...
// Magma code for modular curve with label 48.96.3.pl.1

// Other names and/or labels
// Cummins-Pauli label: 16I3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.1093

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 17, 4, 21], [13, 11, 0, 35], [23, 47, 18, 29], [29, 7, 0, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.bq.1", "24.48.1.hu.1", "48.48.0.cp.2", "48.48.1.et.1", "48.48.1.ez.1", "48.48.2.bo.1", "48.48.2.cl.1"];
...
model_1 := [-3*x^2+y^2+z^2,-189*x^4-540*x^3*z-126*x^2*z^2+324*x*z^3+147*z^4-w^2];
