...
// Magma code for modular curve with label 48.48.3.bl.1

// Other names and/or labels
// Cummins-Pauli label: 16B3
// Rouse-Sutherland-Zureick-Brown label: 48.48.3.205

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 22, 14, 15], [7, 7, 36, 41], [37, 14, 28, 21], [47, 6, 0, 35]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.2.b.1", "24.24.1.ek.1", "48.24.0.p.2"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.3.bl.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.3.bl.1
//   Coordinate number 0:
map_2_coord_0 := 1*(y);
//   Coordinate number 1:
