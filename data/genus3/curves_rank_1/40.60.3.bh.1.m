...
// Magma code for modular curve with label 40.60.3.bh.1

// Other names and/or labels
// Cummins-Pauli label: 10B3
// Rouse-Sutherland-Zureick-Brown label: 40.60.3.52

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 0, 35, 31], [18, 5, 39, 12], [34, 23, 5, 18]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["20.30.1.a.1", "40.30.0.b.1", "40.30.2.k.1"];
...
model_2 := [22*x^2-10*x*y-190*y^2+841*z^2,188500*x^4+653660*x^3*y+12845376*x^2*z^2+28855870*x*y*z^2+200328723*z^4-171475*w^2];
...
// Map from the embedded model to the plane model of modular curve with label 40.60.3.bh.1
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
