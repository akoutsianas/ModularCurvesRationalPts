...
// Magma code for modular curve with label 24.72.3.bfu.1

// Other names and/or labels
// Cummins-Pauli label: 24Q3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.821

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 15, 12, 19], [7, 8, 16, 7], [13, 11, 2, 11], [17, 21, 18, 11], [23, 13, 16, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fo.1", "24.36.1.gc.1", "24.36.1.gs.1"];
