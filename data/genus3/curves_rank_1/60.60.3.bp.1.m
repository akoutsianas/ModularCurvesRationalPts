...
// Magma code for modular curve with label 60.60.3.bp.1

// Other names and/or labels
// Cummins-Pauli label: 10B3
// Rouse-Sutherland-Zureick-Brown label: 60.60.3.15

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[23, 5, 35, 42], [45, 29, 56, 5], [55, 7, 4, 35]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["10.30.1.c.1", "60.30.0.b.1", "60.30.2.h.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.60.3.bp.1
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
