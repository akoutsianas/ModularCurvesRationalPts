...
// Magma code for modular curve with label 24.72.3.nf.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.594

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 14, 16, 13], [9, 17, 8, 15], [11, 2, 4, 23], [15, 20, 4, 9], [19, 15, 12, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.bb.1", "24.36.0.bc.1", "24.36.1.bt.1", "24.36.1.df.1", "24.36.1.en.1", "24.36.2.cf.1", "24.36.2.eg.1"];
...
model_2 := [2*x^2-2*x*y+2*y^2-z^2,-72*x^3*y-84*x^2*z^2+120*x*y*z^2+74*z^4-9*w^2];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.nf.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(u);
