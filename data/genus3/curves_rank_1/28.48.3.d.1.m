...
// Magma code for modular curve with label 28.48.3.d.1

// Other names and/or labels
// Cummins-Pauli label: 28C3
// Rouse-Sutherland-Zureick-Brown label: 28.48.3.2

// Group data
level := 28;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 17, 26, 11], [19, 9, 6, 9], [23, 14, 2, 13], [23, 15, 2, 9], [23, 22, 4, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
;// CM discriminants
CM_discs := [-7, -28];
// Modular curve is a fiber product of the following curvesfactors := ['4.6.0.e.1', '7.8.0.a.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["4.6.0.e.1", "14.24.1.a.1"];
...
// Weierstrass model
model_2 := [-3*x^6*z^2+x^4*y-4*x^4*z^4+x^2*y*z^2-3*x^2*z^6+y^2+y*z^4];
...
// Map from the embedded model to the plane model of modular curve with label 28.48.3.d.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 28.48.3.d.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-y);
//   Coordinate number 1:
map_2_coord_1 := 1*(-7*y^4-4*y^2*w^2-14*y^2*w*t-w^4);
//   Coordinate number 2:
map_2_coord_2 := 1*(w);
// Codomain equation:
map_2_codomain := [-3*x^6*z^2+x^4*y-4*x^4*z^4+x^2*y*z^2-3*x^2*z^6+y^2+y*z^4];
