...
// Magma code for modular curve with label 40.60.3.w.1

// Other names and/or labels
// Cummins-Pauli label: 10B3
// Rouse-Sutherland-Zureick-Brown label: 40.60.3.54

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 10, 11, 13], [17, 13, 5, 6], [34, 11, 15, 22], [39, 34, 22, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["20.30.2.d.1", "40.30.0.c.1", "40.30.1.a.1"];
...
model_2 := [2*x^2-2*x*y-2*y^2+z^2,200*x^4-350*x^3*y+130*x^2*z^2-60*x*y*z^2+4*z^4-25*w^2];
...
// Map from the embedded model to the plane model of modular curve with label 40.60.3.w.1
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
