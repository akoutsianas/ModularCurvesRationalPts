...
// Magma code for modular curve with label 48.96.3.hh.1

// Other names and/or labels
// Cummins-Pauli label: 8B3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.398

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 41, 20, 39], [13, 9, 14, 23], [47, 15, 40, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.0.n.1", "24.48.1.el.1", "48.48.1.dk.1", "48.48.1.dl.1", "48.48.2.m.1", "48.48.2.dc.1", "48.48.2.dd.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.hh.1
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.96.3.hh.1
//   Coordinate number 0:
