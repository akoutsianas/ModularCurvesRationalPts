...
// Magma code for modular curve with label 24.36.3.f.1

// Other names and/or labels
// Cummins-Pauli label: 24A3
// Rouse-Sutherland-Zureick-Brown label: 24.36.3.6

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 8, 4, 5], [5, 21, 18, 5], [7, 20, 8, 11], [13, 10, 16, 11], [21, 13, 2, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["12.18.0.k.1", "24.12.1.bx.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.36.3.f.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.36.3.f.1
//   Coordinate number 0:
