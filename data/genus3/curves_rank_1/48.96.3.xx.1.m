...
// Magma code for modular curve with label 48.96.3.xx.1

// Other names and/or labels
// Cummins-Pauli label: 16L3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.87

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 3, 16, 47], [3, 29, 28, 13], [19, 21, 4, 5], [47, 14, 30, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.bs.1", "48.48.1.gm.1", "48.48.1.ig.1"];
