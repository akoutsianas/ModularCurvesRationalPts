...
// Magma code for modular curve with label 24.96.3.ir.1

// Other names and/or labels
// Cummins-Pauli label: 8A3
// Rouse-Sutherland-Zureick-Brown label: 24.96.3.79

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 16, 4, 5], [11, 17, 2, 13], [23, 17, 16, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.bv.1", "24.48.1.md.1", "24.48.1.mg.1"];
