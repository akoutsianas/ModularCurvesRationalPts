...
// Magma code for modular curve with label 48.96.3.xg.1

// Other names and/or labels
// Cummins-Pauli label: 16L3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.279

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 23, 34, 7], [17, 0, 24, 1], [39, 16, 2, 13], [45, 28, 44, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.bu.1", "48.48.1.fx.1", "48.48.1.il.1"];
