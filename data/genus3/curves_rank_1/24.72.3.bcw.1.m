...
// Magma code for modular curve with label 24.72.3.bcw.1

// Other names and/or labels
// Cummins-Pauli label: 24Q3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.844

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 2, 10, 17], [11, 10, 10, 13], [13, 20, 2, 11], [15, 22, 14, 21], [23, 13, 14, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fq.1", "24.36.1.gc.1", "24.36.1.go.1"];
