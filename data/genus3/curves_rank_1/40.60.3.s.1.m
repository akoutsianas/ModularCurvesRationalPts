...
// Magma code for modular curve with label 40.60.3.s.1

// Other names and/or labels
// Cummins-Pauli label: 10B3
// Rouse-Sutherland-Zureick-Brown label: 40.60.3.26

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[6, 17, 23, 19], [7, 32, 1, 3], [21, 10, 30, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["10.30.1.b.1", "40.30.0.c.1", "40.30.2.e.1"];
...
model_2 := [2*x^2-2*x*y-2*y^2+z^2,100*x^4-175*x^3*y+65*x^2*z^2-30*x*y*z^2+2*z^4-25*w^2];
...
// Map from the embedded model to the plane model of modular curve with label 40.60.3.s.1
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
