...
// Magma code for modular curve with label 24.72.3.yc.1

// Other names and/or labels
// Cummins-Pauli label: 12J3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.463

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 14, 16, 1], [5, 20, 16, 17], [11, 0, 18, 1], [11, 17, 22, 17], [21, 2, 4, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bn.1", "24.36.1.fy.1", "24.36.1.ga.1"];
