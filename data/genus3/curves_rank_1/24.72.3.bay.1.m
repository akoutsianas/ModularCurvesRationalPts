...
// Magma code for modular curve with label 24.72.3.bay.1

// Other names and/or labels
// Cummins-Pauli label: 24O3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.880

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 6, 0, 13], [17, 4, 22, 19], [17, 7, 10, 19], [19, 6, 18, 1], [19, 9, 18, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fn.1", "24.36.1.gh.1", "24.36.1.gi.1"];
