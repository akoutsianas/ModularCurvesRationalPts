...
// Magma code for modular curve with label 48.72.3.bb.1

// Other names and/or labels
// Cummins-Pauli label: 48H3
// Rouse-Sutherland-Zureick-Brown label: 48.72.3.34

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 20, 44, 43], [7, 16, 40, 23], [17, 11, 34, 41], [17, 12, 12, 31], [29, 20, 4, 11], [39, 40, 28, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
// Map from the embedded model to the plane model of modular curve with label 48.72.3.bb.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.72.3.bb.1
//   Coordinate number 0:
map_2_coord_0 := 1*(z+w);
//   Coordinate number 1:
