...
// Magma code for modular curve with label 40.72.3.be.1

// Other names and/or labels
// Cummins-Pauli label: 20J3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.156

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 31, 24, 15], [17, 35, 18, 9], [23, 9, 32, 25], [23, 13, 0, 1], [27, 22, 4, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.1.a.1", "40.12.0.j.1", "40.36.1.h.1", "40.36.1.j.1"];
...
model_2 := [x^2+y^2+z^2,28*x^4-96*x^3*y-132*x^2*z^2+72*x*y*z^2-89*z^4-25*w^2];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.be.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(5*w);
