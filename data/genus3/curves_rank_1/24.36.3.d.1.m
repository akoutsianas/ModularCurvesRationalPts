...
// Magma code for modular curve with label 24.36.3.d.1

// Other names and/or labels
// Cummins-Pauli label: 24A3
// Rouse-Sutherland-Zureick-Brown label: 24.36.3.3

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 19, 8, 19], [3, 4, 8, 15], [5, 15, 0, 23], [17, 17, 4, 23], [19, 9, 18, 1], [23, 3, 12, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
;// CM discriminants
CM_discs := [-4];
// Modular curve is a fiber product of the following curvesfactors := ['3.3.0.a.1', '8.12.1.d.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["8.12.1.d.1", "12.18.0.l.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.36.3.d.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.36.3.d.1
//   Coordinate number 0:
