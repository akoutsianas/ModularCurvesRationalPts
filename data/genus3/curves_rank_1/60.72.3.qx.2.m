...
// Magma code for modular curve with label 60.72.3.qx.2

// Other names and/or labels
// Cummins-Pauli label: 20I3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.812

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[21, 50, 58, 7], [23, 45, 20, 7], [33, 10, 10, 41], [37, 55, 46, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.2.a.1", "60.36.0.c.1", "60.36.1.bf.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.qx.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.72.3.qx.2
//   Coordinate number 0:
map_2_coord_0 := 1*(1/2*y^2+1/2*y*t);
//   Coordinate number 1:
map_2_coord_1 := 1*(-45/8*y^7*u-45/4*y^5*t^2*u-25/8*y^3*t^4*u);
//   Coordinate number 2:
map_2_coord_2 := 1*(-1/2*y^2+1/2*y*t);
// Codomain equation:
