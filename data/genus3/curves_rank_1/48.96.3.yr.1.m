...
// Magma code for modular curve with label 48.96.3.yr.1

// Other names and/or labels
// Cummins-Pauli label: 16K3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.594

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 47, 8, 31], [23, 23, 10, 41], [33, 28, 22, 7], [41, 36, 8, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.co.1", "48.48.1.fk.1", "48.48.1.fl.1"];
