...
// Magma code for modular curve with label 60.72.3.ck.1

// Other names and/or labels
// Cummins-Pauli label: 20J3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.75

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 0, 30, 53], [13, 15, 48, 11], [17, 5, 18, 17], [31, 20, 32, 47], [39, 40, 20, 51]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['5.6.0.a.1', '12.12.0.c.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["12.12.0.c.1", "20.36.1.a.1", "60.36.1.w.1", "60.36.1.dq.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.ck.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
