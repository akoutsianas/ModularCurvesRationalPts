...
// Magma code for modular curve with label 40.72.3.r.1

// Other names and/or labels
// Cummins-Pauli label: 20J3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.23

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 1, 6, 33], [11, 11, 2, 25], [17, 35, 30, 7], [19, 8, 22, 25], [21, 17, 2, 11], [29, 10, 0, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['5.6.0.a.1', '8.12.0.f.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["8.12.0.f.1", "20.36.1.j.1", "40.36.1.a.1", "40.36.1.c.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.r.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.72.3.r.1
//   Coordinate number 0:
