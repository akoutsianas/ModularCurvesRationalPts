...
// Magma code for modular curve with label 24.72.3.jr.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.297

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 21, 18, 13], [13, 23, 16, 13], [17, 7, 2, 5], [19, 3, 0, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.g.1", "24.36.0.k.1", "24.36.1.cd.1", "24.36.1.ds.1", "24.36.2.bz.1", "24.36.2.cy.1", "24.36.2.fh.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.jr.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
