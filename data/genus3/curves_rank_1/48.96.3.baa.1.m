...
// Magma code for modular curve with label 48.96.3.baa.1

// Other names and/or labels
// Cummins-Pauli label: 16L3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.513

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 0, 22, 23], [23, 20, 28, 35], [25, 28, 24, 41], [35, 33, 36, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.df.1", "24.48.1.mh.1", "48.48.1.gp.1"];
