...
// Magma code for modular curve with label 60.72.3.bci.2

// Other names and/or labels
// Cummins-Pauli label: 30J3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.864

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 45, 45, 52], [27, 20, 43, 9], [43, 0, 54, 11], [59, 25, 38, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["30.36.0.e.2", "60.36.1.ds.1", "60.36.2.fv.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.bci.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.72.3.bci.2
//   Coordinate number 0:
map_2_coord_0 := 1*(-t);
//   Coordinate number 1:
