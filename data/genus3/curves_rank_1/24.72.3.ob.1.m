...
// Magma code for modular curve with label 24.72.3.ob.1

// Other names and/or labels
// Cummins-Pauli label: 24L3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.292

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 8, 16, 11], [5, 9, 0, 17], [9, 10, 8, 3], [13, 0, 12, 1], [15, 11, 16, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.i.1", "24.36.2.co.1", "24.36.2.cv.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.ob.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
