...
// Magma code for modular curve with label 24.72.3.lx.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.701

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 2, 16, 5], [15, 20, 2, 21], [15, 23, 10, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.bf.1", "24.36.0.s.1", "24.36.1.bm.1", "24.36.1.da.1", "24.36.1.eh.1", "24.36.2.ca.1", "24.36.2.dl.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.lx.1
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
map_1_coord_1 := 1*(4*z);
