...
// Magma code for modular curve with label 48.96.3.is.1

// Other names and/or labels
// Cummins-Pauli label: 8B3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.1057

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 21, 30, 29], [25, 11, 4, 39], [25, 31, 38, 39]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.m.2", "24.48.1.fh.1", "48.48.0.n.1", "48.48.1.ek.1", "48.48.1.el.1", "48.48.2.ec.1", "48.48.2.ed.1"];
...
model_2 := [x^2+y^2+z^2,28*x^4-64*x^3*z-64*x^2*y*z+28*x^2*z^2-196*x*y*z^2-160*x*z^3+96*y*z^3-119*z^4-6*w^2];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.is.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
