...
// Magma code for modular curve with label 24.72.3.bgo.1

// Other names and/or labels
// Cummins-Pauli label: 24P3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.123

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 23, 16, 7], [3, 2, 14, 21], [7, 1, 16, 5], [11, 0, 12, 19], [17, 14, 2, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bs.1", "24.36.1.fs.1", "24.36.1.gt.1"];
