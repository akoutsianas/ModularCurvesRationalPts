...
// Magma code for modular curve with label 40.72.3.k.1

// Other names and/or labels
// Cummins-Pauli label: 20I3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.201

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 23, 28, 5], [25, 1, 18, 33], [25, 17, 34, 23], [33, 16, 22, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.2.a.1", "40.36.0.d.1", "40.36.1.a.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.k.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.72.3.k.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-z*u);
//   Coordinate number 1:
