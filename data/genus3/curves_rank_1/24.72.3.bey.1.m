...
// Magma code for modular curve with label 24.72.3.bey.1

// Other names and/or labels
// Cummins-Pauli label: 24Q3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.418

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 0, 12, 1], [13, 21, 0, 19], [15, 20, 14, 9], [17, 2, 8, 1], [21, 13, 2, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bw.1", "24.36.1.gl.1", "24.36.1.gp.1"];
