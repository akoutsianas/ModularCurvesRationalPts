...
// Magma code for modular curve with label 48.96.3.zt.1

// Other names and/or labels
// Cummins-Pauli label: 16L3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.468

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 30, 18, 43], [21, 23, 32, 43], [35, 24, 28, 7], [43, 4, 24, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.da.1", "24.48.1.me.1", "48.48.1.gm.1"];
