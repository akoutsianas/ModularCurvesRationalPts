...
// Magma code for modular curve with label 48.96.3.ff.1

// Other names and/or labels
// Cummins-Pauli label: 16I3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.1085

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 3, 14, 19], [11, 45, 12, 13], [45, 46, 40, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.j.1", "24.48.1.fp.1", "48.48.0.t.2", "48.48.1.cu.1", "48.48.1.cw.1", "48.48.2.cn.1", "48.48.2.cp.1"];
...
model_2 := [-3*x^2+y^2+z^2,-1323*x^4+972*x^3*z+126*x^2*z^2-180*x*z^3+21*z^4-16*w^2];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.ff.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
