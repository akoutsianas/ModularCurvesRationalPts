...
// Magma code for modular curve with label 40.60.3.n.1

// Other names and/or labels
// Cummins-Pauli label: 10B3
// Rouse-Sutherland-Zureick-Brown label: 40.60.3.56

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[2, 17, 25, 28], [12, 25, 31, 23], [29, 38, 12, 1], [33, 32, 4, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["20.30.2.d.1", "40.30.0.b.1", "40.30.1.d.1"];
...
model_2 := [10*x^2-10*x*y-58*y^2+121*z^2,131450*x^4+308770*x^3*y+2545312*x^2*z^2+4103616*x*y*z^2+10667360*z^4-24389*w^2];
...
// Map from the embedded model to the plane model of modular curve with label 40.60.3.n.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(5*z);
