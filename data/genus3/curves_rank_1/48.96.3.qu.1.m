...
// Magma code for modular curve with label 48.96.3.qu.1

// Other names and/or labels
// Cummins-Pauli label: 16I3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.599

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 43, 4, 39], [19, 15, 16, 13], [27, 31, 26, 41]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.bb.1", "24.48.1.lf.1", "48.48.0.ch.2", "48.48.1.gl.1", "48.48.2.bx.1", "48.48.2.cp.1", "48.48.2.el.1"];
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.96.3.qu.1
//   Coordinate number 0:
map_1_coord_0 := 1*(2*y^2*t-y^2*u-1/3*t*u^2-1/6*u^3);
//   Coordinate number 1:
map_1_coord_1 := 1*(-192*x*y^10*t+192*x*y^10*u+96*x*y^8*u^3+64/3*x*y^6*t*u^4+32/3*x*y^6*u^5+16/9*x*y^4*t*u^6-16/9*x*y^4*u^7-4/9*x*y^2*t*u^8-4/9*x*y^2*u^9-4/81*x*t*u^10-2/81*x*u^11);
//   Coordinate number 2:
