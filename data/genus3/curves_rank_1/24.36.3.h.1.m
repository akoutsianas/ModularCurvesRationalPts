...
// Magma code for modular curve with label 24.36.3.h.1

// Other names and/or labels
// Cummins-Pauli label: 24A3
// Rouse-Sutherland-Zureick-Brown label: 24.36.3.8

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 5, 8, 7], [7, 13, 14, 1], [13, 14, 10, 19], [17, 23, 10, 11], [19, 10, 10, 17], [19, 22, 4, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
covers := ["12.18.0.l.1", "24.12.1.bz.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.36.3.h.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.36.3.h.1
//   Coordinate number 0:
