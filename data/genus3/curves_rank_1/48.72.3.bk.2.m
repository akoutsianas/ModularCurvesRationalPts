...
// Magma code for modular curve with label 48.72.3.bk.2

// Other names and/or labels
// Cummins-Pauli label: 48F3
// Rouse-Sutherland-Zureick-Brown label: 48.72.3.42

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 42, 0, 11], [23, 33, 6, 17], [31, 4, 32, 31], [45, 8, 34, 39], [47, 10, 28, 7], [47, 38, 46, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
// Map from the embedded model to the plane model of modular curve with label 48.72.3.bk.2
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.72.3.bk.2
//   Coordinate number 0:
map_2_coord_0 := 1*(-z);
//   Coordinate number 1:
