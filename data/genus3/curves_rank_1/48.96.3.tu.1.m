...
// Magma code for modular curve with label 48.96.3.tu.1

// Other names and/or labels
// Cummins-Pauli label: 16H3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.665

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 38, 32, 5], [17, 29, 28, 23], [25, 46, 22, 23], [45, 40, 32, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.bz.1", "24.48.1.lg.1", "48.48.1.gh.1"];
