...
// Magma code for modular curve with label 24.72.3.beu.1

// Other names and/or labels
// Cummins-Pauli label: 24Q3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.815

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 0, 0, 23], [7, 14, 16, 7], [9, 1, 2, 15], [11, 9, 18, 1], [13, 14, 2, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.ga.1", "24.36.1.gl.1", "24.36.1.go.1"];
