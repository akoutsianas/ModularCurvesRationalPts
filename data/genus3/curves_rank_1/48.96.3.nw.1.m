...
// Magma code for modular curve with label 48.96.3.nw.1

// Other names and/or labels
// Cummins-Pauli label: 8B3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.1164

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 18, 34, 7], [21, 25, 28, 19], [33, 40, 22, 31], [47, 37, 2, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.bl.1", "24.48.1.hm.1", "48.48.0.cc.1", "48.48.1.dl.1", "48.48.1.dp.1", "48.48.2.bn.1", "48.48.2.cd.1"];
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.96.3.nw.1
//   Coordinate number 0:
