...
// Magma code for modular curve with label 24.96.3.cz.1

// Other names and/or labels
// Cummins-Pauli label: 12K3
// Rouse-Sutherland-Zureick-Brown label: 24.96.3.471

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 23, 0, 19], [7, 8, 6, 13], [13, 19, 12, 23], [23, 8, 6, 5], [23, 22, 18, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["12.48.2.f.1", "24.24.0.s.1", "24.48.1.cu.1", "24.48.2.o.1"];
...
// Embedded model
model_0 := [2*x*y-y^2-2*z*w-2*w^2-t^2+3*z*u,z^2-z*w-3*x*t+2*y*t-t^2+z*u-w*u,4*x*y-2*y^2+z^2,3*z^2-2*t^2+3*z*u,3*x*z-2*y*z+6*x*w-4*y*w-z*t+t*u,6*x*z-4*y*z-6*x*w+4*y*w+2*z*t+2*w*t-t*u,18*x^2-2*x*y-3*y^2+3*z^2-2*z*w-2*w^2+t^2-u^2];
...
model_2 := [3*x^2-y^2-z^2,-756*x^4+432*x^3*y+420*x^2*z^2-156*x*y*z^2-35*z^4-18*w^2];
...
// Map from the embedded model to the plane model of modular curve with label 24.96.3.cz.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
