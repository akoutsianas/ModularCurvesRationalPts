...
// Magma code for modular curve with label 24.72.3.hp.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.94

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 14, 4, 3], [5, 16, 20, 5], [5, 19, 20, 11], [13, 17, 4, 19], [17, 23, 14, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.0.s.1", "24.36.1.o.1", "24.36.1.bg.1", "24.36.1.ey.1", "24.36.2.bg.1", "24.36.2.bv.1", "24.36.2.ds.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.hp.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.3.hp.1
//   Coordinate number 0:
