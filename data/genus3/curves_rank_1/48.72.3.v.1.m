...
// Magma code for modular curve with label 48.72.3.v.1

// Other names and/or labels
// Cummins-Pauli label: 48H3
// Rouse-Sutherland-Zureick-Brown label: 48.72.3.36

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 13, 38, 37], [3, 37, 22, 45], [9, 35, 26, 15], [21, 8, 4, 15], [25, 40, 28, 35], [43, 4, 8, 43]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
// Map from the embedded model to the plane model of modular curve with label 48.72.3.v.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.72.3.v.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-z+w);
//   Coordinate number 1:
