...
// Magma code for modular curve with label 24.72.3.zl.1

// Other names and/or labels
// Cummins-Pauli label: 24O3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.879

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 21, 12, 19], [11, 1, 14, 17], [15, 7, 8, 21], [17, 13, 22, 19], [19, 1, 16, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fk.1", "24.36.1.fr.1", "24.36.1.gh.1"];
