...
// Magma code for modular curve with label 24.72.3.bw.1

// Other names and/or labels
// Cummins-Pauli label: 12F3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.9

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 2, 14, 15], [3, 8, 8, 21], [13, 12, 0, 23], [13, 18, 0, 23], [19, 12, 12, 19], [21, 14, 14, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["6.36.1.b.1", "24.36.0.c.1", "24.36.2.ev.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.bw.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.3.bw.1
//   Coordinate number 0:
map_2_coord_0 := 1*(w);
//   Coordinate number 1:
map_2_coord_1 := 1*(-6*z^4-4*z^2*w^2-2*z^2*w*t);
//   Coordinate number 2:
map_2_coord_2 := 1*(z);
// Codomain equation:
