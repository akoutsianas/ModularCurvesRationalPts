...
// Magma code for modular curve with label 48.96.3.yt.1

// Other names and/or labels
// Cummins-Pauli label: 16K3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.592

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 33, 22, 43], [35, 3, 18, 29], [41, 22, 0, 5], [45, 13, 8, 35]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.co.1", "48.48.1.fm.1", "48.48.1.fp.1"];
