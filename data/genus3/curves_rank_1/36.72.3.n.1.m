...
// Magma code for modular curve with label 36.72.3.n.1

// Other names and/or labels
// Cummins-Pauli label: 18F3
// Rouse-Sutherland-Zureick-Brown label: 36.72.3.7

// Group data
level := 36;
// Elements that, together with Gamma(level), generate the group
gens := [[10, 33, 15, 2], [29, 18, 18, 5], [35, 21, 24, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["9.36.0.b.1", "12.24.1.d.1", "36.36.1.c.1", "36.36.2.c.1"];
...
// Map from the embedded model to the plane model of modular curve with label 36.72.3.n.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 36.72.3.n.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-w);
//   Coordinate number 1:
