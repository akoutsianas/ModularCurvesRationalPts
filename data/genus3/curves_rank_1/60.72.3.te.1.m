...
// Magma code for modular curve with label 60.72.3.te.1

// Other names and/or labels
// Cummins-Pauli label: 12D3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.232

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 20, 22, 21], [23, 36, 51, 43], [41, 18, 36, 25], [43, 6, 12, 53]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bh.1", "30.36.0.a.1", "60.36.2.dl.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.te.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
