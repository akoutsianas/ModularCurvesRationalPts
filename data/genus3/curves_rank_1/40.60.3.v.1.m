...
// Magma code for modular curve with label 40.60.3.v.1

// Other names and/or labels
// Cummins-Pauli label: 10B3
// Rouse-Sutherland-Zureick-Brown label: 40.60.3.51

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 6, 36, 15], [7, 0, 25, 17], [30, 33, 1, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["20.30.1.a.1", "40.30.0.d.1", "40.30.2.e.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.60.3.v.1
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
