...
// Magma code for modular curve with label 24.72.3.bgk.1

// Other names and/or labels
// Cummins-Pauli label: 24P3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.807

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 17, 14, 9], [7, 13, 22, 5], [11, 20, 20, 19], [13, 16, 22, 11], [23, 11, 2, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fs.1", "24.36.1.fw.1", "24.36.1.gs.1"];
