...
// Magma code for modular curve with label 60.60.3.bm.1

// Other names and/or labels
// Cummins-Pauli label: 10B3
// Rouse-Sutherland-Zureick-Brown label: 60.60.3.53

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[29, 5, 15, 38], [47, 15, 30, 31], [55, 24, 2, 35]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["20.30.0.b.1", "30.30.1.c.1", "60.30.2.h.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.60.3.bm.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.60.3.bm.1
//   Coordinate number 0:
