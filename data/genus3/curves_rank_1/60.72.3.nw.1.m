...
// Magma code for modular curve with label 60.72.3.nw.1

// Other names and/or labels
// Cummins-Pauli label: 12D3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.448

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[14, 1, 25, 46], [14, 19, 27, 58], [44, 51, 57, 32], [55, 14, 8, 47]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.bl.1", "60.36.0.a.1", "60.36.1.eu.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.nw.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
