...
// Magma code for modular curve with label 24.72.3.zq.1

// Other names and/or labels
// Cummins-Pauli label: 12I3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.163

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 5, 8, 21], [11, 0, 6, 1], [11, 21, 0, 1], [15, 14, 16, 15], [21, 7, 8, 3], [21, 20, 20, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
