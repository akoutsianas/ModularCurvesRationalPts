...
// Magma code for modular curve with label 40.72.3.bp.1

// Other names and/or labels
// Cummins-Pauli label: 20J3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.177

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 5, 30, 33], [23, 3, 2, 39], [31, 33, 4, 5], [35, 33, 22, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.1.g.1", "40.12.0.r.1", "40.36.1.c.1", "40.36.1.f.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.bp.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
