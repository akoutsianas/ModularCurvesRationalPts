...
// Magma code for modular curve with label 48.96.3.u.1

// Other names and/or labels
// Cummins-Pauli label: 8B3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.1007

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 18, 44, 1], [7, 42, 38, 17], [9, 22, 34, 31], [35, 8, 36, 43]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.b.1", "24.48.1.d.1", "48.48.0.b.1", "48.48.1.dp.1", "48.48.1.en.1", "48.48.2.cz.1", "48.48.2.dx.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.u.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
