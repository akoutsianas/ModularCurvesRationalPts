...
// Magma code for modular curve with label 24.72.3.qs.1

// Other names and/or labels
// Cummins-Pauli label: 12D3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.47

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 5, 16, 21], [3, 7, 14, 15], [3, 14, 14, 15], [17, 9, 6, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.0.a.1", "24.36.1.ei.1", "24.36.2.eu.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.qs.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
