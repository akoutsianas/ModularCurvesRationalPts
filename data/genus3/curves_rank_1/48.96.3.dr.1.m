...
// Magma code for modular curve with label 48.96.3.dr.1

// Other names and/or labels
// Cummins-Pauli label: 8B3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.1027

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 19, 32, 15], [39, 23, 10, 13], [45, 13, 10, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.f.1", "24.48.1.cn.1", "48.48.0.h.1", "48.48.1.ed.1", "48.48.1.ef.1", "48.48.2.cx.1", "48.48.2.cz.1"];
...
model_2 := [2*x^2-2*x*y+2*y^2-z^2,1836*x^3*y+3456*x^3*z-6912*x^2*y*z-8874*x^2*z^2+7956*x*y*z^2+7488*x*z^3-2880*y*z^3-2091*z^4-4*w^2];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.dr.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
