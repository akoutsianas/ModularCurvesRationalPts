...
// Magma code for modular curve with label 48.48.3.bv.2

// Other names and/or labels
// Cummins-Pauli label: 16F3
// Rouse-Sutherland-Zureick-Brown label: 48.48.3.167

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 40, 36, 47], [13, 25, 22, 21], [27, 19, 10, 15], [33, 26, 32, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.2.a.1", "24.24.0.em.2", "48.24.1.l.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.3.bv.2
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
