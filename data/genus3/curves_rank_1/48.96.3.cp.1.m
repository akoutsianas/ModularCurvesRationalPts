...
// Magma code for modular curve with label 48.96.3.cp.1

// Other names and/or labels
// Cummins-Pauli label: 16H3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.436

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 22, 16, 39], [13, 22, 0, 11], [19, 42, 0, 5], [41, 44, 2, 27], [47, 32, 4, 35]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.b.2", "24.48.1.bv.1", "48.48.1.b.2"];
