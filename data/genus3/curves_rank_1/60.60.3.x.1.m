...
// Magma code for modular curve with label 60.60.3.x.1

// Other names and/or labels
// Cummins-Pauli label: 10B3
// Rouse-Sutherland-Zureick-Brown label: 60.60.3.64

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 17, 9, 20], [30, 49, 1, 35], [35, 13, 8, 45]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["20.30.2.h.1", "30.30.1.b.1", "60.30.0.a.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.60.3.x.1
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
