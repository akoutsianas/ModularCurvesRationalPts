...
// Magma code for modular curve with label 40.96.3.cf.1

// Other names and/or labels
// Cummins-Pauli label: 8A3
// Rouse-Sutherland-Zureick-Brown label: 40.96.3.37

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 34, 14, 35], [21, 22, 30, 23], [31, 10, 3, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.bt.1", "40.48.1.jk.1", "40.48.1.kc.1"];
