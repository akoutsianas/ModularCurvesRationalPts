...
// Magma code for modular curve with label 36.72.3.d.1

// Other names and/or labels
// Cummins-Pauli label: 18F3
// Rouse-Sutherland-Zureick-Brown label: 36.72.3.6

// Group data
level := 36;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 33, 21, 2], [7, 21, 24, 1], [16, 9, 9, 20], [19, 15, 3, 10]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['4.2.0.a.1', '9.36.0.b.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["9.36.0.b.1", "12.24.1.b.1", "36.36.1.d.1", "36.36.2.a.1"];
...
// Map from the embedded model to the plane model of modular curve with label 36.72.3.d.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(9*w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 36.72.3.d.1
//   Coordinate number 0:
map_2_coord_0 := 1*(t);
//   Coordinate number 1:
