...
// Magma code for modular curve with label 48.96.3.ma.1

// Other names and/or labels
// Cummins-Pauli label: 16I3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.1144

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[27, 35, 14, 25], [33, 31, 14, 31], [35, 13, 0, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.v.1", "24.48.1.id.1", "48.48.0.co.1", "48.48.1.da.1", "48.48.1.dw.1", "48.48.2.bf.1", "48.48.2.bz.1"];
