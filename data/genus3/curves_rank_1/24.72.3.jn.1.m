...
// Magma code for modular curve with label 24.72.3.jn.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.658

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 6, 12, 7], [19, 19, 20, 1], [21, 19, 10, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.bm.1", "24.36.0.n.1", "24.36.1.bd.1", "24.36.1.bz.1", "24.36.1.ec.1", "24.36.2.bx.1", "24.36.2.cz.1"];
...
model_2 := [-2*x^2-2*x*y-2*y^2+z^2,-18*x^4-12*x^2*z^2-8*z^4-3*w^2];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.jn.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
