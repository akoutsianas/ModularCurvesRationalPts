...
// Magma code for modular curve with label 40.96.3.bo.1

// Other names and/or labels
// Cummins-Pauli label: 8A3
// Rouse-Sutherland-Zureick-Brown label: 40.96.3.35

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 3, 30, 1], [21, 22, 18, 27], [31, 33, 8, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.x.1", "40.48.1.kc.1", "40.48.1.kd.1"];
