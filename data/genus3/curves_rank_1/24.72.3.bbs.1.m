...
// Magma code for modular curve with label 24.72.3.bbs.1

// Other names and/or labels
// Cummins-Pauli label: 24I3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.258

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 20, 10, 1], [9, 20, 22, 3], [11, 5, 16, 17], [17, 13, 8, 23], [19, 2, 4, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bm.1", "24.36.0.cf.1", "24.36.2.gm.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.bbs.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.3.bbs.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-z);
//   Coordinate number 1:
map_2_coord_1 := 1*(13*y^4+9*y^2*z*t);
//   Coordinate number 2:
map_2_coord_2 := 1*(y);
// Codomain equation:
