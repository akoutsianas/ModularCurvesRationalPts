...
// Magma code for modular curve with label 16.48.3.bv.2

// Other names and/or labels
// Cummins-Pauli label: 16F3
// Rouse-Sutherland-Zureick-Brown label: 16.48.3.17

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 14, 8, 5], [15, 8, 0, 3], [15, 11, 10, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["8.24.0.bk.1", "16.24.1.l.1", "16.24.2.a.1"];
...
// Map from the embedded model to the plane model of modular curve with label 16.48.3.bv.2
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
