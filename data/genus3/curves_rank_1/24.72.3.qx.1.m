...
// Magma code for modular curve with label 24.72.3.qx.1

// Other names and/or labels
// Cummins-Pauli label: 12D3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.227

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 0, 18, 1], [7, 6, 0, 5], [9, 10, 20, 21], [19, 15, 18, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bi.1", "24.36.0.b.1", "24.36.2.ev.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.qx.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
