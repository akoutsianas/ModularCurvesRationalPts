...
// Magma code for modular curve with label 24.72.3.bil.1

// Other names and/or labels
// Cummins-Pauli label: 24I3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.757

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 8, 20, 21], [7, 23, 10, 13], [11, 8, 4, 17], [21, 17, 22, 3], [23, 14, 16, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.0.cg.1", "24.36.1.fh.1", "24.36.2.gk.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.bil.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.3.bil.1
//   Coordinate number 0:
map_2_coord_0 := 1*(u);
//   Coordinate number 1:
