...
// Magma code for modular curve with label 40.72.3.ct.2

// Other names and/or labels
// Cummins-Pauli label: 20H3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.40

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 15, 30, 17], [13, 8, 10, 11], [17, 14, 38, 33], [29, 33, 22, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["10.36.0.b.2", "40.36.1.d.1", "40.36.2.b.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.ct.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
