...
// Magma code for modular curve with label 56.42.3.c.1

// Other names and/or labels
// Cummins-Pauli label: 14A3
// Rouse-Sutherland-Zureick-Brown label: 56.42.3.4

// Group data
level := 56;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 44, 18, 33], [35, 37, 30, 27], [44, 21, 21, 30], [51, 38, 24, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 42;
...
// Map from the embedded model to the plane model of modular curve with label 56.42.3.c.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 56.42.3.c.1
//   Coordinate number 0:
