...
// Magma code for modular curve with label 24.72.3.dj.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.523

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 9, 6, 1], [7, 20, 22, 7], [9, 13, 2, 15], [23, 8, 22, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bf.1", "24.36.0.ba.1", "24.36.1.f.1", "24.36.1.cm.1", "24.36.2.p.1", "24.36.2.v.1", "24.36.2.fj.1"];
...
model_2 := [x^2+y^2+z^2,11*x^4+36*x^3*y+4*x^3*z-104*x^2*y*z-52*x^2*z^2+40*x*y*z^2+40*x*z^3-52*z^4-27*w^2];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.dj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(u);
