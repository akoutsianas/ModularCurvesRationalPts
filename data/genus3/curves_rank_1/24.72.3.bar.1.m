...
// Magma code for modular curve with label 24.72.3.bar.1

// Other names and/or labels
// Cummins-Pauli label: 24N3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.167

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 15, 0, 19], [3, 5, 2, 21], [3, 22, 20, 3], [5, 3, 6, 7], [7, 15, 18, 1], [21, 11, 22, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
