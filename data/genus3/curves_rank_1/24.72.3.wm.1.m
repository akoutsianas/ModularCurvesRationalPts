...
// Magma code for modular curve with label 24.72.3.wm.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.604

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[15, 2, 4, 9], [19, 19, 4, 11], [19, 22, 14, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.bt.1", "24.36.0.ca.1", "24.36.1.df.1", "24.36.1.dp.1", "24.36.1.fm.1", "24.36.2.fg.1", "24.36.2.ge.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.wm.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
