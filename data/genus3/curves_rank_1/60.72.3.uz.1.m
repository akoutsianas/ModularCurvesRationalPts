...
// Magma code for modular curve with label 60.72.3.uz.1

// Other names and/or labels
// Cummins-Pauli label: 12D3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.195

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 18, 18, 25], [4, 35, 27, 44], [13, 50, 18, 29], [28, 3, 41, 44], [38, 55, 33, 46]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bq.1", "60.36.0.a.1", "60.36.2.dl.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.uz.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*w);
