...
// Magma code for modular curve with label 48.48.3.dl.1

// Other names and/or labels
// Cummins-Pauli label: 16D3
// Rouse-Sutherland-Zureick-Brown label: 48.48.3.112

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[27, 29, 46, 33], [35, 32, 12, 29], [37, 21, 6, 17], [43, 28, 40, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.1.i.1", "24.24.1.ef.1", "48.24.1.j.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.3.dl.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.3.dl.1
//   Coordinate number 0:
