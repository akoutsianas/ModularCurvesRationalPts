...
// Magma code for modular curve with label 24.96.3.dc.1

// Other names and/or labels
// Cummins-Pauli label: 8A3
// Rouse-Sutherland-Zureick-Brown label: 24.96.3.71

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 19, 14, 13], [13, 11, 16, 19], [15, 20, 8, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.x.1", "24.48.1.me.1", "24.48.1.mf.1"];
