...
// Magma code for modular curve with label 24.72.3.gj.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.713

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 5, 14, 23], [7, 0, 0, 7], [19, 2, 2, 11], [19, 13, 10, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.n.1", "24.36.0.k.1", "24.36.1.p.1", "24.36.1.dl.1", "24.36.1.eh.1", "24.36.2.bb.1", "24.36.2.em.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.gj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
