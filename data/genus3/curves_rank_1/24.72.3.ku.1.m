...
// Magma code for modular curve with label 24.72.3.ku.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.719

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 1, 8, 5], [7, 20, 8, 17], [7, 22, 8, 13], [15, 10, 4, 3], [19, 4, 4, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.w.1", "24.36.0.m.1", "24.36.1.be.1", "24.36.1.ce.1", "24.36.1.dz.1", "24.36.2.cf.1", "24.36.2.fd.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.ku.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
