...
// Magma code for modular curve with label 48.96.3.we.1

// Other names and/or labels
// Cummins-Pauli label: 16L3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.488

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 31, 18, 31], [1, 43, 22, 15], [35, 16, 18, 25], [43, 29, 2, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.bf.1", "24.48.1.mh.1", "48.48.1.ih.1"];
