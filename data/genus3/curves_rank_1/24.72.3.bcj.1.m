...
// Magma code for modular curve with label 24.72.3.bcj.1

// Other names and/or labels
// Cummins-Pauli label: 24I3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.786

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 14, 10, 19], [7, 23, 16, 1], [15, 14, 2, 9], [17, 3, 0, 19], [21, 13, 8, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.0.cf.1", "24.36.1.fk.1", "24.36.2.gj.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.bcj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.3.bcj.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-z);
//   Coordinate number 1:
