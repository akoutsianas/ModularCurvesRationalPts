...
// Magma code for modular curve with label 24.72.3.o.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.622

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 6, 6, 7], [1, 10, 4, 23], [5, 10, 4, 1], [13, 0, 12, 11], [19, 0, 0, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.f.1", "24.36.0.bb.1", "24.36.1.a.1", "24.36.1.ck.1", "24.36.1.dz.1", "24.36.2.c.1", "24.36.2.fm.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.o.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
