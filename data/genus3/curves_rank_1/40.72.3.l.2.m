...
// Magma code for modular curve with label 40.72.3.l.2

// Other names and/or labels
// Cummins-Pauli label: 20I3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.240

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 1, 24, 9], [19, 15, 18, 1], [25, 21, 14, 37], [37, 22, 0, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.2.b.2", "40.36.0.c.2", "40.36.1.a.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.l.2
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.72.3.l.2
//   Coordinate number 0:
map_2_coord_0 := 1*(w*u);
//   Coordinate number 1:
