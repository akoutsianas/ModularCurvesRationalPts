...
// Magma code for modular curve with label 60.72.3.qx.1

// Other names and/or labels
// Cummins-Pauli label: 20I3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.825

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 55, 46, 11], [19, 5, 4, 27], [29, 25, 28, 31], [49, 40, 42, 59]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.2.a.2", "60.36.0.c.2", "60.36.1.bf.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.qx.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.72.3.qx.1
//   Coordinate number 0:
map_2_coord_0 := 1*(1/2*y^2+1/10*y*u);
//   Coordinate number 1:
map_2_coord_1 := 1*(-9/8*y^7*t-3/100*y^5*t*u^2-1/1000*y^3*t*u^4);
//   Coordinate number 2:
