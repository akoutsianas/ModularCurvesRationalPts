...
// Magma code for modular curve with label 48.96.3.mr.1

// Other names and/or labels
// Cummins-Pauli label: 8B3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.1184

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 5, 16, 43], [7, 43, 6, 25], [29, 26, 12, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.be.1", "24.48.1.ge.1", "48.48.0.cd.2", "48.48.1.ek.1", "48.48.1.eo.1", "48.48.2.u.1", "48.48.2.cc.2"];
...
model_1 := [x^2+y^2+z^2,-392*x^4-352*x^3*z+352*x^2*y*z-392*x^2*z^2+280*x*y*z^2-208*x*z^3+144*y*z^3-14*z^4-3*w^2];
