...
// Magma code for modular curve with label 48.96.3.mc.1

// Other names and/or labels
// Cummins-Pauli label: 16I3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.1140

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 34, 14, 41], [37, 11, 38, 11], [41, 6, 20, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.x.1", "24.48.1.id.1", "48.48.0.cp.2", "48.48.1.cy.1", "48.48.1.dy.1", "48.48.2.bd.1", "48.48.2.bz.2"];
