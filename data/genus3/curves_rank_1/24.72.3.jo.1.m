...
// Magma code for modular curve with label 24.72.3.jo.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.521

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 16, 22, 11], [17, 8, 10, 5], [17, 10, 10, 7], [23, 5, 16, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bf.1", "24.36.0.o.1", "24.36.1.bc.1", "24.36.1.ca.1", "24.36.2.by.1", "24.36.2.cz.1", "24.36.2.ex.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.jo.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
