...
// Magma code for modular curve with label 40.72.3.x.1

// Other names and/or labels
// Cummins-Pauli label: 20J3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.180

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 37, 18, 19], [21, 35, 4, 27], [23, 26, 32, 17], [31, 22, 4, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.1.g.1", "40.12.0.i.1", "40.36.1.b.1", "40.36.1.g.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.x.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(5*w);
