...
// Magma code for modular curve with label 48.48.3.bw.2

// Other names and/or labels
// Cummins-Pauli label: 16F3
// Rouse-Sutherland-Zureick-Brown label: 48.48.3.173

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[21, 32, 16, 25], [23, 24, 36, 37], [37, 43, 26, 45], [43, 45, 38, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.2.a.2", "24.24.0.en.2", "48.24.1.l.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.3.bw.2
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
