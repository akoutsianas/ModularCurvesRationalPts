...
// Magma code for modular curve with label 24.72.3.hm.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.283

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 7, 8, 17], [5, 8, 16, 11], [15, 10, 20, 9], [19, 5, 16, 7], [23, 4, 8, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['3.6.0.a.1', '8.12.0.k.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["12.36.1.i.1", "24.36.0.bw.1", "24.36.1.n.1", "24.36.1.ew.1", "24.36.2.bg.1", "24.36.2.bu.1", "24.36.2.dq.1"];
...
model_2 := [x^2+y^2+z^2,13*x^4-12*x^3*y+20*x^3*z+32*x^2*y*z+4*x^2*z^2+8*x*y*z^2+8*x*z^3+4*z^4-9*w^2];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.hm.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(u);
