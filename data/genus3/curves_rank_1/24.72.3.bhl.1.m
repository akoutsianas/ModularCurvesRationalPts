...
// Magma code for modular curve with label 24.72.3.bhl.1

// Other names and/or labels
// Cummins-Pauli label: 24P3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.800

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 6, 6, 11], [7, 14, 22, 13], [15, 20, 10, 21], [21, 11, 22, 15], [23, 1, 2, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fx.1", "24.36.1.gh.1", "24.36.1.gs.1"];
