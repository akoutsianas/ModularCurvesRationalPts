...
// Magma code for modular curve with label 32.48.3.d.1

// Other names and/or labels
// Cummins-Pauli label: 32C3
// Rouse-Zureick-Brown label: X430
// Rouse-Sutherland-Zureick-Brown label: 32.48.3.7

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 17, 0, 3], [3, 7, 16, 21], [5, 25, 16, 3], [13, 15, 16, 15], [15, 9, 24, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
// Map from the embedded model to the plane model of modular curve with label 32.48.3.d.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(8*z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 32.48.3.d.1
//   Coordinate number 0:
map_2_coord_0 := 1*(t);
//   Coordinate number 1:
