...
// Magma code for modular curve with label 48.96.3.v.1

// Other names and/or labels
// Cummins-Pauli label: 8B3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.348

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 44, 10, 43], [19, 40, 24, 19], [29, 38, 32, 25], [33, 8, 20, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.0.b.1", "24.48.1.d.1", "48.48.1.dq.1", "48.48.1.eo.1", "48.48.2.a.1", "48.48.2.da.1", "48.48.2.dy.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.v.1
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
