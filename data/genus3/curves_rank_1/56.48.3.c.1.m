...
// Magma code for modular curve with label 56.48.3.c.1

// Other names and/or labels
// Cummins-Pauli label: 28C3
// Rouse-Sutherland-Zureick-Brown label: 56.48.3.2

// Group data
level := 56;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 4, 30, 31], [3, 29, 6, 53], [3, 46, 28, 51], [13, 9, 18, 25], [39, 27, 0, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['7.8.0.a.1', '8.6.0.e.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["8.6.0.e.1", "14.24.1.a.1"];
...
// Map from the embedded model to the plane model of modular curve with label 56.48.3.c.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 56.48.3.c.1
//   Coordinate number 0:
map_2_coord_0 := 1*(w);
//   Coordinate number 1:
map_2_coord_1 := 1*(-2*y^4-7*y^2*w^2-28*y*w^2*t-7*w^4);
//   Coordinate number 2:
map_2_coord_2 := 1*(y);
// Codomain equation:
