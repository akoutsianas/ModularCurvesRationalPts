...
// Magma code for modular curve with label 24.72.3.bad.1

// Other names and/or labels
// Cummins-Pauli label: 24O3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.881

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 21, 0, 7], [9, 19, 22, 3], [11, 7, 20, 17], [15, 14, 20, 15], [19, 10, 2, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fk.1", "24.36.1.ft.1", "24.36.1.gj.1"];
