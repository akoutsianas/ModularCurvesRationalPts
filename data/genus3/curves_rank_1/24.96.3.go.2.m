...
// Magma code for modular curve with label 24.96.3.go.2

// Other names and/or labels
// Cummins-Pauli label: 24W3
// Rouse-Sutherland-Zureick-Brown label: 24.96.3.615

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 6, 0, 23], [5, 15, 0, 23], [5, 21, 8, 19], [11, 21, 20, 17], [19, 15, 16, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.48.0.bu.1", "24.48.1.is.1", "24.48.2.f.2"];
...
// Map from the embedded model to the plane model of modular curve with label 24.96.3.go.2
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.96.3.go.2
//   Coordinate number 0:
map_2_coord_0 := 1*(t);
//   Coordinate number 1:
