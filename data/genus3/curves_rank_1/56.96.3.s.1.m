...
// Magma code for modular curve with label 56.96.3.s.1

// Other names and/or labels
// Cummins-Pauli label: 8B3
// Rouse-Sutherland-Zureick-Brown label: 56.96.3.53

// Group data
level := 56;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 24, 36, 41], [13, 4, 36, 1], [13, 40, 0, 43], [27, 44, 16, 11], [45, 52, 16, 47]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.2.a.1", "56.48.0.c.1", "56.48.1.n.1"];
...
// Map from the embedded model to the plane model of modular curve with label 56.96.3.s.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
