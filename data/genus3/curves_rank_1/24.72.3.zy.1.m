...
// Magma code for modular curve with label 24.72.3.zy.1

// Other names and/or labels
// Cummins-Pauli label: 12J3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.341

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 21, 0, 1], [13, 1, 10, 11], [19, 13, 2, 13], [21, 14, 2, 3], [21, 19, 4, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bv.1", "24.36.1.fk.1", "24.36.1.gc.1"];
