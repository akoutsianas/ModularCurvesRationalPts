...
// Magma code for modular curve with label 40.60.3.p.1

// Other names and/or labels
// Cummins-Pauli label: 10B3
// Rouse-Sutherland-Zureick-Brown label: 40.60.3.24

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[4, 29, 7, 6], [7, 28, 21, 23], [11, 27, 38, 39]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["10.30.1.c.1", "40.30.0.b.1", "40.30.2.f.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.60.3.p.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
