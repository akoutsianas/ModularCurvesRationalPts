...
// Magma code for modular curve with label 40.72.3.j.1

// Other names and/or labels
// Cummins-Pauli label: 20J3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.171

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 21, 2, 19], [11, 23, 34, 15], [13, 1, 32, 27], [31, 2, 22, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.1.f.1", "40.12.0.d.1", "40.36.1.a.1", "40.36.1.i.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.j.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
