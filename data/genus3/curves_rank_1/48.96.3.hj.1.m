...
// Magma code for modular curve with label 48.96.3.hj.1

// Other names and/or labels
// Cummins-Pauli label: 8B3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.1058

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 44, 46, 37], [37, 29, 4, 19], [43, 12, 28, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.m.2", "24.48.1.el.1", "48.48.0.o.1", "48.48.1.do.1", "48.48.1.dp.1", "48.48.2.dg.1", "48.48.2.dh.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.hj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.96.3.hj.1
//   Coordinate number 0:
