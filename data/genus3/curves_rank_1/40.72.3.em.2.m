...
// Magma code for modular curve with label 40.72.3.em.2

// Other names and/or labels
// Cummins-Pauli label: 20G3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.165

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[21, 35, 18, 13], [25, 19, 24, 35], [35, 34, 8, 1], [39, 19, 12, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.1.h.1", "40.36.0.a.2", "40.36.2.a.2"];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.em.2
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*z);
