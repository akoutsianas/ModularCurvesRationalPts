...
// Magma code for modular curve with label 48.96.3.dl.1

// Other names and/or labels
// Cummins-Pauli label: 8B3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.1028

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[23, 31, 38, 17], [27, 17, 8, 13], [43, 44, 28, 43]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.f.1", "24.48.1.cl.1", "48.48.0.h.2", "48.48.1.df.1", "48.48.1.dh.1", "48.48.2.dv.1", "48.48.2.dx.1"];
...
model_2 := [3*x^2-y^2-z^2,12852*x^4-7344*x^3*y-15552*x^3*z+8640*x^2*y*z+4284*x^2*z^2-3060*x*y*z^2+864*x*z^3+288*y*z^3-357*z^4-w^2];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.dl.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
