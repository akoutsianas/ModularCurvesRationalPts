...
// Magma code for modular curve with label 24.72.3.wt.1

// Other names and/or labels
// Cummins-Pauli label: 24O3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.794

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 2, 14, 9], [13, 5, 10, 7], [13, 14, 2, 23], [17, 0, 18, 11], [17, 13, 16, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.ey.1", "24.36.1.fp.1", "24.36.1.gh.1"];
