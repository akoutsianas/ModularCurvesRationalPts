...
// Magma code for modular curve with label 36.72.3.o.1

// Other names and/or labels
// Cummins-Pauli label: 18F3
// Rouse-Sutherland-Zureick-Brown label: 36.72.3.31

// Group data
level := 36;
// Elements that, together with Gamma(level), generate the group
gens := [[2, 27, 15, 16], [11, 33, 18, 7], [21, 29, 25, 0]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.24.1.e.1", "18.36.2.b.1", "36.36.0.a.1", "36.36.1.c.1"];
...
// Embedded model
model_0 := [y*w-x*t-x*u-w*u,x^2+y^2-x*w-y*t-t*u-2*u^2,x^2+y^2+2*x*w+2*y*t+2*t*u,3*x*y+x*u-w*u,x^2-2*y^2-x*w-y*t+2*y*u,x^2+3*z^2-x*w+y*u-u^2,x^2+y^2+3*x*w-w^2-3*y*t-t^2-2*y*u];
...
// Map from the embedded model to the plane model of modular curve with label 36.72.3.o.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
