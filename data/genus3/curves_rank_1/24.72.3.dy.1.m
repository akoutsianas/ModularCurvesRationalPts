...
// Magma code for modular curve with label 24.72.3.dy.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.60

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 13, 8, 13], [1, 18, 6, 23], [21, 8, 14, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.0.e.1", "24.36.1.j.1", "24.36.1.do.1", "24.36.1.ej.1", "24.36.2.s.1", "24.36.2.u.1", "24.36.2.et.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.dy.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(u);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.3.dy.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-t);
//   Coordinate number 1:
