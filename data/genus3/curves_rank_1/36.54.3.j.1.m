...
// Magma code for modular curve with label 36.54.3.j.1

// Other names and/or labels
// Cummins-Pauli label: 36E3
// Rouse-Sutherland-Zureick-Brown label: 36.54.3.7

// Group data
level := 36;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 20, 20, 31], [21, 10, 28, 21], [27, 7, 28, 9], [29, 4, 2, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 54;
...
covers := ["12.18.1.i.1", "18.27.1.a.1"];
...
// Weierstrass model
model_2 := [-2*x^6*z^2+x^4*y-8*x^4*z^4+x^2*y*z^2-6*x^2*z^6+y^2+12*z^8];
...
// Map from the embedded model to the plane model of modular curve with label 36.54.3.j.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 36.54.3.j.1
//   Coordinate number 0:
map_2_coord_0 := 1*(z);
//   Coordinate number 1:
map_2_coord_1 := 1*(-2*y^4+y^3*t-3*y^2*z^2-z^4);
//   Coordinate number 2:
map_2_coord_2 := 1*(y);
// Codomain equation:
map_2_codomain := [-2*x^6*z^2+x^4*y-8*x^4*z^4+x^2*y*z^2-6*x^2*z^6+y^2+12*z^8];
