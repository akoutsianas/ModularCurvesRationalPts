...
// Magma code for modular curve with label 40.72.3.en.2

// Other names and/or labels
// Cummins-Pauli label: 20G3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.87

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 34, 8, 1], [13, 3, 24, 17], [31, 2, 8, 25], [33, 38, 26, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.0.a.2", "40.36.1.j.1", "40.36.2.b.2"];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.en.2
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
