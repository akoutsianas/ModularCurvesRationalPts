...
// Magma code for modular curve with label 40.72.3.ex.1

// Other names and/or labels
// Cummins-Pauli label: 20G3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.219

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 21, 34, 39], [17, 9, 8, 3], [21, 31, 30, 37], [25, 32, 24, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.2.a.2", "40.36.0.a.2", "40.36.1.l.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.ex.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
