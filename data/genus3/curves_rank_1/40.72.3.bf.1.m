...
// Magma code for modular curve with label 40.72.3.bf.1

// Other names and/or labels
// Cummins-Pauli label: 20J3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.172

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 27, 26, 31], [7, 34, 28, 33], [27, 0, 24, 13], [31, 25, 32, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.1.f.1", "40.12.0.k.1", "40.36.1.b.1", "40.36.1.j.1"];
...
model_2 := [2*x^2-2*x*y-2*y^2-z^2,200*x^4-300*x^3*y-30*x^2*z^2-20*x*y*z^2-19*z^4-25*w^2];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.bf.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
