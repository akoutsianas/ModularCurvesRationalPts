...
// Magma code for modular curve with label 48.96.3.qt.1

// Other names and/or labels
// Cummins-Pauli label: 16I3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.636

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[15, 7, 4, 41], [15, 40, 22, 17], [25, 12, 16, 25], [29, 42, 12, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.ba.1", "24.48.1.le.1", "48.48.0.ch.1", "48.48.1.gk.1", "48.48.2.bx.2", "48.48.2.co.1", "48.48.2.ek.1"];
