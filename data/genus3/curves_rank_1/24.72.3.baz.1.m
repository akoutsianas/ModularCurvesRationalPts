...
// Magma code for modular curve with label 24.72.3.baz.1

// Other names and/or labels
// Cummins-Pauli label: 24O3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.873

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 13, 8, 19], [7, 2, 22, 1], [15, 10, 8, 15], [17, 16, 4, 13], [23, 1, 4, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fn.1", "24.36.1.gg.1", "24.36.1.gj.1"];
