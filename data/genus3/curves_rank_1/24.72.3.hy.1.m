...
// Magma code for modular curve with label 24.72.3.hy.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.177

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 6, 18, 19], [7, 21, 6, 13], [13, 9, 0, 23], [15, 10, 14, 21], [15, 22, 8, 15], [23, 18, 12, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['3.6.0.b.1', '8.12.0.l.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["12.36.1.bq.1", "24.36.0.bm.1", "24.36.1.q.1", "24.36.1.br.1", "24.36.2.bi.1", "24.36.2.bv.1", "24.36.2.df.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.hy.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.3.hy.1
//   Coordinate number 0:
