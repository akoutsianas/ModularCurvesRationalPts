...
// Magma code for modular curve with label 60.60.3.t.1

// Other names and/or labels
// Cummins-Pauli label: 10B3
// Rouse-Sutherland-Zureick-Brown label: 60.60.3.39

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 39, 37, 10], [19, 35, 30, 7], [35, 21, 9, 40]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["15.30.0.a.1", "20.30.1.b.1", "60.30.2.d.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.60.3.t.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
