...
// Magma code for modular curve with label 48.96.3.ps.1

// Other names and/or labels
// Cummins-Pauli label: 16I3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.1148

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[31, 1, 34, 41], [41, 36, 46, 19], [45, 17, 4, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.bt.1", "24.48.1.id.1", "48.48.0.co.2", "48.48.1.eu.1", "48.48.1.fe.1", "48.48.2.bv.1", "48.48.2.cl.2"];
