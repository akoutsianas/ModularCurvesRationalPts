...
// Magma code for modular curve with label 24.72.3.bib.1

// Other names and/or labels
// Cummins-Pauli label: 24Q3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.812

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 2, 4, 23], [21, 17, 10, 3], [23, 18, 6, 17], [23, 18, 18, 13], [23, 21, 6, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.gd.1", "24.36.1.gl.1", "24.36.1.gs.1"];
