...
// Magma code for modular curve with label 24.48.3.ch.1

// Other names and/or labels
// Cummins-Pauli label: 12C3
// Rouse-Sutherland-Zureick-Brown label: 24.48.3.16

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[10, 1, 1, 14], [12, 1, 7, 12], [21, 13, 5, 0]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["12.24.0.r.1", "24.12.1.bv.1", "24.24.1.ex.1", "24.24.2.d.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.48.3.ch.1
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.48.3.ch.1
//   Coordinate number 0:
map_2_coord_0 := 1*(5/21*y^3-3/7*y^2*w-2/7*y^2*t+13/84*y*w^2+2/21*y*w*t-1/56*w^3-1/84*w^2*t);
//   Coordinate number 1:
map_2_coord_1 := 1*(32/7203*y^11*u-1564/64827*y^10*w*u-452/64827*y^10*t*u+1564/27783*y^9*w^2*u+5084/194481*y^9*w*t*u-1633/21609*y^8*w^3*u-1879/43218*y^8*w^2*t*u+2827/43218*y^7*w^4*u+913/21609*y^7*w^3*t*u-40001/1037232*y^6*w^5*u-13793/518616*y^6*w^4*t*u+5491/345744*y^5*w^6*u+1963/172872*y^5*w^5*t*u-907/197568*y^4*w^7*u-2311/691488*y^4*w^6*t*u+17/18522*y^3*w^8*u+349/518616*y^3*w^7*t*u-673/5531904*y^2*w^9*u-247/2765952*y^2*w^8*t*u+23/2370816*y*w^10*u+59/8297856*y*w^9*t*u-71/199148544*w^11*u-13/49787136*w^10*t*u);
//   Coordinate number 2:
map_2_coord_2 := 1*(1/21*y^3+1/28*y^2*w+1/7*y^2*t-1/42*y*w^2-1/21*y*w*t+1/168*w^3+1/168*w^2*t);
// Codomain equation:
