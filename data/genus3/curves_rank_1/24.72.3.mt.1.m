...
// Magma code for modular curve with label 24.72.3.mt.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.19

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 10, 2, 9], [5, 6, 12, 23], [9, 23, 8, 3], [21, 23, 2, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["6.36.1.d.1", "24.36.0.w.1", "24.36.1.br.1", "24.36.1.ei.1", "24.36.2.cd.1", "24.36.2.dv.1", "24.36.2.dz.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.mt.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*w);
