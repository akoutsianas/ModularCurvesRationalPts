...
// Magma code for modular curve with label 40.72.3.bl.1

// Other names and/or labels
// Cummins-Pauli label: 20J3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.49

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 27, 30, 9], [17, 39, 24, 17], [29, 4, 36, 37], [31, 38, 32, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["10.36.1.b.1", "40.12.0.n.1", "40.36.1.c.1", "40.36.1.j.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.bl.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*u);
