...
// Magma code for modular curve with label 60.72.3.bbv.2

// Other names and/or labels
// Cummins-Pauli label: 30J3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.873

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 10, 41, 7], [13, 25, 47, 28], [27, 40, 59, 3], [47, 50, 14, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["30.36.2.b.2", "60.36.0.cg.2", "60.36.1.do.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.bbv.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.72.3.bbv.2
//   Coordinate number 0:
map_2_coord_0 := 1*(-z);
//   Coordinate number 1:
