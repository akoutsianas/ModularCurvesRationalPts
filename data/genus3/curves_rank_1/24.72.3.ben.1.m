...
// Magma code for modular curve with label 24.72.3.ben.1

// Other names and/or labels
// Cummins-Pauli label: 24Q3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.839

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 10, 2, 7], [7, 1, 16, 17], [7, 8, 10, 1], [13, 5, 22, 19], [19, 10, 22, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.gd.1", "24.36.1.gj.1", "24.36.1.go.1"];
