...
// Magma code for modular curve with label 48.96.3.vz.1

// Other names and/or labels
// Cummins-Pauli label: 16I3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.447

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 46, 34, 3], [25, 31, 8, 7], [37, 13, 30, 11], [41, 13, 14, 47]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.cg.1", "24.48.1.mc.1", "48.48.0.cp.1", "48.48.1.gm.1", "48.48.2.cl.2", "48.48.2.ep.1", "48.48.2.ev.1"];
...
// Embedded model
model_0 := [x^2-y^2+z*u,x^2-2*x*y+y^2-2*w^2-2*t^2,3*x*z+3*y*z+x*u-y*u+t*u,x^2+4*x*y+y^2-w^2,2*x*z-2*y*z-2*z*t+x*u+y*u,x^2-2*x*y+y^2-3*z^2+x*t-y*t,x^2-2*x*y+y^2+2*w^2-2*x*t+2*y*t+2*t^2-u^2];
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.96.3.vz.1
//   Coordinate number 0:
