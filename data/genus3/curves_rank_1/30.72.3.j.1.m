...
// Magma code for modular curve with label 30.72.3.j.1

// Other names and/or labels
// Cummins-Pauli label: 30I3
// Rouse-Sutherland-Zureick-Brown label: 30.72.3.3

// Group data
level := 30;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 12, 0, 23], [3, 29, 11, 6], [7, 9, 15, 26], [16, 15, 9, 22]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["15.36.1.b.1", "30.12.0.b.1"];
