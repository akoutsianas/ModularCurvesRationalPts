...
// Magma code for modular curve with label 40.72.3.p.1

// Other names and/or labels
// Cummins-Pauli label: 20J3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.163

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 9, 26, 3], [7, 9, 8, 33], [23, 9, 36, 21], [27, 32, 24, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.1.h.1", "40.12.0.f.1", "40.36.1.a.1", "40.36.1.g.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.p.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(5*w);
