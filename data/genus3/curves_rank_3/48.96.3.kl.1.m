...
// Magma code for modular curve with label 48.96.3.kl.1

// Other names and/or labels
// Cummins-Pauli label: 16J3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.1065

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[21, 20, 32, 35], [29, 25, 36, 5], [31, 4, 24, 23], [41, 21, 4, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.o.1", "48.48.0.r.1", "48.48.1.o.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.kl.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
