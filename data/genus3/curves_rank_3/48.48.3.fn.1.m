...
// Magma code for modular curve with label 48.48.3.fn.1

// Other names and/or labels
// Cummins-Pauli label: 16C3
// Rouse-Sutherland-Zureick-Brown label: 48.48.3.147

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 44, 12, 5], [3, 1, 40, 17], [15, 14, 14, 21], [33, 43, 22, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.1.n.1", "24.24.0.fa.1", "48.24.2.f.1"];
...
model_2 := [-3*x^2+y^2+z^2,108*x^3*z-60*x^2*y*z-6*x*z^3-2*y*z^3-w^2];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.3.fn.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*z);
