...
// Magma code for modular curve with label 48.48.3.fo.1

// Other names and/or labels
// Cummins-Pauli label: 16C3
// Rouse-Sutherland-Zureick-Brown label: 48.48.3.132

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 14, 38, 27], [5, 39, 12, 47], [11, 24, 20, 7], [29, 31, 18, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.1.n.2", "24.24.0.fb.1", "48.24.2.f.2"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.3.fo.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.3.fo.1
//   Coordinate number 0:
