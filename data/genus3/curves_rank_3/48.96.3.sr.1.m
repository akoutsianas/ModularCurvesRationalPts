...
// Magma code for modular curve with label 48.96.3.sr.1

// Other names and/or labels
// Cummins-Pauli label: 8B3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.655

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 45, 12, 17], [29, 29, 6, 47], [31, 29, 14, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.bg.1", "24.48.1.ke.1", "48.48.0.ck.1", "48.48.1.fh.1", "48.48.2.ci.2", "48.48.2.cv.1", "48.48.2.cw.1"];
