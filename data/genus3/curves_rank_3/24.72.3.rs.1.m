...
// Magma code for modular curve with label 24.72.3.rs.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.82

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 20, 8, 23], [19, 10, 8, 1], [21, 11, 2, 9], [23, 22, 16, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.0.m.1", "24.36.1.ce.1", "24.36.1.ck.1", "24.36.1.es.1", "24.36.2.eh.1", "24.36.2.en.1", "24.36.2.fz.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.rs.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
