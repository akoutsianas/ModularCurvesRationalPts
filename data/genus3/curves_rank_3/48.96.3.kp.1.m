...
// Magma code for modular curve with label 48.96.3.kp.1

// Other names and/or labels
// Cummins-Pauli label: 16I3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.1082

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 5, 4, 45], [19, 0, 6, 5], [23, 31, 28, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.p.1", "24.48.1.fo.1", "48.48.0.t.2", "48.48.1.ez.1", "48.48.1.fb.1", "48.48.2.eq.1", "48.48.2.es.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.kp.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
