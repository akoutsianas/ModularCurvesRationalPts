...
// Magma code for modular curve with label 48.72.3.bn.2

// Other names and/or labels
// Cummins-Pauli label: 48C3
// Rouse-Sutherland-Zureick-Brown label: 48.72.3.13

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 5, 26, 37], [25, 13, 38, 31], [31, 22, 40, 35], [33, 17, 16, 15], [33, 23, 20, 27], [37, 32, 14, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['3.3.0.a.1', '16.24.1.n.2']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["16.24.1.n.2", "24.36.0.cj.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.72.3.bn.2
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.72.3.bn.2
//   Coordinate number 0:
map_2_coord_0 := 1*(-z);
//   Coordinate number 1:
