...
// Magma code for modular curve with label 48.72.3.o.1

// Other names and/or labels
// Cummins-Pauli label: 48D3
// Rouse-Sutherland-Zureick-Brown label: 48.72.3.74

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 28, 34, 23], [19, 25, 16, 29], [23, 35, 44, 1], [39, 1, 22, 33], [41, 35, 46, 23], [41, 47, 2, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.gl.1", "48.24.0.n.2"];
