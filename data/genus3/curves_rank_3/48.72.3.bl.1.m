...
// Magma code for modular curve with label 48.72.3.bl.1

// Other names and/or labels
// Cummins-Pauli label: 48F3
// Rouse-Sutherland-Zureick-Brown label: 48.72.3.47

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 13, 28, 33], [3, 37, 8, 33], [17, 8, 26, 19], [25, 4, 46, 47], [25, 45, 12, 47], [37, 32, 44, 41]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
// Map from the embedded model to the plane model of modular curve with label 48.72.3.bl.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.72.3.bl.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-z);
//   Coordinate number 1:
