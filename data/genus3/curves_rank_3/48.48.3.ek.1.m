...
// Magma code for modular curve with label 48.48.3.ek.1

// Other names and/or labels
// Cummins-Pauli label: 16C3
// Rouse-Sutherland-Zureick-Brown label: 48.48.3.25

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[23, 37, 40, 13], [27, 7, 16, 29], [29, 40, 16, 21], [35, 13, 14, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["8.24.0.bj.1", "48.24.1.m.1", "48.24.2.f.2"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.3.ek.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.3.ek.1
//   Coordinate number 0:
