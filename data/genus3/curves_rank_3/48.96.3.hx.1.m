...
// Magma code for modular curve with label 48.96.3.hx.1

// Other names and/or labels
// Cummins-Pauli label: 16J3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.403

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 35, 28, 25], [17, 20, 8, 33], [19, 35, 12, 43], [21, 37, 20, 45]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.0.r.1", "48.48.1.o.1", "48.48.2.j.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.hx.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.96.3.hx.1
//   Coordinate number 0:
map_2_coord_0 := 1*(t^6+2/3*t^4*u^2-4/9*t^2*u^4-8/27*u^6);
//   Coordinate number 1:
...
//   Coordinate number 2:
map_2_coord_2 := 1*(-w^3*t^3-w^2*t^4+2/3*w^2*t^2*u^2+2*w*t^5+4/3*w*t^3*u^2+16/9*w*t*u^4+t^6-2/3*t^4*u^2+4/3*t^2*u^4-8/9*u^6);
// Codomain equation:
