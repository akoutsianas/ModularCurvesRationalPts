...
// Magma code for modular curve with label 48.96.3.q.1

// Other names and/or labels
// Cummins-Pauli label: 8B3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.352

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 40, 28, 3], [23, 6, 34, 25], [27, 40, 10, 37], [31, 16, 32, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.0.a.1", "24.48.1.d.1", "48.48.1.dl.1", "48.48.1.ej.1", "48.48.2.b.1", "48.48.2.cv.1", "48.48.2.dt.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.q.1
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.96.3.q.1
//   Coordinate number 0:
map_2_coord_0 := 1*(1/2*w^2*t-w*t^2-1/2*t^3);
//   Coordinate number 1:
...
//   Coordinate number 2:
map_2_coord_2 := 1*(-z*w^2-z*t^2+1/2*w^3-w^2*t-1/2*w*t^2);
// Codomain equation:
