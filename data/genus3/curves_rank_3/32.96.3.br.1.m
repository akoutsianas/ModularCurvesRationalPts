...
// Magma code for modular curve with label 32.96.3.br.1

// Other names and/or labels
// Cummins-Pauli label: 32Q3
// Rouse-Zureick-Brown label: X633
// Rouse-Sutherland-Zureick-Brown label: 32.96.3.25

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 1, 26, 31], [15, 19, 2, 1], [21, 11, 8, 11], [21, 19, 20, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
