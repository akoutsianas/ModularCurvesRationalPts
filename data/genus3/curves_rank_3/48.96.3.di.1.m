...
// Magma code for modular curve with label 48.96.3.di.1

// Other names and/or labels
// Cummins-Pauli label: 8B3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.1024

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[29, 19, 40, 3], [33, 26, 14, 31], [35, 25, 20, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.e.1", "24.48.1.cl.1", "48.48.0.h.1", "48.48.1.de.1", "48.48.1.dg.1", "48.48.2.du.1", "48.48.2.dw.1"];
...
model_2 := [-3*x^2+y^2+z^2,756*x^4-432*x^3*y+252*x^2*z^2-180*x*y*z^2-21*z^4-4*w^2];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.di.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
