...
// Magma code for modular curve with label 48.96.3.t.1

// Other names and/or labels
// Cummins-Pauli label: 8B3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.1011

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[23, 10, 42, 41], [25, 38, 4, 37], [33, 10, 14, 31], [41, 22, 42, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.a.1", "24.48.1.d.1", "48.48.0.b.1", "48.48.1.do.1", "48.48.1.em.1", "48.48.2.cy.1", "48.48.2.dw.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.t.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
