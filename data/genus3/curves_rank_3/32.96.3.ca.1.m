...
// Magma code for modular curve with label 32.96.3.ca.1

// Other names and/or labels
// Cummins-Pauli label: 32L3
// Rouse-Zureick-Brown label: X650
// Rouse-Sutherland-Zureick-Brown label: 32.96.3.242

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 25, 20, 9], [15, 5, 30, 17], [17, 1, 18, 15], [29, 4, 30, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
