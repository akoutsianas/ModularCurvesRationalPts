...
// Magma code for modular curve with label 56.96.3.bm.1

// Other names and/or labels
// Cummins-Pauli label: 8A3
// Rouse-Sutherland-Zureick-Brown label: 56.96.3.43

// Group data
level := 56;
// Elements that, together with Gamma(level), generate the group
gens := [[28, 47, 27, 4], [36, 13, 5, 20], [55, 44, 20, 41]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.bv.1", "56.48.1.jj.1", "56.48.1.kc.1"];
