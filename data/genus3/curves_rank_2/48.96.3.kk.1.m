...
// Magma code for modular curve with label 48.96.3.kk.1

// Other names and/or labels
// Cummins-Pauli label: 16I3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.1041

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 23, 12, 31], [29, 10, 0, 37], [29, 24, 36, 25], [43, 26, 40, 43]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.n.1", "24.48.1.fn.1", "48.48.0.q.1", "48.48.1.fa.1", "48.48.1.fb.1", "48.48.2.ew.1", "48.48.2.ex.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.kk.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
