...
// Magma code for modular curve with label 48.96.3.oo.1

// Other names and/or labels
// Cummins-Pauli label: 16I3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.1135

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[27, 16, 26, 17], [47, 2, 36, 43], [47, 29, 8, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.bv.1", "24.48.1.hn.1", "48.48.0.ch.2", "48.48.1.dz.1", "48.48.1.ff.1", "48.48.2.bf.1", "48.48.2.cf.1"];
...
// Embedded model
model_0 := [y^2-z^2-w*u,2*y*w-2*z*w+2*w*t-y*u-z*u,3*y*w+3*z*w+y*u-z*u-t*u,y^2-2*y*z+z^2+3*w^2-y*t+z*t,3*x^2+2*y^2+2*y*z+2*z^2,2*y^2-4*y*z+2*z^2+2*y*t-2*z*t-u^2,3*x^2-3*y^2-3*z^2+2*t^2];
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.96.3.oo.1
//   Coordinate number 0:
