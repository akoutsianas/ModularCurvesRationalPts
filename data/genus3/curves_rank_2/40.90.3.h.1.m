...
// Magma code for modular curve with label 40.90.3.h.1

// Other names and/or labels
// Cummins-Pauli label: 10C3
// Rouse-Sutherland-Zureick-Brown label: 40.90.3.5

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 0, 10, 1], [13, 3, 14, 17], [19, 14, 32, 21], [21, 37, 20, 7], [23, 38, 0, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 90;
...
covers := ["10.45.1.a.1", "40.30.1.d.1"];
