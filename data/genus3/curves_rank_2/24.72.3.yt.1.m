...
// Magma code for modular curve with label 24.72.3.yt.1

// Other names and/or labels
// Cummins-Pauli label: 24O3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.816

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 11, 14, 19], [5, 15, 6, 19], [13, 1, 4, 11], [17, 13, 8, 23], [19, 23, 22, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fb.1", "24.36.1.gg.1", "24.36.1.gl.1"];
