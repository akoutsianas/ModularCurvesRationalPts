...
// Magma code for modular curve with label 48.96.3.wo.1

// Other names and/or labels
// Cummins-Pauli label: 16K3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.577

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 14, 0, 13], [11, 46, 8, 23], [37, 19, 14, 43], [45, 13, 40, 35]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.bn.1", "48.48.1.fp.1", "48.48.1.gw.1"];
