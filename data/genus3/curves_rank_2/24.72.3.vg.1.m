...
// Magma code for modular curve with label 24.72.3.vg.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.88

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 9, 18, 11], [5, 1, 14, 17], [11, 3, 6, 23], [23, 15, 18, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.0.q.1", "24.36.1.dc.1", "24.36.1.dl.1", "24.36.1.fe.1", "24.36.2.fh.1", "24.36.2.fk.1", "24.36.2.fz.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.vg.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
