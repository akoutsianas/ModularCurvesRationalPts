...
// Magma code for modular curve with label 48.96.3.hg.1

// Other names and/or labels
// Cummins-Pauli label: 8B3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.391

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 24, 42, 13], [19, 28, 36, 11], [45, 47, 20, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.0.o.1", "24.48.1.ej.1", "48.48.1.di.1", "48.48.1.dj.1", "48.48.2.m.1", "48.48.2.da.1", "48.48.2.db.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.hg.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
