...
// Magma code for modular curve with label 48.48.3.a.2

// Other names and/or labels
// Cummins-Pauli label: 16B3
// Rouse-Sutherland-Zureick-Brown label: 48.48.3.41

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 14, 10, 39], [1, 18, 30, 35], [19, 10, 38, 45], [25, 0, 0, 17], [29, 30, 28, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["8.24.1.b.1", "48.24.0.p.1", "48.24.2.f.2"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.3.a.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.3.a.2
//   Coordinate number 0:
map_2_coord_0 := 1*(-t);
//   Coordinate number 1:
map_2_coord_1 := 1*(9*y^3*z+2*t^4);
//   Coordinate number 2:
map_2_coord_2 := 1*(y);
// Codomain equation:
