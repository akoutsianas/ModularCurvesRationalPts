...
// Magma code for modular curve with label 40.60.3.bj.1

// Other names and/or labels
// Cummins-Pauli label: 10B3
// Rouse-Sutherland-Zureick-Brown label: 40.60.3.4

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 5, 20, 1], [11, 37, 20, 23], [29, 5, 15, 34], [37, 10, 20, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["5.30.0.a.1", "40.12.1.d.1", "40.30.1.a.1", "40.30.2.l.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.60.3.bj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.60.3.bj.1
//   Coordinate number 0:
