...
// Magma code for modular curve with label 48.96.3.vv.1

// Other names and/or labels
// Cummins-Pauli label: 16I3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.446

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 44, 40, 3], [13, 9, 22, 35], [13, 18, 38, 23], [23, 27, 22, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.cg.1", "24.48.1.ly.1", "48.48.0.cn.2", "48.48.1.go.1", "48.48.2.ck.1", "48.48.2.el.1", "48.48.2.et.1"];
...
// Embedded model
model_0 := [z*t+w*t-y*u,2*y*z+y*w+y*t-z*u+t*u,y*z-y*w+2*y*t-z*u-w*u,2*x^2+z^2+z*w+w^2,z*t-w*t+2*t^2-u^2,2*x^2-3*z*w+z*t-w*t-u^2,3*y^2-z*t+w*t+2*t^2];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.vv.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.96.3.vv.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-3*w*t+3*t^2-3/2*u^2);
//   Coordinate number 1:
map_2_coord_1 := 1*(-72*x*t^3*u^4+72*x*t^2*u^5-18*x*t*u^6);
//   Coordinate number 2:
