...
// Magma code for modular curve with label 48.72.3.bm.1

// Other names and/or labels
// Cummins-Pauli label: 48C3
// Rouse-Sutherland-Zureick-Brown label: 48.72.3.52

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 2, 40, 45], [21, 4, 2, 15], [23, 21, 24, 5], [31, 17, 10, 25], [35, 20, 20, 31], [41, 10, 16, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.0.cj.1", "48.24.1.n.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.72.3.bm.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.72.3.bm.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-z);
//   Coordinate number 1:
