...
// Magma code for modular curve with label 48.96.3.rj.1

// Other names and/or labels
// Cummins-Pauli label: 16I3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.635

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 27, 18, 17], [13, 22, 44, 25], [31, 21, 32, 17], [37, 32, 42, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.ba.1", "24.48.1.lu.1", "48.48.0.cp.2", "48.48.1.fq.1", "48.48.2.bz.2", "48.48.2.cn.1", "48.48.2.dn.1"];
...
model_1 := [-3*x^2+y^2+z^2,-63*x^4-180*x^3*z-42*x^2*z^2+108*x*z^3+49*z^4-16*w^2];
