...
// Magma code for modular curve with label 48.96.3.i.1

// Other names and/or labels
// Cummins-Pauli label: 8B3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.1014

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 10, 34, 23], [13, 28, 30, 11], [19, 2, 34, 45], [27, 40, 32, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.a.1", "24.48.1.c.1", "48.48.0.a.1", "48.48.1.de.1", "48.48.1.ec.1", "48.48.2.de.1", "48.48.2.ec.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.i.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
