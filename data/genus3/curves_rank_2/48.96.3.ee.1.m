...
// Magma code for modular curve with label 48.96.3.ee.1

// Other names and/or labels
// Cummins-Pauli label: 8B3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.1025

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[25, 2, 14, 39], [25, 4, 44, 25], [35, 21, 0, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.e.1", "24.48.1.cz.1", "48.48.0.h.1", "48.48.1.dm.1", "48.48.1.do.1", "48.48.2.ec.1", "48.48.2.ee.1"];
...
model_2 := [2*x^2-2*x*y+2*y^2-z^2,1836*x^4-1836*x^3*y+3456*x^3*z-6912*x^2*y*z-918*x^2*z^2-7956*x*y*z^2-4608*x*z^3-2880*y*z^3-2091*z^4-8*w^2];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.ee.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
