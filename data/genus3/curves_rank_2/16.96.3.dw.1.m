...
// Magma code for modular curve with label 16.96.3.dw.1

// Other names and/or labels
// Cummins-Pauli label: 16J3
// Rouse-Sutherland-Zureick-Brown label: 16.96.3.321

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 6, 0, 15], [9, 3, 8, 13], [13, 0, 4, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.0.s.1", "16.48.1.p.1", "16.48.2.o.1"];
