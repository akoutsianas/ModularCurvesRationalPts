...
// Magma code for modular curve with label 24.72.3.bhe.1

// Other names and/or labels
// Cummins-Pauli label: 24P3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.835

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 22, 2, 23], [7, 17, 4, 1], [11, 0, 18, 5], [19, 6, 18, 17], [19, 22, 4, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fy.1", "24.36.1.ge.1", "24.36.1.gt.1"];
