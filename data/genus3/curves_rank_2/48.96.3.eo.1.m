...
// Magma code for modular curve with label 48.96.3.eo.1

// Other names and/or labels
// Cummins-Pauli label: 8B3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.206

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 23, 12, 7], [19, 42, 18, 29], [33, 41, 2, 31], [47, 1, 12, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.v.1", "48.48.0.h.1", "48.48.1.ge.1", "48.48.1.gg.1", "48.48.2.f.1", "48.48.2.v.1", "48.48.2.x.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.eo.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
