...
// Magma code for modular curve with label 40.60.3.bo.1

// Other names and/or labels
// Cummins-Pauli label: 10A3
// Rouse-Sutherland-Zureick-Brown label: 40.60.3.19

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 32, 8, 39], [3, 5, 10, 3], [7, 22, 38, 25], [31, 20, 14, 29], [39, 29, 26, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["10.30.1.a.1", "40.6.0.a.1", "40.20.1.c.1"];
