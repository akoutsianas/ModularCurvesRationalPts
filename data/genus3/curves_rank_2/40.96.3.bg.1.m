...
// Magma code for modular curve with label 40.96.3.bg.1

// Other names and/or labels
// Cummins-Pauli label: 8B3
// Rouse-Sutherland-Zureick-Brown label: 40.96.3.188

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 28, 22, 23], [7, 30, 30, 21], [9, 36, 10, 13], [13, 10, 32, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["40.48.0.g.1", "40.48.1.bp.1", "40.48.2.b.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.96.3.bg.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(5*z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.96.3.bg.1
//   Coordinate number 0:
