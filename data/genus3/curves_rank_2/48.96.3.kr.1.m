...
// Magma code for modular curve with label 48.96.3.kr.1

// Other names and/or labels
// Cummins-Pauli label: 16I3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.1080

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 22, 10, 19], [19, 14, 40, 19], [35, 45, 34, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.p.1", "24.48.1.fq.1", "48.48.0.t.1", "48.48.1.fc.1", "48.48.1.fe.1", "48.48.2.ev.1", "48.48.2.ex.1"];
...
model_2 := [-2*x^2-2*x*y-2*y^2+z^2,-108*x^4-108*x^3*y+54*x^2*z^2-468*x*y*z^2+123*z^4-32*w^2];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.kr.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*z);
