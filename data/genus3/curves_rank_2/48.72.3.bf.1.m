...
// Magma code for modular curve with label 48.72.3.bf.1

// Other names and/or labels
// Cummins-Pauli label: 48E3
// Rouse-Sutherland-Zureick-Brown label: 48.72.3.9

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 19, 10, 5], [21, 14, 20, 9], [31, 29, 22, 1], [35, 44, 8, 31], [35, 46, 20, 47], [37, 46, 20, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['3.3.0.a.1', '16.24.1.l.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["16.24.1.l.1", "24.36.0.cg.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.72.3.bf.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.72.3.bf.1
//   Coordinate number 0:
map_2_coord_0 := 1*(w);
//   Coordinate number 1:
