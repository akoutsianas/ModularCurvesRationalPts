...
// Magma code for modular curve with label 48.96.3.ko.1

// Other names and/or labels
// Cummins-Pauli label: 16J3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.1064

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[21, 23, 44, 29], [33, 17, 44, 31], [45, 28, 40, 37], [47, 27, 44, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.o.1", "48.48.0.s.1", "48.48.1.p.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.ko.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
