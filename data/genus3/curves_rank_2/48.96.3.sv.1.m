...
// Magma code for modular curve with label 48.96.3.sv.1

// Other names and/or labels
// Cummins-Pauli label: 16H3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.560

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[15, 29, 40, 17], [25, 13, 34, 39], [33, 16, 34, 39], [41, 32, 0, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.bk.1", "24.48.1.kk.1", "48.48.1.fk.1"];
