...
// Magma code for modular curve with label 48.48.3.du.1

// Other names and/or labels
// Cummins-Pauli label: 16D3
// Rouse-Sutherland-Zureick-Brown label: 48.48.3.104

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 4, 24, 11], [11, 10, 16, 37], [19, 12, 8, 19], [47, 25, 46, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.1.l.1", "24.24.1.ef.1", "48.24.1.k.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.3.du.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
