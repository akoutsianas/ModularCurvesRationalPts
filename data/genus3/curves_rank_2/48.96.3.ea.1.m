...
// Magma code for modular curve with label 48.96.3.ea.1

// Other names and/or labels
// Cummins-Pauli label: 8B3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.370

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 28, 4, 15], [11, 29, 36, 41], [37, 33, 38, 47]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.0.h.1", "24.48.1.cx.1", "48.48.1.ej.1", "48.48.1.ep.1", "48.48.2.f.1", "48.48.2.dd.1", "48.48.2.dj.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.ea.1
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.96.3.ea.1
//   Coordinate number 0:
