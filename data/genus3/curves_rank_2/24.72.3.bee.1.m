...
// Magma code for modular curve with label 24.72.3.bee.1

// Other names and/or labels
// Cummins-Pauli label: 24P3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.857

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 10, 8, 1], [1, 11, 20, 23], [13, 13, 22, 11], [21, 2, 20, 21], [23, 17, 4, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fy.1", "24.36.1.gh.1", "24.36.1.go.1"];
