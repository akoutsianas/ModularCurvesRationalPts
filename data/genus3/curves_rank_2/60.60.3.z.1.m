...
// Magma code for modular curve with label 60.60.3.z.1

// Other names and/or labels
// Cummins-Pauli label: 10B3
// Rouse-Sutherland-Zureick-Brown label: 60.60.3.2

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 20, 30, 43], [37, 45, 10, 31], [48, 25, 5, 59], [56, 45, 45, 47]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["5.30.0.a.1", "60.12.1.n.1", "60.30.1.a.1", "60.30.2.h.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.60.3.z.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.60.3.z.1
//   Coordinate number 0:
