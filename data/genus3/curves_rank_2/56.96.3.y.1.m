...
// Magma code for modular curve with label 56.96.3.y.1

// Other names and/or labels
// Cummins-Pauli label: 8A3
// Rouse-Sutherland-Zureick-Brown label: 56.96.3.34

// Group data
level := 56;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 41, 40, 47], [11, 7, 32, 5], [43, 49, 2, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.x.1", "56.48.1.ka.1", "56.48.1.kb.1"];
