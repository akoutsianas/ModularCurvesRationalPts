...
// Magma code for modular curve with label 40.60.3.ch.1

// Other names and/or labels
// Cummins-Pauli label: 20F3
// Rouse-Sutherland-Zureick-Brown label: 40.60.3.10

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 25, 18, 23], [15, 12, 28, 33], [17, 17, 38, 15], [17, 23, 36, 23], [37, 11, 14, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['5.10.0.a.1', '8.6.0.f.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["8.6.0.f.1", "10.30.1.a.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.60.3.ch.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*u);
