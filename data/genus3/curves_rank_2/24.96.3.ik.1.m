...
// Magma code for modular curve with label 24.96.3.ik.1

// Other names and/or labels
// Cummins-Pauli label: 8A3
// Rouse-Sutherland-Zureick-Brown label: 24.96.3.68

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 18, 18, 23], [5, 4, 12, 17], [7, 9, 4, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.bs.1", "24.32.1.g.1", "24.48.1.ly.1", "24.48.1.me.1"];
