...
// Magma code for modular curve with label 48.96.3.oj.1

// Other names and/or labels
// Cummins-Pauli label: 16I3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.1173

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[23, 38, 18, 17], [25, 17, 2, 3], [27, 41, 44, 37], [47, 19, 16, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.bu.1", "24.48.1.hi.1", "48.48.0.cf.2", "48.48.1.du.1", "48.48.1.ey.1", "48.48.2.bc.1", "48.48.2.ce.1"];
...
model_2 := [2*x^2-2*x*y+2*y^2-z^2,-54*x^4+36*x^2*z^2-3*z^4-w^2];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.oj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
