...
// Magma code for modular curve with label 24.48.3.bj.1

// Other names and/or labels
// Cummins-Pauli label: 12C3
// Rouse-Sutherland-Zureick-Brown label: 24.48.3.18

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 22, 5, 7], [5, 13, 13, 4], [16, 19, 1, 8]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["12.24.0.o.1", "24.12.1.bd.1", "24.24.1.ev.1", "24.24.2.c.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.48.3.bj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.48.3.bj.1
//   Coordinate number 0:
