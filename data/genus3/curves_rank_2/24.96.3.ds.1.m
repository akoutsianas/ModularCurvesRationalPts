...
// Magma code for modular curve with label 24.96.3.ds.1

// Other names and/or labels
// Cummins-Pauli label: 24V3
// Rouse-Sutherland-Zureick-Brown label: 24.96.3.182

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 22, 12, 19], [11, 1, 12, 17], [19, 8, 12, 11], [19, 19, 12, 5], [23, 1, 12, 1], [23, 3, 0, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["12.48.1.h.1", "24.24.0.u.1", "24.48.1.is.1", "24.48.2.j.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.96.3.ds.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*z);
