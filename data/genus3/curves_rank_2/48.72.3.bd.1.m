...
// Magma code for modular curve with label 48.72.3.bd.1

// Other names and/or labels
// Cummins-Pauli label: 48E3
// Rouse-Sutherland-Zureick-Brown label: 48.72.3.39

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 36, 36, 25], [21, 22, 20, 45], [27, 23, 34, 33], [31, 13, 22, 41], [31, 16, 8, 19], [45, 41, 38, 45]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.0.cg.1", "48.24.1.l.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.72.3.bd.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.72.3.bd.1
//   Coordinate number 0:
map_2_coord_0 := 1*(w);
//   Coordinate number 1:
