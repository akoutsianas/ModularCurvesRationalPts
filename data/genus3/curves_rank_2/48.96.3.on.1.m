...
// Magma code for modular curve with label 48.96.3.on.1

// Other names and/or labels
// Cummins-Pauli label: 16I3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.1172

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 2, 46, 37], [21, 44, 16, 37], [37, 47, 46, 7], [47, 23, 6, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.bu.1", "24.48.1.hm.1", "48.48.0.ch.1", "48.48.1.dy.1", "48.48.1.fe.1", "48.48.2.be.1", "48.48.2.cf.2"];
...
model_1 := [2*x^2-2*x*y+2*y^2-z^2,27*x^4+108*x^2*z^2+12*z^4-8*w^2];
