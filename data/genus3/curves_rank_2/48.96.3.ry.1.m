...
// Magma code for modular curve with label 48.96.3.ry.1

// Other names and/or labels
// Cummins-Pauli label: 8B3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.660

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 0, 10, 35], [27, 22, 2, 13], [45, 17, 28, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.bh.1", "24.48.1.jo.1", "48.48.0.cc.1", "48.48.1.fj.1", "48.48.2.cd.1", "48.48.2.dt.1", "48.48.2.dx.1"];
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.96.3.ry.1
//   Coordinate number 0:
map_1_coord_0 := 1*(2*x^2*t-x^2*u+1/3*t*u^2+1/6*u^3);
//   Coordinate number 1:
map_1_coord_1 := 1*(384*x^10*w*t-384*x^10*w*u+192*x^8*w*u^3-128/3*x^6*w*t*u^4-64/3*x^6*w*u^5+32/9*x^4*w*t*u^6-32/9*x^4*w*u^7+8/9*x^2*w*t*u^8+8/9*x^2*w*u^9-8/81*w*t*u^10-4/81*w*u^11);
//   Coordinate number 2:
