...
// Magma code for modular curve with label 24.72.3.lz.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.238

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 19, 2, 3], [5, 3, 6, 11], [19, 15, 12, 17], [23, 9, 6, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bh.1", "24.36.0.u.1", "24.36.1.bl.1", "24.36.1.db.1", "24.36.2.cb.1", "24.36.2.dl.1", "24.36.2.eg.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.lz.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
