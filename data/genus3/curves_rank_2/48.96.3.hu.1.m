...
// Magma code for modular curve with label 48.96.3.hu.1

// Other names and/or labels
// Cummins-Pauli label: 16J3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.527

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 7, 4, 21], [21, 7, 44, 5], [29, 16, 32, 5], [37, 35, 4, 43]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.o.1", "48.48.0.s.1", "48.48.2.j.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.hu.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
