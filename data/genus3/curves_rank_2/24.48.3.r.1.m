...
// Magma code for modular curve with label 24.48.3.r.1

// Other names and/or labels
// Cummins-Pauli label: 12C3
// Rouse-Sutherland-Zureick-Brown label: 24.48.3.14

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[14, 15, 9, 17], [16, 19, 7, 20], [23, 6, 9, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["12.24.0.r.1", "24.12.1.l.1", "24.24.1.ev.1", "24.24.2.b.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.48.3.r.1
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.48.3.r.1
//   Coordinate number 0:
