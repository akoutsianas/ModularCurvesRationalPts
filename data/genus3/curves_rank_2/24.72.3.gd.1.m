...
// Magma code for modular curve with label 24.72.3.gd.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.59

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 14, 18, 1], [21, 7, 4, 13], [23, 12, 12, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.0.e.1", "24.36.1.u.1", "24.36.1.di.1", "24.36.1.eg.1", "24.36.2.bd.1", "24.36.2.bg.1", "24.36.2.ek.1"];
...
// Embedded model
model_0 := [y^2-y*z+z^2-w*t+t^2,3*x^2-w*t+t^2,2*x*y-x*z+x*t+z*t+w*t-t^2,x*y+x*z+2*x*t-y*t+z*t,2*x*y-x*z+x*w-z*w-x*t+z*t-w*t+t^2,x*y-2*x*z-x*w-y*w+x*t+y*t-w*t+t^2,y^2+2*y*z+z^2-y*w-z*w+w^2-2*u^2];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.gd.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(u);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.3.gd.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-t);
//   Coordinate number 1:
