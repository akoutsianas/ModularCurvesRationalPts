...
// Magma code for modular curve with label 40.72.3.q.1

// Other names and/or labels
// Cummins-Pauli label: 20J3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.12

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 10, 16, 33], [23, 19, 26, 11], [29, 29, 2, 11], [29, 34, 28, 5], [39, 9, 6, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['5.6.0.a.1', '8.12.0.e.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["8.12.0.e.1", "20.36.1.i.1", "40.36.1.a.1", "40.36.1.d.1"];
...
model_2 := [x^2+y^2+z^2,5*x^4+4*x^2*z^2+4*z^4-w^2];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.q.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
