...
// Magma code for modular curve with label 40.90.3.e.1

// Other names and/or labels
// Cummins-Pauli label: 20P3
// Rouse-Sutherland-Zureick-Brown label: 40.90.3.4

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 3, 30, 27], [31, 29, 30, 3], [37, 3, 30, 11], [39, 0, 2, 21], [39, 15, 0, 39]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 90;
