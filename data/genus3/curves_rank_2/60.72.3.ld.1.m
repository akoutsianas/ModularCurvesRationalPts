...
// Magma code for modular curve with label 60.72.3.ld.1

// Other names and/or labels
// Cummins-Pauli label: 12D3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.3

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[31, 52, 30, 11], [32, 53, 27, 4], [37, 18, 36, 7], [47, 20, 54, 43], [50, 57, 33, 32]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["6.36.0.a.1", "60.24.1.v.1", "60.36.1.ek.1", "60.36.2.dl.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.ld.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.72.3.ld.1
//   Coordinate number 0:
