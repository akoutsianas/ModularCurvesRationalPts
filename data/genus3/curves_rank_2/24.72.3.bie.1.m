...
// Magma code for modular curve with label 24.72.3.bie.1

// Other names and/or labels
// Cummins-Pauli label: 24Q3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.394

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 13, 4, 21], [7, 14, 14, 5], [11, 9, 6, 13], [17, 7, 10, 7], [17, 8, 4, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.by.1", "24.36.1.gl.1", "24.36.1.gt.1"];
