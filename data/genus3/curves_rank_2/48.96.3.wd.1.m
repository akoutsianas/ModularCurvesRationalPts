...
// Magma code for modular curve with label 48.96.3.wd.1

// Other names and/or labels
// Cummins-Pauli label: 16L3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.449

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[31, 2, 6, 25], [31, 35, 2, 9], [33, 1, 10, 15], [47, 16, 20, 35]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.be.1", "24.48.1.me.1", "48.48.1.ig.1"];
