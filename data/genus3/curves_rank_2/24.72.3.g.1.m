...
// Magma code for modular curve with label 24.72.3.g.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.327

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 10, 22, 23], [7, 2, 2, 17], [15, 10, 2, 3], [15, 10, 4, 9], [19, 20, 16, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.a.1", "24.36.0.bx.1", "24.36.1.bc.1", "24.36.1.ez.1", "24.36.2.a.1", "24.36.2.g.1", "24.36.2.dm.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.g.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.3.g.1
//   Coordinate number 0:
map_2_coord_0 := 1*(1/3*z^2+2/3*z*t+2/3*z*u-8/9*u^2);
//   Coordinate number 1:
map_2_coord_1 := 1*(88/81*z^5*u^3-32/27*z^4*w*u^3+176/81*z^4*t*u^3+2/27*z^4*u^4-64/27*z^3*w*t*u^3+16/27*z^3*w*u^4-112/81*z^3*t*u^4-352/81*z^3*u^5+64/27*z^2*w*t*u^4+256/81*z^2*w*u^5-512/243*z^2*t*u^5+496/243*z^2*u^6-64/27*z*w*u^6+320/243*z*t*u^6+1664/729*z*u^7-928/729*u^8);
//   Coordinate number 2:
map_2_coord_2 := 1*(1/3*z^2+2/3*z*t-1/3*z*u-2/9*u^2);
// Codomain equation:
