...
// Magma code for modular curve with label 48.96.3.ib.1

// Other names and/or labels
// Cummins-Pauli label: 16J3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.533

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 31, 36, 25], [3, 14, 8, 21], [5, 22, 24, 19], [27, 38, 40, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.p.1", "48.48.0.r.1", "48.48.2.j.1"];
...
// Embedded model
model_0 := [z^2+x*w,3*y^2+6*y*w-t*u+u^2,6*y^2+t^2+u^2,4*x*t+w*t+4*x*u+y*u-w*u,4*x*t-y*t-w*t-4*x*u-w*u,12*x*y+3*y*w-t*u,32*x^2-y^2+2*w^2];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.ib.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*z);
