...
// Magma code for modular curve with label 48.96.3.yy.1

// Other names and/or labels
// Cummins-Pauli label: 16K3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.595

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 7, 32, 5], [27, 41, 26, 37], [37, 1, 8, 19], [47, 0, 10, 41]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.cs.1", "48.48.1.fo.1", "48.48.1.fp.1"];
