...
// Magma code for modular curve with label 60.72.3.le.1

// Other names and/or labels
// Cummins-Pauli label: 12D3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.98

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 2, 8, 35], [5, 51, 6, 35], [41, 4, 18, 31], [53, 45, 34, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.0.a.1", "60.36.1.ek.1", "60.36.2.dk.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.le.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
