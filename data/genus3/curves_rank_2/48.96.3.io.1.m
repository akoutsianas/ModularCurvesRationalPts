...
// Magma code for modular curve with label 48.96.3.io.1

// Other names and/or labels
// Cummins-Pauli label: 8B3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.1060

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[29, 0, 20, 37], [39, 16, 22, 1], [47, 17, 12, 41]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.m.1", "24.48.1.ff.1", "48.48.0.n.1", "48.48.1.ec.1", "48.48.1.ed.1", "48.48.2.du.1", "48.48.2.dv.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.io.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
