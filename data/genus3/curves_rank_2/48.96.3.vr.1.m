...
// Magma code for modular curve with label 48.96.3.vr.1

// Other names and/or labels
// Cummins-Pauli label: 16I3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.631

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 5, 40, 25], [15, 47, 34, 5], [31, 47, 4, 33], [37, 2, 6, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.cc.1", "24.48.1.lu.1", "48.48.0.cp.1", "48.48.1.gi.1", "48.48.2.cl.1", "48.48.2.el.1", "48.48.2.er.1"];
...
// Embedded model
model_0 := [z^2-w^2-y*u,2*y*z-2*y*w-2*y*t-z*u-w*u,3*x^2+z^2+z*w+w^2-t^2,x^2-3*z*w-t^2,x^2+3*y^2-z^2-z*w-w^2-z*t+w*t-t^2,3*y*z+3*y*w-z*u+w*u-t*u,x^2-2*z^2+z*w-2*w^2+2*z*t-2*w*t-t^2+u^2];
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.96.3.vr.1
//   Coordinate number 0:
