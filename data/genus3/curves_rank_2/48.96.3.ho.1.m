...
// Magma code for modular curve with label 48.96.3.ho.1

// Other names and/or labels
// Cummins-Pauli label: 16I3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.235

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 10, 20, 41], [19, 4, 0, 11], [29, 29, 44, 43], [37, 13, 4, 27], [41, 1, 44, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.bn.1", "48.48.0.p.1", "48.48.1.fq.1", "48.48.1.fr.1", "48.48.2.i.1", "48.48.2.bc.1", "48.48.2.bd.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.ho.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
