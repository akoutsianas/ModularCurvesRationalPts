...
// Magma code for modular curve with label 48.96.3.k.1

// Other names and/or labels
// Cummins-Pauli label: 8B3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.1013

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 40, 30, 43], [19, 44, 26, 45], [21, 32, 34, 3], [27, 34, 20, 39]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.a.1", "24.48.1.c.1", "48.48.0.b.1", "48.48.1.dg.1", "48.48.1.ee.1", "48.48.2.dg.1", "48.48.2.ee.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.k.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
