...
// Magma code for modular curve with label 24.72.3.bic.1

// Other names and/or labels
// Cummins-Pauli label: 24Q3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.828

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 2, 16, 1], [17, 23, 4, 23], [21, 4, 16, 9], [21, 10, 10, 3], [21, 20, 2, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.gc.1", "24.36.1.gk.1", "24.36.1.gt.1"];
