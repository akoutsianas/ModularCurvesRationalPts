...
// Magma code for modular curve with label 60.72.3.nq.1

// Other names and/or labels
// Cummins-Pauli label: 12D3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.1

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[44, 33, 3, 20], [47, 38, 6, 31], [52, 31, 15, 26], [56, 33, 21, 32], [59, 30, 48, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['3.12.0.a.1', '20.6.0.e.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["6.36.0.a.1", "60.24.1.y.1", "60.36.1.eu.1", "60.36.2.dk.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.nq.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.72.3.nq.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-1/2*z^4+2*z^3*w-2*z^2*w^2);
//   Coordinate number 1:
map_2_coord_1 := 1*(9/4*z^15*t-219/16*z^14*w*t+309/16*z^13*w^2*t-27/40*z^13*t^3+309/8*z^12*w^3*t+45/16*z^12*w*t^3-609/4*z^11*w^4*t-27/16*z^11*w^2*t^3+435/2*z^10*w^5*t-27/8*z^10*w^3*t^3-213*z^9*w^6*t-9/5*z^9*w^4*t^3+150*z^8*w^7*t+27/5*z^8*w^5*t^3-60*z^7*w^8*t+27/5*z^7*w^6*t^3+24*z^6*w^9*t-18/5*z^6*w^7*t^3);
//   Coordinate number 2:
map_2_coord_2 := 1*(1/3*z^4+1/3*z^3*w-5/2*z^2*w^2-1/5*z^2*t^2+4/3*z*w^3-1/10*z*w*t^2-2/3*w^4+1/10*w^2*t^2);
// Codomain equation:
