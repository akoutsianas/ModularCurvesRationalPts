...
// Magma code for modular curve with label 60.60.3.by.1

// Other names and/or labels
// Cummins-Pauli label: 30H3
// Rouse-Sutherland-Zureick-Brown label: 60.60.3.45

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 38, 46, 33], [4, 3, 39, 31], [11, 32, 14, 31], [26, 13, 39, 19], [27, 8, 1, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
