...
// Magma code for modular curve with label 48.96.3.tm.1

// Other names and/or labels
// Cummins-Pauli label: 8B3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.624

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 41, 44, 15], [5, 3, 42, 43], [45, 32, 26, 19], [47, 34, 28, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.br.1", "24.48.1.le.1", "48.48.0.cc.2", "48.48.1.gb.1", "48.48.2.cd.2", "48.48.2.cv.1", "48.48.2.cz.1"];
...
model_1 := [-3*x^2+y^2+z^2,-63*x^4-180*x^3*z-42*x^2*z^2+108*x*z^3+49*z^4-4*w^2];
