...
// Magma code for modular curve with label 24.72.3.ya.1

// Other names and/or labels
// Cummins-Pauli label: 12J3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.457

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 13, 4, 11], [9, 5, 22, 15], [13, 9, 18, 7], [17, 14, 2, 7], [19, 13, 14, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bn.1", "24.36.1.fw.1", "24.36.1.gc.1"];
