...
// Magma code for modular curve with label 48.96.3.ii.1

// Other names and/or labels
// Cummins-Pauli label: 16I3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.269

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 47, 36, 7], [9, 32, 32, 17], [11, 12, 6, 29], [35, 13, 26, 21], [47, 32, 38, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.br.1", "48.48.0.t.1", "48.48.1.fv.1", "48.48.1.fx.1", "48.48.2.k.1", "48.48.2.bc.1", "48.48.2.be.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.ii.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
