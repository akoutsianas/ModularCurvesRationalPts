...
// Magma code for modular curve with label 24.72.3.fo.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.375

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 4, 8, 7], [7, 20, 4, 7], [11, 11, 2, 19], [17, 7, 14, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bl.1", "24.36.0.bv.1", "24.36.1.w.1", "24.36.1.bc.1", "24.36.2.ba.1", "24.36.2.bf.1", "24.36.2.do.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.fo.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
