...
// Magma code for modular curve with label 24.72.3.bhk.1

// Other names and/or labels
// Cummins-Pauli label: 24P3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.808

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 14, 4, 13], [9, 2, 14, 15], [11, 8, 20, 19], [13, 5, 8, 11], [21, 10, 20, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fw.1", "24.36.1.gh.1", "24.36.1.gs.1"];
