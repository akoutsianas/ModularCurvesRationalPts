...
// Magma code for modular curve with label 48.48.3.eo.1

// Other names and/or labels
// Cummins-Pauli label: 16C3
// Rouse-Sutherland-Zureick-Brown label: 48.48.3.26

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[25, 9, 8, 31], [25, 14, 42, 19], [29, 5, 8, 3], [47, 41, 40, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["8.24.0.bj.1", "48.24.1.n.1", "48.24.2.f.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.3.eo.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.3.eo.1
//   Coordinate number 0:
