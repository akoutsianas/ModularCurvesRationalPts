...
// Magma code for modular curve with label 48.48.3.u.1

// Other names and/or labels
// Cummins-Pauli label: 16D3
// Rouse-Sutherland-Zureick-Brown label: 48.48.3.55

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 3, 10, 31], [13, 43, 38, 1], [37, 38, 16, 25], [47, 7, 46, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
// Map from the embedded model to the plane model of modular curve with label 48.48.3.u.1
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
