...
// Magma code for modular curve with label 48.72.3.bj.1

// Other names and/or labels
// Cummins-Pauli label: 48F3
// Rouse-Sutherland-Zureick-Brown label: 48.72.3.43

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 8, 40, 1], [13, 6, 6, 11], [13, 45, 18, 35], [29, 2, 2, 7], [35, 42, 24, 7], [41, 28, 16, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
// Map from the embedded model to the plane model of modular curve with label 48.72.3.bj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.72.3.bj.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-z);
//   Coordinate number 1:
