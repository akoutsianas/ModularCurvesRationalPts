...
// Magma code for modular curve with label 48.96.3.f.1

// Other names and/or labels
// Cummins-Pauli label: 8B3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.187

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 14, 20, 33], [13, 2, 28, 9], [37, 10, 42, 11], [45, 8, 40, 45], [47, 46, 22, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.c.1", "48.48.0.b.1", "48.48.1.fj.1", "48.48.1.gb.1", "48.48.2.b.1", "48.48.2.x.1", "48.48.2.bn.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.f.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
