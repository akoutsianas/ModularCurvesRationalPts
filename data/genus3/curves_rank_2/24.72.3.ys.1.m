...
// Magma code for modular curve with label 24.72.3.ys.1

// Other names and/or labels
// Cummins-Pauli label: 24O3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.834

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 4, 16, 15], [3, 19, 14, 9], [5, 15, 12, 19], [9, 8, 14, 3], [19, 14, 10, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fb.1", "24.36.1.gh.1", "24.36.1.gk.1"];
