...
// Magma code for modular curve with label 24.72.3.tb.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.53

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 6, 6, 19], [1, 6, 6, 23], [5, 7, 14, 23], [5, 18, 18, 19], [7, 13, 8, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.0.p.1", "24.36.1.ch.1", "24.36.1.ct.1", "24.36.1.fb.1", "24.36.2.eh.1", "24.36.2.et.1", "24.36.2.gf.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.tb.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.3.tb.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-w);
//   Coordinate number 1:
