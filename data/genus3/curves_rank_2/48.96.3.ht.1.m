...
// Magma code for modular curve with label 48.96.3.ht.1

// Other names and/or labels
// Cummins-Pauli label: 16J3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.529

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 37, 28, 29], [15, 22, 40, 25], [41, 7, 36, 47], [47, 42, 40, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.o.1", "48.48.0.r.1", "48.48.2.j.1"];
...
// Embedded model
model_0 := [z^2-2*x*w,3*y^2-6*y*w-t*u+u^2,6*y^2+t^2+u^2,4*x*t+w*t+4*x*u-y*u-w*u,4*x*t+y*t-w*t-4*x*u-w*u,12*x*y+3*y*w+t*u,32*x^2-y^2+2*w^2];

// Singular plane model
model_1 := [2*x^8+8*x^6*y^2+16*x^4*y^4+32*x^2*y^6+32*y^8+12*x^6*z^2+48*x^2*y^4*z^2+9*x^4*z^4];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.ht.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
...
// Codomain equation:
map_1_codomain := [2*x^8+8*x^6*y^2+16*x^4*y^4+32*x^2*y^6+32*y^8+12*x^6*z^2+48*x^2*y^4*z^2+9*x^4*z^4];
