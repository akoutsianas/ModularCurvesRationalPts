...
// Magma code for modular curve with label 48.96.3.vp.1

// Other names and/or labels
// Cummins-Pauli label: 16I3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.643

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 45, 28, 31], [19, 18, 44, 47], [37, 19, 34, 27], [47, 14, 26, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.ca.1", "24.48.1.lu.1", "48.48.0.co.2", "48.48.1.gk.1", "48.48.2.cl.2", "48.48.2.ej.1", "48.48.2.et.1"];
...
model_1 := [x^2+y^2+z^2,-7*x^4+72*x^3*y-140*x^3*z-104*x^2*y*z+182*x^2*z^2-104*x*y*z^2-140*x*z^3+72*y*z^3-7*z^4-16*w^2];
