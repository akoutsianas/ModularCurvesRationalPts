...
// Magma code for modular curve with label 48.96.3.kn.1

// Other names and/or labels
// Cummins-Pauli label: 16J3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.1066

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 7, 28, 21], [13, 10, 0, 19], [39, 10, 8, 39], [47, 22, 0, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.o.1", "48.48.0.r.1", "48.48.1.p.1"];
...
// Embedded model
model_0 := [3*x*z-w^2,3*y^2-6*y*z-t*u+u^2,6*y^2+t^2+u^2,4*x*t-z*t+4*x*u+y*u+z*u,4*x*t-y*t+z*t-4*x*u+z*u,12*x*y-3*y*z-t*u,32*x^2-y^2+2*z^2];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.kn.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
