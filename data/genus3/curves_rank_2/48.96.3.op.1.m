...
// Magma code for modular curve with label 48.96.3.op.1

// Other names and/or labels
// Cummins-Pauli label: 8B3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.1210

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 10, 42, 37], [15, 19, 22, 37], [25, 0, 38, 23], [35, 28, 16, 43]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.bg.1", "24.48.1.ho.1", "48.48.0.ci.1", "48.48.1.ej.1", "48.48.1.em.1", "48.48.2.bj.1", "48.48.2.cg.2"];
...
// Embedded model
model_0 := [y*w-z*t-w*u,y*w-z*w-y*t-t*u,y^2-y*z+z^2-u^2,w^2-w*t+t^2-2*u^2,w^2-2*w*t-2*z*u,w^2-t^2-2*y*u,48*x^2-3*y*z+u^2];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.op.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
