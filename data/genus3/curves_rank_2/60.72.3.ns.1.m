...
// Magma code for modular curve with label 60.72.3.ns.1

// Other names and/or labels
// Cummins-Pauli label: 12D3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.96

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 5, 44, 23], [13, 44, 8, 23], [43, 20, 26, 53], [53, 12, 52, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.0.a.1", "60.36.1.eu.1", "60.36.2.dl.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.ns.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
