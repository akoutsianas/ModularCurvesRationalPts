...
// Magma code for modular curve with label 48.144.3.e.1

// Other names and/or labels
// Cummins-Pauli label: 48M3
// Rouse-Sutherland-Zureick-Brown label: 48.144.3.60

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 24, 6, 11], [13, 26, 14, 11], [35, 33, 18, 29], [35, 38, 10, 5], [47, 3, 36, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.ek.1", "48.72.0.b.1", "48.72.2.d.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.3.e.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.3.e.1
//   Coordinate number 0:
map_2_coord_0 := 1*(z);
//   Coordinate number 1:
