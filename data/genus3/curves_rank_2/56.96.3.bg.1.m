...
// Magma code for modular curve with label 56.96.3.bg.1

// Other names and/or labels
// Cummins-Pauli label: 8A3
// Rouse-Sutherland-Zureick-Brown label: 56.96.3.38

// Group data
level := 56;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 22, 18, 45], [45, 24, 4, 9], [47, 35, 4, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.bt.1", "56.48.1.je.1", "56.48.1.kb.1"];
