...
// Magma code for modular curve with label 40.96.3.co.1

// Other names and/or labels
// Cummins-Pauli label: 8A3
// Rouse-Sutherland-Zureick-Brown label: 40.96.3.48

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 18, 20, 23], [23, 30, 37, 9], [37, 30, 16, 39]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.bu.1", "40.48.1.kb.1", "40.48.1.kf.1"];
