...
// Magma code for modular curve with label 24.72.3.yf.1

// Other names and/or labels
// Cummins-Pauli label: 12J3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.393

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 7, 22, 19], [11, 7, 2, 5], [13, 23, 8, 23], [19, 8, 10, 13], [19, 9, 12, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.by.1", "24.36.1.fb.1", "24.36.1.fw.1"];
