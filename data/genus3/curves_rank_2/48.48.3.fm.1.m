...
// Magma code for modular curve with label 48.48.3.fm.1

// Other names and/or labels
// Cummins-Pauli label: 16C3
// Rouse-Sutherland-Zureick-Brown label: 48.48.3.153

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 2, 28, 11], [13, 4, 28, 17], [19, 19, 20, 21], [21, 41, 34, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.1.m.2", "24.24.0.fd.1", "48.24.2.f.2"];
...
// Embedded model
model_0 := [z*t-x*u,z*w-y*u,x*w-y*t,2*w^2-2*w*t+2*t^2+u^2,x*w-2*y*w-2*x*t+y*t-z*u,2*x^2-2*x*y+2*y^2+z^2,2*x^2+4*x*y+2*y^2-4*z^2-w*u-t*u];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.3.fm.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
