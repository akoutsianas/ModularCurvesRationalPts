...
// Magma code for modular curve with label 48.96.3.hn.1

// Other names and/or labels
// Cummins-Pauli label: 16I3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.25

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 20, 36, 17], [11, 13, 36, 29], [13, 3, 24, 35], [23, 17, 20, 9], [45, 11, 44, 35]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.bm.1", "48.48.0.p.1", "48.48.1.fu.1", "48.48.1.fv.1", "48.48.2.i.1", "48.48.2.y.1", "48.48.2.z.1"];
...
// Embedded model
model_0 := [x*t+y*t-2*z*t-2*w*t-x*u+2*w*u,x*t+2*w*t+x*u+y*u-2*z*u+2*w*u,x^2+x*y-2*x*z-y*z+z^2-2*w^2,x^2+x*y-y^2-2*x*z+y*z-z^2+2*w^2,y^2-2*y*z+2*z^2+3*x*w+2*w^2+t*u-u^2,y^2-2*y*z+2*z^2-3*x*w+2*w^2-t^2-t*u,3*y*w-6*z*w-t^2+u^2];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.hn.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
