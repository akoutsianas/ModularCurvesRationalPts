...
// Magma code for modular curve with label 56.96.3.bq.1

// Other names and/or labels
// Cummins-Pauli label: 8A3
// Rouse-Sutherland-Zureick-Brown label: 56.96.3.44

// Group data
level := 56;
// Elements that, together with Gamma(level), generate the group
gens := [[20, 13, 45, 20], [36, 5, 49, 44], [44, 39, 37, 52]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.bv.1", "56.48.1.jv.1", "56.48.1.kd.1"];
