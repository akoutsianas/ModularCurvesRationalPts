...
// Magma code for modular curve with label 40.60.3.cc.1

// Other names and/or labels
// Cummins-Pauli label: 10B3
// Rouse-Sutherland-Zureick-Brown label: 40.60.3.41

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 20, 20, 1], [10, 13, 23, 5], [14, 15, 15, 28]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["20.30.0.b.1", "40.30.1.d.1", "40.30.2.l.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.60.3.cc.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.60.3.cc.1
//   Coordinate number 0:
