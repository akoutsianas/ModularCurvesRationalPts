...
// Magma code for modular curve with label 48.48.3.em.1

// Other names and/or labels
// Cummins-Pauli label: 16C3
// Rouse-Sutherland-Zureick-Brown label: 48.48.3.8

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 5, 10, 1], [11, 17, 28, 9], [33, 44, 22, 15], [39, 44, 4, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["8.24.0.bh.1", "48.24.1.n.1", "48.24.2.f.2"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.3.em.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.3.em.1
//   Coordinate number 0:
map_2_coord_0 := 1*(w);
//   Coordinate number 1:
