...
// Magma code for modular curve with label 48.96.3.vs.1

// Other names and/or labels
// Cummins-Pauli label: 16I3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.604

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[29, 45, 24, 19], [35, 14, 4, 23], [47, 31, 2, 45]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.cd.1", "24.48.1.lv.1", "48.48.0.cp.2", "48.48.1.gj.1", "48.48.2.cl.2", "48.48.2.ek.1", "48.48.2.eq.1"];
