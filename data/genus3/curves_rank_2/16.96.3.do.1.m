...
// Magma code for modular curve with label 16.96.3.do.1

// Other names and/or labels
// Cummins-Pauli label: 16I3
// Rouse-Sutherland-Zureick-Brown label: 16.96.3.234

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 5, 12, 13], [7, 13, 12, 9], [9, 2, 4, 5], [9, 13, 0, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.bn.1", "16.48.0.p.1", "16.48.1.ca.1", "16.48.1.cb.1", "16.48.2.n.1", "16.48.2.bs.1", "16.48.2.bt.1"];
...
// Embedded model
model_0 := [y^2-x*u,x*z-w^2+t^2-z*u,x*z+2*z^2-w*t+t^2,x*z-2*w*t+z*u,x*w+2*z*w+2*z*t+t*u,2*z*w+x*t-2*z*t-w*u,x^2+2*w^2+2*t^2+u^2];
...
// Map from the embedded model to the plane model of modular curve with label 16.96.3.do.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(u);
