...
// Magma code for modular curve with label 48.96.3.xh.1

// Other names and/or labels
// Cummins-Pauli label: 16K3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.677

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 10, 38, 27], [13, 23, 20, 15], [41, 32, 22, 39], [43, 0, 0, 35]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.bu.1", "48.48.1.ge.1", "48.48.1.ie.1"];
