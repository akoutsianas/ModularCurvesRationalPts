...
// Magma code for modular curve with label 40.72.3.c.1

// Other names and/or labels
// Cummins-Pauli label: 20J3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.43

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 28, 8, 21], [11, 26, 38, 19], [13, 4, 6, 11], [21, 18, 14, 15], [25, 16, 36, 15], [27, 14, 18, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["10.36.1.a.1", "40.12.0.a.1", "40.36.1.g.1", "40.36.1.j.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.c.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.72.3.c.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-w);
//   Coordinate number 1:
map_2_coord_1 := 1*(50*y^4+20*y^2*w^2-10*y^2*w*t);
//   Coordinate number 2:
map_2_coord_2 := 1*(y);
// Codomain equation:
