...
// Magma code for modular curve with label 24.72.3.tt.1

// Other names and/or labels
// Cummins-Pauli label: 12E3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.42

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 0, 6, 13], [3, 4, 14, 9], [17, 0, 0, 19], [17, 15, 18, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.0.d.1", "24.36.1.dk.1", "24.36.2.ev.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.tt.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.3.tt.1
//   Coordinate number 0:
