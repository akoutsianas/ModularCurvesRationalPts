...
// Magma code for modular curve with label 48.96.3.rx.1

// Other names and/or labels
// Cummins-Pauli label: 8B3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.656

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 20, 42, 47], [21, 23, 34, 39], [43, 7, 44, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.bg.1", "24.48.1.jo.1", "48.48.0.cc.2", "48.48.1.fi.1", "48.48.2.cc.2", "48.48.2.ds.1", "48.48.2.dw.1"];
...
model_1 := [-3*x^2+y^2+z^2,-252*x^4-144*x^3*y+252*x^2*z^2+108*x*y*z^2-49*z^4-4*w^2];
