...
// Magma code for modular curve with label 48.96.3.ze.1

// Other names and/or labels
// Cummins-Pauli label: 16L3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.516

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[25, 23, 8, 47], [33, 8, 20, 37], [39, 16, 14, 33], [43, 20, 28, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.db.1", "24.48.1.mg.1", "48.48.1.fv.1"];
