...
// Magma code for modular curve with label 40.144.3.d.1

// Other names and/or labels
// Cummins-Pauli label: 20R3
// Rouse-Sutherland-Zureick-Brown label: 40.144.3.329

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 25, 30, 21], [15, 12, 34, 23], [19, 4, 8, 35], [23, 25, 2, 11], [25, 27, 6, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
