...
// Magma code for modular curve with label 16.96.3.ce.1

// Other names and/or labels
// Cummins-Pauli label: 16I3
// Rouse-Sutherland-Zureick-Brown label: 16.96.3.209

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 12, 0, 5], [11, 15, 10, 1], [15, 2, 14, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.bo.1", "16.48.0.t.1", "16.48.1.z.1", "16.48.1.bb.1", "16.48.2.j.1", "16.48.2.q.1", "16.48.2.s.1"];
...
// Map from the embedded model to the Weierstrass model of modular curve with label 16.96.3.ce.1
//   Coordinate number 0:
