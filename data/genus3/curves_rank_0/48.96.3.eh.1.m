...
// Magma code for modular curve with label 48.96.3.eh.1

// Other names and/or labels
// Cummins-Pauli label: 8B3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.1029

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 42, 26, 7], [21, 28, 28, 37], [29, 31, 44, 47]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.f.1", "24.48.1.cz.1", "48.48.0.h.2", "48.48.1.dn.1", "48.48.1.dp.1", "48.48.2.ed.1", "48.48.2.ef.1"];
...
model_2 := [2*x^2-2*x*y+2*y^2-z^2,108*x^4-108*x^3*y-54*x^2*z^2-468*x*y*z^2-123*z^4-8*w^2];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.eh.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
