...
// Magma code for modular curve with label 60.72.3.zc.2

// Other names and/or labels
// Cummins-Pauli label: 20G3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.753

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 10, 10, 29], [13, 0, 58, 19], [31, 35, 24, 49], [43, 10, 32, 39], [43, 30, 14, 53]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['4.6.0.e.1', '15.12.0.b.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["20.36.1.j.1", "30.36.0.b.2", "60.36.2.fq.2"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.zc.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
