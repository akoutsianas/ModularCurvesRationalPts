...
// Magma code for modular curve with label 24.72.3.bcp.1

// Other names and/or labels
// Cummins-Pauli label: 24Q3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.822

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 12, 6, 19], [5, 21, 12, 23], [7, 6, 12, 19], [13, 3, 6, 19], [23, 14, 16, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fo.1", "24.36.1.gb.1", "24.36.1.go.1"];
