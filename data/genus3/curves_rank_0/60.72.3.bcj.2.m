...
// Magma code for modular curve with label 60.72.3.bcj.2

// Other names and/or labels
// Cummins-Pauli label: 30J3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.673

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[16, 5, 17, 53], [19, 55, 26, 19], [27, 40, 29, 27], [38, 45, 21, 46]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["15.36.1.c.1", "60.36.0.ch.2", "60.36.2.fu.1"];
...
// Weierstrass model
model_2 := [4*x^8-7*x^6*z^2+x^4*y-3*x^4*z^4+x^2*y*z^2-37*x^2*z^6+y^2+y*z^4+94*z^8];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.bcj.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(u);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.72.3.bcj.2
//   Coordinate number 0:
map_2_coord_0 := 1*(-x);
//   Coordinate number 1:
map_2_coord_1 := 1*(-8*x^4+7*x^2*t^2-8*t^4+15*t^3*u);
//   Coordinate number 2:
map_2_coord_2 := 1*(t);
// Codomain equation:
map_2_codomain := [4*x^8-7*x^6*z^2+x^4*y-3*x^4*z^4+x^2*y*z^2-37*x^2*z^6+y^2+y*z^4+94*z^8];
