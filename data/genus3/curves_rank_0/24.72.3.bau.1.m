...
// Magma code for modular curve with label 24.72.3.bau.1

// Other names and/or labels
// Cummins-Pauli label: 24O3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.831

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 0, 0, 17], [1, 4, 8, 13], [7, 6, 0, 23], [13, 17, 4, 7], [23, 5, 14, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fk.1", "24.36.1.fu.1", "24.36.1.gk.1"];
