...
// Magma code for modular curve with label 24.72.3.ck.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.739

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 3, 12, 17], [3, 22, 10, 21], [5, 2, 16, 5], [13, 19, 16, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.y.1", "24.36.0.bx.1", "24.36.1.k.1", "24.36.1.bb.1", "24.36.1.fa.1", "24.36.2.i.1", "24.36.2.n.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.ck.1
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.3.ck.1
//   Coordinate number 0:
map_2_coord_0 := 1*(4/9*z^2+2/9*z*w+1/9*z*t-5/27*t^2);
//   Coordinate number 1:
map_2_coord_1 := 1*(-40/2187*z^4*t^3*u-20/2187*z^3*w*t^3*u-106/2187*z^3*t^4*u-10/729*z^2*w*t^4*u+56/6561*z^2*t^5*u+82/6561*z*t^6*u);
//   Coordinate number 2:
map_2_coord_2 := 1*(1/9*z^2+1/18*z*w-2/9*z*t-2/27*t^2);
// Codomain equation:
