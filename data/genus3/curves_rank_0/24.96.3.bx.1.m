...
// Magma code for modular curve with label 24.96.3.bx.1

// Other names and/or labels
// Cummins-Pauli label: 12L3
// Rouse-Sutherland-Zureick-Brown label: 24.96.3.466

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 0, 6, 7], [11, 0, 6, 1], [11, 22, 6, 11], [19, 10, 12, 7], [23, 4, 18, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["12.48.2.a.1", "24.48.0.o.1", "24.48.1.bx.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.96.3.bx.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(u);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.96.3.bx.1
//   Coordinate number 0:
map_2_coord_0 := 1*(t);
//   Coordinate number 1:
