...
// Magma code for modular curve with label 48.144.3.l.2

// Other names and/or labels
// Cummins-Pauli label: 48M3
// Rouse-Sutherland-Zureick-Brown label: 48.144.3.11

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 14, 16, 19], [5, 5, 38, 31], [13, 23, 2, 23], [17, 15, 42, 25], [33, 16, 44, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.ev.1", "48.72.0.a.2", "48.72.2.a.2"];
...
// Embedded model
model_0 := [x*z+y*u,w^2+w*t+t^2+u^2,z^2-w*u-2*t*u,y*z+x*w+2*x*t,3*x^2-2*z*u,3*x*y+2*z^2,3*y^2-2*z*w-4*z*t];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.3.l.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.3.l.2
//   Coordinate number 0:
map_2_coord_0 := 1*(z);
//   Coordinate number 1:
map_2_coord_1 := 1*(-27/16*y^4+9/4*y^2*z*t-1/2*z^4);
//   Coordinate number 2:
