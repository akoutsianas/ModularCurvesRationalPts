...
// Magma code for modular curve with label 40.72.3.cj.2

// Other names and/or labels
// Cummins-Pauli label: 20H3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.247

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 2, 30, 23], [1, 18, 24, 25], [5, 2, 38, 29], [13, 1, 22, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.2.b.2", "40.36.0.e.2", "40.36.1.c.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.cj.2
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.72.3.cj.2
//   Coordinate number 0:
