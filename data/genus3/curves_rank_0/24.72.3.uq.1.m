...
// Magma code for modular curve with label 24.72.3.uq.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.636

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 3, 18, 23], [5, 2, 8, 1], [15, 4, 20, 9], [19, 18, 12, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.bu.1", "24.36.0.bs.1", "24.36.1.cu.1", "24.36.1.dp.1", "24.36.1.fh.1", "24.36.2.ez.1", "24.36.2.fo.1"];
