...
// Magma code for modular curve with label 24.72.3.kw.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.710

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 17, 2, 13], [7, 1, 8, 7], [7, 20, 16, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.bo.1", "24.36.0.n.1", "24.36.1.bg.1", "24.36.1.cc.1", "24.36.1.dz.1", "24.36.2.cg.1", "24.36.2.df.1"];
...
model_2 := [2*x^2-2*x*y+2*y^2-z^2,-36*x^3*y-42*x^2*z^2+60*x*y*z^2+37*z^4-6*w^2];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.kw.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
