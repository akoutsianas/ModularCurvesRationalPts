...
// Magma code for modular curve with label 24.96.3.cs.2

// Other names and/or labels
// Cummins-Pauli label: 24U3
// Rouse-Sutherland-Zureick-Brown label: 24.96.3.629

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 21, 0, 13], [11, 6, 6, 5], [13, 0, 2, 7], [13, 0, 18, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.48.0.br.2", "24.48.1.cf.1", "24.48.2.e.2"];
...
// Map from the embedded model to the plane model of modular curve with label 24.96.3.cs.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.96.3.cs.2
//   Coordinate number 0:
map_2_coord_0 := 1*(t);
//   Coordinate number 1:
