...
// Magma code for modular curve with label 32.96.3.f.2

// Other names and/or labels
// Cummins-Pauli label: 32K3
// Rouse-Sutherland-Zureick-Brown label: 32.96.3.191

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 29, 16, 25], [13, 21, 0, 9], [15, 10, 0, 23], [27, 10, 16, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.d.1", "32.48.0.e.2", "32.48.2.a.2"];
...
// Map from the embedded model to the plane model of modular curve with label 32.96.3.f.2
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 32.96.3.f.2
//   Coordinate number 0:
map_2_coord_0 := 1*(-z-w);
//   Coordinate number 1:
