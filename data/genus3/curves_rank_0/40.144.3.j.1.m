...
// Magma code for modular curve with label 40.144.3.j.1

// Other names and/or labels
// Cummins-Pauli label: 40J3
// Rouse-Sutherland-Zureick-Brown label: 40.144.3.324

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 35, 24, 7], [5, 16, 32, 19], [19, 7, 32, 39], [19, 12, 36, 5], [29, 27, 12, 19], [33, 36, 4, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
