...
// Magma code for modular curve with label 40.72.3.bc.2

// Other names and/or labels
// Cummins-Pauli label: 20I3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.225

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 22, 38, 15], [25, 17, 8, 19], [33, 19, 0, 37], [35, 19, 8, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.2.b.1", "40.36.0.d.1", "40.36.1.b.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.bc.2
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.72.3.bc.2
//   Coordinate number 0:
map_2_coord_0 := 1*(-z*u);
//   Coordinate number 1:
