...
// Magma code for modular curve with label 24.72.3.n.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.610

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 22, 22, 3], [5, 12, 18, 1], [11, 22, 10, 1], [13, 10, 8, 7], [15, 8, 20, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.c.1", "24.36.0.bd.1", "24.36.1.a.1", "24.36.1.ci.1", "24.36.1.ea.1", "24.36.2.f.1", "24.36.2.fl.1"];
...
model_2 := [-2*x^2-2*x*y-2*y^2+z^2,108*x^3*y+18*x^2*z^2-36*x*y*z^2+7*z^4-6*w^2];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.n.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*u);
