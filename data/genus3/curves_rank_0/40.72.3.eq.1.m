...
// Magma code for modular curve with label 40.72.3.eq.1

// Other names and/or labels
// Cummins-Pauli label: 20G3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.32

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 21, 22, 27], [9, 18, 38, 19], [9, 38, 30, 17], [25, 12, 16, 1], [33, 26, 2, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['5.12.0.a.2', '8.6.0.e.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["10.36.0.a.1", "40.36.1.k.1", "40.36.2.b.2"];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.eq.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.72.3.eq.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-1/5*x+2/5*z);
//   Coordinate number 1:
map_2_coord_1 := 1*(-1/125*x^3*t+1/125*x^2*z*t+3/125*x*z^2*t-2/125*z^3*t);
//   Coordinate number 2:
map_2_coord_2 := 1*(-2/5*x-1/5*z);
// Codomain equation:
