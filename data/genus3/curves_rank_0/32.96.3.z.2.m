...
// Magma code for modular curve with label 32.96.3.z.2

// Other names and/or labels
// Cummins-Pauli label: 32O3
// Rouse-Zureick-Brown label: X656
// Rouse-Sutherland-Zureick-Brown label: 32.96.3.123

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 31, 24, 25], [5, 1, 16, 31], [11, 5, 8, 15], [15, 6, 16, 23], [17, 5, 0, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
