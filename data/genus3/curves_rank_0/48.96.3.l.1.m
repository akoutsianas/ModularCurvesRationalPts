...
// Magma code for modular curve with label 48.96.3.l.1

// Other names and/or labels
// Cummins-Pauli label: 8B3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.1009

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 20, 44, 35], [31, 38, 10, 25], [31, 40, 42, 25], [33, 46, 44, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.b.1", "24.48.1.c.1", "48.48.0.b.1", "48.48.1.dh.1", "48.48.1.ef.1", "48.48.2.dh.1", "48.48.2.ef.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.l.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
