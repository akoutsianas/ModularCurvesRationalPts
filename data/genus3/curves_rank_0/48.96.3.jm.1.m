...
// Magma code for modular curve with label 48.96.3.jm.1

// Other names and/or labels
// Cummins-Pauli label: 16I3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.234

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 20, 32, 43], [23, 29, 24, 25], [23, 44, 8, 31], [31, 11, 44, 17], [45, 5, 44, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.bn.1", "48.48.0.p.1", "48.48.1.gi.1", "48.48.1.gj.1", "48.48.2.n.1", "48.48.2.bs.1", "48.48.2.bt.1"];
...
// Embedded model
model_0 := [y^2-x*w,x*t+2*z*t+2*z*u+w*u,2*z*t-w*t+x*u-2*z*u,3*x*z+3*z*w+2*t*u,x^2+3*x*z-2*z^2+w^2+t*u-u^2,x^2-2*z^2+3*z*w+w^2-t^2+t*u,x^2+4*z^2+w^2-t^2-u^2];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.jm.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
