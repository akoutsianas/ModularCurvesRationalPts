...
// Magma code for modular curve with label 24.72.3.mw.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.665

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 7, 20, 21], [9, 10, 4, 3], [11, 5, 4, 11], [13, 12, 12, 13], [23, 14, 20, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.t.1", "24.36.0.ba.1", "24.36.1.bq.1", "24.36.1.da.1", "24.36.1.em.1", "24.36.2.dq.1", "24.36.2.ec.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.mw.1
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*z);
