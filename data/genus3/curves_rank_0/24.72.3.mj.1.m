...
// Magma code for modular curve with label 24.72.3.mj.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.477

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 8, 16, 3], [7, 4, 20, 1], [9, 20, 20, 21], [15, 4, 20, 15], [15, 23, 16, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.n.1", "24.36.0.s.1", "24.36.1.cv.1", "24.36.1.ef.1", "24.36.2.cc.1", "24.36.2.dq.1", "24.36.2.dy.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.mj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(u);
