...
// Magma code for modular curve with label 12.72.3.ch.1

// Other names and/or labels
// Cummins-Pauli label: 12D3
// Rouse-Sutherland-Zureick-Brown label: 12.72.3.43

// Group data
level := 12;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 7, 10, 3], [3, 8, 8, 9], [9, 4, 2, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.0.a.1", "12.36.1.bi.1", "12.36.2.bl.1"];
...
// Map from the embedded model to the plane model of modular curve with label 12.72.3.ch.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
