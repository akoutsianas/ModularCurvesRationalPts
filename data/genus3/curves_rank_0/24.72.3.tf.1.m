...
// Magma code for modular curve with label 24.72.3.tf.1

// Other names and/or labels
// Cummins-Pauli label: 12F3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.553

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 17, 10, 9], [15, 14, 22, 3], [21, 1, 4, 3], [21, 22, 20, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.bk.1", "24.36.0.d.1", "24.36.1.cy.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.tf.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.3.tf.1
//   Coordinate number 0:
