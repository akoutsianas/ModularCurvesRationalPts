...
// Magma code for modular curve with label 24.72.3.sd.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.586

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 23, 22, 17], [13, 1, 16, 17], [13, 5, 4, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.bg.1", "24.36.0.bo.1", "24.36.1.by.1", "24.36.1.ci.1", "24.36.1.ex.1", "24.36.2.dx.1", "24.36.2.gb.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.sd.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.3.sd.1
//   Coordinate number 0:
map_2_coord_0 := 1*(t);
//   Coordinate number 1:
