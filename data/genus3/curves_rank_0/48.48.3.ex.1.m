...
// Magma code for modular curve with label 48.48.3.ex.1

// Other names and/or labels
// Cummins-Pauli label: 16F3
// Rouse-Sutherland-Zureick-Brown label: 48.48.3.114

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 36, 0, 29], [5, 41, 30, 5], [27, 44, 28, 29], [43, 23, 2, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.1.k.1", "24.24.0.em.1", "48.24.2.e.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.3.ex.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
