...
// Magma code for modular curve with label 40.72.3.fx.1

// Other names and/or labels
// Cummins-Pauli label: 40C3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.132

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 17, 2, 19], [13, 8, 30, 11], [25, 3, 38, 15], [29, 27, 26, 15], [31, 27, 10, 33], [37, 20, 30, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
