...
// Magma code for modular curve with label 24.72.3.ue.1

// Other names and/or labels
// Cummins-Pauli label: 12D3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.555

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 15, 0, 1], [9, 5, 2, 3], [17, 3, 18, 1], [23, 18, 12, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.bk.1", "24.36.0.b.1", "24.36.1.fc.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.ue.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
