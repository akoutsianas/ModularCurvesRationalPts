...
// Magma code for modular curve with label 24.96.3.hn.1

// Other names and/or labels
// Cummins-Pauli label: 12K3
// Rouse-Sutherland-Zureick-Brown label: 24.96.3.469

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 20, 6, 19], [5, 22, 18, 7], [17, 12, 12, 17], [23, 20, 0, 23], [23, 21, 18, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["12.48.2.f.1", "24.24.0.cr.1", "24.48.1.jg.1", "24.48.2.m.1"];
...
// Embedded model
model_0 := [z^2+2*z*w+w^2+2*t^2+z*u+w*u,z*w+w^2+3*x*t-2*y*t+t^2+w*u,3*x*z-2*y*z+3*x*w-2*y*w+z*t-w*t,6*x*y-3*y^2+2*z^2-2*z*w+2*w^2+t^2,4*z^2-4*z*w+4*w^2-z*u-w*u,9*x*z-6*y*z-9*x*w+6*y*w-z*t-w*t+t*u,54*x^2-6*x*y-9*y^2-z^2-8*z*w-w^2+7*t^2+3*z*u+3*w*u+u^2];
...
// Map from the embedded model to the plane model of modular curve with label 24.96.3.hn.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
