...
// Magma code for modular curve with label 40.60.3.z.1

// Other names and/or labels
// Cummins-Pauli label: 10B3
// Rouse-Sutherland-Zureick-Brown label: 40.60.3.55

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 13, 4, 37], [4, 23, 37, 11], [13, 1, 25, 6], [36, 7, 25, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["20.30.2.d.1", "40.30.0.d.1", "40.30.1.b.1"];
...
model_2 := [2*x^2-2*x*z+121*y^2-302*z^2,-6*x^4-98*x^3*z+20726*x^2*z^2-469862*x*z^3+2746184*z^4-366025*w^2];
...
// Map from the embedded model to the plane model of modular curve with label 40.60.3.z.1
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
