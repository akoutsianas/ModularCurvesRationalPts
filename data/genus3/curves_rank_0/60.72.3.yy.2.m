...
// Magma code for modular curve with label 60.72.3.yy.2

// Other names and/or labels
// Cummins-Pauli label: 20G3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.819

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 25, 48, 41], [47, 55, 2, 23], [51, 20, 56, 33], [51, 25, 26, 49]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.2.a.2", "30.36.0.b.2", "60.36.1.dr.1"];
...
// Embedded model
model_0 := [y*z-y*w+y*u-z*u-w*u,y*z+y*w+y*t+w*t-t^2-y*u-2*t*u,2*y^2+y*w-2*y*t-z*t-y*u-2*t*u+u^2,2*y^2+y*z+2*y*w-y*t-t^2+z*u+t*u+u^2,3*x^2-y*u-z*u+w*u-2*t*u,2*y^2-y*w+3*y*t+z*t+t^2+y*u+2*t*u,2*y^2-y*z-z^2-z*w-w^2+w*t-2*t^2+w*u+t*u];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.yy.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
