...
// Magma code for modular curve with label 24.72.3.zv.1

// Other names and/or labels
// Cummins-Pauli label: 12J3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.416

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 22, 22, 11], [7, 23, 10, 13], [13, 12, 6, 7], [17, 2, 4, 5], [19, 22, 4, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bw.1", "24.36.1.fk.1", "24.36.1.fx.1"];
