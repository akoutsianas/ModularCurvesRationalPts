...
// Magma code for modular curve with label 16.96.3.eg.1

// Other names and/or labels
// Cummins-Pauli label: 16L3
// Rouse-Zureick-Brown label: X576
// Rouse-Sutherland-Zureick-Brown label: 16.96.3.275

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 3, 6, 5], [3, 4, 14, 1], [7, 8, 8, 15], [13, 8, 12, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.bv.1", "16.48.1.bf.1", "16.48.1.db.1"];
