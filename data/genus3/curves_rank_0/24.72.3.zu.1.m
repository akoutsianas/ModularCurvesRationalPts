...
// Magma code for modular curve with label 24.72.3.zu.1

// Other names and/or labels
// Cummins-Pauli label: 12J3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.129

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 20, 10, 7], [3, 4, 14, 9], [5, 15, 12, 19], [7, 12, 6, 5], [19, 13, 16, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bt.1", "24.36.1.fk.1", "24.36.1.ga.1"];
