...
// Magma code for modular curve with label 24.72.3.wk.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.316

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 2, 16, 7], [7, 15, 12, 23], [21, 8, 22, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.x.1", "24.36.0.ca.1", "24.36.1.dq.1", "24.36.1.fl.1", "24.36.2.ff.1", "24.36.2.ft.1", "24.36.2.gd.1"];
...
model_2 := [x^2+y^2+z^2,4*x^4+8*x^3*z-8*x^2*y*z+4*x^2*z^2-32*x*y*z^2+20*x*z^3+12*y*z^3+13*z^4-27*w^2];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.wk.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
