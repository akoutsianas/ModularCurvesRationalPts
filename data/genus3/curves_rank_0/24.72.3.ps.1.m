...
// Magma code for modular curve with label 24.72.3.ps.1

// Other names and/or labels
// Cummins-Pauli label: 24L3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.484

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 3, 12, 17], [5, 8, 4, 11], [5, 15, 0, 13], [13, 7, 8, 7], [23, 11, 20, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.n.1", "24.36.2.cs.1", "24.36.2.cu.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.ps.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
