...
// Magma code for modular curve with label 60.72.3.bg.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.12

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[33, 8, 8, 15], [33, 44, 58, 21], [45, 2, 16, 21], [47, 36, 24, 31], [47, 54, 6, 1], [57, 22, 38, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["6.36.1.b.1", "60.36.0.r.1", "60.36.1.cg.1", "60.36.1.em.1", "60.36.2.c.1", "60.36.2.h.1", "60.36.2.eh.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.bg.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.72.3.bg.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-t);
//   Coordinate number 1:
map_2_coord_1 := 1*(112*z^4-15*z^2*w*t-45*z^2*t^2);
//   Coordinate number 2:
map_2_coord_2 := 1*(z);
// Codomain equation:
