...
// Magma code for modular curve with label 16.96.3.q.1

// Other names and/or labels
// Cummins-Pauli label: 16H3
// Rouse-Zureick-Brown label: X602
// Rouse-Sutherland-Zureick-Brown label: 16.96.3.63

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 4, 8, 5], [7, 12, 4, 11], [7, 12, 8, 15], [11, 12, 4, 7], [11, 12, 10, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
