...
// Magma code for modular curve with label 16.96.3.ci.1

// Other names and/or labels
// Cummins-Pauli label: 16I3
// Rouse-Sutherland-Zureick-Brown label: 16.96.3.212

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 1, 12, 5], [11, 15, 14, 5], [15, 15, 6, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.bq.1", "16.48.0.t.2", "16.48.1.bc.1", "16.48.1.be.1", "16.48.2.j.1", "16.48.2.v.1", "16.48.2.x.1"];
...
// Weierstrass model
model_1 := [34*x^8-112*x^7*z+168*x^6*z^2-112*x^5*z^3+140*x^4*z^4+112*x^3*z^5+168*x^2*z^6+112*x*z^7+y^2+34*z^8];
...
// Map from the embedded model to the Weierstrass model of modular curve with label 16.96.3.ci.1
//   Coordinate number 0:
...
// Codomain equation:
map_1_codomain := [34*x^8-112*x^7*z+168*x^6*z^2-112*x^5*z^3+140*x^4*z^4+112*x^3*z^5+168*x^2*z^6+112*x*z^7+y^2+34*z^8];
