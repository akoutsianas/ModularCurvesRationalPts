...
// Magma code for modular curve with label 24.72.3.uo.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.500

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 22, 14, 19], [19, 5, 10, 7], [23, 22, 4, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bb.1", "24.36.0.bq.1", "24.36.1.cv.1", "24.36.1.ff.1", "24.36.2.fb.1", "24.36.2.fo.1", "24.36.2.fv.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.uo.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
