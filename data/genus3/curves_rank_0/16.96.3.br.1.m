...
// Magma code for modular curve with label 16.96.3.br.1

// Other names and/or labels
// Cummins-Pauli label: 16H3
// Rouse-Sutherland-Zureick-Brown label: 16.96.3.207

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 3, 14, 9], [7, 5, 12, 13], [13, 1, 10, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.v.1", "16.48.1.bu.1", "16.48.1.bz.1"];
