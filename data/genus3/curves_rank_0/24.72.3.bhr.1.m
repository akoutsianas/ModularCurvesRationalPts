...
// Magma code for modular curve with label 24.72.3.bhr.1

// Other names and/or labels
// Cummins-Pauli label: 24Q3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.386

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 10, 20, 1], [1, 11, 16, 19], [1, 16, 14, 19], [3, 7, 16, 9], [5, 6, 18, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bx.1", "24.36.1.gi.1", "24.36.1.gs.1"];
