...
// Magma code for modular curve with label 24.72.3.bdb.1

// Other names and/or labels
// Cummins-Pauli label: 24Q3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.412

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 11, 8, 11], [5, 0, 18, 7], [15, 17, 8, 9], [19, 11, 16, 13], [23, 21, 18, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bz.1", "24.36.1.fq.1", "24.36.1.gp.1"];
