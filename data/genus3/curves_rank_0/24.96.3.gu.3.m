...
// Magma code for modular curve with label 24.96.3.gu.3

// Other names and/or labels
// Cummins-Pauli label: 24W3
// Rouse-Sutherland-Zureick-Brown label: 24.96.3.592

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 0, 20, 19], [13, 15, 8, 23], [17, 0, 20, 11], [19, 3, 0, 5], [23, 15, 8, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.48.0.bu.4", "24.48.1.iu.1", "24.48.2.g.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.96.3.gu.3
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.96.3.gu.3
//   Coordinate number 0:
map_2_coord_0 := 1*(w);
//   Coordinate number 1:
