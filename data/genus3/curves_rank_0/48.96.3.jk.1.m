...
// Magma code for modular curve with label 48.96.3.jk.1

// Other names and/or labels
// Cummins-Pauli label: 16I3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.382

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[15, 47, 28, 1], [21, 44, 44, 25], [27, 26, 32, 11], [33, 17, 28, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.0.p.1", "24.48.1.fn.1", "48.48.1.eq.1", "48.48.1.er.1", "48.48.2.n.1", "48.48.2.em.1", "48.48.2.en.1"];
...
// Embedded model
model_0 := [x*z+w^2-t^2+z*u,2*z^2-w*t+t^2-z*u,x*z-2*w*t-z*u,x*w-2*z*w+2*z*t+t*u,2*z*w+x*t+2*z*t-w*u,x^2+2*w^2+2*t^2+u^2,y^2-3*x*u];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.jk.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(u);
