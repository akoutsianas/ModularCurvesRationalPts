...
// Magma code for modular curve with label 48.96.3.dz.1

// Other names and/or labels
// Cummins-Pauli label: 8B3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.366

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 9, 14, 31], [11, 13, 32, 29], [31, 11, 46, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.0.h.2", "24.48.1.cx.1", "48.48.1.ei.1", "48.48.1.eo.1", "48.48.2.e.1", "48.48.2.dc.1", "48.48.2.di.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.dz.1
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.96.3.dz.1
//   Coordinate number 0:
