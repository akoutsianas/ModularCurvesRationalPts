...
// Magma code for modular curve with label 24.72.3.kh.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.21

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 17, 14, 21], [15, 17, 8, 5], [23, 7, 16, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["6.36.1.c.1", "24.36.0.g.1", "24.36.1.bf.1", "24.36.1.ds.1", "24.36.2.cd.1", "24.36.2.dj.1", "24.36.2.ew.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.kh.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.3.kh.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-t);
//   Coordinate number 1:
map_2_coord_1 := 1*(-5*y^4+9*y^3*w+18*y^2*t^2-6*y*w*t^2-2*t^4);
//   Coordinate number 2:
map_2_coord_2 := 1*(y);
// Codomain equation:
