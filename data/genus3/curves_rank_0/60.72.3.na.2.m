...
// Magma code for modular curve with label 60.72.3.na.2

// Other names and/or labels
// Cummins-Pauli label: 20I3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.813

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 30, 50, 37], [49, 15, 52, 19], [49, 45, 24, 7], [57, 20, 44, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.2.a.1", "60.36.0.c.2", "60.36.1.v.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.na.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.72.3.na.2
//   Coordinate number 0:
map_2_coord_0 := 1*(-1/2*y*w-1/10*w^2);
//   Coordinate number 1:
map_2_coord_1 := 1*(-1/8*y^4*w^3*u-9/100*y^2*w^5*u-9/1000*w^7*u);
//   Coordinate number 2:
