...
// Magma code for modular curve with label 24.96.3.gz.2

// Other names and/or labels
// Cummins-Pauli label: 24W3
// Rouse-Sutherland-Zureick-Brown label: 24.96.3.116

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 6, 20, 11], [5, 15, 4, 13], [5, 21, 0, 19], [17, 15, 16, 17], [23, 0, 12, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["12.48.0.c.2", "24.48.1.ix.1", "24.48.2.g.2"];
...
// Map from the embedded model to the plane model of modular curve with label 24.96.3.gz.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.96.3.gz.2
//   Coordinate number 0:
map_2_coord_0 := 1*(y);
//   Coordinate number 1:
