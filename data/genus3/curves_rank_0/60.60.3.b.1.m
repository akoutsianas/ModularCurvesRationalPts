...
// Magma code for modular curve with label 60.60.3.b.1

// Other names and/or labels
// Cummins-Pauli label: 10B3
// Rouse-Sutherland-Zureick-Brown label: 60.60.3.41

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 30, 50, 7], [15, 11, 47, 50], [30, 31, 7, 10], [35, 29, 29, 30]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['4.2.0.a.1', '15.30.0.a.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["15.30.0.a.1", "20.30.2.d.1", "60.30.1.b.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.60.3.b.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
