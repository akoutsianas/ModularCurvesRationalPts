...
// Magma code for modular curve with label 16.48.3.a.2

// Other names and/or labels
// Cummins-Pauli label: 16B3
// Rouse-Sutherland-Zureick-Brown label: 16.48.3.41

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 14, 8, 7], [5, 10, 2, 7], [7, 0, 0, 7], [11, 10, 4, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["8.24.1.b.1", "16.24.0.p.1", "16.24.2.b.2"];
...
// Map from the embedded model to the plane model of modular curve with label 16.48.3.a.2
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 16.48.3.a.2
//   Coordinate number 0:
map_2_coord_0 := 1*(-z);
//   Coordinate number 1:
map_2_coord_1 := 1*(z^3*w-2*t^4);
//   Coordinate number 2:
map_2_coord_2 := 1*(t);
// Codomain equation:
