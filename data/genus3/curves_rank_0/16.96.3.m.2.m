...
// Magma code for modular curve with label 16.96.3.m.2

// Other names and/or labels
// Cummins-Pauli label: 16O3
// Rouse-Zureick-Brown label: X608
// Rouse-Sutherland-Zureick-Brown label: 16.96.3.159

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 2, 8, 1], [5, 0, 12, 15], [5, 10, 8, 15], [13, 2, 12, 1], [15, 10, 4, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
