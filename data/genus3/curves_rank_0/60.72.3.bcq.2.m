...
// Magma code for modular curve with label 60.72.3.bcq.2

// Other names and/or labels
// Cummins-Pauli label: 30J3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.871

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 40, 44, 7], [33, 5, 8, 57], [47, 50, 14, 37], [52, 15, 39, 26]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["30.36.2.b.2", "60.36.0.ch.2", "60.36.1.dt.1"];
...
// Embedded model
model_0 := [x^2+y*w,x^2+x*z+w*u,y^2+w*u,x*y+x*w+z*w,x*y+y*z-x*u,y^2+x*z+z^2-y*u,4*x^2+2*y^2-x*z+z^2-4*y*w-25*w^2-5*t^2+y*u-2*w*u-u^2];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.bcq.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.72.3.bcq.2
//   Coordinate number 0:
map_2_coord_0 := 1*(-x);
//   Coordinate number 1:
