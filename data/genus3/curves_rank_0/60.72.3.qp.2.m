...
// Magma code for modular curve with label 60.72.3.qp.2

// Other names and/or labels
// Cummins-Pauli label: 20I3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.804

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 55, 16, 37], [23, 5, 52, 17], [59, 20, 6, 53], [59, 55, 44, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.1.d.1", "60.36.0.c.1", "60.36.2.fq.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.qp.2
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.72.3.qp.2
//   Coordinate number 0:
map_2_coord_0 := 1*(1/2*z*t-1/2*t^2);
//   Coordinate number 1:
map_2_coord_1 := 1*(225/8*z^4*t^3*u+45/4*z^2*t^5*u+5/8*t^7*u);
//   Coordinate number 2:
map_2_coord_2 := 1*(z*t);
// Codomain equation:
