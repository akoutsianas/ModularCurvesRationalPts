...
// Magma code for modular curve with label 40.72.3.fu.2

// Other names and/or labels
// Cummins-Pauli label: 40C3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.110

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 11, 34, 19], [15, 34, 8, 31], [17, 25, 18, 29], [19, 27, 30, 31], [21, 3, 22, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
