...
// Magma code for modular curve with label 40.72.3.fv.2

// Other names and/or labels
// Cummins-Pauli label: 40C3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.107

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 37, 30, 3], [15, 22, 28, 29], [27, 0, 36, 31], [39, 2, 28, 33], [39, 35, 6, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
