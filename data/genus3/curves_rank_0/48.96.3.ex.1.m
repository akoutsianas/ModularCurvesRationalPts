...
// Magma code for modular curve with label 48.96.3.ex.1

// Other names and/or labels
// Cummins-Pauli label: 16I3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.1046

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 14, 4, 27], [9, 38, 32, 17], [27, 19, 28, 45], [39, 41, 8, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.h.1", "24.48.1.fn.1", "48.48.0.p.1", "48.48.1.cu.1", "48.48.1.cv.1", "48.48.2.cq.1", "48.48.2.cr.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.ex.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
