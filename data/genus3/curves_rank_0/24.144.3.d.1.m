...
// Magma code for modular curve with label 24.144.3.d.1

// Other names and/or labels
// Cummins-Pauli label: 24AC3
// Rouse-Sutherland-Zureick-Brown label: 24.144.3.38

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 18, 0, 5], [7, 15, 12, 23], [13, 21, 0, 1], [17, 9, 6, 5], [23, 15, 0, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.1.d.1", "24.48.0.br.1", "24.48.0.br.2"];
