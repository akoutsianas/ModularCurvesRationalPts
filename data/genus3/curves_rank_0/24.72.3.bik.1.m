...
// Magma code for modular curve with label 24.72.3.bik.1

// Other names and/or labels
// Cummins-Pauli label: 24I3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.363

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 22, 4, 19], [7, 12, 0, 23], [11, 12, 0, 23], [21, 2, 20, 9], [21, 17, 14, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bp.1", "24.36.0.cg.1", "24.36.2.gl.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.bik.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(u);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.3.bik.1
//   Coordinate number 0:
map_2_coord_0 := 1*(t);
//   Coordinate number 1:
