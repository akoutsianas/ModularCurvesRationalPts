...
// Magma code for modular curve with label 48.96.3.be.1

// Other names and/or labels
// Cummins-Pauli label: 16O3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.106

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 10, 20, 13], [7, 2, 36, 35], [33, 26, 40, 43], [39, 4, 4, 5], [41, 2, 24, 7], [41, 18, 16, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
