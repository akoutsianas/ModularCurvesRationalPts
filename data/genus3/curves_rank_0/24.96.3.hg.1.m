...
// Magma code for modular curve with label 24.96.3.hg.1

// Other names and/or labels
// Cummins-Pauli label: 24V3
// Rouse-Sutherland-Zureick-Brown label: 24.96.3.561

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 7, 0, 23], [7, 2, 18, 13], [11, 9, 18, 5], [17, 12, 0, 17], [17, 14, 12, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.24.0.ck.1", "24.48.1.jj.1", "24.48.2.h.1", "24.48.2.k.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.96.3.hg.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
