...
// Magma code for modular curve with label 24.96.3.gx.3

// Other names and/or labels
// Cummins-Pauli label: 24W3
// Rouse-Sutherland-Zureick-Brown label: 24.96.3.602

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 12, 20, 13], [13, 9, 16, 11], [17, 3, 12, 7], [19, 9, 0, 19], [19, 18, 16, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.48.0.bu.3", "24.48.1.ix.1", "24.48.2.f.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.96.3.gx.3
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(8*u);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.96.3.gx.3
//   Coordinate number 0:
map_2_coord_0 := 1*(t);
//   Coordinate number 1:
