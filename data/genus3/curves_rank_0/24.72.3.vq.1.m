...
// Magma code for modular curve with label 24.72.3.vq.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.491

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 1, 6, 23], [1, 8, 14, 11], [21, 11, 22, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.y.1", "24.36.0.bw.1", "24.36.1.cv.1", "24.36.1.fl.1", "24.36.2.ey.1", "24.36.2.fi.1", "24.36.2.gb.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.vq.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
