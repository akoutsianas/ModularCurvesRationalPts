...
// Magma code for modular curve with label 32.96.3.by.2

// Other names and/or labels
// Cummins-Pauli label: 32N3
// Rouse-Zureick-Brown label: X645
// Rouse-Sutherland-Zureick-Brown label: 32.96.3.225

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[15, 31, 18, 25], [19, 4, 20, 25], [23, 21, 14, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
