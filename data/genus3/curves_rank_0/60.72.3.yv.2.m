...
// Magma code for modular curve with label 60.72.3.yv.2

// Other names and/or labels
// Cummins-Pauli label: 20G3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.726

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 25, 44, 33], [29, 50, 40, 47], [37, 55, 48, 7], [51, 25, 34, 47]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.0.a.2", "60.36.1.dr.1", "60.36.2.fr.2"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.yv.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(u);
