...
// Magma code for modular curve with label 24.72.3.bep.1

// Other names and/or labels
// Cummins-Pauli label: 24Q3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.842

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 11, 20, 19], [9, 7, 20, 3], [15, 14, 20, 15], [19, 12, 12, 23], [23, 13, 10, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.gd.1", "24.36.1.gi.1", "24.36.1.gp.1"];
