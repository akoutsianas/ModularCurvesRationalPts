...
// Magma code for modular curve with label 24.72.3.bdx.1

// Other names and/or labels
// Cummins-Pauli label: 24P3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.797

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 17, 14, 11], [3, 4, 10, 9], [17, 15, 6, 19], [17, 20, 4, 17], [19, 15, 6, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fx.1", "24.36.1.gf.1", "24.36.1.go.1"];
