...
// Magma code for modular curve with label 60.72.3.yv.1

// Other names and/or labels
// Cummins-Pauli label: 20G3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.722

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 40, 24, 7], [37, 25, 36, 43], [43, 55, 38, 31], [49, 35, 56, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.0.a.1", "60.36.1.dr.1", "60.36.2.fr.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.yv.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
