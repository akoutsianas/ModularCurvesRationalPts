...
// Magma code for modular curve with label 40.72.3.cz.2

// Other names and/or labels
// Cummins-Pauli label: 20I3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.71

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 18, 36, 11], [11, 5, 38, 13], [13, 14, 24, 33], [29, 39, 28, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.0.c.2", "40.36.1.e.1", "40.36.2.a.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.cz.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.72.3.cz.2
//   Coordinate number 0:
