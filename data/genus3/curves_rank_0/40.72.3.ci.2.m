...
// Magma code for modular curve with label 40.72.3.ci.2

// Other names and/or labels
// Cummins-Pauli label: 20H3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.123

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 7, 8, 25], [7, 31, 24, 39], [11, 32, 14, 9], [21, 0, 28, 13], [33, 21, 36, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.1.b.1", "40.36.0.e.2", "40.36.2.b.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.ci.2
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.72.3.ci.2
//   Coordinate number 0:
map_2_coord_0 := 1*(-1/2*u^2);
//   Coordinate number 1:
map_2_coord_1 := 1*(480*z*w*t^3*u^3-96*z*w*t*u^5+160*z*t^4*u^3-92*z*t^2*u^5+13/2*z*u^7);
//   Coordinate number 2:
map_2_coord_2 := 1*(-3/2*w*u-1/2*t*u);
// Codomain equation:
