...
// Magma code for modular curve with label 24.72.3.li.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.741

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 5, 22, 5], [7, 0, 0, 7], [9, 23, 10, 21], [15, 8, 2, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.y.1", "24.36.0.z.1", "24.36.1.bn.1", "24.36.1.cw.1", "24.36.1.en.1", "24.36.2.bw.1", "24.36.2.ea.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.li.1
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.3.li.1
//   Coordinate number 0:
