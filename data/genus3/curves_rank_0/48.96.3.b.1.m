...
// Magma code for modular curve with label 48.96.3.b.1

// Other names and/or labels
// Cummins-Pauli label: 8B3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.189

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 20, 10, 29], [11, 34, 22, 37], [17, 10, 42, 47], [33, 28, 38, 15], [45, 28, 40, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.c.1", "48.48.0.a.1", "48.48.1.fg.1", "48.48.1.fy.1", "48.48.2.a.1", "48.48.2.u.1", "48.48.2.bk.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.b.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
