...
// Magma code for modular curve with label 40.72.3.bb.1

// Other names and/or labels
// Cummins-Pauli label: 20I3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.158

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 33, 22, 5], [15, 8, 8, 35], [25, 26, 26, 25], [27, 5, 38, 39], [37, 30, 6, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.1.a.1", "40.36.0.d.2", "40.36.2.b.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.bb.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.72.3.bb.1
//   Coordinate number 0:
