...
// Magma code for modular curve with label 24.72.3.kq.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.532

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 9, 6, 19], [17, 23, 2, 19], [19, 23, 20, 15], [21, 14, 16, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bd.1", "24.36.0.l.1", "24.36.1.bi.1", "24.36.1.ca.1", "24.36.2.ce.1", "24.36.2.df.1", "24.36.2.fa.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.kq.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
