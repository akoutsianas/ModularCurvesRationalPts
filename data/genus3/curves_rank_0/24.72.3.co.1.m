...
// Magma code for modular curve with label 24.72.3.co.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.282

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 11, 16, 7], [5, 3, 0, 17], [7, 16, 14, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.r.1", "24.36.0.bb.1", "24.36.1.e.1", "24.36.1.dy.1", "24.36.2.k.1", "24.36.2.r.1", "24.36.2.fl.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.co.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
