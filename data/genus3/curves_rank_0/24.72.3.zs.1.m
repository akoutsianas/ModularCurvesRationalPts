...
// Magma code for modular curve with label 24.72.3.zs.1

// Other names and/or labels
// Cummins-Pauli label: 12J3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.116

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 13, 8, 9], [7, 11, 22, 1], [7, 15, 18, 17], [9, 14, 10, 15], [13, 11, 8, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bs.1", "24.24.1.ew.1", "24.36.1.fk.1", "24.36.1.gb.1"];
