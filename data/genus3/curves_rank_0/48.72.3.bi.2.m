...
// Magma code for modular curve with label 48.72.3.bi.2

// Other names and/or labels
// Cummins-Pauli label: 48F3
// Rouse-Sutherland-Zureick-Brown label: 48.72.3.46

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 7, 34, 19], [15, 35, 20, 9], [19, 11, 44, 29], [31, 31, 26, 25], [35, 8, 4, 47], [47, 41, 34, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
// Map from the embedded model to the plane model of modular curve with label 48.72.3.bi.2
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.72.3.bi.2
//   Coordinate number 0:
map_2_coord_0 := 1*(-z);
//   Coordinate number 1:
