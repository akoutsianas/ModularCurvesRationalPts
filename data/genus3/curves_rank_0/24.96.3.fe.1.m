...
// Magma code for modular curve with label 24.96.3.fe.1

// Other names and/or labels
// Cummins-Pauli label: 24V3
// Rouse-Sutherland-Zureick-Brown label: 24.96.3.551

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 3, 0, 17], [1, 18, 4, 7], [5, 3, 16, 13], [5, 15, 20, 5], [19, 9, 12, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.24.0.bm.1", "24.48.1.in.1", "24.48.1.iq.1", "24.48.1.it.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.96.3.fe.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
