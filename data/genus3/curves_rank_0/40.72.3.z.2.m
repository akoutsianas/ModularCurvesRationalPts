...
// Magma code for modular curve with label 40.72.3.z.2

// Other names and/or labels
// Cummins-Pauli label: 20I3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.216

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 18, 14, 35], [25, 32, 12, 15], [27, 20, 28, 29], [31, 1, 4, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.2.a.2", "40.36.0.c.2", "40.36.1.b.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.z.2
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.72.3.z.2
//   Coordinate number 0:
map_2_coord_0 := 1*(w*u);
//   Coordinate number 1:
