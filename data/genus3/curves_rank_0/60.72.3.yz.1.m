...
// Magma code for modular curve with label 60.72.3.yz.1

// Other names and/or labels
// Cummins-Pauli label: 20G3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.838

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 55, 8, 53], [7, 30, 34, 11], [31, 30, 8, 29], [43, 15, 40, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.2.b.1", "60.36.0.b.1", "60.36.1.dr.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.yz.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
