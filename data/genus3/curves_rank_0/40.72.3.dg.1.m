...
// Magma code for modular curve with label 40.72.3.dg.1

// Other names and/or labels
// Cummins-Pauli label: 20H3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.192

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[23, 3, 16, 25], [29, 12, 18, 3], [31, 7, 24, 39], [37, 26, 4, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.1.e.1", "40.36.0.e.1", "40.36.2.b.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.dg.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.72.3.dg.1
//   Coordinate number 0:
map_2_coord_0 := 1*(4/33*w^2*t^4-19/825*w^2*t^2*u^2+169/66000*w^2*u^4+5/33*t^6-83/1320*t^4*u^2+1/40*t^3*u^3+13/3300*t^2*u^4);
//   Coordinate number 1:
map_2_coord_1 := 1*(-76/111375*w^3*t^15*u^6-4/111375*w^3*t^14*u^7+329/928125*w^3*t^13*u^8-113/1856250*w^3*t^12*u^9-63631/1113750000*w^3*t^11*u^10+13481/1113750000*w^3*t^10*u^11+52897/11137500000*w^3*t^9*u^12-63713/44550000000*w^3*t^8*u^13-19/22275*w*t^17*u^6-1/22275*w*t^16*u^7+1949/4455000*w*t^15*u^8-103/2227500*w*t^14*u^9-94471/891000000*w*t^13*u^10+27127/891000000*w*t^12*u^11+157313/35640000000*w*t^11*u^12-4901/2227500000*w*t^10*u^13);
//   Coordinate number 2:
