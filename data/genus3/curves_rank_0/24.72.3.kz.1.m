...
// Magma code for modular curve with label 24.72.3.kz.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.664

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 6, 12, 13], [13, 7, 20, 1], [19, 8, 8, 23], [19, 23, 8, 17], [21, 20, 20, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.t.1", "24.36.0.r.1", "24.36.1.bh.1", "24.36.1.cf.1", "24.36.1.ed.1", "24.36.2.dh.1", "24.36.2.ff.1"];
...
model_2 := [x^2+y^2+z^2,-22*x^4+72*x^3*y+208*x^3*z-8*x^2*y*z-148*x^2*z^2-8*x*y*z^2+208*x*z^3+72*y*z^3-22*z^4-27*w^2];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.kz.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
