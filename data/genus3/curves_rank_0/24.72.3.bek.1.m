...
// Magma code for modular curve with label 24.72.3.bek.1

// Other names and/or labels
// Cummins-Pauli label: 24Q3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.398

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 8, 4, 7], [11, 9, 0, 13], [13, 14, 8, 5], [19, 6, 12, 23], [23, 0, 18, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.by.1", "24.36.1.gi.1", "24.36.1.go.1"];
