...
// Magma code for modular curve with label 40.144.3.j.2

// Other names and/or labels
// Cummins-Pauli label: 40J3
// Rouse-Sutherland-Zureick-Brown label: 40.144.3.338

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 22, 16, 33], [11, 0, 32, 19], [13, 33, 12, 39], [15, 1, 4, 17], [17, 19, 16, 25], [35, 33, 4, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
