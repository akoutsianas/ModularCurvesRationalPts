...
// Magma code for modular curve with label 48.48.3.ed.2

// Other names and/or labels
// Cummins-Pauli label: 16F3
// Rouse-Sutherland-Zureick-Brown label: 48.48.3.106

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 44, 36, 41], [19, 3, 10, 1], [21, 22, 32, 35], [43, 45, 22, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.1.i.1", "24.24.0.em.1", "48.24.2.e.2"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.3.ed.2
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
