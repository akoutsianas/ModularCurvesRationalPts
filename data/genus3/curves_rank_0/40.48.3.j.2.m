...
// Magma code for modular curve with label 40.48.3.j.2

// Other names and/or labels
// Cummins-Pauli label: 20B3
// Rouse-Sutherland-Zureick-Brown label: 40.48.3.11

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 39, 7, 22], [29, 10, 38, 31], [31, 30, 19, 17], [34, 19, 15, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["20.24.1.g.1", "40.12.0.bp.2"];
