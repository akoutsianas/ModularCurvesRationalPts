...
// Magma code for modular curve with label 48.96.3.gs.1

// Other names and/or labels
// Cummins-Pauli label: 24V3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.1617

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 38, 6, 25], [35, 7, 42, 43], [35, 16, 36, 35], [37, 47, 12, 31], [41, 8, 0, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.48.1.dp.1", "48.24.0.a.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.gs.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*w);
