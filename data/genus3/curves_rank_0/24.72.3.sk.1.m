...
// Magma code for modular curve with label 24.72.3.sk.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.733

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 18, 18, 17], [19, 16, 8, 13], [23, 21, 18, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.bh.1", "24.36.0.bl.1", "24.36.1.cb.1", "24.36.1.cl.1", "24.36.1.fa.1", "24.36.2.ea.1", "24.36.2.gb.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.sk.1
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
