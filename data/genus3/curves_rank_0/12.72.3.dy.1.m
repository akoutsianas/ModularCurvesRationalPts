...
// Magma code for modular curve with label 12.72.3.dy.1

// Other names and/or labels
// Cummins-Pauli label: 12J3
// Rouse-Sutherland-Zureick-Brown label: 12.72.3.31

// Group data
level := 12;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 11, 8, 7], [11, 1, 8, 5], [11, 10, 2, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.24.1.p.1", "12.36.1.br.1", "12.36.1.bs.1", "12.36.1.bw.1"];
