...
// Magma code for modular curve with label 32.96.3.z.1

// Other names and/or labels
// Cummins-Pauli label: 32O3
// Rouse-Zureick-Brown label: X648
// Rouse-Sutherland-Zureick-Brown label: 32.96.3.103

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 17, 24, 13], [13, 31, 8, 11], [25, 0, 16, 9], [27, 13, 8, 13], [31, 0, 16, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
