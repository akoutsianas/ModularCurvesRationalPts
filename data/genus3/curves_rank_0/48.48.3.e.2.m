...
// Magma code for modular curve with label 48.48.3.e.2

// Other names and/or labels
// Cummins-Pauli label: 16B3
// Rouse-Sutherland-Zureick-Brown label: 48.48.3.35

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 2, 20, 33], [13, 30, 4, 31], [19, 34, 36, 37], [25, 0, 8, 35], [31, 16, 16, 29], [31, 34, 4, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["8.24.1.c.1", "48.24.0.o.1", "48.24.2.e.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.3.e.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.3.e.2
//   Coordinate number 0:
map_2_coord_0 := 1*(w);
//   Coordinate number 1:
map_2_coord_1 := 1*(-9/16*y^3*z-w^4);
//   Coordinate number 2:
