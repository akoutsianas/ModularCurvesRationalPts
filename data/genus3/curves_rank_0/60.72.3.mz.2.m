...
// Magma code for modular curve with label 60.72.3.mz.2

// Other names and/or labels
// Cummins-Pauli label: 20I3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.846

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 50, 40, 41], [9, 35, 26, 9], [23, 15, 26, 31], [53, 35, 8, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.2.b.2", "30.36.1.d.1", "60.36.0.c.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.mz.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(u);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.72.3.mz.2
//   Coordinate number 0:
map_2_coord_0 := 1*(-y^3-3*y^2*z-3*y*z^2-2*z^3);
//   Coordinate number 1:
map_2_coord_1 := 1*(-2/9*y^12-8/3*y^11*z-44/3*y^10*z^2+16/3*y^10*u^2-448/9*y^9*z^3+116/3*y^9*z*u^2-118*y^8*z^4+123*y^8*z^2*u^2-208*y^7*z^5+233*y^7*z^3*u^2-844/3*y^6*z^6+286*y^6*z^4*u^2-296*y^5*z^7+213*y^5*z^5*u^2-242*y^4*z^8+58*y^4*z^6*u^2-1360/9*y^3*z^9-67*y^3*z^7*u^2-208/3*y^2*z^10-93*y^2*z^8*u^2-64/3*y*z^11-160/3*y*z^9*u^2-32/9*z^12-44/3*z^10*u^2);
//   Coordinate number 2:
