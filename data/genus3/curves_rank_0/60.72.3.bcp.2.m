...
// Magma code for modular curve with label 60.72.3.bcp.2

// Other names and/or labels
// Cummins-Pauli label: 30J3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.665

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[36, 35, 47, 24], [38, 35, 23, 19], [43, 20, 35, 29], [43, 30, 0, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["15.36.1.d.1", "60.36.0.ch.2", "60.36.2.fv.2"];
...
// Embedded model
model_0 := [x^2-z*w,x^2+x*y-z^2,x*z-x*w-y*w,x*y+w^2+w*t+2*w*u,y^2+z^2+z*t+2*z*u,y*z+x*w+x*t+2*x*u,x^2+x*y+z^2+z*w-5*w^2+w*t+t^2+2*w*u-t*u-u^2];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.bcp.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(u);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.72.3.bcp.2
//   Coordinate number 0:
map_2_coord_0 := 1*(-x);
//   Coordinate number 1:
map_2_coord_1 := 1*(-3*x^4+2*x^2*w^2-3*w^4-5*w^3*u);
//   Coordinate number 2:
map_2_coord_2 := 1*(w);
// Codomain equation:
