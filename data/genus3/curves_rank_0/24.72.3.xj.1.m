...
// Magma code for modular curve with label 24.72.3.xj.1

// Other names and/or labels
// Cummins-Pauli label: 12J3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.271

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 13, 8, 9], [7, 9, 6, 1], [19, 10, 2, 13], [21, 8, 4, 21], [21, 14, 22, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bm.1", "24.36.1.fz.1", "24.36.1.ga.1"];
