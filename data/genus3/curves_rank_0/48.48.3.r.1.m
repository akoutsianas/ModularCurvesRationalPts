...
// Magma code for modular curve with label 48.48.3.r.1

// Other names and/or labels
// Cummins-Pauli label: 16D3
// Rouse-Sutherland-Zureick-Brown label: 48.48.3.68

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 8, 8, 33], [1, 21, 6, 17], [13, 15, 18, 5], [25, 3, 18, 25], [43, 41, 26, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["8.24.1.l.1", "48.24.2.a.1", "48.24.2.b.1"];
...
model_2 := [3*x^2-y^2-z^2,252*x^4-144*x^3*y-60*x^2*z^2+12*x*y*z^2+5*z^4-w^2];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.3.r.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(u);
