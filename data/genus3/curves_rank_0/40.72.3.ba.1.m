...
// Magma code for modular curve with label 40.72.3.ba.1

// Other names and/or labels
// Cummins-Pauli label: 20I3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.62

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 37, 22, 5], [11, 30, 20, 21], [15, 12, 36, 31], [37, 29, 8, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.0.b.2", "40.36.1.b.1", "40.36.2.a.2"];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.ba.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.72.3.ba.1
//   Coordinate number 0:
