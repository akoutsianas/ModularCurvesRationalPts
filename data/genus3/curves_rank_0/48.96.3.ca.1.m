...
// Magma code for modular curve with label 48.96.3.ca.1

// Other names and/or labels
// Cummins-Pauli label: 16J3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.440

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[15, 46, 16, 9], [23, 14, 32, 37], [31, 6, 24, 11], [33, 46, 16, 31], [37, 6, 32, 47]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.a.2", "24.48.0.ba.1", "48.48.2.d.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.ca.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
