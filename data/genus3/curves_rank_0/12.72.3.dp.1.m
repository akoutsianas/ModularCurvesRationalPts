...
// Magma code for modular curve with label 12.72.3.dp.1

// Other names and/or labels
// Cummins-Pauli label: 12J3
// Rouse-Sutherland-Zureick-Brown label: 12.72.3.96

// Group data
level := 12;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 11, 8, 3], [11, 5, 8, 1], [11, 8, 2, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bn.1", "12.36.1.bt.1", "12.36.1.bz.1"];
