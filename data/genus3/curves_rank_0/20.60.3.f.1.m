...
// Magma code for modular curve with label 20.60.3.f.1

// Other names and/or labels
// Cummins-Pauli label: 10B3
// Rouse-Sutherland-Zureick-Brown label: 20.60.3.16

// Group data
level := 20;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 1, 2, 1], [13, 0, 10, 13], [18, 11, 15, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["10.30.1.c.1", "20.30.0.a.1", "20.30.2.d.1"];
...
// Map from the embedded model to the plane model of modular curve with label 20.60.3.f.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(5*z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 20.60.3.f.1
//   Coordinate number 0:
