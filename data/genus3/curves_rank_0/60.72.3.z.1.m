...
// Magma code for modular curve with label 60.72.3.z.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.11

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 52, 10, 3], [33, 22, 14, 15], [33, 46, 16, 3], [41, 6, 12, 19], [49, 54, 30, 17], [59, 48, 0, 41]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['3.6.0.b.1', '20.12.0.b.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["6.36.1.b.1", "60.36.0.x.1", "60.36.1.cb.1", "60.36.1.es.1", "60.36.2.b.1", "60.36.2.e.1", "60.36.2.eb.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.z.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.72.3.z.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-w^2);
//   Coordinate number 1:
map_2_coord_1 := 1*(-13*x^4*w^4-25*x^4*w^3*t-5*x^2*w^6+10*x^2*w^5*t-w^8-w^7*t);
//   Coordinate number 2:
map_2_coord_2 := 1*(x*w);
// Codomain equation:
