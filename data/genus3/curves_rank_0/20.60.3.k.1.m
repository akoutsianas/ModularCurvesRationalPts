...
// Magma code for modular curve with label 20.60.3.k.1

// Other names and/or labels
// Cummins-Pauli label: 10B3
// Rouse-Sutherland-Zureick-Brown label: 20.60.3.8

// Group data
level := 20;
// Elements that, together with Gamma(level), generate the group
gens := [[2, 17, 15, 1], [7, 0, 10, 7], [14, 9, 15, 12]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["5.30.0.a.1", "20.12.1.b.1", "20.30.1.a.1", "20.30.2.h.1"];
...
// Map from the embedded model to the plane model of modular curve with label 20.60.3.k.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 20.60.3.k.1
//   Coordinate number 0:
