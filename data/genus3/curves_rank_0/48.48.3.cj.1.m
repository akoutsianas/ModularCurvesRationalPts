...
// Magma code for modular curve with label 48.48.3.cj.1

// Other names and/or labels
// Cummins-Pauli label: 16C3
// Rouse-Sutherland-Zureick-Brown label: 48.48.3.202

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 19, 16, 39], [21, 35, 38, 35], [25, 3, 28, 43], [27, 22, 2, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.2.b.1", "24.24.0.fa.1", "48.24.1.n.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.3.cj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
