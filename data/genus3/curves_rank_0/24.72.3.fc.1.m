...
// Magma code for modular curve with label 24.72.3.fc.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.549

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 11, 14, 5], [5, 18, 0, 13], [7, 19, 14, 19], [9, 11, 2, 21], [17, 12, 12, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.i.1", "24.36.0.bj.1", "24.36.1.s.1", "24.36.1.bn.1", "24.36.1.fh.1", "24.36.2.bh.1", "24.36.2.db.1"];
...
model_1 := [x^2+y^2+z^2,2*x^4-24*x^2*z^2-24*z^4-w^2];
