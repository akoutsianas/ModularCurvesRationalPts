...
// Magma code for modular curve with label 24.96.3.gt.3

// Other names and/or labels
// Cummins-Pauli label: 24W3
// Rouse-Sutherland-Zureick-Brown label: 24.96.3.589

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 3, 16, 1], [17, 12, 20, 5], [17, 18, 16, 13], [19, 12, 12, 1], [23, 12, 0, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.48.0.bu.4", "24.48.1.iv.1", "24.48.2.f.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.96.3.gt.3
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.96.3.gt.3
//   Coordinate number 0:
map_2_coord_0 := 1*(w);
//   Coordinate number 1:
