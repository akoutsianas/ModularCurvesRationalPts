...
// Magma code for modular curve with label 48.96.3.jy.1

// Other names and/or labels
// Cummins-Pauli label: 16J3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.402

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 32, 16, 27], [25, 38, 16, 25], [35, 22, 16, 37], [43, 47, 36, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.0.s.1", "48.48.1.p.1", "48.48.2.o.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.jy.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*w);
