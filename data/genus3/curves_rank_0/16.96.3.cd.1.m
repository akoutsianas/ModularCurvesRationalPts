...
// Magma code for modular curve with label 16.96.3.cd.1

// Other names and/or labels
// Cummins-Pauli label: 16J3
// Rouse-Sutherland-Zureick-Brown label: 16.96.3.320

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 1, 12, 5], [7, 4, 0, 7], [9, 12, 4, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.0.s.1", "16.48.1.o.1", "16.48.2.i.1"];
...
// Map from the embedded model to the plane model of modular curve with label 16.96.3.cd.1
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
