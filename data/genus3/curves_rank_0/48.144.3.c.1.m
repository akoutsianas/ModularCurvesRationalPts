...
// Magma code for modular curve with label 48.144.3.c.1

// Other names and/or labels
// Cummins-Pauli label: 48M3
// Rouse-Sutherland-Zureick-Brown label: 48.144.3.43

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 47, 34, 11], [29, 6, 12, 29], [43, 37, 46, 29], [43, 38, 32, 5], [45, 2, 16, 39]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.ee.1", "48.72.0.a.2", "48.72.2.c.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.3.c.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.3.c.1
//   Coordinate number 0:
map_2_coord_0 := 1*(z);
//   Coordinate number 1:
