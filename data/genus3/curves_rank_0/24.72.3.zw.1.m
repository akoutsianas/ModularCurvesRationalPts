...
// Magma code for modular curve with label 24.72.3.zw.1

// Other names and/or labels
// Cummins-Pauli label: 12J3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.352

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 11, 14, 23], [7, 10, 22, 5], [7, 11, 8, 17], [15, 23, 16, 21], [17, 10, 8, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bu.1", "24.36.1.fk.1", "24.36.1.gd.1"];
