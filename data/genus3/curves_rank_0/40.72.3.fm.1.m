...
// Magma code for modular curve with label 40.72.3.fm.1

// Other names and/or labels
// Cummins-Pauli label: 20K3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.128

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 26, 36, 25], [5, 38, 26, 7], [9, 3, 36, 31], [29, 27, 30, 11], [33, 4, 2, 35], [37, 22, 10, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
