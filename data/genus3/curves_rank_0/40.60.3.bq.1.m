...
// Magma code for modular curve with label 40.60.3.bq.1

// Other names and/or labels
// Cummins-Pauli label: 20E3
// Rouse-Sutherland-Zureick-Brown label: 40.60.3.15

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[15, 22, 19, 15], [23, 8, 39, 13], [25, 36, 18, 35], [29, 32, 29, 11], [37, 38, 21, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
