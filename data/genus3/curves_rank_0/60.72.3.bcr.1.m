...
// Magma code for modular curve with label 60.72.3.bcr.1

// Other names and/or labels
// Cummins-Pauli label: 30J3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.857

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 35, 52, 21], [11, 40, 26, 41], [23, 5, 34, 47], [59, 25, 31, 28]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["30.36.0.f.1", "60.36.1.dt.1", "60.36.2.fv.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.bcr.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.72.3.bcr.1
//   Coordinate number 0:
map_2_coord_0 := 1*(w);
//   Coordinate number 1:
