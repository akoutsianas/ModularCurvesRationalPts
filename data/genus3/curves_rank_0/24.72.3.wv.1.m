...
// Magma code for modular curve with label 24.72.3.wv.1

// Other names and/or labels
// Cummins-Pauli label: 24O3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.455

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 8, 14, 17], [9, 2, 2, 3], [9, 14, 16, 9], [9, 17, 10, 3], [17, 0, 0, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bn.1", "24.36.1.fp.1", "24.36.1.ft.1"];
