...
// Magma code for modular curve with label 32.96.3.m.1

// Other names and/or labels
// Cummins-Pauli label: 32J3
// Rouse-Zureick-Brown label: X621
// Rouse-Sutherland-Zureick-Brown label: 32.96.3.196

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 1, 0, 29], [13, 1, 0, 1], [15, 24, 0, 23], [21, 22, 0, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.i.1", "32.48.1.b.1", "32.48.1.b.2"];
