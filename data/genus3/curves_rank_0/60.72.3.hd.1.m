...
// Magma code for modular curve with label 60.72.3.hd.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.471

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[29, 40, 44, 41], [35, 8, 28, 35], [47, 54, 6, 29], [57, 10, 1, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.z.1", "30.36.1.m.1", "60.36.0.bp.1", "60.36.1.g.1", "60.36.1.ei.1", "60.36.2.q.1", "60.36.2.cm.1"];
...
// Embedded model
model_0 := [x^2+2*x*y+x*z+z^2+w^2,2*x*w+3*y*w-2*z*w+x*u+z*u,2*x*w+4*z*w-x*u,2*x^2-x*y+2*x*z+2*z^2-2*w^2,5*y*z-2*w^2+w*u,4*x^2-2*x*y+4*y^2+w^2+x*t+y*t+t^2,4*x^2-7*x*y-11*y^2+5*y*z+7*w^2+x*t+y*t+t^2+w*u+u^2];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.hd.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
