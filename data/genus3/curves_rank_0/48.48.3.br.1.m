...
// Magma code for modular curve with label 48.48.3.br.1

// Other names and/or labels
// Cummins-Pauli label: 16F3
// Rouse-Sutherland-Zureick-Brown label: 48.48.3.179

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 47, 18, 5], [27, 31, 26, 39], [29, 36, 36, 35], [33, 31, 10, 43]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.2.a.2", "24.24.0.em.2", "48.24.1.j.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.3.br.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
