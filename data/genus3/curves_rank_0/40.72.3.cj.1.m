...
// Magma code for modular curve with label 40.72.3.cj.1

// Other names and/or labels
// Cummins-Pauli label: 20H3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.236

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 15, 10, 1], [3, 39, 16, 21], [7, 0, 34, 13], [27, 6, 8, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.2.b.1", "40.36.0.e.1", "40.36.1.c.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.cj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.72.3.cj.1
//   Coordinate number 0:
map_2_coord_0 := 1*(1/30*u^2);
//   Coordinate number 1:
map_2_coord_1 := 1*(64/273375*z*w*t^3*u^3-16/455625*z*w*t*u^5+64/273375*z*t^4*u^3-56/1366875*z*t^2*u^5+13/2278125*z*u^7);
//   Coordinate number 2:
map_2_coord_2 := 1*(-1/30*w*u-1/30*t*u);
// Codomain equation:
