...
// Magma code for modular curve with label 24.72.3.cm.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.736

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 8, 16, 1], [11, 15, 0, 5], [11, 23, 4, 17], [19, 16, 16, 17], [23, 8, 16, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.ba.1", "24.36.0.br.1", "24.36.1.k.1", "24.36.1.bh.1", "24.36.1.eu.1", "24.36.2.j.1", "24.36.2.m.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.cm.1
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*w);
