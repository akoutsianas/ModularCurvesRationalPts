...
// Magma code for modular curve with label 60.72.3.hf.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.473

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 52, 8, 5], [29, 32, 47, 13], [59, 18, 21, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.z.1", "60.36.0.bn.1", "60.36.1.h.1", "60.36.1.da.1", "60.36.1.eg.1", "60.36.2.r.1", "60.36.2.co.1"];
...
// Embedded model
model_0 := [x^2+2*x*y+x*z+z^2-w^2,x^2+x*z+z^2-x*w-2*z*w+w^2-x*t,x^2+x*z-2*y*z+z^2+x*w+2*y*w-z*w-x*t-z*t-w*t,x^2-x*y+x*z+z^2+x*w+2*z*w+w^2+x*t,3*y*z+2*x*w+y*w+z*w+w^2-z*t+w*t,4*y^2+3*w^2-y*t+t^2,12*x^2-8*x*y+7*y^2-3*x*z+3*y*z-3*z^2+x*w+y*w-z*w-12*w^2-x*t+2*y*t-z*t+w*t-2*t^2-u^2];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.hf.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
