...
// Magma code for modular curve with label 24.72.3.bu.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.324

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 4, 20, 17], [15, 4, 16, 3], [15, 22, 22, 15], [17, 20, 14, 19], [19, 10, 4, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.b.1", "24.36.0.j.1", "24.36.1.dq.1", "24.36.1.ef.1", "24.36.2.d.1", "24.36.2.h.1", "24.36.2.eq.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.bu.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
