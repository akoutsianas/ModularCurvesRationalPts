...
// Magma code for modular curve with label 24.72.3.ko.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.332

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 5, 8, 21], [19, 1, 6, 23], [19, 10, 10, 11], [19, 14, 8, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.o.1", "24.36.0.j.1", "24.36.1.bi.1", "24.36.1.dv.1", "24.36.2.cd.1", "24.36.2.dg.1", "24.36.2.ez.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.ko.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(u);
