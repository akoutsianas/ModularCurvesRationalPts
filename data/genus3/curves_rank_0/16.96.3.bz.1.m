...
// Magma code for modular curve with label 16.96.3.bz.1

// Other names and/or labels
// Cummins-Pauli label: 16I3
// Rouse-Sutherland-Zureick-Brown label: 16.96.3.235

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 3, 4, 7], [1, 8, 8, 9], [13, 2, 12, 9], [15, 8, 8, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.bn.1", "16.48.0.p.1", "16.48.1.y.1", "16.48.1.z.1", "16.48.2.h.1", "16.48.2.u.1", "16.48.2.v.1"];
...
// Embedded model
model_0 := [y^2-x*u,x*z+w^2-t^2+z*u,2*z^2-w*t+t^2-z*u,x*z-2*w*t-z*u,x*w-2*z*w+2*z*t+t*u,2*z*w+x*t+2*z*t-w*u,x^2+2*w^2+2*t^2+u^2];
...
// Map from the embedded model to the plane model of modular curve with label 16.96.3.bz.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(u);
