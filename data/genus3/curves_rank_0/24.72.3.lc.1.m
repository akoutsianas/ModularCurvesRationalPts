...
// Magma code for modular curve with label 24.72.3.lc.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.312

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 5, 4, 17], [5, 6, 18, 7], [13, 17, 16, 13], [17, 19, 14, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.q.1", "24.36.0.p.1", "24.36.1.bi.1", "24.36.1.eb.1", "24.36.2.cg.1", "24.36.2.dj.1", "24.36.2.ff.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.lc.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.3.lc.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-t);
//   Coordinate number 1:
