...
// Magma code for modular curve with label 60.72.3.xz.2

// Other names and/or labels
// Cummins-Pauli label: 20G3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.831

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 50, 16, 39], [13, 25, 0, 49], [17, 55, 28, 57], [57, 20, 34, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.2.b.1", "30.36.0.b.2", "60.36.1.dm.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.xz.2
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
