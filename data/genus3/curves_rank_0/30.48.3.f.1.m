...
// Magma code for modular curve with label 30.48.3.f.1

// Other names and/or labels
// Cummins-Pauli label: 30F3
// Rouse-Sutherland-Zureick-Brown label: 30.48.3.4

// Group data
level := 30;
// Elements that, together with Gamma(level), generate the group
gens := [[8, 15, 21, 19], [11, 10, 24, 11], [17, 20, 27, 23], [28, 5, 27, 8]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['3.4.0.a.1', '10.12.0.a.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["10.12.0.a.1", "15.24.1.a.1"];
