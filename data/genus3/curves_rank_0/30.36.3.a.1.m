...
// Magma code for modular curve with label 30.36.3.a.1

// Other names and/or labels
// Cummins-Pauli label: 30B3
// Rouse-Sutherland-Zureick-Brown label: 30.36.3.2

// Group data
level := 30;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 15, 27, 22], [18, 5, 25, 9], [19, 20, 4, 7], [29, 15, 15, 16]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['2.2.0.a.1', '3.3.0.a.1', '5.6.0.a.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["6.6.1.a.1", "10.12.1.a.1", "15.18.0.a.1"];
...
// Map from the embedded model to the plane model of modular curve with label 30.36.3.a.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 30.36.3.a.1
//   Coordinate number 0:
map_2_coord_0 := 1*(t);
//   Coordinate number 1:
