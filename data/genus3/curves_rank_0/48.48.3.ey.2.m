...
// Magma code for modular curve with label 48.48.3.ey.2

// Other names and/or labels
// Cummins-Pauli label: 16F3
// Rouse-Sutherland-Zureick-Brown label: 48.48.3.113

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[25, 22, 44, 37], [25, 33, 30, 19], [31, 24, 12, 5], [37, 28, 32, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.1.k.1", "24.24.0.en.2", "48.24.2.e.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.3.ey.2
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
