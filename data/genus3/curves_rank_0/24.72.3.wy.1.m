...
// Magma code for modular curve with label 24.72.3.wy.1

// Other names and/or labels
// Cummins-Pauli label: 24O3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.273

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 22, 20, 7], [11, 17, 4, 5], [13, 18, 18, 19], [17, 7, 8, 23], [23, 23, 16, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bm.1", "24.36.1.fq.1", "24.36.1.gf.1"];
