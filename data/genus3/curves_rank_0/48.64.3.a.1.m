...
// Magma code for modular curve with label 48.64.3.a.1

// Other names and/or labels
// Cummins-Pauli label: 24G3
// Rouse-Sutherland-Zureick-Brown label: 48.64.3.4

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[10, 15, 3, 22], [19, 10, 18, 5], [38, 47, 15, 35], [46, 33, 21, 14]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 64;
...
covers := ["24.32.1.a.1", "48.16.0.a.1"];
...
model_2 := [3*x^2-y^2-z^2,1260*x^4-720*x^3*y-1296*x^3*z+720*x^2*y*z-348*x^2*z^2+84*x*y*z^2+360*x*z^3-72*y*z^3+29*z^4-18*w^2];
...
// Map from the embedded model to the plane model of modular curve with label 48.64.3.a.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*u);
