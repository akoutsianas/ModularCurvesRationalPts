...
// Magma code for modular curve with label 24.72.3.ln.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.642

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 12, 18, 13], [19, 13, 8, 7], [19, 16, 4, 23], [23, 23, 4, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.q.1", "24.36.0.bd.1", "24.36.1.bk.1", "24.36.1.cx.1", "24.36.1.em.1", "24.36.2.dn.1", "24.36.2.dw.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.ln.1
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
map_1_coord_1 := 1*(4*z);
