...
// Magma code for modular curve with label 40.72.3.w.1

// Other names and/or labels
// Cummins-Pauli label: 20J3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.188

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 7, 12, 31], [3, 13, 14, 27], [3, 23, 30, 21], [19, 35, 36, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.1.e.1", "40.12.0.h.1", "40.36.1.b.1", "40.36.1.i.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.w.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
