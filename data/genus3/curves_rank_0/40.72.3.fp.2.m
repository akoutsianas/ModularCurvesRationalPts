...
// Magma code for modular curve with label 40.72.3.fp.2

// Other names and/or labels
// Cummins-Pauli label: 40G3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.138

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 37, 2, 15], [7, 12, 20, 19], [11, 22, 18, 25], [17, 9, 28, 3], [25, 28, 28, 25], [31, 0, 10, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
