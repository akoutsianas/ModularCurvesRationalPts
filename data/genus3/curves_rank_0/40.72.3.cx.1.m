...
// Magma code for modular curve with label 40.72.3.cx.1

// Other names and/or labels
// Cummins-Pauli label: 20I3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.228

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 3, 34, 29], [7, 19, 0, 31], [31, 26, 32, 35], [37, 1, 4, 39]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.2.b.1", "40.36.0.c.2", "40.36.1.e.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.cx.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.72.3.cx.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-y^2);
//   Coordinate number 1:
