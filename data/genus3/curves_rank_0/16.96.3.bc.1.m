...
// Magma code for modular curve with label 16.96.3.bc.1

// Other names and/or labels
// Cummins-Pauli label: 16O3
// Rouse-Zureick-Brown label: X606
// Rouse-Sutherland-Zureick-Brown label: 16.96.3.105

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 8, 8, 3], [1, 12, 8, 11], [11, 10, 12, 3], [13, 2, 4, 9], [15, 0, 0, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
