...
// Magma code for modular curve with label 40.60.3.by.1

// Other names and/or labels
// Cummins-Pauli label: 10B3
// Rouse-Sutherland-Zureick-Brown label: 40.60.3.58

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[8, 11, 39, 17], [24, 5, 37, 36], [29, 6, 30, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["20.30.2.h.1", "40.30.0.c.1", "40.30.1.c.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.60.3.by.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(5*z);
