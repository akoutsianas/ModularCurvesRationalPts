...
// Magma code for modular curve with label 40.72.3.cu.1

// Other names and/or labels
// Cummins-Pauli label: 20I3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.56

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 39, 4, 17], [27, 25, 8, 39], [33, 1, 10, 9], [37, 6, 0, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["10.36.1.b.1", "40.36.0.c.2", "40.36.2.b.2"];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.cu.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.72.3.cu.1
//   Coordinate number 0:
map_2_coord_0 := 1*(u^2);
//   Coordinate number 1:
map_2_coord_1 := 1*(-20*x^4*t*u^3-50*x^4*u^4-14*x^2*t*u^5-30*x^2*u^6-t*u^7-3*u^8);
//   Coordinate number 2:
map_2_coord_2 := 1*(x*u);
// Codomain equation:
