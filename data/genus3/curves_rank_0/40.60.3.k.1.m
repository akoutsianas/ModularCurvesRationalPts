...
// Magma code for modular curve with label 40.60.3.k.1

// Other names and/or labels
// Cummins-Pauli label: 10B3
// Rouse-Sutherland-Zureick-Brown label: 40.60.3.53

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 12, 23, 9], [17, 20, 10, 17], [19, 35, 2, 31], [39, 15, 30, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["20.30.2.d.1", "40.30.0.a.1", "40.30.1.c.1"];
...
model_2 := [2*x^2-2*x*y-2*y^2+z^2,10*x^4+20*x^3*y+5*x^2*z^2-x*y*z^2-w^2];
...
// Map from the embedded model to the plane model of modular curve with label 40.60.3.k.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(5*z);
