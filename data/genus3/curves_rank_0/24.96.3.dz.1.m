...
// Magma code for modular curve with label 24.96.3.dz.1

// Other names and/or labels
// Cummins-Pauli label: 12L3
// Rouse-Sutherland-Zureick-Brown label: 24.96.3.144

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 2, 18, 7], [11, 4, 0, 19], [11, 17, 6, 7], [17, 22, 12, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["12.48.0.b.1", "24.48.1.er.1", "24.48.2.c.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.96.3.dz.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.96.3.dz.1
//   Coordinate number 0:
