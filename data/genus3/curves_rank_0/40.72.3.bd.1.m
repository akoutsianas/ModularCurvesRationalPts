...
// Magma code for modular curve with label 40.72.3.bd.1

// Other names and/or labels
// Cummins-Pauli label: 20I3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.66

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 13, 32, 39], [17, 0, 4, 23], [19, 29, 26, 37], [25, 27, 34, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.0.c.1", "40.36.1.b.1", "40.36.2.b.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.bd.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.72.3.bd.1
//   Coordinate number 0:
