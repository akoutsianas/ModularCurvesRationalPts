...
// Magma code for modular curve with label 60.48.3.t.1

// Other names and/or labels
// Cummins-Pauli label: 30G3
// Rouse-Sutherland-Zureick-Brown label: 60.48.3.7

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 45, 15, 28], [14, 25, 33, 47], [29, 20, 9, 23], [31, 45, 51, 52], [49, 5, 0, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['5.6.0.a.1', '12.8.0.b.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["12.8.0.b.1", "15.24.1.a.1", "60.12.1.j.1"];
...
// Weierstrass model
model_2 := [-2*x^8-7*x^6*z^2+x^4*y-11*x^4*z^4+x^2*y*z^2-7*x^2*z^6+y^2+y*z^4-2*z^8];
...
// Map from the embedded model to the plane model of modular curve with label 60.48.3.t.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.48.3.t.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-x);
//   Coordinate number 1:
map_2_coord_1 := 1*(-2*x^4-x^2*y^2-x*y^2*w);
//   Coordinate number 2:
map_2_coord_2 := 1*(y);
// Codomain equation:
map_2_codomain := [-2*x^8-7*x^6*z^2+x^4*y-11*x^4*z^4+x^2*y*z^2-7*x^2*z^6+y^2+y*z^4-2*z^8];
