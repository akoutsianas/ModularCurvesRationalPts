...
// Magma code for modular curve with label 48.48.3.bu.2

// Other names and/or labels
// Cummins-Pauli label: 16F3
// Rouse-Sutherland-Zureick-Brown label: 48.48.3.162

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[29, 5, 46, 5], [31, 11, 10, 21], [33, 37, 38, 17], [35, 37, 30, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.2.a.1", "24.24.0.en.2", "48.24.1.k.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.3.bu.2
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
