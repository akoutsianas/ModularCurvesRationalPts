...
// Magma code for modular curve with label 60.72.3.yd.1

// Other names and/or labels
// Cummins-Pauli label: 20G3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.788

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[27, 50, 50, 11], [31, 20, 18, 43], [39, 40, 16, 41], [49, 55, 50, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.1.g.1", "60.36.0.b.1", "60.36.2.fq.2"];
...
// Embedded model
model_0 := [2*x*z+z*w-x*t,2*x*z-2*z*w+x*t-w*t-x*u,5*y^2+z*u+t*u,6*z^2+z*t-t^2-z*u,15*x^2+z^2-z*t-2*t^2-z*u,4*z^2+15*x*w-8*z*t+z*u+t*u,4*z^2-15*x*w-15*w^2-12*z*t+8*t^2-5*z*u-t*u+u^2];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.yd.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*w);
