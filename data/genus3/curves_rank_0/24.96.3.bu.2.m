...
// Magma code for modular curve with label 24.96.3.bu.2

// Other names and/or labels
// Cummins-Pauli label: 12L3
// Rouse-Sutherland-Zureick-Brown label: 24.96.3.463

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 16, 18, 23], [7, 2, 12, 1], [7, 8, 0, 5], [13, 12, 0, 7], [17, 20, 6, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["12.48.2.a.2", "24.48.0.o.2", "24.48.1.bw.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.96.3.bu.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*u);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.96.3.bu.2
//   Coordinate number 0:
map_2_coord_0 := 1*(w);
//   Coordinate number 1:
