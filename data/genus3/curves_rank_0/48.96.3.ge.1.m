...
// Magma code for modular curve with label 48.96.3.ge.1

// Other names and/or labels
// Cummins-Pauli label: 16I3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.20

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 9, 40, 13], [7, 33, 24, 1], [29, 12, 32, 37], [41, 12, 8, 25], [41, 47, 24, 35]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.bb.1", "48.48.0.k.1", "48.48.2.h.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.ge.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*w);
