...
// Magma code for modular curve with label 24.72.3.bao.1

// Other names and/or labels
// Cummins-Pauli label: 12J3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.340

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 7, 20, 7], [7, 21, 18, 5], [15, 22, 16, 15], [19, 2, 16, 7], [19, 12, 18, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bv.1", "24.36.1.fn.1", "24.36.1.gd.1"];
