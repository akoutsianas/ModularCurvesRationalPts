...
// Magma code for modular curve with label 40.72.3.fm.2

// Other names and/or labels
// Cummins-Pauli label: 20K3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.127

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 0, 20, 27], [13, 34, 32, 5], [19, 4, 20, 23], [19, 9, 2, 1], [31, 38, 10, 29], [39, 2, 8, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
