...
// Magma code for modular curve with label 24.72.3.ih.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.698

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 23, 6, 7], [15, 1, 8, 21], [15, 10, 2, 15], [15, 10, 22, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.m.1", "24.36.0.bb.1", "24.36.1.v.1", "24.36.1.ct.1", "24.36.1.ec.1", "24.36.2.bq.1", "24.36.2.fs.1"];
...
// Embedded model
model_0 := [z*w+y*u,x*w+4*y*w-z*u,x*y+4*y^2+z^2,6*x*z-w*u,6*x*y+w^2,6*x^2-4*w^2-u^2,3*x^2-6*z^2+w^2+t^2-t*u];
