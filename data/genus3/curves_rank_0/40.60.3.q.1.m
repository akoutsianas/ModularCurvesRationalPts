...
// Magma code for modular curve with label 40.60.3.q.1

// Other names and/or labels
// Cummins-Pauli label: 10B3
// Rouse-Sutherland-Zureick-Brown label: 40.60.3.30

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 5, 25, 16], [7, 9, 25, 24], [7, 24, 6, 23], [29, 18, 0, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["10.30.2.b.1", "40.30.0.c.1", "40.30.1.b.1"];
...
model_2 := [-2*x^2+2*x*z+121*y^2+302*z^2,-6*x^4+122*x^3*z+20396*x^2*z^2+428728*x*z^3+2296944*z^4-366025*w^2];
...
// Map from the embedded model to the plane model of modular curve with label 40.60.3.q.1
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
