...
// Magma code for modular curve with label 24.72.3.je.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.580

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 8, 10, 9], [5, 6, 6, 11], [19, 11, 10, 19], [23, 7, 22, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.v.1", "24.36.0.p.1", "24.36.1.y.1", "24.36.1.by.1", "24.36.1.dz.1", "24.36.2.bw.1", "24.36.2.fa.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.je.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.3.je.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-w);
//   Coordinate number 1:
