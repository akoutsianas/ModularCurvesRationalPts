...
// Magma code for modular curve with label 48.144.3.d.1

// Other names and/or labels
// Cummins-Pauli label: 48M3
// Rouse-Sutherland-Zureick-Brown label: 48.144.3.3

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 23, 2, 23], [9, 16, 32, 45], [11, 19, 2, 17], [37, 0, 12, 31], [37, 41, 14, 41]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.ef.1", "48.72.0.a.2", "48.72.2.c.2"];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.3.d.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(6*z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.3.d.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-1/2*t);
//   Coordinate number 1:
map_2_coord_1 := 1*(-1/2*y^4-3/4*y*z*t^2+1/16*t^4);
//   Coordinate number 2:
map_2_coord_2 := 1*(y);
// Codomain equation:
