...
// Magma code for modular curve with label 48.96.3.bj.1

// Other names and/or labels
// Cummins-Pauli label: 16H3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.63

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 12, 4, 1], [23, 8, 6, 25], [25, 12, 18, 23], [31, 20, 28, 43], [35, 28, 28, 31], [35, 40, 14, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
