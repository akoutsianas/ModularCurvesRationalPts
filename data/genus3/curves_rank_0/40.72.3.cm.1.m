...
// Magma code for modular curve with label 40.72.3.cm.1

// Other names and/or labels
// Cummins-Pauli label: 20H3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.206

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 17, 8, 23], [11, 3, 24, 35], [19, 22, 30, 21], [33, 9, 16, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.2.a.1", "40.36.0.f.1", "40.36.1.c.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.cm.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.72.3.cm.1
//   Coordinate number 0:
map_2_coord_0 := 1*(1/40*w*t+1/120*t^2-1/80*t*u);
//   Coordinate number 1:
map_2_coord_1 := 1*(1/2160000*z*w*t^6+7/2160000*z*w*t^5*u-271/216000000*z*w*t^4*u^2+221/432000000*z*w*t^3*u^3-19/6480000*z*t^7+1/2160000*z*t^6*u-1337/1296000000*z*t^5*u^2+7/48000000*z*t^4*u^3-5317/51840000000*z*t^3*u^4);
//   Coordinate number 2:
map_2_coord_2 := 1*(-1/80*w*t+1/80*t^2+1/1200*t*u);
// Codomain equation:
