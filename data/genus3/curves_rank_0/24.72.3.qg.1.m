...
// Magma code for modular curve with label 24.72.3.qg.1

// Other names and/or labels
// Cummins-Pauli label: 12E3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.195

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 21, 0, 5], [3, 1, 16, 3], [9, 8, 8, 3], [15, 7, 20, 3], [23, 0, 12, 7], [23, 3, 0, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.m.1", "24.36.0.e.1", "24.36.2.eu.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.qg.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.3.qg.1
//   Coordinate number 0:
map_2_coord_0 := 1*(w^2);
//   Coordinate number 1:
