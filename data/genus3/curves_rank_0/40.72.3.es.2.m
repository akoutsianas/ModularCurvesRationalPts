...
// Magma code for modular curve with label 40.72.3.es.2

// Other names and/or labels
// Cummins-Pauli label: 20G3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.115

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 0, 0, 27], [25, 3, 26, 27], [25, 28, 4, 29], [27, 4, 24, 27], [33, 8, 24, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.1.i.1", "40.36.0.a.2", "40.36.2.b.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.es.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
