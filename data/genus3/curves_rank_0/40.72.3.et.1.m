...
// Magma code for modular curve with label 40.72.3.et.1

// Other names and/or labels
// Cummins-Pauli label: 20G3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.86

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 1, 18, 23], [15, 13, 32, 1], [15, 16, 28, 23], [25, 4, 14, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.0.a.2", "40.36.1.k.1", "40.36.2.a.1"];
...
model_2 := [x^2+y^2+z^2,4*x^3*z+6*x^2*z^2-4*x*z^3-w^2];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.et.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(u);
