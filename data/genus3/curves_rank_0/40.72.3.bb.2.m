...
// Magma code for modular curve with label 40.72.3.bb.2

// Other names and/or labels
// Cummins-Pauli label: 20I3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.157

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 0, 22, 29], [1, 21, 0, 7], [5, 33, 18, 5], [15, 39, 24, 25], [25, 12, 34, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.1.a.1", "40.36.0.d.1", "40.36.2.b.2"];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.bb.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.72.3.bb.2
//   Coordinate number 0:
map_2_coord_0 := 1*(-y*w);
//   Coordinate number 1:
