...
// Magma code for modular curve with label 24.72.3.ut.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.656

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 17, 4, 13], [13, 22, 10, 5], [21, 17, 2, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.bm.1", "24.36.0.bt.1", "24.36.1.cx.1", "24.36.1.do.1", "24.36.1.fd.1", "24.36.2.fs.1", "24.36.2.fu.1"];
...
// Embedded model
model_0 := [x*w-z*t,2*x*y-w*t,2*y*z-w^2,2*y^2-2*y*z-3*w^2-3*t^2,y*w-4*z*w-3*x*t,3*x^2-y*z+4*z^2,3*x^2-y*z-4*z^2-2*w^2-t^2+t*u-u^2];

// Double cover of conic
model_1 := [-2*x^2-2*x*y-2*y^2+z^2,-12*x^3*y-18*x^2*z^2-12*x*y*z^2-7*z^4-6*w^2];
