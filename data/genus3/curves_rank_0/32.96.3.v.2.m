...
// Magma code for modular curve with label 32.96.3.v.2

// Other names and/or labels
// Cummins-Pauli label: 32M3
// Rouse-Sutherland-Zureick-Brown label: 32.96.3.11

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 3, 0, 15], [13, 11, 0, 5], [17, 5, 0, 5], [27, 21, 0, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.0.u.2", "32.48.1.b.1", "32.48.2.a.1"];
...
// Map from the embedded model to the plane model of modular curve with label 32.96.3.v.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 32.96.3.v.2
//   Coordinate number 0:
map_2_coord_0 := 1*(y);
//   Coordinate number 1:
map_2_coord_1 := 1*(2*x^3*z+x^2*y^2+x*y^2*z);
//   Coordinate number 2:
map_2_coord_2 := 1*(x);
// Codomain equation:
