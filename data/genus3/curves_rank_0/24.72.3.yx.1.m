...
// Magma code for modular curve with label 24.72.3.yx.1

// Other names and/or labels
// Cummins-Pauli label: 24O3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.793

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 5, 22, 17], [23, 2, 14, 13], [23, 4, 16, 19], [23, 8, 14, 1], [23, 13, 16, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fk.1", "24.36.1.fp.1", "24.36.1.gf.1"];
