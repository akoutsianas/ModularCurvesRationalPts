...
// Magma code for modular curve with label 24.72.3.vl.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.667

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 8, 20, 21], [11, 16, 4, 7], [21, 10, 8, 21], [23, 9, 18, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.bv.1", "24.36.0.bv.1", "24.36.1.dd.1", "24.36.1.dg.1", "24.36.1.fh.1", "24.36.2.fc.1", "24.36.2.fl.1"];
