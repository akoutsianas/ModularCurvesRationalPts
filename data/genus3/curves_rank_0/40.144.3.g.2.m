...
// Magma code for modular curve with label 40.144.3.g.2

// Other names and/or labels
// Cummins-Pauli label: 40J3
// Rouse-Sutherland-Zureick-Brown label: 40.144.3.339

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 36, 26, 27], [25, 7, 24, 13], [31, 37, 22, 31], [33, 1, 32, 17], [37, 11, 16, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
