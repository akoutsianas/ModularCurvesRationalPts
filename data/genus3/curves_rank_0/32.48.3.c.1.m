...
// Magma code for modular curve with label 32.48.3.c.1

// Other names and/or labels
// Cummins-Pauli label: 32C3
// Rouse-Zureick-Brown label: X431
// Rouse-Sutherland-Zureick-Brown label: 32.48.3.6

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 29, 8, 21], [15, 12, 24, 29], [19, 6, 8, 13], [19, 7, 24, 19], [19, 21, 16, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
// Map from the embedded model to the plane model of modular curve with label 32.48.3.c.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(4*z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 32.48.3.c.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-1/2*t);
//   Coordinate number 1:
map_2_coord_1 := 1*(-2*x^4-x*z*t^2-1/16*t^4);
//   Coordinate number 2:
map_2_coord_2 := 1*(x);
// Codomain equation:
