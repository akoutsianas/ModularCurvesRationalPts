...
// Magma code for modular curve with label 60.72.3.yd.2

// Other names and/or labels
// Cummins-Pauli label: 20G3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.789

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 5, 48, 31], [29, 15, 24, 37], [29, 15, 40, 23], [57, 35, 26, 47]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.1.g.1", "60.36.0.b.2", "60.36.2.fq.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.yd.2
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(5*z);
