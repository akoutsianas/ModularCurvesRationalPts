...
// Magma code for modular curve with label 24.72.3.bgc.1

// Other names and/or labels
// Cummins-Pauli label: 24Q3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.852

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 8, 14, 17], [7, 10, 16, 23], [7, 20, 10, 1], [15, 2, 4, 3], [15, 11, 2, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fq.1", "24.36.1.ga.1", "24.36.1.gs.1"];
