...
// Magma code for modular curve with label 24.72.3.bec.1

// Other names and/or labels
// Cummins-Pauli label: 24P3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.356

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 2, 20, 3], [3, 11, 22, 21], [13, 1, 22, 23], [13, 13, 8, 7], [23, 18, 6, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bu.1", "24.36.1.gg.1", "24.36.1.go.1"];
