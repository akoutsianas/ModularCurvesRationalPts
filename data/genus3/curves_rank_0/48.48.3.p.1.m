...
// Magma code for modular curve with label 48.48.3.p.1

// Other names and/or labels
// Cummins-Pauli label: 16D3
// Rouse-Sutherland-Zureick-Brown label: 48.48.3.51

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 19, 34, 17], [9, 7, 34, 13], [13, 17, 46, 1], [29, 47, 18, 25], [37, 10, 20, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["8.24.1.i.1", "48.24.1.j.1", "48.24.2.b.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.3.p.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*t);
