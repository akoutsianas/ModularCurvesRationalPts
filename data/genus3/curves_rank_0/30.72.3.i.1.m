...
// Magma code for modular curve with label 30.72.3.i.1

// Other names and/or labels
// Cummins-Pauli label: 30J3
// Rouse-Sutherland-Zureick-Brown label: 30.72.3.12

// Group data
level := 30;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 5, 28, 11], [17, 15, 0, 17], [27, 10, 13, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["15.36.1.d.1", "30.36.0.f.1", "30.36.2.b.1"];
...
// Map from the embedded model to the plane model of modular curve with label 30.72.3.i.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(u);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 30.72.3.i.1
//   Coordinate number 0:
map_2_coord_0 := 1*(w);
//   Coordinate number 1:
map_2_coord_1 := 1*(-13*x^4-3*x^2*w^2-w^4-w^3*u);
//   Coordinate number 2:
map_2_coord_2 := 1*(x);
// Codomain equation:
