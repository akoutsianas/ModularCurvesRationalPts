...
// Magma code for modular curve with label 40.72.3.do.2

// Other names and/or labels
// Cummins-Pauli label: 20H3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.76

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 29, 8, 1], [33, 29, 16, 1], [39, 27, 26, 25], [39, 33, 18, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.0.d.1", "40.36.1.h.1", "40.36.2.a.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.do.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.72.3.do.2
//   Coordinate number 0:
