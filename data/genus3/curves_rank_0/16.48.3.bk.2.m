...
// Magma code for modular curve with label 16.48.3.bk.2

// Other names and/or labels
// Cummins-Pauli label: 16F3
// Rouse-Sutherland-Zureick-Brown label: 16.48.3.24

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 10, 0, 1], [7, 15, 10, 1], [13, 1, 6, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["8.24.0.bl.2", "16.24.1.j.1", "16.24.2.a.1"];
...
// Map from the embedded model to the plane model of modular curve with label 16.48.3.bk.2
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(4*z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 16.48.3.bk.2
//   Coordinate number 0:
