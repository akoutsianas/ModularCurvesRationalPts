...
// Magma code for modular curve with label 24.72.3.uw.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.603

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 16, 2, 1], [13, 21, 6, 11], [19, 20, 22, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.bt.1", "24.36.0.bu.1", "24.36.1.cz.1", "24.36.1.dm.1", "24.36.1.fd.1", "24.36.2.ex.1", "24.36.2.fv.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.uw.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
