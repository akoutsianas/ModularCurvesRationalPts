...
// Magma code for modular curve with label 40.144.3.p.2

// Other names and/or labels
// Cummins-Pauli label: 20T3
// Rouse-Sutherland-Zureick-Brown label: 40.144.3.350

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 4, 36, 35], [21, 27, 22, 31], [21, 28, 0, 9], [27, 12, 8, 1], [27, 32, 0, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
