...
// Magma code for modular curve with label 16.96.3.ea.1

// Other names and/or labels
// Cummins-Pauli label: 16N3
// Rouse-Zureick-Brown label: X561
// Rouse-Sutherland-Zureick-Brown label: 16.96.3.334

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 12, 8, 7], [7, 8, 0, 15], [9, 9, 8, 9], [13, 7, 8, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
