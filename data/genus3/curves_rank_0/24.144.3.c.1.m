...
// Magma code for modular curve with label 24.144.3.c.1

// Other names and/or labels
// Cummins-Pauli label: 12O3
// Rouse-Sutherland-Zureick-Brown label: 24.144.3.35

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 3, 12, 23], [13, 0, 12, 17], [13, 0, 12, 19], [13, 9, 0, 1], [17, 9, 12, 1], [19, 6, 12, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["12.72.1.f.1", "24.48.0.bu.3", "24.48.0.bu.4"];
...
//   Coordinate number 1:
map_0_coord_1 := 2*(z*y^3*(y-z)*(y+2*z)^3*(y^2-2*y*z+4*z^2)^3*(y^2+y*z+z^2)*(x^2*y^18-252*x^2*y^15*z^3+5592*x^2*y^12*z^6-17600*x^2*y^9*z^9-2304*x^2*y^6*z^12-3072*x^2*y^3*z^15-2048*x^2*z^18+12*y^18*z^2-760*y^15*z^5+6860*y^12*z^8-8416*y^9*z^11+256*y^6*z^14+1024*y^3*z^17+1024*z^20));
