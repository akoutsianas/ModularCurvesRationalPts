...
// Magma code for modular curve with label 60.72.3.xy.2

// Other names and/or labels
// Cummins-Pauli label: 20G3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.815

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 20, 52, 33], [17, 25, 10, 13], [53, 30, 50, 29], [57, 20, 50, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.2.a.1", "60.36.0.b.2", "60.36.1.dm.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.xy.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(5*w);
