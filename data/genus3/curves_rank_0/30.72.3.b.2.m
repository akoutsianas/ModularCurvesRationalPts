...
// Magma code for modular curve with label 30.72.3.b.2

// Other names and/or labels
// Cummins-Pauli label: 30J3
// Rouse-Sutherland-Zureick-Brown label: 30.72.3.10

// Group data
level := 30;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 0, 21, 1], [9, 10, 14, 27], [14, 5, 13, 8]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["15.36.1.a.1", "30.36.0.e.2", "30.36.2.b.2"];
...
// Weierstrass model
model_2 := [x^8-4*x^6*z^2+x^4*y-6*x^4*z^4+x^2*y*z^2-202*x^2*z^6+y^2+y*z^4+1519*z^8];
...
// Map from the embedded model to the plane model of modular curve with label 30.72.3.b.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(5*u);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 30.72.3.b.2
//   Coordinate number 0:
map_2_coord_0 := 1*(-z);
//   Coordinate number 1:
map_2_coord_1 := 1*(67/625*y^4-1/5*y^2*z^2-1/5*z^4+3/5*z^3*u);
//   Coordinate number 2:
map_2_coord_2 := 1*(1/5*y);
// Codomain equation:
map_2_codomain := [x^8-4*x^6*z^2+x^4*y-6*x^4*z^4+x^2*y*z^2-202*x^2*z^6+y^2+y*z^4+1519*z^8];
