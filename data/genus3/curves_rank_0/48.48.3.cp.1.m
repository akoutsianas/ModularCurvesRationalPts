...
// Magma code for modular curve with label 48.48.3.cp.1

// Other names and/or labels
// Cummins-Pauli label: 16D3
// Rouse-Sutherland-Zureick-Brown label: 48.48.3.223

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 13, 26, 5], [5, 6, 36, 19], [25, 34, 28, 11], [47, 37, 26, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.2.c.1", "24.24.1.t.1", "48.24.2.c.1"];
...
model_2 := [2*x^2-2*x*y+2*y^2-z^2,27*x^4+12*z^4-w^2];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.3.cp.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(u);
