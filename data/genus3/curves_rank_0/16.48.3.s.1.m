...
// Magma code for modular curve with label 16.48.3.s.1

// Other names and/or labels
// Cummins-Pauli label: 16D3
// Rouse-Sutherland-Zureick-Brown label: 16.48.3.56

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 6, 0, 3], [7, 7, 6, 11], [13, 9, 14, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
model_2 := [x^2+y^2+z^2,8*x^3*y+4*x*y*z^2-3*z^4-w^2];
...
// Map from the embedded model to the plane model of modular curve with label 16.48.3.s.1
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
