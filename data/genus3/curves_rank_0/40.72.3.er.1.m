...
// Magma code for modular curve with label 40.72.3.er.1

// Other names and/or labels
// Cummins-Pauli label: 20G3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.232

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 38, 12, 17], [13, 24, 30, 17], [17, 12, 34, 5], [27, 27, 38, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.2.b.1", "40.36.0.a.1", "40.36.1.k.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.er.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
