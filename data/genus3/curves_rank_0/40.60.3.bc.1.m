...
// Magma code for modular curve with label 40.60.3.bc.1

// Other names and/or labels
// Cummins-Pauli label: 10B3
// Rouse-Sutherland-Zureick-Brown label: 40.60.3.33

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 21, 23, 24], [33, 26, 29, 17], [37, 20, 16, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["10.30.2.d.1", "40.30.0.a.1", "40.30.1.b.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.60.3.bc.1
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
