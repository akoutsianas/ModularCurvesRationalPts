...
// Magma code for modular curve with label 24.72.3.xk.1

// Other names and/or labels
// Cummins-Pauli label: 12J3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.114

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 23, 8, 15], [17, 1, 14, 23], [17, 6, 18, 19], [17, 8, 20, 13], [19, 17, 8, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bs.1", "24.24.1.eu.1", "24.36.1.ey.1", "24.36.1.gd.1"];
