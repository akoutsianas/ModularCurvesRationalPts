...
// Magma code for modular curve with label 24.72.3.bcx.1

// Other names and/or labels
// Cummins-Pauli label: 24Q3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.840

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 11, 2, 19], [7, 7, 2, 1], [7, 7, 10, 5], [9, 1, 4, 15], [21, 11, 22, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fq.1", "24.36.1.gd.1", "24.36.1.go.1"];
