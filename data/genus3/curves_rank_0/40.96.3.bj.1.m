...
// Magma code for modular curve with label 40.96.3.bj.1

// Other names and/or labels
// Cummins-Pauli label: 8B3
// Rouse-Sutherland-Zureick-Brown label: 40.96.3.179

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 6, 22, 15], [7, 0, 38, 39], [11, 10, 34, 37], [19, 6, 18, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["40.48.0.h.1", "40.48.1.bp.1", "40.48.2.c.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.96.3.bj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(5*z);
