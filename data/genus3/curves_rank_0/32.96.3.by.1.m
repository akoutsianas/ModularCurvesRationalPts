...
// Magma code for modular curve with label 32.96.3.by.1

// Other names and/or labels
// Cummins-Pauli label: 32N3
// Rouse-Zureick-Brown label: X655
// Rouse-Sutherland-Zureick-Brown label: 32.96.3.221

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[15, 26, 16, 13], [25, 24, 24, 29], [29, 23, 26, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
