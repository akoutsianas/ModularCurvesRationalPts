...
// Magma code for modular curve with label 24.72.3.cs.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.584

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 8, 8, 3], [13, 19, 20, 7], [17, 6, 6, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.bg.1", "24.36.0.p.1", "24.36.1.j.1", "24.36.1.dj.1", "24.36.1.ek.1", "24.36.2.k.1", "24.36.2.m.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.cs.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(u);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.3.cs.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-z);
//   Coordinate number 1:
