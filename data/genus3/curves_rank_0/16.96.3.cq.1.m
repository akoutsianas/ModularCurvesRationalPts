...
// Magma code for modular curve with label 16.96.3.cq.1

// Other names and/or labels
// Cummins-Pauli label: 8A3
// Rouse-Zureick-Brown label: X593
// Rouse-Sutherland-Zureick-Brown label: 16.96.3.221

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 3, 0, 5], [9, 2, 8, 5], [13, 1, 0, 3], [13, 4, 0, 13], [15, 10, 0, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
