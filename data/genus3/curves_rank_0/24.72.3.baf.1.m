...
// Magma code for modular curve with label 24.72.3.baf.1

// Other names and/or labels
// Cummins-Pauli label: 12J3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.436

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 4, 16, 3], [15, 7, 22, 21], [15, 22, 4, 3], [19, 0, 12, 11], [23, 20, 22, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.br.1", "24.36.1.fx.1", "24.36.1.gb.1"];
