...
// Magma code for modular curve with label 24.72.3.bbc.1

// Other names and/or labels
// Cummins-Pauli label: 24O3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.833

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 11, 2, 11], [1, 13, 4, 23], [9, 5, 20, 3], [11, 14, 8, 7], [11, 15, 12, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fn.1", "24.36.1.gf.1", "24.36.1.gk.1"];
