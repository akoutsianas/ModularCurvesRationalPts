...
// Magma code for modular curve with label 40.72.3.ef.1

// Other names and/or labels
// Cummins-Pauli label: 20G3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.244

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 18, 8, 21], [15, 3, 8, 25], [27, 30, 26, 21], [31, 37, 4, 39]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.2.b.2", "40.36.0.a.1", "40.36.1.i.1"];
...
model_2 := [x^2+y^2+z^2,-936*x^4+352*x^3*y-936*x^2*z^2+176*x*y*z^2-42*z^4-125*w^2];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.ef.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
