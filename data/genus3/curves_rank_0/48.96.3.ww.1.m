...
// Magma code for modular curve with label 48.96.3.ww.1

// Other names and/or labels
// Cummins-Pauli label: 16K3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.571

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 10, 40, 21], [25, 47, 38, 23], [33, 20, 22, 39], [33, 41, 16, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.bo.1", "48.48.1.fp.1", "48.48.1.ha.1"];
