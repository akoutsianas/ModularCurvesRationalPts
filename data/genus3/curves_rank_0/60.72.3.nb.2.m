...
// Magma code for modular curve with label 60.72.3.nb.2

// Other names and/or labels
// Cummins-Pauli label: 20I3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.848

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 55, 2, 31], [13, 15, 40, 17], [37, 0, 2, 23], [57, 50, 10, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.2.b.2", "60.36.0.d.1", "60.36.1.v.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.nb.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.72.3.nb.2
//   Coordinate number 0:
map_2_coord_0 := 1*(-y^2*u+1/3*u^3);
//   Coordinate number 1:
map_2_coord_1 := 1*(-45*y^11*w+51*y^9*w*u^2-22*y^7*w*u^4+14/3*y^5*w*u^6-5/9*y^3*w*u^8+1/27*y*w*u^10);
//   Coordinate number 2:
