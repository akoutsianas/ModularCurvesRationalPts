...
// Magma code for modular curve with label 60.72.3.bco.2

// Other names and/or labels
// Cummins-Pauli label: 30J3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.865

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[4, 5, 43, 58], [19, 30, 3, 23], [47, 10, 25, 43], [47, 35, 38, 49]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["30.36.0.e.2", "60.36.1.dt.1", "60.36.2.fu.2"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.bco.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.72.3.bco.2
//   Coordinate number 0:
map_2_coord_0 := 1*(-x);
//   Coordinate number 1:
