...
// Magma code for modular curve with label 40.72.3.dq.1

// Other names and/or labels
// Cummins-Pauli label: 20H3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.242

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 2, 28, 3], [27, 34, 4, 7], [35, 7, 28, 29], [37, 19, 6, 35]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.2.b.2", "40.36.0.f.1", "40.36.1.h.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.dq.1
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.72.3.dq.1
//   Coordinate number 0:
