...
// Magma code for modular curve with label 24.72.3.bby.1

// Other names and/or labels
// Cummins-Pauli label: 24I3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.774

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 11, 10, 3], [5, 15, 6, 7], [11, 18, 0, 19], [23, 10, 8, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.0.cc.1", "24.36.1.fe.1", "24.36.2.gg.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.bby.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.3.bby.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-z);
//   Coordinate number 1:
