...
// Magma code for modular curve with label 60.72.3.xw.1

// Other names and/or labels
// Cummins-Pauli label: 20G3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.36

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 20, 8, 19], [19, 45, 58, 49], [21, 5, 38, 3], [21, 40, 40, 33], [39, 50, 14, 57]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["10.36.0.a.1", "60.36.1.dn.1", "60.36.2.fq.2"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.xw.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.72.3.xw.1
//   Coordinate number 0:
