...
// Magma code for modular curve with label 60.72.3.yb.1

// Other names and/or labels
// Cummins-Pauli label: 20G3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.850

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 50, 18, 37], [7, 55, 0, 37], [31, 50, 12, 41], [47, 20, 56, 39]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.2.b.2", "60.36.0.b.1", "60.36.1.dn.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.yb.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
