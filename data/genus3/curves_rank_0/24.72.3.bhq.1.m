...
// Magma code for modular curve with label 24.72.3.bhq.1

// Other names and/or labels
// Cummins-Pauli label: 24Q3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.422

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 4, 10, 9], [3, 5, 8, 21], [7, 9, 6, 17], [7, 11, 20, 17], [23, 9, 12, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bw.1", "24.36.1.gi.1", "24.36.1.gs.1"];
