...
// Magma code for modular curve with label 24.72.3.bhd.1

// Other names and/or labels
// Cummins-Pauli label: 24P3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.866

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 15, 12, 19], [15, 16, 14, 21], [17, 9, 6, 19], [19, 22, 16, 23], [21, 16, 22, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fz.1", "24.36.1.gf.1", "24.36.1.gs.1"];
