...
// Magma code for modular curve with label 24.72.3.ii.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.322

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 15, 0, 23], [11, 9, 18, 7], [15, 20, 16, 15], [23, 5, 2, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.f.1", "24.36.0.bc.1", "24.36.1.cs.1", "24.36.1.eb.1", "24.36.2.bk.1", "24.36.2.bq.1", "24.36.2.ft.1"];
...
model_2 := [2*x^2-2*x*y+2*y^2-z^2,-36*x^4+36*x^3*y+18*x^2*z^2-60*x*y*z^2+37*z^4-3*w^2];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.ii.1
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*t);
