...
// Magma code for modular curve with label 48.96.3.fg.1

// Other names and/or labels
// Cummins-Pauli label: 16I3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.1084

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 19, 12, 23], [5, 27, 14, 35], [5, 37, 36, 35]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.j.1", "24.48.1.fq.1", "48.48.0.t.2", "48.48.1.cy.1", "48.48.1.da.1", "48.48.2.cr.1", "48.48.2.ct.1"];
...
// Embedded model
model_0 := [x*t-z*t-x*u-y*u-z*u,2*y^2-2*x*z-w^2,2*x*t-2*y*t+2*z*t+x*u-z*u,3*x^2+3*z^2-w^2,3*x^2-3*z^2+t*u,3*x*y+2*y^2+4*x*z+3*y*z+t^2,6*x*y-6*y^2-6*x*z+6*y*z+w^2+u^2];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.fg.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*z);
