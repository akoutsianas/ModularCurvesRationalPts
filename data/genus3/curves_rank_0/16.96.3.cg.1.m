...
// Magma code for modular curve with label 16.96.3.cg.1

// Other names and/or labels
// Cummins-Pauli label: 16J3
// Rouse-Sutherland-Zureick-Brown label: 16.96.3.326

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 4, 0, 3], [13, 1, 8, 1], [13, 11, 4, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.0.r.1", "16.48.1.p.1", "16.48.2.i.1"];
...
// Weierstrass model
model_1 := [x^8-28*x^6*z^2+70*x^4*z^4-28*x^2*z^6+y^2+z^8];
...
// Map from the embedded model to the Weierstrass model of modular curve with label 16.96.3.cg.1
//   Coordinate number 0:
map_1_coord_0 := 1*(-2*w-u);
//   Coordinate number 1:
map_1_coord_1 := 1*(-32*x*w*t^2-64*x*w*u^2-32*x*t^2*u-32*x*u^3);
//   Coordinate number 2:
map_1_coord_2 := 1*(-t);
// Codomain equation:
map_1_codomain := [x^8-28*x^6*z^2+70*x^4*z^4-28*x^2*z^6+y^2+z^8];
