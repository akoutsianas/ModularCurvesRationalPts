...
// Magma code for modular curve with label 40.72.3.da.2

// Other names and/or labels
// Cummins-Pauli label: 20I3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.199

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 24, 16, 1], [15, 9, 6, 3], [25, 13, 28, 35], [27, 34, 34, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.1.d.1", "40.36.0.c.1", "40.36.2.a.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.da.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(u);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.72.3.da.2
//   Coordinate number 0:
map_2_coord_0 := 1*(x*w);
//   Coordinate number 1:
