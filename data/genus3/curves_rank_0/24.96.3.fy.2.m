...
// Magma code for modular curve with label 24.96.3.fy.2

// Other names and/or labels
// Cummins-Pauli label: 24U3
// Rouse-Sutherland-Zureick-Brown label: 24.96.3.624

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 18, 12, 11], [11, 9, 20, 11], [11, 18, 16, 1], [13, 0, 0, 19], [17, 6, 20, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.48.0.bs.1", "24.48.1.in.1", "24.48.2.f.2"];
...
// Map from the embedded model to the plane model of modular curve with label 24.96.3.fy.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.96.3.fy.2
//   Coordinate number 0:
map_2_coord_0 := 1*(t);
//   Coordinate number 1:
