...
// Magma code for modular curve with label 24.72.3.nm.1

// Other names and/or labels
// Cummins-Pauli label: 24L3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.886

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 2, 8, 19], [7, 7, 20, 19], [11, 3, 0, 17], [17, 17, 8, 13], [19, 7, 8, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.be.1", "24.36.2.ci.1", "24.36.2.cs.1"];
...
model_2 := [2*x^2-2*x*y+2*y^2-z^2,3*x^4-6*x^2*z^2+4*z^4-2*w^2];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.nm.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
