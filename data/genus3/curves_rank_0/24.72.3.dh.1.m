...
// Magma code for modular curve with label 24.72.3.dh.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.534

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 1, 8, 17], [5, 9, 0, 19], [19, 4, 4, 17], [23, 22, 2, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bd.1", "24.36.0.u.1", "24.36.1.f.1", "24.36.1.cs.1", "24.36.2.o.1", "24.36.2.u.1", "24.36.2.fp.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.dh.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(u);
