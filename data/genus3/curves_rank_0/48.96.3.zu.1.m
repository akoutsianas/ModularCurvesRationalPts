...
// Magma code for modular curve with label 48.96.3.zu.1

// Other names and/or labels
// Cummins-Pauli label: 16L3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.518

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 19, 44, 23], [23, 13, 32, 41], [29, 32, 18, 19], [39, 25, 22, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.db.1", "24.48.1.mh.1", "48.48.1.gn.1"];
