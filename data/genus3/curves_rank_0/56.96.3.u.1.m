...
// Magma code for modular curve with label 56.96.3.u.1

// Other names and/or labels
// Cummins-Pauli label: 8B3
// Rouse-Sutherland-Zureick-Brown label: 56.96.3.26

// Group data
level := 56;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 52, 12, 9], [7, 36, 8, 13], [7, 44, 52, 7], [13, 48, 20, 3], [25, 44, 28, 45]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.g.2", "56.48.0.c.1", "56.48.2.a.1"];
...
// Map from the embedded model to the plane model of modular curve with label 56.96.3.u.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
