...
// Magma code for modular curve with label 24.72.3.bdj.1

// Other names and/or labels
// Cummins-Pauli label: 24P3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.346

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 4, 22, 5], [9, 13, 14, 3], [17, 18, 0, 13], [19, 1, 2, 13], [19, 20, 2, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bv.1", "24.36.1.fs.1", "24.36.1.gp.1"];
