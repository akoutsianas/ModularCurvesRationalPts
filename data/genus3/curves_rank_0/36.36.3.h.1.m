...
// Magma code for modular curve with label 36.36.3.h.1

// Other names and/or labels
// Cummins-Pauli label: 18A3
// Rouse-Sutherland-Zureick-Brown label: 36.36.3.1

// Group data
level := 36;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 16, 10, 3], [6, 23, 35, 24], [9, 29, 19, 0], [29, 27, 9, 32]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['4.2.0.a.1', '9.18.0.d.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["9.18.0.d.1", "12.12.1.e.1", "36.18.1.a.1", "36.18.2.a.1"];
...
// Map from the embedded model to the plane model of modular curve with label 36.36.3.h.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 36.36.3.h.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-x);
//   Coordinate number 1:
