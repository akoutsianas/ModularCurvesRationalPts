...
// Magma code for modular curve with label 24.72.3.bcv.1

// Other names and/or labels
// Cummins-Pauli label: 24Q3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.789

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 17, 14, 9], [11, 11, 22, 5], [21, 5, 16, 3], [23, 6, 0, 11], [23, 22, 22, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fp.1", "24.36.1.gb.1", "24.36.1.gp.1"];
