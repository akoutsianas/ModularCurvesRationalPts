...
// Magma code for modular curve with label 60.72.3.bcc.1

// Other names and/or labels
// Cummins-Pauli label: 30J3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.866

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 55, 35, 52], [23, 10, 38, 53], [24, 5, 59, 27], [48, 25, 7, 24]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["30.36.0.e.1", "60.36.1.dp.1", "60.36.2.fu.2"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.bcc.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*u);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.72.3.bcc.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-y);
//   Coordinate number 1:
