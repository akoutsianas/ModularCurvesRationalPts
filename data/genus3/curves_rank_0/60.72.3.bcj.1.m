...
// Magma code for modular curve with label 60.72.3.bcj.1

// Other names and/or labels
// Cummins-Pauli label: 30J3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.672

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 45, 30, 49], [33, 40, 7, 9], [43, 10, 4, 29], [59, 5, 47, 28]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["15.36.1.c.1", "60.36.0.ch.1", "60.36.2.fu.2"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.bcj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(u);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.72.3.bcj.1
//   Coordinate number 0:
map_2_coord_0 := 1*(t);
//   Coordinate number 1:
map_2_coord_1 := 1*(37*x^4-8*x^2*t^2+t^4+3*t^3*u);
//   Coordinate number 2:
map_2_coord_2 := 1*(x);
// Codomain equation:
