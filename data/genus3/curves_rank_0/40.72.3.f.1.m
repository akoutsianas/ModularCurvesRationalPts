...
// Magma code for modular curve with label 40.72.3.f.1

// Other names and/or labels
// Cummins-Pauli label: 20I3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.45

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 36, 32, 15], [3, 34, 34, 13], [9, 14, 26, 37], [11, 8, 20, 29], [27, 34, 4, 17], [31, 2, 20, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["10.36.1.a.1", "40.36.0.d.1", "40.36.2.a.2"];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.f.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.72.3.f.1
//   Coordinate number 0:
map_2_coord_0 := 1*(w);
//   Coordinate number 1:
map_2_coord_1 := 1*(10*x^4-2*x^2*w^2-2*x^2*w*t);
//   Coordinate number 2:
map_2_coord_2 := 1*(x);
// Codomain equation:
