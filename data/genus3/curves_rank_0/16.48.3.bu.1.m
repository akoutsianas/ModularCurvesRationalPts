...
// Magma code for modular curve with label 16.48.3.bu.1

// Other names and/or labels
// Cummins-Pauli label: 16F3
// Rouse-Sutherland-Zureick-Brown label: 16.48.3.11

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 2, 0, 15], [9, 12, 0, 13], [13, 9, 14, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["8.24.0.bl.1", "16.24.1.k.1", "16.24.2.a.2"];
...
// Map from the embedded model to the plane model of modular curve with label 16.48.3.bu.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 16.48.3.bu.1
//   Coordinate number 0:
