...
// Magma code for modular curve with label 24.72.3.qi.1

// Other names and/or labels
// Cummins-Pauli label: 12E3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.43

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 0, 12, 13], [7, 12, 6, 19], [9, 4, 8, 3], [11, 21, 18, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.0.d.1", "24.36.1.br.1", "24.36.2.eu.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.qi.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.3.qi.1
//   Coordinate number 0:
