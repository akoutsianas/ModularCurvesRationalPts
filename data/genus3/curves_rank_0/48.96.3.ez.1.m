...
// Magma code for modular curve with label 48.96.3.ez.1

// Other names and/or labels
// Cummins-Pauli label: 16I3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.1045

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[23, 25, 36, 17], [27, 5, 8, 13], [39, 14, 8, 23], [45, 46, 44, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.h.1", "24.48.1.fn.1", "48.48.0.q.1", "48.48.1.cw.1", "48.48.1.cx.1", "48.48.2.cs.1", "48.48.2.ct.1"];
...
// Embedded model
model_0 := [x*t+2*z*t+2*z*u-w*u,2*z*t+w*t+x*u-2*z*u,3*x*z-3*z*w-2*t*u,x^2+3*x*z-2*z^2+w^2-t*u+u^2,x^2-2*z^2-3*z*w+w^2+t^2-t*u,y^2-3*x*w,x^2+4*z^2+w^2+t^2+u^2];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.ez.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
