...
// Magma code for modular curve with label 24.72.3.do.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.251

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[15, 17, 10, 15], [17, 10, 20, 17], [21, 2, 16, 21], [21, 14, 4, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['3.6.0.a.1', '8.12.0.e.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["12.36.1.bk.1", "24.36.0.bv.1", "24.36.1.e.1", "24.36.1.bf.1", "24.36.2.n.1", "24.36.2.w.1", "24.36.2.du.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.do.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
