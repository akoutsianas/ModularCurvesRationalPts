...
// Magma code for modular curve with label 24.72.3.km.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.505

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 4, 16, 9], [7, 15, 0, 19], [11, 15, 8, 1], [11, 20, 12, 13], [17, 4, 4, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.j.1", "24.36.0.k.1", "24.36.1.ca.1", "24.36.1.dv.1", "24.36.2.cc.1", "24.36.2.de.1", "24.36.2.fb.1"];
...
model_2 := [3*x^2-y^2-z^2,252*x^4-144*x^3*y-132*x^2*z^2+48*x*y*z^2+19*z^4-3*w^2];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.km.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
