...
// Magma code for modular curve with label 24.72.3.ot.1

// Other names and/or labels
// Cummins-Pauli label: 24L3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.899

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 13, 8, 7], [1, 19, 16, 23], [5, 15, 0, 13], [13, 21, 0, 7], [19, 16, 8, 13], [19, 17, 16, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.bq.1", "24.36.2.cj.1", "24.36.2.cr.1"];
...
// Embedded model
model_0 := [y*w+z*t-x*u+z*u,2*x^2-2*x*y+2*x*z-w*t-w*u,2*x*w+3*z*w-x*t-y*t+x*u-y*u-z*u,4*x^2-2*x*z+2*z^2+w^2-w*t,2*x^2+4*x*y-2*y^2-2*y*z-2*w*t-t^2+w*u-t*u-u^2,2*x*y+2*y^2+4*x*z+4*w*t+t^2+w*u+2*t*u+2*u^2,4*x^2-2*x*z-4*z^2+w^2+3*w*t+t^2+2*t*u+u^2];

// Singular plane model
model_1 := [72*x^8-3*x^6*y^2+2*x^4*y^4+66*x^6*y*z-28*x^4*y^3*z+261*x^6*z^2+118*x^4*y^2*z^2+88*x^4*y*z^3+8*x^2*y^3*z^3-124*x^4*z^4-44*x^2*y^2*z^4+112*x^2*y*z^5-92*x^2*z^6+8*y^2*z^6-48*y*z^7+72*z^8];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.ot.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Codomain equation:
map_1_codomain := [72*x^8-3*x^6*y^2+2*x^4*y^4+66*x^6*y*z-28*x^4*y^3*z+261*x^6*z^2+118*x^4*y^2*z^2+88*x^4*y*z^3+8*x^2*y^3*z^3-124*x^4*z^4-44*x^2*y^2*z^4+112*x^2*y*z^5-92*x^2*z^6+8*y^2*z^6-48*y*z^7+72*z^8];
