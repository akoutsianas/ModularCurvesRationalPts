...
// Magma code for modular curve with label 24.72.3.bcr.1

// Other names and/or labels
// Cummins-Pauli label: 24Q3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.379

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 7, 2, 19], [7, 12, 0, 19], [9, 11, 16, 15], [13, 14, 16, 1], [17, 7, 10, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bx.1", "24.36.1.fp.1", "24.36.1.go.1"];
