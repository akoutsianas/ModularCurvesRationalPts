...
// Magma code for modular curve with label 40.48.3.i.1

// Other names and/or labels
// Cummins-Pauli label: 20B3
// Rouse-Sutherland-Zureick-Brown label: 40.48.3.9

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 35, 11, 32], [14, 7, 7, 39], [20, 11, 3, 33], [35, 6, 19, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["20.24.1.g.1", "40.12.0.bo.1"];
