...
// Magma code for modular curve with label 48.96.3.bf.2

// Other names and/or labels
// Cummins-Pauli label: 16O3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.156

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 4, 0, 41], [1, 8, 8, 39], [7, 0, 32, 31], [25, 18, 4, 37], [25, 44, 16, 33], [29, 12, 0, 41]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
