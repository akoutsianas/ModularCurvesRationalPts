...
// Magma code for modular curve with label 24.72.3.he.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.679

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 5, 2, 9], [3, 23, 2, 23], [9, 23, 4, 3], [17, 15, 0, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.o.1", "24.36.0.o.1", "24.36.1.p.1", "24.36.1.dm.1", "24.36.1.em.1", "24.36.2.be.1", "24.36.2.eo.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.he.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
