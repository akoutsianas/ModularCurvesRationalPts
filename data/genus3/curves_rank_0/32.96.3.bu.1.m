...
// Magma code for modular curve with label 32.96.3.bu.1

// Other names and/or labels
// Cummins-Pauli label: 32N3
// Rouse-Zureick-Brown label: X616
// Rouse-Sutherland-Zureick-Brown label: 32.96.3.222

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 8, 8, 3], [7, 9, 30, 29], [7, 30, 0, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
