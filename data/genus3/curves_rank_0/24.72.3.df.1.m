...
// Magma code for modular curve with label 24.72.3.df.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.605

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 5, 20, 17], [5, 21, 6, 1], [7, 11, 8, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.bt.1", "24.36.0.w.1", "24.36.1.l.1", "24.36.1.co.1", "24.36.1.dt.1", "24.36.2.l.1", "24.36.2.p.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.df.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
