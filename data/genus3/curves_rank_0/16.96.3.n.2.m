...
// Magma code for modular curve with label 16.96.3.n.2

// Other names and/or labels
// Cummins-Pauli label: 16O3
// Rouse-Zureick-Brown label: X611
// Rouse-Sutherland-Zureick-Brown label: 16.96.3.158

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 2, 0, 1], [9, 4, 0, 1], [11, 8, 4, 1], [13, 4, 12, 15], [13, 12, 0, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
