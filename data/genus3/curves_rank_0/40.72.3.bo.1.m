...
// Magma code for modular curve with label 40.72.3.bo.1

// Other names and/or labels
// Cummins-Pauli label: 20J3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.193

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 20, 38, 21], [17, 31, 0, 23], [23, 10, 6, 7], [23, 13, 6, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.1.d.1", "40.12.0.q.1", "40.36.1.c.1", "40.36.1.i.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.bo.1
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
