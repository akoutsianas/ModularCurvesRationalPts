...
// Magma code for modular curve with label 56.56.3.a.1

// Other names and/or labels
// Cummins-Pauli label: 14C3
// Rouse-Sutherland-Zureick-Brown label: 56.56.3.1

// Group data
level := 56;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 32, 39, 39], [3, 39, 53, 2], [21, 16, 23, 17], [28, 55, 29, 0]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 56;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['7.28.0.a.1', '8.2.0.a.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["7.28.0.a.1", "8.2.0.a.1"];
...
// Map from the embedded model to the plane model of modular curve with label 56.56.3.a.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 56.56.3.a.1
//   Coordinate number 0:
