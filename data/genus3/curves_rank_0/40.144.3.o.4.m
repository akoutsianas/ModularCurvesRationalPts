...
// Magma code for modular curve with label 40.144.3.o.4

// Other names and/or labels
// Cummins-Pauli label: 20T3
// Rouse-Sutherland-Zureick-Brown label: 40.144.3.348

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 16, 36, 35], [21, 31, 2, 25], [23, 38, 24, 37], [31, 18, 8, 1], [39, 12, 0, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
