...
// Magma code for modular curve with label 48.48.3.k.1

// Other names and/or labels
// Cummins-Pauli label: 16D3
// Rouse-Sutherland-Zureick-Brown label: 48.48.3.70

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 7, 6, 5], [19, 45, 10, 5], [31, 25, 34, 47], [43, 22, 32, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["8.24.1.g.1", "48.24.2.a.1", "48.24.2.c.1"];
...
model_2 := [x^2+y^2+z^2,20*x^4+16*x^3*z+16*x^2*y*z+20*x^2*z^2+76*x*y*z^2+40*x*z^3-24*y*z^3+23*z^4-9*w^2];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.3.k.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(u);
