...
// Magma code for modular curve with label 30.72.3.h.2

// Other names and/or labels
// Cummins-Pauli label: 30J3
// Rouse-Sutherland-Zureick-Brown label: 30.72.3.14

// Group data
level := 30;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 10, 19, 9], [16, 25, 19, 17], [22, 5, 23, 14]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["15.36.1.d.1", "30.36.0.e.2", "30.36.2.a.2"];
...
// Embedded model
model_0 := [x*y-x*w-z*w,y*z+x*w-x*t-2*x*u,y^2-y*w+w^2-w*t-2*w*u,5*x^2-3*y*w,2*y^2+y*w-5*w^2-w*t+t^2-2*w*u-t*u-u^2,2*y^2-5*x*z-2*y*w-w^2+w*t+2*w*u,3*y^2+5*z^2-3*y*t-6*y*u];

// Singular plane model
model_1 := [125*x^8-150*x^6*z^2-25*x^4*y*z^3+180*x^4*z^4+15*x^2*y*z^5+y^2*z^6-9*y*z^7-81*z^8];

// Weierstrass model
model_2 := [-31*x^8+38*x^6*z^2+x^4*y+12*x^4*z^4+x^2*y*z^2+68*x^2*z^6+y^2+y*z^4-101*z^8];
...
// Map from the embedded model to the plane model of modular curve with label 30.72.3.h.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(9*u);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 30.72.3.h.2
//   Coordinate number 0:
map_2_coord_0 := 1*(-x);
//   Coordinate number 1:
map_2_coord_1 := 1*(12*x^4-8*x^2*w^2+4*w^4-9*w^3*u);
//   Coordinate number 2:
map_2_coord_2 := 1*(w);
// Codomain equation:
map_2_codomain := [-31*x^8+38*x^6*z^2+x^4*y+12*x^4*z^4+x^2*y*z^2+68*x^2*z^6+y^2+y*z^4-101*z^8];
