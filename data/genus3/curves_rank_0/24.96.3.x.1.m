...
// Magma code for modular curve with label 24.96.3.x.1

// Other names and/or labels
// Cummins-Pauli label: 8B3
// Rouse-Sutherland-Zureick-Brown label: 24.96.3.63

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 20, 0, 17], [11, 20, 4, 15], [15, 20, 20, 3], [17, 8, 2, 7], [17, 20, 14, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.g.2", "24.48.0.c.1", "24.48.2.a.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.96.3.x.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
