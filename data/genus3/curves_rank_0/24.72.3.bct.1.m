...
// Magma code for modular curve with label 24.72.3.bct.1

// Other names and/or labels
// Cummins-Pauli label: 24Q3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.383

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 8, 14, 11], [7, 8, 10, 13], [9, 17, 4, 3], [23, 9, 18, 5], [23, 18, 18, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bx.1", "24.36.1.fo.1", "24.36.1.gp.1"];
