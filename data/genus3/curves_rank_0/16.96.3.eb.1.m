...
// Magma code for modular curve with label 16.96.3.eb.1

// Other names and/or labels
// Cummins-Pauli label: 16N3
// Rouse-Zureick-Brown label: X560
// Rouse-Sutherland-Zureick-Brown label: 16.96.3.332

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 4, 8, 9], [9, 10, 8, 15], [11, 9, 0, 1], [11, 12, 0, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
