...
// Magma code for modular curve with label 24.72.3.bai.1

// Other names and/or labels
// Cummins-Pauli label: 12J3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.115

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 13, 8, 13], [13, 1, 22, 23], [15, 23, 22, 21], [17, 22, 22, 7], [19, 11, 10, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bs.1", "24.24.1.ex.1", "24.36.1.fn.1", "24.36.1.ga.1"];
