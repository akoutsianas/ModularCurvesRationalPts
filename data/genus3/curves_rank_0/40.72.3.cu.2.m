...
// Magma code for modular curve with label 40.72.3.cu.2

// Other names and/or labels
// Cummins-Pauli label: 20I3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.55

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 20, 4, 33], [19, 4, 2, 11], [29, 7, 2, 19], [33, 25, 2, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["10.36.1.b.1", "40.36.0.c.1", "40.36.2.b.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.cu.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.72.3.cu.2
//   Coordinate number 0:
