...
// Magma code for modular curve with label 48.48.3.c.1

// Other names and/or labels
// Cummins-Pauli label: 16D3
// Rouse-Sutherland-Zureick-Brown label: 48.48.3.37

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 8, 40, 11], [27, 2, 4, 29], [31, 34, 44, 37], [39, 46, 4, 27], [47, 6, 44, 29], [47, 12, 0, 41]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["8.24.1.c.1", "48.24.1.j.1", "48.24.1.k.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.3.c.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(6*z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.48.3.c.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-t);
//   Coordinate number 1:
map_2_coord_1 := 1*(18*x^4-6*x*z*t^2-2*t^4);
//   Coordinate number 2:
map_2_coord_2 := 1*(x);
// Codomain equation:
