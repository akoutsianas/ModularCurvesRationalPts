...
// Magma code for modular curve with label 24.72.3.uv.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.218

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 18, 12, 19], [9, 13, 20, 3], [11, 3, 12, 17], [15, 4, 10, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.ba.1", "24.36.0.bt.1", "24.36.1.cy.1", "24.36.1.fc.1", "24.36.2.ey.1", "24.36.2.fr.1", "24.36.2.fv.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.uv.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*w);
