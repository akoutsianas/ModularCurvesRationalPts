...
// Magma code for modular curve with label 16.96.3.k.1

// Other names and/or labels
// Cummins-Pauli label: 8B3
// Rouse-Sutherland-Zureick-Brown label: 16.96.3.180

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 14, 14, 5], [7, 6, 0, 3], [7, 10, 14, 1], [9, 14, 10, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.d.1", "16.48.0.b.1", "16.48.1.bo.1", "16.48.1.by.1", "16.48.2.b.1", "16.48.2.bb.1", "16.48.2.bj.1"];
...
// Map from the embedded model to the plane model of modular curve with label 16.96.3.k.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
