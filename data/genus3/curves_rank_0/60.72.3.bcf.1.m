...
// Magma code for modular curve with label 60.72.3.bcf.1

// Other names and/or labels
// Cummins-Pauli label: 30J3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.854

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 45, 21, 14], [23, 30, 21, 41], [23, 30, 57, 37], [47, 40, 25, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["30.36.0.f.1", "60.36.1.dp.1", "60.36.2.fv.2"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.bcf.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.72.3.bcf.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-y);
//   Coordinate number 1:
