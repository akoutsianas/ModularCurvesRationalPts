...
// Magma code for modular curve with label 60.72.3.ne.2

// Other names and/or labels
// Cummins-Pauli label: 20H3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.828

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 5, 14, 29], [13, 30, 34, 59], [13, 35, 52, 39], [37, 35, 46, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.2.a.2", "60.36.0.e.2", "60.36.1.x.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.ne.2
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.72.3.ne.2
//   Coordinate number 0:
map_2_coord_0 := 1*(t^3*u^3);
//   Coordinate number 1:
map_2_coord_1 := 1*(230400/11*w^3*t^15*u^6-176640/11*w^3*t^13*u^8+73536/11*w^3*t^11*u^10-21632/33*w^3*t^9*u^12+2560/11*w^2*t^16*u^6-5824/33*w^2*t^14*u^8+7232/99*w^2*t^12*u^10-676/99*w^2*t^10*u^12+172800/11*w*t^17*u^6-262080/11*w*t^15*u^8+89712/11*w*t^13*u^10-7228/11*w*t^11*u^12+1920/11*t^18*u^6-2896/11*t^16*u^8+2924/33*t^14*u^10-241/33*t^12*u^12);
//   Coordinate number 2:
