...
// Magma code for modular curve with label 24.72.3.vs.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.643

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 13, 16, 21], [3, 19, 22, 9], [7, 16, 4, 11], [11, 2, 20, 7], [23, 5, 16, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.bw.1", "24.36.0.by.1", "24.36.1.cu.1", "24.36.1.dg.1", "24.36.1.fn.1", "24.36.2.ew.1", "24.36.2.fi.1"];
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.3.vs.1
//   Coordinate number 0:
