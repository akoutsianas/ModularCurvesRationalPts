...
// Magma code for modular curve with label 40.120.3.d.1

// Other names and/or labels
// Cummins-Pauli label: 10D3
// Rouse-Sutherland-Zureick-Brown label: 40.120.3.17

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[24, 15, 21, 6], [25, 6, 31, 5], [32, 13, 17, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 120;
...
covers := ["10.60.1.a.1", "40.40.1.bv.1"];
