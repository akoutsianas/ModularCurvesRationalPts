...
// Magma code for modular curve with label 48.144.3.d.2

// Other names and/or labels
// Cummins-Pauli label: 48M3
// Rouse-Sutherland-Zureick-Brown label: 48.144.3.4

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 18, 24, 23], [19, 17, 14, 23], [29, 30, 24, 23], [31, 25, 38, 1], [35, 12, 36, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.ef.1", "48.72.0.a.1", "48.72.2.c.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.3.d.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.3.d.2
//   Coordinate number 0:
map_2_coord_0 := 1*(-t);
//   Coordinate number 1:
map_2_coord_1 := 1*(-5*y^4-3*y*z*t^2);
//   Coordinate number 2:
map_2_coord_2 := 1*(y);
// Codomain equation:
