...
// Magma code for modular curve with label 24.96.3.gy.1

// Other names and/or labels
// Cummins-Pauli label: 24W3
// Rouse-Sutherland-Zureick-Brown label: 24.96.3.611

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 18, 4, 5], [13, 3, 0, 5], [13, 9, 20, 7], [19, 15, 20, 17], [23, 12, 0, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.48.0.bu.1", "24.48.1.iw.1", "24.48.2.g.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.96.3.gy.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.96.3.gy.1
//   Coordinate number 0:
map_2_coord_0 := 1*(u);
//   Coordinate number 1:
