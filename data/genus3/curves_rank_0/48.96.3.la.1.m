...
// Magma code for modular curve with label 48.96.3.la.1

// Other names and/or labels
// Cummins-Pauli label: 16I3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.1107

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 32, 34, 39], [9, 20, 16, 41], [13, 17, 10, 7], [39, 7, 34, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.t.1", "24.48.1.hb.1", "48.48.0.cf.2", "48.48.1.cz.1", "48.48.1.ex.1", "48.48.2.bp.1", "48.48.2.bw.1"];
...
// Embedded model
model_0 := [x^2-x*y+y^2-t^2,y*z-z^2+x*w+w^2-t*u,2*z*t-x*u-y*u+z*u-w*u,y*z-2*x*w+z*w-w^2+t^2-t*u,x*z-y*z+z^2-y*w+2*z*w-t*u,2*w*t-x*u+2*y*u-2*z*u-w*u,x*z-y*z-z^2-y*w-2*w^2-t*u+3*u^2];
