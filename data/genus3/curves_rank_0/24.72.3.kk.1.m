...
// Magma code for modular curve with label 24.72.3.kk.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.58

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 17, 16, 19], [19, 6, 6, 11], [23, 23, 16, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.0.e.1", "24.36.1.bg.1", "24.36.1.by.1", "24.36.1.du.1", "24.36.2.ce.1", "24.36.2.dj.1", "24.36.2.ey.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.kk.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.3.kk.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-u);
//   Coordinate number 1:
