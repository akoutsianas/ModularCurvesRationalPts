...
// Magma code for modular curve with label 24.72.3.jk.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.498

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 2, 14, 23], [7, 17, 14, 11], [9, 22, 22, 3], [23, 11, 16, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.h.1", "24.36.0.n.1", "24.36.1.ca.1", "24.36.1.eb.1", "24.36.2.bw.1", "24.36.2.cy.1", "24.36.2.ey.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.jk.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
