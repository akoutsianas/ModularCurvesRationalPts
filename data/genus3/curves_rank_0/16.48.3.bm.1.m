...
// Magma code for modular curve with label 16.48.3.bm.1

// Other names and/or labels
// Cummins-Pauli label: 16C3
// Rouse-Sutherland-Zureick-Brown label: 16.48.3.7

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 15, 8, 3], [11, 13, 4, 1], [15, 13, 6, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["8.24.0.bh.1", "16.24.1.m.1", "16.24.2.b.1"];
...
// Map from the embedded model to the plane model of modular curve with label 16.48.3.bm.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 16.48.3.bm.1
//   Coordinate number 0:
map_2_coord_0 := 1*(y*t);
//   Coordinate number 1:
