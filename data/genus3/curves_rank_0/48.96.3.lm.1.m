...
// Magma code for modular curve with label 48.96.3.lm.1

// Other names and/or labels
// Cummins-Pauli label: 16I3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.1139

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 31, 12, 13], [41, 23, 40, 39], [41, 41, 2, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.x.1", "24.48.1.hn.1", "48.48.0.ch.1", "48.48.1.db.1", "48.48.1.ex.1", "48.48.2.bv.1", "48.48.2.bx.2"];
