...
// Magma code for modular curve with label 24.72.3.cg.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.725

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 4, 16, 3], [13, 10, 10, 11], [15, 16, 4, 15], [17, 5, 20, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.u.1", "24.36.0.bl.1", "24.36.1.i.1", "24.36.1.bn.1", "24.36.1.fm.1", "24.36.2.i.1", "24.36.2.p.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.cg.1
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
