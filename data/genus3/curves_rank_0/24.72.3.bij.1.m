...
// Magma code for modular curve with label 24.72.3.bij.1

// Other names and/or labels
// Cummins-Pauli label: 24I3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.762

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 11, 14, 21], [17, 19, 14, 23], [19, 22, 8, 7], [21, 14, 20, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.0.ch.1", "24.36.1.fe.1", "24.36.2.gl.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.bij.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.3.bij.1
//   Coordinate number 0:
