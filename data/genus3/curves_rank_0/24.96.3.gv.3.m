...
// Magma code for modular curve with label 24.96.3.gv.3

// Other names and/or labels
// Cummins-Pauli label: 24W3
// Rouse-Sutherland-Zureick-Brown label: 24.96.3.135

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 21, 16, 1], [11, 6, 0, 7], [17, 18, 16, 7], [19, 9, 12, 13], [23, 9, 20, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["12.48.0.c.4", "24.48.1.iv.1", "24.48.2.g.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.96.3.gv.3
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.96.3.gv.3
//   Coordinate number 0:
map_2_coord_0 := 1*(-3/2*y^2-5/2*y*w+3*y*t-5/3*w^2+2*w*t);
//   Coordinate number 1:
map_2_coord_1 := 1*(6*y^4*z*w^3+10*y^3*z*w^4-12*y^3*z*w^3*t+16/3*y^2*z*w^5-8*y^2*z*w^4*t-7/9*y*z*w^6+4/3*y*z*w^5*t-2/3*z*w^7+8/9*z*w^6*t);
//   Coordinate number 2:
map_2_coord_2 := 1*(3/2*y^2+5/2*y*w-3*y*t+4/3*w^2-2*w*t);
// Codomain equation:
