...
// Magma code for modular curve with label 24.72.3.zf.1

// Other names and/or labels
// Cummins-Pauli label: 24O3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.871

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 16, 14, 23], [15, 7, 8, 9], [15, 17, 22, 9], [19, 10, 2, 13], [19, 22, 16, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fn.1", "24.36.1.fr.1", "24.36.1.fs.1"];
