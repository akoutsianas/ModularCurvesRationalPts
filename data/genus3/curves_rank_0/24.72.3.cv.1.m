...
// Magma code for modular curve with label 24.72.3.cv.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.587

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 13, 22, 15], [7, 16, 6, 5], [19, 18, 12, 19], [21, 23, 14, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.bj.1", "24.36.0.g.1", "24.36.1.j.1", "24.36.1.dm.1", "24.36.1.eh.1", "24.36.2.l.1", "24.36.2.n.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.cv.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(u);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.3.cv.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-z);
//   Coordinate number 1:
