...
// Magma code for modular curve with label 24.96.3.cn.1

// Other names and/or labels
// Cummins-Pauli label: 24U3
// Rouse-Sutherland-Zureick-Brown label: 24.96.3.618

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 3, 0, 17], [7, 15, 16, 11], [11, 18, 0, 1], [13, 6, 8, 5], [17, 18, 12, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.48.0.bs.2", "24.48.1.cg.1", "24.48.2.f.2"];
...
// Map from the embedded model to the plane model of modular curve with label 24.96.3.cn.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(u);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.96.3.cn.1
//   Coordinate number 0:
map_2_coord_0 := 1*(w);
//   Coordinate number 1:
