...
// Magma code for modular curve with label 60.72.3.yc.2

// Other names and/or labels
// Cummins-Pauli label: 20G3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.783

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 30, 24, 19], [7, 25, 0, 1], [7, 30, 34, 1], [47, 40, 0, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.1.g.1", "30.36.0.b.2", "60.36.2.fr.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.yc.2
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
map_1_coord_1 := 1*(5*w);
