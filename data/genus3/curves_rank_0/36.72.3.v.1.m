...
// Magma code for modular curve with label 36.72.3.v.1

// Other names and/or labels
// Cummins-Pauli label: 36G3
// Rouse-Sutherland-Zureick-Brown label: 36.72.3.18

// Group data
level := 36;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 19, 18, 13], [23, 13, 18, 17], [25, 15, 0, 29], [31, 33, 0, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.24.1.j.1", "18.36.0.a.1"];
...
// Map from the embedded model to the plane model of modular curve with label 36.72.3.v.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 36.72.3.v.1
//   Coordinate number 0:
map_2_coord_0 := 1*(x+y);
//   Coordinate number 1:
