...
// Magma code for modular curve with label 40.144.3.k.1

// Other names and/or labels
// Cummins-Pauli label: 40J3
// Rouse-Sutherland-Zureick-Brown label: 40.144.3.340

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 16, 34, 5], [7, 1, 28, 15], [19, 23, 30, 27], [23, 29, 2, 15], [39, 28, 18, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
