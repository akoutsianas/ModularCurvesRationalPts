...
// Magma code for modular curve with label 24.96.3.ig.1

// Other names and/or labels
// Cummins-Pauli label: 8A3
// Rouse-Sutherland-Zureick-Brown label: 24.96.3.70

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 4, 4, 3], [19, 23, 2, 21], [21, 19, 4, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.bs.1", "24.32.1.f.1", "24.48.1.lm.1", "24.48.1.mf.1"];
