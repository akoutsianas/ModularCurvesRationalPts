...
// Magma code for modular curve with label 12.72.3.d.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 12.72.3.67

// Group data
level := 12;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 8, 8, 7], [5, 10, 8, 5], [9, 2, 4, 9], [11, 0, 0, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.0.q.1", "12.36.1.a.1", "12.36.1.j.1", "12.36.1.bl.1", "12.36.2.b.1", "12.36.2.h.1", "12.36.2.ba.1"];
...
// Embedded model
model_0 := [2*x*w-x*t-z*t-y*u,y*w+x*t-y*t+2*x*u,3*x^2+3*y^2-w*t-t*u-u^2,3*x*y-3*z^2+w^2-w*t+u^2,3*x^2+3*x*y-3*y*z+w*t-t^2+u^2,3*x^2-3*x*y-3*y^2+3*y*z+w*t+2*t*u+u^2,3*x^2-6*x*z+3*y*z-u^2];

// Singular plane model
model_1 := [x^6-2*x^4*y^2+x^2*y^4-4*x^4*y*z+4*x^2*y^3*z-6*x^4*z^2+14*x^2*y^2*z^2+20*x^2*y*z^3+13*x^2*z^4-12*y^2*z^4-24*y*z^5-12*z^6];
...
// Map from the embedded model to the plane model of modular curve with label 12.72.3.d.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Codomain equation:
map_1_codomain := [x^6-2*x^4*y^2+x^2*y^4-4*x^4*y*z+4*x^2*y^3*z-6*x^4*z^2+14*x^2*y^2*z^2+20*x^2*y*z^3+13*x^2*z^4-12*y^2*z^4-24*y*z^5-12*z^6];
