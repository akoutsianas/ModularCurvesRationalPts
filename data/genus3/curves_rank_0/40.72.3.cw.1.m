...
// Magma code for modular curve with label 40.72.3.cw.1

// Other names and/or labels
// Cummins-Pauli label: 20I3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.202

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 15, 16, 11], [19, 34, 38, 25], [23, 1, 32, 17], [37, 19, 0, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.2.a.1", "40.36.0.d.2", "40.36.1.e.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.cw.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.72.3.cw.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-y^2);
//   Coordinate number 1:
