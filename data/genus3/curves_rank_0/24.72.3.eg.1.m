...
// Magma code for modular curve with label 24.72.3.eg.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.83

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 15, 6, 7], [13, 21, 6, 17], [23, 13, 2, 17], [23, 17, 22, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.0.m.1", "24.36.1.i.1", "24.36.1.bv.1", "24.36.1.fh.1", "24.36.2.r.1", "24.36.2.w.1", "24.36.2.dg.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.eg.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
