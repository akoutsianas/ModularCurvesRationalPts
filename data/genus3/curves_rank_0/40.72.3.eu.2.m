...
// Magma code for modular curve with label 40.72.3.eu.2

// Other names and/or labels
// Cummins-Pauli label: 20G3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.209

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 29, 18, 1], [7, 14, 26, 5], [13, 31, 22, 7], [29, 23, 12, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.2.a.1", "40.36.0.b.1", "40.36.1.k.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.eu.2
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.72.3.eu.2
//   Coordinate number 0:
