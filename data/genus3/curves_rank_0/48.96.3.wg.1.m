...
// Magma code for modular curve with label 48.96.3.wg.1

// Other names and/or labels
// Cummins-Pauli label: 16L3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.506

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 23, 38, 3], [21, 16, 22, 7], [37, 3, 34, 43], [45, 44, 8, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.bd.1", "24.48.1.mh.1", "48.48.1.il.1"];
