...
// Magma code for modular curve with label 24.72.3.qh.1

// Other names and/or labels
// Cummins-Pauli label: 12E3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.558

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 0, 6, 19], [9, 16, 22, 21], [9, 19, 22, 9], [15, 23, 10, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.bk.1", "24.36.0.e.1", "24.36.1.br.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.qh.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.3.qh.1
//   Coordinate number 0:
