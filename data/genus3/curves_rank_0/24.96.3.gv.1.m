...
// Magma code for modular curve with label 24.96.3.gv.1

// Other names and/or labels
// Cummins-Pauli label: 24W3
// Rouse-Sutherland-Zureick-Brown label: 24.96.3.119

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 9, 12, 5], [7, 3, 12, 1], [7, 3, 16, 7], [13, 6, 16, 23], [23, 6, 4, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["12.48.0.c.2", "24.48.1.iv.1", "24.48.2.g.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.96.3.gv.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.96.3.gv.1
//   Coordinate number 0:
