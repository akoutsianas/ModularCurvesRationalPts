...
// Magma code for modular curve with label 40.72.3.eh.1

// Other names and/or labels
// Cummins-Pauli label: 20G3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.84

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 36, 0, 13], [13, 33, 22, 19], [17, 4, 18, 13], [39, 14, 8, 35]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.0.a.1", "40.36.1.i.1", "40.36.2.a.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.eh.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
