...
// Magma code for modular curve with label 16.96.3.eb.2

// Other names and/or labels
// Cummins-Pauli label: 16N3
// Rouse-Zureick-Brown label: X554
// Rouse-Sutherland-Zureick-Brown label: 16.96.3.328

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 2, 0, 3], [3, 11, 8, 15], [5, 9, 8, 5], [13, 15, 8, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
