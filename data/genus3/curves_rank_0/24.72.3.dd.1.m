...
// Magma code for modular curve with label 24.72.3.dd.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.602

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 14, 4, 23], [5, 16, 2, 5], [5, 21, 12, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.br.1", "24.36.0.bc.1", "24.36.1.l.1", "24.36.1.ci.1", "24.36.1.dz.1", "24.36.2.k.1", "24.36.2.o.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.dd.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
