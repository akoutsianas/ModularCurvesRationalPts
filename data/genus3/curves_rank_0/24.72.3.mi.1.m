...
// Magma code for modular curve with label 24.72.3.mi.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.634

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 14, 20, 23], [13, 17, 20, 21], [15, 5, 20, 17], [23, 6, 12, 17], [23, 22, 16, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.s.1", "24.36.0.u.1", "24.36.1.bt.1", "24.36.1.cu.1", "24.36.1.eg.1", "24.36.2.dq.1", "24.36.2.dw.1"];
...
model_2 := [-3*x^2+y^2+z^2,1512*x^4-864*x^3*y-504*x^2*z^2+144*x*y*z^2+26*z^4-9*w^2];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.mi.1
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
map_1_coord_1 := 1*(4*z);
