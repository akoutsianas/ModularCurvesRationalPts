...
// Magma code for modular curve with label 60.72.3.zb.2

// Other names and/or labels
// Cummins-Pauli label: 20G3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.741

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 35, 14, 51], [11, 55, 42, 37], [33, 25, 38, 59], [43, 35, 58, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.1.i.1", "60.36.0.b.2", "60.36.2.fq.2"];
...
// Embedded model
model_0 := [x^2+z*t-t*u,y*z-y*t+w*t,x^2+3*y^2-3*y*w-u^2,y*z-4*y*u-w*u,2*x^2+z*t-z*u+3*t*u,x^2+3*y^2+z^2-3*w^2-z*t-2*z*u+t*u+3*u^2,x^2-6*y^2+z^2-6*y*w-3*w^2-2*z*t+4*t^2-z*u-2*t*u+2*u^2];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.zb.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
