...
// Magma code for modular curve with label 16.96.3.cc.1

// Other names and/or labels
// Cummins-Pauli label: 16J3
// Rouse-Sutherland-Zureick-Brown label: 16.96.3.324

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 4, 4, 15], [3, 10, 12, 13], [11, 5, 0, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.0.r.1", "16.48.1.o.1", "16.48.2.i.1"];
...
// Map from the embedded model to the plane model of modular curve with label 16.96.3.cc.1
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 16.96.3.cc.1
//   Coordinate number 0:
map_2_coord_0 := 1*(w^3-3*w^2*t+w*t^2+t^3);
//   Coordinate number 1:
map_2_coord_1 := 1*(128*z*w^11-896*z*w^10*t+384*z*w^10*u+1664*z*w^9*t^2-2048*z*w^9*t*u+640*z*w^8*t^3+2688*z*w^8*t^2*u-2816*z*w^7*t^4-512*z*w^7*t^3*u-768*z*w^6*t^5+3328*z*w^6*t^4*u-768*z*w^5*t^6-1536*z*w^5*t^5*u+1280*z*w^4*t^7-4352*z*w^4*t^6*u+4736*z*w^3*t^8-5632*z*w^3*t^7*u+3712*z*w^2*t^9-5760*z*w^2*t^8*u+1152*z*w*t^10-2560*z*w*t^9*u+128*z*t^11-384*z*t^10*u);
//   Coordinate number 2:
map_2_coord_2 := 1*(-w^3+w^2*t-4*w^2*u+3*w*t^2+t^3-4*t^2*u);
// Codomain equation:
