...
// Magma code for modular curve with label 24.72.3.pb.1

// Other names and/or labels
// Cummins-Pauli label: 24L3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.911

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 22, 8, 23], [7, 19, 4, 23], [13, 0, 12, 19], [19, 16, 8, 1], [23, 17, 16, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.bt.1", "24.36.2.cl.1", "24.36.2.cm.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.pb.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
