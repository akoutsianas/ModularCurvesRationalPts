...
// Magma code for modular curve with label 24.72.3.bgf.1

// Other names and/or labels
// Cummins-Pauli label: 24Q3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.385

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 23, 22, 9], [19, 1, 2, 13], [19, 7, 20, 1], [19, 15, 18, 5], [23, 20, 10, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bx.1", "24.36.1.fr.1", "24.36.1.gs.1"];
...
//   Coordinate number 1:
map_0_coord_1 := 1*((y^2+z^2)^6*(3*x^2*y^4-6*x^2*y^2*z^2+y^6-3*y^2*z^4-z^6));
