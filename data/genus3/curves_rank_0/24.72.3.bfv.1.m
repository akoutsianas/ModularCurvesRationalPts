...
// Magma code for modular curve with label 24.72.3.bfv.1

// Other names and/or labels
// Cummins-Pauli label: 24Q3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.820

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 19, 16, 7], [11, 1, 2, 17], [13, 5, 16, 7], [13, 23, 2, 23], [19, 22, 20, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fo.1", "24.36.1.gd.1", "24.36.1.gs.1"];
