...
// Magma code for modular curve with label 48.48.3.cm.1

// Other names and/or labels
// Cummins-Pauli label: 16C3
// Rouse-Sutherland-Zureick-Brown label: 48.48.3.197

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[25, 44, 2, 35], [39, 43, 44, 17], [43, 37, 20, 25], [45, 44, 4, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.2.b.1", "24.24.0.fd.1", "48.24.1.n.2"];
...
model_2 := [x^2+y^2+z^2,-17*x^4-21*x^3*y-28*x^3*z-35*x^2*y*z-38*x^2*z^2-35*x*y*z^2-28*x*z^3-21*y*z^3-17*z^4-3*w^2];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.3.cm.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
