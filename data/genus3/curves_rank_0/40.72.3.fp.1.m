...
// Magma code for modular curve with label 40.72.3.fp.1

// Other names and/or labels
// Cummins-Pauli label: 40G3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.137

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 9, 22, 25], [9, 9, 12, 31], [27, 21, 8, 25], [33, 3, 12, 19], [35, 28, 8, 15], [39, 10, 18, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
