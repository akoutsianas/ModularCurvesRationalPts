...
// Magma code for modular curve with label 24.72.3.qd.1

// Other names and/or labels
// Cummins-Pauli label: 12E3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.210

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 16, 20, 15], [7, 0, 18, 13], [7, 6, 0, 7], [9, 10, 4, 21], [17, 9, 18, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.k.1", "24.36.0.f.1", "24.36.2.eu.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.qd.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.3.qd.1
//   Coordinate number 0:
