...
// Magma code for modular curve with label 24.72.3.ks.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.663

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 15, 0, 1], [7, 10, 8, 13], [13, 18, 0, 11], [15, 2, 20, 9], [17, 0, 12, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.t.1", "24.36.0.o.1", "24.36.1.be.1", "24.36.1.cc.1", "24.36.1.ea.1", "24.36.2.de.1", "24.36.2.fc.1"];
...
model_2 := [-2*x^2-2*x*y-2*y^2+z^2,54*x^4-36*x^2*z^2+8*z^4-3*w^2];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.ks.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
