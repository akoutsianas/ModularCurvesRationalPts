...
// Magma code for modular curve with label 24.36.3.c.1

// Other names and/or labels
// Cummins-Pauli label: 24A3
// Rouse-Sutherland-Zureick-Brown label: 24.36.3.4

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 11, 20, 3], [11, 2, 10, 17], [13, 5, 16, 19], [13, 5, 22, 7], [13, 14, 8, 17], [19, 5, 16, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 36;
...
;// CM discriminants
CM_discs := [-4];
// Modular curve is a fiber product of the following curvesfactors := ['3.3.0.a.1', '8.12.1.c.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["8.12.1.c.1", "12.18.0.l.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.36.3.c.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.36.3.c.1
//   Coordinate number 0:
