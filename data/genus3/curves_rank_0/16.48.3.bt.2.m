...
// Magma code for modular curve with label 16.48.3.bt.2

// Other names and/or labels
// Cummins-Pauli label: 16F3
// Rouse-Sutherland-Zureick-Brown label: 16.48.3.19

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 8, 8, 3], [11, 0, 12, 9], [11, 13, 6, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["8.24.0.bk.1", "16.24.1.k.1", "16.24.2.a.2"];
...
// Map from the embedded model to the plane model of modular curve with label 16.48.3.bt.2
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
