...
// Magma code for modular curve with label 60.72.3.bcm.2

// Other names and/or labels
// Cummins-Pauli label: 30J3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.667

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[4, 5, 25, 37], [26, 5, 29, 28], [47, 50, 44, 49], [57, 10, 32, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["15.36.1.d.1", "60.36.0.cg.2", "60.36.2.fu.2"];
...
// Embedded model
model_0 := [x*z-x*w+y*w,z^2-z*w+w^2+w*t+2*w*u,y*z-x*w-x*t-2*x*u,5*x^2+3*z*w,2*z^2+z*w-5*w^2+w*t+t^2+2*w*u-t*u-u^2,5*x*y-2*z^2+2*z*w+w^2+w*t+2*w*u,5*y^2-3*z^2-3*z*t-6*z*u];

// Singular plane model
model_1 := [125*x^8+150*x^6*z^2+25*x^4*y*z^3+180*x^4*z^4+15*x^2*y*z^5+y^2*z^6+9*y*z^7-81*z^8];

// Weierstrass model
model_2 := [-31*x^8-37*x^6*z^2+x^4*y+12*x^4*z^4+x^2*y*z^2-67*x^2*z^6+y^2+y*z^4-101*z^8];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.bcm.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(9*u);
...
map_1_coord_2 := 1*(w);
// Codomain equation:
map_1_codomain := [125*x^8+150*x^6*z^2+25*x^4*y*z^3+180*x^4*z^4+15*x^2*y*z^5+y^2*z^6+9*y*z^7-81*z^8];

// Map from the embedded model to the Weierstrass model of modular curve with label 60.72.3.bcm.2
//   Coordinate number 0:
map_2_coord_0 := 1*(-x);
//   Coordinate number 1:
map_2_coord_1 := 1*(-13*x^4-8*x^2*w^2-5*w^4-9*w^3*u);
//   Coordinate number 2:
map_2_coord_2 := 1*(w);
// Codomain equation:
map_2_codomain := [-31*x^8-37*x^6*z^2+x^4*y+12*x^4*z^4+x^2*y*z^2-67*x^2*z^6+y^2+y*z^4-101*z^8];
