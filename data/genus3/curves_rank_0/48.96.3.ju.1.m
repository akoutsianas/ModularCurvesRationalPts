...
// Magma code for modular curve with label 48.96.3.ju.1

// Other names and/or labels
// Cummins-Pauli label: 16I3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.265

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 35, 4, 9], [7, 43, 20, 1], [23, 24, 14, 17], [37, 1, 36, 43], [41, 24, 40, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.bp.1", "48.48.0.t.1", "48.48.1.gi.1", "48.48.1.gk.1", "48.48.2.p.1", "48.48.2.bp.1", "48.48.2.br.1"];
...
model_2 := [2*x^2-2*x*y+2*y^2-z^2,-36*x^3*y+174*x^2*z^2-156*x*y*z^2+41*z^4-16*w^2];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.ju.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
