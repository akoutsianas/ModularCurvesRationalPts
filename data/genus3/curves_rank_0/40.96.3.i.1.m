...
// Magma code for modular curve with label 40.96.3.i.1

// Other names and/or labels
// Cummins-Pauli label: 8B3
// Rouse-Sutherland-Zureick-Brown label: 40.96.3.191

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 36, 16, 25], [21, 32, 14, 25], [27, 30, 34, 29], [31, 8, 24, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["40.48.0.g.1", "40.48.1.k.1", "40.48.2.c.1"];
...
// Map from the embedded model to the plane model of modular curve with label 40.96.3.i.1
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.96.3.i.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-z-t);
//   Coordinate number 1:
