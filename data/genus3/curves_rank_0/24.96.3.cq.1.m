...
// Magma code for modular curve with label 24.96.3.cq.1

// Other names and/or labels
// Cummins-Pauli label: 24V3
// Rouse-Sutherland-Zureick-Brown label: 24.96.3.555

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 12, 8, 5], [7, 15, 12, 7], [17, 12, 8, 17], [23, 3, 8, 19], [23, 18, 16, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.24.0.o.1", "24.48.1.cg.1", "24.48.1.it.1", "24.48.1.iv.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.96.3.cq.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
