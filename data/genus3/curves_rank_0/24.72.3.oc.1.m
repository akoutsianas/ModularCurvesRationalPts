...
// Magma code for modular curve with label 24.72.3.oc.1

// Other names and/or labels
// Cummins-Pauli label: 24L3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.888

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 19, 4, 11], [11, 1, 4, 1], [15, 13, 20, 9], [19, 5, 16, 1], [19, 13, 4, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.be.1", "24.36.2.co.1", "24.36.2.cu.1"];
...
model_2 := [2*x^2-2*x*y+2*y^2-z^2,27*x^4-18*x^2*z^2+4*z^4-6*w^2];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.oc.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
