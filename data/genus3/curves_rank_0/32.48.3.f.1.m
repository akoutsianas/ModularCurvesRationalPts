...
// Magma code for modular curve with label 32.48.3.f.1

// Other names and/or labels
// Cummins-Pauli label: 32B3
// Rouse-Zureick-Brown label: X437
// Rouse-Sutherland-Zureick-Brown label: 32.48.3.9

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 8, 0, 7], [17, 8, 8, 19], [31, 16, 24, 21], [31, 29, 4, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
// Map from the embedded model to the plane model of modular curve with label 32.48.3.f.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*w);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 32.48.3.f.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-1/2*y);
//   Coordinate number 1:
map_2_coord_1 := 1*(-1/16*y^4-z^3*w);
//   Coordinate number 2:
map_2_coord_2 := 1*(z);
// Codomain equation:
