...
// Magma code for modular curve with label 40.96.3.bh.1

// Other names and/or labels
// Cummins-Pauli label: 8B3
// Rouse-Sutherland-Zureick-Brown label: 40.96.3.187

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 26, 12, 17], [29, 38, 26, 19], [33, 18, 38, 27], [35, 22, 14, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["40.48.0.g.1", "40.48.1.bp.1", "40.48.2.c.1"];
...
// Weierstrass model
model_2 := [-2*x^8-12*x^7*z+56*x^6*z^2+84*x^5*z^3-140*x^4*z^4-84*x^3*z^5+56*x^2*z^6+12*x*z^7+y^2-2*z^8];
...
// Map from the embedded model to the plane model of modular curve with label 40.96.3.bh.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(5*z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.96.3.bh.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-2*w-t-u);
//   Coordinate number 1:
map_2_coord_1 := 1*(240*z*w*t^2+160*z*w*t*u+240*z*w*u^2+160*z*t^3+160*z*t^2*u+160*z*t*u^2+160*z*u^3);
//   Coordinate number 2:
map_2_coord_2 := 1*(-t+u);
// Codomain equation:
map_2_codomain := [-2*x^8-12*x^7*z+56*x^6*z^2+84*x^5*z^3-140*x^4*z^4-84*x^3*z^5+56*x^2*z^6+12*x*z^7+y^2-2*z^8];
