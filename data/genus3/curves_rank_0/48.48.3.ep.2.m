...
// Magma code for modular curve with label 48.48.3.ep.2

// Other names and/or labels
// Cummins-Pauli label: 16F3
// Rouse-Sutherland-Zureick-Brown label: 48.48.3.20

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 24, 24, 5], [11, 14, 40, 9], [19, 25, 46, 9], [39, 13, 22, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["8.24.0.bk.1", "48.24.1.i.1", "48.24.2.e.1"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.3.ep.2
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
