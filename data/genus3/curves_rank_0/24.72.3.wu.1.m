...
// Magma code for modular curve with label 24.72.3.wu.1

// Other names and/or labels
// Cummins-Pauli label: 24O3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.459

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 5, 22, 19], [11, 20, 14, 1], [15, 2, 4, 3], [19, 7, 16, 17], [23, 18, 0, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bn.1", "24.36.1.fo.1", "24.36.1.fs.1"];
