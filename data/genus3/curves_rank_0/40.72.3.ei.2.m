...
// Magma code for modular curve with label 40.72.3.ei.2

// Other names and/or labels
// Cummins-Pauli label: 20G3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.210

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 17, 34, 3], [13, 20, 12, 1], [31, 26, 30, 17], [37, 5, 10, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.2.a.1", "40.36.0.b.2", "40.36.1.i.1"];
...
// Embedded model
model_0 := [z*w+y*t-w*t,2*x^2-2*y^2-2*z^2+2*y*w+2*z*t+2*y*u-w*u+u^2,5*y*z+y*t+4*z*u+t*u,2*x^2-3*y^2+2*z^2-2*z*t-4*w*u-u^2,x^2-2*y^2-2*z^2-2*y*w+2*w^2-3*z*t-2*y*u-w*u-u^2,3*y^2-2*z^2-2*y*w+2*z*t+3*y*u-w*u+u^2,x^2+2*y*w+2*w^2-3*z*t-2*t^2+4*y*u+w*u+2*u^2];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.ei.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 40.72.3.ei.2
//   Coordinate number 0:
