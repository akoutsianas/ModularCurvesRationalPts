...
// Magma code for modular curve with label 48.144.3.bb.2

// Other names and/or labels
// Cummins-Pauli label: 48M3
// Rouse-Sutherland-Zureick-Brown label: 48.144.3.10

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 27, 42, 5], [15, 38, 40, 33], [25, 24, 0, 37], [37, 28, 20, 43], [41, 32, 16, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["24.72.1.ev.1", "48.72.0.c.2", "48.72.2.c.2"];
...
// Map from the embedded model to the plane model of modular curve with label 48.144.3.bb.2
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(4*t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.144.3.bb.2
//   Coordinate number 0:
map_2_coord_0 := 1*(u);
//   Coordinate number 1:
map_2_coord_1 := 1*(-3/16*y^4+3/2*t*u^3-1/2*u^4);
//   Coordinate number 2:
