...
// Magma code for modular curve with label 24.72.3.bv.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.629

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 4, 12, 11], [21, 22, 4, 1], [23, 2, 0, 1], [23, 10, 10, 7], [23, 20, 0, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.h.1", "24.36.0.k.1", "24.36.1.d.1", "24.36.1.dr.1", "24.36.1.ee.1", "24.36.2.d.1", "24.36.2.ep.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.bv.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
