...
// Magma code for modular curve with label 12.72.3.db.1

// Other names and/or labels
// Cummins-Pauli label: 12D3
// Rouse-Sutherland-Zureick-Brown label: 12.72.3.42

// Group data
level := 12;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 8, 10, 9], [7, 6, 0, 7], [7, 9, 6, 1], [11, 3, 0, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.0.a.1", "12.36.1.bq.1", "12.36.2.bl.1"];
...
// Map from the embedded model to the plane model of modular curve with label 12.72.3.db.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
