...
// Magma code for modular curve with label 24.72.3.bgu.1

// Other names and/or labels
// Cummins-Pauli label: 24P3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.360

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 3, 12, 7], [21, 10, 16, 9], [23, 4, 2, 17], [23, 9, 12, 13], [23, 13, 8, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bu.1", "24.36.1.fv.1", "24.36.1.gs.1"];
