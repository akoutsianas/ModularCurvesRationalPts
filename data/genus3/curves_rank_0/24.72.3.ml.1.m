...
// Magma code for modular curve with label 24.72.3.ml.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.653

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 23, 16, 13], [11, 15, 0, 19], [21, 17, 14, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.bc.1", "24.36.0.s.1", "24.36.1.bv.1", "24.36.1.cu.1", "24.36.1.ee.1", "24.36.2.cd.1", "24.36.2.dr.1"];
