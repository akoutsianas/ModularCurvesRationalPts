...
// Magma code for modular curve with label 48.96.3.pc.1

// Other names and/or labels
// Cummins-Pauli label: 8B3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.1163

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 21, 10, 31], [19, 34, 38, 37], [21, 32, 40, 5], [45, 11, 14, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.bl.1", "24.48.1.ic.1", "48.48.0.ck.2", "48.48.1.ei.1", "48.48.1.el.1", "48.48.2.bk.1", "48.48.2.cj.2"];
...
// Map from the embedded model to the Weierstrass model of modular curve with label 48.96.3.pc.1
//   Coordinate number 0:
