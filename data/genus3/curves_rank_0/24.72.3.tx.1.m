...
// Magma code for modular curve with label 24.72.3.tx.1

// Other names and/or labels
// Cummins-Pauli label: 12E3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.571

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 8, 8, 15], [9, 1, 10, 21], [19, 0, 18, 17], [21, 22, 14, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.bl.1", "24.36.0.f.1", "24.36.1.dn.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.tx.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.3.tx.1
//   Coordinate number 0:
map_2_coord_0 := 1*(-z*t);
//   Coordinate number 1:
