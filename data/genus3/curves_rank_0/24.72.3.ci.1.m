...
// Magma code for modular curve with label 24.72.3.ci.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.722

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 2, 4, 13], [11, 20, 16, 17], [13, 19, 16, 17], [19, 3, 12, 1], [23, 5, 20, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.w.1", "24.36.0.bf.1", "24.36.1.i.1", "24.36.1.bt.1", "24.36.1.fg.1", "24.36.2.j.1", "24.36.2.o.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.ci.1
//   Coordinate number 0:
map_1_coord_0 := 1*(u);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.3.ci.1
//   Coordinate number 0:
