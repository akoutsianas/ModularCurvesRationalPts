...
// Magma code for modular curve with label 48.96.3.gx.1

// Other names and/or labels
// Cummins-Pauli label: 12K3
// Rouse-Sutherland-Zureick-Brown label: 48.96.3.1616

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 32, 30, 23], [29, 23, 36, 13], [35, 38, 42, 17], [37, 18, 12, 13], [47, 44, 12, 47]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.48.1.dq.1", "48.24.0.c.1"];
...
// Embedded model
model_0 := [4*x*y-2*y^2-z^2,3*x*t-2*y*t+z*t-w*t+3*x*u-2*y*u+w*u,3*x*t-2*y*t+w*t-3*x*u+2*y*u+z*u+w*u,3*z^2-6*z*w+t*u+u^2,6*z^2+t^2+u^2,9*x^2-2*x*y-y^2+3*z^2+w^2+t^2+u^2,9*x*z-6*y*z+3*z*w-t*u];
...
// Map from the embedded model to the plane model of modular curve with label 48.96.3.gx.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*w);
