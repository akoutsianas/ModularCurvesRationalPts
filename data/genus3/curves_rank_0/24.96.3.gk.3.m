...
// Magma code for modular curve with label 24.96.3.gk.3

// Other names and/or labels
// Cummins-Pauli label: 24W3
// Rouse-Sutherland-Zureick-Brown label: 24.96.3.604

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 0, 0, 7], [1, 3, 16, 5], [5, 9, 20, 7], [19, 15, 8, 7], [23, 6, 16, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.48.0.bu.3", "24.48.1.iq.1", "24.48.2.f.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.96.3.gk.3
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.96.3.gk.3
//   Coordinate number 0:
map_2_coord_0 := 1*(6/5*w*t^2-16/5*w*t*u+8/5*w*u^2-2*t^3+44/15*t^2*u-16/15*t*u^2);
//   Coordinate number 1:
map_2_coord_1 := 1*(-1088/15*z*w*t^10+122368/225*z*w*t^9*u-1897472/1125*z*w*t^8*u^2+142449664/50625*z*w*t^7*u^3-5547008/2025*z*w*t^6*u^4+26365952/16875*z*w*t^5*u^5-24559616/50625*z*w*t^4*u^6+3211264/50625*z*w*t^3*u^7+256/3*z*t^11-80384/135*z*t^10*u+3494912/2025*z*t^9*u^2-27461632/10125*z*t^8*u^3+126943232/50625*z*t^7*u^4-69271552/50625*z*t^6*u^5+20709376/50625*z*t^5*u^6-524288/10125*z*t^4*u^7);
//   Coordinate number 2:
map_2_coord_2 := 1*(-2/5*w*t^2+16/15*w*t*u-8/15*w*u^2+1/3*t^3-14/15*t^2*u+8/15*t*u^2);
// Codomain equation:
