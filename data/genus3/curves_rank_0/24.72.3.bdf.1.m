...
// Magma code for modular curve with label 24.72.3.bdf.1

// Other names and/or labels
// Cummins-Pauli label: 24P3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.856

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 7, 20, 21], [7, 4, 22, 5], [9, 20, 8, 21], [13, 6, 12, 1], [19, 14, 8, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fs.1", "24.36.1.fz.1", "24.36.1.go.1"];
