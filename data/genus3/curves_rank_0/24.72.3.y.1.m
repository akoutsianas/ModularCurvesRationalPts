...
// Magma code for modular curve with label 24.72.3.y.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.542

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 16, 4, 5], [7, 10, 4, 11], [9, 22, 2, 15], [11, 10, 2, 17], [13, 2, 22, 7], [13, 14, 2, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.a.1", "24.36.0.bp.1", "24.36.1.c.1", "24.36.1.bk.1", "24.36.1.fk.1", "24.36.2.f.1", "24.36.2.db.1"];
...
// Embedded model
model_0 := [2*x^2-x*y-w*t-t^2-w*u-u^2,x*y-2*y^2-w^2-w*t-t^2-w*u-u^2,2*x^2+2*x*y-t^2+2*t*u-u^2,x*w+x*t-2*z*t+x*u+2*z*u,2*z*w+y*t+2*z*t-y*u+2*z*u,x^2-2*x*z-2*y*z+2*z^2-w*u-u^2,x^2+2*x*z+2*y*z+2*z^2-w*t-t^2];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.y.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(u);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.3.y.1
//   Coordinate number 0:
