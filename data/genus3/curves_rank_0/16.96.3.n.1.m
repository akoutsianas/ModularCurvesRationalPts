...
// Magma code for modular curve with label 16.96.3.n.1

// Other names and/or labels
// Cummins-Pauli label: 16O3
// Rouse-Zureick-Brown label: X604
// Rouse-Sutherland-Zureick-Brown label: 16.96.3.106

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 2, 12, 7], [7, 0, 0, 1], [7, 0, 8, 3], [9, 8, 0, 7], [11, 10, 4, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
