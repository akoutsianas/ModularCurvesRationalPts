...
// Magma code for modular curve with label 24.72.3.qk.1

// Other names and/or labels
// Cummins-Pauli label: 12E3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.572

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 9, 18, 7], [13, 15, 6, 11], [15, 1, 8, 15], [17, 12, 12, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.bl.1", "24.36.0.f.1", "24.36.1.br.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.qk.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.3.qk.1
//   Coordinate number 0:
