...
// Magma code for modular curve with label 60.72.3.xx.1

// Other names and/or labels
// Cummins-Pauli label: 20G3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.725

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 45, 12, 23], [11, 50, 56, 3], [27, 35, 34, 19], [41, 10, 50, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.0.a.1", "60.36.1.dn.1", "60.36.2.fr.2"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.xx.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
