...
// Magma code for modular curve with label 32.96.3.ba.2

// Other names and/or labels
// Cummins-Pauli label: 32O3
// Rouse-Zureick-Brown label: X660
// Rouse-Sutherland-Zureick-Brown label: 32.96.3.125

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 20, 16, 9], [7, 11, 0, 25], [19, 26, 8, 9], [21, 5, 16, 31], [23, 13, 8, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
