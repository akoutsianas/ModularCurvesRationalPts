...
// Magma code for modular curve with label 48.48.3.q.1

// Other names and/or labels
// Cummins-Pauli label: 16D3
// Rouse-Sutherland-Zureick-Brown label: 48.48.3.59

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 19, 10, 21], [21, 47, 10, 13], [25, 16, 24, 17], [33, 8, 28, 7], [43, 12, 4, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["8.24.1.k.1", "48.24.1.i.1", "48.24.1.j.1"];
...
model_2 := [-2*x^2-2*x*y-2*y^2+z^2,-9*x^4-24*x^2*z^2+16*z^4-4*w^2];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.3.q.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*u);
