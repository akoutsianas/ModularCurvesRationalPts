...
// Magma code for modular curve with label 48.48.3.ex.2

// Other names and/or labels
// Cummins-Pauli label: 16F3
// Rouse-Sutherland-Zureick-Brown label: 48.48.3.116

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 13, 38, 15], [19, 26, 44, 27], [23, 20, 36, 13], [25, 27, 2, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.1.k.1", "24.24.0.em.2", "48.24.2.e.2"];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.3.ex.2
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*z);
