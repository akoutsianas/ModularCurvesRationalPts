...
// Magma code for modular curve with label 24.72.3.bdu.1

// Other names and/or labels
// Cummins-Pauli label: 24P3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.117

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 6, 18, 11], [7, 17, 20, 17], [19, 6, 6, 13], [21, 1, 10, 15], [23, 4, 4, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bs.1", "24.36.1.ge.1", "24.36.1.go.1"];
