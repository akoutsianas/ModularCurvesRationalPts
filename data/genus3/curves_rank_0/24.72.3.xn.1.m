...
// Magma code for modular curve with label 24.72.3.xn.1

// Other names and/or labels
// Cummins-Pauli label: 12J3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.392

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 6, 0, 5], [1, 7, 22, 23], [1, 10, 10, 11], [3, 16, 14, 9], [11, 1, 22, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.by.1", "24.36.1.ey.1", "24.36.1.fx.1"];
