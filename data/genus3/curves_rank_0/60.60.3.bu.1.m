...
// Magma code for modular curve with label 60.60.3.bu.1

// Other names and/or labels
// Cummins-Pauli label: 20F3
// Rouse-Sutherland-Zureick-Brown label: 60.60.3.7

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 20, 45, 23], [29, 50, 3, 41], [41, 10, 55, 31], [53, 20, 31, 47], [53, 44, 27, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['5.10.0.a.1', '12.6.0.f.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["10.30.1.a.1", "12.6.0.f.1"];
...
// Embedded model
model_0 := [x*z-y*w-z*w+z*t+z*u,y*z+3*x*w,2*x^2-y*z+w^2-x*t+w*t-t^2-x*u-u^2,x^2+y^2-y*z+x*w-x*t-x*u-w*u+2*t*u,4*x*y+z*w-y*t-y*u,3*x^2+y^2+y*z+3*x*t+3*x*u,4*x^2-2*y^2+2*y*z-z^2-x*w-2*w^2-3*x*t-2*w*t+2*t^2-3*x*u+w*u-2*t*u+2*u^2];

// Singular plane model
model_1 := [36*x^8-1620*x^6*y^2+8100*x^4*y^4+756*x^6*y*z-2160*x^4*y^3*z-105*x^6*z^2-1359*x^4*y^2*z^2+1080*x^2*y^4*z^2+435*x^4*y*z^3-144*x^2*y^3*z^3-5*x^4*z^4-180*x^2*y^2*z^4+36*y^4*z^4+35*x^2*y*z^5-5*y^2*z^6];

// Double cover of conic
model_2 := [3*x^2+5*y^2-z^2,261*x^4+720*x^2*y*z-504*x^2*z^2-320*y*z^3+144*z^4-20*w^2];
...
// Map from the embedded model to the plane model of modular curve with label 60.60.3.bu.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(u);
...
map_1_coord_2 := 1*(3*w);
// Codomain equation:
map_1_codomain := [36*x^8-1620*x^6*y^2+8100*x^4*y^4+756*x^6*y*z-2160*x^4*y^3*z-105*x^6*z^2-1359*x^4*y^2*z^2+1080*x^2*y^4*z^2+435*x^4*y*z^3-144*x^2*y^3*z^3-5*x^4*z^4-180*x^2*y^2*z^4+36*y^4*z^4+35*x^2*y*z^5-5*y^2*z^6];
