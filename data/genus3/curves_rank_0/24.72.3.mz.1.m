...
// Magma code for modular curve with label 24.72.3.mz.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.694

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 12, 0, 11], [7, 7, 14, 1], [17, 14, 2, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.be.1", "24.36.0.y.1", "24.36.1.bs.1", "24.36.1.da.1", "24.36.1.ek.1", "24.36.2.cg.1", "24.36.2.dr.1"];
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.72.3.mz.1
//   Coordinate number 0:
map_1_coord_0 := 1*(-1/2*z*w^2+3/16*z*t^2-1/4*w^3+3/8*w^2*t);
//   Coordinate number 1:
map_1_coord_1 := 1*(37/32*z*w^10*t+37/16*z*w^10*u-21/32*z*w^9*t^2-21/16*z*w^9*t*u-225/512*z*w^8*t^3-225/256*z*w^8*t^2*u+63/256*z*w^7*t^4+63/128*z*w^7*t^3*u+9/4096*z*w^6*t^5+9/2048*z*w^6*t^4*u-35/64*w^11*t-35/32*w^11*u+15/64*w^10*t^2+15/32*w^10*t*u+105/512*w^9*t^3+105/256*w^9*t^2*u-45/512*w^8*t^4-45/256*w^8*t^3*u);
//   Coordinate number 2:
