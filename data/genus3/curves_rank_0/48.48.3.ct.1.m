...
// Magma code for modular curve with label 48.48.3.ct.1

// Other names and/or labels
// Cummins-Pauli label: 16D3
// Rouse-Sutherland-Zureick-Brown label: 48.48.3.224

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 47, 10, 35], [7, 15, 42, 7], [7, 16, 0, 35], [45, 14, 20, 47]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
covers := ["16.24.2.c.1", "24.24.1.x.1", "48.24.2.b.1"];
...
model_2 := [-3*x^2+y^2+z^2,-135*x^4+108*x^3*z-90*x^2*z^2+108*x*z^3-39*z^4-w^2];
...
// Map from the embedded model to the plane model of modular curve with label 48.48.3.ct.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
map_1_coord_1 := 1*(u);
