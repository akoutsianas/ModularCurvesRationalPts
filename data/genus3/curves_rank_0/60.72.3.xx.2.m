...
// Magma code for modular curve with label 60.72.3.xx.2

// Other names and/or labels
// Cummins-Pauli label: 20G3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.729

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 50, 50, 7], [23, 30, 0, 13], [41, 50, 54, 1], [53, 15, 34, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.0.a.2", "60.36.1.dn.1", "60.36.2.fr.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.xx.2
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
