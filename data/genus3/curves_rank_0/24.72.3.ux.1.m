...
// Magma code for modular curve with label 24.72.3.ux.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.635

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 8, 4, 9], [5, 14, 20, 19], [13, 11, 22, 13], [23, 11, 10, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.bu.1", "24.36.0.bv.1", "24.36.1.cx.1", "24.36.1.dm.1", "24.36.1.fe.1", "24.36.2.ew.1", "24.36.2.fr.1"];
