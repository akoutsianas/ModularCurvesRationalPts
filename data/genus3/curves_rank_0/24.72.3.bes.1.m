...
// Magma code for modular curve with label 24.72.3.bes.1

// Other names and/or labels
// Cummins-Pauli label: 24Q3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.420

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 9, 18, 7], [15, 11, 22, 9], [19, 22, 16, 23], [21, 4, 16, 9], [23, 14, 2, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bw.1", "24.36.1.gk.1", "24.36.1.go.1"];
