...
// Magma code for modular curve with label 60.72.3.zd.1

// Other names and/or labels
// Cummins-Pauli label: 20G3
// Rouse-Sutherland-Zureick-Brown label: 60.72.3.758

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[31, 25, 52, 33], [41, 5, 12, 43], [49, 40, 30, 23], [53, 30, 30, 47], [53, 45, 50, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.1.j.1", "60.36.0.b.1", "60.36.2.fr.1"];
...
// Map from the embedded model to the plane model of modular curve with label 60.72.3.zd.1
//   Coordinate number 0:
map_1_coord_0 := 1*(w);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
