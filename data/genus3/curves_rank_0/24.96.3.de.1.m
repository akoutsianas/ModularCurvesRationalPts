...
// Magma code for modular curve with label 24.96.3.de.1

// Other names and/or labels
// Cummins-Pauli label: 24V3
// Rouse-Sutherland-Zureick-Brown label: 24.96.3.19

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 5, 0, 19], [5, 18, 12, 17], [7, 4, 0, 23], [7, 4, 12, 11], [19, 6, 0, 11], [19, 16, 0, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['3.4.0.a.1', '8.24.0.p.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["8.24.0.p.1", "12.48.1.h.1", "24.48.1.iq.1", "24.48.2.h.1"];
...
model_2 := [x^2+y^2+z^2,-4*x^4-4*x^2*z^2+3*z^4-w^2];
...
// Map from the embedded model to the plane model of modular curve with label 24.96.3.de.1
//   Coordinate number 0:
map_1_coord_0 := 1*(t);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
