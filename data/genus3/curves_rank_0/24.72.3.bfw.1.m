...
// Magma code for modular curve with label 24.72.3.bfw.1

// Other names and/or labels
// Cummins-Pauli label: 24Q3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.391

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 22, 10, 15], [13, 1, 2, 19], [13, 3, 18, 11], [15, 11, 22, 21], [21, 13, 2, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.by.1", "24.36.1.fp.1", "24.36.1.gs.1"];
