...
// Magma code for modular curve with label 24.72.3.bdt.1

// Other names and/or labels
// Cummins-Pauli label: 24P3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.798

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 20, 4, 1], [5, 14, 14, 7], [5, 19, 2, 11], [11, 4, 4, 19], [13, 2, 4, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fv.1", "24.36.1.fx.1", "24.36.1.gp.1"];
