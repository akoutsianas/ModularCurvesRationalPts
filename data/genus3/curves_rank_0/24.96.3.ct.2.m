...
// Magma code for modular curve with label 24.96.3.ct.2

// Other names and/or labels
// Cummins-Pauli label: 24U3
// Rouse-Sutherland-Zureick-Brown label: 24.96.3.582

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 1, 0, 11], [19, 14, 0, 11], [19, 15, 0, 13], [23, 19, 12, 7], [23, 20, 0, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.48.0.bt.2", "24.48.1.cg.1", "24.48.2.g.2"];
...
// Map from the embedded model to the plane model of modular curve with label 24.96.3.ct.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Map from the embedded model to the Weierstrass model of modular curve with label 24.96.3.ct.2
//   Coordinate number 0:
