...
// Magma code for modular curve with label 16.96.3.ed.1

// Other names and/or labels
// Cummins-Pauli label: 16L3
// Rouse-Sutherland-Zureick-Brown label: 16.96.3.215

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 2, 14, 3], [9, 13, 2, 15], [11, 5, 8, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["8.48.1.bt.1", "16.48.1.bc.1", "16.48.1.da.1"];
