...
// Magma code for modular curve with label 24.72.3.bdo.1

// Other names and/or labels
// Cummins-Pauli label: 24P3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.118

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 15, 12, 7], [1, 20, 4, 13], [3, 8, 16, 15], [11, 7, 2, 5], [13, 9, 18, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bs.1", "24.36.1.fv.1", "24.36.1.go.1"];
