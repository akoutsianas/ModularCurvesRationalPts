...
// Magma code for modular curve with label 60.48.3.c.1

// Other names and/or labels
// Cummins-Pauli label: 30G3
// Rouse-Sutherland-Zureick-Brown label: 60.48.3.6

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 15, 33, 28], [19, 20, 21, 1], [37, 15, 48, 47], [37, 55, 39, 38], [41, 50, 30, 49], [56, 55, 9, 43]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['3.4.0.a.1', '4.2.0.a.1', '5.6.0.a.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["12.8.0.a.1", "15.24.1.a.1", "20.12.1.a.1"];
...
// Weierstrass model
model_2 := [3*x^6*z^2+x^4*y-11*x^4*z^4+x^2*y*z^2+23*x^2*z^6+y^2+y*z^4-20*z^8];
...
// Map from the embedded model to the plane model of modular curve with label 60.48.3.c.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(t);
...
// Map from the embedded model to the Weierstrass model of modular curve with label 60.48.3.c.1
//   Coordinate number 0:
map_2_coord_0 := 1*(y);
//   Coordinate number 1:
map_2_coord_1 := 1*(x^4-x^2*y*t-y^4);
//   Coordinate number 2:
map_2_coord_2 := 1*(x);
// Codomain equation:
map_2_codomain := [3*x^6*z^2+x^4*y-11*x^4*z^4+x^2*y*z^2+23*x^2*z^6+y^2+y*z^4-20*z^8];
