...
// Magma code for modular curve with label 40.72.3.ey.1

// Other names and/or labels
// Cummins-Pauli label: 20G3
// Rouse-Sutherland-Zureick-Brown label: 40.72.3.152

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 10, 4, 7], [15, 7, 22, 25], [27, 6, 24, 39], [33, 34, 30, 27], [39, 8, 18, 29], [39, 34, 28, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["20.36.1.j.1", "40.36.0.a.1", "40.36.2.a.2"];
...
// Map from the embedded model to the plane model of modular curve with label 40.72.3.ey.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*w);
