...
// Magma code for modular curve with label 24.72.3.ek.1

// Other names and/or labels
// Cummins-Pauli label: 12G3
// Rouse-Sutherland-Zureick-Brown label: 24.72.3.85

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 23, 10, 15], [7, 0, 12, 5], [9, 14, 20, 3], [13, 23, 10, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.0.q.1", "24.36.1.k.1", "24.36.1.bj.1", "24.36.1.ev.1", "24.36.2.t.1", "24.36.2.w.1", "24.36.2.ds.1"];
...
// Map from the embedded model to the plane model of modular curve with label 24.72.3.ek.1
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
