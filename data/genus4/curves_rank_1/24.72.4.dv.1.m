...
// Magma code for modular curve with label 24.72.4.dv.1

// Other names and/or labels
// Cummins-Pauli label: 24E4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.358

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 15, 6, 23], [9, 7, 4, 15], [11, 20, 10, 5], [17, 17, 10, 23], [23, 2, 4, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fu.1", "24.36.1.fv.1", "24.36.2.bv.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.dv.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
