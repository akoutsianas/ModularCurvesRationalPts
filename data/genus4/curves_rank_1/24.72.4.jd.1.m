...
// Magma code for modular curve with label 24.72.4.jd.1

// Other names and/or labels
// Cummins-Pauli label: 24I4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.273

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 16, 22, 21], [3, 22, 10, 21], [11, 5, 8, 7], [11, 8, 20, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
model_1 := [-81*x^6+54*x^4*y^2+18*x^3*y^3+36*x^3*y*z^2-9*x^2*y^4+12*x^2*y^2*z^2+12*x^2*z^4-6*x*y^5-12*x*y^3*z^2-y^6-4*y^4*z^2-4*y^2*z^4];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.jd.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*y);
...
// Codomain equation:
map_1_codomain := [-81*x^6+54*x^4*y^2+18*x^3*y^3+36*x^3*y*z^2-9*x^2*y^4+12*x^2*y^2*z^2+12*x^2*z^4-6*x*y^5-12*x*y^3*z^2-y^6-4*y^4*z^2-4*y^2*z^4];
