...
// Magma code for modular curve with label 40.60.4.t.1

// Other names and/or labels
// Cummins-Pauli label: 20A4
// Rouse-Sutherland-Zureick-Brown label: 40.60.4.68

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 29, 22, 35], [33, 1, 8, 13], [35, 1, 24, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["20.30.2.g.1", "40.12.0.k.1", "40.30.2.b.1", "40.30.2.n.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.60.4.t.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
