...
// Magma code for modular curve with label 24.72.4.ke.1

// Other names and/or labels
// Cummins-Pauli label: 24E4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.357

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 14, 16, 9], [11, 2, 16, 23], [11, 4, 14, 5], [19, 17, 2, 5], [23, 21, 6, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fu.1", "24.36.1.gg.1", "24.36.2.gc.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.ke.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
