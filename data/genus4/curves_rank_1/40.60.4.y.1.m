...
// Magma code for modular curve with label 40.60.4.y.1

// Other names and/or labels
// Cummins-Pauli label: 20A4
// Rouse-Sutherland-Zureick-Brown label: 40.60.4.47

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 11, 10, 29], [11, 20, 32, 23], [11, 30, 6, 17], [31, 32, 6, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["20.30.2.b.1", "40.12.0.m.1", "40.30.2.g.1", "40.30.2.n.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.60.4.y.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
