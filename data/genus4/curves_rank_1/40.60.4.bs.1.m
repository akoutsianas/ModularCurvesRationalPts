...
// Magma code for modular curve with label 40.60.4.bs.1

// Other names and/or labels
// Cummins-Pauli label: 20A4
// Rouse-Sutherland-Zureick-Brown label: 40.60.4.35

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 12, 26, 29], [11, 30, 0, 1], [39, 15, 28, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["10.30.2.c.1", "40.12.0.bc.1", "40.30.2.j.1", "40.30.2.o.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.60.4.bs.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
