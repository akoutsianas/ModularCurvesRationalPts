...
// Magma code for modular curve with label 24.72.4.ln.1

// Other names and/or labels
// Cummins-Pauli label: 24L4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.327

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 7, 20, 19], [1, 18, 12, 13], [5, 6, 6, 7], [11, 12, 18, 5], [13, 16, 14, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fo.1", "24.36.1.gd.1", "24.36.2.gj.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.ln.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
