...
// Magma code for modular curve with label 24.72.4.bv.1

// Other names and/or labels
// Cummins-Pauli label: 12C4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.203

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 20, 22, 13], [3, 8, 4, 9], [7, 10, 16, 11], [13, 0, 0, 7], [21, 14, 10, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.f.1", "24.36.2.d.1", "24.36.2.g.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.bv.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
