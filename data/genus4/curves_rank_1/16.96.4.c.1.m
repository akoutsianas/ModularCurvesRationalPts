...
// Magma code for modular curve with label 16.96.4.c.1

// Other names and/or labels
// Cummins-Pauli label: 16B4
// Rouse-Sutherland-Zureick-Brown label: 16.96.4.3

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 15, 10, 1], [11, 1, 14, 13], [11, 3, 4, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.y.1", "16.48.1.bs.1", "16.48.2.bw.1"];
...
model_1 := [x^4*z^2-2*x^2*y^3*z+6*x^2*y^2*z^2+6*x^2*y*z^3+6*x^2*z^4+9*y^6-6*y^5*z-53*y^4*z^2+12*y^3*z^3+83*y^2*z^4+18*y*z^5+z^6];
...
// Map from the canonical model to the plane model of modular curve with label 16.96.4.c.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
...
// Codomain equation:
map_1_codomain := [x^4*z^2-2*x^2*y^3*z+6*x^2*y^2*z^2+6*x^2*y*z^3+6*x^2*z^4+9*y^6-6*y^5*z-53*y^4*z^2+12*y^3*z^3+83*y^2*z^4+18*y*z^5+z^6];
