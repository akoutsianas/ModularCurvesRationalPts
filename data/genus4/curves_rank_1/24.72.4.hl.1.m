...
// Magma code for modular curve with label 24.72.4.hl.1

// Other names and/or labels
// Cummins-Pauli label: 24J4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.427

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 5, 4, 3], [5, 8, 16, 17], [11, 19, 8, 17], [13, 9, 0, 17], [13, 20, 20, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.2.cs.1", "24.36.2.cv.1", "24.36.2.dh.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.hl.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
