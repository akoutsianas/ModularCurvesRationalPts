...
// Magma code for modular curve with label 24.72.4.lb.1

// Other names and/or labels
// Cummins-Pauli label: 24E4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.253

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 18, 6, 7], [9, 5, 2, 3], [13, 16, 4, 5], [15, 8, 2, 9], [15, 8, 4, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.bx.1", "24.36.1.gf.1", "24.36.1.gh.1"];
...
model_1 := [555*x^6+582*x^5*y-819*x^4*y^2+29*x^4*z^2-828*x^3*y^3+134*x^3*y*z^2+549*x^2*y^4+72*x^2*y^2*z^2+3*x^2*z^4+342*x*y^5-150*x*y^3*z^2+12*x*y*z^4-189*y^6+27*y^4*z^2+12*y^2*z^4];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.lb.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
map_1_coord_1 := 1*(y+z);
...
map_1_coord_2 := 1*(w);
// Codomain equation:
map_1_codomain := [555*x^6+582*x^5*y-819*x^4*y^2+29*x^4*z^2-828*x^3*y^3+134*x^3*y*z^2+549*x^2*y^4+72*x^2*y^2*z^2+3*x^2*z^4+342*x*y^5-150*x*y^3*z^2+12*x*y*z^4-189*y^6+27*y^4*z^2+12*y^2*z^4];
