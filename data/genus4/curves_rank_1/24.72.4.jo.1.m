...
// Magma code for modular curve with label 24.72.4.jo.1

// Other names and/or labels
// Cummins-Pauli label: 24E4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.336

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 1, 10, 23], [1, 16, 10, 11], [1, 19, 4, 11], [7, 5, 14, 5], [23, 15, 0, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fs.1", "24.36.1.ge.1", "24.36.2.gc.1"];
...
model_1 := [-x^6-x^4*y^2+6*x^4*z^2-3*x^2*y^4-156*x^2*y^2*z^2-108*x^2*z^4-3*y^6+54*y^4*z^2-324*y^2*z^4+648*z^6];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.jo.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
...
// Codomain equation:
map_1_codomain := [-x^6-x^4*y^2+6*x^4*z^2-3*x^2*y^4-156*x^2*y^2*z^2-108*x^2*z^4-3*y^6+54*y^4*z^2-324*y^2*z^4+648*z^6];
