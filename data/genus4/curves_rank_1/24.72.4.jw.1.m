...
// Magma code for modular curve with label 24.72.4.jw.1

// Other names and/or labels
// Cummins-Pauli label: 12A4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.44

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 3, 6, 7], [7, 4, 22, 5], [7, 16, 10, 5], [17, 7, 10, 19], [23, 16, 2, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bt.1", "24.24.0.cq.1", "24.36.1.fz.1", "24.36.2.gc.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.jw.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
