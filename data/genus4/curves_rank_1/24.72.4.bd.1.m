...
// Magma code for modular curve with label 24.72.4.bd.1

// Other names and/or labels
// Cummins-Pauli label: 12C4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.201

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 2, 4, 7], [5, 18, 12, 1], [7, 6, 0, 19], [11, 10, 8, 5], [15, 8, 22, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.f.1", "24.36.2.a.1", "24.36.2.f.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.bd.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
