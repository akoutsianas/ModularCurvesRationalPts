...
// Magma code for modular curve with label 48.96.4.bl.1

// Other names and/or labels
// Cummins-Pauli label: 16B4
// Rouse-Sutherland-Zureick-Brown label: 48.96.4.42

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 44, 18, 43], [7, 40, 46, 17], [31, 5, 46, 9], [47, 35, 12, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.bx.1", "48.48.1.ga.1", "48.48.1.gi.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.4.bl.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
