...
// Magma code for modular curve with label 24.72.4.pc.1

// Other names and/or labels
// Cummins-Pauli label: 24K4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.39

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 19, 22, 21], [5, 18, 6, 11], [7, 13, 20, 1], [13, 5, 2, 23], [15, 13, 16, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bs.1", "24.36.1.gf.1", "24.36.2.gm.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.pc.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
