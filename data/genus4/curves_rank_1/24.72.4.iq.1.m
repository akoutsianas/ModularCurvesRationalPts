...
// Magma code for modular curve with label 24.72.4.iq.1

// Other names and/or labels
// Cummins-Pauli label: 24J4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.434

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 15, 0, 23], [19, 1, 4, 5], [19, 5, 8, 11], [19, 22, 16, 23], [23, 12, 0, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.2.cr.1", "24.36.2.cu.1", "24.36.2.dt.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.iq.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
