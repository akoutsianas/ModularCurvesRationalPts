...
// Magma code for modular curve with label 24.72.4.mf.1

// Other names and/or labels
// Cummins-Pauli label: 24K4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.52

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 7, 22, 7], [19, 0, 6, 5], [19, 13, 14, 1], [19, 13, 14, 13], [19, 21, 12, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bt.1", "24.36.1.ft.1", "24.36.2.gj.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.mf.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
