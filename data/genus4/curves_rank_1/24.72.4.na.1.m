...
// Magma code for modular curve with label 24.72.4.na.1

// Other names and/or labels
// Cummins-Pauli label: 24K4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.38

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 18, 18, 11], [11, 6, 18, 17], [19, 19, 2, 13], [21, 13, 10, 3], [23, 4, 4, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bs.1", "24.36.1.gg.1", "24.36.2.gj.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.na.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
