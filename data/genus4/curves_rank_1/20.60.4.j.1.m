...
// Magma code for modular curve with label 20.60.4.j.1

// Other names and/or labels
// Cummins-Pauli label: 20A4
// Rouse-Sutherland-Zureick-Brown label: 20.60.4.19

// Group data
level := 20;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 14, 14, 9], [15, 8, 9, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["20.12.0.f.1", "20.30.2.b.1", "20.30.2.e.1", "20.30.2.i.1"];
...
// Map from the canonical model to the plane model of modular curve with label 20.60.4.j.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
