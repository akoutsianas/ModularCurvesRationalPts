...
// Magma code for modular curve with label 60.60.4.bx.1

// Other names and/or labels
// Cummins-Pauli label: 20A4
// Rouse-Sutherland-Zureick-Brown label: 60.60.4.47

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[41, 26, 52, 33], [43, 0, 20, 59], [49, 30, 50, 59], [55, 11, 36, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["20.30.2.l.1", "60.12.0.bk.1", "60.30.2.e.1", "60.30.2.g.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.60.4.bx.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
