...
// Magma code for modular curve with label 24.72.4.il.1

// Other names and/or labels
// Cummins-Pauli label: 24J4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.268

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[15, 8, 4, 3], [17, 14, 4, 17], [19, 16, 4, 5], [21, 22, 16, 3], [23, 1, 4, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.ba.1", "24.36.2.co.1", "24.36.2.cv.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.il.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
