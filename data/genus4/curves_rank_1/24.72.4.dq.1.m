...
// Magma code for modular curve with label 24.72.4.dq.1

// Other names and/or labels
// Cummins-Pauli label: 24E4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.409

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 23, 4, 21], [11, 6, 12, 13], [11, 19, 20, 11], [17, 17, 4, 17], [19, 11, 8, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.2.bu.1", "24.36.2.cm.1", "24.36.2.cn.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.dq.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
