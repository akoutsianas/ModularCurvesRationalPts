...
// Magma code for modular curve with label 24.72.4.ng.1

// Other names and/or labels
// Cummins-Pauli label: 24L4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.122

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 3, 6, 11], [13, 3, 12, 23], [17, 17, 14, 19], [19, 12, 18, 5], [23, 10, 8, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bw.1", "24.36.1.gj.1", "24.36.2.gi.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.ng.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x-y);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*z);
