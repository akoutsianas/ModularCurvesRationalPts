...
// Magma code for modular curve with label 48.96.4.bu.1

// Other names and/or labels
// Cummins-Pauli label: 16B4
// Rouse-Sutherland-Zureick-Brown label: 48.96.4.9

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 1, 16, 33], [25, 8, 42, 47], [25, 31, 24, 7], [27, 19, 26, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.bs.1", "48.48.1.gk.1", "48.48.2.ey.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.4.bu.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
