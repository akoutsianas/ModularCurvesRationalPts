...
// Magma code for modular curve with label 48.96.4.be.1

// Other names and/or labels
// Cummins-Pauli label: 16B4
// Rouse-Sutherland-Zureick-Brown label: 48.96.4.14

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 15, 32, 31], [7, 32, 40, 7], [21, 5, 28, 3], [41, 1, 6, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.bt.1", "48.48.1.fs.1", "48.48.2.ey.1"];
...
model_1 := [36*x^4*z^2+60*x^2*y^3*z+84*x^2*y^2*z^2-180*x^2*y*z^3+84*x^2*z^4+49*y^6+70*y^5*z-269*y^4*z^2-140*y^3*z^3+491*y^2*z^4-210*y*z^5+25*z^6];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.4.be.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
...
// Codomain equation:
map_1_codomain := [36*x^4*z^2+60*x^2*y^3*z+84*x^2*y^2*z^2-180*x^2*y*z^3+84*x^2*z^4+49*y^6+70*y^5*z-269*y^4*z^2-140*y^3*z^3+491*y^2*z^4-210*y*z^5+25*z^6];
