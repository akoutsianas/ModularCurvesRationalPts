...
// Magma code for modular curve with label 16.96.4.m.1

// Other names and/or labels
// Cummins-Pauli label: 16B4
// Rouse-Sutherland-Zureick-Brown label: 16.96.4.9

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 9, 0, 11], [11, 3, 10, 13], [15, 13, 12, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.br.1", "16.48.1.cc.1", "16.48.2.bw.1"];
