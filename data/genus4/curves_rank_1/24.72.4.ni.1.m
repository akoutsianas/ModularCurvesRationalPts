...
// Magma code for modular curve with label 24.72.4.ni.1

// Other names and/or labels
// Cummins-Pauli label: 24L4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.124

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 5, 4, 21], [5, 1, 14, 23], [7, 23, 16, 1], [9, 11, 8, 3], [11, 12, 12, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bw.1", "24.36.1.gi.1", "24.36.2.gj.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.ni.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
