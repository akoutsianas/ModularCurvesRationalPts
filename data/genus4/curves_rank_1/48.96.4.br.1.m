...
// Magma code for modular curve with label 48.96.4.br.1

// Other names and/or labels
// Cummins-Pauli label: 16B4
// Rouse-Sutherland-Zureick-Brown label: 48.96.4.47

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 23, 42, 29], [17, 7, 24, 7], [31, 11, 44, 9], [41, 39, 26, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.bx.1", "48.48.1.fy.1", "48.48.1.gk.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.4.br.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
