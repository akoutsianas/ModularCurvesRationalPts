...
// Magma code for modular curve with label 40.60.4.bt.1

// Other names and/or labels
// Cummins-Pauli label: 20A4
// Rouse-Sutherland-Zureick-Brown label: 40.60.4.66

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 17, 16, 31], [15, 18, 32, 13], [33, 28, 26, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["20.30.2.g.1", "40.12.0.bd.1", "40.30.2.g.1", "40.30.2.o.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.60.4.bt.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
