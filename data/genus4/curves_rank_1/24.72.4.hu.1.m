...
// Magma code for modular curve with label 24.72.4.hu.1

// Other names and/or labels
// Cummins-Pauli label: 24J4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.266

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 16, 16, 17], [7, 22, 20, 19], [9, 13, 4, 21], [11, 12, 12, 1], [21, 23, 8, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.ba.1", "24.36.2.ci.1", "24.36.2.ct.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.hu.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
