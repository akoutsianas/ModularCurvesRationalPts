...
// Magma code for modular curve with label 24.72.4.mz.1

// Other names and/or labels
// Cummins-Pauli label: 24K4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.51

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 16, 20, 19], [13, 1, 16, 11], [13, 16, 14, 7], [19, 20, 16, 19], [23, 0, 6, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bt.1", "24.36.1.gh.1", "24.36.2.gi.1"];
...
// Canonical model
model_0 := [9*x^2-2*y*z+2*z^2+y*w-6*w^2,y^2*z-y*z^2+y^2*w-2*y*z*w+2*z^2*w+y*w^2];

// Singular plane model
model_1 := [-4*x^4*y^2+28*x^2*y^4-68*x^2*y^3*z+58*x^2*y^2*z^2-24*x^2*y*z^3+6*x^2*z^4-42*y^5*z+69*y^4*z^2-72*y^3*z^3+48*y^2*z^4-18*y*z^5+3*z^6];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.mz.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Codomain equation:
map_1_codomain := [-4*x^4*y^2+28*x^2*y^4-68*x^2*y^3*z+58*x^2*y^2*z^2-24*x^2*y*z^3+6*x^2*z^4-42*y^5*z+69*y^4*z^2-72*y^3*z^3+48*y^2*z^4-18*y*z^5+3*z^6];
