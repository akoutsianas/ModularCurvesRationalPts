...
// Magma code for modular curve with label 24.72.4.ky.1

// Other names and/or labels
// Cummins-Pauli label: 12C4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.117

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 14, 4, 19], [9, 8, 14, 3], [11, 22, 16, 19], [17, 9, 12, 23], [23, 10, 8, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bw.1", "24.36.1.gd.1", "24.36.2.gf.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.ky.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y-w);
