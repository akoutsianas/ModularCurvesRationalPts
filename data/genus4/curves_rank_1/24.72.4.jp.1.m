...
// Magma code for modular curve with label 24.72.4.jp.1

// Other names and/or labels
// Cummins-Pauli label: 24E4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.372

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 5, 8, 19], [13, 7, 2, 19], [13, 17, 4, 19], [21, 7, 22, 15], [23, 6, 12, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.ft.1", "24.36.1.gf.1", "24.36.2.gc.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.jp.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
