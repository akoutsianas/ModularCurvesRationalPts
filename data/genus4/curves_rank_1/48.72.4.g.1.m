...
// Magma code for modular curve with label 48.72.4.g.1

// Other names and/or labels
// Cummins-Pauli label: 24D4
// Rouse-Sutherland-Zureick-Brown label: 48.72.4.88

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 44, 22, 37], [21, 47, 20, 39], [27, 34, 16, 27], [43, 1, 2, 7], [47, 27, 6, 35]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.2.y.1", "48.24.0.b.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.72.4.g.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
