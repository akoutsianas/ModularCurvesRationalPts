...
// Magma code for modular curve with label 40.90.4.i.1

// Other names and/or labels
// Cummins-Pauli label: 20E4
// Rouse-Sutherland-Zureick-Brown label: 40.90.4.11

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 5, 0, 13], [7, 4, 0, 19], [7, 33, 30, 21], [11, 19, 10, 23], [17, 32, 16, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 90;
...
covers := ["10.45.1.a.1", "40.30.2.m.1"];
...
model_1 := [875*x^6-2500*x^5*y-1300*x^4*y^2-150*x^3*y^3+3750*x^5*z-2925*x^4*y*z-1800*x^3*y^2*z-190*x^2*y^3*z+4925*x^4*z^2-100*x^3*y*z^2-555*x^2*y^2*z^2-30*x*y^3*z^2+2100*x^3*z^3+50*x^2*y*z^3-170*x*y^2*z^3+3*y^3*z^3+565*x^2*z^4+80*x*y*z^4-31*y^2*z^4+70*x*z^5+19*y*z^5+3*z^6];
...
// Map from the canonical model to the plane model of modular curve with label 40.90.4.i.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x-1/8*z-3/8*w);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*w);
//   Coordinate number 2:
map_1_coord_2 := 1*(1/2*y+7/8*z+9/8*w);
// Codomain equation:
map_1_codomain := [875*x^6-2500*x^5*y-1300*x^4*y^2-150*x^3*y^3+3750*x^5*z-2925*x^4*y*z-1800*x^3*y^2*z-190*x^2*y^3*z+4925*x^4*z^2-100*x^3*y*z^2-555*x^2*y^2*z^2-30*x*y^3*z^2+2100*x^3*z^3+50*x^2*y*z^3-170*x*y^2*z^3+3*y^3*z^3+565*x^2*z^4+80*x*y*z^4-31*y^2*z^4+70*x*z^5+19*y*z^5+3*z^6];
