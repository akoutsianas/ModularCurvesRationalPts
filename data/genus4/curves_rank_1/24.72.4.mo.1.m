...
// Magma code for modular curve with label 24.72.4.mo.1

// Other names and/or labels
// Cummins-Pauli label: 24K4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.339

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 23, 20, 11], [9, 10, 2, 15], [11, 16, 2, 17], [13, 18, 0, 5], [23, 13, 20, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fy.1", "24.36.1.ge.1", "24.36.2.gi.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.mo.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
