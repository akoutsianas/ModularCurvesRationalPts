...
// Magma code for modular curve with label 60.90.4.h.1

// Other names and/or labels
// Cummins-Pauli label: 20E4
// Rouse-Sutherland-Zureick-Brown label: 60.90.4.9

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 5, 20, 27], [19, 45, 30, 43], [25, 21, 36, 5], [29, 45, 50, 49], [59, 25, 0, 41]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 90;
...
covers := ["10.45.1.a.1", "60.30.2.j.1"];
...
// Canonical model
model_0 := [30*x^2+y^2+y*z-z^2+y*w-2*z*w,y^3+y^2*z-y*z^2-2*y^2*w+y*z*w+z^2*w-y*w^2];
...
// Map from the canonical model to the plane model of modular curve with label 60.90.4.h.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
