...
// Magma code for modular curve with label 24.72.4.cz.1

// Other names and/or labels
// Cummins-Pauli label: 12C4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.83

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 4, 22, 23], [17, 16, 14, 11], [19, 11, 14, 5], [21, 11, 10, 15], [23, 0, 12, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bx.1", "24.36.1.gb.1", "24.36.2.x.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.cz.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
