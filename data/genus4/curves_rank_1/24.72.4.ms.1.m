...
// Magma code for modular curve with label 24.72.4.ms.1

// Other names and/or labels
// Cummins-Pauli label: 24K4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.69

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 13, 4, 23], [19, 5, 4, 1], [19, 8, 10, 1], [23, 7, 2, 17], [23, 10, 10, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bu.1", "24.36.1.ge.1", "24.36.2.gj.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.ms.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x-y);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*z);
