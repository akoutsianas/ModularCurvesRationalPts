...
// Magma code for modular curve with label 24.72.4.bo.1

// Other names and/or labels
// Cummins-Pauli label: 12C4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.191

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 4, 14, 15], [15, 2, 14, 15], [19, 10, 2, 7], [19, 14, 2, 5], [23, 2, 4, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.c.1", "24.36.2.e.1", "24.36.2.g.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.bo.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
