...
// Magma code for modular curve with label 24.72.4.oo.1

// Other names and/or labels
// Cummins-Pauli label: 24K4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.365

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 17, 4, 5], [17, 22, 8, 17], [19, 20, 10, 1], [23, 6, 12, 7], [23, 7, 22, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fs.1", "24.36.1.fy.1", "24.36.2.gn.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.oo.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
