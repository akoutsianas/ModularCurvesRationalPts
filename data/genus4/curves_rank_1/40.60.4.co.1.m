...
// Magma code for modular curve with label 40.60.4.co.1

// Other names and/or labels
// Cummins-Pauli label: 20C4
// Rouse-Sutherland-Zureick-Brown label: 40.60.4.50

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 18, 28, 5], [29, 20, 2, 11], [31, 29, 6, 5], [37, 15, 34, 11], [39, 24, 34, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["20.30.2.l.1", "40.12.0.bs.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.60.4.co.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
