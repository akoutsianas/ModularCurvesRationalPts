...
// Magma code for modular curve with label 48.72.4.f.1

// Other names and/or labels
// Cummins-Pauli label: 24E4
// Rouse-Sutherland-Zureick-Brown label: 48.72.4.85

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 3, 6, 29], [5, 9, 12, 31], [15, 43, 44, 21], [23, 6, 6, 47], [29, 37, 26, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
// Map from the canonical model to the plane model of modular curve with label 48.72.4.f.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
