...
// Magma code for modular curve with label 60.90.4.m.1

// Other names and/or labels
// Cummins-Pauli label: 20E4
// Rouse-Sutherland-Zureick-Brown label: 60.90.4.5

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[15, 52, 32, 25], [15, 59, 22, 25], [35, 12, 18, 55], [35, 31, 38, 15], [57, 25, 50, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 90;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['5.15.0.a.1', '12.6.0.f.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["10.45.1.a.1", "60.30.2.m.1"];
...
// Canonical model
model_0 := [30*x^2-5*y*z+z^2+z*w-w^2,6*x^2*z-y^2*z-y*z^2-12*x^2*w+2*y^2*w+5*y*z*w-y*w^2];

// Singular plane model
model_1 := [-6*x^6+2*x^4*y^2-15*x^4*y*z-9*x^4*z^2-x^2*y^4+9*x^2*y^3*z-15*x^2*y^2*z^2-9*x^2*y*z^3+y^5*z-5*y^4*z^2+3*y^3*z^3+9*y^2*z^4];
...
// Map from the canonical model to the plane model of modular curve with label 60.90.4.m.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
...
// Codomain equation:
map_1_codomain := [-6*x^6+2*x^4*y^2-15*x^4*y*z-9*x^4*z^2-x^2*y^4+9*x^2*y^3*z-15*x^2*y^2*z^2-9*x^2*y*z^3+y^5*z-5*y^4*z^2+3*y^3*z^3+9*y^2*z^4];
