...
// Magma code for modular curve with label 60.72.4.cs.1

// Other names and/or labels
// Cummins-Pauli label: 12C4
// Rouse-Sutherland-Zureick-Brown label: 60.72.4.30

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 6, 39, 47], [13, 8, 26, 29], [21, 34, 59, 3], [29, 58, 26, 59]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bw.1", "60.36.1.fv.1", "60.36.2.fl.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.72.4.cs.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+w);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
