...
// Magma code for modular curve with label 40.60.4.bb.1

// Other names and/or labels
// Cummins-Pauli label: 20A4
// Rouse-Sutherland-Zureick-Brown label: 40.60.4.48

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 35, 30, 3], [19, 7, 6, 7], [23, 30, 10, 37], [37, 32, 14, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["20.30.2.b.1", "40.12.0.p.1", "40.30.2.h.1", "40.30.2.m.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.60.4.bb.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
