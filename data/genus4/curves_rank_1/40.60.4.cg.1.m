...
// Magma code for modular curve with label 40.60.4.cg.1

// Other names and/or labels
// Cummins-Pauli label: 20B4
// Rouse-Sutherland-Zureick-Brown label: 40.60.4.28

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 32, 30, 23], [21, 21, 20, 9], [27, 37, 8, 25], [33, 24, 16, 17], [39, 8, 24, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
// Canonical model
model_0 := [50*x^2-3*y^2+32*y*z-12*z^2+3*y*w-6*z*w+3*w^2,2*x^2*y-4*x^2*z-y^2*z+2*y*z^2+4*x^2*w+y*z*w];

// Singular plane model
model_1 := [100*x^6-30*x^4*y^2+240*x^4*y*z-30*x^4*z^2-30*x^2*y^3*z+165*x^2*y^2*z^2-30*x^2*y*z^3+6*y^4*z^2+8*y^3*z^3+6*y^2*z^4];
...
// Map from the canonical model to the plane model of modular curve with label 40.60.4.cg.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
map_1_coord_2 := 1*(z);
// Codomain equation:
map_1_codomain := [100*x^6-30*x^4*y^2+240*x^4*y*z-30*x^4*z^2-30*x^2*y^3*z+165*x^2*y^2*z^2-30*x^2*y*z^3+6*y^4*z^2+8*y^3*z^3+6*y^2*z^4];
