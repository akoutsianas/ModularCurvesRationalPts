...
// Magma code for modular curve with label 24.72.4.bu.1

// Other names and/or labels
// Cummins-Pauli label: 12C4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.195

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 6, 0, 17], [1, 18, 18, 17], [1, 20, 14, 17], [7, 0, 0, 1], [19, 6, 12, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.d.1", "24.36.2.f.1", "24.36.2.g.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.bu.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
