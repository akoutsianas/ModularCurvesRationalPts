...
// Magma code for modular curve with label 24.72.4.nx.1

// Other names and/or labels
// Cummins-Pauli label: 24L4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.305

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 14, 8, 17], [9, 17, 10, 15], [9, 20, 10, 15], [19, 18, 6, 13], [23, 12, 0, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fp.1", "24.36.1.gb.1", "24.36.2.gm.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.nx.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
