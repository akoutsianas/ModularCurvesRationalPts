...
// Magma code for modular curve with label 24.72.4.cy.1

// Other names and/or labels
// Cummins-Pauli label: 12C4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.120

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 14, 14, 23], [7, 3, 12, 13], [15, 7, 22, 9], [19, 5, 20, 17], [23, 22, 20, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bw.1", "24.36.1.ga.1", "24.36.2.x.1"];
...
model_1 := [130*x^6+152*x^5*y-16*x^4*y^2+32*x^4*z^2-52*x^3*y^3+52*x^3*y*z^2+8*x^2*y^4+12*x^2*y^2*z^2+2*x^2*z^4+8*x*y^5-12*x*y^3*z^2+4*x*y*z^4-2*y^6-3*y^4*z^2+2*y^2*z^4];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.cy.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
...
map_1_coord_2 := 1*(w);
// Codomain equation:
map_1_codomain := [130*x^6+152*x^5*y-16*x^4*y^2+32*x^4*z^2-52*x^3*y^3+52*x^3*y*z^2+8*x^2*y^4+12*x^2*y^2*z^2+2*x^2*z^4+8*x*y^5-12*x*y^3*z^2+4*x*y*z^4-2*y^6-3*y^4*z^2+2*y^2*z^4];
