...
// Magma code for modular curve with label 24.72.4.og.1

// Other names and/or labels
// Cummins-Pauli label: 24L4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.347

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 21, 6, 23], [7, 16, 2, 13], [11, 12, 6, 13], [13, 2, 8, 5], [17, 22, 10, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fq.1", "24.36.1.gc.1", "24.36.2.gn.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.og.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
