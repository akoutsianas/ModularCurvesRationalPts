...
// Magma code for modular curve with label 60.72.4.w.1

// Other names and/or labels
// Cummins-Pauli label: 12C4
// Rouse-Sutherland-Zureick-Brown label: 60.72.4.58

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 30, 0, 23], [5, 2, 14, 55], [11, 18, 24, 19], [19, 18, 24, 5], [41, 38, 34, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.e.1", "60.36.2.b.1", "60.36.2.f.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.72.4.w.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
