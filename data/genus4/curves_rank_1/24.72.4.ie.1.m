...
// Magma code for modular curve with label 24.72.4.ie.1

// Other names and/or labels
// Cummins-Pauli label: 24J4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.431

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 20, 4, 13], [9, 22, 16, 15], [13, 3, 12, 13], [23, 20, 20, 1], [23, 21, 12, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.2.ck.1", "24.36.2.cp.1", "24.36.2.dt.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.ie.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
