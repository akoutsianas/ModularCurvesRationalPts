...
// Magma code for modular curve with label 24.72.4.mv.1

// Other names and/or labels
// Cummins-Pauli label: 24K4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.374

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 5, 2, 9], [3, 23, 14, 21], [5, 15, 12, 23], [7, 14, 2, 5], [23, 8, 20, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fz.1", "24.36.1.gf.1", "24.36.2.gj.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.mv.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
