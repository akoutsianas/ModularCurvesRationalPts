...
// Magma code for modular curve with label 24.72.4.fv.1

// Other names and/or labels
// Cummins-Pauli label: 24E4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.420

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 9, 0, 17], [11, 3, 0, 13], [13, 9, 0, 11], [13, 19, 4, 5], [17, 8, 8, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.2.cf.1", "24.36.2.cn.1", "24.36.2.co.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.fv.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
