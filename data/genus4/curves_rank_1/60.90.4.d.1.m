...
// Magma code for modular curve with label 60.90.4.d.1

// Other names and/or labels
// Cummins-Pauli label: 10A4
// Rouse-Sutherland-Zureick-Brown label: 60.90.4.2

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 11, 34, 35], [5, 48, 54, 35], [11, 5, 0, 41], [15, 13, 46, 15], [15, 41, 56, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 90;
...
covers := ["10.45.1.a.1", "60.30.2.e.1", "60.30.2.h.1"];
...
// Canonical model
model_0 := [15*x^2-5*y^2+2*y*w+4*z*w-w^2,y^3-y^2*z-y*z^2+3*y*z*w+z^2*w-y*w^2];
...
// Map from the canonical model to the plane model of modular curve with label 60.90.4.d.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
