...
// Magma code for modular curve with label 16.96.4.f.1

// Other names and/or labels
// Cummins-Pauli label: 16B4
// Rouse-Sutherland-Zureick-Brown label: 16.96.4.10

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 2, 14, 5], [3, 7, 10, 5], [15, 8, 2, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.ba.1", "16.48.1.br.1", "16.48.2.bx.1"];
...
// Canonical model
model_0 := [2*x^2+8*y^2-z^2-w^2,2*x^2*z-z^3+2*x^2*w-2*z^2*w+z*w^2];

// Singular plane model
model_1 := [2*x^6+8*x^5*y+6*x^4*y^2+x^3*y^3+8*x^5*z+14*x^4*y*z+12*x^3*y^2*z+3*x^2*y^3*z+6*x^4*z^2+8*x^3*y*z^2-6*x^2*y^2*z^2-x*y^3*z^2-4*x^2*y*z^3+4*x*y^2*z^3-y^3*z^3+6*x^2*z^4-4*y^2*z^4-8*x*z^5-2*y*z^5+2*z^6];
...
// Map from the canonical model to the plane model of modular curve with label 16.96.4.f.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+1/2*z-1/2*w);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*w);
//   Coordinate number 2:
map_1_coord_2 := 1*(2*y-1/2*z-1/2*w);
// Codomain equation:
map_1_codomain := [2*x^6+8*x^5*y+6*x^4*y^2+x^3*y^3+8*x^5*z+14*x^4*y*z+12*x^3*y^2*z+3*x^2*y^3*z+6*x^4*z^2+8*x^3*y*z^2-6*x^2*y^2*z^2-x*y^3*z^2-4*x^2*y*z^3+4*x*y^2*z^3-y^3*z^3+6*x^2*z^4-4*y^2*z^4-8*x*z^5-2*y*z^5+2*z^6];
