...
// Magma code for modular curve with label 24.72.4.in.1

// Other names and/or labels
// Cummins-Pauli label: 24J4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.398

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 2, 20, 15], [7, 16, 8, 1], [9, 5, 4, 9], [17, 13, 20, 23], [23, 16, 8, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.2.cn.1", "24.36.2.cx.1", "24.36.2.dq.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.in.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
