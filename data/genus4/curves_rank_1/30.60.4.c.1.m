...
// Magma code for modular curve with label 30.60.4.c.1

// Other names and/or labels
// Cummins-Pauli label: 30C4
// Rouse-Sutherland-Zureick-Brown label: 30.60.4.6

// Group data
level := 30;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 14, 29, 7], [6, 1, 17, 24], [7, 27, 27, 28], [17, 29, 22, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
// Map from the canonical model to the plane model of modular curve with label 30.60.4.c.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
