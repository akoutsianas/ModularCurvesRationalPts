...
// Magma code for modular curve with label 24.72.4.pb.1

// Other names and/or labels
// Cummins-Pauli label: 24K4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.307

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 13, 4, 17], [7, 19, 2, 13], [9, 1, 16, 15], [19, 10, 10, 17], [23, 4, 4, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fx.1", "24.36.1.ge.1", "24.36.2.gm.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.pb.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
