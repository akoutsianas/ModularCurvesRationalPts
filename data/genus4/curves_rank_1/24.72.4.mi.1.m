...
// Magma code for modular curve with label 24.72.4.mi.1

// Other names and/or labels
// Cummins-Pauli label: 24K4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.376

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 4, 22, 23], [7, 13, 8, 1], [13, 13, 8, 7], [17, 22, 14, 11], [23, 17, 22, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fv.1", "24.36.1.fy.1", "24.36.2.gi.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.mi.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
