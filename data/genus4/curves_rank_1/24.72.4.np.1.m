...
// Magma code for modular curve with label 24.72.4.np.1

// Other names and/or labels
// Cummins-Pauli label: 24L4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.102

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 7, 22, 9], [3, 8, 14, 21], [9, 11, 22, 15], [13, 23, 22, 19], [17, 7, 2, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bz.1", "24.36.1.gl.1", "24.36.2.gi.1"];
...
// Canonical model
model_0 := [9*x^2-3*y^2-2*y*z-4*z^2+2*w^2,3*x^2*y-y^3-3*x^2*z+y*w^2];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.np.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
