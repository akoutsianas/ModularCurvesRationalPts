...
// Magma code for modular curve with label 48.96.4.h.2

// Other names and/or labels
// Cummins-Pauli label: 48J4
// Rouse-Sutherland-Zureick-Brown label: 48.96.4.6

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 2, 30, 5], [7, 7, 6, 13], [17, 10, 18, 11], [25, 43, 42, 23], [35, 33, 42, 29], [37, 16, 42, 35]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['3.4.0.a.1', '16.24.0.n.2']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["16.24.0.n.2", "24.48.2.s.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.4.h.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
