...
// Magma code for modular curve with label 24.72.4.on.1

// Other names and/or labels
// Cummins-Pauli label: 24K4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.382

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 22, 10, 21], [3, 22, 14, 9], [5, 10, 2, 11], [7, 5, 10, 13], [19, 5, 4, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.ft.1", "24.36.1.fz.1", "24.36.2.gm.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.on.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
