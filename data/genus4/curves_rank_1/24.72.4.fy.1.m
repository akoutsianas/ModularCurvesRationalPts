...
// Magma code for modular curve with label 24.72.4.fy.1

// Other names and/or labels
// Cummins-Pauli label: 24E4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.426

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 16, 8, 13], [3, 23, 20, 9], [5, 8, 20, 13], [17, 3, 12, 17], [21, 2, 4, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.2.cf.1", "24.36.2.cr.1", "24.36.2.cs.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.fy.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
