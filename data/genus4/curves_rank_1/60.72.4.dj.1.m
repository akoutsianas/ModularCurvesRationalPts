...
// Magma code for modular curve with label 60.72.4.dj.1

// Other names and/or labels
// Cummins-Pauli label: 12C4
// Rouse-Sutherland-Zureick-Brown label: 60.72.4.20

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 0, 33, 1], [19, 48, 33, 29], [29, 38, 59, 55], [51, 34, 14, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bx.1", "60.36.1.fw.1", "60.36.2.fp.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.72.4.dj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+w);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
