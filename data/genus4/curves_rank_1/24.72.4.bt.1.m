...
// Magma code for modular curve with label 24.72.4.bt.1

// Other names and/or labels
// Cummins-Pauli label: 12C4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.212

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 18, 0, 7], [1, 20, 2, 23], [9, 14, 8, 9], [19, 20, 16, 7], [21, 4, 22, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.h.1", "24.36.2.c.1", "24.36.2.f.1"];
...
model_1 := [27*x^6+18*x^4*y^2+3*x^2*y^4-12*x^2*y^2*z^2-y^4*z^2+2*y^2*z^4];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.bt.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Codomain equation:
map_1_codomain := [27*x^6+18*x^4*y^2+3*x^2*y^4-12*x^2*y^2*z^2-y^4*z^2+2*y^2*z^4];
