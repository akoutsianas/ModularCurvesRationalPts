...
// Magma code for modular curve with label 24.72.4.hd.1

// Other names and/or labels
// Cummins-Pauli label: 24J4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.437

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 13, 16, 23], [3, 14, 20, 21], [13, 8, 20, 17], [19, 8, 16, 7], [19, 19, 16, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.2.cn.1", "24.36.2.cv.1", "24.36.2.de.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.hd.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
