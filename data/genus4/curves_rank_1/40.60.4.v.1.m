...
// Magma code for modular curve with label 40.60.4.v.1

// Other names and/or labels
// Cummins-Pauli label: 20A4
// Rouse-Sutherland-Zureick-Brown label: 40.60.4.26

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 13, 34, 29], [21, 34, 6, 5], [33, 6, 36, 25], [37, 39, 32, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['5.5.0.a.1', '8.12.0.j.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["8.12.0.j.1", "20.30.2.a.1", "40.30.2.d.1", "40.30.2.p.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.60.4.v.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
