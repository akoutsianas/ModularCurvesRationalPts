...
// Magma code for modular curve with label 24.72.4.ml.1

// Other names and/or labels
// Cummins-Pauli label: 24K4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.361

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 19, 2, 19], [11, 20, 16, 23], [17, 3, 0, 7], [17, 10, 20, 17], [21, 10, 2, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fu.1", "24.36.1.fz.1", "24.36.2.gj.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.ml.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
