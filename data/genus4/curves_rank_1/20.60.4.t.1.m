...
// Magma code for modular curve with label 20.60.4.t.1

// Other names and/or labels
// Cummins-Pauli label: 20B4
// Rouse-Sutherland-Zureick-Brown label: 20.60.4.9

// Group data
level := 20;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 8, 2, 5], [7, 11, 6, 5], [17, 13, 8, 11], [19, 18, 4, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
// Map from the canonical model to the plane model of modular curve with label 20.60.4.t.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
