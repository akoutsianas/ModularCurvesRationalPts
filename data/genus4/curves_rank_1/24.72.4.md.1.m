...
// Magma code for modular curve with label 24.72.4.md.1

// Other names and/or labels
// Cummins-Pauli label: 24K4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.309

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 1, 14, 23], [9, 19, 20, 15], [11, 10, 16, 7], [15, 23, 10, 21], [23, 16, 2, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fs.1", "24.36.1.fx.1", "24.36.2.gj.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.md.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
