...
// Magma code for modular curve with label 24.72.4.cr.1

// Other names and/or labels
// Cummins-Pauli label: 24D4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.300

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 2, 4, 1], [3, 23, 4, 9], [11, 14, 10, 5], [17, 4, 20, 17], [19, 0, 18, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.24.0.q.1", "24.36.1.fq.1", "24.36.1.gi.1", "24.36.2.x.1"];
...
model_1 := [3247*x^6+375*x^3*y^3+6130*x^5*z-225*x^2*y^3*z-7375*x^4*z^2+45*x*y^3*z^2+2940*x^3*z^3-3*y^3*z^3-575*x^2*z^4+50*x*z^5-z^6];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.cr.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y-1/4*w);
//   Coordinate number 1:
map_1_coord_1 := 1*(4*x);
//   Coordinate number 2:
map_1_coord_2 := 1*(z-3/4*w);
// Codomain equation:
map_1_codomain := [3247*x^6+375*x^3*y^3+6130*x^5*z-225*x^2*y^3*z-7375*x^4*z^2+45*x*y^3*z^2+2940*x^3*z^3-3*y^3*z^3-575*x^2*z^4+50*x*z^5-z^6];
