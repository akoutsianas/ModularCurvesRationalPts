...
// Magma code for modular curve with label 24.72.4.el.1

// Other names and/or labels
// Cummins-Pauli label: 24E4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.337

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 9, 0, 23], [7, 10, 10, 5], [11, 22, 4, 19], [17, 7, 14, 23], [17, 18, 18, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.ge.1", "24.36.1.gf.1", "24.36.2.bv.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.el.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
