...
// Magma code for modular curve with label 24.72.4.hk.1

// Other names and/or labels
// Cummins-Pauli label: 24J4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.436

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 11, 16, 5], [5, 20, 8, 19], [7, 6, 0, 7], [7, 11, 20, 11], [9, 22, 4, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.2.ct.1", "24.36.2.cu.1", "24.36.2.dh.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.hk.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
