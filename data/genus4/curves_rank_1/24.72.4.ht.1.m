...
// Magma code for modular curve with label 24.72.4.ht.1

// Other names and/or labels
// Cummins-Pauli label: 24J4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.394

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 21, 0, 23], [3, 5, 16, 15], [5, 13, 16, 19], [15, 14, 16, 15], [17, 17, 8, 1], [23, 15, 0, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.2.cj.1", "24.36.2.ct.1", "24.36.2.dq.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.ht.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
