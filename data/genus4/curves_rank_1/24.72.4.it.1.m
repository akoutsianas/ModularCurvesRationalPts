...
// Magma code for modular curve with label 24.72.4.it.1

// Other names and/or labels
// Cummins-Pauli label: 24J4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.188

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 5, 8, 23], [3, 20, 4, 21], [9, 13, 4, 9], [11, 7, 4, 13], [11, 22, 20, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.bb.1", "24.36.2.cr.1", "24.36.2.cv.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.it.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
