...
// Magma code for modular curve with label 24.72.4.qf.1

// Other names and/or labels
// Cummins-Pauli label: 24L4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.325

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 11, 22, 19], [3, 11, 16, 21], [19, 16, 4, 23], [19, 19, 20, 13], [21, 14, 4, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.gb.1", "24.36.1.gl.1", "24.36.2.gn.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.qf.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*z);
