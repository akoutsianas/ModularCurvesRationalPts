...
// Magma code for modular curve with label 24.72.4.hp.1

// Other names and/or labels
// Cummins-Pauli label: 24J4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.395

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 12, 0, 19], [5, 1, 20, 17], [11, 6, 0, 1], [11, 15, 0, 5], [19, 6, 0, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.2.cq.1", "24.36.2.cx.1", "24.36.2.dh.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.hp.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
