...
// Magma code for modular curve with label 20.90.4.h.1

// Other names and/or labels
// Cummins-Pauli label: 20E4
// Rouse-Sutherland-Zureick-Brown label: 20.90.4.7

// Group data
level := 20;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 0, 15, 17], [5, 2, 4, 5], [5, 12, 16, 15], [15, 14, 16, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 90;
...
covers := ["10.45.1.a.1", "20.30.2.j.1"];
...
// Map from the canonical model to the plane model of modular curve with label 20.90.4.h.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
