...
// Magma code for modular curve with label 24.72.4.bb.1

// Other names and/or labels
// Cummins-Pauli label: 12C4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.197

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 22, 22, 5], [19, 10, 22, 5], [21, 22, 8, 3], [23, 0, 12, 13], [23, 12, 0, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.e.1", "24.36.2.a.1", "24.36.2.e.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.bb.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
