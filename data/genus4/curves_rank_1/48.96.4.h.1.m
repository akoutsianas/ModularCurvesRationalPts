...
// Magma code for modular curve with label 48.96.4.h.1

// Other names and/or labels
// Cummins-Pauli label: 48J4
// Rouse-Sutherland-Zureick-Brown label: 48.96.4.5

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 4, 12, 25], [13, 39, 12, 43], [23, 41, 0, 25], [25, 38, 24, 17], [35, 35, 18, 41], [43, 45, 36, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
;// CM discriminants
CM_discs := [-3];
// Modular curve is a fiber product of the following curvesfactors := ['3.4.0.a.1', '16.24.0.n.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["16.24.0.n.1", "24.48.2.s.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.4.h.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
