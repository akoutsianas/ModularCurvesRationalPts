...
// Magma code for modular curve with label 60.72.4.bc.1

// Other names and/or labels
// Cummins-Pauli label: 12C4
// Rouse-Sutherland-Zureick-Brown label: 60.72.4.65

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 32, 40, 21], [17, 12, 36, 35], [43, 38, 56, 5], [51, 32, 10, 3], [57, 58, 52, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.g.1", "60.36.2.a.1", "60.36.2.g.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.72.4.bc.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
