...
// Magma code for modular curve with label 24.72.4.hw.1

// Other names and/or labels
// Cummins-Pauli label: 24J4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.406

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 14, 16, 19], [7, 17, 4, 13], [17, 1, 20, 17], [19, 6, 12, 5], [21, 5, 8, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.2.ci.1", "24.36.2.cn.1", "24.36.2.dt.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.hw.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
