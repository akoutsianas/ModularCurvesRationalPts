...
// Magma code for modular curve with label 60.60.4.bc.1

// Other names and/or labels
// Cummins-Pauli label: 20A4
// Rouse-Sutherland-Zureick-Brown label: 60.60.4.53

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[31, 53, 34, 13], [35, 59, 22, 15], [43, 27, 56, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["20.30.2.j.1", "60.12.0.t.1", "60.30.2.a.1", "60.30.2.g.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.60.4.bc.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
