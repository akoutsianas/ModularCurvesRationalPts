...
// Magma code for modular curve with label 24.72.4.lc.1

// Other names and/or labels
// Cummins-Pauli label: 24E4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.367

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 5, 22, 9], [9, 8, 14, 3], [11, 2, 22, 5], [11, 15, 18, 13], [19, 23, 22, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.gf.1", "24.36.1.gg.1", "24.36.2.gf.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.lc.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
