...
// Magma code for modular curve with label 48.96.4.q.1

// Other names and/or labels
// Cummins-Pauli label: 16B4
// Rouse-Sutherland-Zureick-Brown label: 48.96.4.19

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 27, 20, 37], [23, 37, 8, 41], [29, 12, 2, 19], [37, 45, 36, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.br.1", "48.48.1.fq.1", "48.48.2.ey.1"];
...
model_1 := [9*x^4*z^2-30*x^2*y^3*z-42*x^2*y^2*z^2+90*x^2*y*z^3-42*x^2*z^4+49*y^6+70*y^5*z-269*y^4*z^2-140*y^3*z^3+491*y^2*z^4-210*y*z^5+25*z^6];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.4.q.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
...
// Codomain equation:
map_1_codomain := [9*x^4*z^2-30*x^2*y^3*z-42*x^2*y^2*z^2+90*x^2*y*z^3-42*x^2*z^4+49*y^6+70*y^5*z-269*y^4*z^2-140*y^3*z^3+491*y^2*z^4-210*y*z^5+25*z^6];
