...
// Magma code for modular curve with label 48.96.4.bw.1

// Other names and/or labels
// Cummins-Pauli label: 16B4
// Rouse-Sutherland-Zureick-Brown label: 48.96.4.40

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 27, 8, 11], [19, 4, 38, 45], [27, 29, 16, 29], [31, 23, 28, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.ca.1", "48.48.1.fy.1", "48.48.2.ey.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.4.bw.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
