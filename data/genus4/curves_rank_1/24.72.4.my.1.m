...
// Magma code for modular curve with label 24.72.4.my.1

// Other names and/or labels
// Cummins-Pauli label: 24K4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.41

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 14, 2, 19], [5, 15, 0, 19], [5, 18, 18, 19], [11, 19, 22, 1], [19, 20, 4, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bs.1", "24.36.1.gh.1", "24.36.2.gi.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.my.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
