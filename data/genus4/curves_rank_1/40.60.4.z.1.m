...
// Magma code for modular curve with label 40.60.4.z.1

// Other names and/or labels
// Cummins-Pauli label: 20A4
// Rouse-Sutherland-Zureick-Brown label: 40.60.4.33

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 3, 34, 35], [11, 38, 14, 3], [21, 8, 14, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["10.30.2.c.1", "40.12.0.n.1", "40.30.2.c.1", "40.30.2.n.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.60.4.z.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
