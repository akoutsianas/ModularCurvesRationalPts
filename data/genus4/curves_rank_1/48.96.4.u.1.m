...
// Magma code for modular curve with label 48.96.4.u.1

// Other names and/or labels
// Cummins-Pauli label: 16B4
// Rouse-Sutherland-Zureick-Brown label: 48.96.4.50

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 5, 8, 13], [9, 31, 26, 23], [37, 14, 28, 9], [43, 36, 46, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.bw.1", "48.48.1.fq.1", "48.48.1.ga.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.4.u.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
