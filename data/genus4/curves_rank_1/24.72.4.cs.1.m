...
// Magma code for modular curve with label 24.72.4.cs.1

// Other names and/or labels
// Cummins-Pauli label: 24E4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.362

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 13, 22, 7], [11, 7, 14, 5], [11, 15, 6, 5], [17, 6, 6, 7], [23, 12, 18, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fs.1", "24.36.1.gg.1", "24.36.2.x.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.cs.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
