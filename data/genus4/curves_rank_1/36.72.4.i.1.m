...
// Magma code for modular curve with label 36.72.4.i.1

// Other names and/or labels
// Cummins-Pauli label: 18I4
// Rouse-Sutherland-Zureick-Brown label: 36.72.4.4

// Group data
level := 36;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 33, 9, 26], [11, 32, 24, 23], [17, 24, 27, 35], [29, 11, 30, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['4.2.0.a.1', '9.36.1.b.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["9.36.1.b.1", "36.24.2.a.1"];
...
// Canonical model
model_0 := [x^2+y*z+y*w+z*w,x^2*y+x^2*z+y*z^2+x^2*w+y^2*w-3*y*z*w+z*w^2];

// Singular plane model
model_1 := [x^4*y-4*x^3*y^2+4*x^2*y^3-x^4*z+4*x^3*y*z-7*x^2*y^2*z+6*x*y^3*z+4*x^2*y*z^2-8*x*y^2*z^2-5*y^3*z^2+7*y^2*z^3-y*z^4];
...
// Map from the canonical model to the plane model of modular curve with label 36.72.4.i.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+w);
//   Coordinate number 1:
map_1_coord_1 := 1*(w);
...
map_1_coord_2 := 1*(z+w);
// Codomain equation:
map_1_codomain := [x^4*y-4*x^3*y^2+4*x^2*y^3-x^4*z+4*x^3*y*z-7*x^2*y^2*z+6*x*y^3*z+4*x^2*y*z^2-8*x*y^2*z^2-5*y^3*z^2+7*y^2*z^3-y*z^4];
