...
// Magma code for modular curve with label 24.72.4.hh.1

// Other names and/or labels
// Cummins-Pauli label: 24J4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.397

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 3, 12, 1], [1, 3, 12, 23], [5, 1, 8, 11], [7, 0, 0, 17], [7, 5, 16, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.2.cp.1", "24.36.2.cx.1", "24.36.2.de.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.hh.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
