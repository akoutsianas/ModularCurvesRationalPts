...
// Magma code for modular curve with label 48.96.4.a.2

// Other names and/or labels
// Cummins-Pauli label: 24R4
// Rouse-Sutherland-Zureick-Brown label: 48.96.4.4

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 8, 42, 41], [11, 16, 24, 43], [29, 1, 36, 7], [29, 39, 0, 31], [35, 27, 18, 29], [35, 44, 6, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
;// CM discriminants
CM_discs := [-12];
// Modular curve is a fiber product of the following curvesfactors := ['3.4.0.a.1', '16.24.0.k.2']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["16.24.0.k.2", "24.48.2.l.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.4.a.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
