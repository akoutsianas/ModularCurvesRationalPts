...
// Magma code for modular curve with label 40.60.4.bo.1

// Other names and/or labels
// Cummins-Pauli label: 40B4
// Rouse-Sutherland-Zureick-Brown label: 40.60.4.39

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 37, 16, 21], [7, 37, 24, 13], [11, 29, 20, 23], [15, 4, 4, 13], [25, 8, 12, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["20.30.2.c.1", "40.12.0.ba.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.60.4.bo.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
