...
// Magma code for modular curve with label 24.72.4.if.1

// Other names and/or labels
// Cummins-Pauli label: 24J4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.421

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 9, 12, 23], [5, 7, 20, 23], [15, 5, 8, 15], [17, 20, 4, 17], [17, 22, 8, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.2.cl.1", "24.36.2.co.1", "24.36.2.dt.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.if.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
