...
// Magma code for modular curve with label 48.72.4.bs.1

// Other names and/or labels
// Cummins-Pauli label: 24O4
// Rouse-Sutherland-Zureick-Brown label: 48.72.4.36

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 31, 4, 29], [19, 33, 18, 5], [21, 22, 22, 27], [23, 28, 22, 25], [25, 26, 46, 31], [33, 22, 26, 39]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
// Map from the canonical model to the plane model of modular curve with label 48.72.4.bs.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
