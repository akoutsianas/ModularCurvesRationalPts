...
// Magma code for modular curve with label 48.72.4.bq.2

// Other names and/or labels
// Cummins-Pauli label: 24H4
// Rouse-Sutherland-Zureick-Brown label: 48.72.4.15

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 35, 22, 31], [3, 8, 32, 3], [7, 2, 34, 25], [11, 38, 32, 7], [23, 9, 30, 29], [43, 17, 28, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
;// CM discriminants
CM_discs := [-4];
// Modular curve is a fiber product of the following curvesfactors := ['3.3.0.a.1', '16.24.1.f.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["16.24.1.f.1", "24.36.1.fw.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.72.4.bq.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x-w);
//   Coordinate number 1:
map_1_coord_1 := 1*(4*y);
