...
// Magma code for modular curve with label 24.72.4.pa.1

// Other names and/or labels
// Cummins-Pauli label: 24K4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.315

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 20, 2, 19], [9, 17, 16, 15], [9, 22, 16, 21], [11, 10, 20, 23], [13, 11, 20, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fw.1", "24.36.1.ge.1", "24.36.2.gm.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.pa.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
