...
// Magma code for modular curve with label 24.72.4.ed.1

// Other names and/or labels
// Cummins-Pauli label: 12A4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.56

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 4, 16, 5], [15, 1, 4, 9], [17, 6, 18, 19], [17, 21, 0, 11], [19, 23, 20, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bv.1", "24.24.0.bb.1", "24.36.1.fy.1", "24.36.2.bv.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.ed.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x-z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
