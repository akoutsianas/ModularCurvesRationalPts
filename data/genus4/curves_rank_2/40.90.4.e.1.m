...
// Magma code for modular curve with label 40.90.4.e.1

// Other names and/or labels
// Cummins-Pauli label: 10A4
// Rouse-Sutherland-Zureick-Brown label: 40.90.4.3

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 4, 28, 39], [13, 1, 14, 27], [17, 38, 6, 33], [19, 38, 32, 31], [37, 30, 6, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 90;
...
covers := ["10.45.1.a.1", "40.30.2.g.1", "40.30.2.k.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.90.4.e.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
