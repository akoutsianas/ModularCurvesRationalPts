...
// Magma code for modular curve with label 48.96.4.n.1

// Other names and/or labels
// Cummins-Pauli label: 16B4
// Rouse-Sutherland-Zureick-Brown label: 48.96.4.31

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[27, 44, 14, 29], [31, 43, 26, 37], [35, 26, 2, 37], [45, 32, 34, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.ba.1", "48.48.1.fz.1", "48.48.2.ez.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.4.n.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
