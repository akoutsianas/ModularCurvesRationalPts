...
// Magma code for modular curve with label 40.60.4.be.1

// Other names and/or labels
// Cummins-Pauli label: 20A4
// Rouse-Sutherland-Zureick-Brown label: 40.60.4.42

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 26, 20, 19], [15, 39, 8, 5], [19, 18, 12, 21], [27, 18, 16, 13], [37, 31, 28, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["20.30.2.c.1", "40.12.0.s.1", "40.30.2.g.1", "40.30.2.m.1"];
...
model_1 := [125*x^6+50*x^4*z^2+35*x^2*y^2*z^2+5*x^2*z^4-8*y^4*z^2+8*y^2*z^4];
...
// Map from the canonical model to the plane model of modular curve with label 40.60.4.be.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Codomain equation:
map_1_codomain := [125*x^6+50*x^4*z^2+35*x^2*y^2*z^2+5*x^2*z^4-8*y^4*z^2+8*y^2*z^4];
