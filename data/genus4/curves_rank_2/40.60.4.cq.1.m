...
// Magma code for modular curve with label 40.60.4.cq.1

// Other names and/or labels
// Cummins-Pauli label: 40C4
// Rouse-Sutherland-Zureick-Brown label: 40.60.4.55

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 14, 20, 13], [17, 5, 2, 19], [27, 31, 28, 1], [31, 21, 28, 29], [35, 4, 14, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["20.30.2.l.1", "40.12.0.bu.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.60.4.cq.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
