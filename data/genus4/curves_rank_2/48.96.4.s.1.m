...
// Magma code for modular curve with label 48.96.4.s.1

// Other names and/or labels
// Cummins-Pauli label: 16B4
// Rouse-Sutherland-Zureick-Brown label: 48.96.4.54

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 38, 44, 33], [5, 40, 32, 29], [35, 29, 38, 13], [45, 19, 40, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.bw.1", "48.48.1.fq.1", "48.48.1.fz.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.4.s.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
