...
// Magma code for modular curve with label 24.72.4.pq.1

// Other names and/or labels
// Cummins-Pauli label: 24L4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.348

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 3, 18, 11], [13, 5, 16, 7], [19, 17, 16, 13], [23, 13, 14, 5], [23, 21, 12, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.gc.1", "24.36.1.gi.1", "24.36.2.gm.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.pq.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
