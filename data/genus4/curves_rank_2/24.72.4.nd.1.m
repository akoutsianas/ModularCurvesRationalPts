...
// Magma code for modular curve with label 24.72.4.nd.1

// Other names and/or labels
// Cummins-Pauli label: 24K4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.313

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 9, 12, 23], [1, 10, 2, 19], [1, 15, 12, 19], [3, 17, 22, 9], [13, 4, 8, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fx.1", "24.36.1.gh.1", "24.36.2.gj.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.nd.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
