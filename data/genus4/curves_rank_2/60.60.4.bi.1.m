...
// Magma code for modular curve with label 60.60.4.bi.1

// Other names and/or labels
// Cummins-Pauli label: 20A4
// Rouse-Sutherland-Zureick-Brown label: 60.60.4.19

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 23, 38, 57], [21, 7, 38, 49], [31, 37, 14, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['5.5.0.a.1', '12.12.0.k.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["12.12.0.k.1", "20.30.2.k.1", "60.30.2.a.1", "60.30.2.b.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.60.4.bi.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
