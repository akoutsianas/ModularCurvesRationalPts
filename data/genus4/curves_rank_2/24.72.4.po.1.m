...
// Magma code for modular curve with label 24.72.4.po.1

// Other names and/or labels
// Cummins-Pauli label: 24K4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.379

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 2, 2, 19], [5, 23, 22, 23], [9, 11, 10, 3], [11, 16, 10, 13], [19, 18, 18, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fy.1", "24.36.1.gh.1", "24.36.2.gn.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.po.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
