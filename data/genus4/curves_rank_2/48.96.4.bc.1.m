...
// Magma code for modular curve with label 48.96.4.bc.1

// Other names and/or labels
// Cummins-Pauli label: 16B4
// Rouse-Sutherland-Zureick-Brown label: 48.96.4.51

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 33, 16, 5], [17, 8, 2, 15], [45, 2, 38, 3], [47, 0, 0, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.bw.1", "48.48.1.fs.1", "48.48.1.gb.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.4.bc.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x-z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
