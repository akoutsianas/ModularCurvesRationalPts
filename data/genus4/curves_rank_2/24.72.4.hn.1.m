...
// Magma code for modular curve with label 24.72.4.hn.1

// Other names and/or labels
// Cummins-Pauli label: 24J4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.179

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 12, 0, 23], [1, 17, 16, 19], [13, 11, 4, 7], [23, 11, 4, 23], [23, 12, 0, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.x.1", "24.36.2.ct.1", "24.36.2.cv.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.hn.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
