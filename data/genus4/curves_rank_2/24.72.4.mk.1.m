...
// Magma code for modular curve with label 24.72.4.mk.1

// Other names and/or labels
// Cummins-Pauli label: 24K4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.360

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 7, 20, 19], [1, 10, 16, 5], [7, 10, 14, 13], [13, 14, 14, 11], [15, 10, 20, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fu.1", "24.36.1.fy.1", "24.36.2.gj.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.mk.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
