...
// Magma code for modular curve with label 24.72.4.kj.1

// Other names and/or labels
// Cummins-Pauli label: 24D4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.293

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 18, 6, 11], [5, 0, 6, 19], [5, 21, 0, 11], [7, 7, 22, 17], [21, 10, 4, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.24.0.cv.1", "24.36.1.fr.1", "24.36.1.gl.1", "24.36.2.gc.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.kj.1
//   Coordinate number 0:
