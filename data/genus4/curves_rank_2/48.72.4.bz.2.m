...
// Magma code for modular curve with label 48.72.4.bz.2

// Other names and/or labels
// Cummins-Pauli label: 48H4
// Rouse-Sutherland-Zureick-Brown label: 48.72.4.41

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 37, 22, 41], [15, 1, 44, 33], [19, 1, 14, 13], [37, 47, 38, 11], [39, 41, 14, 9], [47, 31, 44, 41]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
// Map from the canonical model to the plane model of modular curve with label 48.72.4.bz.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
