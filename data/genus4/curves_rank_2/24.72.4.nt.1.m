...
// Magma code for modular curve with label 24.72.4.nt.1

// Other names and/or labels
// Cummins-Pauli label: 24L4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.323

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 2, 10, 7], [7, 13, 20, 1], [15, 1, 10, 21], [19, 16, 4, 23], [23, 7, 2, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.gd.1", "24.36.1.gl.1", "24.36.2.gj.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.nt.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
