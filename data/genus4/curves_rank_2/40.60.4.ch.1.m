...
// Magma code for modular curve with label 40.60.4.ch.1

// Other names and/or labels
// Cummins-Pauli label: 20B4
// Rouse-Sutherland-Zureick-Brown label: 40.60.4.29

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 18, 22, 9], [9, 37, 18, 21], [23, 1, 4, 27], [31, 33, 2, 33], [33, 14, 26, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
// Map from the canonical model to the plane model of modular curve with label 40.60.4.ch.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
