...
// Magma code for modular curve with label 24.72.4.nk.1

// Other names and/or labels
// Cummins-Pauli label: 24L4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.354

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 19, 20, 23], [11, 9, 12, 5], [13, 2, 10, 19], [19, 12, 6, 17], [21, 2, 14, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.ga.1", "24.36.1.gj.1", "24.36.2.gj.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.nk.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
