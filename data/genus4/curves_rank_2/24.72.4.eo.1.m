...
// Magma code for modular curve with label 24.72.4.eo.1

// Other names and/or labels
// Cummins-Pauli label: 24E4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.410

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 13, 8, 3], [11, 0, 0, 11], [13, 1, 16, 17], [15, 2, 8, 9], [17, 6, 12, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.2.bu.1", "24.36.2.cs.1", "24.36.2.ct.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.eo.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
