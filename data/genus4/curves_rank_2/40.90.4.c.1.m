...
// Magma code for modular curve with label 40.90.4.c.1

// Other names and/or labels
// Cummins-Pauli label: 20D4
// Rouse-Sutherland-Zureick-Brown label: 40.90.4.5

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 9, 8, 19], [13, 10, 24, 27], [21, 24, 10, 33], [33, 13, 30, 27], [39, 1, 2, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 90;
...
;// CM discriminants
CM_discs := [-4];
// Modular curve is a fiber product of the following curvesfactors := ['5.15.0.a.1', '8.6.0.c.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["10.45.1.a.1", "40.30.2.c.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.90.4.c.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
