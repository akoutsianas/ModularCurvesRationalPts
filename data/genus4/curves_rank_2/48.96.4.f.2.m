...
// Magma code for modular curve with label 48.96.4.f.2

// Other names and/or labels
// Cummins-Pauli label: 48J4
// Rouse-Sutherland-Zureick-Brown label: 48.96.4.63

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 0, 18, 25], [25, 15, 24, 23], [29, 43, 6, 35], [31, 35, 0, 25], [37, 20, 36, 17], [43, 46, 24, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.48.2.s.1", "48.24.0.m.2"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.4.f.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
