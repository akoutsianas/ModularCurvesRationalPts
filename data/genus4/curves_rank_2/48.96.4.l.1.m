...
// Magma code for modular curve with label 48.96.4.l.1

// Other names and/or labels
// Cummins-Pauli label: 16B4
// Rouse-Sutherland-Zureick-Brown label: 48.96.4.34

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 32, 14, 21], [13, 31, 18, 11], [25, 16, 24, 17], [29, 21, 44, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.y.1", "48.48.1.gb.1", "48.48.2.ez.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.4.l.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
