...
// Magma code for modular curve with label 40.60.4.cw.1

// Other names and/or labels
// Cummins-Pauli label: 40A4
// Rouse-Sutherland-Zureick-Brown label: 40.60.4.52

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 13, 26, 33], [13, 19, 12, 23], [23, 38, 26, 37], [29, 38, 34, 19], [39, 28, 20, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["20.30.2.l.1", "40.12.0.ca.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.60.4.cw.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
