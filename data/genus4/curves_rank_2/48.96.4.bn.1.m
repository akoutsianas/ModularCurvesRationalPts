...
// Magma code for modular curve with label 48.96.4.bn.1

// Other names and/or labels
// Cummins-Pauli label: 16B4
// Rouse-Sutherland-Zureick-Brown label: 48.96.4.12

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[27, 4, 16, 19], [31, 31, 20, 25], [43, 5, 22, 21], [47, 11, 26, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.bs.1", "48.48.1.gi.1", "48.48.2.ez.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.4.bn.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
