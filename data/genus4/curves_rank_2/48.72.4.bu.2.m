...
// Magma code for modular curve with label 48.72.4.bu.2

// Other names and/or labels
// Cummins-Pauli label: 24O4
// Rouse-Sutherland-Zureick-Brown label: 48.72.4.31

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 46, 32, 41], [15, 7, 20, 21], [19, 28, 8, 19], [25, 35, 26, 35], [29, 29, 46, 35], [35, 27, 0, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
// Map from the canonical model to the plane model of modular curve with label 48.72.4.bu.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
