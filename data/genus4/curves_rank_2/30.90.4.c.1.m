...
// Magma code for modular curve with label 30.90.4.c.1

// Other names and/or labels
// Cummins-Pauli label: 30F4
// Rouse-Sutherland-Zureick-Brown label: 30.90.4.6

// Group data
level := 30;
// Elements that, together with Gamma(level), generate the group
gens := [[10, 29, 1, 25], [26, 15, 15, 2], [26, 15, 15, 16], [26, 25, 5, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 90;
...
covers := ["15.45.1.a.1", "30.30.1.b.1"];
...
// Map from the canonical model to the plane model of modular curve with label 30.90.4.c.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
