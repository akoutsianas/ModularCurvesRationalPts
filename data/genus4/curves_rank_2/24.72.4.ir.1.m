...
// Magma code for modular curve with label 24.72.4.ir.1

// Other names and/or labels
// Cummins-Pauli label: 24J4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.417

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 20, 20, 11], [19, 7, 20, 1], [23, 0, 0, 19], [23, 9, 0, 7], [23, 21, 0, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.2.cq.1", "24.36.2.cv.1", "24.36.2.dt.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.ir.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
