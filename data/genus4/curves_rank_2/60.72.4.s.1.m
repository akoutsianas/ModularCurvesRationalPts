...
// Magma code for modular curve with label 60.72.4.s.1

// Other names and/or labels
// Cummins-Pauli label: 12C4
// Rouse-Sutherland-Zureick-Brown label: 60.72.4.56

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 50, 28, 47], [13, 4, 28, 5], [37, 40, 22, 53], [47, 50, 46, 41], [59, 48, 18, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.d.1", "60.36.2.f.1", "60.36.2.g.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.72.4.s.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
