...
// Magma code for modular curve with label 24.72.4.oe.1

// Other names and/or labels
// Cummins-Pauli label: 24L4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.345

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 13, 10, 19], [17, 17, 8, 19], [21, 2, 14, 3], [21, 11, 10, 3], [23, 16, 16, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fr.1", "24.36.1.gc.1", "24.36.2.gm.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.oe.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
