...
// Magma code for modular curve with label 40.60.4.ca.1

// Other names and/or labels
// Cummins-Pauli label: 20A4
// Rouse-Sutherland-Zureick-Brown label: 40.60.4.57

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 29, 30, 23], [5, 1, 26, 27], [9, 4, 2, 11], [21, 24, 12, 37], [21, 35, 10, 31]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["20.30.2.l.1", "40.12.0.bk.1", "40.30.2.g.1", "40.30.2.i.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.60.4.ca.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
