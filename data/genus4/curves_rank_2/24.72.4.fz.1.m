...
// Magma code for modular curve with label 24.72.4.fz.1

// Other names and/or labels
// Cummins-Pauli label: 24E4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.416

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 2, 20, 17], [1, 13, 4, 23], [5, 23, 4, 17], [11, 20, 20, 13], [19, 18, 0, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.2.cf.1", "24.36.2.cq.1", "24.36.2.ct.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.fz.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
