...
// Magma code for modular curve with label 48.96.4.w.1

// Other names and/or labels
// Cummins-Pauli label: 16B4
// Rouse-Sutherland-Zureick-Brown label: 48.96.4.11

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 41, 14, 13], [17, 18, 36, 29], [27, 4, 14, 29], [43, 8, 30, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.bs.1", "48.48.1.fq.1", "48.48.2.ey.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.4.w.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
