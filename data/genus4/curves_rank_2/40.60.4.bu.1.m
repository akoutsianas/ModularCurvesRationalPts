...
// Magma code for modular curve with label 40.60.4.bu.1

// Other names and/or labels
// Cummins-Pauli label: 20A4
// Rouse-Sutherland-Zureick-Brown label: 40.60.4.46

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 10, 12, 23], [37, 11, 38, 11], [37, 33, 34, 29], [39, 27, 26, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["20.30.2.k.1", "40.12.0.be.1", "40.30.2.g.1", "40.30.2.j.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.60.4.bu.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
