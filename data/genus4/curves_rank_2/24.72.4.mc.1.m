...
// Magma code for modular curve with label 24.72.4.mc.1

// Other names and/or labels
// Cummins-Pauli label: 24K4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.317

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 7, 16, 3], [11, 6, 0, 7], [17, 14, 8, 13], [17, 17, 2, 19], [21, 13, 14, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fs.1", "24.36.1.fw.1", "24.36.2.gj.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.mc.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
