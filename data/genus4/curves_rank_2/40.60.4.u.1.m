...
// Magma code for modular curve with label 40.60.4.u.1

// Other names and/or labels
// Cummins-Pauli label: 20A4
// Rouse-Sutherland-Zureick-Brown label: 40.60.4.64

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[31, 16, 16, 9], [33, 16, 6, 15], [39, 21, 24, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["20.30.2.j.1", "40.12.0.l.1", "40.30.2.b.1", "40.30.2.j.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.60.4.u.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
