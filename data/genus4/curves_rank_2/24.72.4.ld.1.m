...
// Magma code for modular curve with label 24.72.4.ld.1

// Other names and/or labels
// Cummins-Pauli label: 24E4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.338

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 2, 20, 17], [5, 11, 20, 19], [19, 6, 18, 5], [19, 8, 14, 5], [23, 16, 20, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.ge.1", "24.36.1.gh.1", "24.36.2.gf.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.ld.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+z);
//   Coordinate number 1:
