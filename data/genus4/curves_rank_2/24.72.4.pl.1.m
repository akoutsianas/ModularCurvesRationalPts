...
// Magma code for modular curve with label 24.72.4.pl.1

// Other names and/or labels
// Cummins-Pauli label: 24K4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.63

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 14, 16, 1], [3, 17, 8, 21], [7, 16, 4, 23], [11, 12, 6, 5], [17, 0, 6, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bv.1", "24.36.1.gh.1", "24.36.2.gm.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.pl.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*z);
