...
// Magma code for modular curve with label 24.72.4.ep.1

// Other names and/or labels
// Cummins-Pauli label: 24E4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.368

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 8, 16, 1], [5, 4, 22, 19], [9, 11, 16, 3], [17, 6, 6, 19], [17, 15, 18, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.gg.1", "24.36.1.gh.1", "24.36.2.bv.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.ep.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
