...
// Magma code for modular curve with label 60.90.4.a.1

// Other names and/or labels
// Cummins-Pauli label: 10A4
// Rouse-Sutherland-Zureick-Brown label: 60.90.4.1

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 36, 28, 5], [15, 2, 2, 45], [15, 29, 46, 15], [31, 0, 40, 53], [45, 47, 4, 35]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 90;
...
;// CM discriminants
CM_discs := [-4];
// Modular curve is a fiber product of the following curvesfactors := ['5.15.0.a.1', '12.6.0.a.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["10.45.1.a.1", "60.30.2.a.1", "60.30.2.d.1"];
...
// Canonical model
model_0 := [15*x^2-5*y^2-10*y*z-z^2+4*z*w-4*w^2,3*x^2*z-6*x^2*w+3*y*z*w+z^2*w-y*w^2-3*z*w^2+2*w^3];

// Singular plane model
model_1 := [-3*x^6+9*x^4*y^2-18*x^4*y*z+x^4*z^2+54*x^2*y^3*z-27*x^2*y^2*z^2+6*x^2*y*z^3+36*y^4*z^2-30*y^3*z^3+4*y^2*z^4];
...
// Map from the canonical model to the plane model of modular curve with label 60.90.4.a.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
map_1_coord_2 := 1*(w);
// Codomain equation:
map_1_codomain := [-3*x^6+9*x^4*y^2-18*x^4*y*z+x^4*z^2+54*x^2*y^3*z-27*x^2*y^2*z^2+6*x^2*y*z^3+36*y^4*z^2-30*y^3*z^3+4*y^2*z^4];
