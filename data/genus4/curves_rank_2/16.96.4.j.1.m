...
// Magma code for modular curve with label 16.96.4.j.1

// Other names and/or labels
// Cummins-Pauli label: 16B4
// Rouse-Sutherland-Zureick-Brown label: 16.96.4.12

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 12, 10, 13], [11, 9, 6, 1], [13, 6, 4, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.br.1", "16.48.1.ca.1", "16.48.2.bx.1"];
