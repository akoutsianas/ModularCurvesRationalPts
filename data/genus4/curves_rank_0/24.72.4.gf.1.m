...
// Magma code for modular curve with label 24.72.4.gf.1

// Other names and/or labels
// Cummins-Pauli label: 24F4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.276

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 4, 16, 17], [1, 20, 16, 7], [3, 22, 16, 9], [13, 1, 16, 5], [15, 20, 16, 21], [19, 12, 0, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.24.0.by.1", "24.36.2.cj.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.gf.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
