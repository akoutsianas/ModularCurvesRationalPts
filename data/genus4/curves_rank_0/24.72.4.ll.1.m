...
// Magma code for modular curve with label 24.72.4.ll.1

// Other names and/or labels
// Cummins-Pauli label: 24L4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.303

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 17, 16, 3], [13, 6, 18, 19], [13, 17, 2, 23], [17, 13, 2, 23], [19, 18, 0, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fp.1", "24.36.1.gd.1", "24.36.2.gi.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.ll.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
