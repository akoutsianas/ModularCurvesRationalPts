...
// Magma code for modular curve with label 48.72.4.v.1

// Other names and/or labels
// Cummins-Pauli label: 48F4
// Rouse-Sutherland-Zureick-Brown label: 48.72.4.53

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 9, 0, 19], [11, 16, 8, 11], [29, 7, 8, 5], [31, 43, 8, 13], [35, 4, 40, 1], [39, 35, 16, 27], [47, 30, 0, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
// Map from the canonical model to the plane model of modular curve with label 48.72.4.v.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
