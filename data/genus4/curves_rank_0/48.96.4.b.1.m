...
// Magma code for modular curve with label 48.96.4.b.1

// Other names and/or labels
// Cummins-Pauli label: 24R4
// Rouse-Sutherland-Zureick-Brown label: 48.96.4.59

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 30, 36, 5], [13, 9, 30, 35], [23, 45, 12, 25], [25, 8, 36, 25], [41, 30, 24, 29], [43, 24, 30, 29]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.48.2.l.1", "48.24.0.k.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.4.b.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
