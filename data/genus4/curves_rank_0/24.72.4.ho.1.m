...
// Magma code for modular curve with label 24.72.4.ho.1

// Other names and/or labels
// Cummins-Pauli label: 24J4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.401

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 1, 8, 5], [5, 17, 4, 11], [9, 2, 8, 9], [15, 20, 20, 21], [21, 19, 4, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.2.cr.1", "24.36.2.cw.1", "24.36.2.dh.1"];
...
model_1 := [x^6+4*x^4*z^2+4*x^2*y^2*z^2+4*x^2*z^4+y^4*z^2+2*y^2*z^4];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.ho.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
...
// Codomain equation:
map_1_codomain := [x^6+4*x^4*z^2+4*x^2*y^2*z^2+4*x^2*z^4+y^4*z^2+2*y^2*z^4];
