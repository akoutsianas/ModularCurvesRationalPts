...
// Magma code for modular curve with label 16.96.4.g.1

// Other names and/or labels
// Cummins-Pauli label: 16B4
// Rouse-Sutherland-Zureick-Brown label: 16.96.4.6

// Group data
level := 16;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 6, 10, 5], [9, 7, 2, 15], [13, 0, 10, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.ba.1", "16.48.1.bt.1", "16.48.2.bw.1"];
...
model_1 := [4*x^4*y^2+4*x^2*y^4+36*x^2*y^3*z+4*x^2*y^2*z^2-12*x^2*y*z^3+9*y^6+18*y^5*z+27*y^4*z^2+12*y^3*z^3+3*y^2*z^4-6*y*z^5+z^6];
...
// Map from the canonical model to the plane model of modular curve with label 16.96.4.g.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
...
// Codomain equation:
map_1_codomain := [4*x^4*y^2+4*x^2*y^4+36*x^2*y^3*z+4*x^2*y^2*z^2-12*x^2*y*z^3+9*y^6+18*y^5*z+27*y^4*z^2+12*y^3*z^3+3*y^2*z^4-6*y*z^5+z^6];
