...
// Magma code for modular curve with label 32.96.4.c.1

// Other names and/or labels
// Cummins-Pauli label: 16A4
// Rouse-Sutherland-Zureick-Brown label: 32.96.4.4

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 31, 6, 15], [9, 28, 24, 1], [11, 0, 10, 5], [13, 21, 14, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
// Map from the canonical model to the plane model of modular curve with label 32.96.4.c.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
