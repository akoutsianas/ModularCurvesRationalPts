...
// Magma code for modular curve with label 24.72.4.lt.1

// Other names and/or labels
// Cummins-Pauli label: 24L4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.349

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 4, 20, 13], [1, 7, 10, 11], [11, 3, 0, 17], [13, 2, 22, 7], [19, 5, 4, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fr.1", "24.36.1.gb.1", "24.36.2.gi.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.lt.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
