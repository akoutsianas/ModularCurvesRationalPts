...
// Magma code for modular curve with label 18.72.4.j.1

// Other names and/or labels
// Cummins-Pauli label: 18I4
// Rouse-Sutherland-Zureick-Brown label: 18.72.4.11

// Group data
level := 18;
// Elements that, together with Gamma(level), generate the group
gens := [[2, 1, 3, 11], [7, 1, 6, 17], [8, 3, 9, 10]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
// Map from the canonical model to the plane model of modular curve with label 18.72.4.j.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y-z);
