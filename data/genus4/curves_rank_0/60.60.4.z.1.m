...
// Magma code for modular curve with label 60.60.4.z.1

// Other names and/or labels
// Cummins-Pauli label: 20A4
// Rouse-Sutherland-Zureick-Brown label: 60.60.4.58

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 45, 20, 23], [29, 48, 16, 23], [51, 37, 34, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["20.30.2.i.1", "30.30.2.a.1", "60.12.0.q.1", "60.30.2.g.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.60.4.z.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
