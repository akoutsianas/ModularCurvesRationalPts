...
// Magma code for modular curve with label 24.72.4.kc.1

// Other names and/or labels
// Cummins-Pauli label: 24E4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.232

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 3, 12, 23], [5, 17, 10, 23], [5, 23, 10, 11], [13, 18, 0, 1], [17, 23, 16, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.bw.1", "24.36.1.fv.1", "24.36.1.gg.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.kc.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
