...
// Magma code for modular curve with label 24.72.4.mh.1

// Other names and/or labels
// Cummins-Pauli label: 24K4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.58

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 13, 22, 7], [11, 15, 18, 5], [13, 10, 2, 7], [19, 12, 6, 1], [23, 11, 8, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bv.1", "24.36.1.fu.1", "24.36.2.gi.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.mh.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x-y);
//   Coordinate number 1:
map_1_coord_1 := 1*(4*z);
