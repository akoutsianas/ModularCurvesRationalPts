...
// Magma code for modular curve with label 24.72.4.hc.1

// Other names and/or labels
// Cummins-Pauli label: 24J4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.425

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 22, 4, 3], [9, 11, 8, 21], [9, 19, 16, 3], [15, 13, 16, 3], [17, 1, 4, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.2.cm.1", "24.36.2.cu.1", "24.36.2.de.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.hc.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
