...
// Magma code for modular curve with label 60.60.4.bf.1

// Other names and/or labels
// Cummins-Pauli label: 20A4
// Rouse-Sutherland-Zureick-Brown label: 60.60.4.59

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 46, 26, 43], [23, 14, 53, 21], [45, 4, 23, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["20.30.2.i.1", "30.30.2.c.1", "60.12.0.w.1", "60.30.2.c.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.60.4.bf.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
