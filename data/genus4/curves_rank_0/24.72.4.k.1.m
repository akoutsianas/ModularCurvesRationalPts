...
// Magma code for modular curve with label 24.72.4.k.1

// Other names and/or labels
// Cummins-Pauli label: 24E4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.157

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 8, 2, 21], [13, 0, 12, 5], [13, 20, 20, 5], [17, 10, 2, 11], [19, 4, 10, 17], [23, 14, 2, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.a.1", "24.36.1.ft.1", "24.36.1.gg.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.k.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
