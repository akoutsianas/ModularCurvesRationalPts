...
// Magma code for modular curve with label 48.72.4.bb.1

// Other names and/or labels
// Cummins-Pauli label: 48G4
// Rouse-Sutherland-Zureick-Brown label: 48.72.4.57

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 8, 40, 1], [27, 38, 8, 21], [29, 26, 40, 47], [31, 20, 16, 13], [35, 7, 40, 13], [37, 25, 16, 47], [41, 3, 0, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
// Map from the canonical model to the plane model of modular curve with label 48.72.4.bb.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
