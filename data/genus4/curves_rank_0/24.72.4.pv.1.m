...
// Magma code for modular curve with label 24.72.4.pv.1

// Other names and/or labels
// Cummins-Pauli label: 24L4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.112

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 14, 20, 3], [5, 8, 14, 7], [11, 13, 2, 17], [21, 17, 14, 15], [23, 0, 6, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bz.1", "24.36.1.gi.1", "24.36.2.gn.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.pv.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
