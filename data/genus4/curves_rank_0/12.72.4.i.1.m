...
// Magma code for modular curve with label 12.72.4.i.1

// Other names and/or labels
// Cummins-Pauli label: 12C4
// Rouse-Sutherland-Zureick-Brown label: 12.72.4.19

// Group data
level := 12;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 0, 6, 7], [1, 4, 8, 1], [3, 4, 8, 3], [7, 2, 8, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.by.1", "12.36.2.a.1", "12.36.2.g.1"];
...
// Map from the canonical model to the plane model of modular curve with label 12.72.4.i.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
