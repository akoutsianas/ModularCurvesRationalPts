...
// Magma code for modular curve with label 24.72.4.gq.1

// Other names and/or labels
// Cummins-Pauli label: 24J4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.405

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 5, 20, 1], [7, 4, 16, 17], [11, 5, 16, 17], [13, 15, 12, 7], [15, 10, 16, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.2.ci.1", "24.36.2.cp.1", "24.36.2.dh.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.gq.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
