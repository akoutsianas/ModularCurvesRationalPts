...
// Magma code for modular curve with label 60.72.4.cw.1

// Other names and/or labels
// Cummins-Pauli label: 12A4
// Rouse-Sutherland-Zureick-Brown label: 60.72.4.3

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[23, 2, 41, 13], [25, 4, 13, 23], [31, 42, 38, 29], [43, 0, 15, 49]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bs.1", "60.24.0.y.1", "60.24.2.c.1", "60.36.1.fs.1", "60.36.2.fo.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.72.4.cw.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*z);
