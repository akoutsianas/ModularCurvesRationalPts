...
// Magma code for modular curve with label 60.72.4.bd.1

// Other names and/or labels
// Cummins-Pauli label: 12C4
// Rouse-Sutherland-Zureick-Brown label: 60.72.4.69

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 4, 8, 43], [11, 0, 42, 53], [21, 50, 32, 39], [23, 12, 6, 7], [29, 22, 40, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.h.1", "60.36.2.a.1", "60.36.2.h.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.72.4.bd.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
