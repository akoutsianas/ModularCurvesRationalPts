...
// Magma code for modular curve with label 24.72.4.fg.1

// Other names and/or labels
// Cummins-Pauli label: 24E4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.219

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 1, 16, 15], [7, 6, 0, 1], [9, 10, 20, 21], [15, 14, 4, 3], [19, 20, 8, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.s.1", "24.36.2.cm.1", "24.36.2.cr.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.fg.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
