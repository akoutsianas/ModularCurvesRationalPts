...
// Magma code for modular curve with label 24.72.4.br.1

// Other names and/or labels
// Cummins-Pauli label: 12C4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.192

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 4, 20, 19], [5, 0, 0, 19], [19, 8, 2, 11], [21, 16, 2, 9], [23, 22, 2, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.c.1", "24.36.2.f.1", "24.36.2.h.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.br.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
