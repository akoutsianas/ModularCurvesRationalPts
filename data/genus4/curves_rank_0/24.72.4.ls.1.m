...
// Magma code for modular curve with label 24.72.4.ls.1

// Other names and/or labels
// Cummins-Pauli label: 24L4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.353

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 3, 0, 23], [7, 6, 12, 11], [13, 14, 2, 11], [23, 7, 16, 13], [23, 16, 22, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fr.1", "24.36.1.ga.1", "24.36.2.gi.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.ls.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
