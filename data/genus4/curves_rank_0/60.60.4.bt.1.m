...
// Magma code for modular curve with label 60.60.4.bt.1

// Other names and/or labels
// Cummins-Pauli label: 20A4
// Rouse-Sutherland-Zureick-Brown label: 60.60.4.56

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 24, 27, 19], [39, 32, 44, 13], [41, 18, 53, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["20.30.2.g.1", "60.12.0.bg.1", "60.30.2.e.1", "60.30.2.n.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.60.4.bt.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
