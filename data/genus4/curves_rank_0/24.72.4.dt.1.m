...
// Magma code for modular curve with label 24.72.4.dt.1

// Other names and/or labels
// Cummins-Pauli label: 24E4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.170

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 20, 4, 1], [3, 4, 16, 3], [13, 13, 16, 23], [19, 17, 16, 13], [21, 5, 4, 3], [23, 19, 16, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.p.1", "24.36.1.fv.1", "24.36.2.cp.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.dt.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(4*y);
