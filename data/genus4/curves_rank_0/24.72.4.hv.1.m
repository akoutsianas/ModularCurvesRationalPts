...
// Magma code for modular curve with label 24.72.4.hv.1

// Other names and/or labels
// Cummins-Pauli label: 24J4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.263

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 14, 8, 23], [3, 17, 16, 21], [9, 1, 8, 15], [11, 22, 16, 1], [15, 23, 8, 15], [19, 6, 0, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.ba.1", "24.36.2.cj.1", "24.36.2.cs.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.hv.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
