...
// Magma code for modular curve with label 24.72.4.by.1

// Other names and/or labels
// Cummins-Pauli label: 12C4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.199

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 4, 16, 21], [7, 16, 22, 23], [19, 6, 0, 11], [21, 2, 8, 15], [21, 10, 16, 21]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.e.1", "24.36.2.d.1", "24.36.2.h.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.by.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
