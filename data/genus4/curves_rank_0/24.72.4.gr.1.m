...
// Magma code for modular curve with label 24.72.4.gr.1

// Other names and/or labels
// Cummins-Pauli label: 24J4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.391

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 11, 8, 15], [7, 22, 8, 19], [9, 16, 16, 9], [17, 8, 16, 5], [21, 2, 8, 15], [23, 18, 0, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.2.cj.1", "24.36.2.co.1", "24.36.2.dh.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.gr.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
