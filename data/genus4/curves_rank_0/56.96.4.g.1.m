...
// Magma code for modular curve with label 56.96.4.g.1

// Other names and/or labels
// Cummins-Pauli label: 28E4
// Rouse-Sutherland-Zureick-Brown label: 56.96.4.5

// Group data
level := 56;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 5, 28, 1], [19, 35, 0, 33], [25, 42, 36, 1], [35, 4, 20, 51], [43, 6, 8, 21], [49, 17, 48, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
model_1 := [38367*x^6+43904*x^5*y-24696*x^4*y^2+5488*x^3*y^3+81053*x^5*z-674240*x^4*y*z+303408*x^3*y^2*z-50568*x^2*y^3*z-3051734*x^4*z^2+3388672*x^3*y*z^2-1186038*x^2*y^2*z^2+155316*x*y^3*z^2+7612892*x^3*z^3-5781952*x^2*y*z^3+1561158*x*y^2*z^3-159014*y^3*z^3-3179932*x^2*z^4+1452288*x*y*z^4-199692*y^2*z^4+815636*x*z^5-99072*y*z^5-72552*z^6];
...
// Map from the canonical model to the plane model of modular curve with label 56.96.4.g.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y-4/41*w);
//   Coordinate number 1:
map_1_coord_1 := 1*(4*y);
//   Coordinate number 2:
map_1_coord_2 := 1*(1/2*z-15/82*w);
// Codomain equation:
map_1_codomain := [38367*x^6+43904*x^5*y-24696*x^4*y^2+5488*x^3*y^3+81053*x^5*z-674240*x^4*y*z+303408*x^3*y^2*z-50568*x^2*y^3*z-3051734*x^4*z^2+3388672*x^3*y*z^2-1186038*x^2*y^2*z^2+155316*x*y^3*z^2+7612892*x^3*z^3-5781952*x^2*y*z^3+1561158*x*y^2*z^3-159014*y^3*z^3-3179932*x^2*z^4+1452288*x*y*z^4-199692*y^2*z^4+815636*x*z^5-99072*y*z^5-72552*z^6];
