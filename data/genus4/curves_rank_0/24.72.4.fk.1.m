...
// Magma code for modular curve with label 24.72.4.fk.1

// Other names and/or labels
// Cummins-Pauli label: 24E4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.220

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 13, 8, 11], [19, 2, 20, 23], [23, 1, 8, 17], [23, 9, 0, 19], [23, 15, 12, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.s.1", "24.36.2.cp.1", "24.36.2.cs.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.fk.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(4*y);
