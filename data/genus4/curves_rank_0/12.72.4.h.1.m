...
// Magma code for modular curve with label 12.72.4.h.1

// Other names and/or labels
// Cummins-Pauli label: 12C4
// Rouse-Sutherland-Zureick-Brown label: 12.72.4.23

// Group data
level := 12;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 10, 8, 3], [11, 6, 0, 5], [11, 8, 10, 5], [11, 10, 10, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.b.1", "12.36.2.e.1", "12.36.2.f.1"];
...
// Map from the canonical model to the plane model of modular curve with label 12.72.4.h.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
