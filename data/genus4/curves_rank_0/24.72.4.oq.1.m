...
// Magma code for modular curve with label 24.72.4.oq.1

// Other names and/or labels
// Cummins-Pauli label: 24K4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.76

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 1, 16, 9], [9, 13, 22, 15], [15, 13, 14, 21], [17, 22, 10, 7], [21, 20, 16, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bu.1", "24.36.1.ft.1", "24.36.2.gn.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.oq.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
