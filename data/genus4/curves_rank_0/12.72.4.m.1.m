...
// Magma code for modular curve with label 12.72.4.m.1

// Other names and/or labels
// Cummins-Pauli label: 12C4
// Rouse-Sutherland-Zureick-Brown label: 12.72.4.26

// Group data
level := 12;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 10, 4, 11], [7, 8, 2, 11], [9, 2, 2, 9], [11, 2, 8, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.c.1", "12.36.2.f.1", "12.36.2.h.1"];
...
// Map from the canonical model to the plane model of modular curve with label 12.72.4.m.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
