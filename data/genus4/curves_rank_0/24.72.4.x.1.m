...
// Magma code for modular curve with label 24.72.4.x.1

// Other names and/or labels
// Cummins-Pauli label: 24N4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.131

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 22, 8, 13], [9, 14, 20, 3], [15, 2, 20, 21], [17, 10, 20, 23], [17, 22, 16, 7], [19, 16, 20, 13], [23, 10, 8, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.x.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
