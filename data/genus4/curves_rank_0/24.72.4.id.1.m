...
// Magma code for modular curve with label 24.72.4.id.1

// Other names and/or labels
// Cummins-Pauli label: 24J4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.267

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 18, 0, 5], [11, 9, 0, 5], [11, 22, 4, 13], [15, 23, 8, 3], [19, 5, 4, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.ba.1", "24.36.2.cl.1", "24.36.2.cq.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.id.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
