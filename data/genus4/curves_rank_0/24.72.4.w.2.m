...
// Magma code for modular curve with label 24.72.4.w.2

// Other names and/or labels
// Cummins-Pauli label: 24N4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.126

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 12, 12, 19], [7, 0, 0, 1], [9, 16, 4, 3], [11, 6, 0, 19], [11, 16, 4, 7], [15, 22, 8, 3], [17, 20, 4, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.w.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
