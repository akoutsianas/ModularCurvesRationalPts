...
// Magma code for modular curve with label 56.96.4.d.1

// Other names and/or labels
// Cummins-Pauli label: 56C4
// Rouse-Sutherland-Zureick-Brown label: 56.96.4.12

// Group data
level := 56;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 24, 0, 37], [3, 18, 0, 51], [19, 36, 42, 17], [21, 11, 52, 53], [25, 5, 0, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
// Map from the canonical model to the plane model of modular curve with label 56.96.4.d.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
