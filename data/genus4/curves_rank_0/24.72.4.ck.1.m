...
// Magma code for modular curve with label 24.72.4.ck.1

// Other names and/or labels
// Cummins-Pauli label: 24E4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.412

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 16, 20, 23], [9, 4, 20, 3], [11, 3, 0, 5], [11, 11, 20, 1], [23, 4, 8, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.2.j.1", "24.36.2.cm.1", "24.36.2.cs.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.ck.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
