...
// Magma code for modular curve with label 28.144.4.i.2

// Other names and/or labels
// Cummins-Pauli label: 28F4
// Rouse-Sutherland-Zureick-Brown label: 28.144.4.5

// Group data
level := 28;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 26, 4, 9], [11, 6, 18, 23], [13, 17, 20, 27], [15, 18, 20, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 144;
...
covers := ["14.72.1.a.1", "28.48.2.i.1"];
...
// Map from the canonical model to the plane model of modular curve with label 28.144.4.i.2
//   Coordinate number 0:
map_1_coord_0 := 1*(z);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
