...
// Magma code for modular curve with label 40.60.4.bx.1

// Other names and/or labels
// Cummins-Pauli label: 20A4
// Rouse-Sutherland-Zureick-Brown label: 40.60.4.45

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 6, 29, 7], [11, 16, 14, 31], [31, 34, 3, 13], [33, 26, 1, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["20.30.2.k.1", "40.12.0.bh.1", "40.30.2.h.1", "40.30.2.i.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.60.4.bx.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
