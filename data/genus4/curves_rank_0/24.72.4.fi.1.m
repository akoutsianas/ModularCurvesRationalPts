...
// Magma code for modular curve with label 24.72.4.fi.1

// Other names and/or labels
// Cummins-Pauli label: 24E4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.415

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 3, 0, 13], [7, 16, 20, 1], [13, 8, 20, 23], [15, 2, 8, 9], [19, 10, 4, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.2.cc.1", "24.36.2.cm.1", "24.36.2.cq.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.fi.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
