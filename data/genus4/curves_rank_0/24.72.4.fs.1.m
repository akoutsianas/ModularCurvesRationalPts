...
// Magma code for modular curve with label 24.72.4.fs.1

// Other names and/or labels
// Cummins-Pauli label: 24E4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.240

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 7, 20, 1], [11, 9, 12, 7], [11, 18, 0, 11], [11, 21, 12, 5], [15, 13, 8, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.t.1", "24.36.2.cm.1", "24.36.2.co.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.fs.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
