...
// Magma code for modular curve with label 24.72.4.gs.1

// Other names and/or labels
// Cummins-Pauli label: 24J4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.176

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 22, 4, 21], [11, 11, 16, 11], [19, 18, 0, 19], [21, 22, 16, 21], [23, 6, 0, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.x.1", "24.36.2.ci.1", "24.36.2.co.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.gs.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
