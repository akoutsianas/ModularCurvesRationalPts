...
// Magma code for modular curve with label 48.72.4.ba.2

// Other names and/or labels
// Cummins-Pauli label: 48G4
// Rouse-Sutherland-Zureick-Brown label: 48.72.4.63

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 40, 40, 17], [7, 35, 32, 47], [21, 38, 8, 39], [23, 33, 0, 29], [23, 40, 16, 19], [27, 41, 32, 39], [41, 9, 24, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
// Map from the canonical model to the plane model of modular curve with label 48.72.4.ba.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
