...
// Magma code for modular curve with label 24.72.4.fw.1

// Other names and/or labels
// Cummins-Pauli label: 24E4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.239

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 13, 4, 13], [13, 4, 4, 17], [13, 11, 20, 23], [19, 6, 0, 5], [23, 2, 20, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.t.1", "24.36.2.cq.1", "24.36.2.cs.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.fw.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(4*y);
