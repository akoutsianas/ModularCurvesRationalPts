...
// Magma code for modular curve with label 24.72.4.r.1

// Other names and/or labels
// Cummins-Pauli label: 24E4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.143

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 14, 16, 3], [9, 20, 8, 9], [13, 16, 16, 11], [17, 0, 12, 7], [17, 12, 0, 19], [19, 20, 4, 1], [21, 16, 20, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.b.1", "24.36.2.co.1", "24.36.2.cr.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.r.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
