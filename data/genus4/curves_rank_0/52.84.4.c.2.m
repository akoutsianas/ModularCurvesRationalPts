...
// Magma code for modular curve with label 52.84.4.c.2

// Other names and/or labels
// Cummins-Pauli label: 52A4
// Rouse-Sutherland-Zureick-Brown label: 52.84.4.4

// Group data
level := 52;
// Elements that, together with Gamma(level), generate the group
gens := [[15, 1, 30, 5], [39, 1, 4, 3], [45, 40, 46, 31], [51, 24, 46, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 84;
...
model_1 := [8*x^6+12*x^5*z-8*x^4*y^2+6*x^4*z^2-4*x^3*y^2*z+x^3*z^3+5*x^2*y^4+2*x^2*y^2*z^2-4*x*y^4*z+x*y^2*z^3+y^6];
...
// Map from the canonical model to the plane model of modular curve with label 52.84.4.c.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
...
map_1_coord_2 := 1*(w);
// Codomain equation:
map_1_codomain := [8*x^6+12*x^5*z-8*x^4*y^2+6*x^4*z^2-4*x^3*y^2*z+x^3*z^3+5*x^2*y^4+2*x^2*y^2*z^2-4*x*y^4*z+x*y^2*z^3+y^6];
