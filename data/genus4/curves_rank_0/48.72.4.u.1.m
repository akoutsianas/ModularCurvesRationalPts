...
// Magma code for modular curve with label 48.72.4.u.1

// Other names and/or labels
// Cummins-Pauli label: 48F4
// Rouse-Sutherland-Zureick-Brown label: 48.72.4.55

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 47, 32, 5], [3, 8, 32, 27], [13, 22, 32, 25], [25, 4, 40, 35], [25, 11, 16, 13], [31, 2, 8, 47], [37, 6, 0, 37]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
// Map from the canonical model to the plane model of modular curve with label 48.72.4.u.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
