...
// Magma code for modular curve with label 24.72.4.cj.1

// Other names and/or labels
// Cummins-Pauli label: 24D4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.290

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 3, 0, 23], [1, 15, 12, 19], [5, 23, 8, 1], [11, 6, 0, 11], [17, 8, 8, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.24.0.n.1", "24.36.2.j.1", "24.36.2.ck.1", "24.36.2.cu.1"];
...
model_1 := [385400*x^6+3993*x^3*y^3-134568*x^5*z-1089*x^2*y^3*z+5460*x^4*z^2+99*x*y^3*z^2+3520*x^3*z^3-3*y^3*z^3-630*x^2*z^4+42*x*z^5-z^6];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.cj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y-1/3*w);
//   Coordinate number 1:
map_1_coord_1 := 1*(8*x);
//   Coordinate number 2:
map_1_coord_2 := 1*(2*z-8/3*w);
// Codomain equation:
map_1_codomain := [385400*x^6+3993*x^3*y^3-134568*x^5*z-1089*x^2*y^3*z+5460*x^4*z^2+99*x*y^3*z^2+3520*x^3*z^3-3*y^3*z^3-630*x^2*z^4+42*x*z^5-z^6];
