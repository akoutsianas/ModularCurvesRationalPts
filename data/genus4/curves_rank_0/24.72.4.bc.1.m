...
// Magma code for modular curve with label 24.72.4.bc.1

// Other names and/or labels
// Cummins-Pauli label: 12C4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.153

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 2, 8, 17], [11, 2, 8, 19], [13, 4, 2, 7], [13, 18, 12, 17], [15, 16, 22, 9], [19, 22, 22, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.a.1", "24.36.1.gb.1", "24.36.2.f.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.bc.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
