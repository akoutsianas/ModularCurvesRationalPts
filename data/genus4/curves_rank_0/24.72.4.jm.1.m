...
// Magma code for modular curve with label 24.72.4.jm.1

// Other names and/or labels
// Cummins-Pauli label: 24E4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.231

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 2, 14, 7], [5, 7, 8, 11], [11, 10, 16, 7], [11, 12, 6, 5], [17, 8, 20, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.bw.1", "24.36.1.fs.1", "24.36.1.gf.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.jm.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
