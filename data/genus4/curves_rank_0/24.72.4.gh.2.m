...
// Magma code for modular curve with label 24.72.4.gh.2

// Other names and/or labels
// Cummins-Pauli label: 24M4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.384

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 22, 16, 5], [3, 11, 8, 9], [13, 5, 16, 13], [13, 22, 16, 11], [19, 18, 0, 17], [23, 7, 16, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.gh.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
