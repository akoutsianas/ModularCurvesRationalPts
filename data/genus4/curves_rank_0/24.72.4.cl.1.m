...
// Magma code for modular curve with label 24.72.4.cl.1

// Other names and/or labels
// Cummins-Pauli label: 24E4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.411

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 3, 0, 19], [7, 18, 0, 7], [17, 20, 20, 19], [21, 8, 16, 15], [21, 11, 8, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.2.j.1", "24.36.2.co.1", "24.36.2.cq.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.cl.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
