...
// Magma code for modular curve with label 24.72.4.lj.1

// Other names and/or labels
// Cummins-Pauli label: 24L4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.103

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 2, 10, 9], [11, 6, 0, 19], [13, 13, 20, 7], [19, 16, 10, 5], [21, 7, 14, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bz.1", "24.36.1.fo.1", "24.36.2.gi.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.lj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
