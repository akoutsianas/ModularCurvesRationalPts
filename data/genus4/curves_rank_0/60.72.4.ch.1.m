...
// Magma code for modular curve with label 60.72.4.ch.1

// Other names and/or labels
// Cummins-Pauli label: 12A4
// Rouse-Sutherland-Zureick-Brown label: 60.72.4.6

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 50, 19, 31], [29, 38, 35, 7], [29, 52, 11, 35], [35, 4, 16, 43]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['3.3.0.a.1', '20.24.0.h.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["12.36.1.bt.1", "20.24.0.h.1", "60.36.1.fr.1", "60.36.2.fk.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.72.4.ch.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
