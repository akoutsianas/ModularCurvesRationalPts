...
// Magma code for modular curve with label 24.72.4.fj.1

// Other names and/or labels
// Cummins-Pauli label: 24E4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.432

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 2, 4, 1], [9, 16, 16, 15], [15, 13, 8, 3], [17, 2, 4, 23], [17, 11, 8, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.2.cc.1", "24.36.2.cn.1", "24.36.2.cr.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.fj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
