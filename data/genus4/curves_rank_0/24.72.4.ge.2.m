...
// Magma code for modular curve with label 24.72.4.ge.2

// Other names and/or labels
// Cummins-Pauli label: 24F4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.23

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 1, 8, 23], [7, 9, 0, 11], [7, 11, 16, 1], [9, 4, 16, 9], [17, 5, 8, 13], [19, 22, 8, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['3.3.0.a.1', '8.24.0.ba.2']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["8.24.0.ba.2", "24.36.2.cj.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.ge.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
