...
// Magma code for modular curve with label 24.72.4.ej.1

// Other names and/or labels
// Cummins-Pauli label: 24E4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.169

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 20, 8, 11], [9, 20, 4, 21], [11, 10, 16, 7], [13, 5, 16, 19], [15, 22, 16, 15], [21, 16, 4, 9]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.p.1", "24.36.1.gf.1", "24.36.2.cr.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.ej.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
