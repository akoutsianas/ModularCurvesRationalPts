...
// Magma code for modular curve with label 20.90.4.g.1

// Other names and/or labels
// Cummins-Pauli label: 20E4
// Rouse-Sutherland-Zureick-Brown label: 20.90.4.9

// Group data
level := 20;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 0, 14, 13], [7, 6, 0, 19], [7, 12, 19, 13], [17, 2, 4, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 90;
...
covers := ["10.45.1.a.1", "20.30.2.i.1"];
...
// Canonical model
model_0 := [10*x^2+y^2+y*z-z^2+y*w-2*z*w,y^3+y^2*z-y*z^2-2*y^2*w+y*z*w+z^2*w-y*w^2];

// Singular plane model
model_1 := [-25*x^4*y^2+50*x^4*y*z-25*x^4*z^2+15*x^2*y^2*z^2-5*x^2*y*z^3+5*y^4*z^2-5*y^3*z^3-y^2*z^4+y*z^5];
...
// Map from the canonical model to the plane model of modular curve with label 20.90.4.g.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
...
map_1_coord_2 := 1*(w);
// Codomain equation:
map_1_codomain := [-25*x^4*y^2+50*x^4*y*z-25*x^4*z^2+15*x^2*y^2*z^2-5*x^2*y*z^3+5*y^4*z^2-5*y^3*z^3-y^2*z^4+y*z^5];
