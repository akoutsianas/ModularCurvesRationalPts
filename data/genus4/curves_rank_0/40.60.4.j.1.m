...
// Magma code for modular curve with label 40.60.4.j.1

// Other names and/or labels
// Cummins-Pauli label: 20A4
// Rouse-Sutherland-Zureick-Brown label: 40.60.4.63

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 4, 36, 7], [15, 11, 14, 25], [29, 3, 16, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["20.30.2.j.1", "40.12.0.f.1", "40.30.2.a.1", "40.30.2.i.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.60.4.j.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
