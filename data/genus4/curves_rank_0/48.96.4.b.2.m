...
// Magma code for modular curve with label 48.96.4.b.2

// Other names and/or labels
// Cummins-Pauli label: 24R4
// Rouse-Sutherland-Zureick-Brown label: 48.96.4.60

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 47, 24, 47], [7, 26, 24, 35], [13, 34, 6, 43], [23, 2, 36, 35], [25, 15, 12, 31], [29, 19, 18, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["24.48.2.l.1", "48.24.0.k.2"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.4.b.2
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
