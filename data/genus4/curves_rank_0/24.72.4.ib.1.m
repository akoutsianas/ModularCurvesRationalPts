...
// Magma code for modular curve with label 24.72.4.ib.1

// Other names and/or labels
// Cummins-Pauli label: 24J4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.433

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 4, 4, 11], [1, 8, 16, 7], [7, 8, 4, 7], [7, 9, 12, 5], [21, 2, 4, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.2.cl.1", "24.36.2.cr.1", "24.36.2.dq.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.ib.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
