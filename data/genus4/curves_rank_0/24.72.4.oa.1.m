...
// Magma code for modular curve with label 24.72.4.oa.1

// Other names and/or labels
// Cummins-Pauli label: 24L4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.113

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 16, 16, 3], [5, 2, 10, 23], [17, 15, 18, 23], [21, 16, 10, 15], [23, 9, 6, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bw.1", "24.36.1.fp.1", "24.36.2.gn.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.oa.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*z);
