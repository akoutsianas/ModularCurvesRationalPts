...
// Magma code for modular curve with label 60.72.4.bz.1

// Other names and/or labels
// Cummins-Pauli label: 12A4
// Rouse-Sutherland-Zureick-Brown label: 60.72.4.74

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 40, 28, 11], [23, 16, 59, 17], [27, 20, 17, 33], [33, 34, 7, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.bw.1", "60.24.0.l.1", "60.36.1.fr.1", "60.36.1.ft.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.72.4.bz.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
