...
// Magma code for modular curve with label 24.72.4.qd.1

// Other names and/or labels
// Cummins-Pauli label: 24L4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.80

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 8, 14, 23], [3, 5, 14, 21], [11, 17, 4, 5], [15, 11, 20, 21], [21, 10, 22, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bx.1", "24.36.1.gk.1", "24.36.2.gn.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.qd.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x-y);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*z);
