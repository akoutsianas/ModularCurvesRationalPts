...
// Magma code for modular curve with label 48.72.4.r.1

// Other names and/or labels
// Cummins-Pauli label: 48F4
// Rouse-Sutherland-Zureick-Brown label: 48.72.4.59

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 29, 16, 33], [13, 37, 8, 31], [13, 41, 32, 47], [31, 11, 8, 35], [31, 18, 24, 37], [33, 44, 8, 45], [39, 4, 40, 39]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
// Map from the canonical model to the plane model of modular curve with label 48.72.4.r.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
