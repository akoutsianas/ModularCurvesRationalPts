...
// Magma code for modular curve with label 24.72.4.do.1

// Other names and/or labels
// Cummins-Pauli label: 24E4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.167

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 10, 16, 1], [9, 17, 4, 15], [11, 5, 20, 1], [17, 5, 16, 23], [17, 23, 16, 23], [19, 11, 4, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.p.1", "24.36.1.fs.1", "24.36.2.cm.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.do.1
//   Coordinate number 0:
map_1_coord_0 := 1*(y);
//   Coordinate number 1:
