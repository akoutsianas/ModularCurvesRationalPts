...
// Magma code for modular curve with label 24.72.4.gy.1

// Other names and/or labels
// Cummins-Pauli label: 24J4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.428

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 9, 0, 5], [5, 10, 16, 7], [11, 5, 16, 5], [11, 10, 20, 17], [19, 8, 20, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.2.ck.1", "24.36.2.cs.1", "24.36.2.de.1"];
...
model_1 := [27*x^6-18*x^4*z^2-12*x^2*y^2*z^2+3*x^2*z^4-2*y^4*z^2+y^2*z^4];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.gy.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Codomain equation:
map_1_codomain := [27*x^6-18*x^4*z^2-12*x^2*y^2*z^2+3*x^2*z^4-2*y^4*z^2+y^2*z^4];
