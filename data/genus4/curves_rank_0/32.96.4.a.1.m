...
// Magma code for modular curve with label 32.96.4.a.1

// Other names and/or labels
// Cummins-Pauli label: 32C4
// Rouse-Sutherland-Zureick-Brown label: 32.96.4.1

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[5, 0, 6, 27], [11, 17, 20, 29], [27, 8, 26, 21], [27, 16, 12, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
// Map from the canonical model to the plane model of modular curve with label 32.96.4.a.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(z);
