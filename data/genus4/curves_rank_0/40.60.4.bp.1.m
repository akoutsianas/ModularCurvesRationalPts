...
// Magma code for modular curve with label 40.60.4.bp.1

// Other names and/or labels
// Cummins-Pauli label: 40B4
// Rouse-Sutherland-Zureick-Brown label: 40.60.4.37

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 18, 24, 5], [1, 35, 20, 31], [13, 9, 32, 17], [19, 30, 20, 39], [37, 3, 32, 35]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["20.30.2.c.1", "40.12.0.bb.1"];
...
model_1 := [250*x^6-50*x^4*y^2+225*x^4*y*z+125*x^4*z^2+20*x^2*y^4+30*x^2*y^2*z^2+50*x^2*y*z^3+20*x^2*z^4+4*y^5*z+8*y^4*z^2+4*y^3*z^3];
...
// Map from the canonical model to the plane model of modular curve with label 40.60.4.bp.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
...
map_1_coord_2 := 1*(w);
// Codomain equation:
map_1_codomain := [250*x^6-50*x^4*y^2+225*x^4*y*z+125*x^4*z^2+20*x^2*y^4+30*x^2*y^2*z^2+50*x^2*y*z^3+20*x^2*z^4+4*y^5*z+8*y^4*z^2+4*y^3*z^3];
