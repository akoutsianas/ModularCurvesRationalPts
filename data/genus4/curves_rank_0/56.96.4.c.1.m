...
// Magma code for modular curve with label 56.96.4.c.1

// Other names and/or labels
// Cummins-Pauli label: 56C4
// Rouse-Sutherland-Zureick-Brown label: 56.96.4.13

// Group data
level := 56;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 15, 40, 7], [15, 24, 38, 49], [27, 12, 28, 31], [27, 12, 50, 49], [47, 17, 6, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
// Map from the canonical model to the plane model of modular curve with label 56.96.4.c.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
