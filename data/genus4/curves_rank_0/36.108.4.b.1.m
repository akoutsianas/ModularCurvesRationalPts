...
// Magma code for modular curve with label 36.108.4.b.1

// Other names and/or labels
// Cummins-Pauli label: 36Q4
// Rouse-Sutherland-Zureick-Brown label: 36.108.4.26

// Group data
level := 36;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 10, 2, 9], [13, 18, 6, 23], [33, 13, 28, 33], [33, 22, 10, 27]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 108;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['4.6.0.b.1', '9.18.0.a.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["12.36.1.k.1", "18.54.1.a.1"];
...
// Map from the canonical model to the plane model of modular curve with label 36.108.4.b.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
