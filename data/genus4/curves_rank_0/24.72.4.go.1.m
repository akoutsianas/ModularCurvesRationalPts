...
// Magma code for modular curve with label 24.72.4.go.1

// Other names and/or labels
// Cummins-Pauli label: 24J4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.258

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 11, 4, 13], [1, 16, 8, 7], [3, 20, 20, 15], [7, 21, 0, 13], [17, 1, 8, 5]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.w.1", "24.36.2.ci.1", "24.36.2.cr.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.go.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
