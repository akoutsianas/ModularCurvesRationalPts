...
// Magma code for modular curve with label 24.72.4.hm.1

// Other names and/or labels
// Cummins-Pauli label: 24J4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.178

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 6, 12, 17], [7, 19, 20, 7], [9, 16, 16, 3], [11, 1, 16, 19], [15, 16, 4, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.2.x.1", "24.36.2.cs.1", "24.36.2.cu.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.hm.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+y);
//   Coordinate number 1:
