...
// Magma code for modular curve with label 12.72.4.bc.1

// Other names and/or labels
// Cummins-Pauli label: 12C4
// Rouse-Sutherland-Zureick-Brown label: 12.72.4.20

// Group data
level := 12;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 2, 10, 7], [3, 11, 2, 9], [11, 2, 8, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["12.36.1.bw.1", "12.36.1.bz.1", "12.36.2.bx.1"];
...
model_1 := [-x^6-4*x^5*y+4*x^4*y^2+9*x^4*z^2+26*x^3*y^3-36*x^3*y*z^2-8*x^2*y^4-36*x^2*y^2*z^2+36*x^2*z^4-76*x*y^5+156*x*y^3*z^2-72*x*y*z^4+65*y^6-96*y^4*z^2+36*y^2*z^4];
...
// Map from the canonical model to the plane model of modular curve with label 12.72.4.bc.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x+w);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
...
map_1_coord_2 := 1*(z);
// Codomain equation:
map_1_codomain := [-x^6-4*x^5*y+4*x^4*y^2+9*x^4*z^2+26*x^3*y^3-36*x^3*y*z^2-8*x^2*y^4-36*x^2*y^2*z^2+36*x^2*z^4-76*x*y^5+156*x*y^3*z^2-72*x*y*z^4+65*y^6-96*y^4*z^2+36*y^2*z^4];
