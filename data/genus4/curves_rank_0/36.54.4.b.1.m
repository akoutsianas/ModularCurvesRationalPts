...
// Magma code for modular curve with label 36.54.4.b.1

// Other names and/or labels
// Cummins-Pauli label: 36D4
// Rouse-Sutherland-Zureick-Brown label: 36.54.4.4

// Group data
level := 36;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 15, 30, 23], [17, 32, 16, 17], [19, 8, 8, 35], [21, 8, 26, 3]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 54;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['4.6.0.b.1', '9.9.0.a.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["12.18.1.b.1", "18.27.1.a.1"];
...
// Map from the canonical model to the plane model of modular curve with label 36.54.4.b.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
