...
// Magma code for modular curve with label 24.72.4.ia.1

// Other names and/or labels
// Cummins-Pauli label: 24J4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.418

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 19, 20, 1], [19, 23, 4, 13], [21, 16, 8, 3], [23, 5, 20, 13], [23, 20, 4, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.2.ck.1", "24.36.2.cq.1", "24.36.2.dq.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.ia.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
