...
// Magma code for modular curve with label 24.72.4.mj.1

// Other names and/or labels
// Cummins-Pauli label: 24K4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.377

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 1, 8, 19], [5, 7, 8, 11], [5, 21, 12, 23], [11, 16, 14, 5], [21, 7, 4, 15]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.fv.1", "24.36.1.fz.1", "24.36.2.gi.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.mj.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
