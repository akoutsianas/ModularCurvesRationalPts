...
// Magma code for modular curve with label 48.72.4.y.1

// Other names and/or labels
// Cummins-Pauli label: 48D4
// Rouse-Sutherland-Zureick-Brown label: 48.72.4.1

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 12, 24, 43], [7, 19, 44, 31], [9, 46, 44, 15], [11, 5, 8, 37], [33, 29, 40, 3], [33, 44, 40, 21], [35, 15, 12, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
;// CM discriminants
CM_discs := [];
// Modular curve is a fiber product of the following curvesfactors := ['3.3.0.a.1', '16.24.0.e.1']
// Groups containing given group, corresponding to curves covered by given curve
covers := ["16.24.0.e.1", "24.36.2.cj.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.72.4.y.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
