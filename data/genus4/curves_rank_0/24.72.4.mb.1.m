...
// Magma code for modular curve with label 24.72.4.mb.1

// Other names and/or labels
// Cummins-Pauli label: 24K4
// Rouse-Sutherland-Zureick-Brown label: 24.72.4.314

// Group data
level := 24;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 4, 14, 19], [9, 17, 8, 15], [13, 10, 8, 1], [13, 20, 2, 23], [17, 9, 6, 19]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 72;
...
covers := ["24.36.1.ft.1", "24.36.1.fx.1", "24.36.2.gi.1"];
...
// Map from the canonical model to the plane model of modular curve with label 24.72.4.mb.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
