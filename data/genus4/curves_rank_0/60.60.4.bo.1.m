...
// Magma code for modular curve with label 60.60.4.bo.1

// Other names and/or labels
// Cummins-Pauli label: 20A4
// Rouse-Sutherland-Zureick-Brown label: 60.60.4.9

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 4, 52, 51], [41, 40, 25, 7], [51, 34, 1, 51]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["10.30.2.c.1", "60.12.0.bb.1", "60.30.2.f.1", "60.30.2.n.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.60.4.bo.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
