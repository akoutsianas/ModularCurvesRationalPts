...
// Magma code for modular curve with label 60.60.4.bg.1

// Other names and/or labels
// Cummins-Pauli label: 20A4
// Rouse-Sutherland-Zureick-Brown label: 60.60.4.52

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[13, 8, 21, 37], [35, 54, 16, 49], [49, 44, 14, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["20.30.2.j.1", "60.12.0.x.1", "60.30.2.c.1", "60.30.2.e.1"];
...
// Map from the canonical model to the plane model of modular curve with label 60.60.4.bg.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
