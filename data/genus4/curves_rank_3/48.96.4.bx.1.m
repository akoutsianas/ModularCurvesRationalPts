...
// Magma code for modular curve with label 48.96.4.bx.1

// Other names and/or labels
// Cummins-Pauli label: 16B4
// Rouse-Sutherland-Zureick-Brown label: 48.96.4.39

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[21, 5, 46, 39], [21, 19, 40, 35], [21, 47, 40, 35], [29, 10, 20, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.ca.1", "48.48.1.fz.1", "48.48.2.ez.1"];
...
// Canonical model
model_0 := [6*x^2+8*y^2+z^2+w^2,3*x^2*z-4*y^2*w-z^2*w+z*w^2];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.4.bx.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(2*y);
