...
// Magma code for modular curve with label 40.60.4.cf.1

// Other names and/or labels
// Cummins-Pauli label: 20B4
// Rouse-Sutherland-Zureick-Brown label: 40.60.4.30

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[11, 12, 28, 19], [17, 17, 10, 33], [17, 25, 0, 37], [31, 1, 20, 9], [33, 20, 2, 17]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
// Map from the canonical model to the plane model of modular curve with label 40.60.4.cf.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
