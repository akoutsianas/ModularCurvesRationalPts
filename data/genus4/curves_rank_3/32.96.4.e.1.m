...
// Magma code for modular curve with label 32.96.4.e.1

// Other names and/or labels
// Cummins-Pauli label: 16A4
// Rouse-Sutherland-Zureick-Brown label: 32.96.4.6

// Group data
level := 32;
// Elements that, together with Gamma(level), generate the group
gens := [[9, 16, 22, 23], [11, 17, 8, 21], [19, 23, 20, 21], [31, 24, 2, 1]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
// Map from the canonical model to the plane model of modular curve with label 32.96.4.e.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
