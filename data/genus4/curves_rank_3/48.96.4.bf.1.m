...
// Magma code for modular curve with label 48.96.4.bf.1

// Other names and/or labels
// Cummins-Pauli label: 16B4
// Rouse-Sutherland-Zureick-Brown label: 48.96.4.10

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[17, 34, 12, 29], [19, 40, 14, 37], [29, 39, 0, 43], [35, 4, 0, 43]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.1.bs.1", "48.48.1.fs.1", "48.48.2.ez.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.4.bf.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
