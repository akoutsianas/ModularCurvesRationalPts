...
// Magma code for modular curve with label 60.60.4.cl.1

// Other names and/or labels
// Cummins-Pauli label: 30C4
// Rouse-Sutherland-Zureick-Brown label: 60.60.4.30

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 17, 22, 7], [3, 5, 4, 27], [7, 25, 56, 13], [25, 2, 47, 11], [39, 8, 53, 33]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
// Canonical model
model_0 := [75*x^2-7*y^2+21*y*z-7*z^2-37*y*w+8*z*w-3*w^2,y^3-4*y^2*z+4*y*z^2-z^3+3*y^2*w-6*y*z*w+z^2*w+2*y*w^2-z*w^2];

// Singular plane model
model_1 := [-3*x^6-7*x^4*y^2+30*x^4*y*z-6*x^4*z^2+35*x^2*y^3*z+63*x^2*y*z^3+2*x^2*z^4+175*y^4*z^2-200*y^3*z^3+90*y^2*z^4+40*y*z^5+7*z^6];
...
// Map from the canonical model to the plane model of modular curve with label 60.60.4.cl.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Codomain equation:
map_1_codomain := [-3*x^6-7*x^4*y^2+30*x^4*y*z-6*x^4*z^2+35*x^2*y^3*z+63*x^2*y*z^3+2*x^2*z^4+175*y^4*z^2-200*y^3*z^3+90*y^2*z^4+40*y*z^5+7*z^6];
