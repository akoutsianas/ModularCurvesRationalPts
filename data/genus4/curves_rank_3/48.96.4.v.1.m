...
// Magma code for modular curve with label 48.96.4.v.1

// Other names and/or labels
// Cummins-Pauli label: 16B4
// Rouse-Sutherland-Zureick-Brown label: 48.96.4.44

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[1, 21, 4, 47], [23, 20, 6, 25], [29, 7, 10, 3], [31, 8, 16, 7]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.bx.1", "48.48.1.fq.1", "48.48.1.gb.1"];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.4.v.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
