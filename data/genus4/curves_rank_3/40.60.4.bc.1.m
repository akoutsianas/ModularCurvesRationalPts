...
// Magma code for modular curve with label 40.60.4.bc.1

// Other names and/or labels
// Cummins-Pauli label: 20A4
// Rouse-Sutherland-Zureick-Brown label: 40.60.4.77

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[23, 11, 14, 17], [33, 16, 10, 11], [39, 25, 24, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["20.30.2.e.1", "40.12.0.q.1", "40.30.2.c.1", "40.30.2.m.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.60.4.bc.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
