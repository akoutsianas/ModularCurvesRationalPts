...
// Magma code for modular curve with label 40.60.4.ck.1

// Other names and/or labels
// Cummins-Pauli label: 40C4
// Rouse-Sutherland-Zureick-Brown label: 40.60.4.56

// Group data
level := 40;
// Elements that, together with Gamma(level), generate the group
gens := [[23, 3, 34, 37], [23, 4, 22, 29], [25, 36, 2, 15], [35, 3, 38, 1], [39, 30, 4, 23]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
covers := ["20.30.2.l.1", "40.12.0.bq.1"];
...
// Map from the canonical model to the plane model of modular curve with label 40.60.4.ck.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
