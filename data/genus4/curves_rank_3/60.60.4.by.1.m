...
// Magma code for modular curve with label 60.60.4.by.1

// Other names and/or labels
// Cummins-Pauli label: 20B4
// Rouse-Sutherland-Zureick-Brown label: 60.60.4.4

// Group data
level := 60;
// Elements that, together with Gamma(level), generate the group
gens := [[3, 7, 22, 57], [23, 51, 46, 31], [39, 46, 56, 7], [55, 18, 18, 49], [59, 47, 30, 11]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 60;
...
// Canonical model
model_0 := [75*x^2+12*y^2+8*y*z+3*z^2-6*y*w-7*z*w-3*w^2,8*y^3+10*y^2*z+5*y*z^2+z^3-4*y^2*w-7*y*z*w-2*z^2*w-2*y*w^2-2*z*w^2];

// Singular plane model
model_1 := [x^6-9*x^4*y^2-24*x^4*y*z-x^4*z^2+90*x^2*y^3*z+165*x^2*y^2*z^2+10*x^2*y*z^3+180*y^4*z^2-80*y^3*z^3+20*y^2*z^4];
...
// Map from the canonical model to the plane model of modular curve with label 60.60.4.by.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
...
// Codomain equation:
map_1_codomain := [x^6-9*x^4*y^2-24*x^4*y*z-x^4*z^2+90*x^2*y^3*z+165*x^2*y^2*z^2+10*x^2*y*z^3+180*y^4*z^2-80*y^3*z^3+20*y^2*z^4];
