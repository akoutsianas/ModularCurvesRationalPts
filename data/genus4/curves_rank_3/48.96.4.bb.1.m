...
// Magma code for modular curve with label 48.96.4.bb.1

// Other names and/or labels
// Cummins-Pauli label: 16B4
// Rouse-Sutherland-Zureick-Brown label: 48.96.4.45

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[19, 20, 8, 3], [19, 21, 24, 5], [27, 14, 34, 13], [39, 17, 22, 25]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 96;
...
covers := ["16.48.2.bx.1", "48.48.1.fs.1", "48.48.1.fz.1"];
...
model_1 := [54*x^6+36*x^4*y^2+72*x^4*z^2+3*x^2*y^4+24*x^2*y^2*z^2+27*x^2*z^4+2*y^2*z^4+2*z^6];
...
// Map from the canonical model to the plane model of modular curve with label 48.96.4.bb.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(y);
...
map_1_coord_2 := 1*(2*z);
// Codomain equation:
map_1_codomain := [54*x^6+36*x^4*y^2+72*x^4*z^2+3*x^2*y^4+24*x^2*y^2*z^2+27*x^2*z^4+2*y^2*z^4+2*z^6];
