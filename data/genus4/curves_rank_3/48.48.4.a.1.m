...
// Magma code for modular curve with label 48.48.4.a.1

// Other names and/or labels
// Cummins-Pauli label: 24B4
// Rouse-Sutherland-Zureick-Brown label: 48.48.4.5

// Group data
level := 48;
// Elements that, together with Gamma(level), generate the group
gens := [[7, 32, 20, 23], [10, 25, 7, 26], [41, 45, 24, 31], [47, 7, 28, 13]];
// Group contains -1?
ContainsMinus1 := true;
// Index in Gamma(1)
index := 48;
...
// Map from the canonical model to the plane model of modular curve with label 48.48.4.a.1
//   Coordinate number 0:
map_1_coord_0 := 1*(x);
//   Coordinate number 1:
map_1_coord_1 := 1*(3*y);
